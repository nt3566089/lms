...
public class WmsMessageConst extends BaseMessageConst {
	...
	/** エントリーユニット（休憩）が登録されていません。管理者に問い合わせて下さい。 */
	...
	/** 取込用Excelの在庫管理単位を指定するか、荷主マスタの在庫管理単位を設定して下さい。 */
	...
	/** センタ間移動の取引先が登録されていません。出荷元のセンタ、納品先のセンタの取引先を登録して下さい。 */
	...
	/** 処理は正常終了しましたが、エラーデータが含まれています。[/]WMS入荷伝票No.：[0]で登録しました。商品内容が異なるため新しい入荷ラベルNo.で登録された商品があります。 */
	...
	/** WMS入荷伝票No.：[0]で登録しました。商品内容が異なるため新しい入荷ラベルNo.で登録された商品があります。 */
	...
	/** 同梱する商品が異なる荷揃番号で登録されています。同梱商品はまとめて出庫指示して下さい。（名寄せID：[0]） */
	...
	/** 同梱する商品の合計金額が異なります。同梱商品はまとめて出力して下さい。（名寄せID：[0]） */
	...
	/** 選択したセンターと荷主を使う権限がありません。管理者に連絡して下さい。 */
	...
	/** 対象の荷揃番号／出荷梱包No.はケースのみなので、出荷検品できません。 */
	...
	/** 最小値の桁数が桁数欄に入力した値の範囲になるよう入力して下さい。 */
	...
	/** 運送便マスタの追跡番号採番キーに登録されているセンタ採番は削除できません。 */
	...
	/** 同じ入荷ラベルNo.で、異なるロケーション、期限日、ロットが入力できません。 */
	...
	/** 入力された入荷ラベルNo.は商品入数が異なるため使用できません。（入荷ラベルNo.：[0] , 商品CD：[1]） */
	...
	/** 入力された入荷ラベルNo.([0])は異なる商品、在庫区分、預託、ロット、期限日、仕入先で登録されているため使用できません。[/]入荷ラベルNo.を入力しないで登録するか、新しい入庫ラベル… */
	...
	/** 入力された入荷ラベルNo.([0])は異なる商品、在庫区分、預託、ロット、期限日、仕入先、入庫日で登録されているため使用できません。[/]入荷ラベルNo.を入力しないで登録するか、新しい入... */
	...
	/** 入荷ラベルNo.に対する在庫情報は見つかりませんでした。新規登録の場合は入荷ラベルNo.を消して下さい。 */
	...
	/** 入荷ラベルNo.を再採番しました。入庫ラベルを印刷して下さい。 */
	...
	/** ケースピッキングリスト発行済のデータが含まれています。再提案を実行して下さい。 */
	...
	/** 1次ピッキングリスト発行済のデータが含まれています。再提案を実行して下さい。 */
	...
	/** 出庫指示済以外のデータが含まれています。再提案を実行して下さい。 */
	...
	/** シリアルNo.([0])は異なる荷揃番号/出荷梱包No.([1])で登録済です。 */
	...
	/** シフトカレンダーが登録されていません。管理者に問い合わせて下さい。 */
	...
	/** 入荷作業が既に始まっている為、出荷確定解除は出来ません。(荷揃番号：[0]) */
	...
	/** 出荷検品が完了しました。出庫指示時と梱包数が異なりますので、荷札を再出力して下さい。 */
	...
	/** 同一預託・在庫区分・ロケーション・ロット・期限日・入荷ラベルNo.を入力時は、入庫日を入力して下さい。 */
	...
	/** 同一預託・在庫区分・ロケーション・ロット・期限日を入力時は、入庫日または入荷ラベルNo.を入力して下さい。 */
	...
	/** 同一預託・在庫区分・ロケーション・ロット・期限日・入庫日を入力時は、入荷ラベルNo.を入力して下さい。 */
	...
	/** マージ先の在庫があるため、新しい入荷ラベルNo.の指定はできません。 */
	...
	/** 在庫更新で同じ入荷ラベルNo.、ロケーションの現品が存在しています、在庫情報を確認して下さい。 */
	...
	/** 正常に更新されました。商品内容が異なるため新しい入荷ラベルNo.で登録された商品があります。 */
	...
	/** 入荷したロケーションの在庫が不足している為、登録できません。入荷した時の在庫数に戻してから登録して下さい。 */
	...
	/** 欠品数が入力されていません。 */
	public static final String STOCK_OUT_NUM_NOT_INPUT_ERROR = "stockOutNumNotInputError";
	/** ピッキング時欠品数と異なります。 */
	public static final String DIFFER_FROM_STOCK_OUT_NUM_PICKING_ERROR = "differFromStockOutNumPickingError";
	...
	/** この商品は製造日管理対象です。製造日を入力して下さい。 */
	public static final String HANDY_LIMIT_DT_MANAGE_PRODUCT_LIMIT_DT_NOT_ENTERED_ERROR = "handyLimitDtManageProductLimitDtNotEnteredError";
	/** スキャン内容不一致 */
	public static final String HANDY_SCAN_DATA_UNMATCH_ERROR = "handyScanDataUnmatchError";
	/** 印刷枚数を入力して下さい。 */
	public static final String HANDY_PRINT_NUM_NOT_ENTERED_ERROR = "handyPrintNumNotEnteredError";
	/** 当日以外の日付は設定できません。 */
	public static final String HANDY_CURRENT_DATE_ONLY_ERROR = "handyCurrentDateOnlyError";
	/** 個体番号未登録エラー */
	public static final String HANDY_ID_MANAG_NO_UNREGISTERED_ERROR = "handyIdManagNoUnregisteredError";
	/** 個体番号エラー */
	public static final String HANDY_ID_MANAG_NO_ERROR = "handyIdManagNoError";
	/** ソースCDが商品マスタに存在しません。 */
	public static final String JAN_CD_NOT_FOUND_ERROR = "janCdNotFoundError";
	/** 製造日管理フラグが存在しません。 */
	public static final String PROD_DT_MANAGE_FLG_NULL_ERROR = "prodDtManageFlgNullError";
	/** ソースCDを入力して下さい。 */
	public static final String JAN_CD_NOT_INPUT_ERROR = "janCdNotInputError";
	/** 商品CD入力後にロット、期限日、製造日入力を行って下さい。 */
	public static final String HANDY_PROD_DT_NOT_ENTERED_ERROR = "handyProdDtNotEnteredError";
	/** 棚卸日を入力して下さい。 */
	public static final String INVENTORY_DATE_NOT_INPUT_ERROR = "inventoryDateNotInputError";
	/** 医療用管理フラグを入力して下さい。 */
	public static final String MEDICAL_MANAG_FLG_NOT_INPUT_ERROR = "medicalManagFlgNotInputError";
	/** 医療用管理フラグが存在しません。 */
	public static final String MEDICAL_MANAG_FLG_NULL_ERROR = "medicalManagFlgNullError";
	/** 製造日管理フラグを入力して下さい。 */
	public static final String PROD_DT_MANAG_FLG_NOT_INPUT_ERROR = "prodDtManagFlgNotInputError";
	/** 入荷製造日限界日数は整数5桁以内を入力して下さい。 */
	public static final String RECEIVE_PROD_DT_LIMIT_DAYS_LENGTH_CHECK_MAX_ERROR = "receiveProdDtLimitDaysLengthCheckMaxError";
	/** 入荷製造日限界日数に小数は入力できません。 */
	public static final String RECEIVE_PROD_DT_LIMIT_DAYS_CANNOT_ENTER_DECIMAL_ERROR = "receiveProdDtLimitDaysCannotEnterDecimalError";
	/** 入荷製造日限界日数は最小0以上を入力して下さい。 */
	public static final String RECEIVE_PROD_DT_LIMIT_DAYS_CHECK_MIN_ERROR = "receiveProdDtLimitDaysCheckMinError";
	/** 出荷製造日限界日数は整数5桁以内を入力して下さい。 */
	public static final String SHIP_PROD_DT_LIMIT_DAYS_LENGTH_CHECK_MAX_ERROR = "shipProdDtLimitDaysLengthCheckMaxError";
	/** 出荷製造日限界日数に小数は入力できません。 */
	public static final String SHIP_PROD_DT_LIMIT_DAYS_CANNOT_ENTER_DECIMAL_ERROR = "shipProdDtLimitDaysCannotEnterDecimalError";
	/** 出荷製造日限界日数は最小0以上を入力して下さい。 */
	public static final String SHIP_PROD_DT_LIMIT_DAYS_MIN_ERROR = "shipProdDtLimitDaysMinError";
	/** 荷揃処理10足用足数は整数2桁以内を入力して下さい。 */
	public static final String NIZOROE10_NUM_LENGTH_CHECK_MAX_ERROR = "nizoroe10NumLengthCheckMaxError";
	/** 荷揃処理10足用足数に小数は入力できません。 */
	public static final String NIZOROE10_NUM_CANNOT_ENTER_DECIMAL_ERROR = "nizoroe10NumCannotEnterDecimalError";
	/** 荷揃処理10足用足数は最小0以上を入力して下さい。 */
	public static final String NIZOROE10_NUM_CHECK_MIN_ERROR = "nizoroe10NumCheckMinError";
	/** シリアル管理フラグを入力して下さい。 */
	public static final String SERIAL_MANAGE_FLG_NOT_ENTERED_ERROR = "serialManageFlgNotEnteredError";
	/** シリアル管理フラグが存在しません。 */
	public static final String SERIAL_MANAGE_FLG_NULL_ERROR = "serialManageFlgNullError";
	/** 物流特殊区分を入力して下さい。 */
	public static final String LOGI_SPECIAL_TYPE_CD_NOT_ENTERED_ERROR = "logiSpecialTypeCdNotEnteredError";
	/** 物流特殊区分が存在しません。 */
	public static final String LOGI_SPECIAL_TYPE_CD_NULL_ERROR = "logiSpecialTypeCdNullError";
	/** OCR日付形式を入力して下さい。 */
	public static final String OCR_DATE_FORMAT_NOT_ENTERED_ERROR = "ocrDateFormatNotEnteredError";
	/** OCR日付形式が存在しません。 */
	public static final String OCR_DATE_FORMAT_NULL_ERROR = "ocrDateFormatNullError";
	/** 大物取扱フラグはセンタに1つしか設定できません */
	public static final String LARGE_ITEM_HANDLING_FLG_AT_CENTER_ERROR = "largeItemHandlingFlgAtCenterError";
	/** 重量取扱フラグはセンタに1つしか設定できません */
	public static final String HEAVY_ITEM_HANDLING_FLG_AT_CENTER_ERROR = "heavyItemHandlingFlgAtCenterError";
	/** 棚出し数が在庫数を超えています。 */
	public static final String HANDY_STORED_NUM_EXCEEDS_STOCK_NUM_ERROR = "handyStoredNumExceedsStockNumError";
	/** 棚入れ数が棚出し数を超えています。 */
	public static final String HANDY_STORED_NUM_EXCEEDS_PICKED_NUM_ERROR = "handyStoredNumExceedsPickedNumError";
	/** 荷揃番号を入力して下さい。 */
	public static final String HANDY_NIZOROE_NO_NOT_ENTERED_ERROR = "handyNizoroeNoNotEnteredError";
	/** ｽｷｬﾝ内容不一致 ｽｷｬﾝしたﾊﾞｰｺｰﾄﾞが正しいか確認して下さい。 */
	public static final String HANDY_SCANNED_BARCODE_UNMATCH_ERROR = "handyScannedBarcodeUnmatchError";
	/** 検品数が指示数を超えています。 */
	public static final String HANDY_INSPECTION_NUM_EXCEED_INST_NUM_ERROR = "handyInspectionNumExceedInstNumError";
	/** 選択内容不一致 選択した商品が正しいか確認して下さい。 */
	public static final String HANDY_SELECTED_PRODUCT_UNMATCH_ERROR = "handySelectedProductUnmatchError";
	/** ここまで入力したデータが、全て削除されますが、よろしいですか。 */
	public static final String HANDY_ENTERED_DATA_ALL_DELETE_WARNING = "handyEnteredDataAllDeleteWarning";
	/** ピッキング作業途中ですが、強制完了しますか。 */
	public static final String HANDY_WORK_FORCE_COMPLETE_WARNING = "handyWorkForceCompleteWarning";
	/** 作業を強制完了しました。 */
	public static final String HANDY_WORK_FORCE_COMPLETED_INFORMATION = "handyWorkForceCompletedInformation";
	/** 中断をしても、よろしいですか。 */
	public static final String HANDY_WORK_SUSPEND_WARNING = "handyWorkSuspendWarning";
	/** 作業を中断しました。 */
	public static final String HANDY_WORK_SUSPENDED_INFORMATION = "handyWorkSuspendedInformation";
	/** オーダーピッキング再開します。 */
	public static final String HANDY_RESUME_ORDER_PICKING_INFORMATION = "handyResumeOrderPickingInformation";
	/** 代表荷揃番号を入力して下さい。 */
	public static final String HANDY_DAIHYO_NIZOROE_NO_NOT_ENTERED_ERROR = "handyDaihyoNizoroeNoNotEnteredError";
	/** 既にピッキング済のデータです。 */
	public static final String HANDY_ALREADY_PICKED_DATA_ERROR = "handyAlreadyPickedDataError";
	/** ケース入数を入力して下さい。 */
	public static final String HANDY_CASE_UNIT_NUM_NOT_ENTERED_ERROR = "handyCaseUnitNumNotEnteredError";
	/** ケースを入力して下さい。 */
	public static final String HANDY_CASE_NUM_NOT_ENTERED_ERROR = "handyCaseNumNotEnteredError";
	/** ユーザCDが入力されていません。 */
	public static final String USER_CD_NOT_INPUT_ERROR = "userCdNotInputError";
	/** ユーザCDが存在しません。 */
	public static final String USER_CD_NULL_ERROR = "userCdNullError";
	/** 発注伝票番号を入力して下さい。 */
	public static final String ORDER_SLIP_NUM_NOT_ENTERED_ERROR = "orderSlipNumNotEnteredError";
	/** ソースCD/商品CDを入力して下さい。 */
	public static final String SOURCE_CD_OR_PRODUCT_CD_NOT_ENTERED_ERROR = "sourceCdOrProductCdNotEnteredError";
	/** 対象商品は入荷済です。 */
	public static final String TARGET_PRODUCT_ALREADY_RECEIVED_ERROR = "targetProductAlreadyReceivedError";
	/** 商品CD入力後にロット、期限日、製造日入力を行って下さい。 */
	public static final String LOT_LIMIT_DT_PROD_DT_NOT_ENTERED_ERROR = "lotLimitDtProdDtNotEnteredError";
	/** 明細行を選択して下さい。 */
	public static final String DETAIL_ROW_NOT_SELECTED_ERROR = "detailRowNotSelectedError";
	/** 商品CD入力後に数量入力を行って下さい。 */
	public static final String QTY_NOT_ENTERED_ERROR = "qtyNotEnteredError";
	/** この商品はロット管理品です。ロットを入力して下さい。 */
	public static final String LOT_MANAGE_PRODUCT_LOT_NOT_ENTERED_ERROR = "lotManageProductLotNotEnteredError";
	/** この商品は期限日管理品です。期限日を入力して下さい。 */
	public static final String LIMIT_DT_MANAGE_PRODUCT_LIMIT_DT_NOT_ENTERED_ERROR = "limitDtManageProductLimitDtNotEnteredError";
	/** この商品は製造日管理品です。製造日を入力して下さい。 */
	public static final String PROD_DT_MANAGE_PRODUCT_PROD_DT_NOT_ENTERED_ERROR = "prodDtManageProductProdDtNotEnteredError";
	/** 入庫しますか？ */
	public static final String STORE_COMFIRMATION = "storeComfirmation";
	/** 本伝票は更新されています。 */
	public static final String SLIP_UPDATED_ERROR = "slipUpdatedError";
	/** 期限日が過ぎています。登録しますか？ */
	public static final String LIMIT_DT_EXPIRED_WARNING = "limitDtExpiredWarning";
	/** 製造日が過ぎています。登録しますか？ */
	public static final String PROD_DT_EXPIRED_WARNING = "prodDtExpiredWarning";
	/** 入庫が完了しました。 */
	public static final String STORE_COMPLETE_INFORMATION = "storeCompleteInformation";
	/** ラベル印刷を行いますか？ */
	public static final String LABEL_PRINT_COMFIRMATION = "labelPrintComfirmation";
	/** 対象を選択して下さい。 */
	public static final String TARGET_NOT_SELECTED_ERROR = "targetNotSelectedError";
	/** 入荷済のみ印刷可能です。 */
	public static final String CANNOT_PRINT_EXCEPT_RECEIVED_ERROR = "cannotPrintExceptReceivedError";
	/** 作業を中断しますか？ */
	public static final String WORK_SUSPEND_COMFIRMATION = "workSuspendComfirmation";
	/** 未入庫データが存在します。強制入庫しますか？ */
	public static final String UN_STORED_DATA_FORCE_STORE_COMFIRMATION = "unStoredDataForceStoreComfirmation";
	/** 全て入庫済です。 */
	public static final String ALL_STORED_ERROR = "allStoredError";
	/** 入庫済処理が完了しました。 */
	public static final String STORE_PROCESS_COMLETED_INFORMATION = "storeProcessComletedInformation";
	/** 製造日が日付不正（形式：YYYYMMDD） */
	public static final String PROD_DT_INVALID_DATE_FORMAT_ERROR = "prodDtInvalidDateFormatError";
	/** 入荷時入数を入力して下さい。 */
	public static final String RECEIVE_UNIT_NUM_NOT_ENTERED_ERROR = "receiveUnitNumNotEnteredError";
	/** ケース数を入力して下さい。 */
	public static final String CASE_NUM_NOT_ENTERED_ERROR = "caseNumNotEnteredError";
	/** バラ数を入力して下さい。 */
	public static final String PIECE_NUM_NOT_ENTERED_ERROR = "pieceNumNotEnteredError";
	/** ロケーション補充商品マスタに登録されています。 */
	public static final String HANDY_LOCATION_REPLENISH_PRODUCT_MASTER_REGISTERED_ERROR = "handyLocationReplenishProductMasterRegisteredError";
	/** 未入荷の入荷予定は入荷実績入力ができません。 */
	public static final String UNWORK_RECEIVE_INST_CANNOT_INPUT_RECEIVE_RESULT_ERROR = "unworkReceiveInstCannotInputReceiveResultError";
	/** 他ロケーション在庫がありません。 */
	public static final String OTHER_LOCATION_STOCK_NOT_FOUND_ERROR = "otherLocationStockNotFoundError";
	/** ユーザCDを入力して下さい。 */
	public static final String USER_CD_NOT_INPUT_ERROR2 = "userCdNotInputError2";
	/** 伝票Noを入力して下さい。 */
	public static final String SLIP_NO_NOT_INPUT_ERROR = "slipNoNotInputError";
	/** スキャン内容不一致   スキャンしたバーコードが正しいか確認して下さい。 */
	public static final String SCANNED_BARCODE_UNMATCH_ERROR = "scannedBarcodeUnmatchError";
	/** 商品CDを入力または明細行を選択し「ロット、期限日、製造日入力」を行って下さい。 */
	public static final String INPUT_PRODUCT_CD_OR_SELECT_LINE_TO_ENTER_LOT_LIMIT_DT_PROD_DT_ERROR = "inputProductCdOrSelectLineToEnterLotLimitDtProdDtError";
	/** 出庫ロケを入力して下さい。 */
	public static final String PICKING_LOCATION_NOT_INPUT_ERROR = "pickingLocationNotInputError";
	/** 入庫ロケを入力して下さい。 */
	public static final String STORE_LOCATION_NOT_INPUT_ERROR = "storeLocationNotInputError";
	/** プラントが選択されていません。 */
	public static final String PLANT_CD_NOT_SELECTED_ERROR = "plantCdNotSelectedError";
	/** このロケーションにはｽｷｬﾝしたｿｰｽCDの商品の在庫データがありませんが、棚卸実績に登録しますか？ */
	public static final String SCANNED_SOURCE_CD_PRODUCT_STOCK_NOT_IN_LOCATION_WARNING = "scannedSourceCdProductStockNotInLocationWarning";
	/** 数量が正しくありません。 */
	public static final String HANDY_NUM_INCORECT_ERROR = "handyNumIncorectError";
	/** 棚卸数がマイナスになるため、入力できません。 */
	public static final String HANDY_INVENTORY_NUM_MINUS_ERROR = "handyInventoryNumMinusError";
	/** このロケーションにはｽｷｬﾝした期限日の商品の在庫データがありませんが、棚卸実績に登録しますか？ */
	public static final String SCANNED_LIMIT_DT_PRODUCT_STOCK_NOT_IN_LOCATION_WARNING = "scannedLimitDtProductStockNotInLocationWarning";
	/** このロケーションにはｽｷｬﾝした製造日の商品の在庫データがありませんが、棚卸実績に登録しますか？ */
	public static final String SCANNED_PROD_DT_PRODUCT_STOCK_NOT_IN_LOCATION_WARNING = "scannedProdDtProductStockNotInLocationWarning";
	/** このロケーションにはｽｷｬﾝしたロットの商品の在庫データがありませんが、棚卸実績に登録しますか？ */
	public static final String SCANNED_LOT_PRODUCT_STOCK_NOT_IN_LOCATION_WARNING = "scannedLotProductStockNotInLocationWarning";
	/** スキャンした期限日が指示の期限日と不一致です。同じ期限日を入力して下さい。 */
	public static final String SCANNED_LIMIT_DT_UNMATCH_ERROR = "scannedLimitDtUnmatchError";
	/** スキャンした製造日が指示の製造日と不一致です。同じ製造日を入力して下さい。 */
	public static final String SCANNED_PROD_DT_UNMATCH_ERROR = "scannedProdDtUnmatchError";
	/** スキャンしたロットが指示のロットと不一致です。同じロットを入力して下さい。 */
	public static final String SCANNED_LOT_UNMATCH_ERROR = "scannedLotUnmatchError";
	/** 商品CDを入力または明細行を選択し「数量入力」を行って下さい。 */
	public static final String INPUT_PRODUCT_CD_OR_SELECT_LINE_TO_ENTER_NUM_ERROR = "inputProductCdOrSelectLineToEnterNumError";
	/** 検品数が0です。登録できません。 */
	public static final String INSPECTION_NUM_ZERO_ERROR = "inspectionNumZeroError";
	/** ピースを入力して下さい。 */
	public static final String PIECE_NUM_NOT_INPUT_ERROR2 = "pieceNumNotInputError2";
	/** 仮ロケーションは入庫仮ロケーションを入力して下さい。 */
	public static final String TEMP_LOCATION_CHECK_NOT_STORE_TEMP_LOCATION_ERROR = "tempLocationCheckNotStoreTempLocationError";
	/** 格納ロケーションを入力して下さい。 */
	public static final String STORE_LOCATION_NOT_ENTERED_ERROR = "storeLocationNotEnteredError";
	/** 格納ロケーションがロケーションマスタに存在しません。 */
	public static final String STORE_LOCATION_NOT_FOUND_IN_MASTER_ERROR = "storeLocationNotFoundInMasterError";
	/** 格納ロケーションは通常ロケーションを入力して下さい。 */
	public static final String STORE_LOCATION_CHECK_NOT_NORMAL_LOCATION_ERROR = "storeLocationCheckNotNormalLocationError";
	/** 対象商品は入庫済です。 */
	public static final String TARGET_PRODUCT_ALREADY_STORED_ERROR = "targetProductAlreadyStoredError";
	/** 入庫数が0です。登録できません。 */
	public static final String STORE_NUM_ZERO_ERROR = "storeNumZeroError";
	/** 選択した期限日が作業中の商品の期限日と不一致です。同じ期限日を入力して下さい。 */
	public static final String SELECTED_LIMIT_DT_UNMATCH_ERROR = "selectedLimitDtUnmatchError";
	/** 選択した製造日が作業中の商品の製造日と不一致です。同じ製造日を入力して下さい。 */
	public static final String SELECTED_PROD_DT_UNMATCH_ERROR = "selectedProdDtUnmatchError";
	/** 選択したロットが作業中の商品のロットと不一致です。同じロットを入力して下さい。 */
	public static final String SELECTED_LOT_UNMATCH_ERROR = "selectedLotUnmatchError";
	/** スキャンしたロケーションに在庫が存在しません。 */
	public static final String HANDY_NO_STOCK_IN_SCANNED_LOCATION_ERROR = "handyNoStockInScannedLocationError";
	/** スキャンした商品の在庫がロケーションに存在しません。 */
	public static final String HANDY_NO_SCANNED_PRODUCT_STOCK_IN_LOCATION_ERROR = "handyNoScannedProductStockInLocationError";
	/** 商品の在庫がロケーションに存在しません。 */
	public static final String NO_PRODUCT_STOCKIN_LOCATION_ERROR = "noProductStockinLocationError";
	/** 選択した商品の在庫がロケーションに存在しません。 */
	public static final String NO_SELECTED_PRODUCT_STOCK_IN_LOCATION_ERROR = "noSelectedProductStockInLocationError";
	/** スキャンした商品の在庫が存在しません。 */
	public static final String NO_SCANNED_PRODUCT_STOCK_ERROR = "noScannedProductStockError";
	/** 棚出し数を入力して下さい。 */
	public static final String HANDY_PICKING_NUM_NOT_ENTERED_ERROR = "handyPickingNumNotEnteredError";
	/** 棚入れ数を入力して下さい。 */
	public static final String HANDY_STORE_NUM_NOT_ENTERED_ERROR = "handyStoreNumNotEnteredError";
	/** スキャンしたロットの在庫がロケーションに存在しません。 */
	public static final String HANDY_NO_SCANNED_LOT_STOCK_IN_LOCATION_ERROR = "handyNoScannedLotStockInLocationError";
	/** スキャンした期限日の在庫がロケーションに存在しません。 */
	public static final String HANDY_NO_SCANNED_LIMIT_DT_STOCK_IN_LOCATION_ERROR = "handyNoScannedLimitDtStockInLocationError";
	/** スキャンした製造日の在庫がロケーションに存在しません。 */
	public static final String HANDY_NO_SCANNED_PROD_DT_STOCK_IN_LOCATION_ERROR = "handyNoScannedProdDtStockInLocationError";
	/** スキャンしたロットの在庫が棚出しされていません。 */
	public static final String HANDY_SCANNED_LOT_STOCK_IS_NOT_PICKED_ERROR = "handyScannedLotStockIsNotPickedError";
	/** スキャンした期限日の在庫が棚出しされていません。 */
	public static final String HANDY_SCANNED_LIMIT_DT_STOCK_IS_NOT_PICKED_ERROR = "handyScannedLimitDtStockIsNotPickedError";
	/** スキャンした製造日の在庫が棚出しされていません。 */
	public static final String HANDY_SCANNED_PROD_DT_STOCK_IS_NOT_PICKED_ERROR = "handyScannedProdDtStockIsNotPickedError";
	/** 同時に作業可能な荷揃番号は[0]件以下です。 */
	public static final String HANDY_NIZOROE_NO_CAN_WORK_AT_ONCE_ERROR = "handyNizoroeNoCanWorkAtOnceError";
	/** ピッキング済数が指示数を超えています。 */
	public static final String HANDY_PICKED_NUM_EXCEEDS_INST_NUM_ERROR = "handyPickedNumExceedsInstNumError";
	/** ロット割れ禁止の商品です。同じロットを入力して下さい。 */
	public static final String HANDY_MIXED_LOT_PROHIBITED_PRODUCT_ERROR = "handyMixedLotProhibitedProductError";
	/** 期限日割れ禁止の商品です。同じ期限日を入力して下さい。 */
	public static final String HANDY_MIXED_LIMIT_DT_PROHIBITED_PRODUCT_ERROR = "handyMixedLimitDtProhibitedProductError";
	/** 製造日割れ禁止の商品です。同じ製造日を入力して下さい。 */
	public static final String HANDY_MIXED_PROD_DT_PROHIBITED_PRODUCT_ERROR = "handyMixedProdDtProhibitedProductError";
	/** スキャンした商品の棚出しがされていません。 */
	public static final String HANDY_SCANNED_PRODUCT_IS_NOT_PICKED_ERROR = "handyScannedProductIsNotPickedError";
	/** スキャンした入荷ラベルNo.が既にスキャンされています。 */
	public static final String HANDY_SCANNED_RECEIVE_LABEL_NO_ALREADY_SCANNED_ERROR = "handyScannedReceiveLabelNoAlreadyScannedError";
	/** 棚卸するロケーションが正しいか再確認して下さい。このまま続けますか？ */
	public static final String INVENTORY_LOCATION_CHECK_COMFIRMATION = "inventoryLocationCheckComfirmation";
	/** ｽｷｬﾝした入荷ラベルの商品が存在しません。 */
	public static final String HANDY_ENTERED_RECEIVE_LABEL_PRODUCT_NOT_FOUND_ERROR = "handyEnteredReceiveLabelProductNotFoundError";
	/** 預り商品マスタに存在しません。 */
	public static final String NOT_FOUND_IN_DEPOSIT_PRODUCT_MASTER_ERROR = "notFoundInDepositProductMasterError";
	/** ｽｷｬﾝしたロットの棚出しがされていません。 */
	public static final String HANDY_SCANNED_LOT_NOT_PICKED_ERROR = "handyScannedLotNotPickedError";
	/** ｽｷｬﾝした期限日の棚出しがされていません。 */
	public static final String HANDY_SCANNED_LIMIT_DT_NOT_PICKED_ERROR = "handyScannedLimitDtNotPickedError";
	/** ｽｷｬﾝした製造日の棚出しがされていません。 */
	public static final String HANDY_SCANNED_PROD_DT_NOT_PICKED_ERROR = "handyScannedProdDtNotPickedError";
	/** 対象の送り状番号が削除されました。 */
	public static final String HANDY_INVOICE_NO_DELETED_ERROR = "handyInvoiceNoDeletedError";
	/** ケース入数が指示数を超えています。 */
	public static final String HANDY_CASE_UNIT_NUM_EXCEEDS_INST_NUM_ERROR = "handyCaseUnitNumExceedsInstNumError";
	/** ケース入数が未入力です。 */
	public static final String HANDY_CASE_UNIT_NUM_NOT_ENTERED_ERROR2 = "handyCaseUnitNumNotEnteredError2";
	/** 対象の送り状番号は検品済です。 */
	public static final String TARGET_INVOICE_NO_ALREADY_INSPECTED_ERROR = "targetInvoiceNoAlreadyInspectedError";
	/** 対象の送り状番号はすべて検品済です。 */
	public static final String TARGET_INVOICE_NO_ALREADY_INSPECTED_ALL_ERROR = "targetInvoiceNoAlreadyInspectedAllError";
	/** 対象の送り状番号は強制確定済です。 */
	public static final String TARGET_INVOICE_NO_FORCE_COMPLETED_ERROR = "targetInvoiceNoForceCompletedError";
	/** 個体管理番号未登録エラー！該当する番号が存在しません。 */
	public static final String HANDY_ID_MANAG_NO_NOT_FOUND_ERROR = "handyIdManagNoNotFoundError";
	/** 個体管理番号エラー！該当の番号は返却できません。 */
	public static final String HANDY_ID_MANAG_NO_CAN_NOT_RETURN_ERROR = "handyIdManagNoCanNotReturnError";
	/** 個別貼付ラベルNoを入力して下さい。 */
	public static final String INDV_LABEL_NO_BARCODE_NOT_ENTERED_ERROR = "indvLabelNoBarcodeNotEnteredError";
	/** 該当データは既に処理済です。 */
	public static final String HANDY_TARGET_DATA_ALREADY_PROCESSED_ERROR = "handyTargetDataAlreadyProcessedError";
	/** 個別仕分ﾊﾞｰｺｰﾄﾞが商品の情報と不一致です。 */
	public static final String HANDY_INDV_LABEL_NO_BARCODE_AND_PRODUCT_INFORMATION_UNMATCH_ERROR = "handyIndvLabelNoBarcodeAndProductInformationUnmatchError";
	/** 個体管理番号を入力して下さい。 */
	public static final String HANDY_ID_MANAG_NO_NOT_INPUT_ERROR = "handyIdManagNoNotInputError";
	/** 個体管理番号に誤りがあります。 */
	public static final String HANDY_WRONG_ID_MANAG_NO_ERROR = "handyWrongIdManagNoError";
	/** 同じ個体管理番号が既に登録済です。 */
	public static final String HANDY_ID_MANAG_NO_DUPLICATE_ERROR = "handyIdManagNoDuplicateError";
	/** 配達指定日を入力して下さい。 */
	public static final String SPECIFY_DELIVERY_DT_NOT_ENTERED_ERROR = "specifyDeliveryDtNotEnteredError";
	/** 出庫指示済またはピッキング済以外の出庫指示に対して、運送業者変更はできません。 */
	public static final String CANNOT_CHANGE_CARRIER_EXCEPT_INSTRUCTED_OR_PICKED_SHIPPING_INST_ERROR = "cannotChangeCarrierExceptInstructedOrPickedShippingInstError";
	/** 入力されている運送便CDと配達指定日が変更前と同じです。 */
	public static final String DELIVERY_COURSE_CD_SPECIFY_DELIVERY_DT_NO_DIFFERENCE_ERROR = "deliveryCourseCdSpecifyDeliveryDtNoDifferenceError";
	/** 配達指定日は作業日より前の日付に変更できません。 */
	public static final String CANNOT_CHANGE_SPECIFIED_DELIVERY_DT_BEFORE_WORK_DT_ERROR = "cannotChangeSpecifiedDeliveryDtBeforeWorkDtError";
	/** EC受注で指定された運送業者を変更しようとしています。 */
	public static final String CHANGING_CARRIER_SPECIFIED_BY_EC_ORDER_WARNIG = "changingCarrierSpecifiedByEcOrderWarnig";
	/** ピッキング中またはピッキング済以外の出荷指示に対して、ピッキング解除処理を実行できません。 */
	public static final String CANNOT_CANCEL_EXCEPT_PICKING_IN_PROGRESS_OR_PICKED_SHIPPING_INST_ERROR = "cannotCancelExceptPickingInProgressOrPickedShippingInstError";
	/** ピッキング中以外の出荷指示に対して、強制完了承認処理を実行できません。 */
	public static final String CANNOT_FORCE_COMPLETE_APPROVE_EXCEPT_PICKING_IN_PROGRESS_SHIPPING_INST_ERROR = "cannotForceCompleteApproveExceptPickingInProgressShippingInstError";
	/** ピッキング中ですが、解除してよろしいですか。 */
	public static final String PICKING_IN_PROGRESS_CANCEL_COMFIRM_ERROR = "pickingInProgressCancelComfirmError";
	/** 出荷区分「店送り」以外は再印刷することができません。 */
	public static final String CANNOT_REPRINT_EXCEPT_STORE_DELIVERY_ERROR = "cannotReprintExceptStoreDeliveryError";
	/** ロット、期限日、製造日管理対象外です。 */
	public static final String INELIGIBLE_FOR_LOT_LIMIT_DT_PROD_DT_MANAGEMENT_ERROR = "ineligibleForLotLimitDtProdDtManagementError";
	/** 製造日を入力して下さい。 */
	public static final String PROD_DT_NOT_ENTERED_ERROR = "prodDtNotEnteredError";
	/** 検品済のデータがありません。 */
	public static final String NO_INSPECTED_DATA_ERROR = "noInspectedDataError";
	/** 既に箱登録済です。 */
	public static final String BOX_ALREADY_REGISTERED_ERROR = "boxAlreadyRegisteredError";
	/** 出荷検品中断しますか？ */
	public static final String SHIP_INSPECTION_SUSPEND_INFORMATION = "shipInspectionSuspendInformation";
	/** 出荷検品中止しますか？ */
	public static final String SHIP_INSPECTION_CANCEL_INFORMATION = "shipInspectionCancelInformation";
	/** 引き渡し前のデータが含まれています。 */
	public static final String CONTAIN_BEFORE_HAND_OVER_DATA_ERROR = "containBeforeHandOverDataError";
	/** 既に実績が送信されているため、引き渡し確定の解除はできません。 */
	public static final String RESULT_ALREADY_SENT_CANNOT_CANCEL_HAND_OVER_COMFIRM_ERROR = "resultAlreadySentCannotCancelHandOverComfirmError";
	/** 引き渡し済以外の出庫指示に対して、引き渡し確定の解除はできません。 */
	public static final String CANNOT_CANCEL_EXCEPT_HAND_OVER_SHIPPING_INST_ERROR = "cannotCancelExceptHandOverShippingInstError";
	/** 引き渡し済のデータが含まれています。 */
	public static final String CONTAINS_HAND_OVERED_DATA_ERROR = "containsHandOveredDataError";
	/** 検品済以外の出庫指示に対して、引き渡し確定はできません。 */
	public static final String CANNOT_HAND_OVER_COMFIRM_EXCEPT_INSPECTED_SHIPPING_INST_ERROR = "cannotHandOverComfirmExceptInspectedShippingInstError";
	/** 引き渡し済以外のデータが含まれています。 */
	public static final String CONTAINS_NOT_HAND_OVERED_DATA_ERROR = "containsNotHandOveredDataError";
	/** 「ピッキング済」または「出荷検品済」以外の出庫指示に対して、運送業者変更はできません。 */
	public static final String CANNOT_CHANGE_CARRIER_EXCEPT_PICKED_OR_INSPECTED_SHIPPING_INST_ERROR = "cannotChangeCarrierExceptPickedOrInspectedShippingInstError";
	/** 配達指定日は出荷日より前の日付に変更できません。 */
	public static final String CANNOT_CHANGE_SPECIFIED_DELIVERY_DT_BEFORE_SHIPPING_DT_ERROR = "cannotChangeSpecifiedDeliveryDtBeforeShippingDtError";
	/** 出荷検品中以外の出荷指示に対して、出荷検品解除処理を実行できません。 */
	public static final String CANNOT_CANCEL_SHIPPING_INSPECTION_EXCEPT_INSPECTING_IN_PROGRESS_SHIPPING_INST_ERROR = "cannotCancelShippingInspectionExceptInspectingInProgressShippingInstError";
	/** 出荷検品中以外の出荷指示に対して、強制完了承認処理を実行できません。 */
	public static final String CANNOT_FORCE_COMPLETE_APPROVE_EXCEPT_INSPECTING_IN_PROGRESS_SHIPPING_INST_ERROR = "cannotForceCompleteApproveExceptInspectingInProgressShippingInstError";
	/** 出荷検品中ですが、解除してよろしいですか。 */
	public static final String SHIPPINGQ_INSPECTION_IN_PROGRESS_CANCEL_COMFIRM_INFORMATION = "ShippingqInspectionInProgressCancelComfirmInformation";
	/** 強制完了されていない出荷指示に対して、強制完了承認処理を実行できません。 */
	public static final String CANNOT_FORCE_COMPLETE_APPROVE_EXCEPT_FORCE_COMPLETED_SHIPPING_INST_ERROR = "cannotForceCompleteApproveExceptForceCompletedShippingInstError";
	/** 強制完了してよろしいですか。 */
	public static final String FORCE_COMPLETE_COMFIRM_INFORMATION = "forceCompleteComfirmInformation";
	/** 検品数を入力して下さい。 */
	public static final String INSPECTED_NUM_NOT_ENTERED_ERROR = "inspectedNumNotEnteredError";
	/** 都度スキャンの場合は1以下入力可能です。 */
	public static final String EACH_TIME_SCAN_INPUT_MAX_ERROR = "eachTimeScanInputMaxError";
	/** すべて検品済です。 */
	public static final String ALL_INSPECTED_ERROR = "allInspectedError";
	/** 検品中ですが検品確定してよろしいですか？ */
	public static final String INSPECTION_IN_PROGRESS_CONFIRM_ERROR = "inspectionInProgressConfirmError";
	/** 未検品ですが検品確定してよろしいですか？ */
	public static final String UNINSPECTED_COMFIRM_ERROR = "uninspectedComfirmError";
	/** 入荷ラベルを選択して下さい。 */
	public static final String RECEIVE_LABEL_NOT_SELECTED_ERROR = "receiveLabelNotSelectedError";
	/** ピース数を入力して下さい。 */
	public static final String PIECE_NUM_NOT_ENTERED_ERROR2 = "pieceNumNotEnteredError2";
	/** 調整数量は数量より小さい値を入力して下さい。 */
	public static final String ADJUST_NUM_EXCEEDS_NUM_ERROR = "adjustNumExceedsNumError";
	/** 既に棚卸完了しています。棚卸データ作成はできません。 */
	public static final String STOCK_TAKING_ALREADY_FINISHED_CANNOT_MAKE_INVENTORY_DATA_ERROR = "stockTakingAlreadyFinishedCannotMakeInventoryDataError";
	/** 明細を選択して下さい。 */
	public static final String DETAIL_LINE_NOT_SELECT_ERROR = "detailLineNotSelectError";
	/** 既に棚卸一括確定済です。 */
	public static final String STOCK_TAKING_ALREADY_BULK_COMFIRMED_ERROR = "stockTakingAlreadyBulkComfirmedError";
	/** ロットは数値で入力して下さい。 */
	public static final String LOT_CHECK_NUMERIC_ONLY_ERROR = "lotCheckNumericOnlyError";
	/** ロットは1～46桁で入力して下さい。 */
	public static final String LOT_LENGTH_OUT_OF_RANGE_ERROR2 = "lotLengthOutOfRangeError2";
	/** 行が選択されていません。 */
	public static final String ROW_NOT_SELECTED_ERROR = "rowNotSelectedError";
	/** ピックロケーションではありません。 */
	public static final String NOT_PICK_LOCATION_ERROR = "notPickLocationError";
	/** 取引先が取引先マスタに存在しません。 */
	public static final String CUSTOMER_NOT_FOUND_IN_MASTER_ERROR = "customerNotFoundInMasterError";
	/** ロケーションCDがロケーションマスタに存在しません。 */
	public static final String LOCATION_CD_NOT_FOUND_IN_MASTER_ERROR = "locationCdNotFoundInMasterError";
	/** 重複しています。 */
	public static final String DUPLICATE_ERROR = "duplicateError";
	/** 個体番号未登録エラー！該当する番号が存在しません。 */
	public static final String ID_MANAG_NO_NOT_FOUND_ERROR = "idManagNoNotFoundError";
	/** 個体番号エラー！該当の番号は返却できません。 */
	public static final String ID_MANAG_NO_CAN_NOT_RETURN_ERROR = "IdManagNoCanNotReturnError";
	/** 所有者を入力して下さい。 */
	public static final String DEPOSITOR_NOT_ENTERED_ERROR = "depositorNotEnteredError";
	/** 所有者マスタに存在しません。 */
	public static final String DEPOSITOR_NOT_FOUND_IN_CUSTOMER_MASTER_ERROR = "depositorNotFoundInCustomerMasterError";
	/** 緊急補充指示をした商品と不一致です。同じ商品を入力して下さい。 */
	public static final String HANDY_EMERGENCY_REPLENISHMENT_PRODUCT_UNMATCH_ERROR = "handyEmergencyReplenishmentProductUnmatchError";
	/** ｽｷｬﾝした入荷ラベルの在庫が外部倉庫のロケーションに存在しません。 */
	public static final String STOCK_NOT_FOUNDIN_EXTERNAL_WH_LOCATION_ERROR = "stockNotFoundinExternalWhLocationError";
	/** ｽｷｬﾝした期限日が指示の期限日と不一致です。ﾋﾟｯｷﾝｸﾞしますか。 */
	public static final String HANDY_SCANNED_LIMIT_DT_UNMATCH_CONFIRMATION = "handyScannedLimitDtUnmatchConfirmation";
	/** ｽｷｬﾝした期限日が指示の期限日と不一致です。同じ期限日を入力して下さい。 */
	public static final String HANDY_SCANNED_LIMIT_DT_UNMATCH_ERROR = "handyScannedLimitDtUnmatchError";
	/** ｽｷｬﾝした製造日が指示の製造日と不一致です。ﾋﾟｯｷﾝｸﾞしますか。 */
	public static final String HANDY_SCANNED_PROD_DT_UNMATCH_CONFIRMATION = "handyScannedProdDtUnmatchConfirmation";
	/** ｽｷｬﾝした製造日が指示の製造日と不一致です。同じ製造日を入力して下さい。 */
	public static final String HANDY_SCANNED_PROD_DT_UNMATCH_ERROR = "handyScannedProdDtUnmatchError";
	/** ｽｷｬﾝしたロットが指示のロットと不一致です。ﾋﾟｯｷﾝｸﾞしますか。 */
	public static final String HANDY_SCANNED_LOT_UNMATCH_CONFIRMATION = "handyScannedLotUnmatchConfirmation";
	/** ｽｷｬﾝしたロットが指示のロットと不一致です。同じロットを入力して下さい。 */
	public static final String HANDY_SCANNED_LOT_UNMATCH_ERROR = "handyScannedLotUnmatchError";
	/** 製造日が過ぎています。ﾋﾟｯｷﾝｸﾞしますか。 */
	public static final String HANDY_PRODUCTION_DT_EXPIRED_CONFIRMATION = "handyProductionDtExpiredConfirmation";
	/** 製造日が割れている商品です。ﾋﾟｯｷﾝｸﾞしますか。 */
	public static final String HANDY_PRODUCTION_DT_SPLITTED_CONFIRMATION = "handyProductionDtSplittedConfirmation";
	/** ロットが割れている商品です。ﾋﾟｯｷﾝｸﾞしますか。 */
	public static final String HANDY_LOT_SPLITTED_CONFIRMATION = "handyLotSplittedConfirmation";
	/** 入力した商品の在庫が緊急補充中ですが、よろしいですか。 */
	public static final String HANDY_INPUT_PRODUCT_EMERGENCY_REPLENISHING_CONFIRMATION = "handyInputProductEmergencyReplenishingConfirmation";
	/** ロットを入力して下さい。 */
	public static final String HANDY_LOT_NOT_INPUT_ERROR = "handyLotNotInputError";
	/** 期限日を入力して下さい。 */
	public static final String HANDY_LIMIT_DT_NOT_INPUT_ERROR = "handyLimitDtNotInputError";
	/** 預りJANCD以外のJANCDは入力できません。預りJANCDを入力して下さい。 */
	public static final String HANDY_CANNOT_IMPUT_EXCEPT_DEPOSIT_JAN_CD_ERROR = "handyCannotImputExceptDepositJanCdError";
	/** すべて検品済です。箱登録して検品完了して下さい。 */
	public static final String ALL_INSPECTED_REGISTER_BOX_TO_FINISH_ERROR = "allInspectedRegisterBoxToFinishError";
	/** 販売組織マスタに存在しません。 */
	public static final String NOT_FOUND_IN_SALES_ORG_MASTER_ERROR = "notFoundInSalesOrgMasterError";
	/** 入庫数が入荷済を超えています。 */
	public static final String STORE_NUM_EXCEEDS_RECEIVED_NUM_ERROR = "storeNumExceedsReceivedNumError";
	/** 運送便CDまたは配達指定日を入力して下さい。 */
	public static final String DELIVERY_COURSE_CD_OR_SPECIFY_DELIVERY_DT_NOT_ENTERED_ERROR = "deliveryCourseCdOrSpecifyDeliveryDtNotEnteredError";
	/** 格納ロケーションは入庫格納ロケーションを入力して下さい。 */
	public static final String STORE_LOCATION_INPUT_ERROR = "storeLocationInputError";
	/** 仮ロケーションがロケーションマスタに存在しません。 */
	public static final String TEMP_LOCATION_NOT_FOUND_IN_MASTER_ERROR = "tempLocationNotFoundInMasterError";
	/** 仮ロケーションを入力して下さい。 */
	public static final String TEMP_LOCATION_NOT_ENTERED_ERROR = "tempLocationNotEnteredError";
	/** 郵便番号が存在しません。 */
	public static final String ZIP_CD_NULL_ERROR = "zipCdNullError";
	/** 販売組織CDが販売組織マスタに存在しません。 */
	public static final String SALES_ORG_CD_NOT_FOUND_IN_MASTER_ERROR = "salesOrgCdNotFoundInMasterError";
	/** 取引先CDが取引先マスタに存在しません。 */
	public static final String CUSTOMER_CD_NOT_FOUND_IN_MASTER_ERROR = "customerCdNotFoundInMasterError";
	/** 出力年月を正しく入力して下さい。 */
	public static final String OUT_YEAR_MONTH_NOT_ENTERED_PROPERLY_ERROR = "outYearMonthNotEnteredProperlyError";
	/** 数量1を入力して下さい。 */
	public static final String QTY1_NOT_ENTERED_ERROR = "qty1NotEnteredError";
	/** 枚数1を入力して下さい。 */
	public static final String NUM_OF_SHEET_NOT_ENTERED_ERROR = "numOfSheetNotEnteredError";
	/** 数量の合計が元の数量と一致しません。 */
	public static final String TOTAL_QTY_UNMATCH_ERROR = "totalQtyUnmatchError";
	/** 荷揃アラームリストなしは発行できません。 */
	public static final String NO_NIZOROE_ALERM_LIST_CANNOT_PRINT_ERROR = "noNizoroeAlermListCannotPrintError";
	/** 入荷済以外の入荷予定は入荷ラベル発行できません。 */
	public static final String RECEIVE_LABEL_CANNOT_OUTPUT_NOT_RECEIVE_COMPLETED_ERROR = "receiveLabelCannotOutputNotReceiveCompletedError";
	/** 格納済以外の入庫データはJANシール発行できません。 */
	public static final String UNFINISHED_STORE_DATA_CANNOT_PRINT_JAN_LABEL_ERROR = "unfinishedStoreDataCannotPrintJanLabelError";
	/** ピッキングパターンがバラピッキング以外は、通常品以外は再発行できません。 */
	public static final String CANNOT_REPRINT_OTHER_THAN_NORMAL_PRODUCT_EXCEPT_PIECE_ORDER_ERROR = "cannotReprintOtherThanNormalProductExceptPieceOrderError";
	/** ピッキングパターンがバラピッキング以外、預り品または、個体管理品以外は再発行できません。 */
	public static final String CANNOT_REPRINT_OTHER_THAN_DEPOSIT_OR_ID_MANAG_PRODUCT_EXCEPT_PIECE_ORDER_ERROR = "cannotReprintOtherThanDepositOrIdManagProductExceptPieceOrderError";
	/** ピッキングパターンがケースピッキング以外、出荷区分が直送、店送り以外は再発行できません。 */
	public static final String CANNOT_REPRINT_OTHER_THAN_DIRECT_OR_STORE_DELIVERY_EXCEPT_CASE_TOTAL_ERROR = "cannotReprintOtherThanDirectOrStoreDeliveryExceptCaseTotalError";
	/** ピッキングパターンがトータルピッキング以外、出荷区分が戸配以外は再発行できません。 */
	public static final String CANNOT_REPRINT_OTHER_THAN_KOHAI_DELIVERY_EXCEPT_PIECE_TOTAL_ERROR = "cannotReprintOtherThanKohaiDeliveryExceptPieceTotalError";
	/** ピッキングパターンがケースピッキング以外、出荷区分が戸配以外は再発行できません。 */
	public static final String CANNOT_REPRINT_OTHER_THAN_KOHAI_DELIVERY_EXCEPT_CASE_TOTAL_ERROR = "cannotReprintOtherThanKohaiDeliveryExceptCaseTotalError";
	/** ピッキングパターンがトータルピッキング以外、出荷区分が直送、店送り以外は再発行できません。 */
	public static final String CANNOT_REPRINT_OTHER_THAN_ACCOUNT_TOTAL_EXCEPT_PIECE_TOTAL_ERROR = "cannotReprintOtherThanAccountTotalExceptPieceTotalError";
	/** 出荷区分が直送、店送り以外は再発行できません。 */
	public static final String CANNOT_REPRINT_EXCEPT_DIRECT_OR_STORE_DELIVERY_ERROR = "cannotReprintExceptDirectOrStoreDeliveryError";
	/** 預り品区分が個体管理品以外は再発行できません。 */
	public static final String CANNOT_REPRINT_EXCEPT_ID_MANG_PRODUCT_ERROR = "cannotReprintExceptIdMangProductError";
	/** EC受注以外はEC納品書は発行できません。 */
	public static final String EC_DELIVERY_SLIP_CANNOT_PRINT_EXCEPT_EC_ORDER_ERROR = "ecDeliverySlipCannotPrintExceptEcOrderError";
	/** ピッキングパターンがバラオーダー以外、出荷区分が直送、店送りで預り品区分が預り品以外または、出荷区分が戸配で預り品区分が通常品でフロア完結区分がフロア完結しないの場合は再発行できません。 */
	public static final String PICKING_PATTERN_CANNOT_REPRINT_ERROR = "pickingPatternCannotReprintError";
	/** 出庫指示済またはピッキング済以外の出荷指示に対して、ピッキング解除処理を実行できません。 */
	public static final String CANNOT_CANCEL_PICKING_EXCEPT_INSTRUCTED_OR_PICKED_SHIPPING_INST_ERROR = "cannotCancelPickingExceptInstructedOrPickedShippingInstError";
	/** 在庫データが存在しません。（プラントCD：[0] , 保管場所：[1]） */
	public static final String STOCK_DATA_NOT_FOUND_ERROR2 = "stockDataNotFoundError2";
	/** ロット、期限日、製造日管理品は、複数商品を同時にスキャンすることはできません。 */
	public static final String CANNOT_SCAN_MULTI_PRODUCT_AT_ONCE_ERROR = "cannotScanMultiProductAtOnceError";
	/** 全て入荷済です。 */
	public static final String ALL_RECEIVED_ERROR = "allReceivedError";
	/** 棚卸データが存在しません。 */
	public static final String HANDY_STOCK_COUNT_DATA_NOT_FOUND_ERROR = "handyStockCountDataNotFoundError";
	/** 入荷済以外の伝票は入荷ラベルを発行できません。 */
	public static final String UNFINISHED_RECEIVE_SLIP_CANNOT_PRINT_RECEIVE_LABEL_ERROR = "unfinishedReceiveSlipCannotPrintReceiveLabelError";
	/** 未入荷の伝票は入荷実績入力ができません。 */
	public static final String UNWORKED_RECEIVE_SLIP_CANNOT_INPUT_RECEIVE_RESULT_ERROR = "unworkedReceiveSlipCannotInputReceiveResultError";
	/** 期限日が割れている商品です。ピッキングしますか。 */
	public static final String HANDY_LIMIT_DT_SPLITTED_CONFIRMATION = "handyLimitDtSplittedConfirmation";
	/** 期限日が過ぎています。ピッキングしますか。 */
	public static final String HANDY_LIMIT_DT_EXCEEDED_CONFIRMATION = "handyLimitDtExceededConfirmation";
	/** ピッキングを開始しているため、作業中止はできません。 */
	public static final String HANDY_CANNOT_CANCEL_PICKING_STARTED_ERROR = "handyCannotCancelPickingStartedError";
	/** 運送業者引き渡し票が発行済でないデータは発行できません。 */
	public static final String CANNOT_PRINT_EXCEPT_CARRIER_HAND_OVER_SLIP_PRINTED_ERROR = "cannotPrintExceptCarrierHandOverSlipPrintedError";
	/** 承認待ち以外の出荷指示に対して、強制完了承認処理を実行できません。 */
	public static final String CANNOT_FORCE_COMPLETE_APPROVE_EXCEPT_WAINTING_APPROVAL_ERROR = "cannotForceCompleteApproveExceptWaintingApprovalError";
	/** ピッキング中の出庫指示に対して出荷検品を開始することはできません。 */
	public static final String CANNOT_START_SHIPPING_INSPECTION_FOR_PICKING_IN_PROGRESS_SHIPPING_INST_ERROR = "cannotStartShippingInspectionForPickingInProgressShippingInstError";
	/** 明細に検品中の商品がありますので、欠品時強制完了処理を実行できません。 */
	public static final String CANNOT_STOCK_OUT_FORCE_COMPLETE_FOR_INSPECTING_IN_PROGRESS_PRODUCT_ERROR = "cannotStockOutForceCompleteForInspectingInProgressProductError";
	/** 品目グループが数字以外です。 */
	public static final String HINMOKU_GROUP_CHECK_NUMERIC_ONLY_ERROR = "hinmokuGroupCheckNumericOnlyError";
	/** 別ユーザがエリア「[0]」で作業しているため、開始できません。 */
	public static final String CANNOT_START_WORK_OTHER_USER_WORKING_IN_AREA0_ERROR = "cannotStartWorkOtherUserWorkingInArea0Error";
	/** 別ユーザがエリア「1」で作業していないため、開始できません。 */
	public static final String CANNOT_START_WORK_OTHER_USER_NOT_WORKING_IN_AREA1_ERROR = "cannotStartWorkOtherUserNotWorkingInArea1Error";
	/** センタを入力して下さい。 */
	public static final String CENTER_NOT_ENTERED_ERROR = "centerNotEnteredError";
	/** 削除を入力して下さい。 */
	...
	/** 電話番号が半角文字以外です。 */
	public static final String ＴEL_NO_CHECK_HALF_WIDTH_ONLY_ERROR = "ｔelNoCheckHalfWidthOnlyError";
	/** FAXが半角文字以外です。 */
	public static final String FAX_CHECK_HALF_WIDTH_ONLY_ERROR = "faxCheckHalfWidthOnlyError";
	/** 摘要の桁数が範囲外です。 */
	public static final String SUMMARY_LENGTH_OUT_OF_RANGE_ERROR = "summaryLengthOutOfRangeError";
	/** ﾋﾟｯｷﾝｸﾞ済数は1以上で入力して下さい。 */
	public static final String HANDY_PICKED_NUM_MUST_GREATER_THEN_ONE = "handyPickedNumMustGreaterThenOne";
	/** 棚卸数が数字以外です。 */
	public static final String INVENTORY_NUM_CHECK_NUMERIC_ONLY_ERROR = "inventoryNumCheckNumericOnlyError";
	/** 棚卸数が桁数が範囲外です。 */
	public static final String INVENTORY_NUM_LENGTH_OUT_OF_RANGE_ERROR = "inventoryNumLengthOutOfRangeError";
	/** この商品は製造日管理対象外です。製造日は入力しないで下さい。 */
	public static final String PROD_DT_CANNOT_INPUT_EXCEPT_PROD_DT_MANAGEMENT_PRODUCT_ERROR = "prodDtCannotInputExceptProdDtManagementProductError";
	/** 検品数が予定数を超えています。 */
	public static final String ＲECEIVE_QTY_OVER_ERROR = "ｒeceiveQtyOverError";
	/** 移動数は1以上を入力して下さい。 */
	public static final String MOVE_QTY_INPUT_REQUEST_MIN_IS_ONE_ERROR = "moveQtyInputRequestMinIsOneError";
	/** 統合取引先CDが取引先マスタに存在しません。 */
	public static final String UNI_CUSTOMER_CD_NOT_FOUND_IN_CUSTOMER_NASTER_ERROR = "uniCustomerCdNotFoundInCustomerNasterError";
	/** [0]データ 作成 件数：[1]件 */
	public static final String DAILY_PROCESS_SECTION_BILING_TABLE_DATA_MAKE = "dailyProcessSectionBilingTableDataMake";
	/** データ登録を完了しました。テーブル:[1]、登録件数:[2] */
	public static final String DAILY_PROCESS_SECTION_BILING_ALL_DATA_MAKE = "dailyProcessSectionBilingAllDataMake";
	/** システム管理日付：[0] 、センタCD：[1] 、手動荷揃判定フラグ[2] */
	public static final String SYSTEM_DT_CENTER_CD_MANUAL_NIZOROE_FLG_INFORMATION = "systemDtCenterCdManualNizoroeFlgInformation";
	/** 欠品発生件数：[0]件 , 正常件数：[出荷指示][1]件 */
	public static final String SHIP_ORDER_STOCK_OUT_CNT_NORMAL_CNT_INFORMATION = "shipOrderStockOutCntNormalCntInformation";
	/** 荷揃処理件数：[出荷指示]{1}件 */
	public static final String SHIP_ORDER_NIZOROE_PROC_CNT_INFORMATION = "shipOrderNizoroeProcCntInformation";
	/** エラー情報：［出荷指示ヘッダID]：[0],[出荷指示ボディID]：[1] */
	public static final String ERROR_SHIP_ORDER_HEAD_ID_SHIP_ORDER_BODY_ID_INFORMATION = "errorShipOrderHeadIdShipOrderBodyIdInformation";
	/** 期限日・管理日チェック除外在庫：在庫ID[0] */
	public static final String LIMIT_DT_CHECK_EXCLUDE_STOCK_ID_INFORMATION = "limitDtCheckExcludeStockIdInformation";
	/** 割れチェック除外在庫：在庫ID[0] */
	public static final String SPLIT_CHECK_EXCLUDE_STOCK_ID_INFORMATION = "splitCheckExcludeStockIdInformation";
	/** ロット出荷停止チェック除外在庫：在庫ID[0] */
	public static final String LOT_SHIP_STOP_CHECK_EXCLUDE_STOCK_ID_INFORMATION = "lotShipStopCheckExcludeStockIdInformation";
	/** 在庫引当にて欠品が発生しました。 */
	public static final String ALLOCATE_STOCK_OUT_INFORMATION = "allocateStockOutInformation";
	/** 荷揃パターンが取得できませんでした。 */
	public static final String CANNOT_GET_NIZOROE_PATTERN_ERROR = "cannotGetNizoroePatternError";
	/** 個体管理情報抽出バッチ処理(WMS) */
	public static final String ID_MANAG_DATA_WMS_OUTPUT_BATCH_PROGRAM_NAME_INFORMATION = "idManagDataWmsOutputBatchProgramNameInformation";
	/** 登録件数：[個体管理情報連携送信テーブル]：[0]件 */
	public static final String ID_MANAG_DATAR_SEND_TABLE_REGISTERED_CNT_INFORMATION = "idManagDatarSendTableRegisteredCntInformation";
	/** 梱包明細情報抽出バッチ処理(WMS) */
	public static final String PACKING_LIST_DATA_WMS_OUTPUT_BATCH_PROGRAM_NAME_INFORMATION = "packingListDataWmsOutputBatchProgramNameInformation";
	/** 登録件数：[梱包明細送信テーブル]：[0]件 */
	public static final String PACKING_LIST_DATA_SEND_TABLE_REGISTERED_CNT_INFORMATION = "packingListDataSendTableRegisteredCntInformation";
	/** 商品マスタ (移動平均単価)受信バッチ処理（WMS） */
	public static final String PRODUCT_PRICE_MASTER_DATA_WMS_INPUT_BATCH_PROGRAM_NAME_INFORMATION = "productPriceMasterDataWmsInputBatchProgramNameInformation";
	/** 販売組織マスタ受信バッチ処理（WMS） */
	public static final String SALES_ORG_MASTER_DATA_WMS_INPUT_BATCH_PROGRAM_NAME_INFORMATION = "salesOrgMasterDataWmsInputBatchProgramNameInformation";
	/** プラント保管場所マスタ受信バッチ処理（WMS） */
	public static final String PLANT_STORAGE_SPACE_MASTER_DATA_WMS_INPUT_BATCH_PROGRAM_NAME_INFORMATION = "plantStorageSpaceMasterDataWmsInputBatchProgramNameInformation";
	/** 受信CD：[0] , 全件洗い替えフラグ：[1] */
	public static final String RECEIVE_CD_REFRESH_FLG_INFORMATION = "receiveCdRefreshFlgInformation";
	/** 入庫伝票番号：[0] , 入庫明細番号：[1] */
	public static final String STORE_SLIP_NO_STORE_SLIP_ROW_NO_INFORMATION = "storeSlipNoStoreSlipRowNoInformation";
	/** 登録件数：[入庫予定][0]件 , [入庫予定明細][1]件 */
	public static final String STORE_PLAN_STORE_PLAN_DTL_REGISTERED_CNT_INFORMATION = "storePlanStorePlanDtlRegisteredCntInformation";
	/** エラー件数：[入庫予定][0]件 , [入庫予定明細][1]件 , 正常件数：[入庫予定][2]件 , [入庫予定明細][3]件 */
	public static final String STORE_PLAN_STORE_PLAN_DTL_ERROR_CNT_NORMAL_CNT_INFORMATION = "storePlanStorePlanDtlErrorCntNormalCntInformation";
	/** 入庫予定受信バッチ処理（WMS） */
	public static final String RECEIVE_PLAN_DATA_WMS_INPUT_BATCH_PROGRAM_NAME_INFORMATION = "receivePlanDataWmsInputBatchProgramNameInformation";
	/** 入庫伝票番号 */
	public static final String STORE_SLIP_NO_INFORMATION = "storeSlipNoInformation";
	/** 入庫明細番号 */
	public static final String STORE_SLIP_ROW_NO_INFORMATION = "storeSlipRowNoInformation";
	/** 伝票種別 */
	public static final String SLIP_TYPE_CD_INFORMATION = "slipTypeCdInformation";
	/** IFID */
	public static final String IF_ID_INFORMATION = "ifIdInformation";
	/** IF用番号 */
	public static final String IF_NO_INFORMATION = "ifNoInformation";
	/** 品目コード */
	public static final String HINMOKU_CD_INFORMATION = "hinmokuCdInformation";
	/** 品目グループ */
	public static final String HINMOKU_GROUP_INFORMATION = "hinmokuGroupInformation";
	/** 3社区分 */
	public static final String SANSHA_TYPE_CD_INFORMATION = "sanshaTypeCdInformation";
	/** 入荷発生事由 */
	public static final String RECEIVE_REASON_CD_INFORMATION = "receiveReasonCdInformation";
	/** 入荷発生事由名称 */
	public static final String RECEIVE_REASON_NM_INFORMATION = "receiveReasonNmInformation";
	/** 取引先コード */
	public static final String CUSTOMER_CD_INFORMATION = "customerCdInformation";
	/** 取引先名称 */
	public static final String CUSTOMER_NM_INFORMATION = "customerNmInformation";
	/** 発注日 */
	public static final String ORDER_DATE_INFORMATION = "orderDateInformation";
	/** 発注時刻 */
	public static final String ORDER_TIME_INFORMATION = "orderTimeInformation";
	/** 確定納期 */
	public static final String CONFIRMED_DELIVERY_DATE_INFORMATION = "confirmedDeliveryDateInformation";
	/** 品目テキスト */
	public static final String HINMOKU_TEXT_INFORMATION = "hinmokuTextInformation";
	/** JANコード */
	public static final String JAN_CD_INFORMATION = "janCdInformation";
	/** 単位名称 */
	public static final String UNIT_NM_INFORMATION = "unitNmInformation";
	/** 入荷予定数量 */
	public static final String RECEIVE_PLAN_NUM_INFORMATION = "receivePlanNumInformation";
	/** 入荷予定残数 */
	public static final String RECEIVE_REMAINING_NUM_INFORMATION = "receiveRemainingNumInformation";
	/** 入庫プラント */
	public static final String STORE_PLANT_CD_INFORMATION = "storePlantCdInformation";
	/** 入庫保管場所 */
	public static final String STORE_STORAGE_SPACE_CD_INFORMATION = "storeStorageSpaceCdInformation";
	/** 出庫プラント */
	public static final String SHIPPING_PLANT_CD_INFORMATION = "shippingPlantCdInformation";
	/** 出庫保管場所 */
	public static final String SHIPPING_STORAGE_SPACE_CD_INFORMATION = "shippingStorageSpaceCdInformation";
	/** ロット管理区分 */
	public static final String LOT_MANAG_TYPE_CD_INFORMATION = "lotManagTypeCdInformation";
	/** 店販社CD */
	public static final String TENHANSHA_CD_INFORMATION = "tenhanshaCdInformation";
	/** 販売組織CD */
	public static final String SALES_ORG_CD_INFORMATION = "salesOrgCdInformation";
	/** 店販社名称1 */
	public static final String TENHANSHA_NM1_INFORMATION = "tenhanshaNm1Information";
	/** 店販社名称2 */
	public static final String TENHANSHA_NM2_INFORMATION = "tenhanshaNm2Information";
	/** SAPユーザコード */
	public static final String SAP_USER_CD_INFORMATION = "sapUserCdInformation";
	/** SAPユーザ名称 */
	public static final String SAP_USER_NM_INFORMATION = "sapUserNmInformation";
	/** 修正区分 */
	public static final String MOD_TYPE_CD_INFORMATION = "modTypeCdInformation";
	/** 預りJANCD */
	public static final String DEPOSIT_JAN_CD_INFORMATION = "depositJanCdInformation";
	/** 回数 */
	public static final String TIMES_NUM_INFORMATION = "timesNumInformation";
	/** 得意先注文番号 */
	public static final String ACCOUNT_ORDER_NO_INFORMATION = "accountOrderNoInformation";
	/** SAP仕入先コード */
	public static final String SAP_SUPPLIER_CD_INFORMATION = "sapSupplierCdInformation";
	/** SAP発注先コード */
	public static final String SAP_VENDER_CD_INFORMATION = "sapVenderCdInformation";
	/** 当日分フラグ */
	public static final String TODAY_FLG_INFORMATION = "todayFlgInformation";
	/** 3社納品書番号1 */
	public static final String SANSHA_DELIVERY_SLIP_NO1_INFORMATION = "sanshaDeliverySlipNo1Information";
	/** データ区分 */
	public static final String DATA_TYPE_CD_INFORMATION = "dataTypeCdInformation";
	/** SAP作成日_年 */
	public static final String SAP_ADD_YYYY_INFORMATION = "sapAddYyyyInformation";
	/** SAP作成日_月 */
	public static final String SAP_ADD_MM_INFORMATION = "sapAddMmInformation";
	/** SAP作成日_日 */
	public static final String SAP_ADD_DD_INFORMATION = "sapAddDdInformation";
	/** SAP作成時間_時 */
	public static final String SAP_ADD_HH_INFORMATION = "sapAddHhInformation";
	/** SAP作成時間_分 */
	public static final String SAP_ADD_MI_INFORMATION = "sapAddMiInformation";
	/** SAP作成時間_秒 */
	public static final String SAP_ADD_SS_INFORMATION = "sapAddSsInformation";
	/** SAP作成者 */
	public static final String SAP_ADD_USER_CD_INFORMATION = "sapAddUserCdInformation";
	/** SAP更新日_年 */
	public static final String SAP_UPD_YYYY_INFORMATION = "sapUpdYyyyInformation";
	/** SAP更新日_月 */
	public static final String SAP_UPD_MM_INFORMATION = "sapUpdMmInformation";
	/** SAP更新日_日 */
	public static final String SAP_UPD_DD_INFORMATION = "sapUpdDdInformation";
	/** SAP更新時間_時 */
	public static final String SAP_UPD_HH_INFORMATION = "sapUpdHhInformation";
	/** SAP更新時間_分 */
	public static final String SAP_UPD_MI_INFORMATION = "sapUpdMiInformation";
	/** SAP更新時間_秒 */
	public static final String SAP_UPD_SS_INFORMATION = "sapUpdSsInformation";
	/** SAP更新者 */
	public static final String SAP_UPD_USER_CD_INFORMATION = "sapUpdUserCdInformation";
	/** 赤黒区分 */
	public static final String DATA_TRANSFER_ONLY_STR01_INFORMATION = "dataTransferOnlyStr01Information";
	/** 代表ロケーション */
	public static final String DATA_TRANSFER_ONLY_STR02_INFORMATION = "dataTransferOnlyStr02Information";
	/** 品名カナ1 */
	public static final String DATA_TRANSFER_ONLY_STR03_INFORMATION = "dataTransferOnlyStr03Information";
	/** 品名カナ2 */
	public static final String DATA_TRANSFER_ONLY_STR04_INFORMATION = "dataTransferOnlyStr04Information";
	/** 摘要 */
	public static final String DATA_TRANSFER_ONLY_STR05_INFORMATION = "dataTransferOnlyStr05Information";
	/** 端末番号 */
	public static final String DATA_TRANSFER_ONLY_STR06_INFORMATION = "dataTransferOnlyStr06Information";
	/** サーバー送信フラグ */
	public static final String DATA_TRANSFER_ONLY_STR07_INFORMATION = "dataTransferOnlyStr07Information";
	/** サーバー宛送信時刻 */
	public static final String DATA_TRANSFER_ONLY_STR08_INFORMATION = "dataTransferOnlyStr08Information";
	/** 3社納品書番号2 */
	public static final String DATA_TRANSFER_ONLY_STR09_INFORMATION = "dataTransferOnlyStr09Information";
	/** 加工品区分 */
	public static final String DATA_TRANSFER_ONLY_STR10_INFORMATION = "dataTransferOnlyStr10Information";
	/** 管理区分 */
	public static final String DATA_TRANSFER_ONLY_STR11_INFORMATION = "dataTransferOnlyStr11Information";
	/** 3社売上日 */
	public static final String DATA_TRANSFER_ONLY_STR12_INFORMATION = "dataTransferOnlyStr12Information";
	/** 仕入単価 */
	public static final String DATA_TRANSFER_ONLY_STR13_INFORMATION = "dataTransferOnlyStr13Information";
	/** 作成日_発注 */
	public static final String DATA_TRANSFER_ONLY_STR14_INFORMATION = "dataTransferOnlyStr14Information";
	/** 作成時間_発注 */
	public static final String DATA_TRANSFER_ONLY_STR15_INFORMATION = "dataTransferOnlyStr15Information";
	/** データ種別 */
	public static final String DATA_TRANSFER_ONLY_STR16_INFORMATION = "dataTransferOnlyStr16Information";
	/** 管理番号 */
	public static final String DATA_TRANSFER_ONLY_STR17_INFORMATION = "dataTransferOnlyStr17Information";
	/** 入力順 */
	public static final String DATA_TRANSFER_ONLY_STR18_INFORMATION = "dataTransferOnlyStr18Information";
	/** 検品残数量 */
	public static final String DATA_TRANSFER_ONLY_STR19_INFORMATION = "dataTransferOnlyStr19Information";
	/** 検品数量 */
	public static final String DATA_TRANSFER_ONLY_STR20_INFORMATION = "dataTransferOnlyStr20Information";
	/** 検品確定区分 */
	public static final String DATA_TRANSFER_ONLY_STR21_INFORMATION = "dataTransferOnlyStr21Information";
	/** 倉庫コード */
	public static final String DATA_TRANSFER_ONLY_STR22_INFORMATION = "dataTransferOnlyStr22Information";
	/** 完了区分 */
	public static final String DATA_TRANSFER_ONLY_STR23_INFORMATION = "dataTransferOnlyStr23Information";
	/** プログラムID */
	public static final String DATA_TRANSFER_ONLY_STR24_INFORMATION = "dataTransferOnlyStr24Information";
	/** JANコード区分 */
	public static final String DATA_TRANSFER_ONLY_STR25_INFORMATION = "dataTransferOnlyStr25Information";
	/** ダミー */
	public static final String DATA_TRANSFER_ONLY_STR26_INFORMATION = "dataTransferOnlyStr26Information";
	/** SAP更新担当者コード */
	public static final String DATA_TRANSFER_ONLY_STR27_INFORMATION = "dataTransferOnlyStr27Information";
	/** SAP削除フラグ */
	public static final String DATA_TRANSFER_ONLY_STR28_INFORMATION = "dataTransferOnlyStr28Information";
	/** 予備 */
	public static final String SPARE_STR_INFORMATION = "spareStrInformation";
	/** 登録件数：[入庫実績]：[0]件 */
	public static final String STORE_RECORD_REGISTERED_CNT_INFORMATION = "storeRecordRegisteredCntInformation";
	/** エラー件数：[入庫実績][0] 件 , 正常件数：[入庫実績][1] 件 */
	public static final String STORE_RECORD_ERROR_CNT_NORMAL_CNT_INFORMATION = "storeRecordErrorCntNormalCntInformation";
	/** 出荷伝票番号：[0] , 出荷明細番号：[1] */
	public static final String SHIPPING_SLIP_NO_SHIPPING_SLIP_ROW_NOT_INFORMATION = "shippingSlipNoShippingSlipRowNotInformation";
	/** 登録件数：[出荷指示]：[0]件 , [出荷指示明細][1]件 */
	public static final String SHIPPING_INST_SHIPPING_INST_DTL_REGISTERED_CNT_INFORMATION = "shippingInstShippingInstDtlRegisteredCntInformation";
	/** エラー件数：[出荷指示][0]件 , [出荷指示明細][1]件 , 正常件数：[出荷指示][2]件 , [出荷指示明細][3]件 */
	public static final String SHIPPING_INST_SHIPPING_INST_DTL_ERROR_CNT_NORMAL_CNT_INFORMATION = "shippingInstShippingInstDtlErrorCntNormalCntInformation";
	/** 登録件数：[出荷実績][0]件 */
	public static final String SHIPPING_RECORD_REGISTERED_CNT_INFORMATION = "shippingRecordRegisteredCntInformation";
	/** エラー件数：[出荷実績][0]件 , 正常件数：[出荷実績][1]件 */
	public static final String SHIPPING_RECORD_ERROR_CNT_NORMAL_CNT_INFORMATION = "shippingRecordErrorCntNormalCntInformation";
	/** 入庫実績抽出バッチ処理(共通管理→S4) */
	public static final String RECEIVE_RECORD_DATA_LMS_S4_OUTPUT_BATCH_PROGRAM_NAME_INFORMATION = "ReceiveRecordDataLmsS4OutputBatchProgramNameInformation";
	/** 登録件数：[出荷予定][0]件 , [出荷予定明細][1]件 */
	public static final String SHIPPING_PLAN_SHIPPING_PLAN_DTL_REGISTERED_CNT_INFORMATION = "shippingPlanShippingPlanDtlRegisteredCntInformation";
	/** 商品マスタ受信バッチ処理（共通管理） */
	public static final String PRODUCT_MASTER_DATA_LMS_INPUT_BATCH_PROGRAM_NAME_INFORMATION = "ProductMasterDataLmsInputBatchProgramNameInformation";
	/** 入荷日に未来日が設定されています。 */
	public static final String RECEIVE_DT_FUTURE_ERROR = "receiveDtFutureError";
	/** 該当棚卸ヘッダが存在しません。 */
	public static final String INVENTORY_HEADER_NOT_FOUND_ERROR = "inventoryHeaderNotFoundError";
	/** 梱包番号が数字以外です。 */
	public static final String PACKING_NO_CHECK_NUMERIC_ONLY_ERROR = "packingNoCheckNumericOnlyError";
	/** 在庫補充アラーム(定期補充)データ作成 */
	public static final String REPLENISH_ALARM_DATA_MAKE_BATCH_PROGRAM_NAME_INFORMATION = "replenishAlarmDataMakeBatchProgramNameInformation";
	/** システム管理日付：[0] , センタ：[1] */
	public static final String SYSTEM_DT_CENTER_INFORMATION = "systemDtCenterInformation";
	/** 在庫補充アラームリスト発行 */
	public static final String REPLENISH_ALARM_LIST_PRINT_BATCH_PROGRAM_NAME_INFORMATION = "replenishAlarmListPrintBatchProgramNameInformation";
	/** 発行帳票：[0] , 出力件数：[1] */
	public static final String PRINTED_LIST_OUTPUT_CNT_INFORMATION = "printedListOutputCntInformation";
	...
	/** 氏名の桁数が範囲外です。 */
	public static final String EMP_NM_LENGTH_OUT_OF_RANGE_ERROR2 = "empNmLengthOutOfRangeError2";
	/** 実地棚卸伝票番号が存在しません。 */
	...
	/** 入力した製造日が入荷限界日を過ぎています。 */
	public static final String INPUT_PROD_DATE_OVER_ERROR = "inputProdDateOverError";
	/** 作業者CDが存在しません。 */
	...
	/** 入荷可能な製造日を過ぎている商品がありますが、このまま続行しても宜しいですか？ */
	public static final String STOCK_RESULT_REGISTER_PRODUCT_DATE_OVER_INFORMATION = "stockResultRegisterProductDateOverInformation";
	/** 入荷ラベル再発行画面から入荷ラベルを発行してください。 */
	public static final String REPRINT_RECEIVE_LABEL_INFORMATION = "reprintReceiveLabelInformation";
	/** ミドリ安全株式会社 */
	public static final String EC_DELIVERY_SLIP_LIST_COMPANY_NM = "EcDeliverySlipListCompanyNm";
	/** 〒124-0001 */
	public static final String EC_DELIVERY_SLIP_LIST_DELIV_ZIP_CD = "EcDeliverySlipListDelivZipCd";
	/** 東京都葛飾区小菅１－１５－１６ */
	public static final String EC_DELIVERY_SLIP_LIST_DELIV_ADDRESS = "EcDeliverySlipListDelivAddress";
	/** Tel　0120-310-355 */
	public static final String EC_DELIVERY_SLIP_LIST_TEL_NO = "EcDeliverySlipListTelNo";
	/** E-Mail　support@midori-anzen.co.jp */
	public static final String EC_DELIVERY_SLIP_LIST_EMAL = "EcDeliverySlipListEmal";
	/** ミドリ安全.comコールセンター　TEL:0120-310-355 */
	public static final String EC_DELIVERY_SLIP_LIS_CONTACT_INFO = "EcDeliverySlipLisContactInfo";
	/** お買い上げありがとうございます。 */
	public static final String EC_DELIVERY_SLIP_LIS_INVITATION_MESSAGE1_1 = "EcDeliverySlipLisInvitationMessage1_1";
	/** 下記の通り、ご注文の商品を納品いたしますので、ご確認願います。 */
	public static final String EC_DELIVERY_SLIP_LIS_INVITATION_MESSAGE1_2 = "EcDeliverySlipLisInvitationMessage1_2";
	/** ※お支払方法が『後払い(コンビニ・銀行・郵便局)』の場合、お振込用紙は */
	public static final String EC_DELIVERY_SLIP_LIS_INVITATION_MESSAGE2_1 = "EcDeliverySlipLisInvitationMessage2_1";
	/** 商品到着後、一週間前後で【ご注文者様の住所へ郵送にてお届けします】。 */
	public static final String EC_DELIVERY_SLIP_LIS_INVITATION_MESSAGE2_2 = "EcDeliverySlipLisInvitationMessage2_2";
	/** ●＊の付く商品は軽減税率の対象です。 */
	public static final String EC_DELIVERY_SLIP_LIS_INVITATION_MESSAGE3 = "EcDeliverySlipLisInvitationMessage3";
	/** ●お支払方法：後払い（コンビニ・銀行・郵便局）　【※振込用紙は別途郵送 */
	public static final String EC_DELIVERY_SLIP_LIS_INVITATION_MESSAGE4 = "EcDeliverySlipLisInvitationMessage4";
	/** ●お買い上げありがとうございます。納品書は大切に保管願います。 */
	public static final String EC_DELIVERY_SLIP_LIS_INVITATION_MESSAGE5 = "EcDeliverySlipLisInvitationMessage5";
	/** ●お問合せにつきましては、下記電話番号までご連絡願います。 */
	public static final String EC_DELIVERY_SLIP_LIS_INVITATION_MESSAGE6 = "EcDeliverySlipLisInvitationMessage6";
	/** 推奨ロケーションCD  英数字と記号のみ */
	public static final String RECOMMEND_LOCATION_CD_CHECK_ALPHABET_AND_NUMERIC_AND_SYMBOL_ONLY_ERROR = "recommendLocationCdCheckAlphabetAndNumericAndSymbolOnlyError";
	/** 推奨ロケーションCDは最大10文字以下を入力して下さい。 */
	public static final String RECOMMEND_LOCATION_CD_CHECK_INPUT_MAX_ERROR = "recommendLocationCdCheckInputMaxError";
	/** ロケーション種別が入庫仮ロケーションです。 */
	public static final String LOCATION_TYPE_STORE_TEMP_LOCATION_ERROR = "locationTypeStoreTempLocationError";
	/** 推奨ロケーション区分が存在しません。 */
	public static final String RECOMMENDED_LOCATION_TYPE_NOT_FOUND_ERROR = "recommendedLocationTypeNotFoundError";
	/** フロア基準在庫は整数5桁以内を入力して下さい。 */
	public static final String FLOOR_REF_STOCK_NUM_CHECK_INPUT_MAX_ERROR = "floorRefStockNumCheckInputMaxError";
	/** フロア基準在庫に小数は入力できません。 */
	public static final String FLOOR_REF_STOCK_NUM_CHECK_INPUT_DECIMAL_ERROR = "floorRefStockNumCheckInputDecimalError";
	/** フロア基準在庫は最小0以上を入力して下さい。 */
	public static final String FLOOR_REF_STOCK_NUM_INPUT_REQUEST_MIN_IS_ZERO_ERROR = "floorRefStockNumInputRequestMinIsZeroError";
	/** フロア基準在庫 数値のみ */
	public static final String FLOOR_REF_STOCK_NUM_CHECK_NUMERIC_ONLY_ERROR = "floorRefStockNumCheckNumericOnlyError";
	/** 入荷製造日限界日数 数値のみ */
	public static final String PROD_DT_LIMIT_DAYS_RCV_CHECK_NUMERIC_ONLY_ERROR = "prodDtLimitDaysRcvCheckNumericOnlyError";
	/** 出荷製造日限界日数 数値のみ */
	public static final String PROD_DT_LIMIT_DAYS_SHP_CHECK_NUMERIC_ONLY_ERROR = "prodDtLimitDaysShpCheckNumericOnlyError";
	/** 商品のお問い合わせ・サイズ交換・返品等につきましては */
	public static final String DIRECT_OR_STORE_DELIVERY_SLIP_LIST_MEESAGE1 = "directOrStoreDeliverySlipListMeesage1";
	/** 上記「取扱部門」にお願い致します。 */
	public static final String DIRECT_OR_STORE_DELIVERY_SLIP_LIST_MEESAGE2 = "directOrStoreDeliverySlipListMeesage2";
	/** 個体管理番号：[/][0][/][/]個体管理番号[/]未登録エラー！[/]該当する番号が[/]存在しません。 */
	public static final String HANDY_ID_MANAG_NO_DISP_NOT_FOUND_ERROR = "handyIdManagNoDispNotFoundError";
	/** 個体管理番号：[/][0][/][/]個体管理番号エラー！[/]該当の番号は[/]返却できません。 */
	public static final String HANDY_ID_MANAG_NO_DISP_CAN_NOT_RETURN_ERROR = "handyIdManagNoDispCanNotReturnError";
	/** 入庫格納 */
	public static final String RECEIVE_STORE_INFORMATION = "receiveStoreInformation";
	/** 出荷検品 */
	public static final String SHIPPING_INSPECT = "shippingInspect";
	/** 入荷検品開始条件 */
	public static final String RECEIVE_INSPECTION_START_CONDITION = "receiveInspectionStartCondition";
	/** 入荷検品 */
	public static final String RECEIVE_INSPECTION = "receiveInspection";
	/** ケース数量入力 */
	public static final String CASE_TITLE = "caseTitle";
	/** バラ数量入力 */
	public static final String PIECE_TITLE = "pieceTitle";
	/** ロット、期限日、製造日入力 */
	public static final String LIMIT_TITLE = "limitTitle";
	/** 対象データを登録しますか？ */
	public static final String DATA_INSERT_CONFIRMATION = "dataInsertConfirmation";
	/** 登録件数：[出荷指示][0]件 */
	public static final String SHIPPING_INST_REGISTERED_CNT_INFORMATION = "shippingInstRegisteredCntInformation";
	/** 登録件数：[出荷予定][0]件 */
	public static final String SHIPPING_PLAN_REGISTERED_CNT_INFORMATION = "shippingPlanRegisteredCntInformation";
	/** エラー件数：[振替][0]件 , 正常件数：[振替][1]件 */
	public static final String TRANSFER_ERROR_CNT_NORMAL_CNT_INFORMATION = "transferErrorCntNormalCntInformation";
	/** 品目コード{1}、在庫移動日：{2}、入庫プラント：{3}、入庫保管場所：{4}、出庫プラント：{5}、出庫保管場所：{6} */
	public static final String TRANSFER_BATCH_PARAMETER_INFORMATION = "transferBatchParameterInformation";
