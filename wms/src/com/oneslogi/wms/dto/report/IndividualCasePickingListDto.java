...
public class IndividualCasePickingListDto extends ReportDto {
	...
	public String getNizoroeOutTime() {
		return nizoroeOutTime;
	}
	public void setNizoroeOutTime(String nizoroeOutTime) {
		this.nizoroeOutTime = nizoroeOutTime;
	}
