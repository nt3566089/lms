...
// 20240508 初回コンパイルを通す為削除 end
	...
	private SlipKey getSlipKey(EShippingInst eShippingInst) {
		// 20240508 初回コンパイルを通す為 ダミー値入れて訂正 start
		//return new SlipKey(eShippingInst.getClientShippingNo(), eShippingInst.getSupplyCustomerCd());
		return new SlipKey(eShippingInst.getEcOrderNo(), eShippingInst.getEcOrderNo());
		// 20240508 初回コンパイルを通す為 ダミー値入れて訂正 end
	}
