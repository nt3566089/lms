...
-- 荷主センタ変更対応 2017.03.28 hdis End
      ...
      -- 個人情報暗号化対応 2016.09.01 kawana Start
-- 20240508 初回コンパイルを通す為削除      ,f_decrypt(SIH.DELIV_CUSTOMER_NM) AS DELIV_CUSTOMER_NM                   -- 届先名称
      -- 個人情報暗号化対応 2016.09.01 kawana End
...
-- 20240508 初回コンパイルを通す為削除    ,SIH.DELIV_CUSTOMER_NM
...
-- 20240508 初回コンパイルを通す為削除      ,AIH.DELIV_CUSTOMER_NM                                                        -- 届先名称
      -- 米国出荷ドキュメント追加対応 2018.01.01 PYM Start
...
-- 荷主センタ変更対応 2017.03.28 hdis End
        ...
        ,AIH.DELIV_CUSTOMER_CD                                                 -- 届先CD
        -- 個人情報暗号化対応 2016.09.01 kawana Start
-- 20240508 初回コンパイルを通す為削除        ,f_decrypt(AIH.DELIV_CUSTOMER_NM) AS DELIV_CUSTOMER_NM                 -- 届先名称
        -- 個人情報暗号化対応 2016.09.01 kawana End
        -- 米国出荷ドキュメント追加対応 2018.01.01 PYM Start
        -- [#2255] MySQLのSQL_MODE変更対応 GROUP BY 未指定列は全てMAX関数で対応 2018.03.14 kawana Start
...
-- 20240508 初回コンパイルを通す為削除      ,AIH.DELIV_CUSTOMER_NM
      ,PIH.PICKING_STATUS
