...
SELECT BODY.INVENTORY_B_ID       AS INVENTORY_B_ID,
        ...
        BUSER_UPD.USER_NM         AS USER_NM_UPD,
        BUSER_UPD.USER_CD         AS USER_CD_UPD,
 ...
 FROM T_INVENTORY_B BODY
          ...
          LEFT OUTER JOIN B_USER BUSER_UPD
                          ON BODY.INVENTORY_UPD_USER_ID = BUSER_UPD.USER_ID
                              AND BUSER_UPD.DEL_FLG = '0'
 ...
 /*END*/
  ...
  /*END*/
   ...
   AND REPORT.STOCK_DIFF_OUT_FLG = '0'     -- 在庫差異確認表出力フラグ
     /*END*/
