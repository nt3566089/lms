...
public abstract class BsMSalesOrgBhv extends AbstractBehaviorWritable<MSalesOrg, MSalesOrgCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">mSalesOrgBhv</span>.<span style="color: #CC4747">loadTShippingInstHBySalesOrgList</span>(<span style="color: #553000">mSalesOrgList</span>, <span style="color: #553000">hCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstH> loadTShippingInstHBySalesOrgList(List<MSalesOrg> mSalesOrgList, ConditionBeanSetupper<TShippingInstHCB> refCBLambda) {
        xassLRArg(mSalesOrgList, refCBLambda);
        return doLoadTShippingInstHBySalesOrgList(mSalesOrgList, new LoadReferrerOption<TShippingInstHCB, TShippingInstH>().xinit(refCBLambda));
    }
     ...
     * t_shipping_inst_h by SALES_ORG_CD, named 'TShippingInstHBySalesOrgList'.
     * <pre>
     * <span style="color: #0000C0">mSalesOrgBhv</span>.<span style="color: #CC4747">loadTShippingInstHBySalesOrgList</span>(<span style="color: #553000">mSalesOrg</span>, <span style="color: #553000">hCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">hCB</span>.setupSelect...
     *     <span style="color: #553000">hCB</span>.query().set...
     *     <span style="color: #553000">hCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mSalesOrg</span>.<span style="color: #CC4747">getTShippingInstHBySalesOrgList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstH> loadTShippingInstHBySalesOrgList(MSalesOrg mSalesOrg, ConditionBeanSetupper<TShippingInstHCB> refCBLambda) {
        xassLRArg(mSalesOrg, refCBLambda);
        return doLoadTShippingInstHBySalesOrgList(xnewLRLs(mSalesOrg), new LoadReferrerOption<TShippingInstHCB, TShippingInstH>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstH> loadTShippingInstHBySalesOrgList(MSalesOrg mSalesOrg, LoadReferrerOption<TShippingInstHCB, TShippingInstH> loadReferrerOption) {
        xassLRArg(mSalesOrg, loadReferrerOption);
        return loadTShippingInstHBySalesOrgList(xnewLRLs(mSalesOrg), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TShippingInstH> loadTShippingInstHBySalesOrgList(List<MSalesOrg> mSalesOrgList, LoadReferrerOption<TShippingInstHCB, TShippingInstH> loadReferrerOption) {
        xassLRArg(mSalesOrgList, loadReferrerOption);
        if (mSalesOrgList.isEmpty()) { return (NestedReferrerListGateway<TShippingInstH>)EMPTY_NREF_LGWAY; }
        return doLoadTShippingInstHBySalesOrgList(mSalesOrgList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TShippingInstH> doLoadTShippingInstHBySalesOrgList(List<MSalesOrg> mSalesOrgList, LoadReferrerOption<TShippingInstHCB, TShippingInstH> option) {
        return helpLoadReferrerInternally(mSalesOrgList, option, "tShippingInstHBySalesOrgList");
    }
