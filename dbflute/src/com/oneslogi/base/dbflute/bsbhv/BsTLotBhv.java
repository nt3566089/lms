 ...
 *
 * [column]
 *     LOT_ID, PRODUCT_ID, LOT, LOT_SORT, LIMIT_DT, PROD_DT, RECEIVE_DT, DEL_FLG, VERSION_NO, CONTROL_NO, ADD_DT, ADD_USER, ADD_PROCESS, UPD_DT, UPD_USER, UPD_PROCESS
 *
 * [sequence]
 *     
 *
 ...
 *
 * [referrer table]
 *     t_alloc_inst_b, t_alloc_lot, t_inventory_b, t_keeping_lot, t_last_lot, t_move_inst_b, t_shipping_inst_b, t_stock, w_ht_inventory_input_prod, w_ht_picking, w_ht_receive_inspection, w_ht_receive_no_plan_insp, w_ht_receive_store, w_ht_shipping_picking, w_ht_total_picking
 *
 * [foreign property]
 *     mProduct
 *
 * [referrer property]
 *     tAllocInstBList, tAllocLotList, tInventoryBList, tKeepingLotList, tLastLotList, tMoveInstBList, tShippingInstBList, tStockList, wHtInventoryInputProdList, wHtPickingList, wHtReceiveInspectionList, wHtReceiveNoPlanInspList, wHtReceiveStoreList, wHtShippingPickingList, wHtTotalPickingList
 * </pre>
...
public abstract class BsTLotBhv extends AbstractBehaviorWritable<TLot, TLotCB> {
     ...
     * @param lotId : PK, ID, NotNull, BIGINT(19). (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">tLotBhv</span>.<span style="color: #CC4747">loadWHtPickingList</span>(<span style="color: #553000">tLotList</span>, <span style="color: #553000">pickingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (TLot tLot : <span style="color: #553000">tLotList</span>) {
     *     ... = tLot.<span style="color: #CC4747">getWHtPickingList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WHtPicking> loadWHtPickingList(List<TLot> tLotList, ConditionBeanSetupper<WHtPickingCB> refCBLambda) {
        xassLRArg(tLotList, refCBLambda);
        return doLoadWHtPickingList(tLotList, new LoadReferrerOption<WHtPickingCB, WHtPicking>().xinit(refCBLambda));
    }
     ...
     * w_ht_picking by LOT_ID, named 'WHtPickingList'.
     * <pre>
     * <span style="color: #0000C0">tLotBhv</span>.<span style="color: #CC4747">loadWHtPickingList</span>(<span style="color: #553000">tLot</span>, <span style="color: #553000">pickingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">pickingCB</span>.setupSelect...
     *     <span style="color: #553000">pickingCB</span>.query().set...
     *     <span style="color: #553000">pickingCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">tLot</span>.<span style="color: #CC4747">getWHtPickingList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WHtPicking> loadWHtPickingList(TLot tLot, ConditionBeanSetupper<WHtPickingCB> refCBLambda) {
        xassLRArg(tLot, refCBLambda);
        return doLoadWHtPickingList(xnewLRLs(tLot), new LoadReferrerOption<WHtPickingCB, WHtPicking>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WHtPicking> loadWHtPickingList(TLot tLot, LoadReferrerOption<WHtPickingCB, WHtPicking> loadReferrerOption) {
        xassLRArg(tLot, loadReferrerOption);
        return loadWHtPickingList(xnewLRLs(tLot), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<WHtPicking> loadWHtPickingList(List<TLot> tLotList, LoadReferrerOption<WHtPickingCB, WHtPicking> loadReferrerOption) {
        xassLRArg(tLotList, loadReferrerOption);
        if (tLotList.isEmpty()) { return (NestedReferrerListGateway<WHtPicking>)EMPTY_NREF_LGWAY; }
        return doLoadWHtPickingList(tLotList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<WHtPicking> doLoadWHtPickingList(List<TLot> tLotList, LoadReferrerOption<WHtPickingCB, WHtPicking> option) {
        return helpLoadReferrerInternally(tLotList, option, "wHtPickingList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tLotBhv</span>.<span style="color: #CC4747">loadWHtTotalPickingList</span>(<span style="color: #553000">tLotList</span>, <span style="color: #553000">pickingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">pickingCB</span>.setupSelect...
     *     <span style="color: #553000">pickingCB</span>.query().set...
     *     <span style="color: #553000">pickingCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (TLot tLot : <span style="color: #553000">tLotList</span>) {
     *     ... = tLot.<span style="color: #CC4747">getWHtTotalPickingList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WHtTotalPicking> loadWHtTotalPickingList(List<TLot> tLotList, ConditionBeanSetupper<WHtTotalPickingCB> refCBLambda) {
        xassLRArg(tLotList, refCBLambda);
        return doLoadWHtTotalPickingList(tLotList, new LoadReferrerOption<WHtTotalPickingCB, WHtTotalPicking>().xinit(refCBLambda));
    }
     ...
     * w_ht_total_picking by LOT_ID, named 'WHtTotalPickingList'.
     * <pre>
     * <span style="color: #0000C0">tLotBhv</span>.<span style="color: #CC4747">loadWHtTotalPickingList</span>(<span style="color: #553000">tLot</span>, <span style="color: #553000">pickingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">pickingCB</span>.setupSelect...
     *     <span style="color: #553000">pickingCB</span>.query().set...
     *     <span style="color: #553000">pickingCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">tLot</span>.<span style="color: #CC4747">getWHtTotalPickingList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WHtTotalPicking> loadWHtTotalPickingList(TLot tLot, ConditionBeanSetupper<WHtTotalPickingCB> refCBLambda) {
        xassLRArg(tLot, refCBLambda);
        return doLoadWHtTotalPickingList(xnewLRLs(tLot), new LoadReferrerOption<WHtTotalPickingCB, WHtTotalPicking>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WHtTotalPicking> loadWHtTotalPickingList(TLot tLot, LoadReferrerOption<WHtTotalPickingCB, WHtTotalPicking> loadReferrerOption) {
        xassLRArg(tLot, loadReferrerOption);
        return loadWHtTotalPickingList(xnewLRLs(tLot), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<WHtTotalPicking> loadWHtTotalPickingList(List<TLot> tLotList, LoadReferrerOption<WHtTotalPickingCB, WHtTotalPicking> loadReferrerOption) {
        xassLRArg(tLotList, loadReferrerOption);
        if (tLotList.isEmpty()) { return (NestedReferrerListGateway<WHtTotalPicking>)EMPTY_NREF_LGWAY; }
        return doLoadWHtTotalPickingList(tLotList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<WHtTotalPicking> doLoadWHtTotalPickingList(List<TLot> tLotList, LoadReferrerOption<WHtTotalPickingCB, WHtTotalPicking> option) {
        return helpLoadReferrerInternally(tLotList, option, "wHtTotalPickingList");
    }
