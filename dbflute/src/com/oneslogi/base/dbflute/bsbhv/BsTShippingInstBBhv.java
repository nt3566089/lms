...
public abstract class BsTShippingInstBBhv extends AbstractBehaviorWritable<TShippingInstB, TShippingInstBCB> {
     ...
     * @param shippingInstBId : PK, ID, NotNull, BIGINT(19). (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">tShippingInstBBhv</span>.<span style="color: #CC4747">loadTShippingInstBPrintList</span>(<span style="color: #553000">tShippingInstBList</span>, <span style="color: #553000">printCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstBPrint> loadTShippingInstBPrintList(List<TShippingInstB> tShippingInstBList, ConditionBeanSetupper<TShippingInstBPrintCB> refCBLambda) {
        xassLRArg(tShippingInstBList, refCBLambda);
        return doLoadTShippingInstBPrintList(tShippingInstBList, new LoadReferrerOption<TShippingInstBPrintCB, TShippingInstBPrint>().xinit(refCBLambda));
    }
     ...
     * t_shipping_inst_b_print by SHIPPING_INST_B_ID, named 'TShippingInstBPrintList'.
     * <pre>
     * <span style="color: #0000C0">tShippingInstBBhv</span>.<span style="color: #CC4747">loadTShippingInstBPrintList</span>(<span style="color: #553000">tShippingInstB</span>, <span style="color: #553000">printCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">printCB</span>.setupSelect...
     *     <span style="color: #553000">printCB</span>.query().set...
     *     <span style="color: #553000">printCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">tShippingInstB</span>.<span style="color: #CC4747">getTShippingInstBPrintList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstBPrint> loadTShippingInstBPrintList(TShippingInstB tShippingInstB, ConditionBeanSetupper<TShippingInstBPrintCB> refCBLambda) {
        xassLRArg(tShippingInstB, refCBLambda);
        return doLoadTShippingInstBPrintList(xnewLRLs(tShippingInstB), new LoadReferrerOption<TShippingInstBPrintCB, TShippingInstBPrint>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstBPrint> loadTShippingInstBPrintList(TShippingInstB tShippingInstB, LoadReferrerOption<TShippingInstBPrintCB, TShippingInstBPrint> loadReferrerOption) {
        xassLRArg(tShippingInstB, loadReferrerOption);
        return loadTShippingInstBPrintList(xnewLRLs(tShippingInstB), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TShippingInstBPrint> loadTShippingInstBPrintList(List<TShippingInstB> tShippingInstBList, LoadReferrerOption<TShippingInstBPrintCB, TShippingInstBPrint> loadReferrerOption) {
        xassLRArg(tShippingInstBList, loadReferrerOption);
        if (tShippingInstBList.isEmpty()) { return (NestedReferrerListGateway<TShippingInstBPrint>)EMPTY_NREF_LGWAY; }
        return doLoadTShippingInstBPrintList(tShippingInstBList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TShippingInstBPrint> doLoadTShippingInstBPrintList(List<TShippingInstB> tShippingInstBList, LoadReferrerOption<TShippingInstBPrintCB, TShippingInstBPrint> option) {
        return helpLoadReferrerInternally(tShippingInstBList, option, "tShippingInstBPrintList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tShippingInstBBhv</span>.<span style="color: #CC4747">loadTShippingInstDataTransferList</span>(<span style="color: #553000">tShippingInstBList</span>, <span style="color: #553000">transferCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstDataTransfer> loadTShippingInstDataTransferList(List<TShippingInstB> tShippingInstBList, ConditionBeanSetupper<TShippingInstDataTransferCB> refCBLambda) {
        xassLRArg(tShippingInstBList, refCBLambda);
        return doLoadTShippingInstDataTransferList(tShippingInstBList, new LoadReferrerOption<TShippingInstDataTransferCB, TShippingInstDataTransfer>().xinit(refCBLambda));
    }
     ...
     * t_shipping_inst_data_transfer by SHIPPING_INST_B_ID, named 'TShippingInstDataTransferList'.
     * <pre>
     * <span style="color: #0000C0">tShippingInstBBhv</span>.<span style="color: #CC4747">loadTShippingInstDataTransferList</span>(<span style="color: #553000">tShippingInstB</span>, <span style="color: #553000">transferCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">transferCB</span>.setupSelect...
     *     <span style="color: #553000">transferCB</span>.query().set...
     *     <span style="color: #553000">transferCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">tShippingInstB</span>.<span style="color: #CC4747">getTShippingInstDataTransferList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstDataTransfer> loadTShippingInstDataTransferList(TShippingInstB tShippingInstB, ConditionBeanSetupper<TShippingInstDataTransferCB> refCBLambda) {
        xassLRArg(tShippingInstB, refCBLambda);
        return doLoadTShippingInstDataTransferList(xnewLRLs(tShippingInstB), new LoadReferrerOption<TShippingInstDataTransferCB, TShippingInstDataTransfer>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstDataTransfer> loadTShippingInstDataTransferList(TShippingInstB tShippingInstB, LoadReferrerOption<TShippingInstDataTransferCB, TShippingInstDataTransfer> loadReferrerOption) {
        xassLRArg(tShippingInstB, loadReferrerOption);
        return loadTShippingInstDataTransferList(xnewLRLs(tShippingInstB), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TShippingInstDataTransfer> loadTShippingInstDataTransferList(List<TShippingInstB> tShippingInstBList, LoadReferrerOption<TShippingInstDataTransferCB, TShippingInstDataTransfer> loadReferrerOption) {
        xassLRArg(tShippingInstBList, loadReferrerOption);
        if (tShippingInstBList.isEmpty()) { return (NestedReferrerListGateway<TShippingInstDataTransfer>)EMPTY_NREF_LGWAY; }
        return doLoadTShippingInstDataTransferList(tShippingInstBList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TShippingInstDataTransfer> doLoadTShippingInstDataTransferList(List<TShippingInstB> tShippingInstBList, LoadReferrerOption<TShippingInstDataTransferCB, TShippingInstDataTransfer> option) {
        return helpLoadReferrerInternally(tShippingInstBList, option, "tShippingInstDataTransferList");
    }
