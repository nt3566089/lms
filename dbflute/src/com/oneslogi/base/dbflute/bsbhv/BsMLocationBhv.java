...
public abstract class BsMLocationBhv extends AbstractBehaviorWritable<MLocation, MLocationCB> {
     ...
     * @param locationId : PK, ID, NotNull, BIGINT(19). (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">mLocationBhv</span>.<span style="color: #CC4747">loadHLocationAttributeList</span>(<span style="color: #553000">mLocationList</span>, <span style="color: #553000">attributeCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerListGateway<HLocationAttribute> loadHLocationAttributeList(List<MLocation> mLocationList, ConditionBeanSetupper<HLocationAttributeCB> refCBLambda) {
        xassLRArg(mLocationList, refCBLambda);
        return doLoadHLocationAttributeList(mLocationList, new LoadReferrerOption<HLocationAttributeCB, HLocationAttribute>().xinit(refCBLambda));
    }
     ...
     * h_location_attribute by LOCATION_ID, named 'HLocationAttributeList'.
     * <pre>
     * <span style="color: #0000C0">mLocationBhv</span>.<span style="color: #CC4747">loadHLocationAttributeList</span>(<span style="color: #553000">mLocation</span>, <span style="color: #553000">attributeCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">attributeCB</span>.setupSelect...
     *     <span style="color: #553000">attributeCB</span>.query().set...
     *     <span style="color: #553000">attributeCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mLocation</span>.<span style="color: #CC4747">getHLocationAttributeList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<HLocationAttribute> loadHLocationAttributeList(MLocation mLocation, ConditionBeanSetupper<HLocationAttributeCB> refCBLambda) {
        xassLRArg(mLocation, refCBLambda);
        return doLoadHLocationAttributeList(xnewLRLs(mLocation), new LoadReferrerOption<HLocationAttributeCB, HLocationAttribute>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<HLocationAttribute> loadHLocationAttributeList(MLocation mLocation, LoadReferrerOption<HLocationAttributeCB, HLocationAttribute> loadReferrerOption) {
        xassLRArg(mLocation, loadReferrerOption);
        return loadHLocationAttributeList(xnewLRLs(mLocation), loadReferrerOption);
    }
    ...
    public NestedReferrerListGateway<HLocationAttribute> loadHLocationAttributeList(List<MLocation> mLocationList, LoadReferrerOption<HLocationAttributeCB, HLocationAttribute> loadReferrerOption) {
        xassLRArg(mLocationList, loadReferrerOption);
        if (mLocationList.isEmpty()) { return (NestedReferrerListGateway<HLocationAttribute>)EMPTY_NREF_LGWAY; }
        return doLoadHLocationAttributeList(mLocationList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<HLocationAttribute> doLoadHLocationAttributeList(List<MLocation> mLocationList, LoadReferrerOption<HLocationAttributeCB, HLocationAttribute> option) {
        return helpLoadReferrerInternally(mLocationList, option, "hLocationAttributeList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mLocationBhv</span>.<span style="color: #CC4747">loadMLocationReplenishProductList</span>(<span style="color: #553000">mLocationList</span>, <span style="color: #553000">productCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(List<MLocation> mLocationList, ConditionBeanSetupper<MLocationReplenishProductCB> refCBLambda) {
        xassLRArg(mLocationList, refCBLambda);
        return doLoadMLocationReplenishProductList(mLocationList, new LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct>().xinit(refCBLambda));
    }
     ...
     * m_location_replenish_product by LOCATION_ID, named 'MLocationReplenishProductList'.
     * <pre>
     * <span style="color: #0000C0">mLocationBhv</span>.<span style="color: #CC4747">loadMLocationReplenishProductList</span>(<span style="color: #553000">mLocation</span>, <span style="color: #553000">productCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">productCB</span>.setupSelect...
     *     <span style="color: #553000">productCB</span>.query().set...
     *     <span style="color: #553000">productCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mLocation</span>.<span style="color: #CC4747">getMLocationReplenishProductList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(MLocation mLocation, ConditionBeanSetupper<MLocationReplenishProductCB> refCBLambda) {
        xassLRArg(mLocation, refCBLambda);
        return doLoadMLocationReplenishProductList(xnewLRLs(mLocation), new LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(MLocation mLocation, LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct> loadReferrerOption) {
        xassLRArg(mLocation, loadReferrerOption);
        return loadMLocationReplenishProductList(xnewLRLs(mLocation), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(List<MLocation> mLocationList, LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct> loadReferrerOption) {
        xassLRArg(mLocationList, loadReferrerOption);
        if (mLocationList.isEmpty()) { return (NestedReferrerListGateway<MLocationReplenishProduct>)EMPTY_NREF_LGWAY; }
        return doLoadMLocationReplenishProductList(mLocationList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MLocationReplenishProduct> doLoadMLocationReplenishProductList(List<MLocation> mLocationList, LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct> option) {
        return helpLoadReferrerInternally(mLocationList, option, "mLocationReplenishProductList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mLocationBhv</span>.<span style="color: #CC4747">loadWHtPickingList</span>(<span style="color: #553000">mLocationList</span>, <span style="color: #553000">pickingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WHtPicking> loadWHtPickingList(List<MLocation> mLocationList, ConditionBeanSetupper<WHtPickingCB> refCBLambda) {
        xassLRArg(mLocationList, refCBLambda);
        return doLoadWHtPickingList(mLocationList, new LoadReferrerOption<WHtPickingCB, WHtPicking>().xinit(refCBLambda));
    }
     ...
     * w_ht_picking by LOCATION_ID, named 'WHtPickingList'.
     * <pre>
     * <span style="color: #0000C0">mLocationBhv</span>.<span style="color: #CC4747">loadWHtPickingList</span>(<span style="color: #553000">mLocation</span>, <span style="color: #553000">pickingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">pickingCB</span>.setupSelect...
     *     <span style="color: #553000">pickingCB</span>.query().set...
     *     <span style="color: #553000">pickingCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mLocation</span>.<span style="color: #CC4747">getWHtPickingList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WHtPicking> loadWHtPickingList(MLocation mLocation, ConditionBeanSetupper<WHtPickingCB> refCBLambda) {
        xassLRArg(mLocation, refCBLambda);
        return doLoadWHtPickingList(xnewLRLs(mLocation), new LoadReferrerOption<WHtPickingCB, WHtPicking>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WHtPicking> loadWHtPickingList(MLocation mLocation, LoadReferrerOption<WHtPickingCB, WHtPicking> loadReferrerOption) {
        xassLRArg(mLocation, loadReferrerOption);
        return loadWHtPickingList(xnewLRLs(mLocation), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<WHtPicking> loadWHtPickingList(List<MLocation> mLocationList, LoadReferrerOption<WHtPickingCB, WHtPicking> loadReferrerOption) {
        xassLRArg(mLocationList, loadReferrerOption);
        if (mLocationList.isEmpty()) { return (NestedReferrerListGateway<WHtPicking>)EMPTY_NREF_LGWAY; }
        return doLoadWHtPickingList(mLocationList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<WHtPicking> doLoadWHtPickingList(List<MLocation> mLocationList, LoadReferrerOption<WHtPickingCB, WHtPicking> option) {
        return helpLoadReferrerInternally(mLocationList, option, "wHtPickingList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mLocationBhv</span>.<span style="color: #CC4747">loadWHtTotalPickingList</span>(<span style="color: #553000">mLocationList</span>, <span style="color: #553000">pickingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">pickingCB</span>.setupSelect...
     *     <span style="color: #553000">pickingCB</span>.query().set...
     *     <span style="color: #553000">pickingCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WHtTotalPicking> loadWHtTotalPickingList(List<MLocation> mLocationList, ConditionBeanSetupper<WHtTotalPickingCB> refCBLambda) {
        xassLRArg(mLocationList, refCBLambda);
        return doLoadWHtTotalPickingList(mLocationList, new LoadReferrerOption<WHtTotalPickingCB, WHtTotalPicking>().xinit(refCBLambda));
    }
     ...
     * w_ht_total_picking by LOCATION_ID, named 'WHtTotalPickingList'.
     * <pre>
     * <span style="color: #0000C0">mLocationBhv</span>.<span style="color: #CC4747">loadWHtTotalPickingList</span>(<span style="color: #553000">mLocation</span>, <span style="color: #553000">pickingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">pickingCB</span>.setupSelect...
     *     <span style="color: #553000">pickingCB</span>.query().set...
     *     <span style="color: #553000">pickingCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mLocation</span>.<span style="color: #CC4747">getWHtTotalPickingList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WHtTotalPicking> loadWHtTotalPickingList(MLocation mLocation, ConditionBeanSetupper<WHtTotalPickingCB> refCBLambda) {
        xassLRArg(mLocation, refCBLambda);
        return doLoadWHtTotalPickingList(xnewLRLs(mLocation), new LoadReferrerOption<WHtTotalPickingCB, WHtTotalPicking>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<WHtTotalPicking> loadWHtTotalPickingList(MLocation mLocation, LoadReferrerOption<WHtTotalPickingCB, WHtTotalPicking> loadReferrerOption) {
        xassLRArg(mLocation, loadReferrerOption);
        return loadWHtTotalPickingList(xnewLRLs(mLocation), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<WHtTotalPicking> loadWHtTotalPickingList(List<MLocation> mLocationList, LoadReferrerOption<WHtTotalPickingCB, WHtTotalPicking> loadReferrerOption) {
        xassLRArg(mLocationList, loadReferrerOption);
        if (mLocationList.isEmpty()) { return (NestedReferrerListGateway<WHtTotalPicking>)EMPTY_NREF_LGWAY; }
        return doLoadWHtTotalPickingList(mLocationList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<WHtTotalPicking> doLoadWHtTotalPickingList(List<MLocation> mLocationList, LoadReferrerOption<WHtTotalPickingCB, WHtTotalPicking> option) {
        return helpLoadReferrerInternally(mLocationList, option, "wHtTotalPickingList");
    }
