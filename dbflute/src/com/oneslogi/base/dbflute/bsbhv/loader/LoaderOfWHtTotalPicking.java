...
/**
 * The referrer loader of w_ht_total_picking as TABLE. <br>
 * <pre>
 * [primary key]
 *     HT_TOTAL_PICKING_ID
 *
 ...
 */
public class LoaderOfWHtTotalPicking {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<WHtTotalPicking> _selectedList;
    protected BehaviorSelector _selector;
    protected WHtTotalPickingBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfWHtTotalPicking ready(List<WHtTotalPicking> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected WHtTotalPickingBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(WHtTotalPickingBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<WHtTotalPicking> getSelectedList() { return _selectedList; }
