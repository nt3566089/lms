...
/**
 * The referrer loader of es_receive_plan as TABLE. <br>
 * <pre>
 * [primary key]
 *     RECEIVE_PLAN_ID
 *
 ...
 */
public class LoaderOfEsReceivePlan {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<EsReceivePlan> _selectedList;
    protected BehaviorSelector _selector;
    protected EsReceivePlanBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfEsReceivePlan ready(List<EsReceivePlan> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected EsReceivePlanBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(EsReceivePlanBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<EsReceivePlan> getSelectedList() { return _selectedList; }
