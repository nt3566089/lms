...
public class LoaderOfTShippingInstH {
    ...
    protected LoaderOfMSalesOrg _foreignMSalesOrgBySalesOrgLoader;
    public LoaderOfMSalesOrg pulloutMSalesOrgBySalesOrg() {
        if (_foreignMSalesOrgBySalesOrgLoader == null)
        { _foreignMSalesOrgBySalesOrgLoader = new LoaderOfMSalesOrg().ready(myBhv().pulloutMSalesOrgBySalesOrg(_selectedList), _selector); }
        return _foreignMSalesOrgBySalesOrgLoader;
    }

    protected LoaderOfMCustomer _foreignMCustomerByAccoutIdLoader;
    public LoaderOfMCustomer pulloutMCustomerByAccoutId() {
        if (_foreignMCustomerByAccoutIdLoader == null)
        { _foreignMCustomerByAccoutIdLoader = new LoaderOfMCustomer().ready(myBhv().pulloutMCustomerByAccoutId(_selectedList), _selector); }
        return _foreignMCustomerByAccoutIdLoader;
    }
