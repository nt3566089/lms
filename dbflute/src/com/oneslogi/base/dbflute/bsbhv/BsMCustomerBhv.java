...
public abstract class BsMCustomerBhv extends AbstractBehaviorWritable<MCustomer, MCustomerCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadMCarrierDecisionList</span>(<span style="color: #553000">mCustomerList</span>, <span style="color: #553000">decisionCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionList(List<MCustomer> mCustomerList, ConditionBeanSetupper<MCarrierDecisionCB> refCBLambda) {
        xassLRArg(mCustomerList, refCBLambda);
        return doLoadMCarrierDecisionList(mCustomerList, new LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision>().xinit(refCBLambda));
    }
     ...
     * m_carrier_decision by CUSTOMER_ID, named 'MCarrierDecisionList'.
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadMCarrierDecisionList</span>(<span style="color: #553000">mCustomer</span>, <span style="color: #553000">decisionCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">decisionCB</span>.setupSelect...
     *     <span style="color: #553000">decisionCB</span>.query().set...
     *     <span style="color: #553000">decisionCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mCustomer</span>.<span style="color: #CC4747">getMCarrierDecisionList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionList(MCustomer mCustomer, ConditionBeanSetupper<MCarrierDecisionCB> refCBLambda) {
        xassLRArg(mCustomer, refCBLambda);
        return doLoadMCarrierDecisionList(xnewLRLs(mCustomer), new LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionList(MCustomer mCustomer, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> loadReferrerOption) {
        xassLRArg(mCustomer, loadReferrerOption);
        return loadMCarrierDecisionList(xnewLRLs(mCustomer), loadReferrerOption);
    }
    ...
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionList(List<MCustomer> mCustomerList, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> loadReferrerOption) {
        xassLRArg(mCustomerList, loadReferrerOption);
        if (mCustomerList.isEmpty()) { return (NestedReferrerListGateway<MCarrierDecision>)EMPTY_NREF_LGWAY; }
        return doLoadMCarrierDecisionList(mCustomerList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MCarrierDecision> doLoadMCarrierDecisionList(List<MCustomer> mCustomerList, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> option) {
        return helpLoadReferrerInternally(mCustomerList, option, "mCarrierDecisionList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadMCustomerPickingList</span>(<span style="color: #553000">mCustomerList</span>, <span style="color: #553000">pickingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCustomerPicking> loadMCustomerPickingList(List<MCustomer> mCustomerList, ConditionBeanSetupper<MCustomerPickingCB> refCBLambda) {
        xassLRArg(mCustomerList, refCBLambda);
        return doLoadMCustomerPickingList(mCustomerList, new LoadReferrerOption<MCustomerPickingCB, MCustomerPicking>().xinit(refCBLambda));
    }
     ...
     * m_customer_picking by CUSTOMER_ID, named 'MCustomerPickingList'.
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadMCustomerPickingList</span>(<span style="color: #553000">mCustomer</span>, <span style="color: #553000">pickingCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">pickingCB</span>.setupSelect...
     *     <span style="color: #553000">pickingCB</span>.query().set...
     *     <span style="color: #553000">pickingCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mCustomer</span>.<span style="color: #CC4747">getMCustomerPickingList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCustomerPicking> loadMCustomerPickingList(MCustomer mCustomer, ConditionBeanSetupper<MCustomerPickingCB> refCBLambda) {
        xassLRArg(mCustomer, refCBLambda);
        return doLoadMCustomerPickingList(xnewLRLs(mCustomer), new LoadReferrerOption<MCustomerPickingCB, MCustomerPicking>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCustomerPicking> loadMCustomerPickingList(MCustomer mCustomer, LoadReferrerOption<MCustomerPickingCB, MCustomerPicking> loadReferrerOption) {
        xassLRArg(mCustomer, loadReferrerOption);
        return loadMCustomerPickingList(xnewLRLs(mCustomer), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<MCustomerPicking> loadMCustomerPickingList(List<MCustomer> mCustomerList, LoadReferrerOption<MCustomerPickingCB, MCustomerPicking> loadReferrerOption) {
        xassLRArg(mCustomerList, loadReferrerOption);
        if (mCustomerList.isEmpty()) { return (NestedReferrerListGateway<MCustomerPicking>)EMPTY_NREF_LGWAY; }
        return doLoadMCustomerPickingList(mCustomerList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MCustomerPicking> doLoadMCustomerPickingList(List<MCustomer> mCustomerList, LoadReferrerOption<MCustomerPickingCB, MCustomerPicking> option) {
        return helpLoadReferrerInternally(mCustomerList, option, "mCustomerPickingList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadMDepositProductList</span>(<span style="color: #553000">mCustomerList</span>, <span style="color: #553000">productCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MDepositProduct> loadMDepositProductList(List<MCustomer> mCustomerList, ConditionBeanSetupper<MDepositProductCB> refCBLambda) {
        xassLRArg(mCustomerList, refCBLambda);
        return doLoadMDepositProductList(mCustomerList, new LoadReferrerOption<MDepositProductCB, MDepositProduct>().xinit(refCBLambda));
    }
     ...
     * m_deposit_product by ACCOUNT_ID, named 'MDepositProductList'.
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadMDepositProductList</span>(<span style="color: #553000">mCustomer</span>, <span style="color: #553000">productCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">productCB</span>.setupSelect...
     *     <span style="color: #553000">productCB</span>.query().set...
     *     <span style="color: #553000">productCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mCustomer</span>.<span style="color: #CC4747">getMDepositProductList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MDepositProduct> loadMDepositProductList(MCustomer mCustomer, ConditionBeanSetupper<MDepositProductCB> refCBLambda) {
        xassLRArg(mCustomer, refCBLambda);
        return doLoadMDepositProductList(xnewLRLs(mCustomer), new LoadReferrerOption<MDepositProductCB, MDepositProduct>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MDepositProduct> loadMDepositProductList(MCustomer mCustomer, LoadReferrerOption<MDepositProductCB, MDepositProduct> loadReferrerOption) {
        xassLRArg(mCustomer, loadReferrerOption);
        return loadMDepositProductList(xnewLRLs(mCustomer), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<MDepositProduct> loadMDepositProductList(List<MCustomer> mCustomerList, LoadReferrerOption<MDepositProductCB, MDepositProduct> loadReferrerOption) {
        xassLRArg(mCustomerList, loadReferrerOption);
        if (mCustomerList.isEmpty()) { return (NestedReferrerListGateway<MDepositProduct>)EMPTY_NREF_LGWAY; }
        return doLoadMDepositProductList(mCustomerList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MDepositProduct> doLoadMDepositProductList(List<MCustomer> mCustomerList, LoadReferrerOption<MDepositProductCB, MDepositProduct> option) {
        return helpLoadReferrerInternally(mCustomerList, option, "mDepositProductList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadMLocationReplenishProductList</span>(<span style="color: #553000">mCustomerList</span>, <span style="color: #553000">productCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">productCB</span>.setupSelect...
     *     <span style="color: #553000">productCB</span>.query().set...
     *     <span style="color: #553000">productCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(List<MCustomer> mCustomerList, ConditionBeanSetupper<MLocationReplenishProductCB> refCBLambda) {
        xassLRArg(mCustomerList, refCBLambda);
        return doLoadMLocationReplenishProductList(mCustomerList, new LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct>().xinit(refCBLambda));
    }
     ...
     * m_location_replenish_product by REPLENISH_DEPOSIT_ID, named 'MLocationReplenishProductList'.
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadMLocationReplenishProductList</span>(<span style="color: #553000">mCustomer</span>, <span style="color: #553000">productCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">productCB</span>.setupSelect...
     *     <span style="color: #553000">productCB</span>.query().set...
     *     <span style="color: #553000">productCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mCustomer</span>.<span style="color: #CC4747">getMLocationReplenishProductList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(MCustomer mCustomer, ConditionBeanSetupper<MLocationReplenishProductCB> refCBLambda) {
        xassLRArg(mCustomer, refCBLambda);
        return doLoadMLocationReplenishProductList(xnewLRLs(mCustomer), new LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(MCustomer mCustomer, LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct> loadReferrerOption) {
        xassLRArg(mCustomer, loadReferrerOption);
        return loadMLocationReplenishProductList(xnewLRLs(mCustomer), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(List<MCustomer> mCustomerList, LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct> loadReferrerOption) {
        xassLRArg(mCustomerList, loadReferrerOption);
        if (mCustomerList.isEmpty()) { return (NestedReferrerListGateway<MLocationReplenishProduct>)EMPTY_NREF_LGWAY; }
        return doLoadMLocationReplenishProductList(mCustomerList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MLocationReplenishProduct> doLoadMLocationReplenishProductList(List<MCustomer> mCustomerList, LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct> option) {
        return helpLoadReferrerInternally(mCustomerList, option, "mLocationReplenishProductList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadTInventoryBByAccountIdList</span>(<span style="color: #553000">mCustomerList</span>, <span style="color: #553000">bCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">bCB</span>.setupSelect...
     *     <span style="color: #553000">bCB</span>.query().set...
     *     <span style="color: #553000">bCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryB> loadTInventoryBByAccountIdList(List<MCustomer> mCustomerList, ConditionBeanSetupper<TInventoryBCB> refCBLambda) {
        xassLRArg(mCustomerList, refCBLambda);
        return doLoadTInventoryBByAccountIdList(mCustomerList, new LoadReferrerOption<TInventoryBCB, TInventoryB>().xinit(refCBLambda));
    }
     ...
     * t_inventory_b by ACCOUNT_ID, named 'TInventoryBByAccountIdList'.
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadTInventoryBByAccountIdList</span>(<span style="color: #553000">mCustomer</span>, <span style="color: #553000">bCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">bCB</span>.setupSelect...
     *     <span style="color: #553000">bCB</span>.query().set...
     *     <span style="color: #553000">bCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mCustomer</span>.<span style="color: #CC4747">getTInventoryBByAccountIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryB> loadTInventoryBByAccountIdList(MCustomer mCustomer, ConditionBeanSetupper<TInventoryBCB> refCBLambda) {
        xassLRArg(mCustomer, refCBLambda);
        return doLoadTInventoryBByAccountIdList(xnewLRLs(mCustomer), new LoadReferrerOption<TInventoryBCB, TInventoryB>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryB> loadTInventoryBByAccountIdList(MCustomer mCustomer, LoadReferrerOption<TInventoryBCB, TInventoryB> loadReferrerOption) {
        xassLRArg(mCustomer, loadReferrerOption);
        return loadTInventoryBByAccountIdList(xnewLRLs(mCustomer), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TInventoryB> loadTInventoryBByAccountIdList(List<MCustomer> mCustomerList, LoadReferrerOption<TInventoryBCB, TInventoryB> loadReferrerOption) {
        xassLRArg(mCustomerList, loadReferrerOption);
        if (mCustomerList.isEmpty()) { return (NestedReferrerListGateway<TInventoryB>)EMPTY_NREF_LGWAY; }
        return doLoadTInventoryBByAccountIdList(mCustomerList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TInventoryB> doLoadTInventoryBByAccountIdList(List<MCustomer> mCustomerList, LoadReferrerOption<TInventoryBCB, TInventoryB> option) {
        return helpLoadReferrerInternally(mCustomerList, option, "tInventoryBByAccountIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadTMoveInstBByAccountIdList</span>(<span style="color: #553000">mCustomerList</span>, <span style="color: #553000">bCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">bCB</span>.setupSelect...
     *     <span style="color: #553000">bCB</span>.query().set...
     *     <span style="color: #553000">bCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TMoveInstB> loadTMoveInstBByAccountIdList(List<MCustomer> mCustomerList, ConditionBeanSetupper<TMoveInstBCB> refCBLambda) {
        xassLRArg(mCustomerList, refCBLambda);
        return doLoadTMoveInstBByAccountIdList(mCustomerList, new LoadReferrerOption<TMoveInstBCB, TMoveInstB>().xinit(refCBLambda));
    }
     ...
     * t_move_inst_b by ACCOUNT_ID, named 'TMoveInstBByAccountIdList'.
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadTMoveInstBByAccountIdList</span>(<span style="color: #553000">mCustomer</span>, <span style="color: #553000">bCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">bCB</span>.setupSelect...
     *     <span style="color: #553000">bCB</span>.query().set...
     *     <span style="color: #553000">bCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mCustomer</span>.<span style="color: #CC4747">getTMoveInstBByAccountIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TMoveInstB> loadTMoveInstBByAccountIdList(MCustomer mCustomer, ConditionBeanSetupper<TMoveInstBCB> refCBLambda) {
        xassLRArg(mCustomer, refCBLambda);
        return doLoadTMoveInstBByAccountIdList(xnewLRLs(mCustomer), new LoadReferrerOption<TMoveInstBCB, TMoveInstB>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TMoveInstB> loadTMoveInstBByAccountIdList(MCustomer mCustomer, LoadReferrerOption<TMoveInstBCB, TMoveInstB> loadReferrerOption) {
        xassLRArg(mCustomer, loadReferrerOption);
        return loadTMoveInstBByAccountIdList(xnewLRLs(mCustomer), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TMoveInstB> loadTMoveInstBByAccountIdList(List<MCustomer> mCustomerList, LoadReferrerOption<TMoveInstBCB, TMoveInstB> loadReferrerOption) {
        xassLRArg(mCustomerList, loadReferrerOption);
        if (mCustomerList.isEmpty()) { return (NestedReferrerListGateway<TMoveInstB>)EMPTY_NREF_LGWAY; }
        return doLoadTMoveInstBByAccountIdList(mCustomerList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TMoveInstB> doLoadTMoveInstBByAccountIdList(List<MCustomer> mCustomerList, LoadReferrerOption<TMoveInstBCB, TMoveInstB> option) {
        return helpLoadReferrerInternally(mCustomerList, option, "tMoveInstBByAccountIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadTShippingInstHByAccoutIdList</span>(<span style="color: #553000">mCustomerList</span>, <span style="color: #553000">hCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">hCB</span>.setupSelect...
     *     <span style="color: #553000">hCB</span>.query().set...
     *     <span style="color: #553000">hCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstH> loadTShippingInstHByAccoutIdList(List<MCustomer> mCustomerList, ConditionBeanSetupper<TShippingInstHCB> refCBLambda) {
        xassLRArg(mCustomerList, refCBLambda);
        return doLoadTShippingInstHByAccoutIdList(mCustomerList, new LoadReferrerOption<TShippingInstHCB, TShippingInstH>().xinit(refCBLambda));
    }
     ...
     * t_shipping_inst_h by ACCOUNT_ID, named 'TShippingInstHByAccoutIdList'.
     * <pre>
     * <span style="color: #0000C0">mCustomerBhv</span>.<span style="color: #CC4747">loadTShippingInstHByAccoutIdList</span>(<span style="color: #553000">mCustomer</span>, <span style="color: #553000">hCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">hCB</span>.setupSelect...
     *     <span style="color: #553000">hCB</span>.query().set...
     *     <span style="color: #553000">hCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mCustomer</span>.<span style="color: #CC4747">getTShippingInstHByAccoutIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstH> loadTShippingInstHByAccoutIdList(MCustomer mCustomer, ConditionBeanSetupper<TShippingInstHCB> refCBLambda) {
        xassLRArg(mCustomer, refCBLambda);
        return doLoadTShippingInstHByAccoutIdList(xnewLRLs(mCustomer), new LoadReferrerOption<TShippingInstHCB, TShippingInstH>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstH> loadTShippingInstHByAccoutIdList(MCustomer mCustomer, LoadReferrerOption<TShippingInstHCB, TShippingInstH> loadReferrerOption) {
        xassLRArg(mCustomer, loadReferrerOption);
        return loadTShippingInstHByAccoutIdList(xnewLRLs(mCustomer), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TShippingInstH> loadTShippingInstHByAccoutIdList(List<MCustomer> mCustomerList, LoadReferrerOption<TShippingInstHCB, TShippingInstH> loadReferrerOption) {
        xassLRArg(mCustomerList, loadReferrerOption);
        if (mCustomerList.isEmpty()) { return (NestedReferrerListGateway<TShippingInstH>)EMPTY_NREF_LGWAY; }
        return doLoadTShippingInstHByAccoutIdList(mCustomerList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TShippingInstH> doLoadTShippingInstHByAccoutIdList(List<MCustomer> mCustomerList, LoadReferrerOption<TShippingInstHCB, TShippingInstH> option) {
        return helpLoadReferrerInternally(mCustomerList, option, "tShippingInstHByAccoutIdList");
    }
    ...
    /**
     * Pull out the list of foreign table 'MPlantStorageSpace'.
     * @param mCustomerList The list of mCustomer. (NotNull, EmptyAllowed)
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<MPlantStorageSpace> pulloutMPlantStorageSpaceByCd(List<MCustomer> mCustomerList)
    { return helpPulloutInternally(mCustomerList, "mPlantStorageSpaceByCd"); }
