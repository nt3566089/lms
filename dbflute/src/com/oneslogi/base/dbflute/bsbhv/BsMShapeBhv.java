 ...
 *
 * [referrer table]
 *     h_inventory_b, h_stock, m_location_replenish_product, m_shape_grp_dtl, t_alloc_inst_b, t_inventory_b, t_move_inst_b, t_picking_b, t_shipping_inst_b, t_stock
 *
 * [foreign property]
 *     bDictByShapeDictId, bDictByShapeUnitDictId, vDictByShapeDictId, vDictByShapeUnitDictId, bClassDtlByDelFlg
 *
 * [referrer property]
 *     hInventoryBList, hStockList, mLocationReplenishProductList, mShapeGrpDtlList, tAllocInstBList, tInventoryBList, tMoveInstBList, tPickingBList, tShippingInstBList, tStockList
 * </pre>
...
public abstract class BsMShapeBhv extends AbstractBehaviorWritable<MShape, MShapeCB> {
     ...
     * @param shapeId : PK, ID, NotNull, BIGINT(19). (NotNull)
     ...
     * m_location_replenish_product by REPLENISH_P_PRODUCT_SHAPE_ID, named 'MLocationReplenishProductList'.
     * <pre>
     * <span style="color: #0000C0">mShapeBhv</span>.<span style="color: #CC4747">loadMLocationReplenishProductList</span>(<span style="color: #553000">mShapeList</span>, <span style="color: #553000">productCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (MShape mShape : <span style="color: #553000">mShapeList</span>) {
     *     ... = mShape.<span style="color: #CC4747">getMLocationReplenishProductList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(List<MShape> mShapeList, ConditionBeanSetupper<MLocationReplenishProductCB> refCBLambda) {
        xassLRArg(mShapeList, refCBLambda);
        return doLoadMLocationReplenishProductList(mShapeList, new LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct>().xinit(refCBLambda));
    }
     ...
     * m_location_replenish_product by REPLENISH_P_PRODUCT_SHAPE_ID, named 'MLocationReplenishProductList'.
     * <pre>
     * <span style="color: #0000C0">mShapeBhv</span>.<span style="color: #CC4747">loadMLocationReplenishProductList</span>(<span style="color: #553000">mShape</span>, <span style="color: #553000">productCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">productCB</span>.setupSelect...
     *     <span style="color: #553000">productCB</span>.query().set...
     *     <span style="color: #553000">productCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mShape</span>.<span style="color: #CC4747">getMLocationReplenishProductList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(MShape mShape, ConditionBeanSetupper<MLocationReplenishProductCB> refCBLambda) {
        xassLRArg(mShape, refCBLambda);
        return doLoadMLocationReplenishProductList(xnewLRLs(mShape), new LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(MShape mShape, LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct> loadReferrerOption) {
        xassLRArg(mShape, loadReferrerOption);
        return loadMLocationReplenishProductList(xnewLRLs(mShape), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(List<MShape> mShapeList, LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct> loadReferrerOption) {
        xassLRArg(mShapeList, loadReferrerOption);
        if (mShapeList.isEmpty()) { return (NestedReferrerListGateway<MLocationReplenishProduct>)EMPTY_NREF_LGWAY; }
        return doLoadMLocationReplenishProductList(mShapeList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MLocationReplenishProduct> doLoadMLocationReplenishProductList(List<MShape> mShapeList, LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct> option) {
        return helpLoadReferrerInternally(mShapeList, option, "mLocationReplenishProductList");
    }
