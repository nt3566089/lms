...
public abstract class BsTShippingInstHBhv extends AbstractBehaviorWritable<TShippingInstH, TShippingInstHCB> {
    ...
    /** 荷札ヤマトデータを取得します。 */
    public static final String PATH_selectSqlTagLabelYamato = "selectSqlTagLabelYamato";
    /*df:endQueryPath*/
     ...
     * <pre>
     * <span style="color: #0000C0">tShippingInstHBhv</span>.<span style="color: #CC4747">loadTShippingInstHPrintList</span>(<span style="color: #553000">tShippingInstHList</span>, <span style="color: #553000">printCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstHPrint> loadTShippingInstHPrintList(List<TShippingInstH> tShippingInstHList, ConditionBeanSetupper<TShippingInstHPrintCB> refCBLambda) {
        xassLRArg(tShippingInstHList, refCBLambda);
        return doLoadTShippingInstHPrintList(tShippingInstHList, new LoadReferrerOption<TShippingInstHPrintCB, TShippingInstHPrint>().xinit(refCBLambda));
    }
     ...
     * t_shipping_inst_h_print by SHIPPING_INST_H_ID, named 'TShippingInstHPrintList'.
     * <pre>
     * <span style="color: #0000C0">tShippingInstHBhv</span>.<span style="color: #CC4747">loadTShippingInstHPrintList</span>(<span style="color: #553000">tShippingInstH</span>, <span style="color: #553000">printCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">printCB</span>.setupSelect...
     *     <span style="color: #553000">printCB</span>.query().set...
     *     <span style="color: #553000">printCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">tShippingInstH</span>.<span style="color: #CC4747">getTShippingInstHPrintList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstHPrint> loadTShippingInstHPrintList(TShippingInstH tShippingInstH, ConditionBeanSetupper<TShippingInstHPrintCB> refCBLambda) {
        xassLRArg(tShippingInstH, refCBLambda);
        return doLoadTShippingInstHPrintList(xnewLRLs(tShippingInstH), new LoadReferrerOption<TShippingInstHPrintCB, TShippingInstHPrint>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TShippingInstHPrint> loadTShippingInstHPrintList(TShippingInstH tShippingInstH, LoadReferrerOption<TShippingInstHPrintCB, TShippingInstHPrint> loadReferrerOption) {
        xassLRArg(tShippingInstH, loadReferrerOption);
        return loadTShippingInstHPrintList(xnewLRLs(tShippingInstH), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TShippingInstHPrint> loadTShippingInstHPrintList(List<TShippingInstH> tShippingInstHList, LoadReferrerOption<TShippingInstHPrintCB, TShippingInstHPrint> loadReferrerOption) {
        xassLRArg(tShippingInstHList, loadReferrerOption);
        if (tShippingInstHList.isEmpty()) { return (NestedReferrerListGateway<TShippingInstHPrint>)EMPTY_NREF_LGWAY; }
        return doLoadTShippingInstHPrintList(tShippingInstHList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TShippingInstHPrint> doLoadTShippingInstHPrintList(List<TShippingInstH> tShippingInstHList, LoadReferrerOption<TShippingInstHPrintCB, TShippingInstHPrint> option) {
        return helpLoadReferrerInternally(tShippingInstHList, option, "tShippingInstHPrintList");
    }
     ...
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<MSalesOrg> pulloutMSalesOrgBySalesOrg(List<TShippingInstH> tShippingInstHList)
    { return helpPulloutInternally(tShippingInstHList, "mSalesOrgBySalesOrg"); }
     ...
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<MCustomer> pulloutMCustomerByAccoutId(List<TShippingInstH> tShippingInstHList)
    { return helpPulloutInternally(tShippingInstHList, "mCustomerByAccoutId"); }
