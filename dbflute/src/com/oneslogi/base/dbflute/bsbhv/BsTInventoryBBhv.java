...
public abstract class BsTInventoryBBhv extends AbstractBehaviorWritable<TInventoryB, TInventoryBCB> {
    ...
    /*df:beginQueryPath*/
    /** 棚卸関連リスト発行 棚卸在庫差異表 */
    public static final String PATH_selectSqlInventoryListPrintReportData01 = "selectSqlInventoryListPrintReportData01";
    /** 棚卸関連リスト発行 在庫差異確認表 */
    public static final String PATH_selectSqlInventoryListPrintReportData02 = "selectSqlInventoryListPrintReportData02";
    /** 棚卸関連リスト発行 商品別棚卸実績表兼差異表 */
    public static final String PATH_selectSqlInventoryListPrintReportData03 = "selectSqlInventoryListPrintReportData03";
    /** 棚卸関連リスト発行 商品別棚卸実績表(LOC表示あり） */
    public static final String PATH_selectSqlInventoryListPrintReportData04 = "selectSqlInventoryListPrintReportData04";
    /*df:endQueryPath*/
     ...
     * <pre>
     * <span style="color: #0000C0">tInventoryBBhv</span>.<span style="color: #CC4747">loadTInventoryReceiveLabelList</span>(<span style="color: #553000">tInventoryBList</span>, <span style="color: #553000">labelCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryReceiveLabel> loadTInventoryReceiveLabelList(List<TInventoryB> tInventoryBList, ConditionBeanSetupper<TInventoryReceiveLabelCB> refCBLambda) {
        xassLRArg(tInventoryBList, refCBLambda);
        return doLoadTInventoryReceiveLabelList(tInventoryBList, new LoadReferrerOption<TInventoryReceiveLabelCB, TInventoryReceiveLabel>().xinit(refCBLambda));
    }
     ...
     * t_inventory_receive_label by INVENTORY_B_ID, named 'TInventoryReceiveLabelList'.
     * <pre>
     * <span style="color: #0000C0">tInventoryBBhv</span>.<span style="color: #CC4747">loadTInventoryReceiveLabelList</span>(<span style="color: #553000">tInventoryB</span>, <span style="color: #553000">labelCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">labelCB</span>.setupSelect...
     *     <span style="color: #553000">labelCB</span>.query().set...
     *     <span style="color: #553000">labelCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">tInventoryB</span>.<span style="color: #CC4747">getTInventoryReceiveLabelList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryReceiveLabel> loadTInventoryReceiveLabelList(TInventoryB tInventoryB, ConditionBeanSetupper<TInventoryReceiveLabelCB> refCBLambda) {
        xassLRArg(tInventoryB, refCBLambda);
        return doLoadTInventoryReceiveLabelList(xnewLRLs(tInventoryB), new LoadReferrerOption<TInventoryReceiveLabelCB, TInventoryReceiveLabel>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryReceiveLabel> loadTInventoryReceiveLabelList(TInventoryB tInventoryB, LoadReferrerOption<TInventoryReceiveLabelCB, TInventoryReceiveLabel> loadReferrerOption) {
        xassLRArg(tInventoryB, loadReferrerOption);
        return loadTInventoryReceiveLabelList(xnewLRLs(tInventoryB), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TInventoryReceiveLabel> loadTInventoryReceiveLabelList(List<TInventoryB> tInventoryBList, LoadReferrerOption<TInventoryReceiveLabelCB, TInventoryReceiveLabel> loadReferrerOption) {
        xassLRArg(tInventoryBList, loadReferrerOption);
        if (tInventoryBList.isEmpty()) { return (NestedReferrerListGateway<TInventoryReceiveLabel>)EMPTY_NREF_LGWAY; }
        return doLoadTInventoryReceiveLabelList(tInventoryBList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TInventoryReceiveLabel> doLoadTInventoryReceiveLabelList(List<TInventoryB> tInventoryBList, LoadReferrerOption<TInventoryReceiveLabelCB, TInventoryReceiveLabel> option) {
        return helpLoadReferrerInternally(tInventoryBList, option, "tInventoryReceiveLabelList");
    }
     ...
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<BUser> pulloutBUserByInventoryUpdUserId(List<TInventoryB> tInventoryBList)
    { return helpPulloutInternally(tInventoryBList, "bUserByInventoryUpdUserId"); }
     ...
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<MSalesOrg> pulloutMSalesOrg(List<TInventoryB> tInventoryBList)
    { return helpPulloutInternally(tInventoryBList, "mSalesOrg"); }
     ...
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<MCustomer> pulloutMCustomerByAccountId(List<TInventoryB> tInventoryBList)
    { return helpPulloutInternally(tInventoryBList, "mCustomerByAccountId"); }
     ...
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<BUser> pulloutBUserByInventoryUserId(List<TInventoryB> tInventoryBList)
    { return helpPulloutInternally(tInventoryBList, "bUserByInventoryUserId"); }
