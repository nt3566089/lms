...
public abstract class BsMStockTypeBhv extends AbstractBehaviorWritable<MStockType, MStockTypeCB> {
     ...
     * @param stockTypeId : PK, ID, NotNull, BIGINT(19). (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">mStockTypeBhv</span>.<span style="color: #CC4747">loadMLocationReplenishProductList</span>(<span style="color: #553000">mStockTypeList</span>, <span style="color: #553000">productCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (MStockType mStockType : <span style="color: #553000">mStockTypeList</span>) {
     *     ... = mStockType.<span style="color: #CC4747">getMLocationReplenishProductList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(List<MStockType> mStockTypeList, ConditionBeanSetupper<MLocationReplenishProductCB> refCBLambda) {
        xassLRArg(mStockTypeList, refCBLambda);
        return doLoadMLocationReplenishProductList(mStockTypeList, new LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct>().xinit(refCBLambda));
    }
     ...
     * m_location_replenish_product by REPLENISH_STOCK_TYPE_ID, named 'MLocationReplenishProductList'.
     * <pre>
     * <span style="color: #0000C0">mStockTypeBhv</span>.<span style="color: #CC4747">loadMLocationReplenishProductList</span>(<span style="color: #553000">mStockType</span>, <span style="color: #553000">productCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">productCB</span>.setupSelect...
     *     <span style="color: #553000">productCB</span>.query().set...
     *     <span style="color: #553000">productCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mStockType</span>.<span style="color: #CC4747">getMLocationReplenishProductList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(MStockType mStockType, ConditionBeanSetupper<MLocationReplenishProductCB> refCBLambda) {
        xassLRArg(mStockType, refCBLambda);
        return doLoadMLocationReplenishProductList(xnewLRLs(mStockType), new LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(MStockType mStockType, LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct> loadReferrerOption) {
        xassLRArg(mStockType, loadReferrerOption);
        return loadMLocationReplenishProductList(xnewLRLs(mStockType), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<MLocationReplenishProduct> loadMLocationReplenishProductList(List<MStockType> mStockTypeList, LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct> loadReferrerOption) {
        xassLRArg(mStockTypeList, loadReferrerOption);
        if (mStockTypeList.isEmpty()) { return (NestedReferrerListGateway<MLocationReplenishProduct>)EMPTY_NREF_LGWAY; }
        return doLoadMLocationReplenishProductList(mStockTypeList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MLocationReplenishProduct> doLoadMLocationReplenishProductList(List<MStockType> mStockTypeList, LoadReferrerOption<MLocationReplenishProductCB, MLocationReplenishProduct> option) {
        return helpLoadReferrerInternally(mStockTypeList, option, "mLocationReplenishProductList");
    }
