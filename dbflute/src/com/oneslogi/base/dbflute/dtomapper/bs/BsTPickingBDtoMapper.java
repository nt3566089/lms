...
public abstract class BsTPickingBDtoMapper implements DtoMapper<TPickingB, TPickingBDto>, Serializable {
    ...
    public TPickingBDto mappingToDto(TPickingB entity) {
        ...
        dto.setPickedNum(entity.getPickedNum());
        dto.setPickingPaternCd(entity.getPickingPaternCd());
        dto.setIndvLabelNo(entity.getIndvLabelNo());
        dto.setOldPickingBId(entity.getOldPickingBId());
    ...
    public TPickingB mappingToEntity(TPickingBDto dto) {
        ...
        if (needsMapping(dto, dto.getPickedNum(), "pickedNum")) {
            entity.setPickedNum(dto.getPickedNum());
        }
        if (needsMapping(dto, dto.getPickingPaternCd(), "pickingPaternCd")) {
            entity.setPickingPaternCd(dto.getPickingPaternCd());
        }
        if (needsMapping(dto, dto.getIndvLabelNo(), "indvLabelNo")) {
            entity.setIndvLabelNo(dto.getIndvLabelNo());
        }
        if (needsMapping(dto, dto.getOldPickingBId(), "oldPickingBId")) {
            entity.setOldPickingBId(dto.getOldPickingBId());
        }
