...
/**
 * The DTO mapper of es_receive_plan as TABLE. <br>
 * 入庫予定送信テーブル
 * <pre>
 * [primary-key]
 *     RECEIVE_PLAN_ID
 ...
 */
public abstract class BsEsReceivePlanDtoMapper implements DtoMapper<EsReceivePlan, EsReceivePlanDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsReceivePlanDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEsReceivePlanDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EsReceivePlanDto mappingToDto(EsReceivePlan entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsReceivePlanDto dto = new EsReceivePlanDto();
     ...
     * {@inheritDoc}
     */
    public List<EsReceivePlanDto> mappingToDtoList(List<EsReceivePlan> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EsReceivePlanDto> dtoList = new ArrayList<EsReceivePlanDto>();
        for (EsReceivePlan entity : entityList) {
            EsReceivePlanDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EsReceivePlan mappingToEntity(EsReceivePlanDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsReceivePlan entity = new EsReceivePlan();
     ...
     */
    protected boolean needsMapping(EsReceivePlanDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EsReceivePlan> mappingToEntityList(List<EsReceivePlanDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EsReceivePlan> entityList = new ArrayList<EsReceivePlan>();
        for (EsReceivePlanDto dto : dtoList) {
            EsReceivePlan entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EsReceivePlanDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EsReceivePlanDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EsReceivePlanDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EsReceivePlanDtoMapper reverseReference() {
