...
public abstract class BsWHtShippingPickingDtoMapper implements DtoMapper<WHtShippingPicking, WHtShippingPickingDto>, Serializable {
    ...
    public WHtShippingPickingDto mappingToDto(WHtShippingPicking entity) {
        ...
        dto.setMultiPickFlg(entity.getMultiPickFlg());
        dto.setMultiMacAddress(entity.getMultiMacAddress());
    ...
    public WHtShippingPicking mappingToEntity(WHtShippingPickingDto dto) {
        ...
        if (needsMapping(dto, dto.getMultiPickFlg(), "multiPickFlg")) {
            entity.setMultiPickFlg(dto.getMultiPickFlg());
        }
        if (needsMapping(dto, dto.getMultiMacAddress(), "multiMacAddress")) {
            entity.setMultiMacAddress(dto.getMultiMacAddress());
        }
