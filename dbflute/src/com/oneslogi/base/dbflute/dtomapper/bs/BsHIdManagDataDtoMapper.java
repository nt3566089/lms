...
/**
 * The DTO mapper of h_id_manag_data as TABLE. <br>
 * 個体管理情報履歴
 * <pre>
 * [primary-key]
 *     ID_MANAG_DATA_ID
 ...
 */
public abstract class BsHIdManagDataDtoMapper implements DtoMapper<HIdManagData, HIdManagDataDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsHIdManagDataDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsHIdManagDataDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public HIdManagDataDto mappingToDto(HIdManagData entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        HIdManagDataDto dto = new HIdManagDataDto();
     ...
     * {@inheritDoc}
     */
    public List<HIdManagDataDto> mappingToDtoList(List<HIdManagData> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<HIdManagDataDto> dtoList = new ArrayList<HIdManagDataDto>();
        for (HIdManagData entity : entityList) {
            HIdManagDataDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public HIdManagData mappingToEntity(HIdManagDataDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        HIdManagData entity = new HIdManagData();
     ...
     */
    protected boolean needsMapping(HIdManagDataDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<HIdManagData> mappingToEntityList(List<HIdManagDataDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<HIdManagData> entityList = new ArrayList<HIdManagData>();
        for (HIdManagDataDto dto : dtoList) {
            HIdManagData entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public HIdManagDataDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (HIdManagDataDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public HIdManagDataDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public HIdManagDataDtoMapper reverseReference() {
