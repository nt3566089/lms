...
/**
 * The DTO mapper of er_inventory_report_sum as TABLE. <br>
 * 棚卸実績(集約)受信テーブル
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsErInventoryReportSumDtoMapper implements DtoMapper<ErInventoryReportSum, ErInventoryReportSumDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsErInventoryReportSumDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsErInventoryReportSumDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ErInventoryReportSumDto mappingToDto(ErInventoryReportSum entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErInventoryReportSumDto dto = new ErInventoryReportSumDto();
        dto.setInventoryReportSumId(entity.getInventoryReportSumId());
     ...
     * {@inheritDoc}
     */
    public List<ErInventoryReportSumDto> mappingToDtoList(List<ErInventoryReportSum> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ErInventoryReportSumDto> dtoList = new ArrayList<ErInventoryReportSumDto>();
        for (ErInventoryReportSum entity : entityList) {
            ErInventoryReportSumDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ErInventoryReportSum mappingToEntity(ErInventoryReportSumDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErInventoryReportSum entity = new ErInventoryReportSum();
        if (needsMapping(dto, dto.getInventoryReportSumId(), "inventoryReportSumId")) {
            entity.setInventoryReportSumId(dto.getInventoryReportSumId());
        }
     ...
     */
    protected boolean needsMapping(ErInventoryReportSumDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ErInventoryReportSum> mappingToEntityList(List<ErInventoryReportSumDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ErInventoryReportSum> entityList = new ArrayList<ErInventoryReportSum>();
        for (ErInventoryReportSumDto dto : dtoList) {
            ErInventoryReportSum entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ErInventoryReportSumDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ErInventoryReportSumDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ErInventoryReportSumDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ErInventoryReportSumDtoMapper reverseReference() {
