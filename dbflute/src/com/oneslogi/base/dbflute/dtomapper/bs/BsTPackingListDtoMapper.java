...
/**
 * The DTO mapper of t_packing_list as TABLE. <br>
 * 梱包明細情報
 * <pre>
 * [primary-key]
 *     PACKING_LIST_ID
 ...
 */
public abstract class BsTPackingListDtoMapper implements DtoMapper<TPackingList, TPackingListDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTPackingListDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTPackingListDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TPackingListDto mappingToDto(TPackingList entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (TPackingListDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TPackingListDto dto = new TPackingListDto();
        ...
        if (!_suppressMClient && entity.getMClient() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getTPackingListList().add(dto);
                }
            } else {
                ...
                mapper.suppressTPackingListList();
     ...
     * {@inheritDoc}
     */
    public List<TPackingListDto> mappingToDtoList(List<TPackingList> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TPackingListDto> dtoList = new ArrayList<TPackingListDto>();
        for (TPackingList entity : entityList) {
            TPackingListDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TPackingList mappingToEntity(TPackingListDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (TPackingList)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TPackingList entity = new TPackingList();
        ...
        if (!_suppressMClient && dto.getMClient() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getTPackingListList().add(entity);
                }
            } else {
                MClientDtoMapper mapper = new MClientDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(TPackingListDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TPackingList> mappingToEntityList(List<TPackingListDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TPackingList> entityList = new ArrayList<TPackingList>();
        for (TPackingListDto dto : dtoList) {
            TPackingList entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TPackingListDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TPackingListDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TPackingListDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TPackingListDtoMapper reverseReference() {
