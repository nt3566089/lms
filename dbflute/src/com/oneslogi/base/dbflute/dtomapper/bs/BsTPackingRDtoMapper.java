...
public abstract class BsTPackingRDtoMapper implements DtoMapper<TPackingR, TPackingRDto>, Serializable {
    ...
    public TPackingRDto mappingToDto(TPackingR entity) {
        ...
        dto.setCdlOutFlg(entity.getCdlOutFlg());
        dto.setCdlOutUserId(entity.getCdlOutUserId());
        dto.setCdlOutDt(entity.getCdlOutDt());
    ...
    public TPackingR mappingToEntity(TPackingRDto dto) {
        ...
        if (needsMapping(dto, dto.getCdlOutFlg(), "cdlOutFlg")) {
            entity.setCdlOutFlg(dto.getCdlOutFlg());
        }
        if (needsMapping(dto, dto.getCdlOutUserId(), "cdlOutUserId")) {
            entity.setCdlOutUserId(dto.getCdlOutUserId());
        }
        if (needsMapping(dto, dto.getCdlOutDt(), "cdlOutDt")) {
            entity.setCdlOutDt(dto.getCdlOutDt());
        }
