...
public abstract class BsTPackingBDtoMapper implements DtoMapper<TPackingB, TPackingBDto>, Serializable {
    ...
    public TPackingBDto mappingToDto(TPackingB entity) {
        ...
        dto.setShippingPackingRowNo(entity.getShippingPackingRowNo());
        dto.setOldPackingBId(entity.getOldPackingBId());
    ...
    public TPackingB mappingToEntity(TPackingBDto dto) {
        ...
        if (needsMapping(dto, dto.getShippingPackingRowNo(), "shippingPackingRowNo")) {
            entity.setShippingPackingRowNo(dto.getShippingPackingRowNo());
        }
        if (needsMapping(dto, dto.getOldPackingBId(), "oldPackingBId")) {
            entity.setOldPackingBId(dto.getOldPackingBId());
        }
