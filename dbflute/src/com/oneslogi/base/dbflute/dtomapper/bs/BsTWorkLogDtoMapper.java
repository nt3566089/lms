...
public abstract class BsTWorkLogDtoMapper implements DtoMapper<TWorkLog, TWorkLogDto>, Serializable {
    ...
    public TWorkLogDto mappingToDto(TWorkLog entity) {
        ...
        dto.setForceCompleteFlg(entity.getForceCompleteFlg());
        dto.setWorkQtyCs(entity.getWorkQtyCs());
    ...
    public TWorkLog mappingToEntity(TWorkLogDto dto) {
        ...
        if (needsMapping(dto, dto.getForceCompleteFlg(), "forceCompleteFlg")) {
            entity.setForceCompleteFlg(dto.getForceCompleteFlg());
        }
        if (needsMapping(dto, dto.getWorkQtyCs(), "workQtyCs")) {
            entity.setWorkQtyCs(dto.getWorkQtyCs());
        }
