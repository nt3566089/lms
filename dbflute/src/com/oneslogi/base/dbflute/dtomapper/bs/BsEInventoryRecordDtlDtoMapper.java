...
/**
 * The DTO mapper of e_inventory_record_dtl as TABLE. <br>
 * 棚卸実績(明細)送信テーブル
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsEInventoryRecordDtlDtoMapper implements DtoMapper<EInventoryRecordDtl, EInventoryRecordDtlDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEInventoryRecordDtlDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEInventoryRecordDtlDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EInventoryRecordDtlDto mappingToDto(EInventoryRecordDtl entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EInventoryRecordDtlDto dto = new EInventoryRecordDtlDto();
     ...
     * {@inheritDoc}
     */
    public List<EInventoryRecordDtlDto> mappingToDtoList(List<EInventoryRecordDtl> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EInventoryRecordDtlDto> dtoList = new ArrayList<EInventoryRecordDtlDto>();
        for (EInventoryRecordDtl entity : entityList) {
            EInventoryRecordDtlDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EInventoryRecordDtl mappingToEntity(EInventoryRecordDtlDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EInventoryRecordDtl entity = new EInventoryRecordDtl();
     ...
     */
    protected boolean needsMapping(EInventoryRecordDtlDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EInventoryRecordDtl> mappingToEntityList(List<EInventoryRecordDtlDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EInventoryRecordDtl> entityList = new ArrayList<EInventoryRecordDtl>();
        for (EInventoryRecordDtlDto dto : dtoList) {
            EInventoryRecordDtl entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EInventoryRecordDtlDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EInventoryRecordDtlDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EInventoryRecordDtlDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EInventoryRecordDtlDtoMapper reverseReference() {
