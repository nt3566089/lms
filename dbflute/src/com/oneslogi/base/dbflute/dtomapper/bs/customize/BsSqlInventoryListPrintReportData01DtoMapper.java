...
/**
 * The DTO mapper of SqlInventoryListPrintReportData01. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlInventoryListPrintReportData01DtoMapper implements DtoMapper<SqlInventoryListPrintReportData01, SqlInventoryListPrintReportData01Dto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlInventoryListPrintReportData01DtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsSqlInventoryListPrintReportData01DtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public SqlInventoryListPrintReportData01Dto mappingToDto(SqlInventoryListPrintReportData01 entity) {
        if (entity == null) {
            return null;
        }
        SqlInventoryListPrintReportData01Dto dto = new SqlInventoryListPrintReportData01Dto();
     ...
     * {@inheritDoc}
     */
    public List<SqlInventoryListPrintReportData01Dto> mappingToDtoList(List<SqlInventoryListPrintReportData01> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<SqlInventoryListPrintReportData01Dto> dtoList = new ArrayList<SqlInventoryListPrintReportData01Dto>();
        for (SqlInventoryListPrintReportData01 entity : entityList) {
            SqlInventoryListPrintReportData01Dto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public SqlInventoryListPrintReportData01 mappingToEntity(SqlInventoryListPrintReportData01Dto dto) {
        if (dto == null) {
            return null;
        }
        SqlInventoryListPrintReportData01 entity = new SqlInventoryListPrintReportData01();
     ...
     */
    protected boolean needsMapping(SqlInventoryListPrintReportData01Dto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<SqlInventoryListPrintReportData01> mappingToEntityList(List<SqlInventoryListPrintReportData01Dto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<SqlInventoryListPrintReportData01> entityList = new ArrayList<SqlInventoryListPrintReportData01>();
        for (SqlInventoryListPrintReportData01Dto dto : dtoList) {
            SqlInventoryListPrintReportData01 entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public SqlInventoryListPrintReportData01DtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (SqlInventoryListPrintReportData01DtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public SqlInventoryListPrintReportData01DtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public SqlInventoryListPrintReportData01DtoMapper reverseReference() {
