...
/**
 * The DTO mapper of es_plant_storage_space as TABLE. <br>
 * プラント保管場所マスタ送信テーブル
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsEsPlantStorageSpaceDtoMapper implements DtoMapper<EsPlantStorageSpace, EsPlantStorageSpaceDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsPlantStorageSpaceDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEsPlantStorageSpaceDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EsPlantStorageSpaceDto mappingToDto(EsPlantStorageSpace entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsPlantStorageSpaceDto dto = new EsPlantStorageSpaceDto();
        dto.setPlantStorageSpaceId(entity.getPlantStorageSpaceId());
        ...
        dto.setStorageSpaceNm1(entity.getStorageSpaceNm1());
        dto.setStorageSpaceNm2(entity.getStorageSpaceNm2());
        dto.setCountryNm(entity.getCountryNm());
        ...
        dto.setLangNm(entity.getLangNm());
     ...
     * {@inheritDoc}
     */
    public List<EsPlantStorageSpaceDto> mappingToDtoList(List<EsPlantStorageSpace> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EsPlantStorageSpaceDto> dtoList = new ArrayList<EsPlantStorageSpaceDto>();
        for (EsPlantStorageSpace entity : entityList) {
            EsPlantStorageSpaceDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EsPlantStorageSpace mappingToEntity(EsPlantStorageSpaceDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsPlantStorageSpace entity = new EsPlantStorageSpace();
        if (needsMapping(dto, dto.getPlantStorageSpaceId(), "plantStorageSpaceId")) {
            entity.setPlantStorageSpaceId(dto.getPlantStorageSpaceId());
        }
        ...
        if (needsMapping(dto, dto.getStorageSpaceNm1(), "storageSpaceNm1")) {
            entity.setStorageSpaceNm1(dto.getStorageSpaceNm1());
        }
        if (needsMapping(dto, dto.getStorageSpaceNm2(), "storageSpaceNm2")) {
            entity.setStorageSpaceNm2(dto.getStorageSpaceNm2());
        }
        if (needsMapping(dto, dto.getCountryNm(), "countryNm")) {
            entity.setCountryNm(dto.getCountryNm());
        }
        ...
        if (needsMapping(dto, dto.getLangNm(), "langNm")) {
            entity.setLangNm(dto.getLangNm());
        }
     ...
     */
    protected boolean needsMapping(EsPlantStorageSpaceDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EsPlantStorageSpace> mappingToEntityList(List<EsPlantStorageSpaceDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EsPlantStorageSpace> entityList = new ArrayList<EsPlantStorageSpace>();
        for (EsPlantStorageSpaceDto dto : dtoList) {
            EsPlantStorageSpace entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EsPlantStorageSpaceDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EsPlantStorageSpaceDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EsPlantStorageSpaceDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EsPlantStorageSpaceDtoMapper reverseReference() {
