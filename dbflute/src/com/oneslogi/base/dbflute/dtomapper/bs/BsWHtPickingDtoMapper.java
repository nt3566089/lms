...
/**
 * The DTO mapper of w_ht_picking as TABLE. <br>
 * ピッキングワーク
 * <pre>
 * [primary-key]
 *     HT_PICKING_ID
 ...
 */
public abstract class BsWHtPickingDtoMapper implements DtoMapper<WHtPicking, WHtPickingDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWHtPickingDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsWHtPickingDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public WHtPickingDto mappingToDto(WHtPicking entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (WHtPickingDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WHtPickingDto dto = new WHtPickingDto();
        dto.setHtPickingId(entity.getHtPickingId());
        ...
        if (!_suppressTLot && entity.getTLot() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getWHtPickingList().add(dto);
                }
            } else {
     ...
     * {@inheritDoc}
     */
    public List<WHtPickingDto> mappingToDtoList(List<WHtPicking> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<WHtPickingDto> dtoList = new ArrayList<WHtPickingDto>();
        for (WHtPicking entity : entityList) {
            WHtPickingDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public WHtPicking mappingToEntity(WHtPickingDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (WHtPicking)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WHtPicking entity = new WHtPicking();
        if (needsMapping(dto, dto.getHtPickingId(), "htPickingId")) {
            entity.setHtPickingId(dto.getHtPickingId());
        }
        ...
        if (!_suppressTLot && dto.getTLot() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getWHtPickingList().add(entity);
                }
            } else {
                TLotDtoMapper mapper = new TLotDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(WHtPickingDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<WHtPicking> mappingToEntityList(List<WHtPickingDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<WHtPicking> entityList = new ArrayList<WHtPicking>();
        for (WHtPickingDto dto : dtoList) {
            WHtPicking entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public WHtPickingDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (WHtPickingDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public WHtPickingDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public WHtPickingDtoMapper reverseReference() {
