...
/**
 * The DTO mapper of es_stock_record as TABLE. <br>
 * 在庫実績送信テーブル
 * <pre>
 * [primary-key]
 *     PACKING_LIST_ID
 ...
 */
public abstract class BsEsStockRecordDtoMapper implements DtoMapper<EsStockRecord, EsStockRecordDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsStockRecordDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEsStockRecordDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EsStockRecordDto mappingToDto(EsStockRecord entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsStockRecordDto dto = new EsStockRecordDto();
     ...
     * {@inheritDoc}
     */
    public List<EsStockRecordDto> mappingToDtoList(List<EsStockRecord> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EsStockRecordDto> dtoList = new ArrayList<EsStockRecordDto>();
        for (EsStockRecord entity : entityList) {
            EsStockRecordDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EsStockRecord mappingToEntity(EsStockRecordDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsStockRecord entity = new EsStockRecord();
     ...
     */
    protected boolean needsMapping(EsStockRecordDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EsStockRecord> mappingToEntityList(List<EsStockRecordDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EsStockRecord> entityList = new ArrayList<EsStockRecord>();
        for (EsStockRecordDto dto : dtoList) {
            EsStockRecord entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EsStockRecordDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EsStockRecordDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EsStockRecordDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EsStockRecordDtoMapper reverseReference() {
