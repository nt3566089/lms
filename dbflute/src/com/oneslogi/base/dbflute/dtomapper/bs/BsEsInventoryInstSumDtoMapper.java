...
/**
 * The DTO mapper of es_inventory_inst_sum as TABLE. <br>
 * 棚卸指示(集約)送信テーブル
 * <pre>
 * [primary-key]
 *     INVENTORY_INST_ID
 ...
 */
public abstract class BsEsInventoryInstSumDtoMapper implements DtoMapper<EsInventoryInstSum, EsInventoryInstSumDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsInventoryInstSumDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEsInventoryInstSumDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EsInventoryInstSumDto mappingToDto(EsInventoryInstSum entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsInventoryInstSumDto dto = new EsInventoryInstSumDto();
     ...
     * {@inheritDoc}
     */
    public List<EsInventoryInstSumDto> mappingToDtoList(List<EsInventoryInstSum> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EsInventoryInstSumDto> dtoList = new ArrayList<EsInventoryInstSumDto>();
        for (EsInventoryInstSum entity : entityList) {
            EsInventoryInstSumDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EsInventoryInstSum mappingToEntity(EsInventoryInstSumDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsInventoryInstSum entity = new EsInventoryInstSum();
     ...
     */
    protected boolean needsMapping(EsInventoryInstSumDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EsInventoryInstSum> mappingToEntityList(List<EsInventoryInstSumDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EsInventoryInstSum> entityList = new ArrayList<EsInventoryInstSum>();
        for (EsInventoryInstSumDto dto : dtoList) {
            EsInventoryInstSum entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EsInventoryInstSumDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EsInventoryInstSumDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EsInventoryInstSumDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EsInventoryInstSumDtoMapper reverseReference() {
