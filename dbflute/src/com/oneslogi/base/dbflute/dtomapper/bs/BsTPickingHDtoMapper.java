...
public abstract class BsTPickingHDtoMapper implements DtoMapper<TPickingH, TPickingHDto>, Serializable {
    ...
    public TPickingHDto mappingToDto(TPickingH entity) {
        ...
        dto.setPickForceCopleteFlg(entity.getPickForceCopleteFlg());
        dto.setInspForceCopleteFlg(entity.getInspForceCopleteFlg());
        dto.setPrintStatus(entity.getPrintStatus());
        dto.setNizoroePrintTypeCd(entity.getNizoroePrintTypeCd());
        dto.setDelivPrintTypeCd(entity.getDelivPrintTypeCd());
        dto.setTagPrintTypeCd(entity.getTagPrintTypeCd());
        dto.setIntegPrintFlg(entity.getIntegPrintFlg());
        dto.setIdManagPrintTypeCd(entity.getIdManagPrintTypeCd());
        dto.setPllPrintFlg(entity.getPllPrintFlg());
    ...
    public TPickingH mappingToEntity(TPickingHDto dto) {
        ...
        if (needsMapping(dto, dto.getPickForceCopleteFlg(), "pickForceCopleteFlg")) {
            entity.setPickForceCopleteFlg(dto.getPickForceCopleteFlg());
        }
        if (needsMapping(dto, dto.getInspForceCopleteFlg(), "inspForceCopleteFlg")) {
            entity.setInspForceCopleteFlg(dto.getInspForceCopleteFlg());
        }
        if (needsMapping(dto, dto.getPrintStatus(), "printStatus")) {
            entity.setPrintStatus(dto.getPrintStatus());
        }
        if (needsMapping(dto, dto.getNizoroePrintTypeCd(), "nizoroePrintTypeCd")) {
            entity.setNizoroePrintTypeCd(dto.getNizoroePrintTypeCd());
        }
        if (needsMapping(dto, dto.getDelivPrintTypeCd(), "delivPrintTypeCd")) {
            entity.setDelivPrintTypeCd(dto.getDelivPrintTypeCd());
        }
        if (needsMapping(dto, dto.getTagPrintTypeCd(), "tagPrintTypeCd")) {
            entity.setTagPrintTypeCd(dto.getTagPrintTypeCd());
        }
        if (needsMapping(dto, dto.getIntegPrintFlg(), "integPrintFlg")) {
            entity.setIntegPrintFlg(dto.getIntegPrintFlg());
        }
        if (needsMapping(dto, dto.getIdManagPrintTypeCd(), "idManagPrintTypeCd")) {
            entity.setIdManagPrintTypeCd(dto.getIdManagPrintTypeCd());
        }
        if (needsMapping(dto, dto.getPllPrintFlg(), "pllPrintFlg")) {
            entity.setPllPrintFlg(dto.getPllPrintFlg());
        }
