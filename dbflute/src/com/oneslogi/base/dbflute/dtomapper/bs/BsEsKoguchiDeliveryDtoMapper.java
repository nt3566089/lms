...
/**
 * The DTO mapper of es_koguchi_delivery as TABLE. <br>
 * 戸口配送マスタ送信テーブル
 * <pre>
 * [primary-key]
 *     KOGUCHI_DELIVERY_ID
 ...
 */
public abstract class BsEsKoguchiDeliveryDtoMapper implements DtoMapper<EsKoguchiDelivery, EsKoguchiDeliveryDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsKoguchiDeliveryDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEsKoguchiDeliveryDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EsKoguchiDeliveryDto mappingToDto(EsKoguchiDelivery entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsKoguchiDeliveryDto dto = new EsKoguchiDeliveryDto();
     ...
     * {@inheritDoc}
     */
    public List<EsKoguchiDeliveryDto> mappingToDtoList(List<EsKoguchiDelivery> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EsKoguchiDeliveryDto> dtoList = new ArrayList<EsKoguchiDeliveryDto>();
        for (EsKoguchiDelivery entity : entityList) {
            EsKoguchiDeliveryDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EsKoguchiDelivery mappingToEntity(EsKoguchiDeliveryDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsKoguchiDelivery entity = new EsKoguchiDelivery();
     ...
     */
    protected boolean needsMapping(EsKoguchiDeliveryDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EsKoguchiDelivery> mappingToEntityList(List<EsKoguchiDeliveryDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EsKoguchiDelivery> entityList = new ArrayList<EsKoguchiDelivery>();
        for (EsKoguchiDeliveryDto dto : dtoList) {
            EsKoguchiDelivery entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EsKoguchiDeliveryDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EsKoguchiDeliveryDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EsKoguchiDeliveryDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EsKoguchiDeliveryDtoMapper reverseReference() {
