...
/**
 * The DTO mapper of er_packing_list as TABLE. <br>
 * 梱包明細受信テーブル
 * <pre>
 * [primary-key]
 *     PACKING_LIST_ID
 ...
 */
public abstract class BsErPackingListDtoMapper implements DtoMapper<ErPackingList, ErPackingListDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsErPackingListDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsErPackingListDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ErPackingListDto mappingToDto(ErPackingList entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErPackingListDto dto = new ErPackingListDto();
     ...
     * {@inheritDoc}
     */
    public List<ErPackingListDto> mappingToDtoList(List<ErPackingList> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ErPackingListDto> dtoList = new ArrayList<ErPackingListDto>();
        for (ErPackingList entity : entityList) {
            ErPackingListDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ErPackingList mappingToEntity(ErPackingListDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErPackingList entity = new ErPackingList();
     ...
     */
    protected boolean needsMapping(ErPackingListDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ErPackingList> mappingToEntityList(List<ErPackingListDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ErPackingList> entityList = new ArrayList<ErPackingList>();
        for (ErPackingListDto dto : dtoList) {
            ErPackingList entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ErPackingListDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ErPackingListDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ErPackingListDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ErPackingListDtoMapper reverseReference() {
