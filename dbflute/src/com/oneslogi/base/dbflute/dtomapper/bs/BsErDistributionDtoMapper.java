...
/**
 * The DTO mapper of er_distribution as TABLE. <br>
 * 流通加工情報受信テーブル
 * <pre>
 * [primary-key]
 *     DISTRIBUTION_ID
 ...
 */
public abstract class BsErDistributionDtoMapper implements DtoMapper<ErDistribution, ErDistributionDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsErDistributionDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsErDistributionDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ErDistributionDto mappingToDto(ErDistribution entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErDistributionDto dto = new ErDistributionDto();
     ...
     * {@inheritDoc}
     */
    public List<ErDistributionDto> mappingToDtoList(List<ErDistribution> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ErDistributionDto> dtoList = new ArrayList<ErDistributionDto>();
        for (ErDistribution entity : entityList) {
            ErDistributionDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ErDistribution mappingToEntity(ErDistributionDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErDistribution entity = new ErDistribution();
     ...
     */
    protected boolean needsMapping(ErDistributionDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ErDistribution> mappingToEntityList(List<ErDistributionDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ErDistribution> entityList = new ArrayList<ErDistribution>();
        for (ErDistributionDto dto : dtoList) {
            ErDistribution entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ErDistributionDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ErDistributionDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ErDistributionDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ErDistributionDtoMapper reverseReference() {
