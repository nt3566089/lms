...
/**
 * The DTO mapper of e_transfer as TABLE. <br>
 * 振替送信テーブル
 * <pre>
 * [primary-key]
 *     TRANSFER_ID
 ...
 */
public abstract class BsETransferDtoMapper implements DtoMapper<ETransfer, ETransferDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsETransferDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsETransferDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ETransferDto mappingToDto(ETransfer entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ETransferDto dto = new ETransferDto();
     ...
     * {@inheritDoc}
     */
    public List<ETransferDto> mappingToDtoList(List<ETransfer> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ETransferDto> dtoList = new ArrayList<ETransferDto>();
        for (ETransfer entity : entityList) {
            ETransferDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ETransfer mappingToEntity(ETransferDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ETransfer entity = new ETransfer();
     ...
     */
    protected boolean needsMapping(ETransferDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ETransfer> mappingToEntityList(List<ETransferDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ETransfer> entityList = new ArrayList<ETransfer>();
        for (ETransferDto dto : dtoList) {
            ETransfer entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ETransferDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ETransferDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ETransferDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ETransferDtoMapper reverseReference() {
