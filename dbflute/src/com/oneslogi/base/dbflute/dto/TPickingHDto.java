...
public class TPickingHDto extends BsTPickingHDto {
	...
	// ミドリ安全様向けカスタマイズ対応 検索条件を追加 2024.06.13 zheng Add [S]
	// 検索基準日
	private String searchReferenceDt;
	// 出荷帳票発行区分
	private String shippingSlipType;
	// 荷揃番号(From)
	...
	// ミドリ安全様向けカスタマイズ対応 検索条件を追加 2024.06.13 zheng Add [E]
