...
public abstract class BsTPickingHDto implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(c).append(getPllPrintFlg());
     ...
     * 梱包明細印刷フラグ
     * @return The value of the column 'PLL_PRINT_FLG'. (NullAllowed)
     */
     ...
     * 梱包明細印刷フラグ
     * @param pllPrintFlg The value of the column 'PLL_PRINT_FLG'. (NullAllowed)
     */
    public void setPllPrintFlg(String pllPrintFlg) {
        __modifiedProperties.add("pllPrintFlg");
        this._pllPrintFlg = pllPrintFlg;
    }
