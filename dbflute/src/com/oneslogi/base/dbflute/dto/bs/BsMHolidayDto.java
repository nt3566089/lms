...
/**
 * The simple DTO of m_holiday as TABLE. <br>
 * 休日祝日マスタ
 * <pre>
 * [primary-key]
 *     HOLIDAY_ID
...
public abstract class BsMHolidayDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMHolidayDto)) { return false; }
        final BsMHolidayDto otherEntity = (BsMHolidayDto)other;
        if (!helpComparingValue(getHolidayId(), otherEntity.getHolidayId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "m_holiday");
        result = xCH(result, getHolidayId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getHolidayId());
        sb.append(c).append(getBaseCd());
        sb.append(c).append(getCalenderDt());
        sb.append(c).append(getHolidayFlg());
        sb.append(c).append(getNationalHolidayFlg());
     ...
     * 休日祝日ID
     * @return The value of the column 'HOLIDAY_ID'. (NullAllowed)
     */
     ...
     * 休日祝日ID
     * @param holidayId The value of the column 'HOLIDAY_ID'. (NullAllowed)
     */
    public void setHolidayId(Long holidayId) {
        __modifiedProperties.add("holidayId");
     ...
     * カレンダー日付
     * @return The value of the column 'CALENDER_DT'. (NullAllowed)
     */
     ...
     * カレンダー日付
     * @param calenderDt The value of the column 'CALENDER_DT'. (NullAllowed)
     */
    public void setCalenderDt(String calenderDt) {
        __modifiedProperties.add("calenderDt");
        this._calenderDt = calenderDt;
    }

    /**
     * [get] HOLIDAY_FLG: {NotNull, CHAR(1), default=[0]} <br>
     * 休日フラグ
     * @return The value of the column 'HOLIDAY_FLG'. (NullAllowed)
     */
     ...
     * 休日フラグ
     * @param holidayFlg The value of the column 'HOLIDAY_FLG'. (NullAllowed)
     */
    public void setHolidayFlg(String holidayFlg) {
        __modifiedProperties.add("holidayFlg");
        this._holidayFlg = holidayFlg;
    }

    /**
     * [get] NATIONAL_HOLIDAY_FLG: {NotNull, CHAR(1), default=[0]} <br>
     * 祝日フラグ
     * @return The value of the column 'NATIONAL_HOLIDAY_FLG'. (NullAllowed)
     */
     ...
     * 祝日フラグ
     * @param nationalHolidayFlg The value of the column 'NATIONAL_HOLIDAY_FLG'. (NullAllowed)
     */
    public void setNationalHolidayFlg(String nationalHolidayFlg) {
        __modifiedProperties.add("nationalHolidayFlg");
        this._nationalHolidayFlg = nationalHolidayFlg;
    }
