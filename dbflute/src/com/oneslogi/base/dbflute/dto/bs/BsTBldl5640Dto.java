...
/**
 * The simple DTO of t_bldl5640 as TABLE. <br>
 * BLDL5640
 * <pre>
 * [primary-key]
 *     BLDL5640_ID
...
public abstract class BsTBldl5640Dto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTBldl5640Dto)) { return false; }
        final BsTBldl5640Dto otherEntity = (BsTBldl5640Dto)other;
        if (!helpComparingValue(getBldl5640Id(), otherEntity.getBldl5640Id())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "t_bldl5640");
        result = xCH(result, getBldl5640Id());
        return result;
    }
     ...
     * BLDL5640ID
     * @return The value of the column 'BLDL5640_ID'. (NullAllowed)
     */
     ...
     * BLDL5640ID
     * @param bldl5640Id The value of the column 'BLDL5640_ID'. (NullAllowed)
     */
    public void setBldl5640Id(Long bldl5640Id) {
        __modifiedProperties.add("bldl5640Id");
        this._bldl5640Id = bldl5640Id;
    }
     ...
     * 越谷US_出荷件数
     * @return The value of the column 'KOSHIGAYA_SHIPPING_CNT'. (NullAllowed)
     */
     ...
     * 越谷US_出荷件数
     * @param koshigayaShippingCnt The value of the column 'KOSHIGAYA_SHIPPING_CNT'. (NullAllowed)
     */
    public void setKoshigayaShippingCnt(Long koshigayaShippingCnt) {
        __modifiedProperties.add("koshigayaShippingCnt");
        this._koshigayaShippingCnt = koshigayaShippingCnt;
    }

    /**
     * [get] KOSHIGAYA_SHIPPING_NUM: {BIGINT(19)} <br>
     * 越谷US_出荷数量
     * @return The value of the column 'KOSHIGAYA_SHIPPING_NUM'. (NullAllowed)
     */
     ...
     * 越谷US_出荷数量
     * @param koshigayaShippingNum The value of the column 'KOSHIGAYA_SHIPPING_NUM'. (NullAllowed)
     */
    public void setKoshigayaShippingNum(Long koshigayaShippingNum) {
        __modifiedProperties.add("koshigayaShippingNum");
        this._koshigayaShippingNum = koshigayaShippingNum;
    }
