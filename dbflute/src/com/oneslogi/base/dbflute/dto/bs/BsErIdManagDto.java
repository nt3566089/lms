...
/**
 * The simple DTO of er_id_manag as TABLE. <br>
 * 個体管理情報連携受信テーブル
 * <pre>
 * [primary-key]
 *     ID_MANAG_ID
...
public abstract class BsErIdManagDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsErIdManagDto)) { return false; }
        final BsErIdManagDto otherEntity = (BsErIdManagDto)other;
    ...
    //                                                                            ========
    /**
     * [get] ID_MANAG_ID: {PK, NotNull, BIGINT(19)} <br>
     * 個体管理情報連携受信ID
    ...
    /**
     * [set] ID_MANAG_ID: {PK, NotNull, BIGINT(19)} <br>
     * 個体管理情報連携受信ID
