 ...
 *
 * [foreign-table]
 *     m_customer, m_client, m_center
 *
 * [referrer-table]
 *     
 *
 * [foreign-property]
 *     mCustomer, mClient, mCenter
 *
 * [referrer-property]
 *     
 * </pre>
...
public abstract class BsWHtSerialReceiveInspDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] HT_SERIAL_RECEIVE_INSP_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * シリアル登録(入荷)ワークID
    ...
    /**
     * [set] HT_SERIAL_RECEIVE_INSP_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * シリアル登録(入荷)ワークID
