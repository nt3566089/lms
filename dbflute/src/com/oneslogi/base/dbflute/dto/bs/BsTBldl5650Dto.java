...
/**
 * The simple DTO of t_bldl5650 as TABLE. <br>
 * BLDL5650
 * <pre>
 * [primary-key]
 *     BLDL5650_ID
...
public abstract class BsTBldl5650Dto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTBldl5650Dto)) { return false; }
        final BsTBldl5650Dto otherEntity = (BsTBldl5650Dto)other;
        if (!helpComparingValue(getBldl5650Id(), otherEntity.getBldl5650Id())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "t_bldl5650");
        result = xCH(result, getBldl5650Id());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getBldl5650Id());
        ...
        sb.append(c).append(getUnNum());
        sb.append(c).append(getShNum());
     ...
     * BLDL5650ID
     * @return The value of the column 'BLDL5650_ID'. (NullAllowed)
     */
     ...
     * BLDL5650ID
     * @param bldl5650Id The value of the column 'BLDL5650_ID'. (NullAllowed)
     */
    public void setBldl5650Id(Long bldl5650Id) {
        __modifiedProperties.add("bldl5650Id");
        this._bldl5650Id = bldl5650Id;
    }
     ...
     * UN関連
     * @return The value of the column 'UN_NUM'. (NullAllowed)
     */
     ...
     * UN関連
     * @param unNum The value of the column 'UN_NUM'. (NullAllowed)
     */
    public void setUnNum(Long unNum) {
        __modifiedProperties.add("unNum");
        this._unNum = unNum;
    }
     ...
     * SH関連
     * @return The value of the column 'SH_NUM'. (NullAllowed)
     */
     ...
     * SH関連
     * @param shNum The value of the column 'SH_NUM'. (NullAllowed)
     */
    public void setShNum(Long shNum) {
        __modifiedProperties.add("shNum");
        this._shNum = shNum;
    }
