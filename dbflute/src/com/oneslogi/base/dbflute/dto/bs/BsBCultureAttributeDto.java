...
public abstract class BsBCultureAttributeDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] CULTURE_ID: {PK, NotNull, BIGINT(19), FK to b_culture} <br>
     * カルチャID
    ...
    /**
     * [set] CULTURE_ID: {PK, NotNull, BIGINT(19), FK to b_culture} <br>
     * カルチャID
    ...
    /**
     * [get] FONT_SIZE_EXCEL: {DECIMAL(14, 4)} <br>
     * フォントサイズ（Excel）
    ...
    /**
     * [set] FONT_SIZE_EXCEL: {DECIMAL(14, 4)} <br>
     * フォントサイズ（Excel）
