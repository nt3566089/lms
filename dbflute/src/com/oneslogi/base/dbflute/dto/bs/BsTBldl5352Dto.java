...
/**
 * The simple DTO of t_bldl5352 as TABLE. <br>
 * BLDL5352
 * <pre>
 * [primary-key]
 *     BLDL5352_ID
...
public abstract class BsTBldl5352Dto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTBldl5352Dto)) { return false; }
        final BsTBldl5352Dto otherEntity = (BsTBldl5352Dto)other;
        if (!helpComparingValue(getBldl5352Id(), otherEntity.getBldl5352Id())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "t_bldl5352");
        result = xCH(result, getBldl5352Id());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getBldl5352Id());
     ...
     * BLDL5352ID
     * @return The value of the column 'BLDL5352_ID'. (NullAllowed)
     */
     ...
     * BLDL5352ID
     * @param bldl5352Id The value of the column 'BLDL5352_ID'. (NullAllowed)
     */
    public void setBldl5352Id(Long bldl5352Id) {
        __modifiedProperties.add("bldl5352Id");
        this._bldl5352Id = bldl5352Id;
    }
