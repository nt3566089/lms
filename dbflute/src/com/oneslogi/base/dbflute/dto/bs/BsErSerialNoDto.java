...
/**
 * The simple DTO of er_serial_no as TABLE. <br>
 * シリアル番号情報受信テーブル
 * <pre>
 * [primary-key]
 *     SERIAL_NO_ID
...
public abstract class BsErSerialNoDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsErSerialNoDto)) { return false; }
        final BsErSerialNoDto otherEntity = (BsErSerialNoDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "er_serial_no");
