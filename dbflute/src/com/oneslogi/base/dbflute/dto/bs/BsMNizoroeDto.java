...
/**
 * The simple DTO of m_nizoroe as TABLE. <br>
 * 荷揃マスタ
 * <pre>
 * [primary-key]
 *     NIZOROE_ID
...
public abstract class BsMNizoroeDto implements Serializable {
    ...
    protected MNizoroePaternDto _mNizoroePatern;

    public MNizoroePaternDto getMNizoroePatern() {
        return _mNizoroePatern;
    }

    public void setMNizoroePatern(MNizoroePaternDto mNizoroePatern) {
        this._mNizoroePatern = mNizoroePatern;
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMNizoroeDto)) { return false; }
        final BsMNizoroeDto otherEntity = (BsMNizoroeDto)other;
