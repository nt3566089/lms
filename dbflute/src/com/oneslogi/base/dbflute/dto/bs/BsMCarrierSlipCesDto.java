...
public abstract class BsMCarrierSlipCesDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] CUSTOMER_ID: {PK, NotNull, BIGINT(19), FK to m_customer} <br>
     * 取引先ID
    ...
    /**
     * [set] CUSTOMER_ID: {PK, NotNull, BIGINT(19), FK to m_customer} <br>
     * 取引先ID
    ...
    /**
     * [get] COD_AMOUNT: {DECIMAL(14, 4)} <br>
     * COD Amount
    ...
    /**
     * [set] COD_AMOUNT: {DECIMAL(14, 4)} <br>
     * COD Amount
