 ...
 *
 * [foreign-table]
 *     m_center, m_import_type, m_client, t_shipping_inst_h, b_class_dtl(ByDelivMatchFlg), t_ec_order_r(AsOne)
 *
 * [referrer-table]
 *     t_ec_order_b, t_ec_order_r
 *
 * [foreign-property]
 *     mCenter, mImportType, mClient, tShippingInstH, bClassDtlByDelivMatchFlg, bClassDtlByErrorFlg, bClassDtlByGiftFlg, bClassDtlByImportFlg, bClassDtlByPriorityFlg, tEcOrderRAsOne
 *
 * [referrer-property]
 *     tEcOrderBList
 * </pre>
...
public abstract class BsTEcOrderHDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] EC_ORDER_H_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * EC受注ヘッダID
    ...
    /**
     * [set] EC_ORDER_H_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * EC受注ヘッダID
    ...
    /**
     * [get] CLIENT_ID: {IX, BIGINT(19), FK to m_client} <br>
     * 荷主ID
    ...
    /**
     * [set] CLIENT_ID: {IX, BIGINT(19), FK to m_client} <br>
     * 荷主ID
    ...
    /**
     * [get] CENTER_ID: {IX, BIGINT(19), FK to m_center} <br>
     * センタID
    ...
    /**
     * [set] CENTER_ID: {IX, BIGINT(19), FK to m_center} <br>
     * センタID
    ...
    /**
     * [get] SLIP_ITEM_NM1: {LONGTEXT(2147483647)} <br>
     * 品名1
    ...
    /**
     * [set] SLIP_ITEM_NM1: {LONGTEXT(2147483647)} <br>
     * 品名1
