...
/**
 * The simple DTO of t_bldl5151 as TABLE. <br>
 * BLDL5151
 * <pre>
 * [primary-key]
 *     BLDL5151_ID
...
public abstract class BsTBldl5151Dto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTBldl5151Dto)) { return false; }
        final BsTBldl5151Dto otherEntity = (BsTBldl5151Dto)other;
        if (!helpComparingValue(getBldl5151Id(), otherEntity.getBldl5151Id())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "t_bldl5151");
        result = xCH(result, getBldl5151Id());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getBldl5151Id());
     ...
     * BLDL5151ID
     * @return The value of the column 'BLDL5151_ID'. (NullAllowed)
     */
     ...
     * BLDL5151ID
     * @param bldl5151Id The value of the column 'BLDL5151_ID'. (NullAllowed)
     */
    public void setBldl5151Id(Long bldl5151Id) {
        __modifiedProperties.add("bldl5151Id");
        this._bldl5151Id = bldl5151Id;
    }
