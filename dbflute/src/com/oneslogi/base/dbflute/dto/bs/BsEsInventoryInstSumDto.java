...
/**
 * The simple DTO of es_inventory_inst_sum as TABLE. <br>
 * 棚卸指示(集約)送信テーブル
 * <pre>
 * [primary-key]
 *     INVENTORY_INST_ID
...
public abstract class BsEsInventoryInstSumDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsInventoryInstSumDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEsInventoryInstSumDto)) { return false; }
        final BsEsInventoryInstSumDto otherEntity = (BsEsInventoryInstSumDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "es_inventory_inst_sum");
