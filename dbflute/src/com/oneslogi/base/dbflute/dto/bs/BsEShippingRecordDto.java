...
/**
 * The simple DTO of e_shipping_record as TABLE. <br>
 * 出荷実績送信テーブル
 * <pre>
 * [primary-key]
 *     SHIPPING_RECORD_ID
...
public abstract class BsEShippingRecordDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEShippingRecordDto)) { return false; }
        final BsEShippingRecordDto otherEntity = (BsEShippingRecordDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "e_shipping_record");
    ...
    public String toString() {
        ...
        sb.append(c).append(getPlSendFlg());
     ...
     * 梱包明細送信済フラグ
     * @return The value of the column 'PL_SEND_FLG'. (NullAllowed)
     */
     ...
     * 梱包明細送信済フラグ
     * @param plSendFlg The value of the column 'PL_SEND_FLG'. (NullAllowed)
     */
    public void setPlSendFlg(String plSendFlg) {
        __modifiedProperties.add("plSendFlg");
        this._plSendFlg = plSendFlg;
    }
