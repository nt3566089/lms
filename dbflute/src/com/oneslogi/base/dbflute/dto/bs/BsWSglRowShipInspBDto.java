 ...
 *
 * [foreign-table]
 *     t_picking_h, b_user, w_sgl_row_ship_insp_h, b_class_dtl(ByInspectionFlg)
 *
 * [referrer-table]
 *     
 *
 * [foreign-property]
 *     tPickingH, bUser, wSglRowShipInspH, bClassDtlByInspectionFlg
 *
 * [referrer-property]
 *     
 * </pre>
...
public abstract class BsWSglRowShipInspBDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] SGL_ROW_SHIP_INSP_B_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 単行出荷検品ワークボディID
    ...
    /**
     * [set] SGL_ROW_SHIP_INSP_B_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 単行出荷検品ワークボディID
