...
public abstract class BsTShippingInstSpareDto implements Serializable {
    ...
    //                                                Column
    //                                                ------
    /** SHIPPING_INST_B_ID: {PK, NotNull, BIGINT(19), FK to t_shipping_inst_b} */
    @JsonKey
    ...
    //                                                                            ========
    /**
     * [get] SHIPPING_INST_B_ID: {PK, NotNull, BIGINT(19), FK to t_shipping_inst_b} <br>
     * 出荷指示ボディID
    ...
    /**
     * [set] SHIPPING_INST_B_ID: {PK, NotNull, BIGINT(19), FK to t_shipping_inst_b} <br>
     * 出荷指示ボディID
    ...
    /**
     * [get] SPARE_NUM_1: {DECIMAL(14, 4)} <br>
     * 予備項目１（数値）
    ...
    /**
     * [set] SPARE_NUM_1: {DECIMAL(14, 4)} <br>
     * 予備項目１（数値）
    ...
    /**
     * [get] SPARE_NUM_2: {DECIMAL(14, 4)} <br>
     * 予備項目２（数値）
    ...
    /**
     * [set] SPARE_NUM_2: {DECIMAL(14, 4)} <br>
     * 予備項目２（数値）
    ...
    /**
     * [get] SPARE_NUM_3: {DECIMAL(14, 4)} <br>
     * 予備項目３（数値）
    ...
    /**
     * [set] SPARE_NUM_3: {DECIMAL(14, 4)} <br>
     * 予備項目３（数値）
