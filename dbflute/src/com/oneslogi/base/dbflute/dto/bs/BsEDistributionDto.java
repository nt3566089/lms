...
/**
 * The simple DTO of e_distribution as TABLE. <br>
 * 流通加工情報送信テーブル
 * <pre>
 * [primary-key]
 *     DISTRIBUTION_ID
...
public abstract class BsEDistributionDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEDistributionDto)) { return false; }
        final BsEDistributionDto otherEntity = (BsEDistributionDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "e_distribution");
