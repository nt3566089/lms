...
public abstract class BsMCustomerDto implements Serializable {
    ...
    protected MPlantStorageSpaceDto _mPlantStorageSpaceByCd;

    public MPlantStorageSpaceDto getMPlantStorageSpaceByCd() {
        return _mPlantStorageSpaceByCd;
    }

    public void setMPlantStorageSpaceByCd(MPlantStorageSpaceDto mPlantStorageSpaceByCd) {
        this._mPlantStorageSpaceByCd = mPlantStorageSpaceByCd;
    }
    ...
    protected List<TShippingInstHDto> _tShippingInstHByAccoutIdList;

    public List<TShippingInstHDto> getTShippingInstHByAccoutIdList() {
        if (_tShippingInstHByAccoutIdList == null) { _tShippingInstHByAccoutIdList = new ArrayList<TShippingInstHDto>(); }
        return _tShippingInstHByAccoutIdList;
    }

    public void setTShippingInstHByAccoutIdList(List<TShippingInstHDto> tShippingInstHByAccoutIdList) {
        this._tShippingInstHByAccoutIdList = tShippingInstHByAccoutIdList;
    }
