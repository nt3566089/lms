...
public abstract class BsSqlCasePickingDataListDto implements Serializable {
    ...
    /**
     * [get] zone_picking_order: {BIGINT(20)} <br>
    ...
    /**
     * [set] zone_picking_order: {BIGINT(20)} <br>
    ...
    /**
     * [get] location_picking_order: {BIGINT(20)} <br>
    ...
    /**
     * [set] location_picking_order: {BIGINT(20)} <br>
