...
public abstract class BsTMoveInstHDto implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(c).append(getKohaiTypeCd());
     ...
     * 戸配区分
     * @return The value of the column 'KOHAI_TYPE_CD'. (NullAllowed)
     */
     ...
     * 戸配区分
     * @param kohaiTypeCd The value of the column 'KOHAI_TYPE_CD'. (NullAllowed)
     */
    public void setKohaiTypeCd(String kohaiTypeCd) {
        __modifiedProperties.add("kohaiTypeCd");
        this._kohaiTypeCd = kohaiTypeCd;
    }
