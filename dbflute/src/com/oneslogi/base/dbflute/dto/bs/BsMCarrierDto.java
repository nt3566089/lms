...
public abstract class BsMCarrierDto implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(c).append(getProperFlg());
     ...
     * 正規フラグ
     * @return The value of the column 'PROPER_FLG'. (NullAllowed)
     */
     ...
     * 正規フラグ
     * @param properFlg The value of the column 'PROPER_FLG'. (NullAllowed)
     */
    public void setProperFlg(String properFlg) {
        __modifiedProperties.add("properFlg");
        this._properFlg = properFlg;
    }
