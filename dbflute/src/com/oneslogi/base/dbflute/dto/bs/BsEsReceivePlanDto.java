...
/**
 * The simple DTO of es_receive_plan as TABLE. <br>
 * 入庫予定送信テーブル
 * <pre>
 * [primary-key]
 *     RECEIVE_PLAN_ID
...
public abstract class BsEsReceivePlanDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEsReceivePlanDto)) { return false; }
        final BsEsReceivePlanDto otherEntity = (BsEsReceivePlanDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "es_receive_plan");
