...
/**
 * The simple DTO of es_shipping_inst as TABLE. <br>
 * 出荷指示送信テーブル
 * <pre>
 * [primary-key]
 *     SHIPPING_INST_ID
...
public abstract class BsEsShippingInstDto implements Serializable {
    ...
    @JsonKey
    protected String _salesOrderNum;
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEsShippingInstDto)) { return false; }
        final BsEsShippingInstDto otherEntity = (BsEsShippingInstDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "es_shipping_inst");
    ...
    public String toString() {
        ...
        sb.append(c).append(getExpressCd());
        ...
        sb.append(c).append(getSalesTaxRate());
    ...
    //                                                                            ========
    /**
     * [get] SHIPPING_INST_ID: {PK, NotNull, BIGINT(19)} <br>
     * 出荷指示送信D
    ...
    /**
     * [set] SHIPPING_INST_ID: {PK, NotNull, BIGINT(19)} <br>
     * 出荷指示送信D
    ...
    /**
     * [get] SALES_ORDER_NUM: {VARCHAR(30)} <br>
     * 受注数量
    ...
    /**
     * [set] SALES_ORDER_NUM: {VARCHAR(30)} <br>
     * 受注数量
     ...
     * 運送便CD
     * @return The value of the column 'EXPRESS_CD'. (NullAllowed)
     */
     ...
     * 運送便CD
     * @param expressCd The value of the column 'EXPRESS_CD'. (NullAllowed)
     */
    public void setExpressCd(String expressCd) {
        __modifiedProperties.add("expressCd");
        this._expressCd = expressCd;
    }
     ...
     * 消費税率
     * @return The value of the column 'SALES_TAX_RATE'. (NullAllowed)
     */
     ...
     * 消費税率
     * @param salesTaxRate The value of the column 'SALES_TAX_RATE'. (NullAllowed)
     */
    public void setSalesTaxRate(String salesTaxRate) {
        __modifiedProperties.add("salesTaxRate");
