...
/**
 * The simple DTO of e_sales_org as TABLE. <br>
 * 販売組織マスタ受信テーブル
 * <pre>
 * [primary-key]
 *     SALES_ORG_ID
...
public abstract class BsESalesOrgDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsESalesOrgDto)) { return false; }
        final BsESalesOrgDto otherEntity = (BsESalesOrgDto)other;
