...
/**
 * The simple DTO of SqlInventoryListPrintReportData02. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlInventoryListPrintReportData02Dto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlInventoryListPrintReportData02Dto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlInventoryListPrintReportData02Dto)) { return false; }
        final BsSqlInventoryListPrintReportData02Dto otherEntity = (BsSqlInventoryListPrintReportData02Dto)other;
        ...
        if (!helpComparingValue(getUserNmUpd(), otherEntity.getUserNmUpd())) { return false; }
        if (!helpComparingValue(getUserCdUpd(), otherEntity.getUserCdUpd())) { return false; }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlInventoryListPrintReportData02");
        ...
        result = xCH(result, getUserNmUpd());
        result = xCH(result, getUserCdUpd());
    ...
    public String toString() {
        ...
        sb.append(c).append(getUserNmUpd());
        sb.append(c).append(getUserCdUpd());
     ...
     * ユーザ名
     * @return The value of the column 'USER_NM_UPD'. (NullAllowed)
     */
     ...
     * ユーザ名
     * @param userNmUpd The value of the column 'USER_NM_UPD'. (NullAllowed)
     */
    public void setUserNmUpd(String userNmUpd) {
        __modifiedProperties.add("userNmUpd");
        this._userNmUpd = userNmUpd;
    }

    /**
     * [get] USER_CD_UPD: {VARCHAR(30), refers to b_user.USER_CD} <br>
     * ユーザCD
     * @return The value of the column 'USER_CD_UPD'. (NullAllowed)
     */
     ...
     * ユーザCD
     * @param userCdUpd The value of the column 'USER_CD_UPD'. (NullAllowed)
     */
    public void setUserCdUpd(String userCdUpd) {
        __modifiedProperties.add("userCdUpd");
        this._userCdUpd = userCdUpd;
    }
