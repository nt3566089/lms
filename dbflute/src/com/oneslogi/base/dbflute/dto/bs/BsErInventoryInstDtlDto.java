...
/**
 * The simple DTO of er_inventory_inst_dtl as TABLE. <br>
 * 棚卸指示(明細)受信テーブル
 * <pre>
 * [primary-key]
...
public abstract class BsErInventoryInstDtlDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsErInventoryInstDtlDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsErInventoryInstDtlDto)) { return false; }
        final BsErInventoryInstDtlDto otherEntity = (BsErInventoryInstDtlDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "er_inventory_inst_dtl");
