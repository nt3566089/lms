...
public abstract class BsSqlReceiveStatusProgressDto implements Serializable {
    ...
    /**
     * [get] RECEIVE_STATUS_NM: {BINARY} <br>
    ...
    /**
     * [set] RECEIVE_STATUS_NM: {BINARY} <br>
