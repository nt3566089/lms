...
/**
 * The simple DTO of t_bldl5351 as TABLE. <br>
 * BLDL5351
 * <pre>
 * [primary-key]
 *     BLDL5351_ID
...
public abstract class BsTBldl5351Dto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTBldl5351Dto)) { return false; }
        final BsTBldl5351Dto otherEntity = (BsTBldl5351Dto)other;
        if (!helpComparingValue(getBldl5351Id(), otherEntity.getBldl5351Id())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "t_bldl5351");
        result = xCH(result, getBldl5351Id());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getBldl5351Id());
        ...
        sb.append(c).append(getOtherTotalNum());
     ...
     * BLDL5351ID
     * @return The value of the column 'BLDL5351_ID'. (NullAllowed)
     */
     ...
     * BLDL5351ID
     * @param bldl5351Id The value of the column 'BLDL5351_ID'. (NullAllowed)
     */
    public void setBldl5351Id(Long bldl5351Id) {
        __modifiedProperties.add("bldl5351Id");
        this._bldl5351Id = bldl5351Id;
    }
     ...
     * 他倉庫_合計数量
     * @return The value of the column 'OTHER_TOTAL_NUM'. (NullAllowed)
     */
     ...
     * 他倉庫_合計数量
     * @param otherTotalNum The value of the column 'OTHER_TOTAL_NUM'. (NullAllowed)
     */
    public void setOtherTotalNum(Long otherTotalNum) {
        __modifiedProperties.add("otherTotalNum");
        this._otherTotalNum = otherTotalNum;
    }
