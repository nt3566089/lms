...
public abstract class BsBLogDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] LOG_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * ログID
    ...
    /**
     * [set] LOG_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * ログID
    ...
    /**
     * [get] PROCESS_START_DT: {IX, NotNull, DATETIME(19)} <br>
     * 処理開始日時
    ...
    /**
     * [set] PROCESS_START_DT: {IX, NotNull, DATETIME(19)} <br>
     * 処理開始日時
    ...
    /**
     * [get] PROCESS_END_DT: {IX, DATETIME(19)} <br>
     * 処理終了日時
    ...
    /**
     * [set] PROCESS_END_DT: {IX, DATETIME(19)} <br>
     * 処理終了日時
