...
/**
 * The simple DTO of h_stock_book as TABLE. <br>
 * 帳簿在庫履歴
 * <pre>
 * [primary-key]
 *     STOCK_BOOK_ID
...
public abstract class BsHStockBookDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsHStockBookDto)) { return false; }
        final BsHStockBookDto otherEntity = (BsHStockBookDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "h_stock_book");
