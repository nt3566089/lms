...
public abstract class BsEShippingInstDto implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(c).append(getDestinationPrefecture());
     ...
     * 送り先都道府県
     * @return The value of the column 'DESTINATION_PREFECTURE'. (NullAllowed)
     */
     ...
     * 送り先都道府県
     * @param destinationPrefecture The value of the column 'DESTINATION_PREFECTURE'. (NullAllowed)
     */
    public void setDestinationPrefecture(String destinationPrefecture) {
        __modifiedProperties.add("destinationPrefecture");
        this._destinationPrefecture = destinationPrefecture;
    }
