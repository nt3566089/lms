...
public abstract class BsSqlReceiveDataListDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] receive_plan_h_id: {BIGINT(20)} <br>
    ...
    /**
     * [set] receive_plan_h_id: {BIGINT(20)} <br>
    ...
    /**
     * [get] receive_plan_b_id: {BIGINT(20)} <br>
    ...
    /**
     * [set] receive_plan_b_id: {BIGINT(20)} <br>
    ...
    /**
     * [get] store_record_h_id: {BIGINT(20)} <br>
    ...
    /**
     * [set] store_record_h_id: {BIGINT(20)} <br>
    ...
    /**
     * [get] store_record_b_id: {BIGINT(20)} <br>
    ...
    /**
     * [set] store_record_b_id: {BIGINT(20)} <br>
    ...
    /**
     * [get] product_abbr: {VARCHAR(60), refers to m_product.PRODUCT_ABBR} <br>
     * 商品略称
    ...
    /**
     * [set] product_abbr: {VARCHAR(60), refers to m_product.PRODUCT_ABBR} <br>
     * 商品略称
