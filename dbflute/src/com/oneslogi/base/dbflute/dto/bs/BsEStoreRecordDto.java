...
/**
 * The simple DTO of e_store_record as TABLE. <br>
 * 入庫実績送信テーブル
 * <pre>
 * [primary-key]
 *     STORE_RECORD_ID
...
public abstract class BsEStoreRecordDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEStoreRecordDto)) { return false; }
        final BsEStoreRecordDto otherEntity = (BsEStoreRecordDto)other;
        if (!helpComparingValue(getStoreRecordId(), otherEntity.getStoreRecordId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "e_store_record");
        result = xCH(result, getStoreRecordId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getStoreRecordId());
     ...
     * 入庫実績送信ID
     * @return The value of the column 'STORE_RECORD_ID'. (NullAllowed)
     */
     ...
     * 入庫実績送信ID
     * @param storeRecordId The value of the column 'STORE_RECORD_ID'. (NullAllowed)
     */
    public void setStoreRecordId(Long storeRecordId) {
        __modifiedProperties.add("storeRecordId");
        this._storeRecordId = storeRecordId;
    }
