...
/**
 * The simple DTO of es_koguchi_delivery as TABLE. <br>
 * 戸口配送マスタ送信テーブル
 * <pre>
 * [primary-key]
 *     KOGUCHI_DELIVERY_ID
...
public abstract class BsEsKoguchiDeliveryDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEsKoguchiDeliveryDto)) { return false; }
        final BsEsKoguchiDeliveryDto otherEntity = (BsEsKoguchiDeliveryDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "es_koguchi_delivery");
