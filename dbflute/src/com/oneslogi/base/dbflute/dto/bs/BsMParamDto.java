...
public abstract class BsMParamDto implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(c).append(getReceiveLabelFlg());
     ...
     * 入荷ラベル使用フラグ
     * @return The value of the column 'RECEIVE_LABEL_FLG'. (NullAllowed)
     */
    public String getReceiveLabelFlg() {
        return _receiveLabelFlg;
    }

    /**
     * [set] RECEIVE_LABEL_FLG: {CHAR(1)} <br>
     * 入荷ラベル使用フラグ
     * @param receiveLabelFlg The value of the column 'RECEIVE_LABEL_FLG'. (NullAllowed)
     */
    public void setReceiveLabelFlg(String receiveLabelFlg) {
        __modifiedProperties.add("receiveLabelFlg");
        this._receiveLabelFlg = receiveLabelFlg;
    }
