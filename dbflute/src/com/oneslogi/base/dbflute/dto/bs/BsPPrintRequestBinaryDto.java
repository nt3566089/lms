...
public abstract class BsPPrintRequestBinaryDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] PRINT_REQUEST_BINARY_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 印刷データ情報(バイナリ)ID
    ...
    /**
     * [set] PRINT_REQUEST_BINARY_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 印刷データ情報(バイナリ)ID
    ...
    /**
     * [get] REPORT_BINARY: {LONGBLOB(2147483647)} <br>
     * 帳票バイナリデータ
    ...
    /**
     * [set] REPORT_BINARY: {LONGBLOB(2147483647)} <br>
     * 帳票バイナリデータ
