...
/**
 * The simple DTO of es_product_price as TABLE. <br>
 * 商品マスタ(移動平均単価)送信テーブル
 * <pre>
 * [primary-key]
 *     PRODUCT_PRICE_ID
...
public abstract class BsEsProductPriceDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEsProductPriceDto)) { return false; }
        final BsEsProductPriceDto otherEntity = (BsEsProductPriceDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "es_product_price");
