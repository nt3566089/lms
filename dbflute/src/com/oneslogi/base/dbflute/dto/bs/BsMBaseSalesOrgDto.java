...
/**
 * The simple DTO of m_base_sales_org as TABLE. <br>
 * 拠点販売組織マスタ
 * <pre>
 * [primary-key]
 *     BASE_SALES_ORG_ID
...
public abstract class BsMBaseSalesOrgDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMBaseSalesOrgDto)) { return false; }
        final BsMBaseSalesOrgDto otherEntity = (BsMBaseSalesOrgDto)other;
        if (!helpComparingValue(getBaseSalesOrgId(), otherEntity.getBaseSalesOrgId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "m_base_sales_org");
        result = xCH(result, getBaseSalesOrgId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getBaseSalesOrgId());
     ...
     * 拠点販売組織ID
     * @return The value of the column 'BASE_SALES_ORG_ID'. (NullAllowed)
     */
     ...
     * 拠点販売組織ID
     * @param baseSalesOrgId The value of the column 'BASE_SALES_ORG_ID'. (NullAllowed)
     */
    public void setBaseSalesOrgId(Long baseSalesOrgId) {
        __modifiedProperties.add("baseSalesOrgId");
        this._baseSalesOrgId = baseSalesOrgId;
    }
