...
/**
 * The simple DTO of er_ajis_inventory_report as TABLE. <br>
 * エイジス棚卸実績取込受信テーブル
 * <pre>
 * [primary-key]
...
public abstract class BsErAjisInventoryReportDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsErAjisInventoryReportDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsErAjisInventoryReportDto)) { return false; }
        final BsErAjisInventoryReportDto otherEntity = (BsErAjisInventoryReportDto)other;
        if (!helpComparingValue(getAjisInventoryReportId(), otherEntity.getAjisInventoryReportId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "er_ajis_inventory_report");
        result = xCH(result, getAjisInventoryReportId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getAjisInventoryReportId());
     ...
     * エイジス棚卸実績取込受信ID
     * @return The value of the column 'AJIS_INVENTORY_REPORT_ID'. (NullAllowed)
     */
     ...
     * エイジス棚卸実績取込受信ID
     * @param ajisInventoryReportId The value of the column 'AJIS_INVENTORY_REPORT_ID'. (NullAllowed)
     */
    public void setAjisInventoryReportId(Long ajisInventoryReportId) {
        __modifiedProperties.add("ajisInventoryReportId");
        this._ajisInventoryReportId = ajisInventoryReportId;
    }
