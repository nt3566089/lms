...
/**
 * The simple DTO of t_bldl5160 as TABLE. <br>
 * BLDL5160
 * <pre>
 * [primary-key]
 *     BLDL5160_ID
...
public abstract class BsTBldl5160Dto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTBldl5160Dto)) { return false; }
        final BsTBldl5160Dto otherEntity = (BsTBldl5160Dto)other;
        if (!helpComparingValue(getBldl5160Id(), otherEntity.getBldl5160Id())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "t_bldl5160");
        result = xCH(result, getBldl5160Id());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getBldl5160Id());
     ...
     * BLDL5160ID
     * @return The value of the column 'BLDL5160_ID'. (NullAllowed)
     */
     ...
     * BLDL5160ID
     * @param bldl5160Id The value of the column 'BLDL5160_ID'. (NullAllowed)
     */
    public void setBldl5160Id(Long bldl5160Id) {
        __modifiedProperties.add("bldl5160Id");
        this._bldl5160Id = bldl5160Id;
    }
