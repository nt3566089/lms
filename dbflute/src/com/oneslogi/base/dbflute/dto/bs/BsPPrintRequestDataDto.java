...
public abstract class BsPPrintRequestDataDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] PRINT_REQUEST_ID: {PK, NotNull, BIGINT(19), FK to p_print_request} <br>
     * 印刷情報ID
    ...
    /**
     * [set] PRINT_REQUEST_ID: {PK, NotNull, BIGINT(19), FK to p_print_request} <br>
     * 印刷情報ID
    ...
    /**
     * [get] REPORT_LAYOUT_DATA: {LONGTEXT(2147483647)} <br>
     * 帳票レイアウトデータ
    ...
    /**
     * [set] REPORT_LAYOUT_DATA: {LONGTEXT(2147483647)} <br>
     * 帳票レイアウトデータ
    ...
    /**
     * [get] SUBREP_LAYOUT_DATA: {LONGTEXT(2147483647)} <br>
     * サブレポートレイアウトデータ
    ...
    /**
     * [set] SUBREP_LAYOUT_DATA: {LONGTEXT(2147483647)} <br>
     * サブレポートレイアウトデータ
    ...
    /**
     * [get] REPORT_LAYOUT_BINARY: {LONGBLOB(2147483647)} <br>
     * 帳票レイアウトバイナリ
    ...
    /**
     * [set] REPORT_LAYOUT_BINARY: {LONGBLOB(2147483647)} <br>
     * 帳票レイアウトバイナリ
    ...
    /**
     * [get] SUBREP_LAYOUT_BINARY: {LONGBLOB(2147483647)} <br>
     * サブレポートレイアウトバイナリ
    ...
    /**
     * [set] SUBREP_LAYOUT_BINARY: {LONGBLOB(2147483647)} <br>
     * サブレポートレイアウトバイナリ
    ...
    /**
     * [get] DATA_FOR_REPORT: {LONGTEXT(2147483647)} <br>
     * 業務データ
    ...
    /**
     * [set] DATA_FOR_REPORT: {LONGTEXT(2147483647)} <br>
     * 業務データ
