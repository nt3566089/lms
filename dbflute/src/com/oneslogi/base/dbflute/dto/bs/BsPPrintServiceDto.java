...
public abstract class BsPPrintServiceDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] PRINT_SERVICE_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 印刷サービスID
    ...
    /**
     * [set] PRINT_SERVICE_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 印刷サービスID
