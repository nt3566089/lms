...
/**
 * The simple DTO of es_stock_record as TABLE. <br>
 * 在庫実績送信テーブル
 * <pre>
 * [primary-key]
 *     PACKING_LIST_ID
...
public abstract class BsEsStockRecordDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEsStockRecordDto)) { return false; }
        final BsEsStockRecordDto otherEntity = (BsEsStockRecordDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "es_stock_record");
