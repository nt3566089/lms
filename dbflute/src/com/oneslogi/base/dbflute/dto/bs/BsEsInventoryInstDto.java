...
/**
 * The simple DTO of es_inventory_inst as TABLE. <br>
 * 棚卸指示送信テーブル
 * <pre>
 * [primary-key]
 *     INVENTORY_INST_ID
...
public abstract class BsEsInventoryInstDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEsInventoryInstDto)) { return false; }
        final BsEsInventoryInstDto otherEntity = (BsEsInventoryInstDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "es_inventory_inst");
