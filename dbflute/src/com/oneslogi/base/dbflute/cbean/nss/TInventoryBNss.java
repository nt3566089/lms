...
public class TInventoryBNss {
     ...
     * @return The set-upper of more nested relation. {...with[nested-relation].with[more-nested-relation]} (NotNull)
     */
    public BUserNss withBUserByInventoryUpdUserId() {
        _query.xdoNss(() -> _query.queryBUserByInventoryUpdUserId());
        return new BUserNss(_query.queryBUserByInventoryUpdUserId());
    }
    /**
     * With nested relation columns to select clause. <br>
     ...
     * @return The set-upper of more nested relation. {...with[nested-relation].with[more-nested-relation]} (NotNull)
     */
    public MCustomerNss withMCustomerByAccountId() {
        _query.xdoNss(() -> _query.queryMCustomerByAccountId());
        return new MCustomerNss(_query.queryMCustomerByAccountId());
    }
    /**
     * With nested relation columns to select clause. <br>
     ...
     * @return The set-upper of more nested relation. {...with[nested-relation].with[more-nested-relation]} (NotNull)
     */
    public BUserNss withBUserByInventoryUserId() {
        _query.xdoNss(() -> _query.queryBUserByInventoryUserId());
        return new BUserNss(_query.queryBUserByInventoryUserId());
    }
    /**
     * With nested relation columns to select clause. <br>
