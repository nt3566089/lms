...
public class TShippingInstHNss {
     ...
     */
    public void withMSalesOrgBySalesOrg() {
        _query.xdoNss(() -> _query.queryMSalesOrgBySalesOrg());
    }
    /**
     * With nested relation columns to select clause. <br>
     ...
     * @return The set-upper of more nested relation. {...with[nested-relation].with[more-nested-relation]} (NotNull)
     */
    public MCustomerNss withMCustomerByAccoutId() {
        _query.xdoNss(() -> _query.queryMCustomerByAccoutId());
        return new MCustomerNss(_query.queryMCustomerByAccoutId());
    }
    /**
     * With nested relation columns to select clause. <br>
