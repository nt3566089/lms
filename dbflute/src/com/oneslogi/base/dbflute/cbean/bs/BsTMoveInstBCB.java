...
public class BsTMoveInstBCB extends AbstractConditionBean {
     ...
     * @param moveInstBId : PK, ID, NotNull, BIGINT(19). (NotNull)
     * @return this. (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tMoveInstB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tMoveInstB</span>.<span style="color: #CC4747">getMCustomerByAccountId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
