...
/**
 * The base condition-bean of es_plant_storage_space.
 * @author DBFlute(AutoGenerator)
 */
public class BsEsPlantStorageSpaceCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected EsPlantStorageSpaceCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsPlantStorageSpaceCB() {
     ...
     * @return this. (NotNull)
     */
    public EsPlantStorageSpaceCB acceptPK(Long plantStorageSpaceId) {
        assertObjectNotNull("plantStorageSpaceId", plantStorageSpaceId);
        BsEsPlantStorageSpaceCB cb = this;
        cb.query().setPlantStorageSpaceId_Equal(plantStorageSpaceId);
        return (EsPlantStorageSpaceCB)this;
    }
     ...
     */
    public EsPlantStorageSpaceCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public EsPlantStorageSpaceCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected EsPlantStorageSpaceCQ doGetConditionQuery() {
    ...
    protected EsPlantStorageSpaceCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected EsPlantStorageSpaceCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        EsPlantStorageSpaceCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected EsPlantStorageSpaceCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new EsPlantStorageSpaceCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<EsPlantStorageSpaceCB> unionCBLambda) {
        final EsPlantStorageSpaceCB cb = new EsPlantStorageSpaceCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EsPlantStorageSpaceCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<EsPlantStorageSpaceCB> unionCBLambda) {
        final EsPlantStorageSpaceCB cb = new EsPlantStorageSpaceCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EsPlantStorageSpaceCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<EsPlantStorageSpaceCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<EsPlantStorageSpaceCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "es_plant_storage_space"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<EsPlantStorageSpaceCB, EsPlantStorageSpaceCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<EsPlantStorageSpaceCB> sq, EsPlantStorageSpaceCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public EsPlantStorageSpaceCB dreamCruiseCB() {
        EsPlantStorageSpaceCB cb = new EsPlantStorageSpaceCB();
        cb.xsetupForDreamCruise((EsPlantStorageSpaceCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<EsPlantStorageSpaceCB> columnQuery(final SpecifyQuery<EsPlantStorageSpaceCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected EsPlantStorageSpaceCB xcreateColumnQueryCB() {
        EsPlantStorageSpaceCB cb = new EsPlantStorageSpaceCB();
        cb.xsetupForColumnQuery((EsPlantStorageSpaceCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<EsPlantStorageSpaceCB> orCBLambda) {
        xorSQ((EsPlantStorageSpaceCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<EsPlantStorageSpaceCB> andCBLambda) {
        xorSQAP((EsPlantStorageSpaceCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final EsPlantStorageSpaceCB cb;
        if (mainCB != null) {
            cb = (EsPlantStorageSpaceCB)mainCB;
        } else {
            cb = new EsPlantStorageSpaceCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return EsPlantStorageSpaceCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return EsPlantStorageSpaceCQ.class.getName(); }
