...
/**
 * The base condition-bean of er_shipping_record.
 * @author DBFlute(AutoGenerator)
 */
public class BsErShippingRecordCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ErShippingRecordCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsErShippingRecordCB() {
     ...
     * @return this. (NotNull)
     */
    public ErShippingRecordCB acceptPK(Long shippingRecordId) {
        assertObjectNotNull("shippingRecordId", shippingRecordId);
        BsErShippingRecordCB cb = this;
        cb.query().setShippingRecordId_Equal(shippingRecordId);
        return (ErShippingRecordCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ErShippingRecordCB acceptUniqueOf(String receiveCd, Long receiveRowId) {
     ...
     */
    public ErShippingRecordCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ErShippingRecordCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ErShippingRecordCQ doGetConditionQuery() {
    ...
    protected ErShippingRecordCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ErShippingRecordCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ErShippingRecordCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ErShippingRecordCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ErShippingRecordCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ErShippingRecordCB> unionCBLambda) {
        final ErShippingRecordCB cb = new ErShippingRecordCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErShippingRecordCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ErShippingRecordCB> unionCBLambda) {
        final ErShippingRecordCB cb = new ErShippingRecordCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErShippingRecordCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ErShippingRecordCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ErShippingRecordCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "er_shipping_record"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<ErShippingRecordCB, ErShippingRecordCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ErShippingRecordCB> sq, ErShippingRecordCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ErShippingRecordCB dreamCruiseCB() {
        ErShippingRecordCB cb = new ErShippingRecordCB();
        cb.xsetupForDreamCruise((ErShippingRecordCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ErShippingRecordCB> columnQuery(final SpecifyQuery<ErShippingRecordCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ErShippingRecordCB xcreateColumnQueryCB() {
        ErShippingRecordCB cb = new ErShippingRecordCB();
        cb.xsetupForColumnQuery((ErShippingRecordCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ErShippingRecordCB> orCBLambda) {
        xorSQ((ErShippingRecordCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ErShippingRecordCB> andCBLambda) {
        xorSQAP((ErShippingRecordCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ErShippingRecordCB cb;
        if (mainCB != null) {
            cb = (ErShippingRecordCB)mainCB;
        } else {
            cb = new ErShippingRecordCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ErShippingRecordCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ErShippingRecordCQ.class.getName(); }
