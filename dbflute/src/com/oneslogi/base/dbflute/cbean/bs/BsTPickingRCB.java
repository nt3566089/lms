...
public class BsTPickingRCB extends AbstractConditionBean {
     ...
     * @param pickingHId : PK, NotNull, BIGINT(19), FK to t_picking_h. (NotNull)
     * @return this. (NotNull)
     */
    ...
    protected BUserNss _nssBUserByBolOutUserId;
    public BUserNss xdfgetNssBUserByBolOutUserId() {
        if (_nssBUserByBolOutUserId == null) { _nssBUserByBolOutUserId = new BUserNss(null); }
        return _nssBUserByBolOutUserId;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tPickingRBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_BUserByBolOutUserId()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tPickingR</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tPickingR</span>.<span style="color: #CC4747">getBUserByBolOutUserId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public BUserNss setupSelect_BUserByBolOutUserId() {
        assertSetupSelectPurpose("bUserByBolOutUserId");
        if (hasSpecifiedLocalColumn()) {
            specify().columnBolOutUserId();
        }
        doSetupSelect(() -> query().queryBUserByBolOutUserId());
        if (_nssBUserByBolOutUserId == null || !_nssBUserByBolOutUserId.hasConditionQuery())
        { _nssBUserByBolOutUserId = new BUserNss(query().queryBUserByBolOutUserId()); }
        return _nssBUserByBolOutUserId;
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tPickingR</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tPickingR</span>.<span style="color: #CC4747">getBUserByTagOutUserId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    protected BUserNss _nssBUserByDelivOutUserId;
    public BUserNss xdfgetNssBUserByDelivOutUserId() {
        if (_nssBUserByDelivOutUserId == null) { _nssBUserByDelivOutUserId = new BUserNss(null); }
        return _nssBUserByDelivOutUserId;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tPickingRBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_BUserByDelivOutUserId()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tPickingR</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tPickingR</span>.<span style="color: #CC4747">getBUserByDelivOutUserId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public BUserNss setupSelect_BUserByDelivOutUserId() {
        assertSetupSelectPurpose("bUserByDelivOutUserId");
        if (hasSpecifiedLocalColumn()) {
            specify().columnDelivOutUserId();
        }
        doSetupSelect(() -> query().queryBUserByDelivOutUserId());
        if (_nssBUserByDelivOutUserId == null || !_nssBUserByDelivOutUserId.hasConditionQuery())
        { _nssBUserByDelivOutUserId = new BUserNss(query().queryBUserByDelivOutUserId()); }
        return _nssBUserByDelivOutUserId;
    }

    protected BUserNss _nssBUserByIndvSupplyOutUserId;
    public BUserNss xdfgetNssBUserByIndvSupplyOutUserId() {
        if (_nssBUserByIndvSupplyOutUserId == null) { _nssBUserByIndvSupplyOutUserId = new BUserNss(null); }
        return _nssBUserByIndvSupplyOutUserId;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tPickingRBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_BUserByIndvSupplyOutUserId()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tPickingR</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tPickingR</span>.<span style="color: #CC4747">getBUserByIndvSupplyOutUserId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public BUserNss setupSelect_BUserByIndvSupplyOutUserId() {
        assertSetupSelectPurpose("bUserByIndvSupplyOutUserId");
        if (hasSpecifiedLocalColumn()) {
            specify().columnIndvSupplyOutUserId();
        }
        doSetupSelect(() -> query().queryBUserByIndvSupplyOutUserId());
        if (_nssBUserByIndvSupplyOutUserId == null || !_nssBUserByIndvSupplyOutUserId.hasConditionQuery())
        { _nssBUserByIndvSupplyOutUserId = new BUserNss(query().queryBUserByIndvSupplyOutUserId()); }
        return _nssBUserByIndvSupplyOutUserId;
    }
    ...
    protected BUserNss _nssBUserByPlOutUserId;
    public BUserNss xdfgetNssBUserByPlOutUserId() {
        if (_nssBUserByPlOutUserId == null) { _nssBUserByPlOutUserId = new BUserNss(null); }
        return _nssBUserByPlOutUserId;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tPickingRBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_BUserByPlOutUserId()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tPickingR</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tPickingR</span>.<span style="color: #CC4747">getBUserByPlOutUserId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public BUserNss setupSelect_BUserByPlOutUserId() {
        assertSetupSelectPurpose("bUserByPlOutUserId");
        if (hasSpecifiedLocalColumn()) {
            specify().columnPlOutUserId();
        }
        doSetupSelect(() -> query().queryBUserByPlOutUserId());
        if (_nssBUserByPlOutUserId == null || !_nssBUserByPlOutUserId.hasConditionQuery())
        { _nssBUserByPlOutUserId = new BUserNss(query().queryBUserByPlOutUserId()); }
        return _nssBUserByPlOutUserId;
    }

    protected BUserNss _nssBUserByIndvLabelOutUserId;
    public BUserNss xdfgetNssBUserByIndvLabelOutUserId() {
        if (_nssBUserByIndvLabelOutUserId == null) { _nssBUserByIndvLabelOutUserId = new BUserNss(null); }
        return _nssBUserByIndvLabelOutUserId;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tPickingRBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_BUserByIndvLabelOutUserId()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tPickingR</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tPickingR</span>.<span style="color: #CC4747">getBUserByIndvLabelOutUserId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public BUserNss setupSelect_BUserByIndvLabelOutUserId() {
        assertSetupSelectPurpose("bUserByIndvLabelOutUserId");
        if (hasSpecifiedLocalColumn()) {
            specify().columnIndvLabelOutUserId();
        }
        doSetupSelect(() -> query().queryBUserByIndvLabelOutUserId());
        if (_nssBUserByIndvLabelOutUserId == null || !_nssBUserByIndvLabelOutUserId.hasConditionQuery())
        { _nssBUserByIndvLabelOutUserId = new BUserNss(query().queryBUserByIndvLabelOutUserId()); }
        return _nssBUserByIndvLabelOutUserId;
    }
    ...
    protected BUserNss _nssBUserByNizoroeOutUserId;
    public BUserNss xdfgetNssBUserByNizoroeOutUserId() {
        if (_nssBUserByNizoroeOutUserId == null) { _nssBUserByNizoroeOutUserId = new BUserNss(null); }
        return _nssBUserByNizoroeOutUserId;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tPickingRBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_BUserByNizoroeOutUserId()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tPickingR</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tPickingR</span>.<span style="color: #CC4747">getBUserByNizoroeOutUserId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public BUserNss setupSelect_BUserByNizoroeOutUserId() {
        assertSetupSelectPurpose("bUserByNizoroeOutUserId");
        if (hasSpecifiedLocalColumn()) {
            specify().columnNizoroeOutUserId();
        }
        doSetupSelect(() -> query().queryBUserByNizoroeOutUserId());
        if (_nssBUserByNizoroeOutUserId == null || !_nssBUserByNizoroeOutUserId.hasConditionQuery())
        { _nssBUserByNizoroeOutUserId = new BUserNss(query().queryBUserByNizoroeOutUserId()); }
        return _nssBUserByNizoroeOutUserId;
    }

    protected BUserNss _nssBUserByPllOutUserId;
    public BUserNss xdfgetNssBUserByPllOutUserId() {
        if (_nssBUserByPllOutUserId == null) { _nssBUserByPllOutUserId = new BUserNss(null); }
        return _nssBUserByPllOutUserId;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tPickingRBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_BUserByPllOutUserId()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tPickingR</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tPickingR</span>.<span style="color: #CC4747">getBUserByPllOutUserId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public BUserNss setupSelect_BUserByPllOutUserId() {
        assertSetupSelectPurpose("bUserByPllOutUserId");
        if (hasSpecifiedLocalColumn()) {
            specify().columnPllOutUserId();
        }
        doSetupSelect(() -> query().queryBUserByPllOutUserId());
        if (_nssBUserByPllOutUserId == null || !_nssBUserByPllOutUserId.hasConditionQuery())
        { _nssBUserByPllOutUserId = new BUserNss(query().queryBUserByPllOutUserId()); }
        return _nssBUserByPllOutUserId;
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<TPickingRCQ> {
        ...
        protected BUserCB.HpSpecification _bUserByBolOutUserId;
        ...
        protected BUserCB.HpSpecification _bUserByDelivOutUserId;
        protected BUserCB.HpSpecification _bUserByIndvSupplyOutUserId;
        protected BUserCB.HpSpecification _bUserByPackingOutUserId;
        protected BUserCB.HpSpecification _bUserByPlOutUserId;
        protected BUserCB.HpSpecification _bUserByIndvLabelOutUserId;
        protected BUserCB.HpSpecification _bUserByPl2OutUserId;
        protected BUserCB.HpSpecification _bUserBySlipOutUserId;
        protected BUserCB.HpSpecification _bUserByNizoroeOutUserId;
        protected BUserCB.HpSpecification _bUserByPllOutUserId;
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPlOutUserId() { return doColumn("PL_OUT_USER_ID"); }
        /**
         * PL_OUT_DT: {DATETIME(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPlOutDt() { return doColumn("PL_OUT_DT"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnDelivOutFlg() { return doColumn("DELIV_OUT_FLG"); }
        /**
         * DELIV_OUT_USER_ID: {IX, BIGINT(19), FK to b_user}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnDelivOutUserId() { return doColumn("DELIV_OUT_USER_ID"); }
        /**
         * DELIV_OUT_DT: {DATETIME(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnDelivOutDt() { return doColumn("DELIV_OUT_DT"); }
        /**
         * PLL_OUT_FLG: {CHAR(1)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPllOutFlg() { return doColumn("PLL_OUT_FLG"); }
        /**
         * PLL_OUT_USER_ID: {IX, BIGINT(19), FK to b_user}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPllOutUserId() { return doColumn("PLL_OUT_USER_ID"); }
        /**
         * PLL_OUT_DT: {DATETIME(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPllOutDt() { return doColumn("PLL_OUT_DT"); }
        /**
         * NIZOROE_OUT_FLG: {CHAR(1)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnNizoroeOutFlg() { return doColumn("NIZOROE_OUT_FLG"); }
        /**
         * NIZOROE_OUT_USER_ID: {IX, BIGINT(19), FK to b_user}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnNizoroeOutUserId() { return doColumn("NIZOROE_OUT_USER_ID"); }
        /**
         * NIZOROE_OUT_DT: {DATETIME(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnNizoroeOutDt() { return doColumn("NIZOROE_OUT_DT"); }
        /**
         * INDV_SUPPLY_OUT_FLG: {CHAR(1)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnIndvSupplyOutFlg() { return doColumn("INDV_SUPPLY_OUT_FLG"); }
        /**
         * INDV_SUPPLY_OUT_USER_ID: {IX, BIGINT(19), FK to b_user}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnIndvSupplyOutUserId() { return doColumn("INDV_SUPPLY_OUT_USER_ID"); }
        /**
         * INDV_SUPPLY_OUT_DT: {DATETIME(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnIndvSupplyOutDt() { return doColumn("INDV_SUPPLY_OUT_DT"); }
        /**
         * INDV_LABEL_OUT_FLG: {CHAR(1)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnIndvLabelOutFlg() { return doColumn("INDV_LABEL_OUT_FLG"); }
        /**
         * INDV_LABEL_OUT_USER_ID: {IX, BIGINT(19), FK to b_user}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnIndvLabelOutUserId() { return doColumn("INDV_LABEL_OUT_USER_ID"); }
        /**
         * INDV_LABEL_OUT_DT: {DATETIME(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnIndvLabelOutDt() { return doColumn("INDV_LABEL_OUT_DT"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryBUserByBolOutUserId()
                    || qyCall().qy().xgetReferrerQuery() instanceof BUserCQ) {
                columnBolOutUserId(); // FK or one-to-one referrer
            }
            ...
            if (qyCall().qy().hasConditionQueryBUserByDelivOutUserId()
                    || qyCall().qy().xgetReferrerQuery() instanceof BUserCQ) {
                columnDelivOutUserId(); // FK or one-to-one referrer
            }
            if (qyCall().qy().hasConditionQueryBUserByIndvSupplyOutUserId()
                    || qyCall().qy().xgetReferrerQuery() instanceof BUserCQ) {
                columnIndvSupplyOutUserId(); // FK or one-to-one referrer
            }
            if (qyCall().qy().hasConditionQueryBUserByPackingOutUserId()
                    || qyCall().qy().xgetReferrerQuery() instanceof BUserCQ) {
                columnPackingOutUserId(); // FK or one-to-one referrer
            }
            if (qyCall().qy().hasConditionQueryBUserByPlOutUserId()
                    || qyCall().qy().xgetReferrerQuery() instanceof BUserCQ) {
                columnPlOutUserId(); // FK or one-to-one referrer
            }
            if (qyCall().qy().hasConditionQueryBUserByIndvLabelOutUserId()
                    || qyCall().qy().xgetReferrerQuery() instanceof BUserCQ) {
                columnIndvLabelOutUserId(); // FK or one-to-one referrer
            }
            ...
            if (qyCall().qy().hasConditionQueryBUserByNizoroeOutUserId()
                    || qyCall().qy().xgetReferrerQuery() instanceof BUserCQ) {
                columnNizoroeOutUserId(); // FK or one-to-one referrer
            }
            if (qyCall().qy().hasConditionQueryBUserByPllOutUserId()
                    || qyCall().qy().xgetReferrerQuery() instanceof BUserCQ) {
                columnPllOutUserId(); // FK or one-to-one referrer
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public BUserCB.HpSpecification specifyBUserByBolOutUserId() {
            assertRelation("bUserByBolOutUserId");
            if (_bUserByBolOutUserId == null) {
                _bUserByBolOutUserId = new BUserCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryBUserByBolOutUserId()
                                    , () -> _qyCall.qy().queryBUserByBolOutUserId())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _bUserByBolOutUserId.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBUserByBolOutUserId()
                      , () -> xsyncQyCall().qy().queryBUserByBolOutUserId()));
                }
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public BUserCB.HpSpecification specifyBUserByDelivOutUserId() {
            assertRelation("bUserByDelivOutUserId");
            if (_bUserByDelivOutUserId == null) {
                _bUserByDelivOutUserId = new BUserCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryBUserByDelivOutUserId()
                                    , () -> _qyCall.qy().queryBUserByDelivOutUserId())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _bUserByDelivOutUserId.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBUserByDelivOutUserId()
                      , () -> xsyncQyCall().qy().queryBUserByDelivOutUserId()));
                }
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public BUserCB.HpSpecification specifyBUserByIndvSupplyOutUserId() {
            assertRelation("bUserByIndvSupplyOutUserId");
            if (_bUserByIndvSupplyOutUserId == null) {
                _bUserByIndvSupplyOutUserId = new BUserCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryBUserByIndvSupplyOutUserId()
                                    , () -> _qyCall.qy().queryBUserByIndvSupplyOutUserId())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _bUserByIndvSupplyOutUserId.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBUserByIndvSupplyOutUserId()
                      , () -> xsyncQyCall().qy().queryBUserByIndvSupplyOutUserId()));
                }
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public BUserCB.HpSpecification specifyBUserByPlOutUserId() {
            assertRelation("bUserByPlOutUserId");
            if (_bUserByPlOutUserId == null) {
                _bUserByPlOutUserId = new BUserCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryBUserByPlOutUserId()
                                    , () -> _qyCall.qy().queryBUserByPlOutUserId())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _bUserByPlOutUserId.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBUserByPlOutUserId()
                      , () -> xsyncQyCall().qy().queryBUserByPlOutUserId()));
                }
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public BUserCB.HpSpecification specifyBUserByIndvLabelOutUserId() {
            assertRelation("bUserByIndvLabelOutUserId");
            if (_bUserByIndvLabelOutUserId == null) {
                _bUserByIndvLabelOutUserId = new BUserCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryBUserByIndvLabelOutUserId()
                                    , () -> _qyCall.qy().queryBUserByIndvLabelOutUserId())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _bUserByIndvLabelOutUserId.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBUserByIndvLabelOutUserId()
                      , () -> xsyncQyCall().qy().queryBUserByIndvLabelOutUserId()));
                }
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public BUserCB.HpSpecification specifyBUserByNizoroeOutUserId() {
            assertRelation("bUserByNizoroeOutUserId");
            if (_bUserByNizoroeOutUserId == null) {
                _bUserByNizoroeOutUserId = new BUserCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryBUserByNizoroeOutUserId()
                                    , () -> _qyCall.qy().queryBUserByNizoroeOutUserId())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _bUserByNizoroeOutUserId.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBUserByNizoroeOutUserId()
                      , () -> xsyncQyCall().qy().queryBUserByNizoroeOutUserId()));
                }
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public BUserCB.HpSpecification specifyBUserByPllOutUserId() {
            assertRelation("bUserByPllOutUserId");
            if (_bUserByPllOutUserId == null) {
                _bUserByPllOutUserId = new BUserCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryBUserByPllOutUserId()
                                    , () -> _qyCall.qy().queryBUserByPllOutUserId())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _bUserByPllOutUserId.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBUserByPllOutUserId()
                      , () -> xsyncQyCall().qy().queryBUserByPllOutUserId()));
                }
            }
