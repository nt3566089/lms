...
public class BsMStockTypeCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MStockTypeCQ> {
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MLocationReplenishProductCB, MStockTypeCQ> derivedMLocationReplenishProductList() {
            assertDerived("mLocationReplenishProductList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MLocationReplenishProductCB> sq, MStockTypeCQ cq, String al, DerivedReferrerOption op)
