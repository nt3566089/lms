...
public class BsTShippingInstHCB extends AbstractConditionBean {
     ...
     * @param shippingInstHId : PK, ID, NotNull, BIGINT(19). (NotNull)
     * @return this. (NotNull)
     */
     ...
     * <pre>
     * <span style="color: #0000C0">tShippingInstHBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_MSalesOrgBySalesOrg()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tShippingInstH</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tShippingInstH</span>.<span style="color: #CC4747">getMSalesOrgBySalesOrg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    public void setupSelect_MSalesOrgBySalesOrg() {
        assertSetupSelectPurpose("mSalesOrgBySalesOrg");
        if (hasSpecifiedLocalColumn()) {
            specify().columnSalesOrgCd();
        }
        doSetupSelect(() -> query().queryMSalesOrgBySalesOrg());
    }

    protected MCustomerNss _nssMCustomerByAccoutId;
    public MCustomerNss xdfgetNssMCustomerByAccoutId() {
        if (_nssMCustomerByAccoutId == null) { _nssMCustomerByAccoutId = new MCustomerNss(null); }
        return _nssMCustomerByAccoutId;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tShippingInstHBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_MCustomerByAccoutId()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tShippingInstH</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tShippingInstH</span>.<span style="color: #CC4747">getMCustomerByAccoutId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public MCustomerNss setupSelect_MCustomerByAccoutId() {
        assertSetupSelectPurpose("mCustomerByAccoutId");
        if (hasSpecifiedLocalColumn()) {
            specify().columnAccountId();
        }
        doSetupSelect(() -> query().queryMCustomerByAccoutId());
        if (_nssMCustomerByAccoutId == null || !_nssMCustomerByAccoutId.hasConditionQuery())
        { _nssMCustomerByAccoutId = new MCustomerNss(query().queryMCustomerByAccoutId()); }
        return _nssMCustomerByAccoutId;
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<TShippingInstHCQ> {
        ...
        protected MSalesOrgCB.HpSpecification _mSalesOrgBySalesOrg;
        protected MCustomerCB.HpSpecification _mCustomerByAccoutId;
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnRecordSendFlg() { return doColumn("RECORD_SEND_FLG"); }
        /**
         * CARRIER_DATA_OUT_FLG: {CHAR(1), default=[0]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCarrierDataOutFlg() { return doColumn("CARRIER_DATA_OUT_FLG"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnNizoroeId() { return doColumn("NIZOROE_ID"); }
        /**
         * NIZOROE_PROC_UNIT: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnNizoroeProcUnit() { return doColumn("NIZOROE_PROC_UNIT"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnAccountCd() { return doColumn("ACCOUNT_CD"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnTransferFlg() { return doColumn("TRANSFER_FLG"); }
        /**
         * TENHANSHA_SALES_ORDER_NO: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnTenhanshaSalesOrderNo() { return doColumn("TENHANSHA_SALES_ORDER_NO"); }
        /**
         * DELIV_CD: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSalesOrderNum() { return doColumn("SALES_ORDER_NUM"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnDirectUpdFlg() { return doColumn("DIRECT_UPD_FLG"); }
        /**
         * IF_ID: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnDeliveryType() { return doColumn("DELIVERY_TYPE"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryMSalesOrgBySalesOrg()
                    || qyCall().qy().xgetReferrerQuery() instanceof MSalesOrgCQ) {
                columnSalesOrgCd(); // FK or one-to-one referrer
            }
            if (qyCall().qy().hasConditionQueryMCustomerByAccoutId()
                    || qyCall().qy().xgetReferrerQuery() instanceof MCustomerCQ) {
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public MSalesOrgCB.HpSpecification specifyMSalesOrgBySalesOrg() {
            assertRelation("mSalesOrgBySalesOrg");
            if (_mSalesOrgBySalesOrg == null) {
                _mSalesOrgBySalesOrg = new MSalesOrgCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryMSalesOrgBySalesOrg()
                                    , () -> _qyCall.qy().queryMSalesOrgBySalesOrg())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _mSalesOrgBySalesOrg.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryMSalesOrgBySalesOrg()
                      , () -> xsyncQyCall().qy().queryMSalesOrgBySalesOrg()));
                }
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public MCustomerCB.HpSpecification specifyMCustomerByAccoutId() {
            assertRelation("mCustomerByAccoutId");
            if (_mCustomerByAccoutId == null) {
                _mCustomerByAccoutId = new MCustomerCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryMCustomerByAccoutId()
                                    , () -> _qyCall.qy().queryMCustomerByAccoutId())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _mCustomerByAccoutId.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryMCustomerByAccoutId()
                      , () -> xsyncQyCall().qy().queryMCustomerByAccoutId()));
                }
            }
        ...
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_shipping_inst_h_print where ...) as FOO_MAX} <br>
         * t_shipping_inst_h_print by SHIPPING_INST_H_ID, named 'TShippingInstHPrintList'.
         * <pre>
         * cb.specify().<span style="color: #CC4747">derived${relationMethodIdentityName}()</span>.<span style="color: #CC4747">max</span>(printCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
         *     printCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     printCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, TShippingInstHPrint.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TShippingInstHPrintCB, TShippingInstHCQ> derivedTShippingInstHPrintList() {
            assertDerived("tShippingInstHPrintList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TShippingInstHPrintCB> sq, TShippingInstHCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTShippingInstHPrintList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
