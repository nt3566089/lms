...
/**
 * The base condition-bean of es_koguchi_delivery.
 * @author DBFlute(AutoGenerator)
 */
public class BsEsKoguchiDeliveryCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected EsKoguchiDeliveryCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsKoguchiDeliveryCB() {
     ...
     * @return this. (NotNull)
     */
    public EsKoguchiDeliveryCB acceptPK(Long koguchiDeliveryId) {
        assertObjectNotNull("koguchiDeliveryId", koguchiDeliveryId);
        BsEsKoguchiDeliveryCB cb = this;
        cb.query().setKoguchiDeliveryId_Equal(koguchiDeliveryId);
        return (EsKoguchiDeliveryCB)this;
    }
     ...
     */
    public EsKoguchiDeliveryCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public EsKoguchiDeliveryCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected EsKoguchiDeliveryCQ doGetConditionQuery() {
    ...
    protected EsKoguchiDeliveryCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected EsKoguchiDeliveryCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        EsKoguchiDeliveryCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected EsKoguchiDeliveryCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new EsKoguchiDeliveryCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<EsKoguchiDeliveryCB> unionCBLambda) {
        final EsKoguchiDeliveryCB cb = new EsKoguchiDeliveryCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EsKoguchiDeliveryCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<EsKoguchiDeliveryCB> unionCBLambda) {
        final EsKoguchiDeliveryCB cb = new EsKoguchiDeliveryCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EsKoguchiDeliveryCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<EsKoguchiDeliveryCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<EsKoguchiDeliveryCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "es_koguchi_delivery"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<EsKoguchiDeliveryCB, EsKoguchiDeliveryCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<EsKoguchiDeliveryCB> sq, EsKoguchiDeliveryCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public EsKoguchiDeliveryCB dreamCruiseCB() {
        EsKoguchiDeliveryCB cb = new EsKoguchiDeliveryCB();
        cb.xsetupForDreamCruise((EsKoguchiDeliveryCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<EsKoguchiDeliveryCB> columnQuery(final SpecifyQuery<EsKoguchiDeliveryCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected EsKoguchiDeliveryCB xcreateColumnQueryCB() {
        EsKoguchiDeliveryCB cb = new EsKoguchiDeliveryCB();
        cb.xsetupForColumnQuery((EsKoguchiDeliveryCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<EsKoguchiDeliveryCB> orCBLambda) {
        xorSQ((EsKoguchiDeliveryCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<EsKoguchiDeliveryCB> andCBLambda) {
        xorSQAP((EsKoguchiDeliveryCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final EsKoguchiDeliveryCB cb;
        if (mainCB != null) {
            cb = (EsKoguchiDeliveryCB)mainCB;
        } else {
            cb = new EsKoguchiDeliveryCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return EsKoguchiDeliveryCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return EsKoguchiDeliveryCQ.class.getName(); }
