...
public class BsMCarrierCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MCarrierCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnLargeItemHadlingFlg() { return doColumn("LARGE_ITEM_HADLING_FLG"); }
        /**
         * HEAVY_ITEM_HADLING_FLG: {NotNull, CHAR(1), default=[0]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnHeavyItemHadlingFlg() { return doColumn("HEAVY_ITEM_HADLING_FLG"); }
        /**
         * HOLIDAY_CARRIER_FLG: {NotNull, CHAR(1), default=[0]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnHolidayCarrierFlg() { return doColumn("HOLIDAY_CARRIER_FLG"); }
        /**
         * OKINAWA_FLIGHT_FLG: {NotNull, CHAR(1), default=[0]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnOkinawaFlightFlg() { return doColumn("OKINAWA_FLIGHT_FLG"); }
        /**
         * BASE_DEFAULT_CARRIER_FLG: {NotNull, CHAR(1), default=[0]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnBaseDefaultCarrierFlg() { return doColumn("BASE_DEFAULT_CARRIER_FLG"); }
        /**
         * INSURANCE_CARRIER_CD: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnInsuranceCarrierCd() { return doColumn("INSURANCE_CARRIER_CD"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnProperFlg() { return doColumn("PROPER_FLG"); }
        /**
         * LANE_CD: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnLaneCd() { return doColumn("LANE_CD"); }
        /**
         ...
         */
        public HpSDRFunction<MBaseSalesOrgCB, MCarrierCQ> derivedMBaseSalesOrgList() {
            assertDerived("mBaseSalesOrgList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MBaseSalesOrgCB> sq, MCarrierCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MCarrierDecisionCB, MCarrierCQ> derivedMCarrierDecisionByCarrierId2List() {
            assertDerived("mCarrierDecisionByCarrierId2List"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MCarrierDecisionCB> sq, MCarrierCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveMCarrierDecisionByCarrierId2List(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from m_carrier_decision where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MCarrierDecisionCB, MCarrierCQ> derivedMCarrierDecisionByCarrierId1List() {
            assertDerived("mCarrierDecisionByCarrierId1List"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MCarrierDecisionCB> sq, MCarrierCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveMCarrierDecisionByCarrierId1List(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from m_carrier_decision where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MCarrierDecisionCB, MCarrierCQ> derivedMCarrierDecisionByCarrierId3List() {
            assertDerived("mCarrierDecisionByCarrierId3List"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MCarrierDecisionCB> sq, MCarrierCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveMCarrierDecisionByCarrierId3List(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from m_carrier_decision where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MCarrierDecisionCB, MCarrierCQ> derivedMCarrierDecisionByCarrierIdList() {
            assertDerived("mCarrierDecisionByCarrierIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MCarrierDecisionCB> sq, MCarrierCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveMCarrierDecisionByCarrierIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MKoguchiDeliveryCB, MCarrierCQ> derivedMKoguchiDeliveryList() {
            assertDerived("mKoguchiDeliveryList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MKoguchiDeliveryCB> sq, MCarrierCQ cq, String al, DerivedReferrerOption op)
