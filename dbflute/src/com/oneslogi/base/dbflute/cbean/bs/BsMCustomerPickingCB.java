...
/**
 * The base condition-bean of m_customer_picking.
 * @author DBFlute(AutoGenerator)
 */
public class BsMCustomerPickingCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MCustomerPickingCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMCustomerPickingCB() {
     ...
     * @return this. (NotNull)
     */
    public MCustomerPickingCB acceptPK(Long customerPickingId) {
        assertObjectNotNull("customerPickingId", customerPickingId);
        BsMCustomerPickingCB cb = this;
        cb.query().setCustomerPickingId_Equal(customerPickingId);
        return (MCustomerPickingCB)this;
    }
     ...
     * @param customerPickingId : PK, ID, NotNull, BIGINT(19). (NotNull)
     */
    public void acceptPrimaryKey(Long customerPickingId) {
        assertObjectNotNull("customerPickingId", customerPickingId);
        BsMCustomerPickingCB cb = this;
        cb.query().setCustomerPickingId_Equal(customerPickingId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_CustomerPickingId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_CustomerPickingId_Desc();
        return this;
    }
     ...
     */
    public MCustomerPickingCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MCustomerPickingCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MCustomerPickingCQ doGetConditionQuery() {
    ...
    protected MCustomerPickingCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MCustomerPickingCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MCustomerPickingCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MCustomerPickingCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MCustomerPickingCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MCustomerPickingCB> unionCBLambda) {
        final MCustomerPickingCB cb = new MCustomerPickingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MCustomerPickingCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MCustomerPickingCB> unionCBLambda) {
        final MCustomerPickingCB cb = new MCustomerPickingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MCustomerPickingCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCustomerPickingBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">mCustomerPicking</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mCustomerPicking</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mCustomerPicking</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mCustomerPicking</span>.<span style="color: #CC4747">getMSalesOrg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mCustomerPicking</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mCustomerPicking</span>.<span style="color: #CC4747">getMCustomer()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<MCustomerPickingCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MCustomerPickingCQ> qyCall
         ...
         */
        public SpecifiedColumn columnCustomerPickingId() { return doColumn("CUSTOMER_PICKING_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPickPatternCd() { return doColumn("PICK_PATTERN_CD"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "m_customer_picking"; }
        /**
         ...
         */
        public HpSDRFunction<MCustomerPickingCB, MCustomerPickingCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MCustomerPickingCB> sq, MCustomerPickingCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MCustomerPickingCB dreamCruiseCB() {
        MCustomerPickingCB cb = new MCustomerPickingCB();
        cb.xsetupForDreamCruise((MCustomerPickingCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MCustomerPickingCB> columnQuery(final SpecifyQuery<MCustomerPickingCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MCustomerPickingCB xcreateColumnQueryCB() {
        MCustomerPickingCB cb = new MCustomerPickingCB();
        cb.xsetupForColumnQuery((MCustomerPickingCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MCustomerPickingCB> orCBLambda) {
        xorSQ((MCustomerPickingCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MCustomerPickingCB> andCBLambda) {
        xorSQAP((MCustomerPickingCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MCustomerPickingCB cb;
        if (mainCB != null) {
            cb = (MCustomerPickingCB)mainCB;
        } else {
            cb = new MCustomerPickingCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MCustomerPickingCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MCustomerPickingCQ.class.getName(); }
