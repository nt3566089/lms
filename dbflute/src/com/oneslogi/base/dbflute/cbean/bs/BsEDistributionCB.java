...
/**
 * The base condition-bean of e_distribution.
 * @author DBFlute(AutoGenerator)
 */
public class BsEDistributionCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected EDistributionCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsEDistributionCB() {
     ...
     * @return this. (NotNull)
     */
    public EDistributionCB acceptPK(Long distributionId) {
        assertObjectNotNull("distributionId", distributionId);
        BsEDistributionCB cb = this;
        cb.query().setDistributionId_Equal(distributionId);
        return (EDistributionCB)this;
    }
     ...
     */
    public EDistributionCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public EDistributionCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected EDistributionCQ doGetConditionQuery() {
    ...
    protected EDistributionCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected EDistributionCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        EDistributionCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected EDistributionCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new EDistributionCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<EDistributionCB> unionCBLambda) {
        final EDistributionCB cb = new EDistributionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EDistributionCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<EDistributionCB> unionCBLambda) {
        final EDistributionCB cb = new EDistributionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EDistributionCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<EDistributionCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<EDistributionCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "e_distribution"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<EDistributionCB, EDistributionCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<EDistributionCB> sq, EDistributionCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public EDistributionCB dreamCruiseCB() {
        EDistributionCB cb = new EDistributionCB();
        cb.xsetupForDreamCruise((EDistributionCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<EDistributionCB> columnQuery(final SpecifyQuery<EDistributionCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected EDistributionCB xcreateColumnQueryCB() {
        EDistributionCB cb = new EDistributionCB();
        cb.xsetupForColumnQuery((EDistributionCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<EDistributionCB> orCBLambda) {
        xorSQ((EDistributionCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<EDistributionCB> andCBLambda) {
        xorSQAP((EDistributionCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final EDistributionCB cb;
        if (mainCB != null) {
            cb = (EDistributionCB)mainCB;
        } else {
            cb = new EDistributionCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return EDistributionCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return EDistributionCQ.class.getName(); }
