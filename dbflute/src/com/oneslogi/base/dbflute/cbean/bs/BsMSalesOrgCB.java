    ...
    public static class HpSpecification extends HpAbstractSpecification<MSalesOrgCQ> {
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().xgetReferrerQuery() instanceof TShippingInstHCQ) {
                columnSalesOrgCd(); // non PK but referred column (and referrer also non PK)
            }
        }
        @Override
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TShippingInstHCB, MSalesOrgCQ> derivedTShippingInstHBySalesOrgList() {
            assertDerived("tShippingInstHBySalesOrgList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TShippingInstHCB> sq, MSalesOrgCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTShippingInstHBySalesOrgList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
