...
public class BsWHtReceiveInspectionCB extends AbstractConditionBean {
     ...
     * @param htReceiveInspectionId : PK, ID, NotNull, BIGINT(19). (NotNull)
     * @return this. (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WHtReceiveInspectionCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnProductionDt() { return doColumn("PRODUCTION_DT"); }
        /**
         * INPUT_ASSISTANCE_UNIT_NUM: {BIGINT(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnInputAssistanceUnitNum() { return doColumn("INPUT_ASSISTANCE_UNIT_NUM"); }
        /**
         * INPUT_ASSISTANCE_CASE_NUM: {DECIMAL(14, 4)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnInputAssistanceCaseNum() { return doColumn("INPUT_ASSISTANCE_CASE_NUM"); }
        /**
         * INPUT_ASSISTANCE_PIECE_NUM: {DECIMAL(14, 4)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnInputAssistancePieceNum() { return doColumn("INPUT_ASSISTANCE_PIECE_NUM"); }
        /**
         * CASE_RECEIVE_LABEL_NUM: {BIGINT(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCaseReceiveLabelNum() { return doColumn("CASE_RECEIVE_LABEL_NUM"); }
        /**
         * PIECE_RECEIVE_LABEL_NUM: {BIGINT(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPieceReceiveLabelNum() { return doColumn("PIECE_RECEIVE_LABEL_NUM"); }
        /**
