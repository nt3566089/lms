...
public class BsTPickingHCB extends AbstractConditionBean {
     ...
     * @param pickingHId : PK, ID, NotNull, BIGINT(19). (NotNull)
     * @return this. (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<TPickingHCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPickForceCopleteFlg() { return doColumn("PICK_FORCE_COPLETE_FLG"); }
        /**
         * INSP_FORCE_COPLETE_FLG: {CHAR(1), default=[0]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnInspForceCopleteFlg() { return doColumn("INSP_FORCE_COPLETE_FLG"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnNizoroePrintTypeCd() { return doColumn("NIZOROE_PRINT_TYPE_CD"); }
        /**
         * DELIV_PRINT_TYPE_CD: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnDelivPrintTypeCd() { return doColumn("DELIV_PRINT_TYPE_CD"); }
        /**
         * TAG_PRINT_TYPE_CD: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnTagPrintTypeCd() { return doColumn("TAG_PRINT_TYPE_CD"); }
        /**
         * INTEG_PRINT_FLG: {CHAR(1)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnIntegPrintFlg() { return doColumn("INTEG_PRINT_FLG"); }
        /**
         * ID_MANAG_PRINT_TYPE_CD: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnIdManagPrintTypeCd() { return doColumn("ID_MANAG_PRINT_TYPE_CD"); }
        /**
         * PLL_PRINT_FLG: {CHAR(1)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPllPrintFlg() { return doColumn("PLL_PRINT_FLG"); }
        /**
