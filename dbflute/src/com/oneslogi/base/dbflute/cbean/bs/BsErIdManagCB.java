...
/**
 * The base condition-bean of er_id_manag.
 * @author DBFlute(AutoGenerator)
 */
public class BsErIdManagCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ErIdManagCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsErIdManagCB() {
     ...
     * @return this. (NotNull)
     */
    public ErIdManagCB acceptPK(Long idManagId) {
        assertObjectNotNull("idManagId", idManagId);
        BsErIdManagCB cb = this;
        cb.query().setIdManagId_Equal(idManagId);
        return (ErIdManagCB)this;
    }
     ...
     * @param idManagId : PK, NotNull, BIGINT(19). (NotNull)
     */
    public void acceptPrimaryKey(Long idManagId) {
        assertObjectNotNull("idManagId", idManagId);
        BsErIdManagCB cb = this;
        cb.query().setIdManagId_Equal(idManagId);
    }
     ...
     * @return this. (NotNull)
     */
    public ErIdManagCB acceptUniqueOf(String receiveCd, Long receiveRowId) {
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_IdManagId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_IdManagId_Desc();
        return this;
    }
     ...
     */
    public ErIdManagCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ErIdManagCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ErIdManagCQ doGetConditionQuery() {
    ...
    protected ErIdManagCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ErIdManagCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ErIdManagCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ErIdManagCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ErIdManagCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ErIdManagCB> unionCBLambda) {
        final ErIdManagCB cb = new ErIdManagCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErIdManagCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ErIdManagCB> unionCBLambda) {
        final ErIdManagCB cb = new ErIdManagCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErIdManagCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ErIdManagCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ErIdManagCQ> qyCall
         ...
         */
        public SpecifiedColumn columnIdManagId() { return doColumn("ID_MANAG_ID"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "er_id_manag"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<ErIdManagCB, ErIdManagCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ErIdManagCB> sq, ErIdManagCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ErIdManagCB dreamCruiseCB() {
        ErIdManagCB cb = new ErIdManagCB();
        cb.xsetupForDreamCruise((ErIdManagCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ErIdManagCB> columnQuery(final SpecifyQuery<ErIdManagCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ErIdManagCB xcreateColumnQueryCB() {
        ErIdManagCB cb = new ErIdManagCB();
        cb.xsetupForColumnQuery((ErIdManagCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ErIdManagCB> orCBLambda) {
        xorSQ((ErIdManagCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ErIdManagCB> andCBLambda) {
        xorSQAP((ErIdManagCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ErIdManagCB cb;
        if (mainCB != null) {
            cb = (ErIdManagCB)mainCB;
        } else {
            cb = new ErIdManagCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ErIdManagCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ErIdManagCQ.class.getName(); }
