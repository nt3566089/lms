...
/**
 * The base condition-bean of t_shipping_inst_h_print.
 * @author DBFlute(AutoGenerator)
 */
public class BsTShippingInstHPrintCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TShippingInstHPrintCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTShippingInstHPrintCB() {
     ...
     * @return this. (NotNull)
     */
    public TShippingInstHPrintCB acceptPK(Long shippingInstHPrintId) {
        assertObjectNotNull("shippingInstHPrintId", shippingInstHPrintId);
        BsTShippingInstHPrintCB cb = this;
        cb.query().setShippingInstHPrintId_Equal(shippingInstHPrintId);
        return (TShippingInstHPrintCB)this;
    }
     ...
     * @param shippingInstHPrintId : PK, ID, IX, NotNull, BIGINT(19). (NotNull)
     */
    public void acceptPrimaryKey(Long shippingInstHPrintId) {
        assertObjectNotNull("shippingInstHPrintId", shippingInstHPrintId);
        BsTShippingInstHPrintCB cb = this;
        cb.query().setShippingInstHPrintId_Equal(shippingInstHPrintId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_ShippingInstHPrintId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_ShippingInstHPrintId_Desc();
        return this;
    }
     ...
     */
    public TShippingInstHPrintCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TShippingInstHPrintCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TShippingInstHPrintCQ doGetConditionQuery() {
    ...
    protected TShippingInstHPrintCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TShippingInstHPrintCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TShippingInstHPrintCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TShippingInstHPrintCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TShippingInstHPrintCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TShippingInstHPrintCB> unionCBLambda) {
        final TShippingInstHPrintCB cb = new TShippingInstHPrintCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TShippingInstHPrintCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TShippingInstHPrintCB> unionCBLambda) {
        final TShippingInstHPrintCB cb = new TShippingInstHPrintCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TShippingInstHPrintCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tShippingInstHPrintBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">tShippingInstHPrint</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tShippingInstHPrint</span>.<span style="color: #CC4747">getTShippingInstH()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<TShippingInstHPrintCQ> {
        protected TShippingInstHCB.HpSpecification _tShippingInstH;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TShippingInstHPrintCQ> qyCall
         ...
         */
        public SpecifiedColumn columnShippingInstHPrintId() { return doColumn("SHIPPING_INST_H_PRINT_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnShippingReason() { return doColumn("SHIPPING_REASON"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnTenhanshaId() { return doColumn("TENHANSHA_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnContractorNm() { return doColumn("CONTRACTOR_NM"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "t_shipping_inst_h_print"; }
        /**
         ...
         */
        public HpSDRFunction<TShippingInstHPrintCB, TShippingInstHPrintCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TShippingInstHPrintCB> sq, TShippingInstHPrintCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TShippingInstHPrintCB dreamCruiseCB() {
        TShippingInstHPrintCB cb = new TShippingInstHPrintCB();
        cb.xsetupForDreamCruise((TShippingInstHPrintCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TShippingInstHPrintCB> columnQuery(final SpecifyQuery<TShippingInstHPrintCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TShippingInstHPrintCB xcreateColumnQueryCB() {
        TShippingInstHPrintCB cb = new TShippingInstHPrintCB();
        cb.xsetupForColumnQuery((TShippingInstHPrintCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TShippingInstHPrintCB> orCBLambda) {
        xorSQ((TShippingInstHPrintCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TShippingInstHPrintCB> andCBLambda) {
        xorSQAP((TShippingInstHPrintCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TShippingInstHPrintCB cb;
        if (mainCB != null) {
            cb = (TShippingInstHPrintCB)mainCB;
        } else {
            cb = new TShippingInstHPrintCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TShippingInstHPrintCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TShippingInstHPrintCQ.class.getName(); }
