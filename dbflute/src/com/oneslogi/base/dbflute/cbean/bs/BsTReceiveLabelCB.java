...
/**
 * The base condition-bean of t_receive_label.
 * @author DBFlute(AutoGenerator)
 */
public class BsTReceiveLabelCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TReceiveLabelCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTReceiveLabelCB() {
     ...
     * @return this. (NotNull)
     */
    public TReceiveLabelCB acceptPK(Long receiveLabelId) {
        assertObjectNotNull("receiveLabelId", receiveLabelId);
        BsTReceiveLabelCB cb = this;
        cb.query().setReceiveLabelId_Equal(receiveLabelId);
        return (TReceiveLabelCB)this;
    }
     ...
     * @param receiveLabelId : PK, ID, NotNull, BIGINT(19). (NotNull)
     */
    public void acceptPrimaryKey(Long receiveLabelId) {
        assertObjectNotNull("receiveLabelId", receiveLabelId);
        BsTReceiveLabelCB cb = this;
        cb.query().setReceiveLabelId_Equal(receiveLabelId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_ReceiveLabelId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_ReceiveLabelId_Desc();
        return this;
    }
     ...
     */
    public TReceiveLabelCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TReceiveLabelCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TReceiveLabelCQ doGetConditionQuery() {
    ...
    protected TReceiveLabelCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TReceiveLabelCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TReceiveLabelCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TReceiveLabelCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TReceiveLabelCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TReceiveLabelCB> unionCBLambda) {
        final TReceiveLabelCB cb = new TReceiveLabelCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TReceiveLabelCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TReceiveLabelCB> unionCBLambda) {
        final TReceiveLabelCB cb = new TReceiveLabelCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TReceiveLabelCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tReceiveLabelBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">tReceiveLabel</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tReceiveLabel</span>.<span style="color: #CC4747">getTReceivePlanB()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tReceiveLabel</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tReceiveLabel</span>.<span style="color: #CC4747">getTStock()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tReceiveLabel</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tReceiveLabel</span>.<span style="color: #CC4747">getBUser()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<TReceiveLabelCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TReceiveLabelCQ> qyCall
         ...
         */
        public SpecifiedColumn columnReceiveLabelId() { return doColumn("RECEIVE_LABEL_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnOwnerAbbr() { return doColumn("OWNER_ABBR"); }
        /**
         * RECOMMEND_LOCATION_CD: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnRecommendLocationCd() { return doColumn("RECOMMEND_LOCATION_CD"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnJancd() { return doColumn("JANCD"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnReprintFlg() { return doColumn("REPRINT_FLG"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnRcvLblOutUserId() { return doColumn("RCV_LBL_OUT_USER_ID"); }
        /**
         * RCV_LBL_OUT_DT: {DATETIME(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnRcvLblOutDt() { return doColumn("RCV_LBL_OUT_DT"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryBUser()
                ...
                columnRcvLblOutUserId(); // FK or one-to-one referrer
            }
        }
        @Override
        protected String getTableDbName() { return "t_receive_label"; }
        /**
         ...
         */
        public HpSDRFunction<TReceiveLabelCB, TReceiveLabelCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TReceiveLabelCB> sq, TReceiveLabelCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TReceiveLabelCB dreamCruiseCB() {
        TReceiveLabelCB cb = new TReceiveLabelCB();
        cb.xsetupForDreamCruise((TReceiveLabelCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TReceiveLabelCB> columnQuery(final SpecifyQuery<TReceiveLabelCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TReceiveLabelCB xcreateColumnQueryCB() {
        TReceiveLabelCB cb = new TReceiveLabelCB();
        cb.xsetupForColumnQuery((TReceiveLabelCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TReceiveLabelCB> orCBLambda) {
        xorSQ((TReceiveLabelCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TReceiveLabelCB> andCBLambda) {
        xorSQAP((TReceiveLabelCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TReceiveLabelCB cb;
        if (mainCB != null) {
            cb = (TReceiveLabelCB)mainCB;
        } else {
            cb = new TReceiveLabelCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TReceiveLabelCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TReceiveLabelCQ.class.getName(); }
