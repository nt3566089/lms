...
/**
 * The base condition-bean of er_scm_label.
 * @author DBFlute(AutoGenerator)
 */
public class BsErScmLabelCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ErScmLabelCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsErScmLabelCB() {
     ...
     * @return this. (NotNull)
     */
    public ErScmLabelCB acceptPK(Long scmLabelId) {
        assertObjectNotNull("scmLabelId", scmLabelId);
        BsErScmLabelCB cb = this;
        cb.query().setScmLabelId_Equal(scmLabelId);
        return (ErScmLabelCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ErScmLabelCB acceptUniqueOf(String receiveCd, Long receiveRowId) {
     ...
     */
    public ErScmLabelCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ErScmLabelCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ErScmLabelCQ doGetConditionQuery() {
    ...
    protected ErScmLabelCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ErScmLabelCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ErScmLabelCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ErScmLabelCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ErScmLabelCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ErScmLabelCB> unionCBLambda) {
        final ErScmLabelCB cb = new ErScmLabelCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErScmLabelCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ErScmLabelCB> unionCBLambda) {
        final ErScmLabelCB cb = new ErScmLabelCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErScmLabelCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ErScmLabelCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ErScmLabelCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCartonIdNo() { return doColumn("CARTON_ID_NO"); }
        /**
         * SN: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnManagTypeCd() { return doColumn("MANAG_TYPE_CD"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "er_scm_label"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<ErScmLabelCB, ErScmLabelCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ErScmLabelCB> sq, ErScmLabelCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ErScmLabelCB dreamCruiseCB() {
        ErScmLabelCB cb = new ErScmLabelCB();
        cb.xsetupForDreamCruise((ErScmLabelCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ErScmLabelCB> columnQuery(final SpecifyQuery<ErScmLabelCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ErScmLabelCB xcreateColumnQueryCB() {
        ErScmLabelCB cb = new ErScmLabelCB();
        cb.xsetupForColumnQuery((ErScmLabelCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ErScmLabelCB> orCBLambda) {
        xorSQ((ErScmLabelCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ErScmLabelCB> andCBLambda) {
        xorSQAP((ErScmLabelCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ErScmLabelCB cb;
        if (mainCB != null) {
            cb = (ErScmLabelCB)mainCB;
        } else {
            cb = new ErScmLabelCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ErScmLabelCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ErScmLabelCQ.class.getName(); }
