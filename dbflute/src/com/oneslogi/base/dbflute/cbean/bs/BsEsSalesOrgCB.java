...
/**
 * The base condition-bean of es_sales_org.
 * @author DBFlute(AutoGenerator)
 */
public class BsEsSalesOrgCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected EsSalesOrgCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsSalesOrgCB() {
     ...
     * @return this. (NotNull)
     */
    public EsSalesOrgCB acceptPK(Long salesOrgId) {
        assertObjectNotNull("salesOrgId", salesOrgId);
        BsEsSalesOrgCB cb = this;
        cb.query().setSalesOrgId_Equal(salesOrgId);
        return (EsSalesOrgCB)this;
    }
     ...
     */
    public EsSalesOrgCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public EsSalesOrgCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected EsSalesOrgCQ doGetConditionQuery() {
    ...
    protected EsSalesOrgCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected EsSalesOrgCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        EsSalesOrgCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected EsSalesOrgCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new EsSalesOrgCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<EsSalesOrgCB> unionCBLambda) {
        final EsSalesOrgCB cb = new EsSalesOrgCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EsSalesOrgCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<EsSalesOrgCB> unionCBLambda) {
        final EsSalesOrgCB cb = new EsSalesOrgCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EsSalesOrgCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<EsSalesOrgCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<EsSalesOrgCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "es_sales_org"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<EsSalesOrgCB, EsSalesOrgCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<EsSalesOrgCB> sq, EsSalesOrgCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public EsSalesOrgCB dreamCruiseCB() {
        EsSalesOrgCB cb = new EsSalesOrgCB();
        cb.xsetupForDreamCruise((EsSalesOrgCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<EsSalesOrgCB> columnQuery(final SpecifyQuery<EsSalesOrgCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected EsSalesOrgCB xcreateColumnQueryCB() {
        EsSalesOrgCB cb = new EsSalesOrgCB();
        cb.xsetupForColumnQuery((EsSalesOrgCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<EsSalesOrgCB> orCBLambda) {
        xorSQ((EsSalesOrgCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<EsSalesOrgCB> andCBLambda) {
        xorSQAP((EsSalesOrgCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final EsSalesOrgCB cb;
        if (mainCB != null) {
            cb = (EsSalesOrgCB)mainCB;
        } else {
            cb = new EsSalesOrgCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return EsSalesOrgCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return EsSalesOrgCQ.class.getName(); }
