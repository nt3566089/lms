...
public class BsTPickingBCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<TPickingBCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPickedNum() { return doColumn("PICKED_NUM"); }
        /**
         * PICKING_PATERN_CD: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPickingPaternCd() { return doColumn("PICKING_PATERN_CD"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnOldPickingBId() { return doColumn("OLD_PICKING_B_ID"); }
        /**
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TPickingRecordStockCB, TPickingBCQ> derivedTPickingRecordStockList() {
            assertDerived("tPickingRecordStockList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TPickingRecordStockCB> sq, TPickingBCQ cq, String al, DerivedReferrerOption op)
