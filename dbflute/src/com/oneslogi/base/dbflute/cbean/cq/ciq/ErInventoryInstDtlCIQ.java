...
/**
 * The condition-query for in-line of er_inventory_inst_dtl.
 * @author DBFlute(AutoGenerator)
 */
public class ErInventoryInstDtlCIQ extends AbstractBsErInventoryInstDtlCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsErInventoryInstDtlCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ErInventoryInstDtlCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsErInventoryInstDtlCQ myCQ) {
    ...
    public String keepScalarCondition(ErInventoryInstDtlCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ErInventoryInstDtlCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ErInventoryInstDtlCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ErInventoryInstDtlCQ sq)
    ...
    protected String xinCB() { return ErInventoryInstDtlCB.class.getName(); }
    protected String xinCQ() { return ErInventoryInstDtlCQ.class.getName(); }
}
