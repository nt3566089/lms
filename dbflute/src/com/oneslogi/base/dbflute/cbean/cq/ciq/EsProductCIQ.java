...
/**
 * The condition-query for in-line of es_product.
 * @author DBFlute(AutoGenerator)
 */
public class EsProductCIQ extends AbstractBsEsProductCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEsProductCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EsProductCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEsProductCQ myCQ) {
    ...
    public String keepScalarCondition(EsProductCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EsProductCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EsProductCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EsProductCQ sq)
    ...
    protected String xinCB() { return EsProductCB.class.getName(); }
    protected String xinCQ() { return EsProductCQ.class.getName(); }
}
