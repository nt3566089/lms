...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsMBaseSalesOrgCQ;

/**
 * The condition-query of m_base_sales_org.
 * <p>
 ...
 */
public class MBaseSalesOrgCQ extends BsMBaseSalesOrgCQ {
     ...
     */
    public MBaseSalesOrgCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
