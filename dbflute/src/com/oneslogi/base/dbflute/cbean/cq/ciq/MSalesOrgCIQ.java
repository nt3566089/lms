...
public class MSalesOrgCIQ extends AbstractBsMSalesOrgCQ {
    ...
    public String keepSalesOrgCd_ExistsReferrer_TShippingInstHBySalesOrgList(TShippingInstHCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepSalesOrgCd_NotExistsReferrer_TShippingInstHBySalesOrgList(TShippingInstHCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepSalesOrgCd_SpecifyDerivedReferrer_TShippingInstHBySalesOrgList(TShippingInstHCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepSalesOrgCd_QueryDerivedReferrer_TShippingInstHBySalesOrgList(TShippingInstHCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepSalesOrgCd_QueryDerivedReferrer_TShippingInstHBySalesOrgListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
