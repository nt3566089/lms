...
public abstract class AbstractBsMParamCQ extends AbstractConditionQuery {
     ...
     * CLIENT_CENTER_ID: {PK, NotNull, BIGINT(19), FK to m_client_center}
     ...
     * STORE_DT_FLG: {CHAR(1), default=[0], FK to B_CLASS_DTL, classification=StoreDtFlg}
     */
    public void setStoreDtFlg_IsNullOrEmpty() { regStoreDtFlg(CK_ISNOE, DOBJ); }
     ...
     * OVER_STORE_NUM_FLG: {CHAR(1), default=[0], FK to B_CLASS_DTL, classification=OverStoreNumFlg}
     */
    public void setOverStoreNumFlg_IsNullOrEmpty() { regOverStoreNumFlg(CK_ISNOE, DOBJ); }
     ...
     * PAST_STORE_DT_FLG: {CHAR(1), default=[0], FK to B_CLASS_DTL, classification=PastStoreDtFlg}
     */
    public void setPastStoreDtFlg_IsNullOrEmpty() { regPastStoreDtFlg(CK_ISNOE, DOBJ); }
     ...
     * CASE_PIC_FLG: {CHAR(1), default=[0], FK to B_CLASS_DTL, classification=CasePicFlg}
     */
    public void setCasePicFlg_IsNullOrEmpty() { regCasePicFlg(CK_ISNOE, DOBJ); }
     ...
     * PIC_MTHD_RCMD_MLT_PL_OUT: {CHAR(1), FK to B_CLASS_DTL, classification=PicMthdRcmdListOut}
     */
    public void setPicMthdRcmdMltPlOut_IsNullOrEmpty() { regPicMthdRcmdMltPlOut(CK_ISNOE, DOBJ); }
     ...
     * PIC_MTHD_RCMD_SPL_SL_OUT: {CHAR(1), FK to B_CLASS_DTL, classification=PicMthdRcmdListOut}
     */
    public void setPicMthdRcmdSplSlOut_IsNullOrEmpty() { regPicMthdRcmdSplSlOut(CK_ISNOE, DOBJ); }
     ...
     * PRODUCT_LABEL_OUT_UNIT: {CHAR(1), FK to B_CLASS_DTL, classification=ProductLabelOutUnit}
     */
    public void setProductLabelOutUnit_IsNullOrEmpty() { regProductLabelOutUnit(CK_ISNOE, DOBJ); }
     ...
     * RESULT_AFTER_PRODUCT_LABEL: {CHAR(1), FK to B_CLASS_DTL, classification=ResultAfterProductLabel}
     */
    public void setResultAfterProductLabel_IsNullOrEmpty() { regResultAfterProductLabel(CK_ISNOE, DOBJ); }
     ...
     * RESULT_AFTER_PRODUCT_TARGET: {CHAR(1), FK to B_CLASS_DTL, classification=ResultAfterProductTarget}
     */
    public void setResultAfterProductTarget_IsNullOrEmpty() { regResultAfterProductTarget(CK_ISNOE, DOBJ); }
     ...
     * BOX_SELECT_SKIP: {CHAR(1), FK to B_CLASS_DTL, classification=BoxSelectSkip}
     */
    public void setBoxSelectSkip_IsNullOrEmpty() { regBoxSelectSkip(CK_ISNOE, DOBJ); }
     ...
     * TAG_DELIVERY_OUT_FLG: {CHAR(1), FK to B_CLASS_DTL, classification=TagDeliveryOutFlg}
     */
    public void setTagDeliveryOutFlg_IsNullOrEmpty() { regTagDeliveryOutFlg(CK_ISNOE, DOBJ); }
     ...
     * AFTER_DELIV_SLIP_OUT_TGT: {CHAR(1), FK to B_CLASS_DTL, classification=AfterDelivSlipOutTgt}
     */
    public void setAfterDelivSlipOutTgt_IsNullOrEmpty() { regAfterDelivSlipOutTgt(CK_ISNOE, DOBJ); }
     ...
     * HT_CHAR_READ_FLG: {CHAR(1), default=[0], FK to B_CLASS_DTL, classification=HtCharReadFlg}
     */
    public void setHtCharReadFlg_IsNullOrEmpty() { regHtCharReadFlg(CK_ISNOE, DOBJ); }
     ...
     * INSPECTION_LABEL_OUT_FLG: {CHAR(1), default=[0], FK to B_CLASS_DTL, classification=InspectionLabelOutFlg}
     */
    public void setInspectionLabelOutFlg_IsNullOrEmpty() { regInspectionLabelOutFlg(CK_ISNOE, DOBJ); }
     ...
     * STOCK_OUT_AUTO_INST_FLG: {CHAR(1), FK to B_CLASS_DTL, classification=StockOutAutoInstFlg}
     */
    public void setStockOutAutoInstFlg_IsNullOrEmpty() { regStockOutAutoInstFlg(CK_ISNOE, DOBJ); }
     ...
     * STOCK_OUT_INST_SPLIT_FLG: {CHAR(1), default=[0], FK to B_CLASS_DTL, classification=StockOutInstSplitFlg}
     */
    public void setStockOutInstSplitFlg_IsNullOrEmpty() { regStockOutInstSplitFlg(CK_ISNOE, DOBJ); }
     ...
     * CES_INTEGRATION_FLG: {CHAR(1), FK to B_CLASS_DTL, classification=CesIntegrationFlg}
     */
    public void setCesIntegrationFlg_IsNullOrEmpty() { regCesIntegrationFlg(CK_ISNOE, DOBJ); }
     ...
     * PACKING_SLIP_AUTO_OUTPUT_FLG: {CHAR(1), FK to B_CLASS_DTL, classification=PackingSlipAutoOutputFlg}
     */
    public void setPackingSlipAutoOutputFlg_IsNullOrEmpty() { regPackingSlipAutoOutputFlg(CK_ISNOE, DOBJ); }
    ...
    /**
     * Equal(=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_LABEL_FLG: {CHAR(1)}
     * @param receiveLabelFlg The value of receiveLabelFlg as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveLabelFlg_Equal(String receiveLabelFlg) {
        doSetReceiveLabelFlg_Equal(fRES(receiveLabelFlg));
    }

    protected void doSetReceiveLabelFlg_Equal(String receiveLabelFlg) {
        regReceiveLabelFlg(CK_EQ, receiveLabelFlg);
    }

    /**
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_LABEL_FLG: {CHAR(1)}
     * @param receiveLabelFlg The value of receiveLabelFlg as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveLabelFlg_NotEqual(String receiveLabelFlg) {
        doSetReceiveLabelFlg_NotEqual(fRES(receiveLabelFlg));
    }

    protected void doSetReceiveLabelFlg_NotEqual(String receiveLabelFlg) {
        regReceiveLabelFlg(CK_NES, receiveLabelFlg);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_LABEL_FLG: {CHAR(1)}
     * @param receiveLabelFlg The value of receiveLabelFlg as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveLabelFlg_GreaterThan(String receiveLabelFlg) {
        regReceiveLabelFlg(CK_GT, fRES(receiveLabelFlg));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_LABEL_FLG: {CHAR(1)}
     * @param receiveLabelFlg The value of receiveLabelFlg as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveLabelFlg_LessThan(String receiveLabelFlg) {
        regReceiveLabelFlg(CK_LT, fRES(receiveLabelFlg));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_LABEL_FLG: {CHAR(1)}
     * @param receiveLabelFlg The value of receiveLabelFlg as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveLabelFlg_GreaterEqual(String receiveLabelFlg) {
        regReceiveLabelFlg(CK_GE, fRES(receiveLabelFlg));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_LABEL_FLG: {CHAR(1)}
     * @param receiveLabelFlg The value of receiveLabelFlg as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveLabelFlg_LessEqual(String receiveLabelFlg) {
        regReceiveLabelFlg(CK_LE, fRES(receiveLabelFlg));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * RECEIVE_LABEL_FLG: {CHAR(1)}
     * @param receiveLabelFlgList The collection of receiveLabelFlg as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveLabelFlg_InScope(Collection<String> receiveLabelFlgList) {
        doSetReceiveLabelFlg_InScope(receiveLabelFlgList);
    }

    protected void doSetReceiveLabelFlg_InScope(Collection<String> receiveLabelFlgList) {
        regINS(CK_INS, cTL(receiveLabelFlgList), xgetCValueReceiveLabelFlg(), "RECEIVE_LABEL_FLG");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * RECEIVE_LABEL_FLG: {CHAR(1)}
     * @param receiveLabelFlgList The collection of receiveLabelFlg as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveLabelFlg_NotInScope(Collection<String> receiveLabelFlgList) {
        doSetReceiveLabelFlg_NotInScope(receiveLabelFlgList);
    }

    protected void doSetReceiveLabelFlg_NotInScope(Collection<String> receiveLabelFlgList) {
        regINS(CK_NINS, cTL(receiveLabelFlgList), xgetCValueReceiveLabelFlg(), "RECEIVE_LABEL_FLG");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * RECEIVE_LABEL_FLG: {CHAR(1)} <br>
     * <pre>e.g. setReceiveLabelFlg_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param receiveLabelFlg The value of receiveLabelFlg as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setReceiveLabelFlg_LikeSearch(String receiveLabelFlg, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(receiveLabelFlg), xgetCValueReceiveLabelFlg(), "RECEIVE_LABEL_FLG", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * RECEIVE_LABEL_FLG: {CHAR(1)}
     * @param receiveLabelFlg The value of receiveLabelFlg as notLikeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setReceiveLabelFlg_NotLikeSearch(String receiveLabelFlg, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(receiveLabelFlg), xgetCValueReceiveLabelFlg(), "RECEIVE_LABEL_FLG", likeSearchOption);
    }

    /**
     * PrefixSearch {like 'xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * RECEIVE_LABEL_FLG: {CHAR(1)}
     * @param receiveLabelFlg The value of receiveLabelFlg as prefixSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveLabelFlg_PrefixSearch(String receiveLabelFlg) {
        setReceiveLabelFlg_LikeSearch(receiveLabelFlg, xcLSOPPre());
    }
     ...
     * RECEIVE_LABEL_FLG: {CHAR(1)}
     */
    public void setReceiveLabelFlg_IsNull() { regReceiveLabelFlg(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * RECEIVE_LABEL_FLG: {CHAR(1)}
     */
    public void setReceiveLabelFlg_IsNullOrEmpty() { regReceiveLabelFlg(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * RECEIVE_LABEL_FLG: {CHAR(1)}
     */
    public void setReceiveLabelFlg_IsNotNull() { regReceiveLabelFlg(CK_ISNN, DOBJ); }

    protected void regReceiveLabelFlg(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueReceiveLabelFlg(), "RECEIVE_LABEL_FLG"); }
    protected abstract ConditionValue xgetCValueReceiveLabelFlg();
