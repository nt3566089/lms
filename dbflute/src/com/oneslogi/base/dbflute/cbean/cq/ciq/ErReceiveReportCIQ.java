...
/**
 * The condition-query for in-line of er_receive_report.
 * @author DBFlute(AutoGenerator)
 */
public class ErReceiveReportCIQ extends AbstractBsErReceiveReportCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsErReceiveReportCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ErReceiveReportCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsErReceiveReportCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueReceiveReportId() { return _myCQ.xdfgetReceiveReportId(); }
    ...
    public String keepScalarCondition(ErReceiveReportCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ErReceiveReportCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ErReceiveReportCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ErReceiveReportCQ sq)
    ...
    protected String xinCB() { return ErReceiveReportCB.class.getName(); }
    protected String xinCQ() { return ErReceiveReportCQ.class.getName(); }
}
