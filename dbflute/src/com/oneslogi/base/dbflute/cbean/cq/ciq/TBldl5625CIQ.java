...
/**
 * The condition-query for in-line of t_bldl5625.
 * @author DBFlute(AutoGenerator)
 */
public class TBldl5625CIQ extends AbstractBsTBldl5625CQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTBldl5625CQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TBldl5625CIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTBldl5625CQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueBldl5625Id() { return _myCQ.xdfgetBldl5625Id(); }
    ...
    public String keepScalarCondition(TBldl5625CQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TBldl5625CQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TBldl5625CQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TBldl5625CQ sq)
    ...
    protected String xinCB() { return TBldl5625CB.class.getName(); }
    protected String xinCQ() { return TBldl5625CQ.class.getName(); }
}
