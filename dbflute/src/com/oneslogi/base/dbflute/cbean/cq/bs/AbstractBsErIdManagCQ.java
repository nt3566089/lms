...
/**
 * The abstract condition-query of er_id_manag.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsErIdManagCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsErIdManagCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<ErIdManagCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ErIdManagCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErIdManagCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ErIdManagCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErIdManagCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ErIdManagCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErIdManagCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ErIdManagCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErIdManagCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ErIdManagCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ErIdManagCB&gt;() {
     *     public void query(ErIdManagCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErIdManagCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ErIdManagCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ErIdManagCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ErIdManagCQ sq);

    protected ErIdManagCB xcreateScalarConditionCB() {
        ErIdManagCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ErIdManagCB xcreateScalarConditionPartitionByCB() {
        ErIdManagCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ErIdManagCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErIdManagCB cb = new ErIdManagCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "ID_MANAG_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ErIdManagCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ErIdManagCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ErIdManagCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErIdManagCB cb = new ErIdManagCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "ID_MANAG_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ErIdManagCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ErIdManagCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ErIdManagCB cb = new ErIdManagCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ErIdManagCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ErIdManagCB newMyCB() {
        return new ErIdManagCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ErIdManagCQ.class.getName(); }
