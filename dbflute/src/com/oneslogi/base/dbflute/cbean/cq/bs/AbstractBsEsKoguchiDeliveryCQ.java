...
/**
 * The abstract condition-query of es_koguchi_delivery.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEsKoguchiDeliveryCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEsKoguchiDeliveryCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<EsKoguchiDeliveryCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EsKoguchiDeliveryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsKoguchiDeliveryCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EsKoguchiDeliveryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsKoguchiDeliveryCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EsKoguchiDeliveryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsKoguchiDeliveryCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EsKoguchiDeliveryCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsKoguchiDeliveryCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EsKoguchiDeliveryCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EsKoguchiDeliveryCB&gt;() {
     *     public void query(EsKoguchiDeliveryCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsKoguchiDeliveryCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EsKoguchiDeliveryCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EsKoguchiDeliveryCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EsKoguchiDeliveryCQ sq);

    protected EsKoguchiDeliveryCB xcreateScalarConditionCB() {
        EsKoguchiDeliveryCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EsKoguchiDeliveryCB xcreateScalarConditionPartitionByCB() {
        EsKoguchiDeliveryCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EsKoguchiDeliveryCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EsKoguchiDeliveryCB cb = new EsKoguchiDeliveryCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "KOGUCHI_DELIVERY_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EsKoguchiDeliveryCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EsKoguchiDeliveryCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EsKoguchiDeliveryCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EsKoguchiDeliveryCB cb = new EsKoguchiDeliveryCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "KOGUCHI_DELIVERY_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EsKoguchiDeliveryCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EsKoguchiDeliveryCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EsKoguchiDeliveryCB cb = new EsKoguchiDeliveryCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EsKoguchiDeliveryCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EsKoguchiDeliveryCB newMyCB() {
        return new EsKoguchiDeliveryCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EsKoguchiDeliveryCQ.class.getName(); }
