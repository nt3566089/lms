...
/**
 * The abstract condition-query of t_bldl5125.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTBldl5125CQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTBldl5125CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param bldl5125Id The value of bldl5125Id as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5125Id_Equal(Long bldl5125Id) {
        doSetBldl5125Id_Equal(bldl5125Id);
    }

    protected void doSetBldl5125Id_Equal(Long bldl5125Id) {
        regBldl5125Id(CK_EQ, bldl5125Id);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5125_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5125Id The value of bldl5125Id as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5125Id_NotEqual(Long bldl5125Id) {
        doSetBldl5125Id_NotEqual(bldl5125Id);
    }

    protected void doSetBldl5125Id_NotEqual(Long bldl5125Id) {
        regBldl5125Id(CK_NES, bldl5125Id);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5125_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5125Id The value of bldl5125Id as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5125Id_GreaterThan(Long bldl5125Id) {
        regBldl5125Id(CK_GT, bldl5125Id);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5125_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5125Id The value of bldl5125Id as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5125Id_LessThan(Long bldl5125Id) {
        regBldl5125Id(CK_LT, bldl5125Id);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5125_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5125Id The value of bldl5125Id as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5125Id_GreaterEqual(Long bldl5125Id) {
        regBldl5125Id(CK_GE, bldl5125Id);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5125_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5125Id The value of bldl5125Id as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5125Id_LessEqual(Long bldl5125Id) {
        regBldl5125Id(CK_LE, bldl5125Id);
    }
     ...
     * BLDL5125_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of bldl5125Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of bldl5125Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setBldl5125Id_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueBldl5125Id(), "BLDL5125_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5125_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5125IdList The collection of bldl5125Id as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5125Id_InScope(Collection<Long> bldl5125IdList) {
        doSetBldl5125Id_InScope(bldl5125IdList);
    }

    protected void doSetBldl5125Id_InScope(Collection<Long> bldl5125IdList) {
        regINS(CK_INS, cTL(bldl5125IdList), xgetCValueBldl5125Id(), "BLDL5125_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5125_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5125IdList The collection of bldl5125Id as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5125Id_NotInScope(Collection<Long> bldl5125IdList) {
        doSetBldl5125Id_NotInScope(bldl5125IdList);
    }

    protected void doSetBldl5125Id_NotInScope(Collection<Long> bldl5125IdList) {
        regINS(CK_NINS, cTL(bldl5125IdList), xgetCValueBldl5125Id(), "BLDL5125_ID");
    }
     ...
     * BLDL5125_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5125Id_IsNull() { regBldl5125Id(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * BLDL5125_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5125Id_IsNotNull() { regBldl5125Id(CK_ISNN, DOBJ); }

    protected void regBldl5125Id(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueBldl5125Id(), "BLDL5125_ID"); }
    protected abstract ConditionValue xgetCValueBldl5125Id();
     ...
     * @param koshigayaStore The value of koshigayaStore as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setKoshigayaStore_Equal(Long koshigayaStore) {
        doSetKoshigayaStore_Equal(koshigayaStore);
    }

    protected void doSetKoshigayaStore_Equal(Long koshigayaStore) {
        regKoshigayaStore(CK_EQ, koshigayaStore);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * KOSHIGAYA_STORE: {BIGINT(19)}
     * @param koshigayaStore The value of koshigayaStore as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setKoshigayaStore_NotEqual(Long koshigayaStore) {
        doSetKoshigayaStore_NotEqual(koshigayaStore);
    }

    protected void doSetKoshigayaStore_NotEqual(Long koshigayaStore) {
        regKoshigayaStore(CK_NES, koshigayaStore);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * KOSHIGAYA_STORE: {BIGINT(19)}
     * @param koshigayaStore The value of koshigayaStore as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setKoshigayaStore_GreaterThan(Long koshigayaStore) {
        regKoshigayaStore(CK_GT, koshigayaStore);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * KOSHIGAYA_STORE: {BIGINT(19)}
     * @param koshigayaStore The value of koshigayaStore as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setKoshigayaStore_LessThan(Long koshigayaStore) {
        regKoshigayaStore(CK_LT, koshigayaStore);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * KOSHIGAYA_STORE: {BIGINT(19)}
     * @param koshigayaStore The value of koshigayaStore as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setKoshigayaStore_GreaterEqual(Long koshigayaStore) {
        regKoshigayaStore(CK_GE, koshigayaStore);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * KOSHIGAYA_STORE: {BIGINT(19)}
     * @param koshigayaStore The value of koshigayaStore as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setKoshigayaStore_LessEqual(Long koshigayaStore) {
        regKoshigayaStore(CK_LE, koshigayaStore);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * KOSHIGAYA_STORE: {BIGINT(19)}
     * @param minNumber The min number of koshigayaStore. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of koshigayaStore. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setKoshigayaStore_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueKoshigayaStore(), "KOSHIGAYA_STORE", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * KOSHIGAYA_STORE: {BIGINT(19)}
     * @param koshigayaStoreList The collection of koshigayaStore as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setKoshigayaStore_InScope(Collection<Long> koshigayaStoreList) {
        doSetKoshigayaStore_InScope(koshigayaStoreList);
    }

    protected void doSetKoshigayaStore_InScope(Collection<Long> koshigayaStoreList) {
        regINS(CK_INS, cTL(koshigayaStoreList), xgetCValueKoshigayaStore(), "KOSHIGAYA_STORE");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * KOSHIGAYA_STORE: {BIGINT(19)}
     * @param koshigayaStoreList The collection of koshigayaStore as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setKoshigayaStore_NotInScope(Collection<Long> koshigayaStoreList) {
        doSetKoshigayaStore_NotInScope(koshigayaStoreList);
    }

    protected void doSetKoshigayaStore_NotInScope(Collection<Long> koshigayaStoreList) {
        regINS(CK_NINS, cTL(koshigayaStoreList), xgetCValueKoshigayaStore(), "KOSHIGAYA_STORE");
    }
     ...
     * KOSHIGAYA_STORE: {BIGINT(19)}
     */
    public void setKoshigayaStore_IsNull() { regKoshigayaStore(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * KOSHIGAYA_STORE: {BIGINT(19)}
     */
    public void setKoshigayaStore_IsNotNull() { regKoshigayaStore(CK_ISNN, DOBJ); }

    protected void regKoshigayaStore(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueKoshigayaStore(), "KOSHIGAYA_STORE"); }
    protected abstract ConditionValue xgetCValueKoshigayaStore();

    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. <br>
     * KOSHIGAYA_DIRECT: {BIGINT(19)}
     * @param koshigayaDirect The value of koshigayaDirect as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setKoshigayaDirect_Equal(Long koshigayaDirect) {
        doSetKoshigayaDirect_Equal(koshigayaDirect);
    }

    protected void doSetKoshigayaDirect_Equal(Long koshigayaDirect) {
        regKoshigayaDirect(CK_EQ, koshigayaDirect);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * KOSHIGAYA_DIRECT: {BIGINT(19)}
     * @param koshigayaDirect The value of koshigayaDirect as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setKoshigayaDirect_NotEqual(Long koshigayaDirect) {
        doSetKoshigayaDirect_NotEqual(koshigayaDirect);
    }

    protected void doSetKoshigayaDirect_NotEqual(Long koshigayaDirect) {
        regKoshigayaDirect(CK_NES, koshigayaDirect);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * KOSHIGAYA_DIRECT: {BIGINT(19)}
     * @param koshigayaDirect The value of koshigayaDirect as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setKoshigayaDirect_GreaterThan(Long koshigayaDirect) {
        regKoshigayaDirect(CK_GT, koshigayaDirect);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * KOSHIGAYA_DIRECT: {BIGINT(19)}
     * @param koshigayaDirect The value of koshigayaDirect as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setKoshigayaDirect_LessThan(Long koshigayaDirect) {
        regKoshigayaDirect(CK_LT, koshigayaDirect);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * KOSHIGAYA_DIRECT: {BIGINT(19)}
     * @param koshigayaDirect The value of koshigayaDirect as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setKoshigayaDirect_GreaterEqual(Long koshigayaDirect) {
        regKoshigayaDirect(CK_GE, koshigayaDirect);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * KOSHIGAYA_DIRECT: {BIGINT(19)}
     * @param koshigayaDirect The value of koshigayaDirect as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setKoshigayaDirect_LessEqual(Long koshigayaDirect) {
        regKoshigayaDirect(CK_LE, koshigayaDirect);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * KOSHIGAYA_DIRECT: {BIGINT(19)}
     * @param minNumber The min number of koshigayaDirect. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of koshigayaDirect. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setKoshigayaDirect_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueKoshigayaDirect(), "KOSHIGAYA_DIRECT", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * KOSHIGAYA_DIRECT: {BIGINT(19)}
     * @param koshigayaDirectList The collection of koshigayaDirect as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setKoshigayaDirect_InScope(Collection<Long> koshigayaDirectList) {
        doSetKoshigayaDirect_InScope(koshigayaDirectList);
    }

    protected void doSetKoshigayaDirect_InScope(Collection<Long> koshigayaDirectList) {
        regINS(CK_INS, cTL(koshigayaDirectList), xgetCValueKoshigayaDirect(), "KOSHIGAYA_DIRECT");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * KOSHIGAYA_DIRECT: {BIGINT(19)}
     * @param koshigayaDirectList The collection of koshigayaDirect as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setKoshigayaDirect_NotInScope(Collection<Long> koshigayaDirectList) {
        doSetKoshigayaDirect_NotInScope(koshigayaDirectList);
    }

    protected void doSetKoshigayaDirect_NotInScope(Collection<Long> koshigayaDirectList) {
        regINS(CK_NINS, cTL(koshigayaDirectList), xgetCValueKoshigayaDirect(), "KOSHIGAYA_DIRECT");
    }
     ...
     * KOSHIGAYA_DIRECT: {BIGINT(19)}
     */
    public void setKoshigayaDirect_IsNull() { regKoshigayaDirect(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * KOSHIGAYA_DIRECT: {BIGINT(19)}
     */
    public void setKoshigayaDirect_IsNotNull() { regKoshigayaDirect(CK_ISNN, DOBJ); }

    protected void regKoshigayaDirect(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueKoshigayaDirect(), "KOSHIGAYA_DIRECT"); }
    protected abstract ConditionValue xgetCValueKoshigayaDirect();
     ...
     */
    public HpSLCFunction<TBldl5125CB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TBldl5125CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5125CB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TBldl5125CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5125CB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TBldl5125CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5125CB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TBldl5125CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5125CB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TBldl5125CB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TBldl5125CB&gt;() {
     *     public void query(TBldl5125CB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5125CB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TBldl5125CB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5125CB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TBldl5125CQ sq);

    protected TBldl5125CB xcreateScalarConditionCB() {
        TBldl5125CB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TBldl5125CB xcreateScalarConditionPartitionByCB() {
        TBldl5125CB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TBldl5125CB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5125CB cb = new TBldl5125CB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "BLDL5125_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TBldl5125CQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TBldl5125CB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TBldl5125CB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5125CB cb = new TBldl5125CB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "BLDL5125_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TBldl5125CQ sq);
     ...
     */
    public void myselfExists(SubQuery<TBldl5125CB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TBldl5125CB cb = new TBldl5125CB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TBldl5125CQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TBldl5125CB newMyCB() {
        return new TBldl5125CB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TBldl5125CQ.class.getName(); }
