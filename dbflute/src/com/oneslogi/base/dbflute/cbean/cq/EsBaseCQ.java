...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsEsBaseCQ;

/**
 * The condition-query of es_base.
 * <p>
 ...
 */
public class EsBaseCQ extends BsEsBaseCQ {
     ...
     */
    public EsBaseCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
