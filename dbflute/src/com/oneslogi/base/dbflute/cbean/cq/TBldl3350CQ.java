...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTBldl3350CQ;

/**
 * The condition-query of t_bldl3350.
 * <p>
 ...
 */
public class TBldl3350CQ extends BsTBldl3350CQ {
     ...
     */
    public TBldl3350CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
