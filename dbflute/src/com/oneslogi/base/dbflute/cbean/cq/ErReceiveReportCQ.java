...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsErReceiveReportCQ;

/**
 * The condition-query of er_receive_report.
 * <p>
 ...
 */
public class ErReceiveReportCQ extends BsErReceiveReportCQ {
     ...
     */
    public ErReceiveReportCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
