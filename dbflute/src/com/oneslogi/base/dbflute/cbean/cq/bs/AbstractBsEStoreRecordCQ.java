...
/**
 * The abstract condition-query of e_store_record.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEStoreRecordCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEStoreRecordCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param storeRecordId The value of storeRecordId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setStoreRecordId_Equal(Long storeRecordId) {
        doSetStoreRecordId_Equal(storeRecordId);
    }

    protected void doSetStoreRecordId_Equal(Long storeRecordId) {
        regStoreRecordId(CK_EQ, storeRecordId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * STORE_RECORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param storeRecordId The value of storeRecordId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setStoreRecordId_NotEqual(Long storeRecordId) {
        doSetStoreRecordId_NotEqual(storeRecordId);
    }

    protected void doSetStoreRecordId_NotEqual(Long storeRecordId) {
        regStoreRecordId(CK_NES, storeRecordId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * STORE_RECORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param storeRecordId The value of storeRecordId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setStoreRecordId_GreaterThan(Long storeRecordId) {
        regStoreRecordId(CK_GT, storeRecordId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * STORE_RECORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param storeRecordId The value of storeRecordId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setStoreRecordId_LessThan(Long storeRecordId) {
        regStoreRecordId(CK_LT, storeRecordId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * STORE_RECORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param storeRecordId The value of storeRecordId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setStoreRecordId_GreaterEqual(Long storeRecordId) {
        regStoreRecordId(CK_GE, storeRecordId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * STORE_RECORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param storeRecordId The value of storeRecordId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setStoreRecordId_LessEqual(Long storeRecordId) {
        regStoreRecordId(CK_LE, storeRecordId);
    }
     ...
     * STORE_RECORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of storeRecordId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of storeRecordId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setStoreRecordId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueStoreRecordId(), "STORE_RECORD_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * STORE_RECORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param storeRecordIdList The collection of storeRecordId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setStoreRecordId_InScope(Collection<Long> storeRecordIdList) {
        doSetStoreRecordId_InScope(storeRecordIdList);
    }

    protected void doSetStoreRecordId_InScope(Collection<Long> storeRecordIdList) {
        regINS(CK_INS, cTL(storeRecordIdList), xgetCValueStoreRecordId(), "STORE_RECORD_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * STORE_RECORD_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param storeRecordIdList The collection of storeRecordId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setStoreRecordId_NotInScope(Collection<Long> storeRecordIdList) {
        doSetStoreRecordId_NotInScope(storeRecordIdList);
    }

    protected void doSetStoreRecordId_NotInScope(Collection<Long> storeRecordIdList) {
        regINS(CK_NINS, cTL(storeRecordIdList), xgetCValueStoreRecordId(), "STORE_RECORD_ID");
    }
     ...
     * STORE_RECORD_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setStoreRecordId_IsNull() { regStoreRecordId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * STORE_RECORD_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setStoreRecordId_IsNotNull() { regStoreRecordId(CK_ISNN, DOBJ); }

    protected void regStoreRecordId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueStoreRecordId(), "STORE_RECORD_ID"); }
    protected abstract ConditionValue xgetCValueStoreRecordId();
     ...
     */
    public HpSLCFunction<EStoreRecordCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EStoreRecordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EStoreRecordCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EStoreRecordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EStoreRecordCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EStoreRecordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EStoreRecordCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EStoreRecordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EStoreRecordCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EStoreRecordCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EStoreRecordCB&gt;() {
     *     public void query(EStoreRecordCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EStoreRecordCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EStoreRecordCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EStoreRecordCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EStoreRecordCQ sq);

    protected EStoreRecordCB xcreateScalarConditionCB() {
        EStoreRecordCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EStoreRecordCB xcreateScalarConditionPartitionByCB() {
        EStoreRecordCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EStoreRecordCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EStoreRecordCB cb = new EStoreRecordCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "STORE_RECORD_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EStoreRecordCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EStoreRecordCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EStoreRecordCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EStoreRecordCB cb = new EStoreRecordCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "STORE_RECORD_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EStoreRecordCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EStoreRecordCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EStoreRecordCB cb = new EStoreRecordCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EStoreRecordCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EStoreRecordCB newMyCB() {
        return new EStoreRecordCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EStoreRecordCQ.class.getName(); }
