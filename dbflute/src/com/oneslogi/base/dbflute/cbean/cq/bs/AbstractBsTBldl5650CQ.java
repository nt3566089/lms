...
/**
 * The abstract condition-query of t_bldl5650.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTBldl5650CQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTBldl5650CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param bldl5650Id The value of bldl5650Id as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5650Id_Equal(Long bldl5650Id) {
        doSetBldl5650Id_Equal(bldl5650Id);
    }

    protected void doSetBldl5650Id_Equal(Long bldl5650Id) {
        regBldl5650Id(CK_EQ, bldl5650Id);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5650_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5650Id The value of bldl5650Id as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5650Id_NotEqual(Long bldl5650Id) {
        doSetBldl5650Id_NotEqual(bldl5650Id);
    }

    protected void doSetBldl5650Id_NotEqual(Long bldl5650Id) {
        regBldl5650Id(CK_NES, bldl5650Id);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5650_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5650Id The value of bldl5650Id as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5650Id_GreaterThan(Long bldl5650Id) {
        regBldl5650Id(CK_GT, bldl5650Id);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5650_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5650Id The value of bldl5650Id as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5650Id_LessThan(Long bldl5650Id) {
        regBldl5650Id(CK_LT, bldl5650Id);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5650_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5650Id The value of bldl5650Id as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5650Id_GreaterEqual(Long bldl5650Id) {
        regBldl5650Id(CK_GE, bldl5650Id);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5650_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5650Id The value of bldl5650Id as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5650Id_LessEqual(Long bldl5650Id) {
        regBldl5650Id(CK_LE, bldl5650Id);
    }
     ...
     * BLDL5650_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of bldl5650Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of bldl5650Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setBldl5650Id_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueBldl5650Id(), "BLDL5650_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5650_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5650IdList The collection of bldl5650Id as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5650Id_InScope(Collection<Long> bldl5650IdList) {
        doSetBldl5650Id_InScope(bldl5650IdList);
    }

    protected void doSetBldl5650Id_InScope(Collection<Long> bldl5650IdList) {
        regINS(CK_INS, cTL(bldl5650IdList), xgetCValueBldl5650Id(), "BLDL5650_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5650_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5650IdList The collection of bldl5650Id as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5650Id_NotInScope(Collection<Long> bldl5650IdList) {
        doSetBldl5650Id_NotInScope(bldl5650IdList);
    }

    protected void doSetBldl5650Id_NotInScope(Collection<Long> bldl5650IdList) {
        regINS(CK_NINS, cTL(bldl5650IdList), xgetCValueBldl5650Id(), "BLDL5650_ID");
    }
     ...
     * BLDL5650_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5650Id_IsNull() { regBldl5650Id(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * BLDL5650_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5650Id_IsNotNull() { regBldl5650Id(CK_ISNN, DOBJ); }

    protected void regBldl5650Id(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueBldl5650Id(), "BLDL5650_ID"); }
    protected abstract ConditionValue xgetCValueBldl5650Id();
     ...
     */
    public HpSLCFunction<TBldl5650CB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TBldl5650CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5650CB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TBldl5650CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5650CB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TBldl5650CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5650CB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TBldl5650CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5650CB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TBldl5650CB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TBldl5650CB&gt;() {
     *     public void query(TBldl5650CB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5650CB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TBldl5650CB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5650CB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TBldl5650CQ sq);

    protected TBldl5650CB xcreateScalarConditionCB() {
        TBldl5650CB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TBldl5650CB xcreateScalarConditionPartitionByCB() {
        TBldl5650CB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TBldl5650CB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5650CB cb = new TBldl5650CB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "BLDL5650_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TBldl5650CQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TBldl5650CB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TBldl5650CB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5650CB cb = new TBldl5650CB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "BLDL5650_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TBldl5650CQ sq);
     ...
     */
    public void myselfExists(SubQuery<TBldl5650CB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TBldl5650CB cb = new TBldl5650CB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TBldl5650CQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TBldl5650CB newMyCB() {
        return new TBldl5650CB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TBldl5650CQ.class.getName(); }
