...
/**
 * The abstract condition-query of er_ajis_inventory_report.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsErAjisInventoryReportCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsErAjisInventoryReportCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param ajisInventoryReportId The value of ajisInventoryReportId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setAjisInventoryReportId_Equal(Long ajisInventoryReportId) {
        doSetAjisInventoryReportId_Equal(ajisInventoryReportId);
    }

    protected void doSetAjisInventoryReportId_Equal(Long ajisInventoryReportId) {
        regAjisInventoryReportId(CK_EQ, ajisInventoryReportId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * AJIS_INVENTORY_REPORT_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param ajisInventoryReportId The value of ajisInventoryReportId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setAjisInventoryReportId_NotEqual(Long ajisInventoryReportId) {
        doSetAjisInventoryReportId_NotEqual(ajisInventoryReportId);
    }

    protected void doSetAjisInventoryReportId_NotEqual(Long ajisInventoryReportId) {
        regAjisInventoryReportId(CK_NES, ajisInventoryReportId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * AJIS_INVENTORY_REPORT_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param ajisInventoryReportId The value of ajisInventoryReportId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setAjisInventoryReportId_GreaterThan(Long ajisInventoryReportId) {
        regAjisInventoryReportId(CK_GT, ajisInventoryReportId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * AJIS_INVENTORY_REPORT_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param ajisInventoryReportId The value of ajisInventoryReportId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setAjisInventoryReportId_LessThan(Long ajisInventoryReportId) {
        regAjisInventoryReportId(CK_LT, ajisInventoryReportId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * AJIS_INVENTORY_REPORT_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param ajisInventoryReportId The value of ajisInventoryReportId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setAjisInventoryReportId_GreaterEqual(Long ajisInventoryReportId) {
        regAjisInventoryReportId(CK_GE, ajisInventoryReportId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * AJIS_INVENTORY_REPORT_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param ajisInventoryReportId The value of ajisInventoryReportId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setAjisInventoryReportId_LessEqual(Long ajisInventoryReportId) {
        regAjisInventoryReportId(CK_LE, ajisInventoryReportId);
    }
     ...
     * AJIS_INVENTORY_REPORT_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of ajisInventoryReportId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of ajisInventoryReportId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setAjisInventoryReportId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueAjisInventoryReportId(), "AJIS_INVENTORY_REPORT_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * AJIS_INVENTORY_REPORT_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param ajisInventoryReportIdList The collection of ajisInventoryReportId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setAjisInventoryReportId_InScope(Collection<Long> ajisInventoryReportIdList) {
        doSetAjisInventoryReportId_InScope(ajisInventoryReportIdList);
    }

    protected void doSetAjisInventoryReportId_InScope(Collection<Long> ajisInventoryReportIdList) {
        regINS(CK_INS, cTL(ajisInventoryReportIdList), xgetCValueAjisInventoryReportId(), "AJIS_INVENTORY_REPORT_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * AJIS_INVENTORY_REPORT_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param ajisInventoryReportIdList The collection of ajisInventoryReportId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setAjisInventoryReportId_NotInScope(Collection<Long> ajisInventoryReportIdList) {
        doSetAjisInventoryReportId_NotInScope(ajisInventoryReportIdList);
    }

    protected void doSetAjisInventoryReportId_NotInScope(Collection<Long> ajisInventoryReportIdList) {
        regINS(CK_NINS, cTL(ajisInventoryReportIdList), xgetCValueAjisInventoryReportId(), "AJIS_INVENTORY_REPORT_ID");
    }
     ...
     * AJIS_INVENTORY_REPORT_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setAjisInventoryReportId_IsNull() { regAjisInventoryReportId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * AJIS_INVENTORY_REPORT_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setAjisInventoryReportId_IsNotNull() { regAjisInventoryReportId(CK_ISNN, DOBJ); }

    protected void regAjisInventoryReportId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueAjisInventoryReportId(), "AJIS_INVENTORY_REPORT_ID"); }
    protected abstract ConditionValue xgetCValueAjisInventoryReportId();
     ...
     * @param inventoryNum The value of inventoryNum as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryNum_Equal(String inventoryNum) {
        doSetInventoryNum_Equal(fRES(inventoryNum));
    }

    protected void doSetInventoryNum_Equal(String inventoryNum) {
     ...
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_NUM: {VARCHAR(30)}
     * @param inventoryNum The value of inventoryNum as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryNum_NotEqual(String inventoryNum) {
        doSetInventoryNum_NotEqual(fRES(inventoryNum));
    }

    protected void doSetInventoryNum_NotEqual(String inventoryNum) {
     ...
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_NUM: {VARCHAR(30)}
     * @param inventoryNum The value of inventoryNum as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryNum_GreaterThan(String inventoryNum) {
        regInventoryNum(CK_GT, fRES(inventoryNum));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_NUM: {VARCHAR(30)}
     * @param inventoryNum The value of inventoryNum as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryNum_LessThan(String inventoryNum) {
        regInventoryNum(CK_LT, fRES(inventoryNum));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_NUM: {VARCHAR(30)}
     * @param inventoryNum The value of inventoryNum as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryNum_GreaterEqual(String inventoryNum) {
        regInventoryNum(CK_GE, fRES(inventoryNum));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_NUM: {VARCHAR(30)}
     * @param inventoryNum The value of inventoryNum as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryNum_LessEqual(String inventoryNum) {
        regInventoryNum(CK_LE, fRES(inventoryNum));
    }
     ...
     */
    public void setInventoryNum_InScope(Collection<String> inventoryNumList) {
        doSetInventoryNum_InScope(inventoryNumList);
    }

    protected void doSetInventoryNum_InScope(Collection<String> inventoryNumList) {
     ...
     */
    public void setInventoryNum_NotInScope(Collection<String> inventoryNumList) {
        doSetInventoryNum_NotInScope(inventoryNumList);
    }

    protected void doSetInventoryNum_NotInScope(Collection<String> inventoryNumList) {
        regINS(CK_NINS, cTL(inventoryNumList), xgetCValueInventoryNum(), "INVENTORY_NUM");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * INVENTORY_NUM: {VARCHAR(30)} <br>
     * <pre>e.g. setInventoryNum_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param inventoryNum The value of inventoryNum as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setInventoryNum_LikeSearch(String inventoryNum, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(inventoryNum), xgetCValueInventoryNum(), "INVENTORY_NUM", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * INVENTORY_NUM: {VARCHAR(30)}
     * @param inventoryNum The value of inventoryNum as notLikeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setInventoryNum_NotLikeSearch(String inventoryNum, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(inventoryNum), xgetCValueInventoryNum(), "INVENTORY_NUM", likeSearchOption);
    }

    /**
     * PrefixSearch {like 'xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * INVENTORY_NUM: {VARCHAR(30)}
     * @param inventoryNum The value of inventoryNum as prefixSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryNum_PrefixSearch(String inventoryNum) {
        setInventoryNum_LikeSearch(inventoryNum, xcLSOPPre());
    }
     ...
     * INVENTORY_NUM: {VARCHAR(30)}
     */
    public void setInventoryNum_IsNull() { regInventoryNum(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * INVENTORY_NUM: {VARCHAR(30)}
     */
    public void setInventoryNum_IsNullOrEmpty() { regInventoryNum(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * INVENTORY_NUM: {VARCHAR(30)}
     */
    public void setInventoryNum_IsNotNull() { regInventoryNum(CK_ISNN, DOBJ); }
     ...
     */
    public HpSLCFunction<ErAjisInventoryReportCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ErAjisInventoryReportCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErAjisInventoryReportCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ErAjisInventoryReportCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErAjisInventoryReportCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ErAjisInventoryReportCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErAjisInventoryReportCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ErAjisInventoryReportCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErAjisInventoryReportCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ErAjisInventoryReportCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ErAjisInventoryReportCB&gt;() {
     *     public void query(ErAjisInventoryReportCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErAjisInventoryReportCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ErAjisInventoryReportCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ErAjisInventoryReportCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ErAjisInventoryReportCQ sq);

    protected ErAjisInventoryReportCB xcreateScalarConditionCB() {
        ErAjisInventoryReportCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ErAjisInventoryReportCB xcreateScalarConditionPartitionByCB() {
        ErAjisInventoryReportCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ErAjisInventoryReportCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErAjisInventoryReportCB cb = new ErAjisInventoryReportCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "AJIS_INVENTORY_REPORT_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ErAjisInventoryReportCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ErAjisInventoryReportCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ErAjisInventoryReportCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErAjisInventoryReportCB cb = new ErAjisInventoryReportCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "AJIS_INVENTORY_REPORT_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ErAjisInventoryReportCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ErAjisInventoryReportCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ErAjisInventoryReportCB cb = new ErAjisInventoryReportCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ErAjisInventoryReportCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ErAjisInventoryReportCB newMyCB() {
        return new ErAjisInventoryReportCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ErAjisInventoryReportCQ.class.getName(); }
