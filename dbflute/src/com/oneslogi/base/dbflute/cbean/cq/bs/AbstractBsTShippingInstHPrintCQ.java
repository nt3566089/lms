...
/**
 * The abstract condition-query of t_shipping_inst_h_print.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTShippingInstHPrintCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTShippingInstHPrintCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param shippingInstHPrintId The value of shippingInstHPrintId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setShippingInstHPrintId_Equal(Long shippingInstHPrintId) {
        doSetShippingInstHPrintId_Equal(shippingInstHPrintId);
    }

    protected void doSetShippingInstHPrintId_Equal(Long shippingInstHPrintId) {
        regShippingInstHPrintId(CK_EQ, shippingInstHPrintId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * SHIPPING_INST_H_PRINT_ID: {PK, ID, IX, NotNull, BIGINT(19)}
     * @param shippingInstHPrintId The value of shippingInstHPrintId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setShippingInstHPrintId_NotEqual(Long shippingInstHPrintId) {
        doSetShippingInstHPrintId_NotEqual(shippingInstHPrintId);
    }

    protected void doSetShippingInstHPrintId_NotEqual(Long shippingInstHPrintId) {
        regShippingInstHPrintId(CK_NES, shippingInstHPrintId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * SHIPPING_INST_H_PRINT_ID: {PK, ID, IX, NotNull, BIGINT(19)}
     * @param shippingInstHPrintId The value of shippingInstHPrintId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setShippingInstHPrintId_GreaterThan(Long shippingInstHPrintId) {
        regShippingInstHPrintId(CK_GT, shippingInstHPrintId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * SHIPPING_INST_H_PRINT_ID: {PK, ID, IX, NotNull, BIGINT(19)}
     * @param shippingInstHPrintId The value of shippingInstHPrintId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setShippingInstHPrintId_LessThan(Long shippingInstHPrintId) {
        regShippingInstHPrintId(CK_LT, shippingInstHPrintId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * SHIPPING_INST_H_PRINT_ID: {PK, ID, IX, NotNull, BIGINT(19)}
     * @param shippingInstHPrintId The value of shippingInstHPrintId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setShippingInstHPrintId_GreaterEqual(Long shippingInstHPrintId) {
        regShippingInstHPrintId(CK_GE, shippingInstHPrintId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * SHIPPING_INST_H_PRINT_ID: {PK, ID, IX, NotNull, BIGINT(19)}
     * @param shippingInstHPrintId The value of shippingInstHPrintId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setShippingInstHPrintId_LessEqual(Long shippingInstHPrintId) {
        regShippingInstHPrintId(CK_LE, shippingInstHPrintId);
    }
     ...
     * SHIPPING_INST_H_PRINT_ID: {PK, ID, IX, NotNull, BIGINT(19)}
     * @param minNumber The min number of shippingInstHPrintId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of shippingInstHPrintId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setShippingInstHPrintId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueShippingInstHPrintId(), "SHIPPING_INST_H_PRINT_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * SHIPPING_INST_H_PRINT_ID: {PK, ID, IX, NotNull, BIGINT(19)}
     * @param shippingInstHPrintIdList The collection of shippingInstHPrintId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setShippingInstHPrintId_InScope(Collection<Long> shippingInstHPrintIdList) {
        doSetShippingInstHPrintId_InScope(shippingInstHPrintIdList);
    }

    protected void doSetShippingInstHPrintId_InScope(Collection<Long> shippingInstHPrintIdList) {
        regINS(CK_INS, cTL(shippingInstHPrintIdList), xgetCValueShippingInstHPrintId(), "SHIPPING_INST_H_PRINT_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * SHIPPING_INST_H_PRINT_ID: {PK, ID, IX, NotNull, BIGINT(19)}
     * @param shippingInstHPrintIdList The collection of shippingInstHPrintId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setShippingInstHPrintId_NotInScope(Collection<Long> shippingInstHPrintIdList) {
        doSetShippingInstHPrintId_NotInScope(shippingInstHPrintIdList);
    }

    protected void doSetShippingInstHPrintId_NotInScope(Collection<Long> shippingInstHPrintIdList) {
        regINS(CK_NINS, cTL(shippingInstHPrintIdList), xgetCValueShippingInstHPrintId(), "SHIPPING_INST_H_PRINT_ID");
    }
     ...
     * SHIPPING_INST_H_PRINT_ID: {PK, ID, IX, NotNull, BIGINT(19)}
     */
    public void setShippingInstHPrintId_IsNull() { regShippingInstHPrintId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * SHIPPING_INST_H_PRINT_ID: {PK, ID, IX, NotNull, BIGINT(19)}
     */
    public void setShippingInstHPrintId_IsNotNull() { regShippingInstHPrintId(CK_ISNN, DOBJ); }

    protected void regShippingInstHPrintId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueShippingInstHPrintId(), "SHIPPING_INST_H_PRINT_ID"); }
    protected abstract ConditionValue xgetCValueShippingInstHPrintId();
     ...
     * @param shippingReason The value of shippingReason as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setShippingReason_Equal(String shippingReason) {
        doSetShippingReason_Equal(fRES(shippingReason));
    }

    protected void doSetShippingReason_Equal(String shippingReason) {
        regShippingReason(CK_EQ, shippingReason);
    }

    /**
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * SHIPPING_REASON: {VARCHAR(60)}
     * @param shippingReason The value of shippingReason as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setShippingReason_NotEqual(String shippingReason) {
        doSetShippingReason_NotEqual(fRES(shippingReason));
    }

    protected void doSetShippingReason_NotEqual(String shippingReason) {
        regShippingReason(CK_NES, shippingReason);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * SHIPPING_REASON: {VARCHAR(60)}
     * @param shippingReason The value of shippingReason as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setShippingReason_GreaterThan(String shippingReason) {
        regShippingReason(CK_GT, fRES(shippingReason));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * SHIPPING_REASON: {VARCHAR(60)}
     * @param shippingReason The value of shippingReason as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setShippingReason_LessThan(String shippingReason) {
        regShippingReason(CK_LT, fRES(shippingReason));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * SHIPPING_REASON: {VARCHAR(60)}
     * @param shippingReason The value of shippingReason as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setShippingReason_GreaterEqual(String shippingReason) {
        regShippingReason(CK_GE, fRES(shippingReason));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * SHIPPING_REASON: {VARCHAR(60)}
     * @param shippingReason The value of shippingReason as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setShippingReason_LessEqual(String shippingReason) {
        regShippingReason(CK_LE, fRES(shippingReason));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * SHIPPING_REASON: {VARCHAR(60)}
     * @param shippingReasonList The collection of shippingReason as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setShippingReason_InScope(Collection<String> shippingReasonList) {
        doSetShippingReason_InScope(shippingReasonList);
    }

    protected void doSetShippingReason_InScope(Collection<String> shippingReasonList) {
        regINS(CK_INS, cTL(shippingReasonList), xgetCValueShippingReason(), "SHIPPING_REASON");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * SHIPPING_REASON: {VARCHAR(60)}
     * @param shippingReasonList The collection of shippingReason as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setShippingReason_NotInScope(Collection<String> shippingReasonList) {
        doSetShippingReason_NotInScope(shippingReasonList);
    }

    protected void doSetShippingReason_NotInScope(Collection<String> shippingReasonList) {
        regINS(CK_NINS, cTL(shippingReasonList), xgetCValueShippingReason(), "SHIPPING_REASON");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * SHIPPING_REASON: {VARCHAR(60)} <br>
     * <pre>e.g. setShippingReason_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param shippingReason The value of shippingReason as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setShippingReason_LikeSearch(String shippingReason, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(shippingReason), xgetCValueShippingReason(), "SHIPPING_REASON", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * SHIPPING_REASON: {VARCHAR(60)}
     * @param shippingReason The value of shippingReason as notLikeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setShippingReason_NotLikeSearch(String shippingReason, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(shippingReason), xgetCValueShippingReason(), "SHIPPING_REASON", likeSearchOption);
    }

    /**
     * PrefixSearch {like 'xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * SHIPPING_REASON: {VARCHAR(60)}
     * @param shippingReason The value of shippingReason as prefixSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setShippingReason_PrefixSearch(String shippingReason) {
        setShippingReason_LikeSearch(shippingReason, xcLSOPPre());
    }
     ...
     * SHIPPING_REASON: {VARCHAR(60)}
     */
    public void setShippingReason_IsNull() { regShippingReason(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * SHIPPING_REASON: {VARCHAR(60)}
     */
    public void setShippingReason_IsNullOrEmpty() { regShippingReason(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * SHIPPING_REASON: {VARCHAR(60)}
     */
    public void setShippingReason_IsNotNull() { regShippingReason(CK_ISNN, DOBJ); }

    protected void regShippingReason(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueShippingReason(), "SHIPPING_REASON"); }
    protected abstract ConditionValue xgetCValueShippingReason();
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * SPECIFY_DELIVERY_TIME: {VARCHAR(6)} <br>
     ...
     * @param tenhanshaId The value of tenhanshaId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setTenhanshaId_Equal(Long tenhanshaId) {
        doSetTenhanshaId_Equal(tenhanshaId);
    }

    protected void doSetTenhanshaId_Equal(Long tenhanshaId) {
        regTenhanshaId(CK_EQ, tenhanshaId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * TENHANSHA_ID: {BIGINT(19)}
     * @param tenhanshaId The value of tenhanshaId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setTenhanshaId_NotEqual(Long tenhanshaId) {
        doSetTenhanshaId_NotEqual(tenhanshaId);
    }

    protected void doSetTenhanshaId_NotEqual(Long tenhanshaId) {
        regTenhanshaId(CK_NES, tenhanshaId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * TENHANSHA_ID: {BIGINT(19)}
     * @param tenhanshaId The value of tenhanshaId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setTenhanshaId_GreaterThan(Long tenhanshaId) {
        regTenhanshaId(CK_GT, tenhanshaId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * TENHANSHA_ID: {BIGINT(19)}
     * @param tenhanshaId The value of tenhanshaId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setTenhanshaId_LessThan(Long tenhanshaId) {
        regTenhanshaId(CK_LT, tenhanshaId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * TENHANSHA_ID: {BIGINT(19)}
     * @param tenhanshaId The value of tenhanshaId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setTenhanshaId_GreaterEqual(Long tenhanshaId) {
        regTenhanshaId(CK_GE, tenhanshaId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * TENHANSHA_ID: {BIGINT(19)}
     * @param tenhanshaId The value of tenhanshaId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setTenhanshaId_LessEqual(Long tenhanshaId) {
        regTenhanshaId(CK_LE, tenhanshaId);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * TENHANSHA_ID: {BIGINT(19)}
     * @param minNumber The min number of tenhanshaId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of tenhanshaId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setTenhanshaId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueTenhanshaId(), "TENHANSHA_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * TENHANSHA_ID: {BIGINT(19)}
     * @param tenhanshaIdList The collection of tenhanshaId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setTenhanshaId_InScope(Collection<Long> tenhanshaIdList) {
        doSetTenhanshaId_InScope(tenhanshaIdList);
    }

    protected void doSetTenhanshaId_InScope(Collection<Long> tenhanshaIdList) {
        regINS(CK_INS, cTL(tenhanshaIdList), xgetCValueTenhanshaId(), "TENHANSHA_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * TENHANSHA_ID: {BIGINT(19)}
     * @param tenhanshaIdList The collection of tenhanshaId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setTenhanshaId_NotInScope(Collection<Long> tenhanshaIdList) {
        doSetTenhanshaId_NotInScope(tenhanshaIdList);
    }

    protected void doSetTenhanshaId_NotInScope(Collection<Long> tenhanshaIdList) {
        regINS(CK_NINS, cTL(tenhanshaIdList), xgetCValueTenhanshaId(), "TENHANSHA_ID");
    }
     ...
     * TENHANSHA_ID: {BIGINT(19)}
     */
    public void setTenhanshaId_IsNull() { regTenhanshaId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * TENHANSHA_ID: {BIGINT(19)}
     */
    public void setTenhanshaId_IsNotNull() { regTenhanshaId(CK_ISNN, DOBJ); }

    protected void regTenhanshaId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueTenhanshaId(), "TENHANSHA_ID"); }
    protected abstract ConditionValue xgetCValueTenhanshaId();
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * DESTINATION_ZIP_CD: {VARCHAR(60)} <br>
     ...
     */
    public HpSLCFunction<TShippingInstHPrintCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TShippingInstHPrintCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TShippingInstHPrintCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TShippingInstHPrintCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TShippingInstHPrintCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TShippingInstHPrintCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TShippingInstHPrintCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TShippingInstHPrintCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TShippingInstHPrintCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TShippingInstHPrintCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TShippingInstHPrintCB&gt;() {
     *     public void query(TShippingInstHPrintCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TShippingInstHPrintCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TShippingInstHPrintCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TShippingInstHPrintCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TShippingInstHPrintCQ sq);

    protected TShippingInstHPrintCB xcreateScalarConditionCB() {
        TShippingInstHPrintCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TShippingInstHPrintCB xcreateScalarConditionPartitionByCB() {
        TShippingInstHPrintCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TShippingInstHPrintCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TShippingInstHPrintCB cb = new TShippingInstHPrintCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "SHIPPING_INST_H_PRINT_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TShippingInstHPrintCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TShippingInstHPrintCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TShippingInstHPrintCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TShippingInstHPrintCB cb = new TShippingInstHPrintCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "SHIPPING_INST_H_PRINT_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TShippingInstHPrintCQ sq);
     ...
     */
    public void myselfExists(SubQuery<TShippingInstHPrintCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TShippingInstHPrintCB cb = new TShippingInstHPrintCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TShippingInstHPrintCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TShippingInstHPrintCB newMyCB() {
        return new TShippingInstHPrintCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TShippingInstHPrintCQ.class.getName(); }
