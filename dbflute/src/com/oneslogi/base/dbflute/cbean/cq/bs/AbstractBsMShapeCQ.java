...
public abstract class AbstractBsMShapeCQ extends AbstractConditionQuery {
     ...
     * SHAPE_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    /**
     * Set up ExistsReferrer (correlated sub-query). <br>
     * {exists (select REPLENISH_P_PRODUCT_SHAPE_ID from m_location_replenish_product where ...)} <br>
     * m_location_replenish_product by REPLENISH_P_PRODUCT_SHAPE_ID, named 'MLocationReplenishProductAsOne'.
     * <pre>
    ...
    public void existsMLocationReplenishProductList(SubQuery<MLocationReplenishProductCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepShapeId_ExistsReferrer_MLocationReplenishProductList(cb.query());
        registerExistsReferrer(cb.query(), "SHAPE_ID", "REPLENISH_P_PRODUCT_SHAPE_ID", pp, "mLocationReplenishProductList");
    }
    public abstract String keepShapeId_ExistsReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq);
    ...
    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select REPLENISH_P_PRODUCT_SHAPE_ID from m_location_replenish_product where ...)} <br>
     * m_location_replenish_product by REPLENISH_P_PRODUCT_SHAPE_ID, named 'MLocationReplenishProductAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of ShapeId_NotExistsReferrer_MLocationReplenishProductList for 'not exists'. (NotNull)
     */
    public void notExistsMLocationReplenishProductList(SubQuery<MLocationReplenishProductCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MLocationReplenishProductCB cb = new MLocationReplenishProductCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepShapeId_NotExistsReferrer_MLocationReplenishProductList(cb.query());
        registerNotExistsReferrer(cb.query(), "SHAPE_ID", "REPLENISH_P_PRODUCT_SHAPE_ID", pp, "mLocationReplenishProductList");
    }
    public abstract String keepShapeId_NotExistsReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq);
    ...
    public void xsderiveMLocationReplenishProductList(String fn, SubQuery<MLocationReplenishProductCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepShapeId_SpecifyDerivedReferrer_MLocationReplenishProductList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "SHAPE_ID", "REPLENISH_P_PRODUCT_SHAPE_ID", pp, "mLocationReplenishProductList", al, op);
    }
    public abstract String keepShapeId_SpecifyDerivedReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq);
    ...
    public void xqderiveMLocationReplenishProductList(String fn, SubQuery<MLocationReplenishProductCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MLocationReplenishProductCB cb = new MLocationReplenishProductCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepShapeId_QueryDerivedReferrer_MLocationReplenishProductList(cb.query()); String prpp = keepShapeId_QueryDerivedReferrer_MLocationReplenishProductListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "SHAPE_ID", "REPLENISH_P_PRODUCT_SHAPE_ID", sqpp, "mLocationReplenishProductList", rd, vl, prpp, op);
    }
    public abstract String keepShapeId_QueryDerivedReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq);
    public abstract String keepShapeId_QueryDerivedReferrer_MLocationReplenishProductListParameter(Object vl);
