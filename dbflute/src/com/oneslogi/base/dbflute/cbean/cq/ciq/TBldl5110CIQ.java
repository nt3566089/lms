...
/**
 * The condition-query for in-line of t_bldl5110.
 * @author DBFlute(AutoGenerator)
 */
public class TBldl5110CIQ extends AbstractBsTBldl5110CQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTBldl5110CQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TBldl5110CIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTBldl5110CQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueBldl5110Id() { return _myCQ.xdfgetBldl5110Id(); }
    ...
    public String keepScalarCondition(TBldl5110CQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TBldl5110CQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TBldl5110CQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TBldl5110CQ sq)
    ...
    protected String xinCB() { return TBldl5110CB.class.getName(); }
    protected String xinCQ() { return TBldl5110CQ.class.getName(); }
}
