...
public class BsTShippingInstHCQ extends AbstractBsTShippingInstHCQ {
    ...
    public Map<String, MSalesOrgCQ> getSalesOrgCd_InScopeRelation_MSalesOrgBySalesOrg() { return xgetSQueMap("salesOrgCd_InScopeRelation_MSalesOrgBySalesOrg"); }
    public String keepSalesOrgCd_InScopeRelation_MSalesOrgBySalesOrg(MSalesOrgCQ sq) { return xkeepSQue("salesOrgCd_InScopeRelation_MSalesOrgBySalesOrg", sq); }

    public Map<String, MSalesOrgCQ> getSalesOrgCd_NotInScopeRelation_MSalesOrgBySalesOrg() { return xgetSQueMap("salesOrgCd_NotInScopeRelation_MSalesOrgBySalesOrg"); }
    public String keepSalesOrgCd_NotInScopeRelation_MSalesOrgBySalesOrg(MSalesOrgCQ sq) { return xkeepSQue("salesOrgCd_NotInScopeRelation_MSalesOrgBySalesOrg", sq); }
    ...
    public Map<String, MCustomerCQ> getAccountId_InScopeRelation_MCustomerByAccoutId() { return xgetSQueMap("accountId_InScopeRelation_MCustomerByAccoutId"); }
    public String keepAccountId_InScopeRelation_MCustomerByAccoutId(MCustomerCQ sq) { return xkeepSQue("accountId_InScopeRelation_MCustomerByAccoutId", sq); }

    public Map<String, MCustomerCQ> getAccountId_NotInScopeRelation_MCustomerByAccoutId() { return xgetSQueMap("accountId_NotInScopeRelation_MCustomerByAccoutId"); }
    public String keepAccountId_NotInScopeRelation_MCustomerByAccoutId(MCustomerCQ sq) { return xkeepSQue("accountId_NotInScopeRelation_MCustomerByAccoutId", sq); }
    ...
    public void reflectRelationOnUnionQuery(ConditionQuery bqs, ConditionQuery uqs) {
        ...
        if (bq.hasConditionQueryMSalesOrgBySalesOrg()) {
            uq.queryMSalesOrgBySalesOrg().reflectRelationOnUnionQuery(bq.queryMSalesOrgBySalesOrg(), uq.queryMSalesOrgBySalesOrg());
        }
        if (bq.hasConditionQueryMCustomerByAccoutId()) {
            uq.queryMCustomerByAccoutId().reflectRelationOnUnionQuery(bq.queryMCustomerByAccoutId(), uq.queryMCustomerByAccoutId());
        }
     ...
     * @return The instance of condition-query. (NotNull)
     */
    public MSalesOrgCQ queryMSalesOrgBySalesOrg() {
        return xdfgetConditionQueryMSalesOrgBySalesOrg();
    }
    public MSalesOrgCQ xdfgetConditionQueryMSalesOrgBySalesOrg() {
        String prop = "mSalesOrgBySalesOrg";
        if (!xhasQueRlMap(prop)) { xregQueRl(prop, xcreateQueryMSalesOrgBySalesOrg()); xsetupOuterJoinMSalesOrgBySalesOrg(); }
        return xgetQueRlMap(prop);
    }
    protected MSalesOrgCQ xcreateQueryMSalesOrgBySalesOrg() {
        String nrp = xresolveNRP("t_shipping_inst_h", "mSalesOrgBySalesOrg"); String jan = xresolveJAN(nrp, xgetNNLvl());
        return xinitRelCQ(new MSalesOrgCQ(this, xgetSqlClause(), jan, xgetNNLvl()), _baseCB, "mSalesOrgBySalesOrg", nrp);
    }
    protected void xsetupOuterJoinMSalesOrgBySalesOrg() { xregOutJo("mSalesOrgBySalesOrg"); }
    public boolean hasConditionQueryMSalesOrgBySalesOrg() { return xhasQueRlMap("mSalesOrgBySalesOrg"); }
     ...
     * @return The instance of condition-query. (NotNull)
     */
    public MCustomerCQ queryMCustomerByAccoutId() {
        return xdfgetConditionQueryMCustomerByAccoutId();
    }
    public MCustomerCQ xdfgetConditionQueryMCustomerByAccoutId() {
        String prop = "mCustomerByAccoutId";
        if (!xhasQueRlMap(prop)) { xregQueRl(prop, xcreateQueryMCustomerByAccoutId()); xsetupOuterJoinMCustomerByAccoutId(); }
        return xgetQueRlMap(prop);
    }
    protected MCustomerCQ xcreateQueryMCustomerByAccoutId() {
        String nrp = xresolveNRP("t_shipping_inst_h", "mCustomerByAccoutId"); String jan = xresolveJAN(nrp, xgetNNLvl());
        return xinitRelCQ(new MCustomerCQ(this, xgetSqlClause(), jan, xgetNNLvl()), _baseCB, "mCustomerByAccoutId", nrp);
    }
    protected void xsetupOuterJoinMCustomerByAccoutId() { xregOutJo("mCustomerByAccoutId"); }
    public boolean hasConditionQueryMCustomerByAccoutId() { return xhasQueRlMap("mCustomerByAccoutId"); }
