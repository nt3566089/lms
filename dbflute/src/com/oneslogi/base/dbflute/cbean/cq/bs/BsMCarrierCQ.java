...
public class BsMCarrierCQ extends AbstractBsMCarrierCQ {
    ...
    protected ConditionValue _properFlg;
    public ConditionValue xdfgetProperFlg()
    { if (_properFlg == null) { _properFlg = nCV(); }
      return _properFlg; }
    protected ConditionValue xgetCValueProperFlg() { return xdfgetProperFlg(); }
     ...
     * @return this. (NotNull)
     */
    public BsMCarrierCQ addOrderBy_ProperFlg_Asc() { regOBA("PROPER_FLG"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCarrierCQ addOrderBy_ProperFlg_Desc() { regOBD("PROPER_FLG"); return this; }

    protected ConditionValue _laneCd;
    public ConditionValue xdfgetLaneCd()
    { if (_laneCd == null) { _laneCd = nCV(); }
      return _laneCd; }
    protected ConditionValue xgetCValueLaneCd() { return xdfgetLaneCd(); }
     ...
     * @return this. (NotNull)
     */
    public BsMCarrierCQ addOrderBy_LaneCd_Asc() { regOBA("LANE_CD"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCarrierCQ addOrderBy_LaneCd_Desc() { regOBD("LANE_CD"); return this; }
