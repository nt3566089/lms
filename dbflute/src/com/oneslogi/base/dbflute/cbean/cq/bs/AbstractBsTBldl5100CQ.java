...
/**
 * The abstract condition-query of t_bldl5100.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTBldl5100CQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTBldl5100CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param bldl5100Id The value of bldl5100Id as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5100Id_Equal(Long bldl5100Id) {
        doSetBldl5100Id_Equal(bldl5100Id);
    }

    protected void doSetBldl5100Id_Equal(Long bldl5100Id) {
        regBldl5100Id(CK_EQ, bldl5100Id);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5100_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5100Id The value of bldl5100Id as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5100Id_NotEqual(Long bldl5100Id) {
        doSetBldl5100Id_NotEqual(bldl5100Id);
    }

    protected void doSetBldl5100Id_NotEqual(Long bldl5100Id) {
        regBldl5100Id(CK_NES, bldl5100Id);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5100_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5100Id The value of bldl5100Id as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5100Id_GreaterThan(Long bldl5100Id) {
        regBldl5100Id(CK_GT, bldl5100Id);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5100_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5100Id The value of bldl5100Id as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5100Id_LessThan(Long bldl5100Id) {
        regBldl5100Id(CK_LT, bldl5100Id);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5100_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5100Id The value of bldl5100Id as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5100Id_GreaterEqual(Long bldl5100Id) {
        regBldl5100Id(CK_GE, bldl5100Id);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5100_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5100Id The value of bldl5100Id as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5100Id_LessEqual(Long bldl5100Id) {
        regBldl5100Id(CK_LE, bldl5100Id);
    }
     ...
     * BLDL5100_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of bldl5100Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of bldl5100Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setBldl5100Id_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueBldl5100Id(), "BLDL5100_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5100_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5100IdList The collection of bldl5100Id as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5100Id_InScope(Collection<Long> bldl5100IdList) {
        doSetBldl5100Id_InScope(bldl5100IdList);
    }

    protected void doSetBldl5100Id_InScope(Collection<Long> bldl5100IdList) {
        regINS(CK_INS, cTL(bldl5100IdList), xgetCValueBldl5100Id(), "BLDL5100_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5100_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5100IdList The collection of bldl5100Id as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5100Id_NotInScope(Collection<Long> bldl5100IdList) {
        doSetBldl5100Id_NotInScope(bldl5100IdList);
    }

    protected void doSetBldl5100Id_NotInScope(Collection<Long> bldl5100IdList) {
        regINS(CK_NINS, cTL(bldl5100IdList), xgetCValueBldl5100Id(), "BLDL5100_ID");
    }
     ...
     * BLDL5100_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5100Id_IsNull() { regBldl5100Id(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * BLDL5100_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5100Id_IsNotNull() { regBldl5100Id(CK_ISNN, DOBJ); }

    protected void regBldl5100Id(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueBldl5100Id(), "BLDL5100_ID"); }
    protected abstract ConditionValue xgetCValueBldl5100Id();
     ...
     */
    public HpSLCFunction<TBldl5100CB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TBldl5100CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5100CB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TBldl5100CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5100CB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TBldl5100CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5100CB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TBldl5100CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5100CB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TBldl5100CB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TBldl5100CB&gt;() {
     *     public void query(TBldl5100CB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5100CB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TBldl5100CB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5100CB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TBldl5100CQ sq);

    protected TBldl5100CB xcreateScalarConditionCB() {
        TBldl5100CB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TBldl5100CB xcreateScalarConditionPartitionByCB() {
        TBldl5100CB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TBldl5100CB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5100CB cb = new TBldl5100CB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "BLDL5100_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TBldl5100CQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TBldl5100CB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TBldl5100CB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5100CB cb = new TBldl5100CB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "BLDL5100_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TBldl5100CQ sq);
     ...
     */
    public void myselfExists(SubQuery<TBldl5100CB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TBldl5100CB cb = new TBldl5100CB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TBldl5100CQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TBldl5100CB newMyCB() {
        return new TBldl5100CB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TBldl5100CQ.class.getName(); }
