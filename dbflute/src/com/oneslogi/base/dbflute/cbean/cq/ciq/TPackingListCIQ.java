...
/**
 * The condition-query for in-line of t_packing_list.
 * @author DBFlute(AutoGenerator)
 */
public class TPackingListCIQ extends AbstractBsTPackingListCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTPackingListCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TPackingListCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTPackingListCQ myCQ) {
    ...
    public String keepScalarCondition(TPackingListCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TPackingListCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TPackingListCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TPackingListCQ sq)
    ...
    protected String xinCB() { return TPackingListCB.class.getName(); }
    protected String xinCQ() { return TPackingListCQ.class.getName(); }
}
