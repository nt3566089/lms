...
/**
 * The abstract condition-query of er_sales_org.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsErSalesOrgCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsErSalesOrgCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<ErSalesOrgCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ErSalesOrgCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErSalesOrgCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ErSalesOrgCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErSalesOrgCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ErSalesOrgCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErSalesOrgCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ErSalesOrgCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErSalesOrgCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ErSalesOrgCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ErSalesOrgCB&gt;() {
     *     public void query(ErSalesOrgCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErSalesOrgCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ErSalesOrgCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ErSalesOrgCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ErSalesOrgCQ sq);

    protected ErSalesOrgCB xcreateScalarConditionCB() {
        ErSalesOrgCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ErSalesOrgCB xcreateScalarConditionPartitionByCB() {
        ErSalesOrgCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ErSalesOrgCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErSalesOrgCB cb = new ErSalesOrgCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "SALES_ORG_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ErSalesOrgCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ErSalesOrgCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ErSalesOrgCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErSalesOrgCB cb = new ErSalesOrgCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "SALES_ORG_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ErSalesOrgCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ErSalesOrgCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ErSalesOrgCB cb = new ErSalesOrgCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ErSalesOrgCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ErSalesOrgCB newMyCB() {
        return new ErSalesOrgCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ErSalesOrgCQ.class.getName(); }
