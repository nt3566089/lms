...
public abstract class AbstractBsTShippingInstHCQ extends AbstractConditionQuery {
     ...
     * $60: 承認待ち
     */
    public void setShippingStatus_Equal_$60() {
        setShippingStatus_Equal_AsShippingStatus(CDef.ShippingStatus.$60);
    }
     ...
     * $60: 承認待ち
     */
    public void setShippingStatus_NotEqual_$60() {
        setShippingStatus_NotEqual_AsShippingStatus(CDef.ShippingStatus.$60);
    }
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * SALES_ORG_CD: {VARCHAR(30), FK to M_SALES_ORG} <br>
    ...
    /**
     * Set up InScopeRelation (sub-query). <br />
     * {in (select SALES_ORG_CD from m_sales_org where ...)} <br />
     * m_sales_org by my SALES_ORG_CD, named 'MSalesOrgBySalesOrg'.
     * @param subCBLambda The callback for sub-query of MSalesOrgBySalesOrg for 'in-scope'. (NotNull)
     */
    public void inScopeMSalesOrgBySalesOrg(SubQuery<MSalesOrgCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MSalesOrgCB cb = new MSalesOrgCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subCBLambda.query(cb); } finally { unlock(); }
        String pp = keepSalesOrgCd_InScopeRelation_MSalesOrgBySalesOrg(cb.query());
        registerInScopeRelation(cb.query(), "SALES_ORG_CD", "SALES_ORG_CD", pp, "mSalesOrgBySalesOrg", false);
    }
    public abstract String keepSalesOrgCd_InScopeRelation_MSalesOrgBySalesOrg(MSalesOrgCQ sq);

    /**
     * Set up NotInScopeRelation (sub-query). <br />
     * {not in (select SALES_ORG_CD from m_sales_org where ...)} <br />
     * m_sales_org by my SALES_ORG_CD, named 'MSalesOrgBySalesOrg'.
     * @param subCBLambda The callback for sub-query of MSalesOrgBySalesOrg for 'not in-scope'. (NotNull)
     */
    public void notInScopeMSalesOrgBySalesOrg(SubQuery<MSalesOrgCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MSalesOrgCB cb = new MSalesOrgCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subCBLambda.query(cb); } finally { unlock(); }
        String pp = keepSalesOrgCd_NotInScopeRelation_MSalesOrgBySalesOrg(cb.query());
        registerInScopeRelation(cb.query(), "SALES_ORG_CD", "SALES_ORG_CD", pp, "mSalesOrgBySalesOrg", true);
    }
    public abstract String keepSalesOrgCd_NotInScopeRelation_MSalesOrgBySalesOrg(MSalesOrgCQ sq);
     ...
     * @param subCBLambda The callback for sub-query of MCustomerByAccoutId for 'in-scope'. (NotNull)
     */
    public void inScopeMCustomerByAccoutId(SubQuery<MCustomerCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MCustomerCB cb = new MCustomerCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subCBLambda.query(cb); } finally { unlock(); }
        String pp = keepAccountId_InScopeRelation_MCustomerByAccoutId(cb.query());
        registerInScopeRelation(cb.query(), "ACCOUNT_ID", "CUSTOMER_ID", pp, "mCustomerByAccoutId", false);
    }
    public abstract String keepAccountId_InScopeRelation_MCustomerByAccoutId(MCustomerCQ sq);

    /**
     * Set up NotInScopeRelation (sub-query). <br />
     * {not in (select ACCOUNT_ID from m_customer where ...)} <br />
     * m_customer by my ACCOUNT_ID, named 'MCustomerByAccoutId'.
     * @param subCBLambda The callback for sub-query of MCustomerByAccoutId for 'not in-scope'. (NotNull)
     */
    public void notInScopeMCustomerByAccoutId(SubQuery<MCustomerCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MCustomerCB cb = new MCustomerCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subCBLambda.query(cb); } finally { unlock(); }
        String pp = keepAccountId_NotInScopeRelation_MCustomerByAccoutId(cb.query());
        registerInScopeRelation(cb.query(), "ACCOUNT_ID", "CUSTOMER_ID", pp, "mCustomerByAccoutId", true);
    }
    public abstract String keepAccountId_NotInScopeRelation_MCustomerByAccoutId(MCustomerCQ sq);
