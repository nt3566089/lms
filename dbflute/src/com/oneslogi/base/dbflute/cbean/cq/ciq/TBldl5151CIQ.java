...
/**
 * The condition-query for in-line of t_bldl5151.
 * @author DBFlute(AutoGenerator)
 */
public class TBldl5151CIQ extends AbstractBsTBldl5151CQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTBldl5151CQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TBldl5151CIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTBldl5151CQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueBldl5151Id() { return _myCQ.xdfgetBldl5151Id(); }
    ...
    public String keepScalarCondition(TBldl5151CQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TBldl5151CQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TBldl5151CQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TBldl5151CQ sq)
    ...
    protected String xinCB() { return TBldl5151CB.class.getName(); }
    protected String xinCQ() { return TBldl5151CQ.class.getName(); }
}
