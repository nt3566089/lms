...
/**
 * The abstract condition-query of er_scm_label.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsErScmLabelCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsErScmLabelCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<ErScmLabelCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ErScmLabelCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErScmLabelCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ErScmLabelCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErScmLabelCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ErScmLabelCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErScmLabelCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ErScmLabelCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErScmLabelCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ErScmLabelCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ErScmLabelCB&gt;() {
     *     public void query(ErScmLabelCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErScmLabelCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ErScmLabelCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ErScmLabelCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ErScmLabelCQ sq);

    protected ErScmLabelCB xcreateScalarConditionCB() {
        ErScmLabelCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ErScmLabelCB xcreateScalarConditionPartitionByCB() {
        ErScmLabelCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ErScmLabelCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErScmLabelCB cb = new ErScmLabelCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "SCM_LABEL_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ErScmLabelCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ErScmLabelCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ErScmLabelCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErScmLabelCB cb = new ErScmLabelCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "SCM_LABEL_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ErScmLabelCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ErScmLabelCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ErScmLabelCB cb = new ErScmLabelCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ErScmLabelCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ErScmLabelCB newMyCB() {
        return new ErScmLabelCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ErScmLabelCQ.class.getName(); }
