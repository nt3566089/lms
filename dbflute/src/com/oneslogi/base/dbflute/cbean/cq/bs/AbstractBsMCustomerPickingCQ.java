...
/**
 * The abstract condition-query of m_customer_picking.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsMCustomerPickingCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsMCustomerPickingCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param customerPickingId The value of customerPickingId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setCustomerPickingId_Equal(Long customerPickingId) {
        doSetCustomerPickingId_Equal(customerPickingId);
    }

    protected void doSetCustomerPickingId_Equal(Long customerPickingId) {
        regCustomerPickingId(CK_EQ, customerPickingId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CUSTOMER_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param customerPickingId The value of customerPickingId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCustomerPickingId_NotEqual(Long customerPickingId) {
        doSetCustomerPickingId_NotEqual(customerPickingId);
    }

    protected void doSetCustomerPickingId_NotEqual(Long customerPickingId) {
        regCustomerPickingId(CK_NES, customerPickingId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CUSTOMER_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param customerPickingId The value of customerPickingId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCustomerPickingId_GreaterThan(Long customerPickingId) {
        regCustomerPickingId(CK_GT, customerPickingId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CUSTOMER_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param customerPickingId The value of customerPickingId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCustomerPickingId_LessThan(Long customerPickingId) {
        regCustomerPickingId(CK_LT, customerPickingId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CUSTOMER_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param customerPickingId The value of customerPickingId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCustomerPickingId_GreaterEqual(Long customerPickingId) {
        regCustomerPickingId(CK_GE, customerPickingId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CUSTOMER_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param customerPickingId The value of customerPickingId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCustomerPickingId_LessEqual(Long customerPickingId) {
        regCustomerPickingId(CK_LE, customerPickingId);
    }
     ...
     * CUSTOMER_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of customerPickingId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of customerPickingId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setCustomerPickingId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueCustomerPickingId(), "CUSTOMER_PICKING_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * CUSTOMER_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param customerPickingIdList The collection of customerPickingId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCustomerPickingId_InScope(Collection<Long> customerPickingIdList) {
        doSetCustomerPickingId_InScope(customerPickingIdList);
    }

    protected void doSetCustomerPickingId_InScope(Collection<Long> customerPickingIdList) {
        regINS(CK_INS, cTL(customerPickingIdList), xgetCValueCustomerPickingId(), "CUSTOMER_PICKING_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * CUSTOMER_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param customerPickingIdList The collection of customerPickingId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCustomerPickingId_NotInScope(Collection<Long> customerPickingIdList) {
        doSetCustomerPickingId_NotInScope(customerPickingIdList);
    }

    protected void doSetCustomerPickingId_NotInScope(Collection<Long> customerPickingIdList) {
        regINS(CK_NINS, cTL(customerPickingIdList), xgetCValueCustomerPickingId(), "CUSTOMER_PICKING_ID");
    }
     ...
     * CUSTOMER_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setCustomerPickingId_IsNull() { regCustomerPickingId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * CUSTOMER_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setCustomerPickingId_IsNotNull() { regCustomerPickingId(CK_ISNN, DOBJ); }

    protected void regCustomerPickingId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueCustomerPickingId(), "CUSTOMER_PICKING_ID"); }
    protected abstract ConditionValue xgetCValueCustomerPickingId();
     ...
     * @param pickPatternCd The value of pickPatternCd as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPickPatternCd_Equal(String pickPatternCd) {
        doSetPickPatternCd_Equal(fRES(pickPatternCd));
    }

    protected void doSetPickPatternCd_Equal(String pickPatternCd) {
        regPickPatternCd(CK_EQ, pickPatternCd);
    }

    /**
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PICK_PATTERN_CD: {VARCHAR(30)}
     * @param pickPatternCd The value of pickPatternCd as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPickPatternCd_NotEqual(String pickPatternCd) {
        doSetPickPatternCd_NotEqual(fRES(pickPatternCd));
    }

    protected void doSetPickPatternCd_NotEqual(String pickPatternCd) {
        regPickPatternCd(CK_NES, pickPatternCd);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PICK_PATTERN_CD: {VARCHAR(30)}
     * @param pickPatternCd The value of pickPatternCd as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPickPatternCd_GreaterThan(String pickPatternCd) {
        regPickPatternCd(CK_GT, fRES(pickPatternCd));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PICK_PATTERN_CD: {VARCHAR(30)}
     * @param pickPatternCd The value of pickPatternCd as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPickPatternCd_LessThan(String pickPatternCd) {
        regPickPatternCd(CK_LT, fRES(pickPatternCd));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PICK_PATTERN_CD: {VARCHAR(30)}
     * @param pickPatternCd The value of pickPatternCd as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPickPatternCd_GreaterEqual(String pickPatternCd) {
        regPickPatternCd(CK_GE, fRES(pickPatternCd));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PICK_PATTERN_CD: {VARCHAR(30)}
     * @param pickPatternCd The value of pickPatternCd as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPickPatternCd_LessEqual(String pickPatternCd) {
        regPickPatternCd(CK_LE, fRES(pickPatternCd));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * PICK_PATTERN_CD: {VARCHAR(30)}
     * @param pickPatternCdList The collection of pickPatternCd as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPickPatternCd_InScope(Collection<String> pickPatternCdList) {
        doSetPickPatternCd_InScope(pickPatternCdList);
    }

    protected void doSetPickPatternCd_InScope(Collection<String> pickPatternCdList) {
        regINS(CK_INS, cTL(pickPatternCdList), xgetCValuePickPatternCd(), "PICK_PATTERN_CD");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * PICK_PATTERN_CD: {VARCHAR(30)}
     * @param pickPatternCdList The collection of pickPatternCd as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPickPatternCd_NotInScope(Collection<String> pickPatternCdList) {
        doSetPickPatternCd_NotInScope(pickPatternCdList);
    }

    protected void doSetPickPatternCd_NotInScope(Collection<String> pickPatternCdList) {
        regINS(CK_NINS, cTL(pickPatternCdList), xgetCValuePickPatternCd(), "PICK_PATTERN_CD");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * PICK_PATTERN_CD: {VARCHAR(30)} <br>
     * <pre>e.g. setPickPatternCd_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param pickPatternCd The value of pickPatternCd as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setPickPatternCd_LikeSearch(String pickPatternCd, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(pickPatternCd), xgetCValuePickPatternCd(), "PICK_PATTERN_CD", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * PICK_PATTERN_CD: {VARCHAR(30)}
     * @param pickPatternCd The value of pickPatternCd as notLikeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setPickPatternCd_NotLikeSearch(String pickPatternCd, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(pickPatternCd), xgetCValuePickPatternCd(), "PICK_PATTERN_CD", likeSearchOption);
    }

    /**
     * PrefixSearch {like 'xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * PICK_PATTERN_CD: {VARCHAR(30)}
     * @param pickPatternCd The value of pickPatternCd as prefixSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPickPatternCd_PrefixSearch(String pickPatternCd) {
        setPickPatternCd_LikeSearch(pickPatternCd, xcLSOPPre());
    }
     ...
     * PICK_PATTERN_CD: {VARCHAR(30)}
     */
    public void setPickPatternCd_IsNull() { regPickPatternCd(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * PICK_PATTERN_CD: {VARCHAR(30)}
     */
    public void setPickPatternCd_IsNullOrEmpty() { regPickPatternCd(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * PICK_PATTERN_CD: {VARCHAR(30)}
     */
    public void setPickPatternCd_IsNotNull() { regPickPatternCd(CK_ISNN, DOBJ); }

    protected void regPickPatternCd(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValuePickPatternCd(), "PICK_PATTERN_CD"); }
    protected abstract ConditionValue xgetCValuePickPatternCd();
     ...
     */
    public HpSLCFunction<MCustomerPickingCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, MCustomerPickingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCustomerPickingCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, MCustomerPickingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCustomerPickingCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, MCustomerPickingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCustomerPickingCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, MCustomerPickingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCustomerPickingCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, MCustomerPickingCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MCustomerPickingCB&gt;() {
     *     public void query(MCustomerPickingCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCustomerPickingCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, MCustomerPickingCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        MCustomerPickingCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(MCustomerPickingCQ sq);

    protected MCustomerPickingCB xcreateScalarConditionCB() {
        MCustomerPickingCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected MCustomerPickingCB xcreateScalarConditionPartitionByCB() {
        MCustomerPickingCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<MCustomerPickingCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MCustomerPickingCB cb = new MCustomerPickingCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "CUSTOMER_PICKING_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(MCustomerPickingCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<MCustomerPickingCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(MCustomerPickingCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MCustomerPickingCB cb = new MCustomerPickingCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "CUSTOMER_PICKING_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(MCustomerPickingCQ sq);
     ...
     */
    public void myselfExists(SubQuery<MCustomerPickingCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MCustomerPickingCB cb = new MCustomerPickingCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(MCustomerPickingCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected MCustomerPickingCB newMyCB() {
        return new MCustomerPickingCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return MCustomerPickingCQ.class.getName(); }
