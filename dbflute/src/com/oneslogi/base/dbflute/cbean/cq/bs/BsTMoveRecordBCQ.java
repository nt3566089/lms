...
public class BsTMoveRecordBCQ extends AbstractBsTMoveRecordBCQ {
     ...
     * @return this. (NotNull)
     */
    public BsTMoveRecordBCQ addOrderBy_UserId_Asc() { regOBA("USER_ID"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTMoveRecordBCQ addOrderBy_UserId_Desc() { regOBD("USER_ID"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTMoveRecordBCQ addOrderBy_CmSendFlg_Asc() { regOBA("CM_SEND_FLG"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTMoveRecordBCQ addOrderBy_CmSendFlg_Desc() { regOBD("CM_SEND_FLG"); return this; }
    ...
    protected BUserCQ xcreateQueryBUser() {
        String nrp = xresolveNRP("t_move_record_b", "bUser"); String jan = xresolveJAN(nrp, xgetNNLvl());
