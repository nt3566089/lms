...
/**
 * The abstract condition-query of e_sales_org.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsESalesOrgCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsESalesOrgCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<ESalesOrgCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ESalesOrgCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ESalesOrgCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ESalesOrgCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ESalesOrgCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ESalesOrgCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ESalesOrgCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ESalesOrgCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ESalesOrgCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ESalesOrgCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ESalesOrgCB&gt;() {
     *     public void query(ESalesOrgCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ESalesOrgCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ESalesOrgCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ESalesOrgCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ESalesOrgCQ sq);

    protected ESalesOrgCB xcreateScalarConditionCB() {
        ESalesOrgCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ESalesOrgCB xcreateScalarConditionPartitionByCB() {
        ESalesOrgCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ESalesOrgCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ESalesOrgCB cb = new ESalesOrgCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "SALES_ORG_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ESalesOrgCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ESalesOrgCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ESalesOrgCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ESalesOrgCB cb = new ESalesOrgCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "SALES_ORG_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ESalesOrgCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ESalesOrgCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ESalesOrgCB cb = new ESalesOrgCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ESalesOrgCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ESalesOrgCB newMyCB() {
        return new ESalesOrgCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ESalesOrgCQ.class.getName(); }
