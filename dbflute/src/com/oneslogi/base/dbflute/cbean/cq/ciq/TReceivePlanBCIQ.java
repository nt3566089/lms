...
public class TReceivePlanBCIQ extends AbstractBsTReceivePlanBCQ {
    ...
    public String keepReceivePlanBId_ExistsReferrer_TReceiveLabelList(TReceiveLabelCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepReceivePlanBId_ExistsReferrer_TReceivePlanDataTransferList(TReceivePlanDataTransferCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    ...
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepReceivePlanBId_NotExistsReferrer_TReceiveLabelList(TReceiveLabelCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepReceivePlanBId_NotExistsReferrer_TReceivePlanDataTransferList(TReceivePlanDataTransferCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    ...
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepReceivePlanBId_SpecifyDerivedReferrer_TReceiveLabelList(TReceiveLabelCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepReceivePlanBId_SpecifyDerivedReferrer_TReceivePlanDataTransferList(TReceivePlanDataTransferCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepReceivePlanBId_SpecifyDerivedReferrer_TStoreRecordBList(TStoreRecordBCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepReceivePlanBId_QueryDerivedReferrer_TReceiveLabelList(TReceiveLabelCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepReceivePlanBId_QueryDerivedReferrer_TReceiveLabelListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepReceivePlanBId_QueryDerivedReferrer_TReceivePlanDataTransferList(TReceivePlanDataTransferCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepReceivePlanBId_QueryDerivedReferrer_TReceivePlanDataTransferListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    ...
    protected ConditionValue xgetCValueStoreRowNo() { return _myCQ.xdfgetStoreRowNo(); }
    protected ConditionValue xgetCValuePlanProdDt() { return _myCQ.xdfgetPlanProdDt(); }
    ...
    protected ConditionValue xgetCValueRemainingReceiveNum() { return _myCQ.xdfgetRemainingReceiveNum(); }
    protected ConditionValue xgetCValueLotManagTypeId() { return _myCQ.xdfgetLotManagTypeId(); }
    ...
    protected ConditionValue xgetCValueRemainFlg() { return _myCQ.xdfgetRemainFlg(); }
