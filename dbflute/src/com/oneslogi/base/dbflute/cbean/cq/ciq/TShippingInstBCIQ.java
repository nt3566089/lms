...
public class TShippingInstBCIQ extends AbstractBsTShippingInstBCQ {
    ...
    public String keepShippingInstBId_ExistsReferrer_TShippingInstBPrintList(TShippingInstBPrintCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepShippingInstBId_ExistsReferrer_TShippingInstDataTransferList(TShippingInstDataTransferCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    ...
    public String keepShippingInstBId_NotExistsReferrer_TShippingInstBPrintList(TShippingInstBPrintCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepShippingInstBId_NotExistsReferrer_TShippingInstDataTransferList(TShippingInstDataTransferCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    ...
    public String keepShippingInstBId_SpecifyDerivedReferrer_TShippingInstBPrintList(TShippingInstBPrintCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepShippingInstBId_SpecifyDerivedReferrer_TShippingInstDataTransferList(TShippingInstDataTransferCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    ...
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepShippingInstBId_QueryDerivedReferrer_TShippingInstBPrintList(TShippingInstBPrintCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepShippingInstBId_QueryDerivedReferrer_TShippingInstBPrintListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepShippingInstBId_QueryDerivedReferrer_TShippingInstDataTransferList(TShippingInstDataTransferCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepShippingInstBId_QueryDerivedReferrer_TShippingInstDataTransferListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    ...
    protected ConditionValue xgetCValueUs3fTypeCd() { return _myCQ.xdfgetUs3fTypeCd(); }
