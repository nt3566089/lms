...
/**
 * The condition-query for in-line of e_scm_label.
 * @author DBFlute(AutoGenerator)
 */
public class EScmLabelCIQ extends AbstractBsEScmLabelCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEScmLabelCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EScmLabelCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEScmLabelCQ myCQ) {
    ...
    public String keepScalarCondition(EScmLabelCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EScmLabelCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EScmLabelCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EScmLabelCQ sq)
    ...
    protected String xinCB() { return EScmLabelCB.class.getName(); }
    protected String xinCQ() { return EScmLabelCQ.class.getName(); }
}
