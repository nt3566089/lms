...
/**
 * The condition-query for in-line of er_distribution.
 * @author DBFlute(AutoGenerator)
 */
public class ErDistributionCIQ extends AbstractBsErDistributionCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsErDistributionCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ErDistributionCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsErDistributionCQ myCQ) {
    ...
    public String keepScalarCondition(ErDistributionCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ErDistributionCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ErDistributionCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ErDistributionCQ sq)
    ...
    protected String xinCB() { return ErDistributionCB.class.getName(); }
    protected String xinCQ() { return ErDistributionCQ.class.getName(); }
}
