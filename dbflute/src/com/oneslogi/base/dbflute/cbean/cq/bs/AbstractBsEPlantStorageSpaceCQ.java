...
/**
 * The abstract condition-query of e_plant_storage_space.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEPlantStorageSpaceCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEPlantStorageSpaceCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<EPlantStorageSpaceCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EPlantStorageSpaceCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EPlantStorageSpaceCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EPlantStorageSpaceCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EPlantStorageSpaceCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EPlantStorageSpaceCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EPlantStorageSpaceCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EPlantStorageSpaceCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EPlantStorageSpaceCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EPlantStorageSpaceCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EPlantStorageSpaceCB&gt;() {
     *     public void query(EPlantStorageSpaceCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EPlantStorageSpaceCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EPlantStorageSpaceCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EPlantStorageSpaceCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EPlantStorageSpaceCQ sq);

    protected EPlantStorageSpaceCB xcreateScalarConditionCB() {
        EPlantStorageSpaceCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EPlantStorageSpaceCB xcreateScalarConditionPartitionByCB() {
        EPlantStorageSpaceCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EPlantStorageSpaceCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EPlantStorageSpaceCB cb = new EPlantStorageSpaceCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "PLANT_STORAGE_SPACE_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EPlantStorageSpaceCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EPlantStorageSpaceCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EPlantStorageSpaceCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EPlantStorageSpaceCB cb = new EPlantStorageSpaceCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PLANT_STORAGE_SPACE_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EPlantStorageSpaceCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EPlantStorageSpaceCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EPlantStorageSpaceCB cb = new EPlantStorageSpaceCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EPlantStorageSpaceCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EPlantStorageSpaceCB newMyCB() {
        return new EPlantStorageSpaceCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EPlantStorageSpaceCQ.class.getName(); }
