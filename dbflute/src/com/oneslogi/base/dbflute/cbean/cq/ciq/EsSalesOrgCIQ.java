...
/**
 * The condition-query for in-line of es_sales_org.
 * @author DBFlute(AutoGenerator)
 */
public class EsSalesOrgCIQ extends AbstractBsEsSalesOrgCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEsSalesOrgCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EsSalesOrgCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEsSalesOrgCQ myCQ) {
    ...
    public String keepScalarCondition(EsSalesOrgCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EsSalesOrgCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EsSalesOrgCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EsSalesOrgCQ sq)
    ...
    protected String xinCB() { return EsSalesOrgCB.class.getName(); }
    protected String xinCQ() { return EsSalesOrgCQ.class.getName(); }
}
