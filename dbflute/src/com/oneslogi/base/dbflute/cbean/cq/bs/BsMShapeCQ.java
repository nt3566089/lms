...
public class BsMShapeCQ extends AbstractBsMShapeCQ {
    ...
    public Map<String, MLocationReplenishProductCQ> xdfgetShapeId_ExistsReferrer_MLocationReplenishProductList() { return xgetSQueMap("shapeId_ExistsReferrer_MLocationReplenishProductList"); }
    public String keepShapeId_ExistsReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq) { return xkeepSQue("shapeId_ExistsReferrer_MLocationReplenishProductList", sq); }
    ...
    public Map<String, MLocationReplenishProductCQ> xdfgetShapeId_NotExistsReferrer_MLocationReplenishProductList() { return xgetSQueMap("shapeId_NotExistsReferrer_MLocationReplenishProductList"); }
    public String keepShapeId_NotExistsReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq) { return xkeepSQue("shapeId_NotExistsReferrer_MLocationReplenishProductList", sq); }
    ...
    public Map<String, MLocationReplenishProductCQ> xdfgetShapeId_SpecifyDerivedReferrer_MLocationReplenishProductList() { return xgetSQueMap("shapeId_SpecifyDerivedReferrer_MLocationReplenishProductList"); }
    public String keepShapeId_SpecifyDerivedReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq) { return xkeepSQue("shapeId_SpecifyDerivedReferrer_MLocationReplenishProductList", sq); }
    ...
    public Map<String, MLocationReplenishProductCQ> xdfgetShapeId_QueryDerivedReferrer_MLocationReplenishProductList() { return xgetSQueMap("shapeId_QueryDerivedReferrer_MLocationReplenishProductList"); }
    public String keepShapeId_QueryDerivedReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq) { return xkeepSQue("shapeId_QueryDerivedReferrer_MLocationReplenishProductList", sq); }
    public Map<String, Object> xdfgetShapeId_QueryDerivedReferrer_MLocationReplenishProductListParameter() { return xgetSQuePmMap("shapeId_QueryDerivedReferrer_MLocationReplenishProductList"); }
    public String keepShapeId_QueryDerivedReferrer_MLocationReplenishProductListParameter(Object pm) { return xkeepSQuePm("shapeId_QueryDerivedReferrer_MLocationReplenishProductList", pm); }
