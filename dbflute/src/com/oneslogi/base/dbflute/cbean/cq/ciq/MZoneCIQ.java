...
public class MZoneCIQ extends AbstractBsMZoneCQ {
    ...
    protected ConditionValue xgetCValueFloorCd() { return _myCQ.xdfgetFloorCd(); }
    protected ConditionValue xgetCValueStorageSpaceCd() { return _myCQ.xdfgetStorageSpaceCd(); }
    protected ConditionValue xgetCValueReplenishTypeCd() { return _myCQ.xdfgetReplenishTypeCd(); }
