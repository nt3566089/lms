...
/**
 * The condition-query for in-line of t_id_manag_data.
 * @author DBFlute(AutoGenerator)
 */
public class TIdManagDataCIQ extends AbstractBsTIdManagDataCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTIdManagDataCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TIdManagDataCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTIdManagDataCQ myCQ) {
    ...
    public String keepScalarCondition(TIdManagDataCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TIdManagDataCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TIdManagDataCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TIdManagDataCQ sq)
    ...
    protected String xinCB() { return TIdManagDataCB.class.getName(); }
    protected String xinCQ() { return TIdManagDataCQ.class.getName(); }
}
