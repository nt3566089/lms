...
/**
 * The condition-query for in-line of er_stock_record.
 * @author DBFlute(AutoGenerator)
 */
public class ErStockRecordCIQ extends AbstractBsErStockRecordCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsErStockRecordCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ErStockRecordCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsErStockRecordCQ myCQ) {
    ...
    public String keepScalarCondition(ErStockRecordCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ErStockRecordCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ErStockRecordCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ErStockRecordCQ sq)
    ...
    protected String xinCB() { return ErStockRecordCB.class.getName(); }
    protected String xinCQ() { return ErStockRecordCQ.class.getName(); }
}
