...
public abstract class AbstractBsMClientItemCQ extends AbstractConditionQuery {
     ...
     * VISIBLE: {CHAR(1)}
     */
    public void setVisible_IsNullOrEmpty() { regVisible(CK_ISNOE, DOBJ); }
     ...
     * EDITABLE: {CHAR(1)}
     */
    public void setEditable_IsNullOrEmpty() { regEditable(CK_ISNOE, DOBJ); }
     ...
     * NECESSARY: {CHAR(1)}
     */
    public void setNecessary_IsNullOrEmpty() { regNecessary(CK_ISNOE, DOBJ); }
