...
/**
 * The abstract condition-query of er_stock_record.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsErStockRecordCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsErStockRecordCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<ErStockRecordCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ErStockRecordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErStockRecordCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ErStockRecordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErStockRecordCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ErStockRecordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErStockRecordCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ErStockRecordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErStockRecordCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ErStockRecordCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ErStockRecordCB&gt;() {
     *     public void query(ErStockRecordCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErStockRecordCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ErStockRecordCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ErStockRecordCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ErStockRecordCQ sq);

    protected ErStockRecordCB xcreateScalarConditionCB() {
        ErStockRecordCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ErStockRecordCB xcreateScalarConditionPartitionByCB() {
        ErStockRecordCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ErStockRecordCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErStockRecordCB cb = new ErStockRecordCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "STOCK_RECORD_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ErStockRecordCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ErStockRecordCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ErStockRecordCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErStockRecordCB cb = new ErStockRecordCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "STOCK_RECORD_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ErStockRecordCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ErStockRecordCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ErStockRecordCB cb = new ErStockRecordCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ErStockRecordCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ErStockRecordCB newMyCB() {
        return new ErStockRecordCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ErStockRecordCQ.class.getName(); }
