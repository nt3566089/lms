...
public class BsMCustomerCQ extends AbstractBsMCustomerCQ {
    ...
    public Map<String, MCarrierDecisionCQ> xdfgetCustomerId_ExistsReferrer_MCarrierDecisionList() { return xgetSQueMap("customerId_ExistsReferrer_MCarrierDecisionList"); }
    public String keepCustomerId_ExistsReferrer_MCarrierDecisionList(MCarrierDecisionCQ sq) { return xkeepSQue("customerId_ExistsReferrer_MCarrierDecisionList", sq); }
    ...
    public Map<String, MCustomerPickingCQ> xdfgetCustomerId_ExistsReferrer_MCustomerPickingList() { return xgetSQueMap("customerId_ExistsReferrer_MCustomerPickingList"); }
    public String keepCustomerId_ExistsReferrer_MCustomerPickingList(MCustomerPickingCQ sq) { return xkeepSQue("customerId_ExistsReferrer_MCustomerPickingList", sq); }

    public Map<String, MDepositProductCQ> xdfgetCustomerId_ExistsReferrer_MDepositProductList() { return xgetSQueMap("customerId_ExistsReferrer_MDepositProductList"); }
    public String keepCustomerId_ExistsReferrer_MDepositProductList(MDepositProductCQ sq) { return xkeepSQue("customerId_ExistsReferrer_MDepositProductList", sq); }
    ...
    public Map<String, MLocationReplenishProductCQ> xdfgetCustomerId_ExistsReferrer_MLocationReplenishProductList() { return xgetSQueMap("customerId_ExistsReferrer_MLocationReplenishProductList"); }
    public String keepCustomerId_ExistsReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq) { return xkeepSQue("customerId_ExistsReferrer_MLocationReplenishProductList", sq); }
    ...
    public Map<String, TInventoryBCQ> xdfgetCustomerId_ExistsReferrer_TInventoryBByAccountIdList() { return xgetSQueMap("customerId_ExistsReferrer_TInventoryBByAccountIdList"); }
    public String keepCustomerId_ExistsReferrer_TInventoryBByAccountIdList(TInventoryBCQ sq) { return xkeepSQue("customerId_ExistsReferrer_TInventoryBByAccountIdList", sq); }
    ...
    public Map<String, TMoveInstBCQ> xdfgetCustomerId_ExistsReferrer_TMoveInstBByAccountIdList() { return xgetSQueMap("customerId_ExistsReferrer_TMoveInstBByAccountIdList"); }
    public String keepCustomerId_ExistsReferrer_TMoveInstBByAccountIdList(TMoveInstBCQ sq) { return xkeepSQue("customerId_ExistsReferrer_TMoveInstBByAccountIdList", sq); }
    ...
    public Map<String, TShippingInstHCQ> xdfgetCustomerId_ExistsReferrer_TShippingInstHByAccoutIdList() { return xgetSQueMap("customerId_ExistsReferrer_TShippingInstHByAccoutIdList"); }
    public String keepCustomerId_ExistsReferrer_TShippingInstHByAccoutIdList(TShippingInstHCQ sq) { return xkeepSQue("customerId_ExistsReferrer_TShippingInstHByAccoutIdList", sq); }

    public Map<String, MCarrierDecisionCQ> xdfgetCustomerId_NotExistsReferrer_MCarrierDecisionList() { return xgetSQueMap("customerId_NotExistsReferrer_MCarrierDecisionList"); }
    public String keepCustomerId_NotExistsReferrer_MCarrierDecisionList(MCarrierDecisionCQ sq) { return xkeepSQue("customerId_NotExistsReferrer_MCarrierDecisionList", sq); }
    ...
    public Map<String, MCustomerPickingCQ> xdfgetCustomerId_NotExistsReferrer_MCustomerPickingList() { return xgetSQueMap("customerId_NotExistsReferrer_MCustomerPickingList"); }
    public String keepCustomerId_NotExistsReferrer_MCustomerPickingList(MCustomerPickingCQ sq) { return xkeepSQue("customerId_NotExistsReferrer_MCustomerPickingList", sq); }

    public Map<String, MDepositProductCQ> xdfgetCustomerId_NotExistsReferrer_MDepositProductList() { return xgetSQueMap("customerId_NotExistsReferrer_MDepositProductList"); }
    public String keepCustomerId_NotExistsReferrer_MDepositProductList(MDepositProductCQ sq) { return xkeepSQue("customerId_NotExistsReferrer_MDepositProductList", sq); }
    ...
    public Map<String, MLocationReplenishProductCQ> xdfgetCustomerId_NotExistsReferrer_MLocationReplenishProductList() { return xgetSQueMap("customerId_NotExistsReferrer_MLocationReplenishProductList"); }
    public String keepCustomerId_NotExistsReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq) { return xkeepSQue("customerId_NotExistsReferrer_MLocationReplenishProductList", sq); }
    ...
    public Map<String, TInventoryBCQ> xdfgetCustomerId_NotExistsReferrer_TInventoryBByAccountIdList() { return xgetSQueMap("customerId_NotExistsReferrer_TInventoryBByAccountIdList"); }
    public String keepCustomerId_NotExistsReferrer_TInventoryBByAccountIdList(TInventoryBCQ sq) { return xkeepSQue("customerId_NotExistsReferrer_TInventoryBByAccountIdList", sq); }
    ...
    public Map<String, TMoveInstBCQ> xdfgetCustomerId_NotExistsReferrer_TMoveInstBByAccountIdList() { return xgetSQueMap("customerId_NotExistsReferrer_TMoveInstBByAccountIdList"); }
    public String keepCustomerId_NotExistsReferrer_TMoveInstBByAccountIdList(TMoveInstBCQ sq) { return xkeepSQue("customerId_NotExistsReferrer_TMoveInstBByAccountIdList", sq); }
    ...
    public Map<String, TShippingInstHCQ> xdfgetCustomerId_NotExistsReferrer_TShippingInstHByAccoutIdList() { return xgetSQueMap("customerId_NotExistsReferrer_TShippingInstHByAccoutIdList"); }
    public String keepCustomerId_NotExistsReferrer_TShippingInstHByAccoutIdList(TShippingInstHCQ sq) { return xkeepSQue("customerId_NotExistsReferrer_TShippingInstHByAccoutIdList", sq); }

    public Map<String, MCarrierDecisionCQ> xdfgetCustomerId_SpecifyDerivedReferrer_MCarrierDecisionList() { return xgetSQueMap("customerId_SpecifyDerivedReferrer_MCarrierDecisionList"); }
    public String keepCustomerId_SpecifyDerivedReferrer_MCarrierDecisionList(MCarrierDecisionCQ sq) { return xkeepSQue("customerId_SpecifyDerivedReferrer_MCarrierDecisionList", sq); }
    ...
    public Map<String, MCustomerPickingCQ> xdfgetCustomerId_SpecifyDerivedReferrer_MCustomerPickingList() { return xgetSQueMap("customerId_SpecifyDerivedReferrer_MCustomerPickingList"); }
    public String keepCustomerId_SpecifyDerivedReferrer_MCustomerPickingList(MCustomerPickingCQ sq) { return xkeepSQue("customerId_SpecifyDerivedReferrer_MCustomerPickingList", sq); }

    public Map<String, MDepositProductCQ> xdfgetCustomerId_SpecifyDerivedReferrer_MDepositProductList() { return xgetSQueMap("customerId_SpecifyDerivedReferrer_MDepositProductList"); }
    public String keepCustomerId_SpecifyDerivedReferrer_MDepositProductList(MDepositProductCQ sq) { return xkeepSQue("customerId_SpecifyDerivedReferrer_MDepositProductList", sq); }
    ...
    public Map<String, MLocationReplenishProductCQ> xdfgetCustomerId_SpecifyDerivedReferrer_MLocationReplenishProductList() { return xgetSQueMap("customerId_SpecifyDerivedReferrer_MLocationReplenishProductList"); }
    public String keepCustomerId_SpecifyDerivedReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq) { return xkeepSQue("customerId_SpecifyDerivedReferrer_MLocationReplenishProductList", sq); }
    ...
    public Map<String, TInventoryBCQ> xdfgetCustomerId_SpecifyDerivedReferrer_TInventoryBByAccountIdList() { return xgetSQueMap("customerId_SpecifyDerivedReferrer_TInventoryBByAccountIdList"); }
    public String keepCustomerId_SpecifyDerivedReferrer_TInventoryBByAccountIdList(TInventoryBCQ sq) { return xkeepSQue("customerId_SpecifyDerivedReferrer_TInventoryBByAccountIdList", sq); }
    ...
    public Map<String, TMoveInstBCQ> xdfgetCustomerId_SpecifyDerivedReferrer_TMoveInstBByAccountIdList() { return xgetSQueMap("customerId_SpecifyDerivedReferrer_TMoveInstBByAccountIdList"); }
    public String keepCustomerId_SpecifyDerivedReferrer_TMoveInstBByAccountIdList(TMoveInstBCQ sq) { return xkeepSQue("customerId_SpecifyDerivedReferrer_TMoveInstBByAccountIdList", sq); }
    ...
    public Map<String, TShippingInstHCQ> xdfgetCustomerId_SpecifyDerivedReferrer_TShippingInstHByAccoutIdList() { return xgetSQueMap("customerId_SpecifyDerivedReferrer_TShippingInstHByAccoutIdList"); }
    public String keepCustomerId_SpecifyDerivedReferrer_TShippingInstHByAccoutIdList(TShippingInstHCQ sq) { return xkeepSQue("customerId_SpecifyDerivedReferrer_TShippingInstHByAccoutIdList", sq); }

    public Map<String, MCarrierDecisionCQ> xdfgetCustomerId_QueryDerivedReferrer_MCarrierDecisionList() { return xgetSQueMap("customerId_QueryDerivedReferrer_MCarrierDecisionList"); }
    public String keepCustomerId_QueryDerivedReferrer_MCarrierDecisionList(MCarrierDecisionCQ sq) { return xkeepSQue("customerId_QueryDerivedReferrer_MCarrierDecisionList", sq); }
    public Map<String, Object> xdfgetCustomerId_QueryDerivedReferrer_MCarrierDecisionListParameter() { return xgetSQuePmMap("customerId_QueryDerivedReferrer_MCarrierDecisionList"); }
    public String keepCustomerId_QueryDerivedReferrer_MCarrierDecisionListParameter(Object pm) { return xkeepSQuePm("customerId_QueryDerivedReferrer_MCarrierDecisionList", pm); }
    ...
    public Map<String, MCustomerPickingCQ> xdfgetCustomerId_QueryDerivedReferrer_MCustomerPickingList() { return xgetSQueMap("customerId_QueryDerivedReferrer_MCustomerPickingList"); }
    public String keepCustomerId_QueryDerivedReferrer_MCustomerPickingList(MCustomerPickingCQ sq) { return xkeepSQue("customerId_QueryDerivedReferrer_MCustomerPickingList", sq); }
    public Map<String, Object> xdfgetCustomerId_QueryDerivedReferrer_MCustomerPickingListParameter() { return xgetSQuePmMap("customerId_QueryDerivedReferrer_MCustomerPickingList"); }
    public String keepCustomerId_QueryDerivedReferrer_MCustomerPickingListParameter(Object pm) { return xkeepSQuePm("customerId_QueryDerivedReferrer_MCustomerPickingList", pm); }

    public Map<String, MDepositProductCQ> xdfgetCustomerId_QueryDerivedReferrer_MDepositProductList() { return xgetSQueMap("customerId_QueryDerivedReferrer_MDepositProductList"); }
    public String keepCustomerId_QueryDerivedReferrer_MDepositProductList(MDepositProductCQ sq) { return xkeepSQue("customerId_QueryDerivedReferrer_MDepositProductList", sq); }
    public Map<String, Object> xdfgetCustomerId_QueryDerivedReferrer_MDepositProductListParameter() { return xgetSQuePmMap("customerId_QueryDerivedReferrer_MDepositProductList"); }
    public String keepCustomerId_QueryDerivedReferrer_MDepositProductListParameter(Object pm) { return xkeepSQuePm("customerId_QueryDerivedReferrer_MDepositProductList", pm); }
    ...
    public Map<String, MLocationReplenishProductCQ> xdfgetCustomerId_QueryDerivedReferrer_MLocationReplenishProductList() { return xgetSQueMap("customerId_QueryDerivedReferrer_MLocationReplenishProductList"); }
    public String keepCustomerId_QueryDerivedReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq) { return xkeepSQue("customerId_QueryDerivedReferrer_MLocationReplenishProductList", sq); }
    public Map<String, Object> xdfgetCustomerId_QueryDerivedReferrer_MLocationReplenishProductListParameter() { return xgetSQuePmMap("customerId_QueryDerivedReferrer_MLocationReplenishProductList"); }
    public String keepCustomerId_QueryDerivedReferrer_MLocationReplenishProductListParameter(Object pm) { return xkeepSQuePm("customerId_QueryDerivedReferrer_MLocationReplenishProductList", pm); }
    ...
    public Map<String, TInventoryBCQ> xdfgetCustomerId_QueryDerivedReferrer_TInventoryBByAccountIdList() { return xgetSQueMap("customerId_QueryDerivedReferrer_TInventoryBByAccountIdList"); }
    public String keepCustomerId_QueryDerivedReferrer_TInventoryBByAccountIdList(TInventoryBCQ sq) { return xkeepSQue("customerId_QueryDerivedReferrer_TInventoryBByAccountIdList", sq); }
    public Map<String, Object> xdfgetCustomerId_QueryDerivedReferrer_TInventoryBByAccountIdListParameter() { return xgetSQuePmMap("customerId_QueryDerivedReferrer_TInventoryBByAccountIdList"); }
    public String keepCustomerId_QueryDerivedReferrer_TInventoryBByAccountIdListParameter(Object pm) { return xkeepSQuePm("customerId_QueryDerivedReferrer_TInventoryBByAccountIdList", pm); }
    ...
    public Map<String, TMoveInstBCQ> xdfgetCustomerId_QueryDerivedReferrer_TMoveInstBByAccountIdList() { return xgetSQueMap("customerId_QueryDerivedReferrer_TMoveInstBByAccountIdList"); }
    public String keepCustomerId_QueryDerivedReferrer_TMoveInstBByAccountIdList(TMoveInstBCQ sq) { return xkeepSQue("customerId_QueryDerivedReferrer_TMoveInstBByAccountIdList", sq); }
    public Map<String, Object> xdfgetCustomerId_QueryDerivedReferrer_TMoveInstBByAccountIdListParameter() { return xgetSQuePmMap("customerId_QueryDerivedReferrer_TMoveInstBByAccountIdList"); }
    public String keepCustomerId_QueryDerivedReferrer_TMoveInstBByAccountIdListParameter(Object pm) { return xkeepSQuePm("customerId_QueryDerivedReferrer_TMoveInstBByAccountIdList", pm); }
    ...
    public Map<String, TShippingInstHCQ> xdfgetCustomerId_QueryDerivedReferrer_TShippingInstHByAccoutIdList() { return xgetSQueMap("customerId_QueryDerivedReferrer_TShippingInstHByAccoutIdList"); }
    public String keepCustomerId_QueryDerivedReferrer_TShippingInstHByAccoutIdList(TShippingInstHCQ sq) { return xkeepSQue("customerId_QueryDerivedReferrer_TShippingInstHByAccoutIdList", sq); }
    public Map<String, Object> xdfgetCustomerId_QueryDerivedReferrer_TShippingInstHByAccoutIdListParameter() { return xgetSQuePmMap("customerId_QueryDerivedReferrer_TShippingInstHByAccoutIdList"); }
    public String keepCustomerId_QueryDerivedReferrer_TShippingInstHByAccoutIdListParameter(Object pm) { return xkeepSQuePm("customerId_QueryDerivedReferrer_TShippingInstHByAccoutIdList", pm); }
    ...
    public Map<String, MPlantStorageSpaceCQ> getCustomerCd_InScopeRelation_MPlantStorageSpaceByCd() { return xgetSQueMap("customerCd_InScopeRelation_MPlantStorageSpaceByCd"); }
    public String keepCustomerCd_InScopeRelation_MPlantStorageSpaceByCd(MPlantStorageSpaceCQ sq) { return xkeepSQue("customerCd_InScopeRelation_MPlantStorageSpaceByCd", sq); }

    public Map<String, MPlantStorageSpaceCQ> getCustomerCd_NotInScopeRelation_MPlantStorageSpaceByCd() { return xgetSQueMap("customerCd_NotInScopeRelation_MPlantStorageSpaceByCd"); }
    public String keepCustomerCd_NotInScopeRelation_MPlantStorageSpaceByCd(MPlantStorageSpaceCQ sq) { return xkeepSQue("customerCd_NotInScopeRelation_MPlantStorageSpaceByCd", sq); }
    ...
    protected ConditionValue _accountFlg;
    public ConditionValue xdfgetAccountFlg()
    { if (_accountFlg == null) { _accountFlg = nCV(); }
      return _accountFlg; }
    protected ConditionValue xgetCValueAccountFlg() { return xdfgetAccountFlg(); }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_AccountFlg_Asc() { regOBA("ACCOUNT_FLG"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_AccountFlg_Desc() { regOBD("ACCOUNT_FLG"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_CenterId_Asc() { regOBA("CENTER_ID"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_CenterId_Desc() { regOBD("CENTER_ID"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_SalesOrgId_Asc() { regOBA("SALES_ORG_ID"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_SalesOrgId_Desc() { regOBD("SALES_ORG_ID"); return this; }

    protected ConditionValue _lotSplitTypeCd;
    public ConditionValue xdfgetLotSplitTypeCd()
    { if (_lotSplitTypeCd == null) { _lotSplitTypeCd = nCV(); }
      return _lotSplitTypeCd; }
    protected ConditionValue xgetCValueLotSplitTypeCd() { return xdfgetLotSplitTypeCd(); }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_LotSplitTypeCd_Asc() { regOBA("LOT_SPLIT_TYPE_CD"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_LotSplitTypeCd_Desc() { regOBD("LOT_SPLIT_TYPE_CD"); return this; }

    protected ConditionValue _limitDtSplitTypeCd;
    public ConditionValue xdfgetLimitDtSplitTypeCd()
    { if (_limitDtSplitTypeCd == null) { _limitDtSplitTypeCd = nCV(); }
      return _limitDtSplitTypeCd; }
    protected ConditionValue xgetCValueLimitDtSplitTypeCd() { return xdfgetLimitDtSplitTypeCd(); }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_LimitDtSplitTypeCd_Asc() { regOBA("LIMIT_DT_SPLIT_TYPE_CD"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_LimitDtSplitTypeCd_Desc() { regOBD("LIMIT_DT_SPLIT_TYPE_CD"); return this; }

    protected ConditionValue _prodDtSplitTypeCd;
    public ConditionValue xdfgetProdDtSplitTypeCd()
    { if (_prodDtSplitTypeCd == null) { _prodDtSplitTypeCd = nCV(); }
      return _prodDtSplitTypeCd; }
    protected ConditionValue xgetCValueProdDtSplitTypeCd() { return xdfgetProdDtSplitTypeCd(); }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_ProdDtSplitTypeCd_Asc() { regOBA("PROD_DT_SPLIT_TYPE_CD"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_ProdDtSplitTypeCd_Desc() { regOBD("PROD_DT_SPLIT_TYPE_CD"); return this; }

    protected ConditionValue _lotUnmatchTypeCd;
    public ConditionValue xdfgetLotUnmatchTypeCd()
    { if (_lotUnmatchTypeCd == null) { _lotUnmatchTypeCd = nCV(); }
      return _lotUnmatchTypeCd; }
    protected ConditionValue xgetCValueLotUnmatchTypeCd() { return xdfgetLotUnmatchTypeCd(); }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_LotUnmatchTypeCd_Asc() { regOBA("LOT_UNMATCH_TYPE_CD"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_LotUnmatchTypeCd_Desc() { regOBD("LOT_UNMATCH_TYPE_CD"); return this; }

    protected ConditionValue _limitDtUnmatchTypeCd;
    public ConditionValue xdfgetLimitDtUnmatchTypeCd()
    { if (_limitDtUnmatchTypeCd == null) { _limitDtUnmatchTypeCd = nCV(); }
      return _limitDtUnmatchTypeCd; }
    protected ConditionValue xgetCValueLimitDtUnmatchTypeCd() { return xdfgetLimitDtUnmatchTypeCd(); }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_LimitDtUnmatchTypeCd_Asc() { regOBA("LIMIT_DT_UNMATCH_TYPE_CD"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_LimitDtUnmatchTypeCd_Desc() { regOBD("LIMIT_DT_UNMATCH_TYPE_CD"); return this; }

    protected ConditionValue _prodDtUnmatchTypeCd;
    public ConditionValue xdfgetProdDtUnmatchTypeCd()
    { if (_prodDtUnmatchTypeCd == null) { _prodDtUnmatchTypeCd = nCV(); }
      return _prodDtUnmatchTypeCd; }
    protected ConditionValue xgetCValueProdDtUnmatchTypeCd() { return xdfgetProdDtUnmatchTypeCd(); }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_ProdDtUnmatchTypeCd_Asc() { regOBA("PROD_DT_UNMATCH_TYPE_CD"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_ProdDtUnmatchTypeCd_Desc() { regOBD("PROD_DT_UNMATCH_TYPE_CD"); return this; }

    protected ConditionValue _uniCustomerCd;
    public ConditionValue xdfgetUniCustomerCd()
    { if (_uniCustomerCd == null) { _uniCustomerCd = nCV(); }
      return _uniCustomerCd; }
    protected ConditionValue xgetCValueUniCustomerCd() { return xdfgetUniCustomerCd(); }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_UniCustomerCd_Asc() { regOBA("UNI_CUSTOMER_CD"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMCustomerCQ addOrderBy_UniCustomerCd_Desc() { regOBD("UNI_CUSTOMER_CD"); return this; }
    ...
    public void reflectRelationOnUnionQuery(ConditionQuery bqs, ConditionQuery uqs) {
        ...
        if (bq.hasConditionQueryMPlantStorageSpaceByCd()) {
            uq.queryMPlantStorageSpaceByCd().reflectRelationOnUnionQuery(bq.queryMPlantStorageSpaceByCd(), uq.queryMPlantStorageSpaceByCd());
        }
     ...
     * @return The instance of condition-query. (NotNull)
     */
    public MPlantStorageSpaceCQ queryMPlantStorageSpaceByCd() {
        return xdfgetConditionQueryMPlantStorageSpaceByCd();
    }
    public MPlantStorageSpaceCQ xdfgetConditionQueryMPlantStorageSpaceByCd() {
        String prop = "mPlantStorageSpaceByCd";
        if (!xhasQueRlMap(prop)) { xregQueRl(prop, xcreateQueryMPlantStorageSpaceByCd()); xsetupOuterJoinMPlantStorageSpaceByCd(); }
        return xgetQueRlMap(prop);
    }
    protected MPlantStorageSpaceCQ xcreateQueryMPlantStorageSpaceByCd() {
        String nrp = xresolveNRP("m_customer", "mPlantStorageSpaceByCd"); String jan = xresolveJAN(nrp, xgetNNLvl());
        return xinitRelCQ(new MPlantStorageSpaceCQ(this, xgetSqlClause(), jan, xgetNNLvl()), _baseCB, "mPlantStorageSpaceByCd", nrp);
    }
    protected void xsetupOuterJoinMPlantStorageSpaceByCd() { xregOutJo("mPlantStorageSpaceByCd"); }
    public boolean hasConditionQueryMPlantStorageSpaceByCd() { return xhasQueRlMap("mPlantStorageSpaceByCd"); }
