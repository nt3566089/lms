...
/**
 * The abstract condition-query of er_distribution.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsErDistributionCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsErDistributionCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<ErDistributionCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ErDistributionCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErDistributionCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ErDistributionCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErDistributionCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ErDistributionCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErDistributionCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ErDistributionCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErDistributionCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ErDistributionCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ErDistributionCB&gt;() {
     *     public void query(ErDistributionCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErDistributionCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ErDistributionCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ErDistributionCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ErDistributionCQ sq);

    protected ErDistributionCB xcreateScalarConditionCB() {
        ErDistributionCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ErDistributionCB xcreateScalarConditionPartitionByCB() {
        ErDistributionCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ErDistributionCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErDistributionCB cb = new ErDistributionCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "DISTRIBUTION_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ErDistributionCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ErDistributionCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ErDistributionCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErDistributionCB cb = new ErDistributionCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "DISTRIBUTION_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ErDistributionCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ErDistributionCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ErDistributionCB cb = new ErDistributionCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ErDistributionCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ErDistributionCB newMyCB() {
        return new ErDistributionCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ErDistributionCQ.class.getName(); }
