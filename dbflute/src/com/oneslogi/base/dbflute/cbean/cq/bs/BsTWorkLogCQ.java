...
public class BsTWorkLogCQ extends AbstractBsTWorkLogCQ {
    ...
    protected ConditionValue _forceCompleteFlg;
    public ConditionValue xdfgetForceCompleteFlg()
    { if (_forceCompleteFlg == null) { _forceCompleteFlg = nCV(); }
      return _forceCompleteFlg; }
    protected ConditionValue xgetCValueForceCompleteFlg() { return xdfgetForceCompleteFlg(); }
     ...
     * @return this. (NotNull)
     */
    public BsTWorkLogCQ addOrderBy_ForceCompleteFlg_Asc() { regOBA("FORCE_COMPLETE_FLG"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTWorkLogCQ addOrderBy_ForceCompleteFlg_Desc() { regOBD("FORCE_COMPLETE_FLG"); return this; }

    protected ConditionValue _workQtyCs;
    public ConditionValue xdfgetWorkQtyCs()
    { if (_workQtyCs == null) { _workQtyCs = nCV(); }
      return _workQtyCs; }
    protected ConditionValue xgetCValueWorkQtyCs() { return xdfgetWorkQtyCs(); }
     ...
     * @return this. (NotNull)
     */
    public BsTWorkLogCQ addOrderBy_WorkQtyCs_Asc() { regOBA("WORK_QTY_CS"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTWorkLogCQ addOrderBy_WorkQtyCs_Desc() { regOBD("WORK_QTY_CS"); return this; }
