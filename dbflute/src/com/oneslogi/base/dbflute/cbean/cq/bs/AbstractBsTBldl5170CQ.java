...
/**
 * The abstract condition-query of t_bldl5170.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTBldl5170CQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTBldl5170CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param bldl5170Id The value of bldl5170Id as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5170Id_Equal(Long bldl5170Id) {
        doSetBldl5170Id_Equal(bldl5170Id);
    }

    protected void doSetBldl5170Id_Equal(Long bldl5170Id) {
        regBldl5170Id(CK_EQ, bldl5170Id);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5170_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5170Id The value of bldl5170Id as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5170Id_NotEqual(Long bldl5170Id) {
        doSetBldl5170Id_NotEqual(bldl5170Id);
    }

    protected void doSetBldl5170Id_NotEqual(Long bldl5170Id) {
        regBldl5170Id(CK_NES, bldl5170Id);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5170_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5170Id The value of bldl5170Id as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5170Id_GreaterThan(Long bldl5170Id) {
        regBldl5170Id(CK_GT, bldl5170Id);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5170_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5170Id The value of bldl5170Id as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5170Id_LessThan(Long bldl5170Id) {
        regBldl5170Id(CK_LT, bldl5170Id);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5170_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5170Id The value of bldl5170Id as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5170Id_GreaterEqual(Long bldl5170Id) {
        regBldl5170Id(CK_GE, bldl5170Id);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5170_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5170Id The value of bldl5170Id as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5170Id_LessEqual(Long bldl5170Id) {
        regBldl5170Id(CK_LE, bldl5170Id);
    }
     ...
     * BLDL5170_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of bldl5170Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of bldl5170Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setBldl5170Id_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueBldl5170Id(), "BLDL5170_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5170_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5170IdList The collection of bldl5170Id as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5170Id_InScope(Collection<Long> bldl5170IdList) {
        doSetBldl5170Id_InScope(bldl5170IdList);
    }

    protected void doSetBldl5170Id_InScope(Collection<Long> bldl5170IdList) {
        regINS(CK_INS, cTL(bldl5170IdList), xgetCValueBldl5170Id(), "BLDL5170_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5170_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5170IdList The collection of bldl5170Id as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5170Id_NotInScope(Collection<Long> bldl5170IdList) {
        doSetBldl5170Id_NotInScope(bldl5170IdList);
    }

    protected void doSetBldl5170Id_NotInScope(Collection<Long> bldl5170IdList) {
        regINS(CK_NINS, cTL(bldl5170IdList), xgetCValueBldl5170Id(), "BLDL5170_ID");
    }
     ...
     * BLDL5170_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5170Id_IsNull() { regBldl5170Id(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * BLDL5170_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5170Id_IsNotNull() { regBldl5170Id(CK_ISNN, DOBJ); }

    protected void regBldl5170Id(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueBldl5170Id(), "BLDL5170_ID"); }
    protected abstract ConditionValue xgetCValueBldl5170Id();
     ...
     */
    public HpSLCFunction<TBldl5170CB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TBldl5170CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5170CB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TBldl5170CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5170CB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TBldl5170CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5170CB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TBldl5170CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5170CB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TBldl5170CB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TBldl5170CB&gt;() {
     *     public void query(TBldl5170CB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5170CB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TBldl5170CB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5170CB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TBldl5170CQ sq);

    protected TBldl5170CB xcreateScalarConditionCB() {
        TBldl5170CB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TBldl5170CB xcreateScalarConditionPartitionByCB() {
        TBldl5170CB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TBldl5170CB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5170CB cb = new TBldl5170CB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "BLDL5170_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TBldl5170CQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TBldl5170CB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TBldl5170CB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5170CB cb = new TBldl5170CB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "BLDL5170_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TBldl5170CQ sq);
     ...
     */
    public void myselfExists(SubQuery<TBldl5170CB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TBldl5170CB cb = new TBldl5170CB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TBldl5170CQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TBldl5170CB newMyCB() {
        return new TBldl5170CB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TBldl5170CQ.class.getName(); }
