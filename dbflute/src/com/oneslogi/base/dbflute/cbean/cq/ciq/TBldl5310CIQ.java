...
/**
 * The condition-query for in-line of t_bldl5310.
 * @author DBFlute(AutoGenerator)
 */
public class TBldl5310CIQ extends AbstractBsTBldl5310CQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTBldl5310CQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TBldl5310CIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTBldl5310CQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueBldl5310Id() { return _myCQ.xdfgetBldl5310Id(); }
    ...
    public String keepScalarCondition(TBldl5310CQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TBldl5310CQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TBldl5310CQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TBldl5310CQ sq)
    ...
    protected String xinCB() { return TBldl5310CB.class.getName(); }
    protected String xinCQ() { return TBldl5310CQ.class.getName(); }
}
