...
/**
 * The abstract condition-query of e_inventory_inst_dtl.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEInventoryInstDtlCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEInventoryInstDtlCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<EInventoryInstDtlCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EInventoryInstDtlCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EInventoryInstDtlCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EInventoryInstDtlCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EInventoryInstDtlCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EInventoryInstDtlCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EInventoryInstDtlCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EInventoryInstDtlCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EInventoryInstDtlCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EInventoryInstDtlCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EInventoryInstDtlCB&gt;() {
     *     public void query(EInventoryInstDtlCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EInventoryInstDtlCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EInventoryInstDtlCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EInventoryInstDtlCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EInventoryInstDtlCQ sq);

    protected EInventoryInstDtlCB xcreateScalarConditionCB() {
        EInventoryInstDtlCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EInventoryInstDtlCB xcreateScalarConditionPartitionByCB() {
        EInventoryInstDtlCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EInventoryInstDtlCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EInventoryInstDtlCB cb = new EInventoryInstDtlCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "INVENTORY_INST_DTL_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EInventoryInstDtlCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EInventoryInstDtlCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EInventoryInstDtlCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EInventoryInstDtlCB cb = new EInventoryInstDtlCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "INVENTORY_INST_DTL_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EInventoryInstDtlCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EInventoryInstDtlCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EInventoryInstDtlCB cb = new EInventoryInstDtlCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EInventoryInstDtlCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EInventoryInstDtlCB newMyCB() {
        return new EInventoryInstDtlCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EInventoryInstDtlCQ.class.getName(); }
