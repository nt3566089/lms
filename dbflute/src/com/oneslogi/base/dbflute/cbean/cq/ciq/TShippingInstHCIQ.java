...
public class TShippingInstHCIQ extends AbstractBsTShippingInstHCQ {
    ...
    public String keepSalesOrgCd_InScopeRelation_MSalesOrgBySalesOrg(MSalesOrgCQ sq)
    { return _myCQ.keepSalesOrgCd_InScopeRelation_MSalesOrgBySalesOrg(sq); }
    public String keepSalesOrgCd_NotInScopeRelation_MSalesOrgBySalesOrg(MSalesOrgCQ sq)
    { return _myCQ.keepSalesOrgCd_NotInScopeRelation_MSalesOrgBySalesOrg(sq); }
    ...
    public String keepAccountId_InScopeRelation_MCustomerByAccoutId(MCustomerCQ sq)
    { return _myCQ.keepAccountId_InScopeRelation_MCustomerByAccoutId(sq); }
    public String keepAccountId_NotInScopeRelation_MCustomerByAccoutId(MCustomerCQ sq)
    { return _myCQ.keepAccountId_NotInScopeRelation_MCustomerByAccoutId(sq); }
