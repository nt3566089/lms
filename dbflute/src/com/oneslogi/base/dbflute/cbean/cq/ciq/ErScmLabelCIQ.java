...
/**
 * The condition-query for in-line of er_scm_label.
 * @author DBFlute(AutoGenerator)
 */
public class ErScmLabelCIQ extends AbstractBsErScmLabelCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsErScmLabelCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ErScmLabelCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsErScmLabelCQ myCQ) {
    ...
    protected ConditionValue xgetCValueCartonIdNo() { return _myCQ.xdfgetCartonIdNo(); }
    protected ConditionValue xgetCValueSn() { return _myCQ.xdfgetSn(); }
    protected ConditionValue xgetCValueManagTypeCd() { return _myCQ.xdfgetManagTypeCd(); }
    ...
    public String keepScalarCondition(ErScmLabelCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ErScmLabelCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ErScmLabelCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ErScmLabelCQ sq)
    ...
    protected String xinCB() { return ErScmLabelCB.class.getName(); }
    protected String xinCQ() { return ErScmLabelCQ.class.getName(); }
}
