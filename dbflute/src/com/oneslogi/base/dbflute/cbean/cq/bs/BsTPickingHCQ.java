...
public class BsTPickingHCQ extends AbstractBsTPickingHCQ {
    ...
    protected ConditionValue _idManagPrintTypeCd;
    public ConditionValue xdfgetIdManagPrintTypeCd()
    { if (_idManagPrintTypeCd == null) { _idManagPrintTypeCd = nCV(); }
      return _idManagPrintTypeCd; }
    protected ConditionValue xgetCValueIdManagPrintTypeCd() { return xdfgetIdManagPrintTypeCd(); }
     ...
     * @return this. (NotNull)
     */
    public BsTPickingHCQ addOrderBy_IdManagPrintTypeCd_Asc() { regOBA("ID_MANAG_PRINT_TYPE_CD"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTPickingHCQ addOrderBy_IdManagPrintTypeCd_Desc() { regOBD("ID_MANAG_PRINT_TYPE_CD"); return this; }

    protected ConditionValue _pllPrintFlg;
    public ConditionValue xdfgetPllPrintFlg()
    { if (_pllPrintFlg == null) { _pllPrintFlg = nCV(); }
      return _pllPrintFlg; }
    protected ConditionValue xgetCValuePllPrintFlg() { return xdfgetPllPrintFlg(); }
     ...
     * @return this. (NotNull)
     */
    public BsTPickingHCQ addOrderBy_PllPrintFlg_Asc() { regOBA("PLL_PRINT_FLG"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTPickingHCQ addOrderBy_PllPrintFlg_Desc() { regOBD("PLL_PRINT_FLG"); return this; }
