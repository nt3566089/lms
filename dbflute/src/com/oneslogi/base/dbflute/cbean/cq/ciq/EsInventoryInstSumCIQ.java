...
/**
 * The condition-query for in-line of es_inventory_inst_sum.
 * @author DBFlute(AutoGenerator)
 */
public class EsInventoryInstSumCIQ extends AbstractBsEsInventoryInstSumCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEsInventoryInstSumCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EsInventoryInstSumCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEsInventoryInstSumCQ myCQ) {
    ...
    public String keepScalarCondition(EsInventoryInstSumCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EsInventoryInstSumCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EsInventoryInstSumCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EsInventoryInstSumCQ sq)
    ...
    protected String xinCB() { return EsInventoryInstSumCB.class.getName(); }
    protected String xinCQ() { return EsInventoryInstSumCQ.class.getName(); }
}
