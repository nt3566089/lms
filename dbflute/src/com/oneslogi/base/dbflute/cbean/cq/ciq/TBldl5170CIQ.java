...
/**
 * The condition-query for in-line of t_bldl5170.
 * @author DBFlute(AutoGenerator)
 */
public class TBldl5170CIQ extends AbstractBsTBldl5170CQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTBldl5170CQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TBldl5170CIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTBldl5170CQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueBldl5170Id() { return _myCQ.xdfgetBldl5170Id(); }
    ...
    public String keepScalarCondition(TBldl5170CQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TBldl5170CQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TBldl5170CQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TBldl5170CQ sq)
    ...
    protected String xinCB() { return TBldl5170CB.class.getName(); }
    protected String xinCQ() { return TBldl5170CQ.class.getName(); }
}
