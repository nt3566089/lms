...
public abstract class AbstractBsMProductShapeCQ extends AbstractConditionQuery {
    ...
    /**
     * Set up ExistsReferrer (correlated sub-query). <br>
     * {exists (select MAX_STORE_PRODUCT_SHAPE_ID from m_location_replenish_product where ...)} <br>
     * m_location_replenish_product by MAX_STORE_PRODUCT_SHAPE_ID, named 'MLocationReplenishProductAsOne'.
     * <pre>
    ...
    public void existsMLocationReplenishProductList(SubQuery<MLocationReplenishProductCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepProductShapeId_ExistsReferrer_MLocationReplenishProductList(cb.query());
        registerExistsReferrer(cb.query(), "PRODUCT_SHAPE_ID", "MAX_STORE_PRODUCT_SHAPE_ID", pp, "mLocationReplenishProductList");
    }
    public abstract String keepProductShapeId_ExistsReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq);
    ...
    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select MAX_STORE_PRODUCT_SHAPE_ID from m_location_replenish_product where ...)} <br>
     * m_location_replenish_product by MAX_STORE_PRODUCT_SHAPE_ID, named 'MLocationReplenishProductAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of ProductShapeId_NotExistsReferrer_MLocationReplenishProductList for 'not exists'. (NotNull)
     */
    public void notExistsMLocationReplenishProductList(SubQuery<MLocationReplenishProductCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MLocationReplenishProductCB cb = new MLocationReplenishProductCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepProductShapeId_NotExistsReferrer_MLocationReplenishProductList(cb.query());
        registerNotExistsReferrer(cb.query(), "PRODUCT_SHAPE_ID", "MAX_STORE_PRODUCT_SHAPE_ID", pp, "mLocationReplenishProductList");
    }
    public abstract String keepProductShapeId_NotExistsReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq);
    ...
    public void xsderiveMLocationReplenishProductList(String fn, SubQuery<MLocationReplenishProductCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepProductShapeId_SpecifyDerivedReferrer_MLocationReplenishProductList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "PRODUCT_SHAPE_ID", "MAX_STORE_PRODUCT_SHAPE_ID", pp, "mLocationReplenishProductList", al, op);
    }
    public abstract String keepProductShapeId_SpecifyDerivedReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq);
    ...
    public void xqderiveMLocationReplenishProductList(String fn, SubQuery<MLocationReplenishProductCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MLocationReplenishProductCB cb = new MLocationReplenishProductCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepProductShapeId_QueryDerivedReferrer_MLocationReplenishProductList(cb.query()); String prpp = keepProductShapeId_QueryDerivedReferrer_MLocationReplenishProductListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "PRODUCT_SHAPE_ID", "MAX_STORE_PRODUCT_SHAPE_ID", sqpp, "mLocationReplenishProductList", rd, vl, prpp, op);
    }
    public abstract String keepProductShapeId_QueryDerivedReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq);
    public abstract String keepProductShapeId_QueryDerivedReferrer_MLocationReplenishProductListParameter(Object vl);
