...
/**
 * The abstract condition-query of w_ht_picking.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsWHtPickingCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsWHtPickingCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param htPickingId The value of htPickingId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtPickingId_Equal(Long htPickingId) {
        doSetHtPickingId_Equal(htPickingId);
    }

    protected void doSetHtPickingId_Equal(Long htPickingId) {
        regHtPickingId(CK_EQ, htPickingId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htPickingId The value of htPickingId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtPickingId_NotEqual(Long htPickingId) {
        doSetHtPickingId_NotEqual(htPickingId);
    }

    protected void doSetHtPickingId_NotEqual(Long htPickingId) {
        regHtPickingId(CK_NES, htPickingId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htPickingId The value of htPickingId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtPickingId_GreaterThan(Long htPickingId) {
        regHtPickingId(CK_GT, htPickingId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htPickingId The value of htPickingId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtPickingId_LessThan(Long htPickingId) {
        regHtPickingId(CK_LT, htPickingId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htPickingId The value of htPickingId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtPickingId_GreaterEqual(Long htPickingId) {
        regHtPickingId(CK_GE, htPickingId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htPickingId The value of htPickingId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtPickingId_LessEqual(Long htPickingId) {
        regHtPickingId(CK_LE, htPickingId);
    }
     ...
     * HT_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of htPickingId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of htPickingId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setHtPickingId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueHtPickingId(), "HT_PICKING_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * HT_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htPickingIdList The collection of htPickingId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setHtPickingId_InScope(Collection<Long> htPickingIdList) {
        doSetHtPickingId_InScope(htPickingIdList);
    }

    protected void doSetHtPickingId_InScope(Collection<Long> htPickingIdList) {
        regINS(CK_INS, cTL(htPickingIdList), xgetCValueHtPickingId(), "HT_PICKING_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * HT_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htPickingIdList The collection of htPickingId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setHtPickingId_NotInScope(Collection<Long> htPickingIdList) {
        doSetHtPickingId_NotInScope(htPickingIdList);
    }

    protected void doSetHtPickingId_NotInScope(Collection<Long> htPickingIdList) {
        regINS(CK_NINS, cTL(htPickingIdList), xgetCValueHtPickingId(), "HT_PICKING_ID");
    }
     ...
     * HT_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setHtPickingId_IsNull() { regHtPickingId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * HT_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setHtPickingId_IsNotNull() { regHtPickingId(CK_ISNN, DOBJ); }

    protected void regHtPickingId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueHtPickingId(), "HT_PICKING_ID"); }
    protected abstract ConditionValue xgetCValueHtPickingId();
     ...
     */
    public HpSLCFunction<WHtPickingCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WHtPickingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtPickingCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WHtPickingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtPickingCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WHtPickingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtPickingCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WHtPickingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtPickingCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WHtPickingCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WHtPickingCB&gt;() {
     *     public void query(WHtPickingCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtPickingCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WHtPickingCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        WHtPickingCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(WHtPickingCQ sq);

    protected WHtPickingCB xcreateScalarConditionCB() {
        WHtPickingCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected WHtPickingCB xcreateScalarConditionPartitionByCB() {
        WHtPickingCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<WHtPickingCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WHtPickingCB cb = new WHtPickingCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "HT_PICKING_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(WHtPickingCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<WHtPickingCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(WHtPickingCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WHtPickingCB cb = new WHtPickingCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "HT_PICKING_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(WHtPickingCQ sq);
     ...
     */
    public void myselfExists(SubQuery<WHtPickingCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        WHtPickingCB cb = new WHtPickingCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(WHtPickingCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected WHtPickingCB newMyCB() {
        return new WHtPickingCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return WHtPickingCQ.class.getName(); }
