...
/**
 * The abstract condition-query of e_packing_list.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEPackingListCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEPackingListCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<EPackingListCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EPackingListCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EPackingListCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EPackingListCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EPackingListCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EPackingListCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EPackingListCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EPackingListCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EPackingListCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EPackingListCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EPackingListCB&gt;() {
     *     public void query(EPackingListCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EPackingListCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EPackingListCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EPackingListCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EPackingListCQ sq);

    protected EPackingListCB xcreateScalarConditionCB() {
        EPackingListCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EPackingListCB xcreateScalarConditionPartitionByCB() {
        EPackingListCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EPackingListCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EPackingListCB cb = new EPackingListCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "PACKING_LIST_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EPackingListCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EPackingListCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EPackingListCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EPackingListCB cb = new EPackingListCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PACKING_LIST_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EPackingListCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EPackingListCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EPackingListCB cb = new EPackingListCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EPackingListCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EPackingListCB newMyCB() {
        return new EPackingListCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EPackingListCQ.class.getName(); }
