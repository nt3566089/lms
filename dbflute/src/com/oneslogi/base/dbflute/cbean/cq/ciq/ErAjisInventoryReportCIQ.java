...
/**
 * The condition-query for in-line of er_ajis_inventory_report.
 * @author DBFlute(AutoGenerator)
 */
public class ErAjisInventoryReportCIQ extends AbstractBsErAjisInventoryReportCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsErAjisInventoryReportCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ErAjisInventoryReportCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsErAjisInventoryReportCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueAjisInventoryReportId() { return _myCQ.xdfgetAjisInventoryReportId(); }
    ...
    public String keepScalarCondition(ErAjisInventoryReportCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ErAjisInventoryReportCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ErAjisInventoryReportCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ErAjisInventoryReportCQ sq)
    ...
    protected String xinCB() { return ErAjisInventoryReportCB.class.getName(); }
    protected String xinCQ() { return ErAjisInventoryReportCQ.class.getName(); }
}
