...
/**
 * The condition-query for in-line of e_sales_org.
 * @author DBFlute(AutoGenerator)
 */
public class ESalesOrgCIQ extends AbstractBsESalesOrgCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsESalesOrgCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ESalesOrgCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsESalesOrgCQ myCQ) {
    ...
    public String keepScalarCondition(ESalesOrgCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ESalesOrgCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ESalesOrgCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ESalesOrgCQ sq)
    ...
    protected String xinCB() { return ESalesOrgCB.class.getName(); }
    protected String xinCQ() { return ESalesOrgCQ.class.getName(); }
}
