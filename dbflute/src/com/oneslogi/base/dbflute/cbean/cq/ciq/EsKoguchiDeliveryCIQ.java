...
/**
 * The condition-query for in-line of es_koguchi_delivery.
 * @author DBFlute(AutoGenerator)
 */
public class EsKoguchiDeliveryCIQ extends AbstractBsEsKoguchiDeliveryCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEsKoguchiDeliveryCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EsKoguchiDeliveryCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEsKoguchiDeliveryCQ myCQ) {
    ...
    public String keepScalarCondition(EsKoguchiDeliveryCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EsKoguchiDeliveryCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EsKoguchiDeliveryCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EsKoguchiDeliveryCQ sq)
    ...
    protected String xinCB() { return EsKoguchiDeliveryCB.class.getName(); }
    protected String xinCQ() { return EsKoguchiDeliveryCQ.class.getName(); }
}
