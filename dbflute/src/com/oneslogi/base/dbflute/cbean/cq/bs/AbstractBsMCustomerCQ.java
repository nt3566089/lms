...
public abstract class AbstractBsMCustomerCQ extends AbstractConditionQuery {
    ...
    /**
     * Set up ExistsReferrer (correlated sub-query). <br>
     * {exists (select ACCOUNT_ID from t_shipping_inst_h where ...)} <br>
     * t_shipping_inst_h by ACCOUNT_ID, named 'TShippingInstHByAccountIdAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">existsTShippingInstHByAccoutIdList</span>(hCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     hCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of TShippingInstHByAccoutIdList for 'exists'. (NotNull)
     */
    public void existsTShippingInstHByAccoutIdList(SubQuery<TShippingInstHCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TShippingInstHCB cb = new TShippingInstHCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepCustomerId_ExistsReferrer_TShippingInstHByAccoutIdList(cb.query());
        registerExistsReferrer(cb.query(), "CUSTOMER_ID", "ACCOUNT_ID", pp, "tShippingInstHByAccoutIdList");
    }
    public abstract String keepCustomerId_ExistsReferrer_TShippingInstHByAccoutIdList(TShippingInstHCQ sq);
    ...
    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select ACCOUNT_ID from t_shipping_inst_h where ...)} <br>
     * t_shipping_inst_h by ACCOUNT_ID, named 'TShippingInstHByAccountIdAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">notExistsTShippingInstHByAccoutIdList</span>(hCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     hCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of CustomerId_NotExistsReferrer_TShippingInstHByAccoutIdList for 'not exists'. (NotNull)
     */
    public void notExistsTShippingInstHByAccoutIdList(SubQuery<TShippingInstHCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TShippingInstHCB cb = new TShippingInstHCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepCustomerId_NotExistsReferrer_TShippingInstHByAccoutIdList(cb.query());
        registerNotExistsReferrer(cb.query(), "CUSTOMER_ID", "ACCOUNT_ID", pp, "tShippingInstHByAccoutIdList");
    }
    public abstract String keepCustomerId_NotExistsReferrer_TShippingInstHByAccoutIdList(TShippingInstHCQ sq);
    ...
    public void xsderiveTShippingInstHByAccoutIdList(String fn, SubQuery<TShippingInstHCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TShippingInstHCB cb = new TShippingInstHCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepCustomerId_SpecifyDerivedReferrer_TShippingInstHByAccoutIdList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "CUSTOMER_ID", "ACCOUNT_ID", pp, "tShippingInstHByAccoutIdList", al, op);
    }
    public abstract String keepCustomerId_SpecifyDerivedReferrer_TShippingInstHByAccoutIdList(TShippingInstHCQ sq);
     ...
     * t_shipping_inst_h by ACCOUNT_ID, named 'TShippingInstHByAccountIdAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">derivedTShippingInstHByAccoutIdList()</span>.<span style="color: #CC4747">max</span>(hCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     hCB.specify().<span style="color: #CC4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     *     hCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
     * }).<span style="color: #CC4747">greaterEqual</span>(123); <span style="color: #3F7E5E">// condition to derived column</span>
     * </pre>
     * @return The object to set up a function for referrer table. (NotNull)
     */
    public HpQDRFunction<TShippingInstHCB> derivedTShippingInstHByAccoutIdList() {
        return xcreateQDRFunctionTShippingInstHByAccoutIdList();
    }
    protected HpQDRFunction<TShippingInstHCB> xcreateQDRFunctionTShippingInstHByAccoutIdList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveTShippingInstHByAccoutIdList(fn, sq, rd, vl, op));
    }
    public void xqderiveTShippingInstHByAccoutIdList(String fn, SubQuery<TShippingInstHCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TShippingInstHCB cb = new TShippingInstHCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepCustomerId_QueryDerivedReferrer_TShippingInstHByAccoutIdList(cb.query()); String prpp = keepCustomerId_QueryDerivedReferrer_TShippingInstHByAccoutIdListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "CUSTOMER_ID", "ACCOUNT_ID", sqpp, "tShippingInstHByAccoutIdList", rd, vl, prpp, op);
    }
    public abstract String keepCustomerId_QueryDerivedReferrer_TShippingInstHByAccoutIdList(TShippingInstHCQ sq);
    public abstract String keepCustomerId_QueryDerivedReferrer_TShippingInstHByAccoutIdListParameter(Object vl);
     ...
     * CUSTOMER_CD: {+UQ, IX, NotNull, VARCHAR(30), FK to M_PLANT_STORAGE_SPACE} <br>
    ...
    /**
     * Set up InScopeRelation (sub-query). <br />
     * {in (select CUSTOMER_CD from m_plant_storage_space where ...)} <br />
     * m_plant_storage_space by my CUSTOMER_CD, named 'MPlantStorageSpaceByCd'.
     * @param subCBLambda The callback for sub-query of MPlantStorageSpaceByCd for 'in-scope'. (NotNull)
     */
    public void inScopeMPlantStorageSpaceByCd(SubQuery<MPlantStorageSpaceCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MPlantStorageSpaceCB cb = new MPlantStorageSpaceCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subCBLambda.query(cb); } finally { unlock(); }
        String pp = keepCustomerCd_InScopeRelation_MPlantStorageSpaceByCd(cb.query());
        registerInScopeRelation(cb.query(), "CUSTOMER_CD", "PLANT_CD", pp, "mPlantStorageSpaceByCd", false);
    }
    public abstract String keepCustomerCd_InScopeRelation_MPlantStorageSpaceByCd(MPlantStorageSpaceCQ sq);

    /**
     * Set up NotInScopeRelation (sub-query). <br />
     * {not in (select CUSTOMER_CD from m_plant_storage_space where ...)} <br />
     * m_plant_storage_space by my CUSTOMER_CD, named 'MPlantStorageSpaceByCd'.
     * @param subCBLambda The callback for sub-query of MPlantStorageSpaceByCd for 'not in-scope'. (NotNull)
     */
    public void notInScopeMPlantStorageSpaceByCd(SubQuery<MPlantStorageSpaceCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MPlantStorageSpaceCB cb = new MPlantStorageSpaceCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subCBLambda.query(cb); } finally { unlock(); }
        String pp = keepCustomerCd_NotInScopeRelation_MPlantStorageSpaceByCd(cb.query());
        registerInScopeRelation(cb.query(), "CUSTOMER_CD", "PLANT_CD", pp, "mPlantStorageSpaceByCd", true);
    }
    public abstract String keepCustomerCd_NotInScopeRelation_MPlantStorageSpaceByCd(MPlantStorageSpaceCQ sq);
