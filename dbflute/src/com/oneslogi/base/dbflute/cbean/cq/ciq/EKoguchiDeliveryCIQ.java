...
/**
 * The condition-query for in-line of e_koguchi_delivery.
 * @author DBFlute(AutoGenerator)
 */
public class EKoguchiDeliveryCIQ extends AbstractBsEKoguchiDeliveryCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEKoguchiDeliveryCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EKoguchiDeliveryCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEKoguchiDeliveryCQ myCQ) {
    ...
    public String keepScalarCondition(EKoguchiDeliveryCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EKoguchiDeliveryCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EKoguchiDeliveryCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EKoguchiDeliveryCQ sq)
    ...
    protected String xinCB() { return EKoguchiDeliveryCB.class.getName(); }
    protected String xinCQ() { return EKoguchiDeliveryCQ.class.getName(); }
}
