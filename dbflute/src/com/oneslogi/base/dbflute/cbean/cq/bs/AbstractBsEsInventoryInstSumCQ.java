...
/**
 * The abstract condition-query of es_inventory_inst_sum.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEsInventoryInstSumCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEsInventoryInstSumCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<EsInventoryInstSumCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EsInventoryInstSumCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstSumCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EsInventoryInstSumCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstSumCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EsInventoryInstSumCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstSumCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EsInventoryInstSumCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstSumCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EsInventoryInstSumCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EsInventoryInstSumCB&gt;() {
     *     public void query(EsInventoryInstSumCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstSumCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EsInventoryInstSumCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EsInventoryInstSumCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EsInventoryInstSumCQ sq);

    protected EsInventoryInstSumCB xcreateScalarConditionCB() {
        EsInventoryInstSumCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EsInventoryInstSumCB xcreateScalarConditionPartitionByCB() {
        EsInventoryInstSumCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EsInventoryInstSumCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EsInventoryInstSumCB cb = new EsInventoryInstSumCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "INVENTORY_INST_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EsInventoryInstSumCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EsInventoryInstSumCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EsInventoryInstSumCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EsInventoryInstSumCB cb = new EsInventoryInstSumCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "INVENTORY_INST_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EsInventoryInstSumCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EsInventoryInstSumCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EsInventoryInstSumCB cb = new EsInventoryInstSumCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EsInventoryInstSumCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EsInventoryInstSumCB newMyCB() {
        return new EsInventoryInstSumCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EsInventoryInstSumCQ.class.getName(); }
