...
public class BsMParamCQ extends AbstractBsMParamCQ {
    ...
    protected ConditionValue _receiveLabelFlg;
    public ConditionValue xdfgetReceiveLabelFlg()
    { if (_receiveLabelFlg == null) { _receiveLabelFlg = nCV(); }
      return _receiveLabelFlg; }
    protected ConditionValue xgetCValueReceiveLabelFlg() { return xdfgetReceiveLabelFlg(); }
     ...
     * @return this. (NotNull)
     */
    public BsMParamCQ addOrderBy_ReceiveLabelFlg_Asc() { regOBA("RECEIVE_LABEL_FLG"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsMParamCQ addOrderBy_ReceiveLabelFlg_Desc() { regOBD("RECEIVE_LABEL_FLG"); return this; }
