...
public abstract class BsTShippingInstH extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected MSalesOrg _mSalesOrgBySalesOrg;

    /**
     * [get] m_sales_org by my SALES_ORG_CD, named 'MSalesOrgBySalesOrg'. <br>
     * @return The entity of foreign property 'MSalesOrgBySalesOrg'. (NullAllowed: when e.g. null FK column, no setupSelect)
     */
    public MSalesOrg getMSalesOrgBySalesOrg() {
        return _mSalesOrgBySalesOrg;
    }

    /**
     * [set] m_sales_org by my SALES_ORG_CD, named 'MSalesOrgBySalesOrg'.
     * @param mSalesOrgBySalesOrg The entity of foreign property 'MSalesOrgBySalesOrg'. (NullAllowed)
     */
    public void setMSalesOrgBySalesOrg(MSalesOrg mSalesOrgBySalesOrg) {
        _mSalesOrgBySalesOrg = mSalesOrgBySalesOrg;
    }

    /** m_customer by my ACCOUNT_ID, named 'MCustomerByAccoutId'. */
    protected MCustomer _mCustomerByAccoutId;

    /**
     * [get] m_customer by my ACCOUNT_ID, named 'MCustomerByAccoutId'. <br>
     * @return The entity of foreign property 'MCustomerByAccoutId'. (NullAllowed: when e.g. null FK column, no setupSelect)
     */
    public MCustomer getMCustomerByAccoutId() {
        return _mCustomerByAccoutId;
    }

    /**
     * [set] m_customer by my ACCOUNT_ID, named 'MCustomerByAccoutId'.
     * @param mCustomerByAccoutId The entity of foreign property 'MCustomerByAccoutId'. (NullAllowed)
     */
    public void setMCustomerByAccoutId(MCustomer mCustomerByAccoutId) {
        _mCustomerByAccoutId = mCustomerByAccoutId;
    }
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        { sb.append(li).append(xbRDS(_mSalesOrgBySalesOrg, "mSalesOrgBySalesOrg")); }
        if (_mCustomerByAccoutId != null)
        { sb.append(li).append(xbRDS(_mCustomerByAccoutId, "mCustomerByAccoutId")); }
    ...
    protected String doBuildRelationString(String dm) {
        ...
        if (_mSalesOrgBySalesOrg != null)
        { sb.append(dm).append("mSalesOrgBySalesOrg"); }
        if (_mCustomerByAccoutId != null)
        { sb.append(dm).append("mCustomerByAccoutId"); }
        if (_bClassDtlByDelivTz != null)
