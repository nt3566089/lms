...
/**
 * The entity of e_inventory_record_sum as TABLE. <br>
 * 棚卸実績(集約)送信テーブル
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long inventoryRecordSumId = entity.getInventoryRecordSumId();
 ...
 * entity.setInventoryRecordSumId(inventoryRecordSumId);
 ...
 */
public abstract class BsEInventoryRecordSum extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected Long _inventoryRecordSumId;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_inventoryRecordSumId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEInventoryRecordSum) {
            BsEInventoryRecordSum other = (BsEInventoryRecordSum)obj;
            if (!xSV(_inventoryRecordSumId, other._inventoryRecordSumId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _inventoryRecordSumId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_inventoryRecordSumId));
    ...
    @Override
    public EInventoryRecordSum clone() {
        return (EInventoryRecordSum)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] INVENTORY_RECORD_SUM_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 棚卸実績_集約送信ID
     * @return The value of the column 'INVENTORY_RECORD_SUM_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getInventoryRecordSumId() {
        checkSpecifiedProperty("inventoryRecordSumId");
        return _inventoryRecordSumId;
    }

    /**
     * [set] INVENTORY_RECORD_SUM_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 棚卸実績_集約送信ID
     * @param inventoryRecordSumId The value of the column 'INVENTORY_RECORD_SUM_ID'. (basically NotNull if update: for the constraint)
     */
    public void setInventoryRecordSumId(Long inventoryRecordSumId) {
        registerModifiedProperty("inventoryRecordSumId");
        _inventoryRecordSumId = inventoryRecordSumId;
    }
