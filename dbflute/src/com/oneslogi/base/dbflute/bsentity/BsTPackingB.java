 ...
 * String shippingPackingRowNo = entity.getShippingPackingRowNo();
 * Long oldPackingBId = entity.getOldPackingBId();
 ...
 * entity.setShippingPackingRowNo(shippingPackingRowNo);
 * entity.setOldPackingBId(oldPackingBId);
...
public abstract class BsTPackingB extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_shippingPackingRowNo));
        sb.append(dm).append(xfND(_oldPackingBId));
     ...
     * 出荷梱包明細No
     * @return The value of the column 'SHIPPING_PACKING_ROW_NO'. (NullAllowed even if selected: for no constraint)
     */
    public String getShippingPackingRowNo() {
        checkSpecifiedProperty("shippingPackingRowNo");
        return convertEmptyToNull(_shippingPackingRowNo);
    }

    /**
     * [set] SHIPPING_PACKING_ROW_NO: {VARCHAR(30)} <br>
     * 出荷梱包明細No
     * @param shippingPackingRowNo The value of the column 'SHIPPING_PACKING_ROW_NO'. (NullAllowed: null update allowed for no constraint)
     */
    public void setShippingPackingRowNo(String shippingPackingRowNo) {
        registerModifiedProperty("shippingPackingRowNo");
        _shippingPackingRowNo = shippingPackingRowNo;
    }

    /**
     * [get] OLD_PACKING_B_ID: {BIGINT(19)} <br>
     * 元梱包ボディID
     * @return The value of the column 'OLD_PACKING_B_ID'. (NullAllowed even if selected: for no constraint)
     */
    public Long getOldPackingBId() {
        checkSpecifiedProperty("oldPackingBId");
     ...
     * 元梱包ボディID
     * @param oldPackingBId The value of the column 'OLD_PACKING_B_ID'. (NullAllowed: null update allowed for no constraint)
     */
    public void setOldPackingBId(Long oldPackingBId) {
        registerModifiedProperty("oldPackingBId");
        _oldPackingBId = oldPackingBId;
    }
