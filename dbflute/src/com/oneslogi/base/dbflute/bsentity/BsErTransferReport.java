...
/**
 * The entity of er_transfer_report as TABLE. <br>
 * 振替受信テーブル
 * <pre>
 * [primary-key]
 *     TRANSFER_REPORT_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long transferReportId = entity.getTransferReportId();
 ...
 * entity.setTransferReportId(transferReportId);
 ...
 */
public abstract class BsErTransferReport extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_transferReportId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsErTransferReport) {
            BsErTransferReport other = (BsErTransferReport)obj;
            if (!xSV(_transferReportId, other._transferReportId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_transferReportId));
    ...
    @Override
    public ErTransferReport clone() {
        return (ErTransferReport)super.clone();
    }
     ...
     * 振替受信ID
     * @return The value of the column 'TRANSFER_REPORT_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getTransferReportId() {
        checkSpecifiedProperty("transferReportId");
     ...
     * 振替受信ID
     * @param transferReportId The value of the column 'TRANSFER_REPORT_ID'. (basically NotNull if update: for the constraint)
     */
    public void setTransferReportId(Long transferReportId) {
        registerModifiedProperty("transferReportId");
        _transferReportId = transferReportId;
    }
