...
/**
 * The entity of er_packing_list as TABLE. <br>
 * 梱包明細受信テーブル
 * <pre>
 * [primary-key]
 *     PACKING_LIST_ID
 ...
 */
public abstract class BsErPackingList extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsErPackingList) {
            BsErPackingList other = (BsErPackingList)obj;
    ...
    @Override
    public ErPackingList clone() {
        return (ErPackingList)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] PACKING_LIST_ID: {PK, NotNull, BIGINT(19)} <br>
     * 梱包明細受信ID
    ...
    /**
     * [set] PACKING_LIST_ID: {PK, NotNull, BIGINT(19)} <br>
     * 梱包明細受信ID
