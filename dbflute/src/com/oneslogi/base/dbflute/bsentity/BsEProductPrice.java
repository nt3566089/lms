...
/**
 * The entity of e_product_price as TABLE. <br>
 * 商品マスタ(移動平均単価)受信テーブル
 * <pre>
 * [primary-key]
 *     PRODUCT_PRICE_ID
 ...
 */
public abstract class BsEProductPrice extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEProductPrice) {
            BsEProductPrice other = (BsEProductPrice)obj;
    ...
    @Override
    public EProductPrice clone() {
        return (EProductPrice)super.clone();
    }
