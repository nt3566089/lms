...
/**
 * The entity of t_bldl350n as TABLE. <br>
 * BLDL350N
 * <pre>
 * [primary-key]
 *     BLDL350N_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl350nId = entity.getBldl350nId();
 ...
 * entity.setBldl350nId(bldl350nId);
 ...
 */
public abstract class BsTBldl350n extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl350nId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl350n) {
            BsTBldl350n other = (BsTBldl350n)obj;
            if (!xSV(_bldl350nId, other._bldl350nId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl350nId));
    ...
    @Override
    public TBldl350n clone() {
        return (TBldl350n)super.clone();
    }
     ...
     * BLDL350NID
     * @return The value of the column 'BLDL350N_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl350nId() {
        checkSpecifiedProperty("bldl350nId");
        return _bldl350nId;
    }
     ...
     * BLDL350NID
     * @param bldl350nId The value of the column 'BLDL350N_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl350nId(Long bldl350nId) {
        registerModifiedProperty("bldl350nId");
        _bldl350nId = bldl350nId;
    }
