...
/**
 * The entity of t_bldl5615 as TABLE. <br>
 * BLDL5615
 * <pre>
 * [primary-key]
 *     BLDL5615_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5615Id = entity.getBldl5615Id();
 ...
 * entity.setBldl5615Id(bldl5615Id);
 ...
 */
public abstract class BsTBldl5615 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5615Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5615) {
            BsTBldl5615 other = (BsTBldl5615)obj;
            if (!xSV(_bldl5615Id, other._bldl5615Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5615Id));
    ...
    @Override
    public TBldl5615 clone() {
        return (TBldl5615)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] BLDL5615_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5615ID
     * @return The value of the column 'BLDL5615_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5615Id() {
        checkSpecifiedProperty("bldl5615Id");
        return _bldl5615Id;
    }

    /**
     * [set] BLDL5615_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5615ID
     * @param bldl5615Id The value of the column 'BLDL5615_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5615Id(Long bldl5615Id) {
        registerModifiedProperty("bldl5615Id");
        _bldl5615Id = bldl5615Id;
    }
