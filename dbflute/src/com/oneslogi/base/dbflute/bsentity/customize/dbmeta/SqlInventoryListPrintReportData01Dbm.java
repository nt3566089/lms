...
/**
 * The DB meta of SqlInventoryListPrintReportData01. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class SqlInventoryListPrintReportData01Dbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final SqlInventoryListPrintReportData01Dbm _instance = new SqlInventoryListPrintReportData01Dbm();
    private SqlInventoryListPrintReportData01Dbm() {}
    public static SqlInventoryListPrintReportData01Dbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getInventoryBId(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setInventoryBId(ctl(vl)), "inventoryBId");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getLot(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setLot((String)vl), "lot");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getLimitDt(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setLimitDt((String)vl), "limitDt");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getChargeNum(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setChargeNum(ctb(vl)), "chargeNum");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getInventoryNum(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setInventoryNum(ctb(vl)), "inventoryNum");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getProdDt(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setProdDt((String)vl), "prodDt");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getAreaCd(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setAreaCd((String)vl), "areaCd");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getDepositCd(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setDepositCd((String)vl), "depositCd");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getCustomerCd(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setCustomerCd((String)vl), "customerCd");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getCustomerNm(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setCustomerNm((String)vl), "customerNm");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getCenterCd(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setCenterCd((String)vl), "centerCd");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getCenterAbbr(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setCenterAbbr((String)vl), "centerAbbr");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getLocationCd(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setLocationCd((String)vl), "locationCd");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getJanCd(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setJanCd((String)vl), "janCd");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getDjanCd(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setDjanCd((String)vl), "djanCd");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getProductNm(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setProductNm((String)vl), "productNm");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getSalesOrgCd(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setSalesOrgCd((String)vl), "salesOrgCd");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getTenhanshaNm1(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setTenhanshaNm1((String)vl), "tenhanshaNm1");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getTenhanshaNm2(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setTenhanshaNm2((String)vl), "tenhanshaNm2");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getUserNm(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setUserNm((String)vl), "userNm");
        setupEpg(_epgMap, et -> ((SqlInventoryListPrintReportData01)et).getScancount(), (et, vl) -> ((SqlInventoryListPrintReportData01)et).setScancount(ctl(vl)), "scancount");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "SqlInventoryListPrintReportData01";
    protected final String _tableDispName = "SqlInventoryListPrintReportData01";
    protected final String _tablePropertyName = "sqlInventoryListPrintReportData01";
    protected final TableSqlName _tableSqlName = new TableSqlName("SqlInventoryListPrintReportData01", _tableDbName);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.customize.SqlInventoryListPrintReportData01"; }
    ...
    //                                                                     Object Instance
    //                                                                     ===============
    public SqlInventoryListPrintReportData01 newEntity() { return new SqlInventoryListPrintReportData01(); }
    public SqlInventoryListPrintReportData01 newMyEntity() { return new SqlInventoryListPrintReportData01(); }

    // ===================================================================================
    //                                                                   Map Communication
    //                                                                   =================
    public void acceptPrimaryKeyMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptPrimaryKeyMap((SqlInventoryListPrintReportData01)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((SqlInventoryListPrintReportData01)et, mp); }
