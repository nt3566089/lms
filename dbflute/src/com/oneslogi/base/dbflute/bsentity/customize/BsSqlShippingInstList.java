...
public abstract class BsSqlShippingInstList extends AbstractEntity implements CustomizeEntity {
    ...
    /**
     * [get] INSPECTION_NUM: {DECIMAL(58)} <br>
    ...
    /**
     * [set] INSPECTION_NUM: {DECIMAL(58)} <br>
    ...
    /**
     * [get] LOADING_STATUS: {DECIMAL(27)} <br>
    ...
    /**
     * [set] LOADING_STATUS: {DECIMAL(27)} <br>
