...
public abstract class BsSqlShippingTagDataOutput extends AbstractEntity implements CustomizeEntity {
    ...
    //                                                                            ========
    /**
     * [get] CLIENT_ID: {BIGINT(20), refers to t_picking_h.CLIENT_ID} <br>
     * 荷主ID
    ...
    /**
     * [set] CLIENT_ID: {BIGINT(20), refers to t_picking_h.CLIENT_ID} <br>
     * 荷主ID
    ...
    /**
     * [get] SUM_PICKINGH_COUNT: {BIGINT(21)} <br>
    ...
    /**
     * [set] SUM_PICKINGH_COUNT: {BIGINT(21)} <br>
    ...
    /**
     * [get] INVOICE_CREATE_DT: {DATETIME(23)} <br>
    ...
    /**
     * [set] INVOICE_CREATE_DT: {DATETIME(23)} <br>
