...
public abstract class BsSqlShippingPlanBulkMasterData extends AbstractEntity implements CustomizeEntity {
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** SHIPPING_INST_H_ID: {BIGINT(20), refers to t_shipping_inst_h.SHIPPING_INST_H_ID} */
    ...
    /** SUPPLY_CUSTOMER_CD: {VARCHAR(30), refers to m_customer.CUSTOMER_CD} */
    protected String _supplyCustomerCd;

    /** SUPPLY_CUSTOMER_NM: {VARCHAR(60), refers to m_customer.CUSTOMER_NM} */
    protected String _supplyCustomerNm;

    /** SUPPLY_DELIVERY_FLG: {CHAR(1), refers to m_customer.DELIVERY_FLG} */
    protected String _supplyDeliveryFlg;

    /** DELIVERY_CUSTOMER_ID: {BIGINT(20), refers to m_customer.CUSTOMER_ID} */
    protected Long _deliveryCustomerId;

    /** DELIVERY_CUSTOMER_CD: {VARCHAR(30), refers to m_customer.CUSTOMER_CD} */
    protected String _deliveryCustomerCd;

    /** DELIVERY_CUSTOMER_NM: {VARCHAR(60), refers to m_customer.CUSTOMER_NM} */
    protected String _deliveryCustomerNm;

    /** DELIVERY_ZIP_CD: {VARCHAR(30), refers to m_customer.ZIP_CD} */
    protected String _deliveryZipCd;

    /** DELIVERY_TEL_NO: {VARCHAR(30), refers to m_customer.TEL_NO} */
    protected String _deliveryTelNo;

    /** DELIVERY_ADDRESS1: {VARCHAR(60), refers to m_customer.ADDRESS1} */
    protected String _deliveryAddress1;

    /** DELIVERY_ADDRESS2: {VARCHAR(60), refers to m_customer.ADDRESS2} */
    protected String _deliveryAddress2;

    /** DELIVERY_ADDRESS3: {VARCHAR(60), refers to m_customer.ADDRESS3} */
    protected String _deliveryAddress3;

    /** DELIVERY_DELIVERY_FLG: {CHAR(1), refers to m_customer.DELIVERY_FLG} */
    protected String _deliveryDeliveryFlg;

    /** DELIVERY_ONETIME_FLG: {CHAR(1), refers to m_customer.ONETIME_FLG} */
    protected String _deliveryOnetimeFlg;

    /** CLIENT_CENTER_ID: {BIGINT(20), refers to m_client_center.CLIENT_CENTER_ID} */
    protected Long _clientCenterId;

    /** MCLIENT_CENTER_CENTER_ID: {BIGINT(20), refers to m_client_center.CENTER_ID} */
    protected Long _mclientCenterCenterId;

    /** MCLIENT_CENTER_CLIENT_ID: {BIGINT(20), refers to m_client_center.CLIENT_ID} */
    protected Long _mclientCenterClientId;

    /** MCLIENT_CENTER_CUSTOMER_ID: {BIGINT(20), refers to m_client_center.CUSTOMER_ID} */
    protected Long _mclientCenterCustomerId;

    /** MCENTER_CENTER_ID: {BIGINT(20), refers to m_center.CENTER_ID} */
    protected Long _mcenterCenterId;

    /** MCUSTOMER_CC_CUSTOMER_ID: {BIGINT(20), refers to m_customer.CUSTOMER_ID} */
    protected Long _mcustomerCcCustomerId;

    /** MZIP_ZIP_ID: {BIGINT(20), refers to m_zip.ZIP_ID} */
    ...
    /** MDELIV_COURSE_CARRIER_ID: {BIGINT(20), refers to m_delivery_course.CARRIER_ID} */
    protected Long _mdelivCourseCarrierId;

    /** MCARRIER_CARRIER_CD: {VARCHAR(30), refers to m_carrier.CARRIER_CD} */
    protected String _mcarrierCarrierCd;

    /** MCARRIER_DEL_FLG: {CHAR(1), refers to m_carrier.DEL_FLG} */
    protected String _mcarrierDelFlg;

    /** DEPOSIT_CUSTOMER_ID: {BIGINT(20), refers to m_customer.CUSTOMER_ID} */
    protected Long _depositCustomerId;

    /** DEPOSIT_CUSTOMER_CD: {VARCHAR(30), refers to m_customer.CUSTOMER_CD} */
    protected String _depositCustomerCd;

    /** DEPOSIT_CUSTOMER_NM: {VARCHAR(60), refers to m_customer.CUSTOMER_NM} */
    protected String _depositCustomerNm;

    /** DEPOSIT_DEPOSIT_FLG: {CHAR(1), refers to m_customer.DEPOSIT_FLG} */
    protected String _depositDepositFlg;

    /** STOCK_TYPE_ID: {BIGINT(20), refers to m_stock_type.STOCK_TYPE_ID} */
    protected Long _stockTypeId;

    /** STOCK_TYPE_CD: {VARCHAR(30), refers to m_stock_type.STOCK_TYPE_CD} */
    protected String _stockTypeCd;

    /** MPRODUCT_PRODUCT_ID: {BIGINT(20), refers to m_product.PRODUCT_ID} */
    protected Long _mproductProductId;

    /** MPRODUCT_PRODUCT_CD: {VARCHAR(100), refers to m_product.PRODUCT_CD} */
    protected String _mproductProductCd;

    /** MPRODUCT_PRODUCT_NM: {VARCHAR(255), refers to m_product.PRODUCT_NM} */
    protected String _mproductProductNm;

    /** MS_DECIMAL_EXIST_FLG: {CHAR(1), refers to m_shape_grp.DECIMAL_EXIST_FLG} */
    protected String _msDecimalExistFlg;

    /** MW_WAREHOUSE_ID: {BIGINT(20), refers to m_warehouse.WAREHOUSE_ID} */
    protected Long _mwWarehouseId;

    /** MW_WAREHOUSE_CD: {VARCHAR(30), refers to m_warehouse.WAREHOUSE_CD} */
    protected String _mwWarehouseCd;

    /** MW_WAREHOUSE_NM: {VARCHAR(60), refers to m_warehouse.WAREHOUSE_NM} */
    protected String _mwWarehouseNm;

    /** ML_LOCATION_ID: {BIGINT(20), refers to m_location.LOCATION_ID} */
    protected Long _mlLocationId;

    /** ML_LOCATION_CD: {VARCHAR(30), refers to m_location.LOCATION_CD} */
    protected String _mlLocationCd;

    /** ML_LOCATION_NM: {VARCHAR(60), refers to m_location.LOCATION_NM} */
    protected String _mlLocationNm;

    /** MZ_MW_WAREHOUSE_ID: {BIGINT(20), refers to m_warehouse.WAREHOUSE_ID} */
    protected Long _mzMwWarehouseId;

    /** MZ_MW_WAREHOUSE_CD: {VARCHAR(30), refers to m_warehouse.WAREHOUSE_CD} */
    protected String _mzMwWarehouseCd;

    /** CENTER_CUSTOMER_ID: {BIGINT(20), refers to m_center_customer.CENTER_CUSTOMER_ID} */
    protected Long _centerCustomerId;

    /** DELIV_COURSE_ID_BY_CUSTOMER: {BIGINT(20), refers to m_center_customer.DELIVERY_COURSE_ID} */
    protected Long _delivCourseIdByCustomer;

    /** CENTER_ID: {BIGINT(20), refers to m_center_customer.CENTER_ID} */
    protected Long _centerId;

    /** DELIV_COURSE_CD_BY_CUSTOMER: {VARCHAR(30), refers to m_delivery_course.DELIVERY_COURSE_CD} */
    ...
    //                                                                            ========
    /**
     * [get] SHIPPING_INST_H_ID: {BIGINT(20), refers to t_shipping_inst_h.SHIPPING_INST_H_ID} <br>
     * 出荷指示ヘッダID
    ...
    /**
     * [set] SHIPPING_INST_H_ID: {BIGINT(20), refers to t_shipping_inst_h.SHIPPING_INST_H_ID} <br>
     * 出荷指示ヘッダID
    ...
    /**
     * [get] SUPPLY_CUSTOMER_CD: {VARCHAR(30), refers to m_customer.CUSTOMER_CD} <br>
     * 取引先CD
    ...
    /**
     * [set] SUPPLY_CUSTOMER_CD: {VARCHAR(30), refers to m_customer.CUSTOMER_CD} <br>
     * 取引先CD
    ...
    /**
     * [get] SUPPLY_CUSTOMER_NM: {VARCHAR(60), refers to m_customer.CUSTOMER_NM} <br>
     * 取引先名称
    ...
    /**
     * [set] SUPPLY_CUSTOMER_NM: {VARCHAR(60), refers to m_customer.CUSTOMER_NM} <br>
     * 取引先名称
    ...
    /**
     * [get] SUPPLY_DELIVERY_FLG: {CHAR(1), refers to m_customer.DELIVERY_FLG} <br>
     * 納品先フラグ
    ...
    /**
     * [set] SUPPLY_DELIVERY_FLG: {CHAR(1), refers to m_customer.DELIVERY_FLG} <br>
     * 納品先フラグ
    ...
    /**
     * [get] DELIVERY_CUSTOMER_ID: {BIGINT(20), refers to m_customer.CUSTOMER_ID} <br>
     * 取引先ID
    ...
    /**
     * [set] DELIVERY_CUSTOMER_ID: {BIGINT(20), refers to m_customer.CUSTOMER_ID} <br>
     * 取引先ID
    ...
    /**
     * [get] DELIVERY_CUSTOMER_CD: {VARCHAR(30), refers to m_customer.CUSTOMER_CD} <br>
     * 取引先CD
    ...
    /**
     * [set] DELIVERY_CUSTOMER_CD: {VARCHAR(30), refers to m_customer.CUSTOMER_CD} <br>
     * 取引先CD
    ...
    /**
     * [get] DELIVERY_CUSTOMER_NM: {VARCHAR(60), refers to m_customer.CUSTOMER_NM} <br>
     * 取引先名称
    ...
    /**
     * [set] DELIVERY_CUSTOMER_NM: {VARCHAR(60), refers to m_customer.CUSTOMER_NM} <br>
     * 取引先名称
    ...
    /**
     * [get] DELIVERY_ZIP_CD: {VARCHAR(30), refers to m_customer.ZIP_CD} <br>
     * 郵便番号
    ...
    /**
     * [set] DELIVERY_ZIP_CD: {VARCHAR(30), refers to m_customer.ZIP_CD} <br>
     * 郵便番号
    ...
    /**
     * [get] DELIVERY_TEL_NO: {VARCHAR(30), refers to m_customer.TEL_NO} <br>
     * 電話番号
    ...
    /**
     * [set] DELIVERY_TEL_NO: {VARCHAR(30), refers to m_customer.TEL_NO} <br>
     * 電話番号
    ...
    /**
     * [get] DELIVERY_ADDRESS1: {VARCHAR(60), refers to m_customer.ADDRESS1} <br>
     * 住所1
    ...
    /**
     * [set] DELIVERY_ADDRESS1: {VARCHAR(60), refers to m_customer.ADDRESS1} <br>
     * 住所1
    ...
    /**
     * [get] DELIVERY_ADDRESS2: {VARCHAR(60), refers to m_customer.ADDRESS2} <br>
     * 住所2
    ...
    /**
     * [set] DELIVERY_ADDRESS2: {VARCHAR(60), refers to m_customer.ADDRESS2} <br>
     * 住所2
    ...
    /**
     * [get] DELIVERY_ADDRESS3: {VARCHAR(60), refers to m_customer.ADDRESS3} <br>
     * 住所3
    ...
    /**
     * [set] DELIVERY_ADDRESS3: {VARCHAR(60), refers to m_customer.ADDRESS3} <br>
     * 住所3
    ...
    /**
     * [get] DELIVERY_DELIVERY_FLG: {CHAR(1), refers to m_customer.DELIVERY_FLG} <br>
     * 納品先フラグ
    ...
    /**
     * [set] DELIVERY_DELIVERY_FLG: {CHAR(1), refers to m_customer.DELIVERY_FLG} <br>
     * 納品先フラグ
    ...
    /**
     * [get] DELIVERY_ONETIME_FLG: {CHAR(1), refers to m_customer.ONETIME_FLG} <br>
     * ワンタイムフラグ
    ...
    /**
     * [set] DELIVERY_ONETIME_FLG: {CHAR(1), refers to m_customer.ONETIME_FLG} <br>
     * ワンタイムフラグ
    ...
    /**
     * [get] CLIENT_CENTER_ID: {BIGINT(20), refers to m_client_center.CLIENT_CENTER_ID} <br>
     * 荷主センタID
    ...
    /**
     * [set] CLIENT_CENTER_ID: {BIGINT(20), refers to m_client_center.CLIENT_CENTER_ID} <br>
     * 荷主センタID
    ...
    /**
     * [get] MCLIENT_CENTER_CENTER_ID: {BIGINT(20), refers to m_client_center.CENTER_ID} <br>
     * センタID
    ...
    /**
     * [set] MCLIENT_CENTER_CENTER_ID: {BIGINT(20), refers to m_client_center.CENTER_ID} <br>
     * センタID
    ...
    /**
     * [get] MCLIENT_CENTER_CLIENT_ID: {BIGINT(20), refers to m_client_center.CLIENT_ID} <br>
     * 荷主ID
    ...
    /**
     * [set] MCLIENT_CENTER_CLIENT_ID: {BIGINT(20), refers to m_client_center.CLIENT_ID} <br>
     * 荷主ID
    ...
    /**
     * [get] MCLIENT_CENTER_CUSTOMER_ID: {BIGINT(20), refers to m_client_center.CUSTOMER_ID} <br>
     * センタ取引先ID
    ...
    /**
     * [set] MCLIENT_CENTER_CUSTOMER_ID: {BIGINT(20), refers to m_client_center.CUSTOMER_ID} <br>
     * センタ取引先ID
    ...
    /**
     * [get] MCENTER_CENTER_ID: {BIGINT(20), refers to m_center.CENTER_ID} <br>
     * センタID
    ...
    /**
     * [set] MCENTER_CENTER_ID: {BIGINT(20), refers to m_center.CENTER_ID} <br>
     * センタID
    ...
    /**
     * [get] MCUSTOMER_CC_CUSTOMER_ID: {BIGINT(20), refers to m_customer.CUSTOMER_ID} <br>
     * 取引先ID
    ...
    /**
     * [set] MCUSTOMER_CC_CUSTOMER_ID: {BIGINT(20), refers to m_customer.CUSTOMER_ID} <br>
     * 取引先ID
    ...
    /**
     * [get] MZIP_ZIP_ID: {BIGINT(20), refers to m_zip.ZIP_ID} <br>
     * 郵便番号ID
    ...
    /**
     * [set] MZIP_ZIP_ID: {BIGINT(20), refers to m_zip.ZIP_ID} <br>
     * 郵便番号ID
    ...
    /**
     * [get] MDELIV_COURSE_CARRIER_ID: {BIGINT(20), refers to m_delivery_course.CARRIER_ID} <br>
     * 運送業者ID
    ...
    /**
     * [set] MDELIV_COURSE_CARRIER_ID: {BIGINT(20), refers to m_delivery_course.CARRIER_ID} <br>
     * 運送業者ID
    ...
    /**
     * [get] MCARRIER_CARRIER_CD: {VARCHAR(30), refers to m_carrier.CARRIER_CD} <br>
     * 運送業者CD
    ...
    /**
     * [set] MCARRIER_CARRIER_CD: {VARCHAR(30), refers to m_carrier.CARRIER_CD} <br>
     * 運送業者CD
    ...
    /**
     * [get] MCARRIER_DEL_FLG: {CHAR(1), refers to m_carrier.DEL_FLG} <br>
     * 削除フラグ
    ...
    /**
     * [set] MCARRIER_DEL_FLG: {CHAR(1), refers to m_carrier.DEL_FLG} <br>
     * 削除フラグ
    ...
    /**
     * [get] DEPOSIT_CUSTOMER_ID: {BIGINT(20), refers to m_customer.CUSTOMER_ID} <br>
     * 取引先ID
    ...
    /**
     * [set] DEPOSIT_CUSTOMER_ID: {BIGINT(20), refers to m_customer.CUSTOMER_ID} <br>
     * 取引先ID
    ...
    /**
     * [get] DEPOSIT_CUSTOMER_CD: {VARCHAR(30), refers to m_customer.CUSTOMER_CD} <br>
     * 取引先CD
    ...
    /**
     * [set] DEPOSIT_CUSTOMER_CD: {VARCHAR(30), refers to m_customer.CUSTOMER_CD} <br>
     * 取引先CD
    ...
    /**
     * [get] DEPOSIT_CUSTOMER_NM: {VARCHAR(60), refers to m_customer.CUSTOMER_NM} <br>
     * 取引先名称
    ...
    /**
     * [set] DEPOSIT_CUSTOMER_NM: {VARCHAR(60), refers to m_customer.CUSTOMER_NM} <br>
     * 取引先名称
    ...
    /**
     * [get] DEPOSIT_DEPOSIT_FLG: {CHAR(1), refers to m_customer.DEPOSIT_FLG} <br>
     * 預託先フラグ
    ...
    /**
     * [set] DEPOSIT_DEPOSIT_FLG: {CHAR(1), refers to m_customer.DEPOSIT_FLG} <br>
     * 預託先フラグ
    ...
    /**
     * [get] STOCK_TYPE_ID: {BIGINT(20), refers to m_stock_type.STOCK_TYPE_ID} <br>
     * 在庫区分ID
    ...
    /**
     * [set] STOCK_TYPE_ID: {BIGINT(20), refers to m_stock_type.STOCK_TYPE_ID} <br>
     * 在庫区分ID
    ...
    /**
     * [get] MPRODUCT_PRODUCT_ID: {BIGINT(20), refers to m_product.PRODUCT_ID} <br>
     * 商品ID
    ...
    /**
     * [set] MPRODUCT_PRODUCT_ID: {BIGINT(20), refers to m_product.PRODUCT_ID} <br>
     * 商品ID
    ...
    /**
     * [get] MPRODUCT_PRODUCT_CD: {VARCHAR(100), refers to m_product.PRODUCT_CD} <br>
     * 商品CD
    ...
    /**
     * [set] MPRODUCT_PRODUCT_CD: {VARCHAR(100), refers to m_product.PRODUCT_CD} <br>
     * 商品CD
    ...
    /**
     * [get] MPRODUCT_PRODUCT_NM: {VARCHAR(255), refers to m_product.PRODUCT_NM} <br>
     * 商品名称
    ...
    /**
     * [set] MPRODUCT_PRODUCT_NM: {VARCHAR(255), refers to m_product.PRODUCT_NM} <br>
     * 商品名称
    ...
    /**
     * [get] MS_DECIMAL_EXIST_FLG: {CHAR(1), refers to m_shape_grp.DECIMAL_EXIST_FLG} <br>
     * 小数有無フラグ
    ...
    /**
     * [set] MS_DECIMAL_EXIST_FLG: {CHAR(1), refers to m_shape_grp.DECIMAL_EXIST_FLG} <br>
     * 小数有無フラグ
    ...
    /**
     * [get] MW_WAREHOUSE_ID: {BIGINT(20), refers to m_warehouse.WAREHOUSE_ID} <br>
     * 倉庫ID
    ...
    /**
     * [set] MW_WAREHOUSE_ID: {BIGINT(20), refers to m_warehouse.WAREHOUSE_ID} <br>
     * 倉庫ID
    ...
    /**
     * [get] MW_WAREHOUSE_CD: {VARCHAR(30), refers to m_warehouse.WAREHOUSE_CD} <br>
     * 倉庫CD
    ...
    /**
     * [set] MW_WAREHOUSE_CD: {VARCHAR(30), refers to m_warehouse.WAREHOUSE_CD} <br>
     * 倉庫CD
    ...
    /**
     * [get] MW_WAREHOUSE_NM: {VARCHAR(60), refers to m_warehouse.WAREHOUSE_NM} <br>
     * 倉庫名称
    ...
    /**
     * [set] MW_WAREHOUSE_NM: {VARCHAR(60), refers to m_warehouse.WAREHOUSE_NM} <br>
     * 倉庫名称
    ...
    /**
     * [get] ML_LOCATION_ID: {BIGINT(20), refers to m_location.LOCATION_ID} <br>
     * ロケーションID
    ...
    /**
     * [set] ML_LOCATION_ID: {BIGINT(20), refers to m_location.LOCATION_ID} <br>
     * ロケーションID
    ...
    /**
     * [get] ML_LOCATION_CD: {VARCHAR(30), refers to m_location.LOCATION_CD} <br>
     * ロケーションCD
    ...
    /**
     * [set] ML_LOCATION_CD: {VARCHAR(30), refers to m_location.LOCATION_CD} <br>
     * ロケーションCD
    ...
    /**
     * [get] ML_LOCATION_NM: {VARCHAR(60), refers to m_location.LOCATION_NM} <br>
     * ロケーション名称
    ...
    /**
     * [set] ML_LOCATION_NM: {VARCHAR(60), refers to m_location.LOCATION_NM} <br>
     * ロケーション名称
    ...
    /**
     * [get] MZ_MW_WAREHOUSE_ID: {BIGINT(20), refers to m_warehouse.WAREHOUSE_ID} <br>
     * 倉庫ID
    ...
    /**
     * [set] MZ_MW_WAREHOUSE_ID: {BIGINT(20), refers to m_warehouse.WAREHOUSE_ID} <br>
     * 倉庫ID
    ...
    /**
     * [get] MZ_MW_WAREHOUSE_CD: {VARCHAR(30), refers to m_warehouse.WAREHOUSE_CD} <br>
     * 倉庫CD
    ...
    /**
     * [set] MZ_MW_WAREHOUSE_CD: {VARCHAR(30), refers to m_warehouse.WAREHOUSE_CD} <br>
     * 倉庫CD
    ...
    /**
     * [get] CENTER_CUSTOMER_ID: {BIGINT(20), refers to m_center_customer.CENTER_CUSTOMER_ID} <br>
     * センタ取引先ID
    ...
    /**
     * [set] CENTER_CUSTOMER_ID: {BIGINT(20), refers to m_center_customer.CENTER_CUSTOMER_ID} <br>
     * センタ取引先ID
    ...
    /**
     * [get] DELIV_COURSE_ID_BY_CUSTOMER: {BIGINT(20), refers to m_center_customer.DELIVERY_COURSE_ID} <br>
     * 配送コースID
    ...
    /**
     * [set] DELIV_COURSE_ID_BY_CUSTOMER: {BIGINT(20), refers to m_center_customer.DELIVERY_COURSE_ID} <br>
     * 配送コースID
    ...
    /**
     * [get] CENTER_ID: {BIGINT(20), refers to m_center_customer.CENTER_ID} <br>
     * センタID
    ...
    /**
     * [set] CENTER_ID: {BIGINT(20), refers to m_center_customer.CENTER_ID} <br>
     * センタID
    ...
    /**
     * [get] DELIV_COURSE_CD_BY_CUSTOMER: {VARCHAR(30), refers to m_delivery_course.DELIVERY_COURSE_CD} <br>
     * 配送コースCD
    ...
    /**
     * [set] DELIV_COURSE_CD_BY_CUSTOMER: {VARCHAR(30), refers to m_delivery_course.DELIVERY_COURSE_CD} <br>
     * 配送コースCD
