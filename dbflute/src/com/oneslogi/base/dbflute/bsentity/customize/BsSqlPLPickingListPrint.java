...
public abstract class BsSqlPLPickingListPrint extends AbstractEntity implements CustomizeEntity {
     ...
     * PL_OUT_FLG: {CHAR(1), refers to t_picking_r.PL_OUT_FLG, classification=ListOutFlg} <br>
     * リスト発行フラグ
     * <p>It's treated as case insensitive and if the code value is null, it returns null.</p>
     * @return The instance of classification definition (as ENUM type). (NullAllowed: when the column value is null)
     */
    ...
    /**
     * [get] SEEDING_NO: {VARCHAR(30), refers to t_packing_h.SEEDING_NO} <br>
     * 種蒔きNo.
    ...
    /**
     * [set] SEEDING_NO: {VARCHAR(30), refers to t_packing_h.SEEDING_NO} <br>
     * 種蒔きNo.
