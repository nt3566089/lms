 ...
 * java.math.BigDecimal shippingSlipNo = entity.getShippingSlipNo();
 * java.math.BigDecimal num = entity.getNum();
 * Long tsihNum = entity.getTsihNum();
 * java.math.BigDecimal countProductCd = entity.getCountProductCd();
 * java.math.BigDecimal instNum = entity.getInstNum();
 * java.math.BigDecimal allocNum = entity.getAllocNum();
 * java.math.BigDecimal countShippingPackingNo = entity.getCountShippingPackingNo();
 * java.math.BigDecimal sumGrossWeight = entity.getSumGrossWeight();
 * java.math.BigDecimal picListStatus1 = entity.getPicListStatus1();
 * java.math.BigDecimal picListStatus2 = entity.getPicListStatus2();
 * java.math.BigDecimal chkStatus = entity.getChkStatus();
 * java.math.BigDecimal invoiceCreate = entity.getInvoiceCreate();
 * java.math.BigDecimal packingOut = entity.getPackingOut();
 * java.math.BigDecimal loadingStatus = entity.getLoadingStatus();
 * java.math.BigDecimal shippingFixed = entity.getShippingFixed();
...
public abstract class BsSqlDeliveryCourseShippingList extends AbstractEntity implements CustomizeEntity {
    ...
    protected java.math.BigDecimal _shippingSlipNo;
    ...
    protected java.math.BigDecimal _countProductCd;
    ...
    protected java.math.BigDecimal _countShippingPackingNo;

    /** SUM_GROSS_WEIGHT: {DECIMAL(58, 4)} */
    protected java.math.BigDecimal _sumGrossWeight;

    /** PIC_LIST_STATUS1: {DECIMAL(27)} */
    protected java.math.BigDecimal _picListStatus1;

    /** PIC_LIST_STATUS2: {DECIMAL(27)} */
    protected java.math.BigDecimal _picListStatus2;

    /** CHK_STATUS: {DECIMAL(27)} */
    protected java.math.BigDecimal _chkStatus;

    /** INVOICE_CREATE: {DECIMAL(27)} */
    protected java.math.BigDecimal _invoiceCreate;

    /** PACKING_OUT: {DECIMAL(27)} */
    protected java.math.BigDecimal _packingOut;

    /** LOADING_STATUS: {DECIMAL(49)} */
    protected java.math.BigDecimal _loadingStatus;

    /** SHIPPING_FIXED: {DECIMAL(27)} */
    protected java.math.BigDecimal _shippingFixed;
    ...
    /**
     * Set the value of shippingStatus as $60 (60). <br>
     * $60: 承認待ち
     */
    public void setShippingStatus_$60() {
        setShippingStatusAsShippingStatus(CDef.ShippingStatus.$60);
    }
    ...
    /**
     * Set the value of shippingStatusMax as $60 (60). <br>
     * $60: 承認待ち
     */
    public void setShippingStatusMax_$60() {
        setShippingStatusMaxAsShippingStatus(CDef.ShippingStatus.$60);
    }
    ...
    /**
     * Is the value of shippingStatus $60? <br>
     * $60: 承認待ち
     * <p>It's treated as case insensitive and if the code value is null, it returns false.</p>
     * @return The determination, true or false.
     */
    public boolean isShippingStatus$60() {
        CDef.ShippingStatus cdef = getShippingStatusAsShippingStatus();
        return cdef != null ? cdef.equals(CDef.ShippingStatus.$60) : false;
    }
    ...
    /**
     * Is the value of shippingStatusMax $60? <br>
     * $60: 承認待ち
     * <p>It's treated as case insensitive and if the code value is null, it returns false.</p>
     * @return The determination, true or false.
     */
    public boolean isShippingStatusMax$60() {
        CDef.ShippingStatus cdef = getShippingStatusMaxAsShippingStatus();
        return cdef != null ? cdef.equals(CDef.ShippingStatus.$60) : false;
    }
    ...
    /**
     * [get] COUNT_SUPPLY_CUSTOMER_CD: {BIGINT(21)} <br>
    ...
    /**
     * [set] COUNT_SUPPLY_CUSTOMER_CD: {BIGINT(21)} <br>
     ...
     */
    public void setCountShippingPackingNo(java.math.BigDecimal countShippingPackingNo) {
        registerModifiedProperty("countShippingPackingNo");
        _countShippingPackingNo = countShippingPackingNo;
    }

    /**
     * [get] SUM_GROSS_WEIGHT: {DECIMAL(58, 4)} <br>
    ...
    /**
     * [set] SUM_GROSS_WEIGHT: {DECIMAL(58, 4)} <br>
