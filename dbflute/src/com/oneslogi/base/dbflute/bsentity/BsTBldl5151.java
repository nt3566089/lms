...
/**
 * The entity of t_bldl5151 as TABLE. <br>
 * BLDL5151
 * <pre>
 * [primary-key]
 *     BLDL5151_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5151Id = entity.getBldl5151Id();
 ...
 * Long fwRcvCnt = entity.getFwRcvCnt();
 * Long fwRcvNum = entity.getFwRcvNum();
 * Long fwCaseNum = entity.getFwCaseNum();
 * Long unRcvCnt = entity.getUnRcvCnt();
 * Long unRcvNum = entity.getUnRcvNum();
 * Long unCaseNum = entity.getUnCaseNum();
 * Long shRcvCnt = entity.getShRcvCnt();
 * Long shRcvNum = entity.getShRcvNum();
 * Long shCaseNum = entity.getShCaseNum();
 * Long hmRcvCnt = entity.getHmRcvCnt();
 * Long hmRcvNum = entity.getHmRcvNum();
 * Long hmCaseNum = entity.getHmCaseNum();
 * Long totalRcvNum = entity.getTotalRcvNum();
 ...
 * entity.setBldl5151Id(bldl5151Id);
 * entity.setYearmonth(yearmonth);
 * entity.setBaseNm(baseNm);
 * entity.setMonth(month);
 * entity.setRowNo(rowNo);
 * entity.setReceiveDt(receiveDt);
 * entity.setFwRcvCnt(fwRcvCnt);
 * entity.setFwRcvNum(fwRcvNum);
 * entity.setFwCaseNum(fwCaseNum);
 * entity.setUnRcvCnt(unRcvCnt);
 * entity.setUnRcvNum(unRcvNum);
 * entity.setUnCaseNum(unCaseNum);
 * entity.setShRcvCnt(shRcvCnt);
 * entity.setShRcvNum(shRcvNum);
 * entity.setShCaseNum(shCaseNum);
 * entity.setHmRcvCnt(hmRcvCnt);
 * entity.setHmRcvNum(hmRcvNum);
 * entity.setHmCaseNum(hmCaseNum);
 * entity.setTotalRcvNum(totalRcvNum);
 ...
 */
public abstract class BsTBldl5151 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5151Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5151) {
            BsTBldl5151 other = (BsTBldl5151)obj;
            if (!xSV(_bldl5151Id, other._bldl5151Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5151Id));
        ...
        sb.append(dm).append(xfND(_fwRcvCnt));
        sb.append(dm).append(xfND(_fwRcvNum));
        sb.append(dm).append(xfND(_fwCaseNum));
        sb.append(dm).append(xfND(_unRcvCnt));
        sb.append(dm).append(xfND(_unRcvNum));
        sb.append(dm).append(xfND(_unCaseNum));
        sb.append(dm).append(xfND(_shRcvCnt));
        sb.append(dm).append(xfND(_shRcvNum));
        sb.append(dm).append(xfND(_shCaseNum));
        sb.append(dm).append(xfND(_hmRcvCnt));
        sb.append(dm).append(xfND(_hmRcvNum));
        sb.append(dm).append(xfND(_hmCaseNum));
        sb.append(dm).append(xfND(_totalRcvNum));
    ...
    @Override
    public TBldl5151 clone() {
        return (TBldl5151)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] BLDL5151_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5151ID
     * @return The value of the column 'BLDL5151_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5151Id() {
        checkSpecifiedProperty("bldl5151Id");
        return _bldl5151Id;
    }

    /**
     * [set] BLDL5151_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5151ID
     * @param bldl5151Id The value of the column 'BLDL5151_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5151Id(Long bldl5151Id) {
        registerModifiedProperty("bldl5151Id");
        _bldl5151Id = bldl5151Id;
    }
     ...
     * FW_入荷件数
     * @return The value of the column 'FW_RCV_CNT'. (NullAllowed even if selected: for no constraint)
     */
    public Long getFwRcvCnt() {
        checkSpecifiedProperty("fwRcvCnt");
        return _fwRcvCnt;
    }
     ...
     * FW_入荷件数
     * @param fwRcvCnt The value of the column 'FW_RCV_CNT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setFwRcvCnt(Long fwRcvCnt) {
        registerModifiedProperty("fwRcvCnt");
        _fwRcvCnt = fwRcvCnt;
    }
     ...
     * FW_入荷数量
     * @return The value of the column 'FW_RCV_NUM'. (NullAllowed even if selected: for no constraint)
     */
    public Long getFwRcvNum() {
        checkSpecifiedProperty("fwRcvNum");
        return _fwRcvNum;
    }
     ...
     * FW_入荷数量
     * @param fwRcvNum The value of the column 'FW_RCV_NUM'. (NullAllowed: null update allowed for no constraint)
     */
    public void setFwRcvNum(Long fwRcvNum) {
        registerModifiedProperty("fwRcvNum");
        _fwRcvNum = fwRcvNum;
    }
     ...
     * UN_入荷件数
     * @return The value of the column 'UN_RCV_CNT'. (NullAllowed even if selected: for no constraint)
     */
    public Long getUnRcvCnt() {
        checkSpecifiedProperty("unRcvCnt");
        return _unRcvCnt;
    }
     ...
     * UN_入荷件数
     * @param unRcvCnt The value of the column 'UN_RCV_CNT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setUnRcvCnt(Long unRcvCnt) {
        registerModifiedProperty("unRcvCnt");
        _unRcvCnt = unRcvCnt;
    }
     ...
     * UN_入荷数量
     * @return The value of the column 'UN_RCV_NUM'. (NullAllowed even if selected: for no constraint)
     */
    public Long getUnRcvNum() {
        checkSpecifiedProperty("unRcvNum");
        return _unRcvNum;
    }
     ...
     * UN_入荷数量
     * @param unRcvNum The value of the column 'UN_RCV_NUM'. (NullAllowed: null update allowed for no constraint)
     */
    public void setUnRcvNum(Long unRcvNum) {
        registerModifiedProperty("unRcvNum");
        _unRcvNum = unRcvNum;
    }
     ...
     * SH_入荷件数
     * @return The value of the column 'SH_RCV_CNT'. (NullAllowed even if selected: for no constraint)
     */
    public Long getShRcvCnt() {
        checkSpecifiedProperty("shRcvCnt");
        return _shRcvCnt;
    }
     ...
     * SH_入荷件数
     * @param shRcvCnt The value of the column 'SH_RCV_CNT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setShRcvCnt(Long shRcvCnt) {
        registerModifiedProperty("shRcvCnt");
        _shRcvCnt = shRcvCnt;
    }
     ...
     * SH_入荷数量
     * @return The value of the column 'SH_RCV_NUM'. (NullAllowed even if selected: for no constraint)
     */
    public Long getShRcvNum() {
        checkSpecifiedProperty("shRcvNum");
        return _shRcvNum;
    }
     ...
     * SH_入荷数量
     * @param shRcvNum The value of the column 'SH_RCV_NUM'. (NullAllowed: null update allowed for no constraint)
     */
    public void setShRcvNum(Long shRcvNum) {
        registerModifiedProperty("shRcvNum");
        _shRcvNum = shRcvNum;
    }
     ...
     * HM_入荷件数
     * @return The value of the column 'HM_RCV_CNT'. (NullAllowed even if selected: for no constraint)
     */
    public Long getHmRcvCnt() {
        checkSpecifiedProperty("hmRcvCnt");
        return _hmRcvCnt;
    }
     ...
     * HM_入荷件数
     * @param hmRcvCnt The value of the column 'HM_RCV_CNT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setHmRcvCnt(Long hmRcvCnt) {
        registerModifiedProperty("hmRcvCnt");
        _hmRcvCnt = hmRcvCnt;
    }
     ...
     * HM_入荷数量
     * @return The value of the column 'HM_RCV_NUM'. (NullAllowed even if selected: for no constraint)
     */
    public Long getHmRcvNum() {
        checkSpecifiedProperty("hmRcvNum");
        return _hmRcvNum;
    }
     ...
     * HM_入荷数量
     * @param hmRcvNum The value of the column 'HM_RCV_NUM'. (NullAllowed: null update allowed for no constraint)
     */
    public void setHmRcvNum(Long hmRcvNum) {
        registerModifiedProperty("hmRcvNum");
        _hmRcvNum = hmRcvNum;
    }
     ...
     * 当日合計_入荷数
     * @return The value of the column 'TOTAL_RCV_NUM'. (NullAllowed even if selected: for no constraint)
     */
    public Long getTotalRcvNum() {
        checkSpecifiedProperty("totalRcvNum");
        return _totalRcvNum;
    }
     ...
     * 当日合計_入荷数
     * @param totalRcvNum The value of the column 'TOTAL_RCV_NUM'. (NullAllowed: null update allowed for no constraint)
     */
    public void setTotalRcvNum(Long totalRcvNum) {
        registerModifiedProperty("totalRcvNum");
        _totalRcvNum = totalRcvNum;
    }
