...
/**
 * The entity of er_ajis_inventory_report as TABLE. <br>
 * エイジス棚卸実績取込受信テーブル
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long ajisInventoryReportId = entity.getAjisInventoryReportId();
 ...
 * String inventoryNum = entity.getInventoryNum();
 ...
 * entity.setAjisInventoryReportId(ajisInventoryReportId);
 ...
 */
public abstract class BsErAjisInventoryReport extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected Long _ajisInventoryReportId;
    ...
    protected String _inventoryNum;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_ajisInventoryReportId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsErAjisInventoryReport) {
            BsErAjisInventoryReport other = (BsErAjisInventoryReport)obj;
            if (!xSV(_ajisInventoryReportId, other._ajisInventoryReportId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _ajisInventoryReportId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_ajisInventoryReportId));
    ...
    @Override
    public ErAjisInventoryReport clone() {
        return (ErAjisInventoryReport)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] AJIS_INVENTORY_REPORT_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * エイジス棚卸実績取込受信ID
     * @return The value of the column 'AJIS_INVENTORY_REPORT_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getAjisInventoryReportId() {
        checkSpecifiedProperty("ajisInventoryReportId");
        return _ajisInventoryReportId;
    }

    /**
     * [set] AJIS_INVENTORY_REPORT_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * エイジス棚卸実績取込受信ID
     * @param ajisInventoryReportId The value of the column 'AJIS_INVENTORY_REPORT_ID'. (basically NotNull if update: for the constraint)
     */
    public void setAjisInventoryReportId(Long ajisInventoryReportId) {
        registerModifiedProperty("ajisInventoryReportId");
        _ajisInventoryReportId = ajisInventoryReportId;
    }
    ...
    /**
     * [get] INVENTORY_NUM: {VARCHAR(30)} <br>
     * 棚卸数
    ...
    public String getInventoryNum() {
        ...
        return convertEmptyToNull(_inventoryNum);
    }

    /**
     * [set] INVENTORY_NUM: {VARCHAR(30)} <br>
     * 棚卸数
