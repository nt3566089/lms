...
public abstract class BsPPrintRequestHist extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] PRINT_REQUEST_HIST_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 印刷履歴ID
    ...
    /**
     * [set] PRINT_REQUEST_HIST_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 印刷履歴ID
    ...
    /**
     * [get] PROCESS_INFO: {LONGTEXT(2147483647)} <br>
     * 処理情報
    ...
    /**
     * [set] PROCESS_INFO: {LONGTEXT(2147483647)} <br>
     * 処理情報
    ...
    /**
     * [get] QUEUE_ADD_DT: {NotNull, DATETIME(19)} <br>
     * キュー登録日時
    ...
    /**
     * [set] QUEUE_ADD_DT: {NotNull, DATETIME(19)} <br>
     * キュー登録日時
    ...
    /**
     * [get] PRINT_DT: {NotNull, DATETIME(19)} <br>
     * 印刷日時
    ...
    /**
     * [set] PRINT_DT: {NotNull, DATETIME(19)} <br>
     * 印刷日時
