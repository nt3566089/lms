...
public abstract class BsBUserAuth extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    /**
     * [get] PASSWORD_MODIFIED_DATE: {DATETIME(19)} <br>
     * パスワード変更日時
    ...
    /**
     * [set] PASSWORD_MODIFIED_DATE: {DATETIME(19)} <br>
     * パスワード変更日時
    ...
    /**
     * [get] LAST_LOGIN_DATE: {DATETIME(19)} <br>
     * 最終ログイン日時
    ...
    /**
     * [set] LAST_LOGIN_DATE: {DATETIME(19)} <br>
     * 最終ログイン日時
    ...
    /**
     * [get] LAST_FAILED_LOGIN_DATE: {DATETIME(19)} <br>
     * 最終ログイン失敗日時
    ...
    /**
     * [set] LAST_FAILED_LOGIN_DATE: {DATETIME(19)} <br>
     * 最終ログイン失敗日時
    ...
    /**
     * [get] LOCKOUT_DATE: {DATETIME(19)} <br>
     * ロックアウト日時
    ...
    /**
     * [set] LOCKOUT_DATE: {DATETIME(19)} <br>
     * ロックアウト日時
    ...
    /**
     * [get] AVAILABLE_START_DATE: {NotNull, DATETIME(19)} <br>
     * 利用可能開始日
    ...
    /**
     * [set] AVAILABLE_START_DATE: {NotNull, DATETIME(19)} <br>
     * 利用可能開始日
    ...
    /**
     * [get] AVAILABLE_END_DATE: {NotNull, DATETIME(19)} <br>
     * 利用可能終了日
    ...
    /**
     * [set] AVAILABLE_END_DATE: {NotNull, DATETIME(19)} <br>
     * 利用可能終了日
