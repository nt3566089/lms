 ...
 *
 * [column]
 *     PICKING_H_ID, CLIENT_ID, CENTER_ID, PROCESS_TYPE_ID, PICKING_STATUS, DELIV_UNIT_NO, PICKING_WORK_NO, ALLOC_INST_H_ID, FORCE_FIXED_FLG, PICKING_GROUP_NO, SGL_ROW_PIC_FLG, SHIPPING_FIXED_DT, CENTER_TRANSIT_FLG, PACKING_CAL_CLS, BOL_NO, NIZOROE_NO, DAIHYO_NIZOROE_NO, NIZOROE_NO2, DAIHYO_NIZOROE_NO2, PICK_FORCE_COPLETE_FLG, INSP_FORCE_COPLETE_FLG, PRINT_STATUS, NIZOROE_PRINT_TYPE_CD, DELIV_PRINT_TYPE_CD, TAG_PRINT_TYPE_CD, INTEG_PRINT_FLG, ID_MANAG_PRINT_TYPE_CD, PLL_PRINT_FLG, DEL_FLG, VERSION_NO, CONTROL_NO, ADD_DT, ADD_USER, ADD_PROCESS, UPD_DT, UPD_USER, UPD_PROCESS
 *
 * [sequence]
 *     
 *
 ...
 * String pickForceCopleteFlg = entity.getPickForceCopleteFlg();
 * String inspForceCopleteFlg = entity.getInspForceCopleteFlg();
 * String printStatus = entity.getPrintStatus();
 * String nizoroePrintTypeCd = entity.getNizoroePrintTypeCd();
 * String delivPrintTypeCd = entity.getDelivPrintTypeCd();
 * String tagPrintTypeCd = entity.getTagPrintTypeCd();
 * String integPrintFlg = entity.getIntegPrintFlg();
 * String idManagPrintTypeCd = entity.getIdManagPrintTypeCd();
 * String pllPrintFlg = entity.getPllPrintFlg();
 ...
 * entity.setPickForceCopleteFlg(pickForceCopleteFlg);
 * entity.setInspForceCopleteFlg(inspForceCopleteFlg);
 * entity.setPrintStatus(printStatus);
 * entity.setNizoroePrintTypeCd(nizoroePrintTypeCd);
 * entity.setDelivPrintTypeCd(delivPrintTypeCd);
 * entity.setTagPrintTypeCd(tagPrintTypeCd);
 * entity.setIntegPrintFlg(integPrintFlg);
 * entity.setIdManagPrintTypeCd(idManagPrintTypeCd);
 * entity.setPllPrintFlg(pllPrintFlg);
...
public abstract class BsTPickingH extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    /**
     * Set the value of pickingStatus as $60 (60). <br>
     * $60: 承認待ち
     */
    public void setPickingStatus_$60() {
        setPickingStatusAsPickingStatus(CDef.PickingStatus.$60);
    }
    ...
    /**
     * Is the value of pickingStatus $60? <br>
     * $60: 承認待ち
     * <p>It's treated as case insensitive and if the code value is null, it returns false.</p>
     * @return The determination, true or false.
     */
    public boolean isPickingStatus$60() {
        CDef.PickingStatus cdef = getPickingStatusAsPickingStatus();
        return cdef != null ? cdef.equals(CDef.PickingStatus.$60) : false;
    }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_pickForceCopleteFlg));
        sb.append(dm).append(xfND(_inspForceCopleteFlg));
        sb.append(dm).append(xfND(_printStatus));
        sb.append(dm).append(xfND(_nizoroePrintTypeCd));
        sb.append(dm).append(xfND(_delivPrintTypeCd));
        sb.append(dm).append(xfND(_tagPrintTypeCd));
        sb.append(dm).append(xfND(_integPrintFlg));
        sb.append(dm).append(xfND(_idManagPrintTypeCd));
        sb.append(dm).append(xfND(_pllPrintFlg));
     ...
     * ピッキング強制完了フラグ
     * @return The value of the column 'PICK_FORCE_COPLETE_FLG'. (NullAllowed even if selected: for no constraint)
     */
    public String getPickForceCopleteFlg() {
        checkSpecifiedProperty("pickForceCopleteFlg");
        return convertEmptyToNull(_pickForceCopleteFlg);
    }

    /**
     * [set] PICK_FORCE_COPLETE_FLG: {CHAR(1), default=[0]} <br>
     * ピッキング強制完了フラグ
     * @param pickForceCopleteFlg The value of the column 'PICK_FORCE_COPLETE_FLG'. (NullAllowed: null update allowed for no constraint)
     */
    public void setPickForceCopleteFlg(String pickForceCopleteFlg) {
        registerModifiedProperty("pickForceCopleteFlg");
        _pickForceCopleteFlg = pickForceCopleteFlg;
    }

    /**
     * [get] INSP_FORCE_COPLETE_FLG: {CHAR(1), default=[0]} <br>
     * 出荷検品強制完了フラグ
     * @return The value of the column 'INSP_FORCE_COPLETE_FLG'. (NullAllowed even if selected: for no constraint)
     */
    public String getInspForceCopleteFlg() {
        checkSpecifiedProperty("inspForceCopleteFlg");
        return convertEmptyToNull(_inspForceCopleteFlg);
    }

    /**
     * [set] INSP_FORCE_COPLETE_FLG: {CHAR(1), default=[0]} <br>
     * 出荷検品強制完了フラグ
     * @param inspForceCopleteFlg The value of the column 'INSP_FORCE_COPLETE_FLG'. (NullAllowed: null update allowed for no constraint)
     */
    public void setInspForceCopleteFlg(String inspForceCopleteFlg) {
        registerModifiedProperty("inspForceCopleteFlg");
        _inspForceCopleteFlg = inspForceCopleteFlg;
    }

    /**
     * [get] PRINT_STATUS: {VARCHAR(30)} <br>
     * 発行状況
     * @return The value of the column 'PRINT_STATUS'. (NullAllowed even if selected: for no constraint)
     */
     ...
     * 発行状況
     * @param printStatus The value of the column 'PRINT_STATUS'. (NullAllowed: null update allowed for no constraint)
     */
     ...
     * 荷揃表印刷区分
     * @return The value of the column 'NIZOROE_PRINT_TYPE_CD'. (NullAllowed even if selected: for no constraint)
     */
    public String getNizoroePrintTypeCd() {
        checkSpecifiedProperty("nizoroePrintTypeCd");
        return convertEmptyToNull(_nizoroePrintTypeCd);
    }

    /**
     * [set] NIZOROE_PRINT_TYPE_CD: {VARCHAR(30)} <br>
     * 荷揃表印刷区分
     * @param nizoroePrintTypeCd The value of the column 'NIZOROE_PRINT_TYPE_CD'. (NullAllowed: null update allowed for no constraint)
     */
    public void setNizoroePrintTypeCd(String nizoroePrintTypeCd) {
        registerModifiedProperty("nizoroePrintTypeCd");
        _nizoroePrintTypeCd = nizoroePrintTypeCd;
    }

    /**
     * [get] DELIV_PRINT_TYPE_CD: {VARCHAR(30)} <br>
     * 納品書印刷区分
     * @return The value of the column 'DELIV_PRINT_TYPE_CD'. (NullAllowed even if selected: for no constraint)
     */
    public String getDelivPrintTypeCd() {
        checkSpecifiedProperty("delivPrintTypeCd");
        return convertEmptyToNull(_delivPrintTypeCd);
    }

    /**
     * [set] DELIV_PRINT_TYPE_CD: {VARCHAR(30)} <br>
     * 納品書印刷区分
     * @param delivPrintTypeCd The value of the column 'DELIV_PRINT_TYPE_CD'. (NullAllowed: null update allowed for no constraint)
     */
    public void setDelivPrintTypeCd(String delivPrintTypeCd) {
        registerModifiedProperty("delivPrintTypeCd");
        _delivPrintTypeCd = delivPrintTypeCd;
    }

    /**
     * [get] TAG_PRINT_TYPE_CD: {VARCHAR(30)} <br>
     * 荷札印刷区分
     * @return The value of the column 'TAG_PRINT_TYPE_CD'. (NullAllowed even if selected: for no constraint)
     */
    public String getTagPrintTypeCd() {
        checkSpecifiedProperty("tagPrintTypeCd");
        return convertEmptyToNull(_tagPrintTypeCd);
    }

    /**
     * [set] TAG_PRINT_TYPE_CD: {VARCHAR(30)} <br>
     * 荷札印刷区分
     * @param tagPrintTypeCd The value of the column 'TAG_PRINT_TYPE_CD'. (NullAllowed: null update allowed for no constraint)
     */
    public void setTagPrintTypeCd(String tagPrintTypeCd) {
        registerModifiedProperty("tagPrintTypeCd");
        _tagPrintTypeCd = tagPrintTypeCd;
    }

    /**
     * [get] INTEG_PRINT_FLG: {CHAR(1)} <br>
     * 一体型伝票印刷フラグ
     * @return The value of the column 'INTEG_PRINT_FLG'. (NullAllowed even if selected: for no constraint)
     */
    public String getIntegPrintFlg() {
        checkSpecifiedProperty("integPrintFlg");
        return convertEmptyToNull(_integPrintFlg);
    }

    /**
     * [set] INTEG_PRINT_FLG: {CHAR(1)} <br>
     * 一体型伝票印刷フラグ
     * @param integPrintFlg The value of the column 'INTEG_PRINT_FLG'. (NullAllowed: null update allowed for no constraint)
     */
    public void setIntegPrintFlg(String integPrintFlg) {
        registerModifiedProperty("integPrintFlg");
        _integPrintFlg = integPrintFlg;
    }
    ...
    /**
     * [get] PLL_PRINT_FLG: {CHAR(1)} <br>
     * 梱包明細印刷フラグ
     * @return The value of the column 'PLL_PRINT_FLG'. (NullAllowed even if selected: for no constraint)
     */
    public String getPllPrintFlg() {
        checkSpecifiedProperty("pllPrintFlg");
        return convertEmptyToNull(_pllPrintFlg);
    }

    /**
     * [set] PLL_PRINT_FLG: {CHAR(1)} <br>
     * 梱包明細印刷フラグ
     * @param pllPrintFlg The value of the column 'PLL_PRINT_FLG'. (NullAllowed: null update allowed for no constraint)
     */
    public void setPllPrintFlg(String pllPrintFlg) {
        registerModifiedProperty("pllPrintFlg");
        _pllPrintFlg = pllPrintFlg;
    }
