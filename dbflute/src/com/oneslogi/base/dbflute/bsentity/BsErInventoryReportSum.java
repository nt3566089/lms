...
/**
 * The entity of er_inventory_report_sum as TABLE. <br>
 * 棚卸実績(集約)受信テーブル
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long inventoryReportSumId = entity.getInventoryReportSumId();
 ...
 * entity.setInventoryReportSumId(inventoryReportSumId);
 ...
 */
public abstract class BsErInventoryReportSum extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected Long _inventoryReportSumId;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_inventoryReportSumId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsErInventoryReportSum) {
            BsErInventoryReportSum other = (BsErInventoryReportSum)obj;
            if (!xSV(_inventoryReportSumId, other._inventoryReportSumId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _inventoryReportSumId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_inventoryReportSumId));
    ...
    @Override
    public ErInventoryReportSum clone() {
        return (ErInventoryReportSum)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] INVENTORY_REPORT_SUM_ID: {PK, NotNull, BIGINT(19)} <br>
     * 棚卸実績_集約受信ID
     * @return The value of the column 'INVENTORY_REPORT_SUM_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getInventoryReportSumId() {
        checkSpecifiedProperty("inventoryReportSumId");
        return _inventoryReportSumId;
    }

    /**
     * [set] INVENTORY_REPORT_SUM_ID: {PK, NotNull, BIGINT(19)} <br>
     * 棚卸実績_集約受信ID
     * @param inventoryReportSumId The value of the column 'INVENTORY_REPORT_SUM_ID'. (basically NotNull if update: for the constraint)
     */
    public void setInventoryReportSumId(Long inventoryReportSumId) {
        registerModifiedProperty("inventoryReportSumId");
        _inventoryReportSumId = inventoryReportSumId;
    }
