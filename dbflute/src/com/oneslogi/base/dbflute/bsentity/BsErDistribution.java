...
/**
 * The entity of er_distribution as TABLE. <br>
 * 流通加工情報受信テーブル
 * <pre>
 * [primary-key]
 *     DISTRIBUTION_ID
 ...
 */
public abstract class BsErDistribution extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsErDistribution) {
            BsErDistribution other = (BsErDistribution)obj;
    ...
    @Override
    public ErDistribution clone() {
        return (ErDistribution)super.clone();
    }
