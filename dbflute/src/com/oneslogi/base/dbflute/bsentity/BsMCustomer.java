...
public abstract class BsMCustomer extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected MPlantStorageSpace _mPlantStorageSpaceByCd;

    /**
     * [get] m_plant_storage_space by my CUSTOMER_CD, named 'MPlantStorageSpaceByCd'. <br>
     * @return The entity of foreign property 'MPlantStorageSpaceByCd'. (NullAllowed: when e.g. null FK column, no setupSelect)
     */
    public MPlantStorageSpace getMPlantStorageSpaceByCd() {
        return _mPlantStorageSpaceByCd;
    }

    /**
     * [set] m_plant_storage_space by my CUSTOMER_CD, named 'MPlantStorageSpaceByCd'.
     * @param mPlantStorageSpaceByCd The entity of foreign property 'MPlantStorageSpaceByCd'. (NullAllowed)
     */
    public void setMPlantStorageSpaceByCd(MPlantStorageSpace mPlantStorageSpaceByCd) {
        _mPlantStorageSpaceByCd = mPlantStorageSpaceByCd;
    }
    ...
    protected List<TShippingInstH> _tShippingInstHByAccoutIdList;

    /**
     * [get] t_shipping_inst_h by ACCOUNT_ID, named 'TShippingInstHByAccoutIdList'.
     * @return The entity list of referrer property 'TShippingInstHByAccoutIdList'. (NotNull: even if no loading, returns empty list)
     */
    public List<TShippingInstH> getTShippingInstHByAccoutIdList() {
        if (_tShippingInstHByAccoutIdList == null) { _tShippingInstHByAccoutIdList = newReferrerList(); }
        return _tShippingInstHByAccoutIdList;
    }

    /**
     * [set] t_shipping_inst_h by ACCOUNT_ID, named 'TShippingInstHByAccoutIdList'.
     * @param tShippingInstHByAccoutIdList The entity list of referrer property 'TShippingInstHByAccoutIdList'. (NullAllowed)
     */
    public void setTShippingInstHByAccoutIdList(List<TShippingInstH> tShippingInstHByAccoutIdList) {
        _tShippingInstHByAccoutIdList = tShippingInstHByAccoutIdList;
    }
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        { sb.append(li).append(xbRDS(_mPlantStorageSpaceByCd, "mPlantStorageSpaceByCd")); }
        ...
        if (_tShippingInstHByAccoutIdList != null) { for (TShippingInstH et : _tShippingInstHByAccoutIdList)
        { if (et != null) { sb.append(li).append(xbRDS(et, "tShippingInstHByAccoutIdList")); } } }
        return sb.toString();
    }
    ...
    protected String doBuildRelationString(String dm) {
        ...
        if (_mPlantStorageSpaceByCd != null)
        { sb.append(dm).append("mPlantStorageSpaceByCd"); }
        if (_bClassDtlByDelFlg != null)
        ...
        if (_tShippingInstHByAccoutIdList != null && !_tShippingInstHByAccoutIdList.isEmpty())
        { sb.append(dm).append("tShippingInstHByAccoutIdList"); }
        if (sb.length() > dm.length()) {
    ...
    /**
     * [get] CUSTOMER_CD: {+UQ, IX, NotNull, VARCHAR(30), FK to M_PLANT_STORAGE_SPACE} <br>
     * 取引先CD
    ...
    /**
     * [set] CUSTOMER_CD: {+UQ, IX, NotNull, VARCHAR(30), FK to M_PLANT_STORAGE_SPACE} <br>
     * 取引先CD
