...
/**
 * The entity of t_operation_log as TABLE. <br>
 * 特殊操作履歴
 * <pre>
 * [primary-key]
 *     OPERATION_LOG_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long operationLogId = entity.getOperationLogId();
 ...
 * entity.setOperationLogId(operationLogId);
 ...
 */
public abstract class BsTOperationLog extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_operationLogId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTOperationLog) {
            BsTOperationLog other = (BsTOperationLog)obj;
            if (!xSV(_operationLogId, other._operationLogId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_operationLogId));
    ...
    @Override
    public TOperationLog clone() {
        return (TOperationLog)super.clone();
    }
     ...
     * 特殊操作履歴ID
     * @return The value of the column 'OPERATION_LOG_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getOperationLogId() {
        checkSpecifiedProperty("operationLogId");
     ...
     * 特殊操作履歴ID
     * @param operationLogId The value of the column 'OPERATION_LOG_ID'. (basically NotNull if update: for the constraint)
     */
    public void setOperationLogId(Long operationLogId) {
        registerModifiedProperty("operationLogId");
        _operationLogId = operationLogId;
    }
