...
/**
 * The entity of t_bldl5310 as TABLE. <br>
 * BLDL5310
 * <pre>
 * [primary-key]
 *     BLDL5310_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5310Id = entity.getBldl5310Id();
 ...
 * entity.setBldl5310Id(bldl5310Id);
 ...
 */
public abstract class BsTBldl5310 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5310Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5310) {
            BsTBldl5310 other = (BsTBldl5310)obj;
            if (!xSV(_bldl5310Id, other._bldl5310Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5310Id));
    ...
    @Override
    public TBldl5310 clone() {
        return (TBldl5310)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] BLDL5310_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5310ID
     * @return The value of the column 'BLDL5310_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5310Id() {
        checkSpecifiedProperty("bldl5310Id");
        return _bldl5310Id;
    }

    /**
     * [set] BLDL5310_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5310ID
     * @param bldl5310Id The value of the column 'BLDL5310_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5310Id(Long bldl5310Id) {
        registerModifiedProperty("bldl5310Id");
        _bldl5310Id = bldl5310Id;
    }
