...
/**
 * The entity of t_bldl5160 as TABLE. <br>
 * BLDL5160
 * <pre>
 * [primary-key]
 *     BLDL5160_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5160Id = entity.getBldl5160Id();
 ...
 * entity.setBldl5160Id(bldl5160Id);
 ...
 */
public abstract class BsTBldl5160 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5160Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5160) {
            BsTBldl5160 other = (BsTBldl5160)obj;
            if (!xSV(_bldl5160Id, other._bldl5160Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5160Id));
    ...
    @Override
    public TBldl5160 clone() {
        return (TBldl5160)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] BLDL5160_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5160ID
     * @return The value of the column 'BLDL5160_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5160Id() {
        checkSpecifiedProperty("bldl5160Id");
        return _bldl5160Id;
    }

    /**
     * [set] BLDL5160_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5160ID
     * @param bldl5160Id The value of the column 'BLDL5160_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5160Id(Long bldl5160Id) {
        registerModifiedProperty("bldl5160Id");
        _bldl5160Id = bldl5160Id;
    }
