...
/**
 * The entity of e_inventory_record_dtl as TABLE. <br>
 * 棚卸実績(明細)送信テーブル
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsEInventoryRecordDtl extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEInventoryRecordDtl) {
            BsEInventoryRecordDtl other = (BsEInventoryRecordDtl)obj;
    ...
    @Override
    public EInventoryRecordDtl clone() {
        return (EInventoryRecordDtl)super.clone();
    }
