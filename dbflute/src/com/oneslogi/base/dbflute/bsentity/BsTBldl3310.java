...
/**
 * The entity of t_bldl3310 as TABLE. <br>
 * BLDL3310
 * <pre>
 * [primary-key]
 *     BLDL3310_ID
 ...
 * String ecTypeCd = entity.getEcTypeCd();
 * Long fwPrice = entity.getFwPrice();
 * Long sanshaFwPrice = entity.getSanshaFwPrice();
 * Long sanshaUnPrice = entity.getSanshaUnPrice();
 * Long sanshaShPrice = entity.getSanshaShPrice();
 * Long sanshaHmPrice = entity.getSanshaHmPrice();
 * Long sanshaTotalPrice = entity.getSanshaTotalPrice();
 ...
 * entity.setEcTypeCd(ecTypeCd);
 * entity.setFwPrice(fwPrice);
 * entity.setSanshaFwPrice(sanshaFwPrice);
 * entity.setSanshaUnPrice(sanshaUnPrice);
 * entity.setSanshaShPrice(sanshaShPrice);
 * entity.setSanshaHmPrice(sanshaHmPrice);
 * entity.setSanshaTotalPrice(sanshaTotalPrice);
 ...
 */
public abstract class BsTBldl3310 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl3310) {
            BsTBldl3310 other = (BsTBldl3310)obj;
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_ecTypeCd));
        sb.append(dm).append(xfND(_fwPrice));
        sb.append(dm).append(xfND(_sanshaFwPrice));
        sb.append(dm).append(xfND(_sanshaUnPrice));
        sb.append(dm).append(xfND(_sanshaShPrice));
        sb.append(dm).append(xfND(_sanshaHmPrice));
        sb.append(dm).append(xfND(_sanshaTotalPrice));
    ...
    @Override
    public TBldl3310 clone() {
        return (TBldl3310)super.clone();
    }
     ...
     * EC区分
     * @return The value of the column 'EC_TYPE_CD'. (NullAllowed even if selected: for no constraint)
     */
    public String getEcTypeCd() {
        checkSpecifiedProperty("ecTypeCd");
        return convertEmptyToNull(_ecTypeCd);
    }

    /**
     * [set] EC_TYPE_CD: {VARCHAR(30)} <br>
     * EC区分
     * @param ecTypeCd The value of the column 'EC_TYPE_CD'. (NullAllowed: null update allowed for no constraint)
     */
    public void setEcTypeCd(String ecTypeCd) {
        registerModifiedProperty("ecTypeCd");
        _ecTypeCd = ecTypeCd;
    }
     ...
     * FW単体金額
     * @return The value of the column 'FW_PRICE'. (NullAllowed even if selected: for no constraint)
     */
    public Long getFwPrice() {
        checkSpecifiedProperty("fwPrice");
        return _fwPrice;
    }
     ...
     * FW単体金額
     * @param fwPrice The value of the column 'FW_PRICE'. (NullAllowed: null update allowed for no constraint)
     */
    public void setFwPrice(Long fwPrice) {
        registerModifiedProperty("fwPrice");
        _fwPrice = fwPrice;
    }
     ...
     * 3社戸配対象_FW金額
     * @return The value of the column 'SANSHA_FW_PRICE'. (NullAllowed even if selected: for no constraint)
     */
    public Long getSanshaFwPrice() {
        checkSpecifiedProperty("sanshaFwPrice");
     ...
     * 3社戸配対象_FW金額
     * @param sanshaFwPrice The value of the column 'SANSHA_FW_PRICE'. (NullAllowed: null update allowed for no constraint)
     */
    public void setSanshaFwPrice(Long sanshaFwPrice) {
        registerModifiedProperty("sanshaFwPrice");
        _sanshaFwPrice = sanshaFwPrice;
    }

    /**
     * [get] SANSHA_UN_PRICE: {BIGINT(19)} <br>
     * 3社戸配対象_UN金額
     * @return The value of the column 'SANSHA_UN_PRICE'. (NullAllowed even if selected: for no constraint)
     */
    public Long getSanshaUnPrice() {
        checkSpecifiedProperty("sanshaUnPrice");
     ...
     * 3社戸配対象_UN金額
     * @param sanshaUnPrice The value of the column 'SANSHA_UN_PRICE'. (NullAllowed: null update allowed for no constraint)
     */
    public void setSanshaUnPrice(Long sanshaUnPrice) {
        registerModifiedProperty("sanshaUnPrice");
        _sanshaUnPrice = sanshaUnPrice;
    }

    /**
     * [get] SANSHA_SH_PRICE: {BIGINT(19)} <br>
     * 3社戸配対象_SH金額
     * @return The value of the column 'SANSHA_SH_PRICE'. (NullAllowed even if selected: for no constraint)
     */
    public Long getSanshaShPrice() {
        checkSpecifiedProperty("sanshaShPrice");
     ...
     * 3社戸配対象_SH金額
     * @param sanshaShPrice The value of the column 'SANSHA_SH_PRICE'. (NullAllowed: null update allowed for no constraint)
     */
    public void setSanshaShPrice(Long sanshaShPrice) {
        registerModifiedProperty("sanshaShPrice");
        _sanshaShPrice = sanshaShPrice;
    }

    /**
     * [get] SANSHA_HM_PRICE: {BIGINT(19)} <br>
     * 3社戸配対象_HM金額
     * @return The value of the column 'SANSHA_HM_PRICE'. (NullAllowed even if selected: for no constraint)
     */
    public Long getSanshaHmPrice() {
        checkSpecifiedProperty("sanshaHmPrice");
     ...
     * 3社戸配対象_HM金額
     * @param sanshaHmPrice The value of the column 'SANSHA_HM_PRICE'. (NullAllowed: null update allowed for no constraint)
     */
    public void setSanshaHmPrice(Long sanshaHmPrice) {
        registerModifiedProperty("sanshaHmPrice");
        _sanshaHmPrice = sanshaHmPrice;
    }

    /**
     * [get] SANSHA_TOTAL_PRICE: {BIGINT(19)} <br>
     * 3社戸配対象_3社合計
     * @return The value of the column 'SANSHA_TOTAL_PRICE'. (NullAllowed even if selected: for no constraint)
     */
    public Long getSanshaTotalPrice() {
        checkSpecifiedProperty("sanshaTotalPrice");
     ...
     * 3社戸配対象_3社合計
     * @param sanshaTotalPrice The value of the column 'SANSHA_TOTAL_PRICE'. (NullAllowed: null update allowed for no constraint)
     */
    public void setSanshaTotalPrice(Long sanshaTotalPrice) {
        registerModifiedProperty("sanshaTotalPrice");
        _sanshaTotalPrice = sanshaTotalPrice;
    }
