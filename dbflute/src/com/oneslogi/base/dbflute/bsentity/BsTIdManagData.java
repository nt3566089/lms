...
/**
 * The entity of t_id_manag_data as TABLE. <br>
 * 個体管理情報
 * <pre>
 * [primary-key]
 *     ID_MANAG_DATA_ID
 ...
 */
public abstract class BsTIdManagData extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTIdManagData) {
            BsTIdManagData other = (BsTIdManagData)obj;
    ...
    @Override
    public TIdManagData clone() {
        return (TIdManagData)super.clone();
    }
