...
/**
 * The entity of es_inventory_inst as TABLE. <br>
 * 棚卸指示送信テーブル
 * <pre>
 * [primary-key]
 *     INVENTORY_INST_ID
 ...
 */
public abstract class BsEsInventoryInst extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEsInventoryInst) {
            BsEsInventoryInst other = (BsEsInventoryInst)obj;
    ...
    @Override
    public EsInventoryInst clone() {
        return (EsInventoryInst)super.clone();
    }
