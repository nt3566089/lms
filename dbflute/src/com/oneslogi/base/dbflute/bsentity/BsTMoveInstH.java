 ...
 *
 * [column]
 *     MOVE_INST_H_ID, CLIENT_ID, CENTER_ID, INST_DT, MOVE_SLIP_NO, PROCESS_TYPE_ID, MOVE_INST_STATUS, INPUT_TYPE, MOVE_INST_COMMENT, SOURCE_BATCH_NO, KOHAI_TYPE_CD, DEL_FLG, VERSION_NO, CONTROL_NO, ADD_DT, ADD_USER, ADD_PROCESS, UPD_DT, UPD_USER, UPD_PROCESS
 *
 * [sequence]
 *     
 *
 ...
 *
 * [foreign table]
 *     m_center, m_process_type, m_client, b_class_dtl(ByInputType), t_move_inst_r(AsOne)
 *
 * [referrer table]
 *     t_inventory_b, t_move_inst_b, t_move_record_b, t_move_inst_r
 *
 * [foreign property]
 *     mCenter, mProcessType, mClient, bClassDtlByInputType, bClassDtlByMoveInstStatus, tMoveInstRAsOne
 *
 * [referrer property]
 ...
 * String kohaiTypeCd = entity.getKohaiTypeCd();
 ...
 * entity.setKohaiTypeCd(kohaiTypeCd);
...
public abstract class BsTMoveInstH extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_kohaiTypeCd));
    ...
    //                                                                            ========
    /**
     * [get] MOVE_INST_H_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 在庫移動指示ヘッダID
    ...
    /**
     * [set] MOVE_INST_H_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 在庫移動指示ヘッダID
    ...
    /**
     * [get] KOHAI_TYPE_CD: {VARCHAR(30)} <br>
     * 戸配区分
     * @return The value of the column 'KOHAI_TYPE_CD'. (NullAllowed even if selected: for no constraint)
     */
    public String getKohaiTypeCd() {
        checkSpecifiedProperty("kohaiTypeCd");
        return convertEmptyToNull(_kohaiTypeCd);
    }

    /**
     * [set] KOHAI_TYPE_CD: {VARCHAR(30)} <br>
     * 戸配区分
     * @param kohaiTypeCd The value of the column 'KOHAI_TYPE_CD'. (NullAllowed: null update allowed for no constraint)
     */
    public void setKohaiTypeCd(String kohaiTypeCd) {
        registerModifiedProperty("kohaiTypeCd");
        _kohaiTypeCd = kohaiTypeCd;
    }
