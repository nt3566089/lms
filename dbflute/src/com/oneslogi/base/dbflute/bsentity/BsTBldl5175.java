...
/**
 * The entity of t_bldl5175 as TABLE. <br>
 * BLDL5175
 * <pre>
 * [primary-key]
 *     BLDL5175_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5175Id = entity.getBldl5175Id();
 ...
 * entity.setBldl5175Id(bldl5175Id);
 ...
 */
public abstract class BsTBldl5175 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5175Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5175) {
            BsTBldl5175 other = (BsTBldl5175)obj;
            if (!xSV(_bldl5175Id, other._bldl5175Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5175Id));
    ...
    @Override
    public TBldl5175 clone() {
        return (TBldl5175)super.clone();
    }
     ...
     * BLDL5175ID
     * @return The value of the column 'BLDL5175_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5175Id() {
        checkSpecifiedProperty("bldl5175Id");
        return _bldl5175Id;
    }
     ...
     * BLDL5175ID
     * @param bldl5175Id The value of the column 'BLDL5175_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5175Id(Long bldl5175Id) {
        registerModifiedProperty("bldl5175Id");
        _bldl5175Id = bldl5175Id;
    }
