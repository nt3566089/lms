...
/**
 * The entity of e_plant_storage_space as TABLE. <br>
 * プラント保管場所マスタ受信テーブル
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsEPlantStorageSpace extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEPlantStorageSpace) {
            BsEPlantStorageSpace other = (BsEPlantStorageSpace)obj;
    ...
    @Override
    public EPlantStorageSpace clone() {
        return (EPlantStorageSpace)super.clone();
    }
