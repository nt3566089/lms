...
/**
 * The entity of t_inventory_receive_label as TABLE. <br>
 * 棚卸入荷ラベル
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long inventoryReceiveLabelId = entity.getInventoryReceiveLabelId();
 * Long inventoryBId = entity.getInventoryBId();
 * String receiveLabelNo = entity.getReceiveLabelNo();
 * String scanFlg = entity.getScanFlg();
 ...
 * entity.setInventoryReceiveLabelId(inventoryReceiveLabelId);
 * entity.setInventoryBId(inventoryBId);
 * entity.setReceiveLabelNo(receiveLabelNo);
 * entity.setScanFlg(scanFlg);
 ...
 */
public abstract class BsTInventoryReceiveLabel extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_inventoryReceiveLabelId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTInventoryReceiveLabel) {
            BsTInventoryReceiveLabel other = (BsTInventoryReceiveLabel)obj;
            if (!xSV(_inventoryReceiveLabelId, other._inventoryReceiveLabelId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _inventoryReceiveLabelId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_inventoryReceiveLabelId));
        sb.append(dm).append(xfND(_inventoryBId));
        sb.append(dm).append(xfND(_receiveLabelNo));
        sb.append(dm).append(xfND(_scanFlg));
    ...
    @Override
    public TInventoryReceiveLabel clone() {
        return (TInventoryReceiveLabel)super.clone();
    }
     ...
     * 棚卸入荷ラベルID
     * @return The value of the column 'INVENTORY_RECEIVE_LABEL_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getInventoryReceiveLabelId() {
        checkSpecifiedProperty("inventoryReceiveLabelId");
     ...
     * 棚卸入荷ラベルID
     * @param inventoryReceiveLabelId The value of the column 'INVENTORY_RECEIVE_LABEL_ID'. (basically NotNull if update: for the constraint)
     */
    public void setInventoryReceiveLabelId(Long inventoryReceiveLabelId) {
        registerModifiedProperty("inventoryReceiveLabelId");
        _inventoryReceiveLabelId = inventoryReceiveLabelId;
    }
     ...
     * スキャン済フラグ
     * @return The value of the column 'SCAN_FLG'. (NullAllowed even if selected: for no constraint)
     */
    public String getScanFlg() {
        checkSpecifiedProperty("scanFlg");
        return convertEmptyToNull(_scanFlg);
    }

    /**
     * [set] SCAN_FLG: {CHAR(1), default=[0]} <br>
     * スキャン済フラグ
     * @param scanFlg The value of the column 'SCAN_FLG'. (NullAllowed: null update allowed for no constraint)
     */
    public void setScanFlg(String scanFlg) {
        registerModifiedProperty("scanFlg");
        _scanFlg = scanFlg;
    }
