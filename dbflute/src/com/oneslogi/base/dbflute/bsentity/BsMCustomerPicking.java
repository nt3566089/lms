...
/**
 * The entity of m_customer_picking as TABLE. <br>
 * 指定取引先ピッキングマスタ
 * <pre>
 * [primary-key]
 *     CUSTOMER_PICKING_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long customerPickingId = entity.getCustomerPickingId();
 ...
 * String pickPatternCd = entity.getPickPatternCd();
 ...
 * entity.setCustomerPickingId(customerPickingId);
 ...
 * entity.setPickPatternCd(pickPatternCd);
 ...
 */
public abstract class BsMCustomerPicking extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_customerPickingId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMCustomerPicking) {
            BsMCustomerPicking other = (BsMCustomerPicking)obj;
            if (!xSV(_customerPickingId, other._customerPickingId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_customerPickingId));
        ...
        sb.append(dm).append(xfND(_pickPatternCd));
    ...
    @Override
    public MCustomerPicking clone() {
        return (MCustomerPicking)super.clone();
    }
     ...
     * 指定取引先ピッキングID
     * @return The value of the column 'CUSTOMER_PICKING_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getCustomerPickingId() {
        checkSpecifiedProperty("customerPickingId");
     ...
     * 指定取引先ピッキングID
     * @param customerPickingId The value of the column 'CUSTOMER_PICKING_ID'. (basically NotNull if update: for the constraint)
     */
    public void setCustomerPickingId(Long customerPickingId) {
        registerModifiedProperty("customerPickingId");
        _customerPickingId = customerPickingId;
    }
     ...
     * ピックパターンCD
     * @return The value of the column 'PICK_PATTERN_CD'. (NullAllowed even if selected: for no constraint)
     */
    public String getPickPatternCd() {
        checkSpecifiedProperty("pickPatternCd");
        return convertEmptyToNull(_pickPatternCd);
    }

    /**
     * [set] PICK_PATTERN_CD: {VARCHAR(30)} <br>
     * ピックパターンCD
     * @param pickPatternCd The value of the column 'PICK_PATTERN_CD'. (NullAllowed: null update allowed for no constraint)
     */
    public void setPickPatternCd(String pickPatternCd) {
        registerModifiedProperty("pickPatternCd");
        _pickPatternCd = pickPatternCd;
    }
