...
/**
 * The entity of er_stock_record as TABLE. <br>
 * 在庫実績受信テーブル
 * <pre>
 * [primary-key]
 *     STOCK_RECORD_ID
 ...
 */
public abstract class BsErStockRecord extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsErStockRecord) {
            BsErStockRecord other = (BsErStockRecord)obj;
    ...
    @Override
    public ErStockRecord clone() {
        return (ErStockRecord)super.clone();
    }
