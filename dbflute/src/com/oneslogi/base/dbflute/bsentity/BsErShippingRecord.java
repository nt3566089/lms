...
/**
 * The entity of er_shipping_record as TABLE. <br>
 * 出荷実績受信テーブル
 * <pre>
 * [primary-key]
 *     SHIPPING_RECORD_ID
 ...
 */
public abstract class BsErShippingRecord extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsErShippingRecord) {
            BsErShippingRecord other = (BsErShippingRecord)obj;
    ...
    @Override
    public ErShippingRecord clone() {
        return (ErShippingRecord)super.clone();
    }
