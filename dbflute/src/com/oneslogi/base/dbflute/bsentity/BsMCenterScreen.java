 ...
 *
 * [foreign table]
 *     b_dict, b_screen, m_center, v_dict, v_ht_dict
 *
 * [referrer table]
 *     
 *
 * [foreign property]
 *     bDict, bScreen, mCenter, vDict, vHtDict
 *
 * [referrer property]
 *     
 *
...
public abstract class BsMCenterScreen extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] CENTER_SCREEN_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * センタ画面ID
    ...
    /**
     * [set] CENTER_SCREEN_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * センタ画面ID
