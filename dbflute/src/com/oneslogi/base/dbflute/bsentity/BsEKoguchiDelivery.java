...
/**
 * The entity of e_koguchi_delivery as TABLE. <br>
 * 戸口配送マスタ受信テーブル
 * <pre>
 * [primary-key]
 *     KOGUCHI_DELIVERY_ID
 ...
 */
public abstract class BsEKoguchiDelivery extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEKoguchiDelivery) {
            BsEKoguchiDelivery other = (BsEKoguchiDelivery)obj;
    ...
    @Override
    public EKoguchiDelivery clone() {
        return (EKoguchiDelivery)super.clone();
    }
