...
public abstract class BsTStoreRecordR extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] STORE_RECORD_H_ID: {PK, NotNull, BIGINT(19), FK to t_store_record_h} <br>
     * 入庫実績ヘッダID
    ...
    /**
     * [set] STORE_RECORD_H_ID: {PK, NotNull, BIGINT(19), FK to t_store_record_h} <br>
     * 入庫実績ヘッダID
    ...
    /**
     * [get] RECEIVE_RECORD_OUT_DT: {DATETIME(19)} <br>
     * 入荷実績出力日時
    ...
    /**
     * [set] RECEIVE_RECORD_OUT_DT: {DATETIME(19)} <br>
     * 入荷実績出力日時
