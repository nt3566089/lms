...
/**
 * The entity of t_bldl5050 as TABLE. <br>
 * BLDL5050
 * <pre>
 * [primary-key]
 *     BLDL5050_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5050Id = entity.getBldl5050Id();
 ...
 */
public abstract class BsTBldl5050 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5050Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5050) {
            BsTBldl5050 other = (BsTBldl5050)obj;
            if (!xSV(_bldl5050Id, other._bldl5050Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5050Id));
    ...
    @Override
    public TBldl5050 clone() {
        return (TBldl5050)super.clone();
    }
     ...
     * BLDL5050ID
     * @return The value of the column 'BLDL5050_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5050Id() {
        checkSpecifiedProperty("bldl5050Id");
        return _bldl5050Id;
    }
     ...
     * BLDL5050ID
     * @param bldl5050Id The value of the column 'BLDL5050_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5050Id(Long bldl5050Id) {
        registerModifiedProperty("bldl5050Id");
        _bldl5050Id = bldl5050Id;
    }
     ...
     * FW関連_アイテム数
     * @return The value of the column 'FW_ITEM_CNT'. (NullAllowed even if selected: for no constraint)
     */
    public Long getFwItemCnt() {
        checkSpecifiedProperty("fwItemCnt");
        return _fwItemCnt;
    }
     ...
     * FW関連_アイテム数
     * @param fwItemCnt The value of the column 'FW_ITEM_CNT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setFwItemCnt(Long fwItemCnt) {
        registerModifiedProperty("fwItemCnt");
        _fwItemCnt = fwItemCnt;
    }
     ...
     * UN関連_アイテム数
     * @return The value of the column 'UN_ITEM_CNT'. (NullAllowed even if selected: for no constraint)
     */
    public Long getUnItemCnt() {
        checkSpecifiedProperty("unItemCnt");
        return _unItemCnt;
    }
     ...
     * UN関連_アイテム数
     * @param unItemCnt The value of the column 'UN_ITEM_CNT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setUnItemCnt(Long unItemCnt) {
        registerModifiedProperty("unItemCnt");
        _unItemCnt = unItemCnt;
    }
     ...
     * SH関連_アイテム数
     * @return The value of the column 'SH_ITEM_CNT'. (NullAllowed even if selected: for no constraint)
     */
    public Long getShItemCnt() {
        checkSpecifiedProperty("shItemCnt");
        return _shItemCnt;
    }
     ...
     * SH関連_アイテム数
     * @param shItemCnt The value of the column 'SH_ITEM_CNT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setShItemCnt(Long shItemCnt) {
        registerModifiedProperty("shItemCnt");
        _shItemCnt = shItemCnt;
    }
     ...
     * HM関連_アイテム数
     * @return The value of the column 'HM_ITEM_CNT'. (NullAllowed even if selected: for no constraint)
     */
    public Long getHmItemCnt() {
        checkSpecifiedProperty("hmItemCnt");
        return _hmItemCnt;
    }
     ...
     * HM関連_アイテム数
     * @param hmItemCnt The value of the column 'HM_ITEM_CNT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setHmItemCnt(Long hmItemCnt) {
        registerModifiedProperty("hmItemCnt");
        _hmItemCnt = hmItemCnt;
    }
     ...
     * 当日合計_アイテム数
     * @return The value of the column 'TOTAL_ITEM_CNT'. (NullAllowed even if selected: for no constraint)
     */
    public Long getTotalItemCnt() {
        checkSpecifiedProperty("totalItemCnt");
     ...
     * 当日合計_アイテム数
     * @param totalItemCnt The value of the column 'TOTAL_ITEM_CNT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setTotalItemCnt(Long totalItemCnt) {
        registerModifiedProperty("totalItemCnt");
