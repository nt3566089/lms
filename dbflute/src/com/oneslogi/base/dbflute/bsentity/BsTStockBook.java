...
/**
 * The entity of t_stock_book as TABLE. <br>
 * 帳簿在庫
 * <pre>
 * [primary-key]
 *     STOCK_BOOK_ID
 ...
 */
public abstract class BsTStockBook extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTStockBook) {
            BsTStockBook other = (BsTStockBook)obj;
    ...
    @Override
    public TStockBook clone() {
        return (TStockBook)super.clone();
    }
