...
public class TPackingBDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((TPackingB)et).getShippingPackingRowNo(), (et, vl) -> ((TPackingB)et).setShippingPackingRowNo((String)vl), "shippingPackingRowNo");
        setupEpg(_epgMap, et -> ((TPackingB)et).getOldPackingBId(), (et, vl) -> ((TPackingB)et).setOldPackingBId(ctl(vl)), "oldPackingBId");
        setupEpg(_epgMap, et -> ((TPackingB)et).getReceiveLabelNo(), (et, vl) -> ((TPackingB)et).setReceiveLabelNo((String)vl), "receiveLabelNo");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPackingBId = cci("PACKING_B_ID", "PACKING_B_ID", null, null, Long.class, "packingBId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnPackingNum = cci("PACKING_NUM", "PACKING_NUM", null, null, java.math.BigDecimal.class, "packingNum", null, false, false, true, "DECIMAL", 14, 4, null, "0.0000", false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnShippingPackingRowNo = cci("SHIPPING_PACKING_ROW_NO", "SHIPPING_PACKING_ROW_NO", null, null, String.class, "shippingPackingRowNo", null, false, false, false, "VARCHAR", 30, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnOldPackingBId = cci("OLD_PACKING_B_ID", "OLD_PACKING_B_ID", null, null, Long.class, "oldPackingBId", null, false, false, false, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
     ...
     * @return The information object of specified column. (NotNull)
     */
    public ColumnInfo columnShippingPackingRowNo() { return _columnShippingPackingRowNo; }
    /**
     * OLD_PACKING_B_ID: {BIGINT(19)}
     * @return The information object of specified column. (NotNull)
     */
    public ColumnInfo columnOldPackingBId() { return _columnOldPackingBId; }
    /**
    ...
    protected List<ColumnInfo> ccil() {
        ...
        ls.add(columnShippingPackingRowNo());
        ls.add(columnOldPackingBId());
    ...
    public ForeignInfo foreignTPackingH() {
        ...
        return cfi("T_PACKING_B_FK1", "TPackingH", this, TPackingHDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "TPackingBList", false);
    }
    /**
    ...
    public ForeignInfo foreignTAllocInstB() {
        ...
        return cfi("T_PACKING_B_FK3", "TAllocInstB", this, TAllocInstBDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "TPackingBList", false);
    }
    /**
