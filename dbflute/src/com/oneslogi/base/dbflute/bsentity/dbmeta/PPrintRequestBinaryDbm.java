...
public class PPrintRequestBinaryDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPrintRequestBinaryId = cci("PRINT_REQUEST_BINARY_ID", "PRINT_REQUEST_BINARY_ID", null, null, Long.class, "printRequestBinaryId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnReportBinary = cci("REPORT_BINARY", "REPORT_BINARY", null, null, byte[].class, "reportBinary", null, false, false, false, "LONGBLOB", 2147483647, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * PRINT_REQUEST_BINARY_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    /**
     * REPORT_BINARY: {LONGBLOB(2147483647)}
     * @return The information object of specified column. (NotNull)
     */
