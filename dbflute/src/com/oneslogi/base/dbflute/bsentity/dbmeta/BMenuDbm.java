...
public class BMenuDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMenuId = cci("MENU_ID", "MENU_ID", null, null, Long.class, "menuId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignBMenuGrp() {
        ...
        return cfi("B_MENU_FK1", "BMenuGrp", this, BMenuGrpDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "BMenuList", false);
    }
    /**
    ...
    public ForeignInfo foreignBDict() {
        ...
        return cfi("B_MENU_FK2", "BDict", this, BDictDbm.getInstance(), mp, 2, null, false, false, false, false, null, null, false, "BMenuList", false);
    }
    /**
