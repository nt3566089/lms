...
public class MImportTypeBCopyHDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnImportTypeBCopyHId = cci("IMPORT_TYPE_B_COPY_H_ID", "IMPORT_TYPE_B_COPY_H_ID", null, null, Long.class, "importTypeBCopyHId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * IMPORT_TYPE_B_COPY_H_ID: {PK, ID, NotNull, BIGINT(19)}
