...
/**
 * The DB meta of e_inventory_record_dtl. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class EInventoryRecordDtlDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final EInventoryRecordDtlDbm _instance = new EInventoryRecordDtlDbm();
    private EInventoryRecordDtlDbm() {}
    public static EInventoryRecordDtlDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getInventoryRecordDtlId(), (et, vl) -> ((EInventoryRecordDtl)et).setInventoryRecordDtlId(ctl(vl)), "inventoryRecordDtlId");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getSendFlg(), (et, vl) -> ((EInventoryRecordDtl)et).setSendFlg((String)vl), "sendFlg");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getInventorySlipNo(), (et, vl) -> ((EInventoryRecordDtl)et).setInventorySlipNo((String)vl), "inventorySlipNo");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getFiscalYear(), (et, vl) -> ((EInventoryRecordDtl)et).setFiscalYear((String)vl), "fiscalYear");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getInventorySlipRowNo(), (et, vl) -> ((EInventoryRecordDtl)et).setInventorySlipRowNo((String)vl), "inventorySlipRowNo");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getPlantCd(), (et, vl) -> ((EInventoryRecordDtl)et).setPlantCd((String)vl), "plantCd");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getStorageSpaceCd(), (et, vl) -> ((EInventoryRecordDtl)et).setStorageSpaceCd((String)vl), "storageSpaceCd");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getReferenceDt(), (et, vl) -> ((EInventoryRecordDtl)et).setReferenceDt((String)vl), "referenceDt");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getHinmokuCd(), (et, vl) -> ((EInventoryRecordDtl)et).setHinmokuCd((String)vl), "hinmokuCd");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getStockNum(), (et, vl) -> ((EInventoryRecordDtl)et).setStockNum(ctb(vl)), "stockNum");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getProductNmKanji(), (et, vl) -> ((EInventoryRecordDtl)et).setProductNmKanji((String)vl), "productNmKanji");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getBarcode(), (et, vl) -> ((EInventoryRecordDtl)et).setBarcode((String)vl), "barcode");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getDepositJanCd(), (et, vl) -> ((EInventoryRecordDtl)et).setDepositJanCd((String)vl), "depositJanCd");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getTenhanshaCd(), (et, vl) -> ((EInventoryRecordDtl)et).setTenhanshaCd((String)vl), "tenhanshaCd");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getSalesOrgCd(), (et, vl) -> ((EInventoryRecordDtl)et).setSalesOrgCd((String)vl), "salesOrgCd");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getTenhanshaNm1(), (et, vl) -> ((EInventoryRecordDtl)et).setTenhanshaNm1((String)vl), "tenhanshaNm1");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getTenhanshaNm2(), (et, vl) -> ((EInventoryRecordDtl)et).setTenhanshaNm2((String)vl), "tenhanshaNm2");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getSapUserCd(), (et, vl) -> ((EInventoryRecordDtl)et).setSapUserCd((String)vl), "sapUserCd");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getSapUserNm(), (et, vl) -> ((EInventoryRecordDtl)et).setSapUserNm((String)vl), "sapUserNm");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getAllocTypeCd(), (et, vl) -> ((EInventoryRecordDtl)et).setAllocTypeCd((String)vl), "allocTypeCd");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsAddYyyy(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsAddYyyy((String)vl), "wmsAddYyyy");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsAddMm(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsAddMm((String)vl), "wmsAddMm");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsAddDd(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsAddDd((String)vl), "wmsAddDd");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsAddHh(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsAddHh((String)vl), "wmsAddHh");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsAddMi(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsAddMi((String)vl), "wmsAddMi");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsAddSs(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsAddSs((String)vl), "wmsAddSs");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsAddUserCd(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsAddUserCd((String)vl), "wmsAddUserCd");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsUpdYyyy(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsUpdYyyy((String)vl), "wmsUpdYyyy");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsUpdMm(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsUpdMm((String)vl), "wmsUpdMm");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsUpdDd(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsUpdDd((String)vl), "wmsUpdDd");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsUpdHh(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsUpdHh((String)vl), "wmsUpdHh");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsUpdMi(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsUpdMi((String)vl), "wmsUpdMi");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsUpdSs(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsUpdSs((String)vl), "wmsUpdSs");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getWmsUpdUserCd(), (et, vl) -> ((EInventoryRecordDtl)et).setWmsUpdUserCd((String)vl), "wmsUpdUserCd");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getProductType(), (et, vl) -> ((EInventoryRecordDtl)et).setProductType((String)vl), "productType");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getSpareStr(), (et, vl) -> ((EInventoryRecordDtl)et).setSpareStr((String)vl), "spareStr");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getDelFlg(), (et, vl) -> ((EInventoryRecordDtl)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getVersionNo(), (et, vl) -> ((EInventoryRecordDtl)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getControlNo(), (et, vl) -> ((EInventoryRecordDtl)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getAddDt(), (et, vl) -> ((EInventoryRecordDtl)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getAddUser(), (et, vl) -> ((EInventoryRecordDtl)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getAddProcess(), (et, vl) -> ((EInventoryRecordDtl)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getUpdDt(), (et, vl) -> ((EInventoryRecordDtl)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getUpdUser(), (et, vl) -> ((EInventoryRecordDtl)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((EInventoryRecordDtl)et).getUpdProcess(), (et, vl) -> ((EInventoryRecordDtl)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "e_inventory_record_dtl";
    protected final String _tableDispName = "e_inventory_record_dtl";
    protected final String _tablePropertyName = "EInventoryRecordDtl";
    protected final TableSqlName _tableSqlName = new TableSqlName("e_inventory_record_dtl", _tableDbName);
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnInventoryRecordDtlId = cci("INVENTORY_RECORD_DTL_ID", "INVENTORY_RECORD_DTL_ID", null, null, Long.class, "inventoryRecordDtlId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.EInventoryRecordDtl"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.EInventoryRecordDtlCB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.EInventoryRecordDtlBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<EInventoryRecordDtl> getEntityType() { return EInventoryRecordDtl.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public EInventoryRecordDtl newEntity() { return new EInventoryRecordDtl(); }
    ...
    { doAcceptPrimaryKeyMap((EInventoryRecordDtl)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((EInventoryRecordDtl)et, mp); }
