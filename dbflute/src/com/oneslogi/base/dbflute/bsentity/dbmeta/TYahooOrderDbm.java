...
public class TYahooOrderDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnYahooOrderId = cci("YAHOO_ORDER_ID", "YAHOO_ORDER_ID", null, null, Long.class, "yahooOrderId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * YAHOO_ORDER_ID: {PK, ID, NotNull, BIGINT(19)}
