...
public class TMoveInstHDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((TMoveInstH)et).getKohaiTypeCd(), (et, vl) -> ((TMoveInstH)et).setKohaiTypeCd((String)vl), "kohaiTypeCd");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMoveInstHId = cci("MOVE_INST_H_ID", "MOVE_INST_H_ID", null, null, Long.class, "moveInstHId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "TInventoryBList,TMoveInstBList,TMoveRecordBList", null, false);
    ...
    protected final ColumnInfo _columnKohaiTypeCd = cci("KOHAI_TYPE_CD", "KOHAI_TYPE_CD", null, null, String.class, "kohaiTypeCd", null, false, false, false, "VARCHAR", 30, 0, null, null, false, null, null, null, null, null, false);
     ...
     * @return The information object of specified column. (NotNull)
     */
    public ColumnInfo columnKohaiTypeCd() { return _columnKohaiTypeCd; }
    /**
    ...
    public ForeignInfo foreignMCenter() {
        ...
        return cfi("T_MOVE_INST_H_FK3", "MCenter", this, MCenterDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "TMoveInstHList", false);
    }
    /**
    ...
    public ForeignInfo foreignMClient() {
        ...
        return cfi("T_MOVE_INST_H_FK2", "MClient", this, MClientDbm.getInstance(), mp, 2, null, false, false, false, false, null, null, false, "TMoveInstHList", false);
    }
    /**
    ...
    public ReferrerInfo referrerTInventoryBList() {
        ...
        return cri("T_INVENTORY_B_FK11", "TInventoryBList", this, TInventoryBDbm.getInstance(), mp, false, "TMoveInstH");
    }
    /**
    ...
    public ReferrerInfo referrerTMoveInstBList() {
        ...
        return cri("T_MOVE_INST_B_FK4", "TMoveInstBList", this, TMoveInstBDbm.getInstance(), mp, false, "TMoveInstH");
    }
    /**
    ...
    public ReferrerInfo referrerTMoveRecordBList() {
        ...
        return cri("T_MOVE_RECORD_B_FK3", "TMoveRecordBList", this, TMoveRecordBDbm.getInstance(), mp, false, "TMoveInstH");
    }
