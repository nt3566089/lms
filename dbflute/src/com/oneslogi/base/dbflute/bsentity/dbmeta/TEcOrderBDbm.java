...
public class TEcOrderBDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnEcOrderBId = cci("EC_ORDER_B_ID", "EC_ORDER_B_ID", null, null, Long.class, "ecOrderBId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "TAmazonOrderList,TRakutenOrderList,TYahooOrderList", null, false);
    ...
    /**
     * EC_ORDER_B_ID: {PK, ID, NotNull, BIGINT(19)}
