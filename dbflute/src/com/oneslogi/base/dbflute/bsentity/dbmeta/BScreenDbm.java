...
public class BScreenDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnScreenId = cci("SCREEN_ID", "SCREEN_ID", null, null, Long.class, "screenId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "BItemList,BMenuList,BScreenRoleList,MCenterScreenList,MClientScreenList", null, false);
    ...
    public ReferrerInfo referrerMClientScreenList() {
        ...
        return cri("M_CLIENT_SCREEN_FK2", "MClientScreenList", this, MClientScreenDbm.getInstance(), mp, false, "BScreen");
    }
