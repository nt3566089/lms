...
/**
 * The DB meta of er_shipping_record. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class ErShippingRecordDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final ErShippingRecordDbm _instance = new ErShippingRecordDbm();
    private ErShippingRecordDbm() {}
    public static ErShippingRecordDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getShippingRecordId(), (et, vl) -> ((ErShippingRecord)et).setShippingRecordId(ctl(vl)), "shippingRecordId");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getReceiveCd(), (et, vl) -> ((ErShippingRecord)et).setReceiveCd((String)vl), "receiveCd");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getReceiveRowId(), (et, vl) -> ((ErShippingRecord)et).setReceiveRowId(ctl(vl)), "receiveRowId");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getImportFlg(), (et, vl) -> ((ErShippingRecord)et).setImportFlg((String)vl), "importFlg");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getErrorFlg(), (et, vl) -> ((ErShippingRecord)et).setErrorFlg((String)vl), "errorFlg");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getErrorMessageCd(), (et, vl) -> ((ErShippingRecord)et).setErrorMessageCd((String)vl), "errorMessageCd");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getShippingSlipNo(), (et, vl) -> ((ErShippingRecord)et).setShippingSlipNo((String)vl), "shippingSlipNo");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getShippingSlipRowNo(), (et, vl) -> ((ErShippingRecord)et).setShippingSlipRowNo((String)vl), "shippingSlipRowNo");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getSn(), (et, vl) -> ((ErShippingRecord)et).setSn(ctl(vl)), "sn");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getSalesOrderNo(), (et, vl) -> ((ErShippingRecord)et).setSalesOrderNo((String)vl), "salesOrderNo");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getHinmokuCd(), (et, vl) -> ((ErShippingRecord)et).setHinmokuCd((String)vl), "hinmokuCd");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getShippingDt(), (et, vl) -> ((ErShippingRecord)et).setShippingDt((String)vl), "shippingDt");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getJanCd(), (et, vl) -> ((ErShippingRecord)et).setJanCd((String)vl), "janCd");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getNum(), (et, vl) -> ((ErShippingRecord)et).setNum(ctb(vl)), "num");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getLotManagTypeCd(), (et, vl) -> ((ErShippingRecord)et).setLotManagTypeCd((String)vl), "lotManagTypeCd");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getLot(), (et, vl) -> ((ErShippingRecord)et).setLot((String)vl), "lot");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getCarrierSlipNo(), (et, vl) -> ((ErShippingRecord)et).setCarrierSlipNo((String)vl), "carrierSlipNo");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getCarrierCd(), (et, vl) -> ((ErShippingRecord)et).setCarrierCd((String)vl), "carrierCd");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getCarrierRnm(), (et, vl) -> ((ErShippingRecord)et).setCarrierRnm((String)vl), "carrierRnm");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getConfirmedPackingNum(), (et, vl) -> ((ErShippingRecord)et).setConfirmedPackingNum(ctl(vl)), "confirmedPackingNum");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getSalesNo2(), (et, vl) -> ((ErShippingRecord)et).setSalesNo2((String)vl), "salesNo2");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getDeliverySlipNo(), (et, vl) -> ((ErShippingRecord)et).setDeliverySlipNo((String)vl), "deliverySlipNo");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getDStr(), (et, vl) -> ((ErShippingRecord)et).setDStr((String)vl), "DStr");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getIStr(), (et, vl) -> ((ErShippingRecord)et).setIStr((String)vl), "IStr");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getShippingStorageSpaceCd(), (et, vl) -> ((ErShippingRecord)et).setShippingStorageSpaceCd((String)vl), "shippingStorageSpaceCd");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsAddYyyy(), (et, vl) -> ((ErShippingRecord)et).setWmsAddYyyy((String)vl), "wmsAddYyyy");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsAddMm(), (et, vl) -> ((ErShippingRecord)et).setWmsAddMm((String)vl), "wmsAddMm");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsAddDd(), (et, vl) -> ((ErShippingRecord)et).setWmsAddDd((String)vl), "wmsAddDd");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsAddHh(), (et, vl) -> ((ErShippingRecord)et).setWmsAddHh((String)vl), "wmsAddHh");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsAddMi(), (et, vl) -> ((ErShippingRecord)et).setWmsAddMi((String)vl), "wmsAddMi");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsAddSs(), (et, vl) -> ((ErShippingRecord)et).setWmsAddSs((String)vl), "wmsAddSs");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsAddUserCd(), (et, vl) -> ((ErShippingRecord)et).setWmsAddUserCd((String)vl), "wmsAddUserCd");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsUpdYyyy(), (et, vl) -> ((ErShippingRecord)et).setWmsUpdYyyy((String)vl), "wmsUpdYyyy");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsUpdMm(), (et, vl) -> ((ErShippingRecord)et).setWmsUpdMm((String)vl), "wmsUpdMm");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsUpdDd(), (et, vl) -> ((ErShippingRecord)et).setWmsUpdDd((String)vl), "wmsUpdDd");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsUpdHh(), (et, vl) -> ((ErShippingRecord)et).setWmsUpdHh((String)vl), "wmsUpdHh");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsUpdMi(), (et, vl) -> ((ErShippingRecord)et).setWmsUpdMi((String)vl), "wmsUpdMi");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsUpdSs(), (et, vl) -> ((ErShippingRecord)et).setWmsUpdSs((String)vl), "wmsUpdSs");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getWmsUpdUserCd(), (et, vl) -> ((ErShippingRecord)et).setWmsUpdUserCd((String)vl), "wmsUpdUserCd");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getSpareStr(), (et, vl) -> ((ErShippingRecord)et).setSpareStr((String)vl), "spareStr");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getDelFlg(), (et, vl) -> ((ErShippingRecord)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getVersionNo(), (et, vl) -> ((ErShippingRecord)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getControlNo(), (et, vl) -> ((ErShippingRecord)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getAddDt(), (et, vl) -> ((ErShippingRecord)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getAddUser(), (et, vl) -> ((ErShippingRecord)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getAddProcess(), (et, vl) -> ((ErShippingRecord)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getUpdDt(), (et, vl) -> ((ErShippingRecord)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getUpdUser(), (et, vl) -> ((ErShippingRecord)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((ErShippingRecord)et).getUpdProcess(), (et, vl) -> ((ErShippingRecord)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "er_shipping_record";
    protected final String _tableDispName = "er_shipping_record";
    protected final String _tablePropertyName = "erShippingRecord";
    protected final TableSqlName _tableSqlName = new TableSqlName("er_shipping_record", _tableDbName);
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnShippingRecordId = cci("SHIPPING_RECORD_ID", "SHIPPING_RECORD_ID", null, null, Long.class, "shippingRecordId", null, true, false, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.ErShippingRecord"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.ErShippingRecordCB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.ErShippingRecordBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<ErShippingRecord> getEntityType() { return ErShippingRecord.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public ErShippingRecord newEntity() { return new ErShippingRecord(); }
    ...
    { doAcceptPrimaryKeyMap((ErShippingRecord)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((ErShippingRecord)et, mp); }
