...
public class MShapeGrpDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnShapeGrpId = cci("SHAPE_GRP_ID", "SHAPE_GRP_ID", null, null, Long.class, "shapeGrpId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MClientList,MProductList,MShapeGrpDtlList", null, false);
    ...
    /**
     * SHAPE_GRP_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ReferrerInfo referrerMProductList() {
        ...
        return cri("M_PRODUCT_FK2", "MProductList", this, MProductDbm.getInstance(), mp, false, "MShapeGrp");
    }
    /**
    ...
    public ReferrerInfo referrerMShapeGrpDtlList() {
        ...
        return cri("M_SHAPE_GRP_DTL_FK1", "MShapeGrpDtlList", this, MShapeGrpDtlDbm.getInstance(), mp, false, "MShapeGrp");
    }
