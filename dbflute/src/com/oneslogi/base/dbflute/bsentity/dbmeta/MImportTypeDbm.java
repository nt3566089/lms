...
public class MImportTypeDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnImportTypeId = cci("IMPORT_TYPE_ID", "IMPORT_TYPE_ID", null, null, Long.class, "importTypeId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MImportTypeBList,TEcOrderHList", null, false);
    ...
    /**
     * IMPORT_TYPE_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ForeignInfo foreignMClient() {
        ...
        return cfi("M_IMPORT_TYPE_FK1", "MClient", this, MClientDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "MImportTypeList", false);
    }
    /**
    ...
    public ForeignInfo foreignMEdi() {
        ...
        return cfi("M_IMPORT_TYPE_FK2", "MEdi", this, MEdiDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "MImportTypeList", false);
    }
    /**
    ...
    public ReferrerInfo referrerMImportTypeBList() {
        ...
        return cri("M_IMPORT_TYPE_B_FK2", "MImportTypeBList", this, MImportTypeBDbm.getInstance(), mp, false, "MImportType");
    }
    /**
    ...
    public ReferrerInfo referrerTEcOrderHList() {
        ...
        return cri("T_EC_ORDER_H_FK1", "TEcOrderHList", this, TEcOrderHDbm.getInstance(), mp, false, "MImportType");
    }
