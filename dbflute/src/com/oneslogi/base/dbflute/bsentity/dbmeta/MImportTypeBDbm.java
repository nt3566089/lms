...
public class MImportTypeBDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnImportTypeBId = cci("IMPORT_TYPE_B_ID", "IMPORT_TYPE_B_ID", null, null, Long.class, "importTypeBId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MImportTypeBCopyBList,MImportTypeBCopyHList", null, false);
    ...
    public ForeignInfo foreignMImportType() {
        ...
        return cfi("M_IMPORT_TYPE_B_FK2", "MImportType", this, MImportTypeDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "MImportTypeBList", false);
    }
    /**
    ...
    public ForeignInfo foreignMEdiColumn() {
        ...
        return cfi("M_IMPORT_TYPE_B_FK1", "MEdiColumn", this, MEdiColumnDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "MImportTypeBList", false);
    }
