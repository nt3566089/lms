...
public class BItemDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnItemId = cci("ITEM_ID", "ITEM_ID", null, null, Long.class, "itemId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "BColList,BColExtBaseList,BColExtUserList,BItemRoleList,MCenterItemList,MClientItemList", null, false);
    ...
    /**
     * ITEM_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ReferrerInfo referrerBColList() {
        ...
        return cri("B_COL_FK1", "BColList", this, BColDbm.getInstance(), mp, false, "BItem");
    }
    /**
    ...
    public ReferrerInfo referrerBItemRoleList() {
        ...
        return cri("B_ITEM_ROLE_FK1", "BItemRoleList", this, BItemRoleDbm.getInstance(), mp, false, "BItem");
    }
    /**
