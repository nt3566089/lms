...
public class HInventoryHDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnInventoryHId = cci("INVENTORY_H_ID", "INVENTORY_H_ID", null, null, Long.class, "inventoryHId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "HInventoryBList", null, false);
    ...
    public ReferrerInfo referrerHInventoryBList() {
        ...
        return cri("H_INVENTORY_B_FK4", "HInventoryBList", this, HInventoryBDbm.getInstance(), mp, false, "HInventoryH");
    }
