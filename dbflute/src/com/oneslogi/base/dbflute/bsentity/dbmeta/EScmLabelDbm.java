...
/**
 * The DB meta of e_scm_label. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class EScmLabelDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final EScmLabelDbm _instance = new EScmLabelDbm();
    private EScmLabelDbm() {}
    public static EScmLabelDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((EScmLabel)et).getScmLabelId(), (et, vl) -> ((EScmLabel)et).setScmLabelId(ctl(vl)), "scmLabelId");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getSendFlg(), (et, vl) -> ((EScmLabel)et).setSendFlg((String)vl), "sendFlg");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getShippingSlipNo(), (et, vl) -> ((EScmLabel)et).setShippingSlipNo((String)vl), "shippingSlipNo");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getPackingNo(), (et, vl) -> ((EScmLabel)et).setPackingNo((String)vl), "packingNo");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getCartonIdNo(), (et, vl) -> ((EScmLabel)et).setCartonIdNo((String)vl), "cartonIdNo");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getSn(), (et, vl) -> ((EScmLabel)et).setSn((String)vl), "sn");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getManagTypeCd(), (et, vl) -> ((EScmLabel)et).setManagTypeCd((String)vl), "managTypeCd");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getHinmokuCd(), (et, vl) -> ((EScmLabel)et).setHinmokuCd((String)vl), "hinmokuCd");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getHinmokuGroup(), (et, vl) -> ((EScmLabel)et).setHinmokuGroup((String)vl), "hinmokuGroup");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getHinmokuText(), (et, vl) -> ((EScmLabel)et).setHinmokuText((String)vl), "hinmokuText");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getJanCd(), (et, vl) -> ((EScmLabel)et).setJanCd((String)vl), "janCd");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getNum(), (et, vl) -> ((EScmLabel)et).setNum((String)vl), "num");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getSerialNo(), (et, vl) -> ((EScmLabel)et).setSerialNo((String)vl), "serialNo");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getLotManagTypeCd(), (et, vl) -> ((EScmLabel)et).setLotManagTypeCd((String)vl), "lotManagTypeCd");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getLot(), (et, vl) -> ((EScmLabel)et).setLot((String)vl), "lot");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getLimitDt(), (et, vl) -> ((EScmLabel)et).setLimitDt((String)vl), "limitDt");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getProdDt(), (et, vl) -> ((EScmLabel)et).setProdDt((String)vl), "prodDt");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsAddYyyy(), (et, vl) -> ((EScmLabel)et).setWmsAddYyyy((String)vl), "wmsAddYyyy");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsAddMm(), (et, vl) -> ((EScmLabel)et).setWmsAddMm((String)vl), "wmsAddMm");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsAddDd(), (et, vl) -> ((EScmLabel)et).setWmsAddDd((String)vl), "wmsAddDd");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsAddHh(), (et, vl) -> ((EScmLabel)et).setWmsAddHh((String)vl), "wmsAddHh");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsAddMi(), (et, vl) -> ((EScmLabel)et).setWmsAddMi((String)vl), "wmsAddMi");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsAddSs(), (et, vl) -> ((EScmLabel)et).setWmsAddSs((String)vl), "wmsAddSs");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsAddUserCd(), (et, vl) -> ((EScmLabel)et).setWmsAddUserCd((String)vl), "wmsAddUserCd");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsUpdYyyy(), (et, vl) -> ((EScmLabel)et).setWmsUpdYyyy((String)vl), "wmsUpdYyyy");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsUpdMm(), (et, vl) -> ((EScmLabel)et).setWmsUpdMm((String)vl), "wmsUpdMm");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsUpdDd(), (et, vl) -> ((EScmLabel)et).setWmsUpdDd((String)vl), "wmsUpdDd");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsUpdHh(), (et, vl) -> ((EScmLabel)et).setWmsUpdHh((String)vl), "wmsUpdHh");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsUpdMi(), (et, vl) -> ((EScmLabel)et).setWmsUpdMi((String)vl), "wmsUpdMi");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsUpdSs(), (et, vl) -> ((EScmLabel)et).setWmsUpdSs((String)vl), "wmsUpdSs");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getWmsUpdUserCd(), (et, vl) -> ((EScmLabel)et).setWmsUpdUserCd((String)vl), "wmsUpdUserCd");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getSpareStr(), (et, vl) -> ((EScmLabel)et).setSpareStr((String)vl), "spareStr");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getDelFlg(), (et, vl) -> ((EScmLabel)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getVersionNo(), (et, vl) -> ((EScmLabel)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getControlNo(), (et, vl) -> ((EScmLabel)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getAddDt(), (et, vl) -> ((EScmLabel)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getAddUser(), (et, vl) -> ((EScmLabel)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getAddProcess(), (et, vl) -> ((EScmLabel)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getUpdDt(), (et, vl) -> ((EScmLabel)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getUpdUser(), (et, vl) -> ((EScmLabel)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((EScmLabel)et).getUpdProcess(), (et, vl) -> ((EScmLabel)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "e_scm_label";
    protected final String _tableDispName = "e_scm_label";
    protected final String _tablePropertyName = "EScmLabel";
    protected final TableSqlName _tableSqlName = new TableSqlName("e_scm_label", _tableDbName);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.EScmLabel"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.EScmLabelCB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.EScmLabelBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<EScmLabel> getEntityType() { return EScmLabel.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public EScmLabel newEntity() { return new EScmLabel(); }
    ...
    { doAcceptPrimaryKeyMap((EScmLabel)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((EScmLabel)et, mp); }
