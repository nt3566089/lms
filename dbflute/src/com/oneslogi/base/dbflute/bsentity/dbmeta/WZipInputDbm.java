...
public class WZipInputDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnZipInputId = cci("ZIP_INPUT_ID", "ZIP_INPUT_ID", null, null, Long.class, "zipInputId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * ZIP_INPUT_ID: {PK, ID, NotNull, BIGINT(19)}
