...
public class BDictCultureDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnDictCultureId = cci("DICT_CULTURE_ID", "DICT_CULTURE_ID", null, null, Long.class, "dictCultureId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "", null, false);
    ...
    public ForeignInfo foreignBCulture() {
        ...
        return cfi("B_DICT_CULTURE_FK1", "BCulture", this, BCultureDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "BDictCultureList", false);
    }
    /**
    ...
    public ForeignInfo foreignBDict() {
        ...
        return cfi("B_DICT_CULTURE_FK2", "BDict", this, BDictDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "BDictCultureList", false);
    }
    /**
