...
public class BUserAuthDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnPasswordModifiedDate = cci("PASSWORD_MODIFIED_DATE", "PASSWORD_MODIFIED_DATE", null, null, java.sql.Timestamp.class, "passwordModifiedDate", null, false, false, false, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnLastLoginDate = cci("LAST_LOGIN_DATE", "LAST_LOGIN_DATE", null, null, java.sql.Timestamp.class, "lastLoginDate", null, false, false, false, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnLastFailedLoginDate = cci("LAST_FAILED_LOGIN_DATE", "LAST_FAILED_LOGIN_DATE", null, null, java.sql.Timestamp.class, "lastFailedLoginDate", null, false, false, false, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnLockoutDate = cci("LOCKOUT_DATE", "LOCKOUT_DATE", null, null, java.sql.Timestamp.class, "lockoutDate", null, false, false, false, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnAvailableStartDate = cci("AVAILABLE_START_DATE", "AVAILABLE_START_DATE", null, null, java.sql.Timestamp.class, "availableStartDate", null, false, false, true, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnAvailableEndDate = cci("AVAILABLE_END_DATE", "AVAILABLE_END_DATE", null, null, java.sql.Timestamp.class, "availableEndDate", null, false, false, true, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
