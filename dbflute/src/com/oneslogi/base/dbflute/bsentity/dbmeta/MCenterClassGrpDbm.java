...
public class MCenterClassGrpDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnCenterClassGrpId = cci("CENTER_CLASS_GRP_ID", "CENTER_CLASS_GRP_ID", null, null, Long.class, "centerClassGrpId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MCenterClassGrpDtlList", null, false);
    ...
    public ReferrerInfo referrerMCenterClassGrpDtlList() {
        ...
        return cri("M_CENTER_CLASS_GRP_DTL_FK2", "MCenterClassGrpDtlList", this, MCenterClassGrpDtlDbm.getInstance(), mp, false, "MCenterClassGrp");
    }
