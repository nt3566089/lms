...
public class PPrinterGroupDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPrinterGroupId = cci("PRINTER_GROUP_ID", "PRINTER_GROUP_ID", null, null, Long.class, "printerGroupId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "PLayoutPrintSettingList,PPrinterList,PUserAutoPrintSettingByPrinterGroupIdList,PTerminalAutoPrintSetByPrinterGroupIdList", null, false);
    ...
    /**
     * PRINTER_GROUP_ID: {PK, ID, NotNull, BIGINT(19)}
