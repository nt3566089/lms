...
public class BClassDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnClassId = cci("CLASS_ID", "CLASS_ID", null, null, Long.class, "classId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "BClassDtlList,BClassGrpList", null, false);
    ...
    /**
     * CLASS_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ReferrerInfo referrerBClassDtlList() {
        ...
        return cri("B_CLASS_DTL_FK2", "BClassDtlList", this, BClassDtlDbm.getInstance(), mp, false, "BClass");
    }
    /**
