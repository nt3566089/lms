...
/**
 * The DB meta of es_receive_plan. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class EsReceivePlanDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final EsReceivePlanDbm _instance = new EsReceivePlanDbm();
    private EsReceivePlanDbm() {}
    public static EsReceivePlanDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getReceivePlanId(), (et, vl) -> ((EsReceivePlan)et).setReceivePlanId(ctl(vl)), "receivePlanId");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSendFlg(), (et, vl) -> ((EsReceivePlan)et).setSendFlg((String)vl), "sendFlg");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getStoreSlipNo(), (et, vl) -> ((EsReceivePlan)et).setStoreSlipNo((String)vl), "storeSlipNo");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getStoreSlipRowNo(), (et, vl) -> ((EsReceivePlan)et).setStoreSlipRowNo((String)vl), "storeSlipRowNo");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSlipTypeCd(), (et, vl) -> ((EsReceivePlan)et).setSlipTypeCd((String)vl), "slipTypeCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getIfId(), (et, vl) -> ((EsReceivePlan)et).setIfId((String)vl), "ifId");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getIfNo(), (et, vl) -> ((EsReceivePlan)et).setIfNo((String)vl), "ifNo");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getHinmokuCd(), (et, vl) -> ((EsReceivePlan)et).setHinmokuCd((String)vl), "hinmokuCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getHinmokuGroup(), (et, vl) -> ((EsReceivePlan)et).setHinmokuGroup((String)vl), "hinmokuGroup");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSanshaTypeCd(), (et, vl) -> ((EsReceivePlan)et).setSanshaTypeCd((String)vl), "sanshaTypeCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getReceiveReasonCd(), (et, vl) -> ((EsReceivePlan)et).setReceiveReasonCd((String)vl), "receiveReasonCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getReceiveReasonNm(), (et, vl) -> ((EsReceivePlan)et).setReceiveReasonNm((String)vl), "receiveReasonNm");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getCustomerCd(), (et, vl) -> ((EsReceivePlan)et).setCustomerCd((String)vl), "customerCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getCustomerNm(), (et, vl) -> ((EsReceivePlan)et).setCustomerNm((String)vl), "customerNm");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getOrderDate(), (et, vl) -> ((EsReceivePlan)et).setOrderDate((String)vl), "orderDate");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getOrderTime(), (et, vl) -> ((EsReceivePlan)et).setOrderTime((String)vl), "orderTime");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getConfirmedDeliveryDate(), (et, vl) -> ((EsReceivePlan)et).setConfirmedDeliveryDate((String)vl), "confirmedDeliveryDate");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getHinmokuText(), (et, vl) -> ((EsReceivePlan)et).setHinmokuText((String)vl), "hinmokuText");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getJanCd(), (et, vl) -> ((EsReceivePlan)et).setJanCd((String)vl), "janCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getUnitNm(), (et, vl) -> ((EsReceivePlan)et).setUnitNm((String)vl), "unitNm");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getReceivePlanNum(), (et, vl) -> ((EsReceivePlan)et).setReceivePlanNum((String)vl), "receivePlanNum");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getReceiveRemainingNum(), (et, vl) -> ((EsReceivePlan)et).setReceiveRemainingNum((String)vl), "receiveRemainingNum");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getStorePlantCd(), (et, vl) -> ((EsReceivePlan)et).setStorePlantCd((String)vl), "storePlantCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getStoreStorageSpaceCd(), (et, vl) -> ((EsReceivePlan)et).setStoreStorageSpaceCd((String)vl), "storeStorageSpaceCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getShippingPlantCd(), (et, vl) -> ((EsReceivePlan)et).setShippingPlantCd((String)vl), "shippingPlantCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getShippingStorageSpaceCd(), (et, vl) -> ((EsReceivePlan)et).setShippingStorageSpaceCd((String)vl), "shippingStorageSpaceCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getLotManagTypeCd(), (et, vl) -> ((EsReceivePlan)et).setLotManagTypeCd((String)vl), "lotManagTypeCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getTenhanshaCd(), (et, vl) -> ((EsReceivePlan)et).setTenhanshaCd((String)vl), "tenhanshaCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSalesOrgCd(), (et, vl) -> ((EsReceivePlan)et).setSalesOrgCd((String)vl), "salesOrgCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getTenhanshaNm1(), (et, vl) -> ((EsReceivePlan)et).setTenhanshaNm1((String)vl), "tenhanshaNm1");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getTenhanshaNm2(), (et, vl) -> ((EsReceivePlan)et).setTenhanshaNm2((String)vl), "tenhanshaNm2");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapUserCd(), (et, vl) -> ((EsReceivePlan)et).setSapUserCd((String)vl), "sapUserCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapUserNm(), (et, vl) -> ((EsReceivePlan)et).setSapUserNm((String)vl), "sapUserNm");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getModTypeCd(), (et, vl) -> ((EsReceivePlan)et).setModTypeCd((String)vl), "modTypeCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDepositJanCd(), (et, vl) -> ((EsReceivePlan)et).setDepositJanCd((String)vl), "depositJanCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getTimesNum(), (et, vl) -> ((EsReceivePlan)et).setTimesNum((String)vl), "timesNum");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getAccountOrderNo(), (et, vl) -> ((EsReceivePlan)et).setAccountOrderNo((String)vl), "accountOrderNo");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapSupplierCd(), (et, vl) -> ((EsReceivePlan)et).setSapSupplierCd((String)vl), "sapSupplierCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapVenderCd(), (et, vl) -> ((EsReceivePlan)et).setSapVenderCd((String)vl), "sapVenderCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getTodayFlg(), (et, vl) -> ((EsReceivePlan)et).setTodayFlg((String)vl), "todayFlg");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSanshaDeliverySlipNo1(), (et, vl) -> ((EsReceivePlan)et).setSanshaDeliverySlipNo1((String)vl), "sanshaDeliverySlipNo1");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTypeCd(), (et, vl) -> ((EsReceivePlan)et).setDataTypeCd((String)vl), "dataTypeCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapAddYyyy(), (et, vl) -> ((EsReceivePlan)et).setSapAddYyyy((String)vl), "sapAddYyyy");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapAddMm(), (et, vl) -> ((EsReceivePlan)et).setSapAddMm((String)vl), "sapAddMm");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapAddDd(), (et, vl) -> ((EsReceivePlan)et).setSapAddDd((String)vl), "sapAddDd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapAddHh(), (et, vl) -> ((EsReceivePlan)et).setSapAddHh((String)vl), "sapAddHh");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapAddMi(), (et, vl) -> ((EsReceivePlan)et).setSapAddMi((String)vl), "sapAddMi");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapAddSs(), (et, vl) -> ((EsReceivePlan)et).setSapAddSs((String)vl), "sapAddSs");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapAddUserCd(), (et, vl) -> ((EsReceivePlan)et).setSapAddUserCd((String)vl), "sapAddUserCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapUpdYyyy(), (et, vl) -> ((EsReceivePlan)et).setSapUpdYyyy((String)vl), "sapUpdYyyy");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapUpdMm(), (et, vl) -> ((EsReceivePlan)et).setSapUpdMm((String)vl), "sapUpdMm");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapUpdDd(), (et, vl) -> ((EsReceivePlan)et).setSapUpdDd((String)vl), "sapUpdDd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapUpdHh(), (et, vl) -> ((EsReceivePlan)et).setSapUpdHh((String)vl), "sapUpdHh");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapUpdMi(), (et, vl) -> ((EsReceivePlan)et).setSapUpdMi((String)vl), "sapUpdMi");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapUpdSs(), (et, vl) -> ((EsReceivePlan)et).setSapUpdSs((String)vl), "sapUpdSs");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSapUpdUserCd(), (et, vl) -> ((EsReceivePlan)et).setSapUpdUserCd((String)vl), "sapUpdUserCd");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr01(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr01((String)vl), "dataTransferOnlyStr01");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr02(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr02((String)vl), "dataTransferOnlyStr02");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr03(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr03((String)vl), "dataTransferOnlyStr03");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr04(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr04((String)vl), "dataTransferOnlyStr04");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr05(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr05((String)vl), "dataTransferOnlyStr05");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr06(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr06((String)vl), "dataTransferOnlyStr06");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr07(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr07((String)vl), "dataTransferOnlyStr07");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr08(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr08((String)vl), "dataTransferOnlyStr08");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr09(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr09((String)vl), "dataTransferOnlyStr09");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr10(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr10((String)vl), "dataTransferOnlyStr10");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr11(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr11((String)vl), "dataTransferOnlyStr11");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr12(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr12((String)vl), "dataTransferOnlyStr12");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr13(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr13((String)vl), "dataTransferOnlyStr13");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr14(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr14((String)vl), "dataTransferOnlyStr14");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr15(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr15((String)vl), "dataTransferOnlyStr15");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr16(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr16((String)vl), "dataTransferOnlyStr16");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr17(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr17((String)vl), "dataTransferOnlyStr17");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr18(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr18((String)vl), "dataTransferOnlyStr18");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr19(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr19((String)vl), "dataTransferOnlyStr19");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr20(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr20((String)vl), "dataTransferOnlyStr20");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr21(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr21((String)vl), "dataTransferOnlyStr21");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr22(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr22((String)vl), "dataTransferOnlyStr22");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr23(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr23((String)vl), "dataTransferOnlyStr23");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr24(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr24((String)vl), "dataTransferOnlyStr24");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr25(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr25((String)vl), "dataTransferOnlyStr25");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr26(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr26((String)vl), "dataTransferOnlyStr26");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr27(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr27((String)vl), "dataTransferOnlyStr27");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDataTransferOnlyStr28(), (et, vl) -> ((EsReceivePlan)et).setDataTransferOnlyStr28((String)vl), "dataTransferOnlyStr28");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getSpareStr(), (et, vl) -> ((EsReceivePlan)et).setSpareStr((String)vl), "spareStr");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getDelFlg(), (et, vl) -> ((EsReceivePlan)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getVersionNo(), (et, vl) -> ((EsReceivePlan)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getControlNo(), (et, vl) -> ((EsReceivePlan)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getAddDt(), (et, vl) -> ((EsReceivePlan)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getAddUser(), (et, vl) -> ((EsReceivePlan)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getAddProcess(), (et, vl) -> ((EsReceivePlan)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getUpdDt(), (et, vl) -> ((EsReceivePlan)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getUpdUser(), (et, vl) -> ((EsReceivePlan)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((EsReceivePlan)et).getUpdProcess(), (et, vl) -> ((EsReceivePlan)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "es_receive_plan";
    protected final String _tableDispName = "es_receive_plan";
    protected final String _tablePropertyName = "esReceivePlan";
    protected final TableSqlName _tableSqlName = new TableSqlName("es_receive_plan", _tableDbName);
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnReceivePlanId = cci("RECEIVE_PLAN_ID", "RECEIVE_PLAN_ID", null, null, Long.class, "receivePlanId", null, true, false, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.EsReceivePlan"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.EsReceivePlanCB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.EsReceivePlanBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<EsReceivePlan> getEntityType() { return EsReceivePlan.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public EsReceivePlan newEntity() { return new EsReceivePlan(); }
    ...
    { doAcceptPrimaryKeyMap((EsReceivePlan)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((EsReceivePlan)et, mp); }
