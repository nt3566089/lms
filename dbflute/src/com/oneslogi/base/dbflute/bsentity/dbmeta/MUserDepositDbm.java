...
public class MUserDepositDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnUserDepositId = cci("USER_DEPOSIT_ID", "USER_DEPOSIT_ID", null, null, Long.class, "userDepositId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * USER_DEPOSIT_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ForeignInfo foreignMCustomer() {
        ...
        return cfi("M_USER_DEPOSIT_FK1", "MCustomer", this, MCustomerDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "MUserDepositList", false);
    }
    /**
    ...
    public ForeignInfo foreignBUser() {
        ...
        return cfi("M_USER_DEPOSIT_FK2", "BUser", this, BUserDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "MUserDepositList", false);
    }
