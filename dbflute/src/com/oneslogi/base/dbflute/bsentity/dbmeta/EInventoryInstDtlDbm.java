...
/**
 * The DB meta of e_inventory_inst_dtl. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class EInventoryInstDtlDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final EInventoryInstDtlDbm _instance = new EInventoryInstDtlDbm();
    private EInventoryInstDtlDbm() {}
    public static EInventoryInstDtlDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getInventoryInstDtlId(), (et, vl) -> ((EInventoryInstDtl)et).setInventoryInstDtlId(ctl(vl)), "inventoryInstDtlId");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getReceiveCd(), (et, vl) -> ((EInventoryInstDtl)et).setReceiveCd((String)vl), "receiveCd");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getReceiveRowId(), (et, vl) -> ((EInventoryInstDtl)et).setReceiveRowId(ctl(vl)), "receiveRowId");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getImportFlg(), (et, vl) -> ((EInventoryInstDtl)et).setImportFlg((String)vl), "importFlg");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getErrorFlg(), (et, vl) -> ((EInventoryInstDtl)et).setErrorFlg((String)vl), "errorFlg");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getErrorMessageCd(), (et, vl) -> ((EInventoryInstDtl)et).setErrorMessageCd((String)vl), "errorMessageCd");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getInventorySlipNo(), (et, vl) -> ((EInventoryInstDtl)et).setInventorySlipNo((String)vl), "inventorySlipNo");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getInventorySlipRowNo(), (et, vl) -> ((EInventoryInstDtl)et).setInventorySlipRowNo((String)vl), "inventorySlipRowNo");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getPlantCd(), (et, vl) -> ((EInventoryInstDtl)et).setPlantCd((String)vl), "plantCd");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getStorageSpaceCd(), (et, vl) -> ((EInventoryInstDtl)et).setStorageSpaceCd((String)vl), "storageSpaceCd");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getReferenceDt(), (et, vl) -> ((EInventoryInstDtl)et).setReferenceDt((String)vl), "referenceDt");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getUnitNm(), (et, vl) -> ((EInventoryInstDtl)et).setUnitNm((String)vl), "unitNm");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapAddYyyy(), (et, vl) -> ((EInventoryInstDtl)et).setSapAddYyyy((String)vl), "sapAddYyyy");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapAddMm(), (et, vl) -> ((EInventoryInstDtl)et).setSapAddMm((String)vl), "sapAddMm");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapAddDd(), (et, vl) -> ((EInventoryInstDtl)et).setSapAddDd((String)vl), "sapAddDd");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapAddHh(), (et, vl) -> ((EInventoryInstDtl)et).setSapAddHh((String)vl), "sapAddHh");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapAddMi(), (et, vl) -> ((EInventoryInstDtl)et).setSapAddMi((String)vl), "sapAddMi");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapAddSs(), (et, vl) -> ((EInventoryInstDtl)et).setSapAddSs((String)vl), "sapAddSs");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapAddUserCd(), (et, vl) -> ((EInventoryInstDtl)et).setSapAddUserCd((String)vl), "sapAddUserCd");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapUpdYyyy(), (et, vl) -> ((EInventoryInstDtl)et).setSapUpdYyyy((String)vl), "sapUpdYyyy");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapUpdMm(), (et, vl) -> ((EInventoryInstDtl)et).setSapUpdMm((String)vl), "sapUpdMm");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapUpdDd(), (et, vl) -> ((EInventoryInstDtl)et).setSapUpdDd((String)vl), "sapUpdDd");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapUpdHh(), (et, vl) -> ((EInventoryInstDtl)et).setSapUpdHh((String)vl), "sapUpdHh");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapUpdMi(), (et, vl) -> ((EInventoryInstDtl)et).setSapUpdMi((String)vl), "sapUpdMi");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapUpdSs(), (et, vl) -> ((EInventoryInstDtl)et).setSapUpdSs((String)vl), "sapUpdSs");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapUpdUserCd(), (et, vl) -> ((EInventoryInstDtl)et).setSapUpdUserCd((String)vl), "sapUpdUserCd");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getProductNmKanji(), (et, vl) -> ((EInventoryInstDtl)et).setProductNmKanji((String)vl), "productNmKanji");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getBarcode(), (et, vl) -> ((EInventoryInstDtl)et).setBarcode((String)vl), "barcode");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getDepositJanCd(), (et, vl) -> ((EInventoryInstDtl)et).setDepositJanCd((String)vl), "depositJanCd");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getTenhanshaCd(), (et, vl) -> ((EInventoryInstDtl)et).setTenhanshaCd((String)vl), "tenhanshaCd");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getTenhanshaNm1(), (et, vl) -> ((EInventoryInstDtl)et).setTenhanshaNm1((String)vl), "tenhanshaNm1");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getTenhanshaNm2(), (et, vl) -> ((EInventoryInstDtl)et).setTenhanshaNm2((String)vl), "tenhanshaNm2");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapUserCd(), (et, vl) -> ((EInventoryInstDtl)et).setSapUserCd((String)vl), "sapUserCd");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSapUserNm(), (et, vl) -> ((EInventoryInstDtl)et).setSapUserNm((String)vl), "sapUserNm");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getProductType(), (et, vl) -> ((EInventoryInstDtl)et).setProductType((String)vl), "productType");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getAllocTypeCd(), (et, vl) -> ((EInventoryInstDtl)et).setAllocTypeCd((String)vl), "allocTypeCd");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getSpareStr(), (et, vl) -> ((EInventoryInstDtl)et).setSpareStr((String)vl), "spareStr");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getDelFlg(), (et, vl) -> ((EInventoryInstDtl)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getVersionNo(), (et, vl) -> ((EInventoryInstDtl)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getControlNo(), (et, vl) -> ((EInventoryInstDtl)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getAddDt(), (et, vl) -> ((EInventoryInstDtl)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getAddUser(), (et, vl) -> ((EInventoryInstDtl)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getAddProcess(), (et, vl) -> ((EInventoryInstDtl)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getUpdDt(), (et, vl) -> ((EInventoryInstDtl)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getUpdUser(), (et, vl) -> ((EInventoryInstDtl)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((EInventoryInstDtl)et).getUpdProcess(), (et, vl) -> ((EInventoryInstDtl)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "e_inventory_inst_dtl";
    protected final String _tableDispName = "e_inventory_inst_dtl";
    protected final String _tablePropertyName = "EInventoryInstDtl";
    protected final TableSqlName _tableSqlName = new TableSqlName("e_inventory_inst_dtl", _tableDbName);
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnInventoryInstDtlId = cci("INVENTORY_INST_DTL_ID", "INVENTORY_INST_DTL_ID", null, null, Long.class, "inventoryInstDtlId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.EInventoryInstDtl"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.EInventoryInstDtlCB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.EInventoryInstDtlBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<EInventoryInstDtl> getEntityType() { return EInventoryInstDtl.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public EInventoryInstDtl newEntity() { return new EInventoryInstDtl(); }
    ...
    { doAcceptPrimaryKeyMap((EInventoryInstDtl)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((EInventoryInstDtl)et, mp); }
