...
public class HReceiveHDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnStoreRecordHId = cci("STORE_RECORD_H_ID", "STORE_RECORD_H_ID", null, null, Long.class, "storeRecordHId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "HReceiveBList", null, false);
    ...
    public ReferrerInfo referrerHReceiveBList() {
        ...
        return cri("H_RECEIVE_B_FK1", "HReceiveBList", this, HReceiveBDbm.getInstance(), mp, false, "HReceiveH");
    }
