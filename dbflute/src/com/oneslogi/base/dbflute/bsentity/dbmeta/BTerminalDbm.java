...
public class BTerminalDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnTerminalId = cci("TERMINAL_ID", "TERMINAL_ID", null, null, Long.class, "terminalId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * TERMINAL_ID: {PK, ID, NotNull, BIGINT(19)}
