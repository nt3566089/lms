...
public class TAllocInstBDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((TAllocInstB)et).getProdDt(), (et, vl) -> ((TAllocInstB)et).setProdDt((String)vl), "prodDt");
        setupEpg(_epgMap, et -> ((TAllocInstB)et).getProdDtManagFlg(), (et, vl) -> ((TAllocInstB)et).setProdDtManagFlg((String)vl), "prodDtManagFlg");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnAllocInstBId = cci("ALLOC_INST_B_ID", "ALLOC_INST_B_ID", null, null, Long.class, "allocInstBId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "TPackingBList,TPickingBList,TShippingInstBList,TStockInoutList", null, false);
    ...
    public ForeignInfo foreignMLocation() {
        ...
        return cfi("T_ALLOC_INST_B_FK7", "MLocation", this, MLocationDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "TAllocInstBList", false);
    }
    /**
    ...
    public ForeignInfo foreignMStockType() {
        ...
        return cfi("T_ALLOC_INST_B_FK9", "MStockType", this, MStockTypeDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "TAllocInstBList", false);
    }
    /**
    ...
    public ForeignInfo foreignTLot() {
        ...
        return cfi("T_ALLOC_INST_B_FK3", "TLot", this, TLotDbm.getInstance(), mp, 2, null, false, false, false, false, null, null, false, "TAllocInstBList", false);
    }
    /**
    ...
    public ForeignInfo foreignMWarehouse() {
        ...
        return cfi("T_ALLOC_INST_B_FK6", "MWarehouse", this, MWarehouseDbm.getInstance(), mp, 3, null, false, false, false, false, null, null, false, "TAllocInstBList", false);
    }
    /**
    ...
    public ForeignInfo foreignMCustomer() {
        ...
        return cfi("T_ALLOC_INST_B_FK1", "MCustomer", this, MCustomerDbm.getInstance(), mp, 4, null, false, false, false, false, null, null, false, "TAllocInstBList", false);
    }
    /**
    ...
    public ForeignInfo foreignTAllocInstH() {
        ...
        return cfi("T_ALLOC_INST_B_FK5", "TAllocInstH", this, TAllocInstHDbm.getInstance(), mp, 5, null, false, false, false, false, null, null, false, "TAllocInstBList", false);
    }
    /**
    ...
    public ForeignInfo foreignMProduct() {
        ...
        return cfi("T_ALLOC_INST_B_FK8", "MProduct", this, MProductDbm.getInstance(), mp, 6, null, false, false, false, false, null, null, false, "TAllocInstBList", false);
    }
    /**
    ...
    public ForeignInfo foreignTStoreNo() {
        ...
        return cfi("T_ALLOC_INST_B_FK4", "TStoreNo", this, TStoreNoDbm.getInstance(), mp, 7, null, false, false, false, false, null, null, false, "TAllocInstBList", false);
    }
    /**
    ...
    public ForeignInfo foreignMShape() {
        ...
        return cfi("T_ALLOC_INST_B_FK2", "MShape", this, MShapeDbm.getInstance(), mp, 8, null, false, false, false, false, null, null, false, "TAllocInstBList", false);
    }
    /**
    ...
    public ReferrerInfo referrerTPackingBList() {
        ...
        return cri("T_PACKING_B_FK3", "TPackingBList", this, TPackingBDbm.getInstance(), mp, false, "TAllocInstB");
    }
    /**
