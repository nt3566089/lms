...
public class BArgDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnArgId = cci("ARG_ID", "ARG_ID", null, null, Long.class, "argId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "", null, false);
    ...
    /**
     * ARG_ID: {PK, ID, NotNull, BIGINT(19)}
