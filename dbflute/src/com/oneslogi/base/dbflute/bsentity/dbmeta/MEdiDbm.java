...
public class MEdiDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnEdiId = cci("EDI_ID", "EDI_ID", null, null, Long.class, "ediId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MEdiColumnList,MImportTypeList", null, false);
    ...
    /**
     * EDI_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ReferrerInfo referrerMImportTypeList() {
        ...
        return cri("M_IMPORT_TYPE_FK2", "MImportTypeList", this, MImportTypeDbm.getInstance(), mp, false, "MEdi");
    }
