...
public class PReportLayoutDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnReportLayoutId = cci("REPORT_LAYOUT_ID", "REPORT_LAYOUT_ID", null, null, Long.class, "reportLayoutId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "PReportLayoutItemList,PUserAutoPrintSettingByReportLayoutIdList,PTerminalAutoPrintSetByReportLayoutIdList", null, false);
    ...
    protected final ColumnInfo _columnReportLayoutData = cci("REPORT_LAYOUT_DATA", "REPORT_LAYOUT_DATA", null, null, String.class, "reportLayoutData", null, false, false, true, "LONGTEXT", 2147483647, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * REPORT_LAYOUT_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    /**
     * REPORT_LAYOUT_DATA: {NotNull, LONGTEXT(2147483647)}
     * @return The information object of specified column. (NotNull)
     */
    ...
    public ForeignInfo foreignPLayoutPrintSettingAsOne() {
        ...
        return cfi("P_LAYOUT_PRINT_SETTING_FK3", "PLayoutPrintSettingAsOne", this, PLayoutPrintSettingDbm.getInstance(), mp, 3, null, true, false, true, false, null, null, false, "PReportLayout", false);
    }
    /**
    ...
    public ReferrerInfo referrerPReportLayoutItemList() {
        ...
        return cri("P_REPORT_LAYOUT_ITEM_FK1", "PReportLayoutItemList", this, PReportLayoutItemDbm.getInstance(), mp, false, "PReportLayout");
    }
    /**
