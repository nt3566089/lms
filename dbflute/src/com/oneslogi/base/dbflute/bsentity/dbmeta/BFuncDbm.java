...
public class BFuncDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnFuncId = cci("FUNC_ID", "FUNC_ID", null, null, Long.class, "funcId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "BArgList,BFuncRoleList", null, false);
    ...
    /**
     * FUNC_ID: {PK, ID, NotNull, BIGINT(19)}
