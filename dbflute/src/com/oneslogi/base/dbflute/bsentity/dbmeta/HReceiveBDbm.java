...
public class HReceiveBDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnStoreRecordBId = cci("STORE_RECORD_B_ID", "STORE_RECORD_B_ID", null, null, Long.class, "storeRecordBId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "", null, false);
    ...
    public ForeignInfo foreignHReceiveH() {
        ...
        return cfi("H_RECEIVE_B_FK1", "HReceiveH", this, HReceiveHDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "HReceiveBList", false);
    }
    /**
    ...
    public ForeignInfo foreignHStock() {
        ...
        return cfi("H_RECEIVE_B_FK2", "HStock", this, HStockDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "HReceiveBList", false);
    }
    /**
