...
/**
 * The DB meta of es_stock_record. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class EsStockRecordDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final EsStockRecordDbm _instance = new EsStockRecordDbm();
    private EsStockRecordDbm() {}
    public static EsStockRecordDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getPackingListId(), (et, vl) -> ((EsStockRecord)et).setPackingListId(ctl(vl)), "packingListId");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getReceiveCd(), (et, vl) -> ((EsStockRecord)et).setReceiveCd((String)vl), "receiveCd");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getReceiveRowId(), (et, vl) -> ((EsStockRecord)et).setReceiveRowId(ctl(vl)), "receiveRowId");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getImportFlg(), (et, vl) -> ((EsStockRecord)et).setImportFlg((String)vl), "importFlg");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getErrorFlg(), (et, vl) -> ((EsStockRecord)et).setErrorFlg((String)vl), "errorFlg");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getErrorMessageCd(), (et, vl) -> ((EsStockRecord)et).setErrorMessageCd((String)vl), "errorMessageCd");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getShippingSlipNo(), (et, vl) -> ((EsStockRecord)et).setShippingSlipNo((String)vl), "shippingSlipNo");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getPackingNo(), (et, vl) -> ((EsStockRecord)et).setPackingNo((String)vl), "packingNo");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getPackingRowNo(), (et, vl) -> ((EsStockRecord)et).setPackingRowNo((String)vl), "packingRowNo");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getShippingSlipRowNo(), (et, vl) -> ((EsStockRecord)et).setShippingSlipRowNo((String)vl), "shippingSlipRowNo");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getShippingSlipRowNoSn(), (et, vl) -> ((EsStockRecord)et).setShippingSlipRowNoSn((String)vl), "shippingSlipRowNoSn");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getHinmokuCd(), (et, vl) -> ((EsStockRecord)et).setHinmokuCd((String)vl), "hinmokuCd");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getNum(), (et, vl) -> ((EsStockRecord)et).setNum((String)vl), "num");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getCarrierSlipNo(), (et, vl) -> ((EsStockRecord)et).setCarrierSlipNo((String)vl), "carrierSlipNo");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsAddYyyy(), (et, vl) -> ((EsStockRecord)et).setWmsAddYyyy((String)vl), "wmsAddYyyy");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsAddMm(), (et, vl) -> ((EsStockRecord)et).setWmsAddMm((String)vl), "wmsAddMm");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsAddDd(), (et, vl) -> ((EsStockRecord)et).setWmsAddDd((String)vl), "wmsAddDd");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsAddHh(), (et, vl) -> ((EsStockRecord)et).setWmsAddHh((String)vl), "wmsAddHh");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsAddMi(), (et, vl) -> ((EsStockRecord)et).setWmsAddMi((String)vl), "wmsAddMi");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsAddSs(), (et, vl) -> ((EsStockRecord)et).setWmsAddSs((String)vl), "wmsAddSs");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsAddUserCd(), (et, vl) -> ((EsStockRecord)et).setWmsAddUserCd((String)vl), "wmsAddUserCd");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsUpdYyyy(), (et, vl) -> ((EsStockRecord)et).setWmsUpdYyyy((String)vl), "wmsUpdYyyy");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsUpdMm(), (et, vl) -> ((EsStockRecord)et).setWmsUpdMm((String)vl), "wmsUpdMm");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsUpdDd(), (et, vl) -> ((EsStockRecord)et).setWmsUpdDd((String)vl), "wmsUpdDd");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsUpdHh(), (et, vl) -> ((EsStockRecord)et).setWmsUpdHh((String)vl), "wmsUpdHh");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsUpdMi(), (et, vl) -> ((EsStockRecord)et).setWmsUpdMi((String)vl), "wmsUpdMi");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsUpdSs(), (et, vl) -> ((EsStockRecord)et).setWmsUpdSs((String)vl), "wmsUpdSs");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getWmsUpdUserCd(), (et, vl) -> ((EsStockRecord)et).setWmsUpdUserCd((String)vl), "wmsUpdUserCd");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getSpareStr(), (et, vl) -> ((EsStockRecord)et).setSpareStr((String)vl), "spareStr");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getDelFlg(), (et, vl) -> ((EsStockRecord)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getVersionNo(), (et, vl) -> ((EsStockRecord)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getControlNo(), (et, vl) -> ((EsStockRecord)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getAddDt(), (et, vl) -> ((EsStockRecord)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getAddUser(), (et, vl) -> ((EsStockRecord)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getAddProcess(), (et, vl) -> ((EsStockRecord)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getUpdDt(), (et, vl) -> ((EsStockRecord)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getUpdUser(), (et, vl) -> ((EsStockRecord)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((EsStockRecord)et).getUpdProcess(), (et, vl) -> ((EsStockRecord)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "es_stock_record";
    protected final String _tableDispName = "es_stock_record";
    protected final String _tablePropertyName = "esStockRecord";
    protected final TableSqlName _tableSqlName = new TableSqlName("es_stock_record", _tableDbName);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.EsStockRecord"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.EsStockRecordCB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.EsStockRecordBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<EsStockRecord> getEntityType() { return EsStockRecord.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public EsStockRecord newEntity() { return new EsStockRecord(); }
    ...
    { doAcceptPrimaryKeyMap((EsStockRecord)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((EsStockRecord)et, mp); }
