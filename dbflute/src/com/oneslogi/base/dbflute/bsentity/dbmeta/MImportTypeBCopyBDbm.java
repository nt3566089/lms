...
public class MImportTypeBCopyBDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnImportTypeBCopyBId = cci("IMPORT_TYPE_B_COPY_B_ID", "IMPORT_TYPE_B_COPY_B_ID", null, null, Long.class, "importTypeBCopyBId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * IMPORT_TYPE_B_COPY_B_ID: {PK, ID, NotNull, BIGINT(19)}
