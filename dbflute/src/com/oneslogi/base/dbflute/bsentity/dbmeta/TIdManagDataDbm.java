...
/**
 * The DB meta of t_id_manag_data. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class TIdManagDataDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final TIdManagDataDbm _instance = new TIdManagDataDbm();
    private TIdManagDataDbm() {}
    public static TIdManagDataDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((TIdManagData)et).getIdManagDataId(), (et, vl) -> ((TIdManagData)et).setIdManagDataId(ctl(vl)), "idManagDataId");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getIdManagNo(), (et, vl) -> ((TIdManagData)et).setIdManagNo((String)vl), "idManagNo");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getTenhanshaCd(), (et, vl) -> ((TIdManagData)et).setTenhanshaCd((String)vl), "tenhanshaCd");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getSalesOrgCd(), (et, vl) -> ((TIdManagData)et).setSalesOrgCd((String)vl), "salesOrgCd");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getCustomerCd(), (et, vl) -> ((TIdManagData)et).setCustomerCd((String)vl), "customerCd");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getProductCd(), (et, vl) -> ((TIdManagData)et).setProductCd((String)vl), "productCd");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getHinmokuText(), (et, vl) -> ((TIdManagData)et).setHinmokuText((String)vl), "hinmokuText");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getJanCd(), (et, vl) -> ((TIdManagData)et).setJanCd((String)vl), "janCd");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getUnitNm(), (et, vl) -> ((TIdManagData)et).setUnitNm((String)vl), "unitNm");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getSharedProductTypeCd(), (et, vl) -> ((TIdManagData)et).setSharedProductTypeCd((String)vl), "sharedProductTypeCd");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getCustomerOrderNo(), (et, vl) -> ((TIdManagData)et).setCustomerOrderNo((String)vl), "customerOrderNo");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDelivCd(), (et, vl) -> ((TIdManagData)et).setDelivCd((String)vl), "delivCd");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDestinationZipCd(), (et, vl) -> ((TIdManagData)et).setDestinationZipCd((String)vl), "destinationZipCd");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDestinationAddress1(), (et, vl) -> ((TIdManagData)et).setDestinationAddress1((String)vl), "destinationAddress1");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDestinationAddress2(), (et, vl) -> ((TIdManagData)et).setDestinationAddress2((String)vl), "destinationAddress2");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDestinationNm1(), (et, vl) -> ((TIdManagData)et).setDestinationNm1((String)vl), "destinationNm1");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDestinationNm2(), (et, vl) -> ((TIdManagData)et).setDestinationNm2((String)vl), "destinationNm2");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDestinationTel(), (et, vl) -> ((TIdManagData)et).setDestinationTel((String)vl), "destinationTel");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getEmpIdCd(), (et, vl) -> ((TIdManagData)et).setEmpIdCd((String)vl), "empIdCd");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getEmpNm(), (et, vl) -> ((TIdManagData)et).setEmpNm((String)vl), "empNm");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getStoreDt(), (et, vl) -> ((TIdManagData)et).setStoreDt((String)vl), "storeDt");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getInventoryDt(), (et, vl) -> ((TIdManagData)et).setInventoryDt((String)vl), "inventoryDt");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getPickingDt(), (et, vl) -> ((TIdManagData)et).setPickingDt((String)vl), "pickingDt");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getProductReturnDt(), (et, vl) -> ((TIdManagData)et).setProductReturnDt((String)vl), "productReturnDt");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getWasteReturnDt(), (et, vl) -> ((TIdManagData)et).setWasteReturnDt((String)vl), "wasteReturnDt");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getIdManagAbolitionTypeCd(), (et, vl) -> ((TIdManagData)et).setIdManagAbolitionTypeCd((String)vl), "idManagAbolitionTypeCd");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getSpareTypeCd(), (et, vl) -> ((TIdManagData)et).setSpareTypeCd((String)vl), "spareTypeCd");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDataExtFlgPicking(), (et, vl) -> ((TIdManagData)et).setDataExtFlgPicking((String)vl), "dataExtFlgPicking");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDataAddDtPicking(), (et, vl) -> ((TIdManagData)et).setDataAddDtPicking((String)vl), "dataAddDtPicking");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDataExtFlgReturn(), (et, vl) -> ((TIdManagData)et).setDataExtFlgReturn((String)vl), "dataExtFlgReturn");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDataAddDtReturn(), (et, vl) -> ((TIdManagData)et).setDataAddDtReturn((String)vl), "dataAddDtReturn");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDataExtFlgWaste(), (et, vl) -> ((TIdManagData)et).setDataExtFlgWaste((String)vl), "dataExtFlgWaste");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDataAddDtWaste(), (et, vl) -> ((TIdManagData)et).setDataAddDtWaste((String)vl), "dataAddDtWaste");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getCmSendFlg(), (et, vl) -> ((TIdManagData)et).setCmSendFlg((String)vl), "cmSendFlg");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getDelFlg(), (et, vl) -> ((TIdManagData)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getVersionNo(), (et, vl) -> ((TIdManagData)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getControlNo(), (et, vl) -> ((TIdManagData)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getAddDt(), (et, vl) -> ((TIdManagData)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getAddUser(), (et, vl) -> ((TIdManagData)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getAddProcess(), (et, vl) -> ((TIdManagData)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getUpdDt(), (et, vl) -> ((TIdManagData)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getUpdUser(), (et, vl) -> ((TIdManagData)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((TIdManagData)et).getUpdProcess(), (et, vl) -> ((TIdManagData)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "t_id_manag_data";
    protected final String _tableDispName = "t_id_manag_data";
    protected final String _tablePropertyName = "TIdManagData";
    protected final TableSqlName _tableSqlName = new TableSqlName("t_id_manag_data", _tableDbName);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.TIdManagData"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.TIdManagDataCB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.TIdManagDataBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<TIdManagData> getEntityType() { return TIdManagData.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public TIdManagData newEntity() { return new TIdManagData(); }
    ...
    { doAcceptPrimaryKeyMap((TIdManagData)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((TIdManagData)et, mp); }
