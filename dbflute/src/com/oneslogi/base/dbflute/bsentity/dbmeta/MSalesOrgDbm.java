...
public class MSalesOrgDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnSalesOrgCd = cci("SALES_ORG_CD", "SALES_ORG_CD", null, null, String.class, "salesOrgCd", null, false, false, false, "VARCHAR", 30, 0, null, null, false, null, null, null, "TShippingInstHBySalesOrgList", null, false);
     ...
     * @return The information object of referrer property. (NotNull)
     */
    public ReferrerInfo referrerTShippingInstHBySalesOrgList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnSalesOrgCd(), TShippingInstHDbm.getInstance().columnSalesOrgCd());
        return cri("FK_T_SHIPPING_INST_H_TO_M_SALES_ORG", "TShippingInstHBySalesOrgList", this, TShippingInstHDbm.getInstance(), mp, false, "MSalesOrgBySalesOrg");
    }
