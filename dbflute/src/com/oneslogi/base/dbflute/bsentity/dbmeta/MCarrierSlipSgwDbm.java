...
public class MCarrierSlipSgwDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnCarrierSlipSgwId = cci("CARRIER_SLIP_SGW_ID", "CARRIER_SLIP_SGW_ID", null, null, Long.class, "carrierSlipSgwId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MDeliveryCourseList", null, false);
    ...
    /**
     * CARRIER_SLIP_SGW_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ReferrerInfo referrerMDeliveryCourseList() {
        ...
        return cri("M_DELIVERY_COURSE_FK2", "MDeliveryCourseList", this, MDeliveryCourseDbm.getInstance(), mp, false, "MCarrierSlipSgw");
    }
