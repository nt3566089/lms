...
/**
 * The DB meta of er_receive_report. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class ErReceiveReportDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final ErReceiveReportDbm _instance = new ErReceiveReportDbm();
    private ErReceiveReportDbm() {}
    public static ErReceiveReportDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getReceiveReportId(), (et, vl) -> ((ErReceiveReport)et).setReceiveReportId(ctl(vl)), "receiveReportId");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getReceiveCd(), (et, vl) -> ((ErReceiveReport)et).setReceiveCd((String)vl), "receiveCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getReceiveRowId(), (et, vl) -> ((ErReceiveReport)et).setReceiveRowId(ctl(vl)), "receiveRowId");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getImportFlg(), (et, vl) -> ((ErReceiveReport)et).setImportFlg((String)vl), "importFlg");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getErrorFlg(), (et, vl) -> ((ErReceiveReport)et).setErrorFlg((String)vl), "errorFlg");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getErrorMessageCd(), (et, vl) -> ((ErReceiveReport)et).setErrorMessageCd((String)vl), "errorMessageCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getStoreSlipNo(), (et, vl) -> ((ErReceiveReport)et).setStoreSlipNo((String)vl), "storeSlipNo");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getStoreSlipRowNo(), (et, vl) -> ((ErReceiveReport)et).setStoreSlipRowNo((String)vl), "storeSlipRowNo");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getSlipTypeCd(), (et, vl) -> ((ErReceiveReport)et).setSlipTypeCd((String)vl), "slipTypeCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getSn(), (et, vl) -> ((ErReceiveReport)et).setSn(ctl(vl)), "sn");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getIfId(), (et, vl) -> ((ErReceiveReport)et).setIfId((String)vl), "ifId");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getIfNo(), (et, vl) -> ((ErReceiveReport)et).setIfNo((String)vl), "ifNo");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getHinmokuCd(), (et, vl) -> ((ErReceiveReport)et).setHinmokuCd((String)vl), "hinmokuCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getJanCd(), (et, vl) -> ((ErReceiveReport)et).setJanCd((String)vl), "janCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getStoreReasonCd(), (et, vl) -> ((ErReceiveReport)et).setStoreReasonCd((String)vl), "storeReasonCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getStoreDt(), (et, vl) -> ((ErReceiveReport)et).setStoreDt((String)vl), "storeDt");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getNum(), (et, vl) -> ((ErReceiveReport)et).setNum(ctb(vl)), "num");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getLotManagTypeCd(), (et, vl) -> ((ErReceiveReport)et).setLotManagTypeCd((String)vl), "lotManagTypeCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getLot(), (et, vl) -> ((ErReceiveReport)et).setLot((String)vl), "lot");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getReceiveNo(), (et, vl) -> ((ErReceiveReport)et).setReceiveNo((String)vl), "receiveNo");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getShippingPlantCd(), (et, vl) -> ((ErReceiveReport)et).setShippingPlantCd((String)vl), "shippingPlantCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getShippingStorageSpaceCd(), (et, vl) -> ((ErReceiveReport)et).setShippingStorageSpaceCd((String)vl), "shippingStorageSpaceCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getStorePlantCd(), (et, vl) -> ((ErReceiveReport)et).setStorePlantCd((String)vl), "storePlantCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getStoreStorageSpaceCd(), (et, vl) -> ((ErReceiveReport)et).setStoreStorageSpaceCd((String)vl), "storeStorageSpaceCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getTenhanshaCd(), (et, vl) -> ((ErReceiveReport)et).setTenhanshaCd((String)vl), "tenhanshaCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getSalesOrgCd(), (et, vl) -> ((ErReceiveReport)et).setSalesOrgCd((String)vl), "salesOrgCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getSanshaDeliverySlipNo1(), (et, vl) -> ((ErReceiveReport)et).setSanshaDeliverySlipNo1((String)vl), "sanshaDeliverySlipNo1");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getDataTypeCd(), (et, vl) -> ((ErReceiveReport)et).setDataTypeCd((String)vl), "dataTypeCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getProcessTypeCd(), (et, vl) -> ((ErReceiveReport)et).setProcessTypeCd((String)vl), "processTypeCd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getSlipNo(), (et, vl) -> ((ErReceiveReport)et).setSlipNo((String)vl), "slipNo");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsAddYyyy(), (et, vl) -> ((ErReceiveReport)et).setWmsAddYyyy((String)vl), "wmsAddYyyy");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsAddMm(), (et, vl) -> ((ErReceiveReport)et).setWmsAddMm((String)vl), "wmsAddMm");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsAddDd(), (et, vl) -> ((ErReceiveReport)et).setWmsAddDd((String)vl), "wmsAddDd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsAddHh(), (et, vl) -> ((ErReceiveReport)et).setWmsAddHh((String)vl), "wmsAddHh");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsAddMi(), (et, vl) -> ((ErReceiveReport)et).setWmsAddMi((String)vl), "wmsAddMi");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsAddSs(), (et, vl) -> ((ErReceiveReport)et).setWmsAddSs((String)vl), "wmsAddSs");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsAddUserNm(), (et, vl) -> ((ErReceiveReport)et).setWmsAddUserNm((String)vl), "wmsAddUserNm");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsUpdYyyy(), (et, vl) -> ((ErReceiveReport)et).setWmsUpdYyyy((String)vl), "wmsUpdYyyy");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsUpdMm(), (et, vl) -> ((ErReceiveReport)et).setWmsUpdMm((String)vl), "wmsUpdMm");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsUpdDd(), (et, vl) -> ((ErReceiveReport)et).setWmsUpdDd((String)vl), "wmsUpdDd");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsUpdHh(), (et, vl) -> ((ErReceiveReport)et).setWmsUpdHh((String)vl), "wmsUpdHh");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsUpdMi(), (et, vl) -> ((ErReceiveReport)et).setWmsUpdMi((String)vl), "wmsUpdMi");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsUpdSs(), (et, vl) -> ((ErReceiveReport)et).setWmsUpdSs((String)vl), "wmsUpdSs");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getWmsUpdUserNm(), (et, vl) -> ((ErReceiveReport)et).setWmsUpdUserNm((String)vl), "wmsUpdUserNm");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getDataTransferOnlyStr01(), (et, vl) -> ((ErReceiveReport)et).setDataTransferOnlyStr01((String)vl), "dataTransferOnlyStr01");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getSpareStr(), (et, vl) -> ((ErReceiveReport)et).setSpareStr((String)vl), "spareStr");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getDelFlg(), (et, vl) -> ((ErReceiveReport)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getVersionNo(), (et, vl) -> ((ErReceiveReport)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getControlNo(), (et, vl) -> ((ErReceiveReport)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getAddDt(), (et, vl) -> ((ErReceiveReport)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getAddUser(), (et, vl) -> ((ErReceiveReport)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getAddProcess(), (et, vl) -> ((ErReceiveReport)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getUpdDt(), (et, vl) -> ((ErReceiveReport)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getUpdUser(), (et, vl) -> ((ErReceiveReport)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((ErReceiveReport)et).getUpdProcess(), (et, vl) -> ((ErReceiveReport)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "er_receive_report";
    protected final String _tableDispName = "er_receive_report";
    protected final String _tablePropertyName = "erReceiveReport";
    protected final TableSqlName _tableSqlName = new TableSqlName("er_receive_report", _tableDbName);
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnReceiveReportId = cci("RECEIVE_REPORT_ID", "RECEIVE_REPORT_ID", null, null, Long.class, "receiveReportId", null, true, false, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
     ...
     */
    public ColumnInfo columnReceiveReportId() { return _columnReceiveReportId; }
    /**
    ...
    //                                       Primary Element
    //                                       ---------------
    protected UniqueInfo cpui() { return hpcpui(columnReceiveReportId()); }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.ErReceiveReport"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.ErReceiveReportCB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.ErReceiveReportBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<ErReceiveReport> getEntityType() { return ErReceiveReport.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public ErReceiveReport newEntity() { return new ErReceiveReport(); }
    ...
    { doAcceptPrimaryKeyMap((ErReceiveReport)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((ErReceiveReport)et, mp); }
