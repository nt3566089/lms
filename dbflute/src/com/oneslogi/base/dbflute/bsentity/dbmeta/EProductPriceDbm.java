...
/**
 * The DB meta of e_product_price. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class EProductPriceDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final EProductPriceDbm _instance = new EProductPriceDbm();
    private EProductPriceDbm() {}
    public static EProductPriceDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((EProductPrice)et).getProductPriceId(), (et, vl) -> ((EProductPrice)et).setProductPriceId(ctl(vl)), "productPriceId");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getReceiveCd(), (et, vl) -> ((EProductPrice)et).setReceiveCd((String)vl), "receiveCd");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getReceiveRowId(), (et, vl) -> ((EProductPrice)et).setReceiveRowId(ctl(vl)), "receiveRowId");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getImportFlg(), (et, vl) -> ((EProductPrice)et).setImportFlg((String)vl), "importFlg");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getErrorFlg(), (et, vl) -> ((EProductPrice)et).setErrorFlg((String)vl), "errorFlg");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getErrorMessageCd(), (et, vl) -> ((EProductPrice)et).setErrorMessageCd((String)vl), "errorMessageCd");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getHinmokuCd(), (et, vl) -> ((EProductPrice)et).setHinmokuCd((String)vl), "hinmokuCd");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getHinmokuGroupCd(), (et, vl) -> ((EProductPrice)et).setHinmokuGroupCd((String)vl), "hinmokuGroupCd");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getMovingAveragePrice(), (et, vl) -> ((EProductPrice)et).setMovingAveragePrice(ctb(vl)), "movingAveragePrice");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapAddYyyy(), (et, vl) -> ((EProductPrice)et).setSapAddYyyy((String)vl), "sapAddYyyy");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapAddMm(), (et, vl) -> ((EProductPrice)et).setSapAddMm((String)vl), "sapAddMm");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapAddDd(), (et, vl) -> ((EProductPrice)et).setSapAddDd((String)vl), "sapAddDd");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapAddHh(), (et, vl) -> ((EProductPrice)et).setSapAddHh((String)vl), "sapAddHh");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapAddMi(), (et, vl) -> ((EProductPrice)et).setSapAddMi((String)vl), "sapAddMi");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapAddSs(), (et, vl) -> ((EProductPrice)et).setSapAddSs((String)vl), "sapAddSs");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapAddUserNm(), (et, vl) -> ((EProductPrice)et).setSapAddUserNm((String)vl), "sapAddUserNm");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapUpdYyyy(), (et, vl) -> ((EProductPrice)et).setSapUpdYyyy((String)vl), "sapUpdYyyy");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapUpdMm(), (et, vl) -> ((EProductPrice)et).setSapUpdMm((String)vl), "sapUpdMm");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapUpdDd(), (et, vl) -> ((EProductPrice)et).setSapUpdDd((String)vl), "sapUpdDd");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapUpdHh(), (et, vl) -> ((EProductPrice)et).setSapUpdHh((String)vl), "sapUpdHh");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapUpdMi(), (et, vl) -> ((EProductPrice)et).setSapUpdMi((String)vl), "sapUpdMi");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapUpdSs(), (et, vl) -> ((EProductPrice)et).setSapUpdSs((String)vl), "sapUpdSs");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSapUpdUserNm(), (et, vl) -> ((EProductPrice)et).setSapUpdUserNm((String)vl), "sapUpdUserNm");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getSpareStr(), (et, vl) -> ((EProductPrice)et).setSpareStr((String)vl), "spareStr");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getDelFlg(), (et, vl) -> ((EProductPrice)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getVersionNo(), (et, vl) -> ((EProductPrice)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getControlNo(), (et, vl) -> ((EProductPrice)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getAddDt(), (et, vl) -> ((EProductPrice)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getAddUser(), (et, vl) -> ((EProductPrice)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getAddProcess(), (et, vl) -> ((EProductPrice)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getUpdDt(), (et, vl) -> ((EProductPrice)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getUpdUser(), (et, vl) -> ((EProductPrice)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((EProductPrice)et).getUpdProcess(), (et, vl) -> ((EProductPrice)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "e_product_price";
    protected final String _tableDispName = "e_product_price";
    protected final String _tablePropertyName = "EProductPrice";
    protected final TableSqlName _tableSqlName = new TableSqlName("e_product_price", _tableDbName);
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductPriceId = cci("PRODUCT_PRICE_ID", "PRODUCT_PRICE_ID", null, null, Long.class, "productPriceId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.EProductPrice"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.EProductPriceCB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.EProductPriceBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<EProductPrice> getEntityType() { return EProductPrice.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public EProductPrice newEntity() { return new EProductPrice(); }
    ...
    { doAcceptPrimaryKeyMap((EProductPrice)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((EProductPrice)et, mp); }
