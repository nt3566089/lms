...
public class MCarrierZipDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnCarrierZipId = cci("CARRIER_ZIP_ID", "CARRIER_ZIP_ID", null, null, Long.class, "carrierZipId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * CARRIER_ZIP_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ForeignInfo foreignMZip() {
        ...
        return cfi("M_CARRIER_ZIP_FK2", "MZip", this, MZipDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "MCarrierZipList", false);
    }
    /**
    ...
    public ForeignInfo foreignMCommonCarrier() {
        ...
        return cfi("M_CARRIER_ZIP_FK1", "MCommonCarrier", this, MCommonCarrierDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "MCarrierZipList", false);
    }
