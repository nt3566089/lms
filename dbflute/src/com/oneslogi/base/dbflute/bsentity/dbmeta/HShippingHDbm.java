...
public class HShippingHDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnShippingInstHId = cci("SHIPPING_INST_H_ID", "SHIPPING_INST_H_ID", null, null, Long.class, "shippingInstHId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "HPackingHList,HShippingBList", null, false);
    ...
    public ReferrerInfo referrerHShippingBList() {
        ...
        return cri("H_SHIPPING_B_FK1", "HShippingBList", this, HShippingBDbm.getInstance(), mp, false, "HShippingH");
    }
