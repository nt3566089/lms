...
public class TWorkDataDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((TWorkData)et).getWorkQtyCs(), (et, vl) -> ((TWorkData)et).setWorkQtyCs(ctl(vl)), "workQtyCs");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnWorkDataId = cci("WORK_DATA_ID", "WORK_DATA_ID", null, null, Long.class, "workDataId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnWorkQtyCs = cci("WORK_QTY_CS", "WORK_QTY_CS", null, null, Long.class, "workQtyCs", null, false, false, false, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
