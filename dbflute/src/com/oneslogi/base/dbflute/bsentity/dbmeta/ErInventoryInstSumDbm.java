...
/**
 * The DB meta of er_inventory_inst_sum. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class ErInventoryInstSumDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final ErInventoryInstSumDbm _instance = new ErInventoryInstSumDbm();
    private ErInventoryInstSumDbm() {}
    public static ErInventoryInstSumDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getInventoryInstId(), (et, vl) -> ((ErInventoryInstSum)et).setInventoryInstId(ctl(vl)), "inventoryInstId");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getReceiveCd(), (et, vl) -> ((ErInventoryInstSum)et).setReceiveCd((String)vl), "receiveCd");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getReceiveRowId(), (et, vl) -> ((ErInventoryInstSum)et).setReceiveRowId(ctl(vl)), "receiveRowId");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getImportFlg(), (et, vl) -> ((ErInventoryInstSum)et).setImportFlg((String)vl), "importFlg");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getErrorFlg(), (et, vl) -> ((ErInventoryInstSum)et).setErrorFlg((String)vl), "errorFlg");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getErrorMessageCd(), (et, vl) -> ((ErInventoryInstSum)et).setErrorMessageCd((String)vl), "errorMessageCd");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getInventorySlipNo(), (et, vl) -> ((ErInventoryInstSum)et).setInventorySlipNo((String)vl), "inventorySlipNo");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getFiscalYear(), (et, vl) -> ((ErInventoryInstSum)et).setFiscalYear((String)vl), "fiscalYear");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getInventorySlipRowNo(), (et, vl) -> ((ErInventoryInstSum)et).setInventorySlipRowNo((String)vl), "inventorySlipRowNo");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getPlantCd(), (et, vl) -> ((ErInventoryInstSum)et).setPlantCd((String)vl), "plantCd");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getStorageSpaceCd(), (et, vl) -> ((ErInventoryInstSum)et).setStorageSpaceCd((String)vl), "storageSpaceCd");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getReferenceDt(), (et, vl) -> ((ErInventoryInstSum)et).setReferenceDt((String)vl), "referenceDt");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getLpSendFlg(), (et, vl) -> ((ErInventoryInstSum)et).setLpSendFlg((String)vl), "lpSendFlg");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapAddYyyy(), (et, vl) -> ((ErInventoryInstSum)et).setSapAddYyyy((String)vl), "sapAddYyyy");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapAddMm(), (et, vl) -> ((ErInventoryInstSum)et).setSapAddMm((String)vl), "sapAddMm");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapAddDd(), (et, vl) -> ((ErInventoryInstSum)et).setSapAddDd((String)vl), "sapAddDd");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapAddHh(), (et, vl) -> ((ErInventoryInstSum)et).setSapAddHh((String)vl), "sapAddHh");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapAddMi(), (et, vl) -> ((ErInventoryInstSum)et).setSapAddMi((String)vl), "sapAddMi");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapAddSs(), (et, vl) -> ((ErInventoryInstSum)et).setSapAddSs((String)vl), "sapAddSs");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapAddUserCd(), (et, vl) -> ((ErInventoryInstSum)et).setSapAddUserCd((String)vl), "sapAddUserCd");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapUpdYyyy(), (et, vl) -> ((ErInventoryInstSum)et).setSapUpdYyyy((String)vl), "sapUpdYyyy");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapUpdMm(), (et, vl) -> ((ErInventoryInstSum)et).setSapUpdMm((String)vl), "sapUpdMm");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapUpdDd(), (et, vl) -> ((ErInventoryInstSum)et).setSapUpdDd((String)vl), "sapUpdDd");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapUpdHh(), (et, vl) -> ((ErInventoryInstSum)et).setSapUpdHh((String)vl), "sapUpdHh");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapUpdMi(), (et, vl) -> ((ErInventoryInstSum)et).setSapUpdMi((String)vl), "sapUpdMi");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapUpdSs(), (et, vl) -> ((ErInventoryInstSum)et).setSapUpdSs((String)vl), "sapUpdSs");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSapUpdUserCd(), (et, vl) -> ((ErInventoryInstSum)et).setSapUpdUserCd((String)vl), "sapUpdUserCd");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getSpareStr(), (et, vl) -> ((ErInventoryInstSum)et).setSpareStr((String)vl), "spareStr");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getDelFlg(), (et, vl) -> ((ErInventoryInstSum)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getVersionNo(), (et, vl) -> ((ErInventoryInstSum)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getControlNo(), (et, vl) -> ((ErInventoryInstSum)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getAddDt(), (et, vl) -> ((ErInventoryInstSum)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getAddUser(), (et, vl) -> ((ErInventoryInstSum)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getAddProcess(), (et, vl) -> ((ErInventoryInstSum)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getUpdDt(), (et, vl) -> ((ErInventoryInstSum)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getUpdUser(), (et, vl) -> ((ErInventoryInstSum)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((ErInventoryInstSum)et).getUpdProcess(), (et, vl) -> ((ErInventoryInstSum)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "er_inventory_inst_sum";
    protected final String _tableDispName = "er_inventory_inst_sum";
    protected final String _tablePropertyName = "erInventoryInstSum";
    protected final TableSqlName _tableSqlName = new TableSqlName("er_inventory_inst_sum", _tableDbName);
    ...
    protected final ColumnInfo _columnLpSendFlg = cci("LP_SEND_FLG", "LP_SEND_FLG", null, null, String.class, "lpSendFlg", null, false, false, false, "VARCHAR", 30, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.ErInventoryInstSum"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.ErInventoryInstSumCB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.ErInventoryInstSumBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<ErInventoryInstSum> getEntityType() { return ErInventoryInstSum.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public ErInventoryInstSum newEntity() { return new ErInventoryInstSum(); }
    ...
    { doAcceptPrimaryKeyMap((ErInventoryInstSum)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((ErInventoryInstSum)et, mp); }
