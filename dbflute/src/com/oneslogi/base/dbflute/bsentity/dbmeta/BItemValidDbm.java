...
public class BItemValidDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnItemId = cci("ITEM_ID", "ITEM_ID", null, null, Long.class, "itemId", null, true, false, true, "BIGINT", 19, 0, null, null, false, null, null, "BItem", null, null, false);
    ...
    /**
     * ITEM_ID: {PK, NotNull, BIGINT(19), FK to b_item}
