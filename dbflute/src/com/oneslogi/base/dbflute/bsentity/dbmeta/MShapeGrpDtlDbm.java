...
public class MShapeGrpDtlDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnShapeGrpDtlId = cci("SHAPE_GRP_DTL_ID", "SHAPE_GRP_DTL_ID", null, null, Long.class, "shapeGrpDtlId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MProductShapeList", null, false);
    ...
    /**
     * SHAPE_GRP_DTL_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ForeignInfo foreignMShapeGrp() {
        ...
        return cfi("M_SHAPE_GRP_DTL_FK1", "MShapeGrp", this, MShapeGrpDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "MShapeGrpDtlList", false);
    }
    /**
    ...
    public ForeignInfo foreignMShape() {
        ...
        return cfi("M_SHAPE_GRP_DTL_FK2", "MShape", this, MShapeDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "MShapeGrpDtlList", false);
    }
    /**
    ...
    public ReferrerInfo referrerMProductShapeList() {
        ...
        return cri("M_PRODUCT_SHAPE_FK2", "MProductShapeList", this, MProductShapeDbm.getInstance(), mp, false, "MShapeGrpDtl");
    }
