...
public class MProductShapeDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductShapeId = cci("PRODUCT_SHAPE_ID", "PRODUCT_SHAPE_ID", null, null, Long.class, "productShapeId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MLocationByMaxStoreProductShapeIdList,MLocationByReplenishPProductShapeIdList,MLocationReplenishProductList", null, false);
    ...
    protected final ColumnInfo _columnNetWeight = cci("NET_WEIGHT", "NET_WEIGHT", null, null, java.math.BigDecimal.class, "netWeight", null, false, false, false, "DECIMAL", 14, 4, null, null, false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignMShapeGrpDtl() {
        ...
        return cfi("M_PRODUCT_SHAPE_FK2", "MShapeGrpDtl", this, MShapeGrpDtlDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "MProductShapeList", false);
    }
    /**
    ...
    public ForeignInfo foreignMProduct() {
        ...
        return cfi("M_PRODUCT_SHAPE_FK1", "MProduct", this, MProductDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "MProductShapeList", false);
    }
    /**
    ...
    public ReferrerInfo referrerMLocationByMaxStoreProductShapeIdList() {
        ...
        return cri("M_LOCATION_FK1", "MLocationByMaxStoreProductShapeIdList", this, MLocationDbm.getInstance(), mp, false, "MProductShapeByMaxStoreProductShapeId");
    }
    /**
    ...
    public ReferrerInfo referrerMLocationByReplenishPProductShapeIdList() {
        ...
        return cri("M_LOCATION_FK2", "MLocationByReplenishPProductShapeIdList", this, MLocationDbm.getInstance(), mp, false, "MProductShapeByReplenishPProductShapeId");
    }
    /**
    ...
    public ReferrerInfo referrerMLocationReplenishProductList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnProductShapeId(), MLocationReplenishProductDbm.getInstance().columnMaxStoreProductShapeId());
        return cri("M_LOCATION_REPLENISH_PRODUCT_FK4", "MLocationReplenishProductList", this, MLocationReplenishProductDbm.getInstance(), mp, false, "MProductShape");
    }
