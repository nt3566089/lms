...
public class BRoleDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRoleId = cci("ROLE_ID", "ROLE_ID", null, null, Long.class, "roleId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "BColRoleList,BFuncRoleList,BItemRoleList,BRoleGrpDtlList,BScreenRoleList", null, false);
    ...
    public ReferrerInfo referrerBItemRoleList() {
        ...
        return cri("B_ITEM_ROLE_FK2", "BItemRoleList", this, BItemRoleDbm.getInstance(), mp, false, "BRole");
    }
    /**
    ...
    public ReferrerInfo referrerBRoleGrpDtlList() {
        ...
        return cri("B_ROLE_GRP_DTL_FK2", "BRoleGrpDtlList", this, BRoleGrpDtlDbm.getInstance(), mp, false, "BRole");
    }
    /**
