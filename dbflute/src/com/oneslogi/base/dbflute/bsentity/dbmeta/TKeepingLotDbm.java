...
public class TKeepingLotDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnKeepingLotId = cci("KEEPING_LOT_ID", "KEEPING_LOT_ID", null, null, Long.class, "keepingLotId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * KEEPING_LOT_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ForeignInfo foreignTLot() {
        ...
        return cfi("T_KEEPING_LOT_FK2", "TLot", this, TLotDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "TKeepingLotList", false);
    }
    /**
    ...
    public ForeignInfo foreignMCustomer() {
        ...
        return cfi("T_KEEPING_LOT_FK1", "MCustomer", this, MCustomerDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "TKeepingLotList", false);
    }
    /**
    ...
    public ForeignInfo foreignMProduct() {
        ...
        return cfi("T_KEEPING_LOT_FK3", "MProduct", this, MProductDbm.getInstance(), mp, 2, null, false, false, false, false, null, null, false, "TKeepingLotList", false);
    }
