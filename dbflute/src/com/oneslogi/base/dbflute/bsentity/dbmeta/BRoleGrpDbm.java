...
public class BRoleGrpDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRoleGrpId = cci("ROLE_GRP_ID", "ROLE_GRP_ID", null, null, Long.class, "roleGrpId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "BRoleGrpDtlList,BUserList", null, false);
    ...
    /**
     * ROLE_GRP_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ReferrerInfo referrerBRoleGrpDtlList() {
        ...
        return cri("B_ROLE_GRP_DTL_FK1", "BRoleGrpDtlList", this, BRoleGrpDtlDbm.getInstance(), mp, false, "BRoleGrp");
    }
    /**
    ...
    public ReferrerInfo referrerBUserList() {
        ...
        return cri("B_USER_FK2", "BUserList", this, BUserDbm.getInstance(), mp, false, "BRoleGrp");
    }
