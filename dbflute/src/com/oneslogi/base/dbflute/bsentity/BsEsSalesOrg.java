...
/**
 * The entity of es_sales_org as TABLE. <br>
 * 販売組織マスタ送信テーブル
 * <pre>
 * [primary-key]
 *     SALES_ORG_ID
 ...
 */
public abstract class BsEsSalesOrg extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEsSalesOrg) {
            BsEsSalesOrg other = (BsEsSalesOrg)obj;
    ...
    @Override
    public EsSalesOrg clone() {
        return (EsSalesOrg)super.clone();
    }
