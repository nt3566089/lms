...
/**
 * The entity of t_bldl5180 as TABLE. <br>
 * BLDL5180
 * <pre>
 * [primary-key]
 *     BLDL5180_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5180Id = entity.getBldl5180Id();
 ...
 * Long koshigayaReceiveCnt = entity.getKoshigayaReceiveCnt();
 * Long koshigayaReceiveNum = entity.getKoshigayaReceiveNum();
 * Long koshigayaCaseNum = entity.getKoshigayaCaseNum();
 ...
 * entity.setBldl5180Id(bldl5180Id);
 * entity.setYearmonth(yearmonth);
 * entity.setMonth(month);
 * entity.setRowNo(rowNo);
 * entity.setReceiveDt(receiveDt);
 * entity.setKoshigayaReceiveCnt(koshigayaReceiveCnt);
 * entity.setKoshigayaReceiveNum(koshigayaReceiveNum);
 * entity.setKoshigayaCaseNum(koshigayaCaseNum);
 ...
 */
public abstract class BsTBldl5180 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5180Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5180) {
            BsTBldl5180 other = (BsTBldl5180)obj;
            if (!xSV(_bldl5180Id, other._bldl5180Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5180Id));
        ...
        sb.append(dm).append(xfND(_koshigayaReceiveCnt));
        sb.append(dm).append(xfND(_koshigayaReceiveNum));
        sb.append(dm).append(xfND(_koshigayaCaseNum));
    ...
    @Override
    public TBldl5180 clone() {
        return (TBldl5180)super.clone();
    }
     ...
     * BLDL5180ID
     * @return The value of the column 'BLDL5180_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5180Id() {
        checkSpecifiedProperty("bldl5180Id");
        return _bldl5180Id;
    }
     ...
     * BLDL5180ID
     * @param bldl5180Id The value of the column 'BLDL5180_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5180Id(Long bldl5180Id) {
        registerModifiedProperty("bldl5180Id");
        _bldl5180Id = bldl5180Id;
    }
     ...
     * 越谷US_入荷件数
     * @return The value of the column 'KOSHIGAYA_RECEIVE_CNT'. (NullAllowed even if selected: for no constraint)
     */
    public Long getKoshigayaReceiveCnt() {
        checkSpecifiedProperty("koshigayaReceiveCnt");
     ...
     * 越谷US_入荷件数
     * @param koshigayaReceiveCnt The value of the column 'KOSHIGAYA_RECEIVE_CNT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setKoshigayaReceiveCnt(Long koshigayaReceiveCnt) {
        registerModifiedProperty("koshigayaReceiveCnt");
        _koshigayaReceiveCnt = koshigayaReceiveCnt;
    }

    /**
     * [get] KOSHIGAYA_RECEIVE_NUM: {BIGINT(19)} <br>
     * 越谷US_入荷数量
     * @return The value of the column 'KOSHIGAYA_RECEIVE_NUM'. (NullAllowed even if selected: for no constraint)
     */
    public Long getKoshigayaReceiveNum() {
        checkSpecifiedProperty("koshigayaReceiveNum");
     ...
     * 越谷US_入荷数量
     * @param koshigayaReceiveNum The value of the column 'KOSHIGAYA_RECEIVE_NUM'. (NullAllowed: null update allowed for no constraint)
     */
    public void setKoshigayaReceiveNum(Long koshigayaReceiveNum) {
        registerModifiedProperty("koshigayaReceiveNum");
        _koshigayaReceiveNum = koshigayaReceiveNum;
    }

    /**
     * [get] KOSHIGAYA_CASE_NUM: {BIGINT(19)} <br>
     * 越谷US_ケース数
     * @return The value of the column 'KOSHIGAYA_CASE_NUM'. (NullAllowed even if selected: for no constraint)
     */
    public Long getKoshigayaCaseNum() {
        checkSpecifiedProperty("koshigayaCaseNum");
     ...
     * 越谷US_ケース数
     * @param koshigayaCaseNum The value of the column 'KOSHIGAYA_CASE_NUM'. (NullAllowed: null update allowed for no constraint)
     */
    public void setKoshigayaCaseNum(Long koshigayaCaseNum) {
        registerModifiedProperty("koshigayaCaseNum");
        _koshigayaCaseNum = koshigayaCaseNum;
    }
