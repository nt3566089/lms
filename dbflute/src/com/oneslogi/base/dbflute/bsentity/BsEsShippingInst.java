...
/**
 * The entity of es_shipping_inst as TABLE. <br>
 * 出荷指示送信テーブル
 * <pre>
 * [primary-key]
 *     SHIPPING_INST_ID
 ...
 * String salesOrderNum = entity.getSalesOrderNum();
 ...
 */
public abstract class BsEsShippingInst extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEsShippingInst) {
            BsEsShippingInst other = (BsEsShippingInst)obj;
    ...
    @Override
    public EsShippingInst clone() {
        return (EsShippingInst)super.clone();
    }
    ...
    public String getSalesOrderNum() {
        ...
        return convertEmptyToNull(_salesOrderNum);
    }
