...
/**
 * The entity of t_bldl3390 as TABLE. <br>
 * BLDL3390
 * <pre>
 * [primary-key]
 *     BLDL3390_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl3390Id = entity.getBldl3390Id();
 ...
 * String contractorCd = entity.getContractorCd();
 ...
 * Long kohaiFee = entity.getKohaiFee();
 * Long tax = entity.getTax();
 * Long taxRate = entity.getTaxRate();
 ...
 */
public abstract class BsTBldl3390 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl3390Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl3390) {
            BsTBldl3390 other = (BsTBldl3390)obj;
            if (!xSV(_bldl3390Id, other._bldl3390Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl3390Id));
    ...
    @Override
    public TBldl3390 clone() {
        return (TBldl3390)super.clone();
    }
     ...
     * BLDL3390ID
     * @return The value of the column 'BLDL3390_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl3390Id() {
        checkSpecifiedProperty("bldl3390Id");
        return _bldl3390Id;
    }
     ...
     * BLDL3390ID
     * @param bldl3390Id The value of the column 'BLDL3390_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl3390Id(Long bldl3390Id) {
        registerModifiedProperty("bldl3390Id");
        _bldl3390Id = bldl3390Id;
    }
     ...
     * 戸口契約先CD
     * @return The value of the column 'CONTRACTOR_CD'. (NullAllowed even if selected: for no constraint)
     */
    public String getContractorCd() {
        checkSpecifiedProperty("contractorCd");
        return convertEmptyToNull(_contractorCd);
    }

    /**
     * [set] CONTRACTOR_CD: {VARCHAR(30)} <br>
     * 戸口契約先CD
     * @param contractorCd The value of the column 'CONTRACTOR_CD'. (NullAllowed: null update allowed for no constraint)
     */
    public void setContractorCd(String contractorCd) {
        registerModifiedProperty("contractorCd");
        _contractorCd = contractorCd;
    }
     ...
     * 戸配手数料
     * @return The value of the column 'KOHAI_FEE'. (NullAllowed even if selected: for no constraint)
     */
    public Long getKohaiFee() {
        checkSpecifiedProperty("kohaiFee");
        return _kohaiFee;
    }
     ...
     * 戸配手数料
     * @param kohaiFee The value of the column 'KOHAI_FEE'. (NullAllowed: null update allowed for no constraint)
     */
    public void setKohaiFee(Long kohaiFee) {
        registerModifiedProperty("kohaiFee");
        _kohaiFee = kohaiFee;
    }
