...
/**
 * The entity of t_bldl5352 as TABLE. <br>
 * BLDL5352
 * <pre>
 * [primary-key]
 *     BLDL5352_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5352Id = entity.getBldl5352Id();
 ...
 * entity.setBldl5352Id(bldl5352Id);
 ...
 */
public abstract class BsTBldl5352 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5352Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5352) {
            BsTBldl5352 other = (BsTBldl5352)obj;
            if (!xSV(_bldl5352Id, other._bldl5352Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5352Id));
    ...
    @Override
    public TBldl5352 clone() {
        return (TBldl5352)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] BLDL5352_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5352ID
     * @return The value of the column 'BLDL5352_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5352Id() {
        checkSpecifiedProperty("bldl5352Id");
        return _bldl5352Id;
    }

    /**
     * [set] BLDL5352_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5352ID
     * @param bldl5352Id The value of the column 'BLDL5352_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5352Id(Long bldl5352Id) {
        registerModifiedProperty("bldl5352Id");
        _bldl5352Id = bldl5352Id;
    }
