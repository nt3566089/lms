...
public abstract class BsTPackingH extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    /**
     * Set the value of packingStatus as $60 (60). <br>
     * $60: 承認待ち
     */
    public void setPackingStatus_$60() {
        setPackingStatusAsPackingStatus(CDef.PackingStatus.$60);
    }
    ...
    /**
     * Is the value of packingStatus $60? <br>
     * $60: 承認待ち
     * <p>It's treated as case insensitive and if the code value is null, it returns false.</p>
     * @return The determination, true or false.
     */
    public boolean isPackingStatus$60() {
        CDef.PackingStatus cdef = getPackingStatusAsPackingStatus();
        return cdef != null ? cdef.equals(CDef.PackingStatus.$60) : false;
    }
