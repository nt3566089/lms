...
/**
 * The entity of h_stock_book as TABLE. <br>
 * 帳簿在庫履歴
 * <pre>
 * [primary-key]
 *     STOCK_BOOK_ID
 ...
 * entity.setVarietyTypeCd(varietyTypeCd);
 ...
 */
public abstract class BsHStockBook extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_stockBookId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsHStockBook) {
            BsHStockBook other = (BsHStockBook)obj;
            if (!xSV(_stockBookId, other._stockBookId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    @Override
    public HStockBook clone() {
        return (HStockBook)super.clone();
    }
     ...
     * 帳簿在庫履歴ID
     * @return The value of the column 'STOCK_BOOK_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getStockBookId() {
        checkSpecifiedProperty("stockBookId");
        return _stockBookId;
    }
     ...
     * 帳簿在庫履歴ID
     * @param stockBookId The value of the column 'STOCK_BOOK_ID'. (basically NotNull if update: for the constraint)
     */
    public void setStockBookId(Long stockBookId) {
        registerModifiedProperty("stockBookId");
        _stockBookId = stockBookId;
    }

    /**
     * [get] REFERENCE_DT: {NotNull, VARCHAR(8)} <br>
     * 基準日
     * @return The value of the column 'REFERENCE_DT'. (basically NotNull if selected: for the constraint)
     */
    ...
    /**
     * [set] REFERENCE_DT: {NotNull, VARCHAR(8)} <br>
     * 基準日
     * @param referenceDt The value of the column 'REFERENCE_DT'. (basically NotNull if update: for the constraint)
     */
     ...
     * 品種区分
     * @return The value of the column 'VARIETY_TYPE_CD'. (NullAllowed even if selected: for no constraint)
     */
    public String getVarietyTypeCd() {
        checkSpecifiedProperty("varietyTypeCd");
        return convertEmptyToNull(_varietyTypeCd);
    }

    /**
     * [set] VARIETY_TYPE_CD: {VARCHAR(30)} <br>
     * 品種区分
     * @param varietyTypeCd The value of the column 'VARIETY_TYPE_CD'. (NullAllowed: null update allowed for no constraint)
     */
    public void setVarietyTypeCd(String varietyTypeCd) {
        registerModifiedProperty("varietyTypeCd");
        _varietyTypeCd = varietyTypeCd;
    }
