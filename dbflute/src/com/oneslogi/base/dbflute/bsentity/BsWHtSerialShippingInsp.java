...
public abstract class BsWHtSerialShippingInsp extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** HT_SERIAL_SHIPPING_INSP_ID: {PK, ID, NotNull, BIGINT(19)} */
    ...
    //                                                                            ========
    /**
     * [get] HT_SERIAL_SHIPPING_INSP_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * シリアル登録(出荷)ワークID
    ...
    /**
     * [set] HT_SERIAL_SHIPPING_INSP_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * シリアル登録(出荷)ワークID
