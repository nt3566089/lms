...
/**
 * The entity of t_billing_data as TABLE. <br>
 * 請求元データ
 * <pre>
 * [primary-key]
 *     BILLING_DATA_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long billingDataId = entity.getBillingDataId();
 ...
 * entity.setBillingDataId(billingDataId);
 ...
 */
public abstract class BsTBillingData extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_billingDataId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBillingData) {
            BsTBillingData other = (BsTBillingData)obj;
            if (!xSV(_billingDataId, other._billingDataId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_billingDataId));
    ...
    @Override
    public TBillingData clone() {
        return (TBillingData)super.clone();
    }
     ...
     * 請求元データID
     * @return The value of the column 'BILLING_DATA_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBillingDataId() {
        checkSpecifiedProperty("billingDataId");
     ...
     * 請求元データID
     * @param billingDataId The value of the column 'BILLING_DATA_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBillingDataId(Long billingDataId) {
        registerModifiedProperty("billingDataId");
        _billingDataId = billingDataId;
    }
