...
//	ミドリ安全様向けカスタマイズ対応 戸口送付先一覧を新規作成 2024.07.10 YJS.Cui Add [E]
    ...
    // ミドリ安全様向けカスタマイズ対応 運送業者引き渡し確定画面追加 2024.07.11 YJS_ZHANG Add [S]
	// 引き渡しステータス
	private String cdlOutStatus;
	// 引き渡し済非表示
	private String cdlOutFlg;
	// ミドリ安全様向けカスタマイズ対応 運送業者引き渡し確定画面追加 2024.07.11 YJS_ZHANG Add [E]

	// ミドリ安全様向けカスタマイズ対応 ピッキングパターンCD追加 2024.07.17 Zheng Add [S]
	public static final String ALIAS_maxPickingPaternCd = "MAX_PICKING_PATERN_CD";
	private String maxPickingPaternCd;
	// ミドリ安全様向けカスタマイズ対応 ピッキングパターンCD追加 2024.07.17 Zheng Add [E]
...
//	ミドリ安全様向けカスタマイズ対応 戸口送付先一覧を新規作成 2024.07.10 YJS.Cui Add [E]
    ...
    // ミドリ安全様向けカスタマイズ対応 運送業者引き渡し確定画面追加 2024.07.11 YJS_ZHANG Add [S]
	public String getCdlOutStatus() {
		return cdlOutStatus;
	}

	public void setCdlOutStatus(String cdlOutStatus) {
		this.cdlOutStatus = cdlOutStatus;
	}
