...
public class TInventoryB extends BsTInventoryB {
	...
	*/
	...
	private String toLocationNm;
 	//スキャン済の入荷ラベルNoのCOUNT数
	private BigDecimal scanCount;
	//JanCd 預り商品マスタ
	private String dJanCd;
	//入力者cd
	private String updateUserCd;
	//入力者名
	private String updateUserNm;
	//修正前数量
	private BigDecimal inventoryModNum;
	//部門名
	private String plantNm;
	//品種名
	private String typeNm;
	//棚卸差異名
	private String inventoryDiffNm;
	//販売組織/ユーザ
	private String salesUserNm;
	
	 public String getSalesUserNm() {
		return salesUserNm;
	}

	public void setSalesUserNm(String salesUserNm) {
	...
	public String getInventoryDiffNm() {
		return inventoryDiffNm;
	}

	public void setInventoryDiffNm(String inventoryDiffNm) {
		this.inventoryDiffNm = inventoryDiffNm;
	}
	...
	public BigDecimal getScanCount() {
		return scanCount;
	}

	public void setScanCount(BigDecimal scanCount) {
