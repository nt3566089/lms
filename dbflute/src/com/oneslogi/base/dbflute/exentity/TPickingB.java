...
public class TPickingB extends BsTPickingB {
	...
	// 梱包ヘッダIDのCOUNTを抽出
	public static final String ALIAS_sumPackingCount = "SUM_PACKING_COUNT";
	private Integer sumPackingCount;
	
	// ミドリ安全様向けカスタマイズ対応  梱包ボディ情報追加 2024.7.15 張 Add [S]
	private SqlPackingListUpdate packingBInfos;

	
	public SqlPackingListUpdate getPackingBInfos() {
		return packingBInfos;
	}

	public void setPackingBInfos(SqlPackingListUpdate packingBInfos) {
		this.packingBInfos = packingBInfos;
	}
    // ミドリ安全様向けカスタマイズ対応  梱包ボディ情報追加 2024.7.15 張 Add [E]
	...
	public Integer getSumPackingCount() {
		return sumPackingCount;
	}

	public void setSumPackingCount(Integer sumPackingCount) {
		this.sumPackingCount = sumPackingCount;
	}
}
