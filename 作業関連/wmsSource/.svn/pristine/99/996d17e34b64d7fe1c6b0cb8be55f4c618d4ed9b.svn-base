...
/**
 * The entity of h_location_attribute as TABLE. <br>
 * ロケーション属性履歴
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long locationAttributeId = entity.getLocationAttributeId();
 * Long centerId = entity.getCenterId();
 * Long locationId = entity.getLocationId();
 * Long histNo = entity.getHistNo();
 * String prevLocationHist = entity.getPrevLocationHist();
 * String curtLocationHist = entity.getCurtLocationHist();
 ...
 * entity.setLocationAttributeId(locationAttributeId);
 * entity.setCenterId(centerId);
 * entity.setLocationId(locationId);
 * entity.setHistNo(histNo);
 * entity.setPrevLocationHist(prevLocationHist);
 * entity.setCurtLocationHist(curtLocationHist);
 ...
 */
public abstract class BsHLocationAttribute extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_locationAttributeId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsHLocationAttribute) {
            BsHLocationAttribute other = (BsHLocationAttribute)obj;
            if (!xSV(_locationAttributeId, other._locationAttributeId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _locationAttributeId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_locationAttributeId));
        sb.append(dm).append(xfND(_centerId));
        sb.append(dm).append(xfND(_locationId));
        sb.append(dm).append(xfND(_histNo));
        sb.append(dm).append(xfND(_prevLocationHist));
        sb.append(dm).append(xfND(_curtLocationHist));
    ...
    @Override
    public HLocationAttribute clone() {
        return (HLocationAttribute)super.clone();
    }
     ...
     * ロケーション属性ID
     * @return The value of the column 'LOCATION_ATTRIBUTE_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getLocationAttributeId() {
        checkSpecifiedProperty("locationAttributeId");
     ...
     * ロケーション属性ID
     * @param locationAttributeId The value of the column 'LOCATION_ATTRIBUTE_ID'. (basically NotNull if update: for the constraint)
     */
    public void setLocationAttributeId(Long locationAttributeId) {
        registerModifiedProperty("locationAttributeId");
        _locationAttributeId = locationAttributeId;
    }
     ...
     * 履歴番号
     * @return The value of the column 'HIST_NO'. (NullAllowed even if selected: for no constraint)
     */
    public Long getHistNo() {
        checkSpecifiedProperty("histNo");
        return _histNo;
    }
     ...
     * 履歴番号
     * @param histNo The value of the column 'HIST_NO'. (NullAllowed: null update allowed for no constraint)
     */
    public void setHistNo(Long histNo) {
        registerModifiedProperty("histNo");
        _histNo = histNo;
    }
     ...
     * 前回ロケーション履歴
     * @return The value of the column 'PREV_LOCATION_HIST'. (NullAllowed even if selected: for no constraint)
     */
    public String getPrevLocationHist() {
        checkSpecifiedProperty("prevLocationHist");
        return convertEmptyToNull(_prevLocationHist);
    }

    /**
     * [set] PREV_LOCATION_HIST: {VARCHAR(30)} <br>
     * 前回ロケーション履歴
     * @param prevLocationHist The value of the column 'PREV_LOCATION_HIST'. (NullAllowed: null update allowed for no constraint)
     */
    public void setPrevLocationHist(String prevLocationHist) {
        registerModifiedProperty("prevLocationHist");
        _prevLocationHist = prevLocationHist;
    }

    /**
     * [get] CURT_LOCATION_HIST: {VARCHAR(30)} <br>
     * 今回ロケーション履歴
     * @return The value of the column 'CURT_LOCATION_HIST'. (NullAllowed even if selected: for no constraint)
     */
    public String getCurtLocationHist() {
        checkSpecifiedProperty("curtLocationHist");
        return convertEmptyToNull(_curtLocationHist);
    }

    /**
     * [set] CURT_LOCATION_HIST: {VARCHAR(30)} <br>
     * 今回ロケーション履歴
     * @param curtLocationHist The value of the column 'CURT_LOCATION_HIST'. (NullAllowed: null update allowed for no constraint)
     */
    public void setCurtLocationHist(String curtLocationHist) {
        registerModifiedProperty("curtLocationHist");
        _curtLocationHist = curtLocationHist;
    }
