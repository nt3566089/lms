...
/**
 * The DTO mapper of e_sales_org as TABLE. <br>
 * 販売組織マスタ受信テーブル
 * <pre>
 * [primary-key]
 *     SALES_ORG_ID
 ...
 */
public abstract class BsESalesOrgDtoMapper implements DtoMapper<ESalesOrg, ESalesOrgDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsESalesOrgDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsESalesOrgDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ESalesOrgDto mappingToDto(ESalesOrg entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ESalesOrgDto dto = new ESalesOrgDto();
     ...
     * {@inheritDoc}
     */
    public List<ESalesOrgDto> mappingToDtoList(List<ESalesOrg> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ESalesOrgDto> dtoList = new ArrayList<ESalesOrgDto>();
        for (ESalesOrg entity : entityList) {
            ESalesOrgDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ESalesOrg mappingToEntity(ESalesOrgDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ESalesOrg entity = new ESalesOrg();
     ...
     */
    protected boolean needsMapping(ESalesOrgDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ESalesOrg> mappingToEntityList(List<ESalesOrgDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ESalesOrg> entityList = new ArrayList<ESalesOrg>();
        for (ESalesOrgDto dto : dtoList) {
            ESalesOrg entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ESalesOrgDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ESalesOrgDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ESalesOrgDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ESalesOrgDtoMapper reverseReference() {
