...
public class EZipDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnZipId = cci("ZIP_ID", "ZIP_ID", null, null, Long.class, "zipId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
