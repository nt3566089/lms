...
/**
 * The condition-query for in-line of es_plant_storage_space.
 * @author DBFlute(AutoGenerator)
 */
public class EsPlantStorageSpaceCIQ extends AbstractBsEsPlantStorageSpaceCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEsPlantStorageSpaceCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EsPlantStorageSpaceCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEsPlantStorageSpaceCQ myCQ) {
    ...
    public String keepScalarCondition(EsPlantStorageSpaceCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EsPlantStorageSpaceCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EsPlantStorageSpaceCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EsPlantStorageSpaceCQ sq)
    ...
    protected String xinCB() { return EsPlantStorageSpaceCB.class.getName(); }
    protected String xinCQ() { return EsPlantStorageSpaceCQ.class.getName(); }
}
