 ...
 *
 * [foreign table]
 *     m_client, m_center, m_delivery_course
 *
 * [referrer table]
 *     
 *
 * [foreign property]
 *     mClient, mCenter, mDeliveryCourse
 *
 * [referrer property]
 *     
 *
...
public abstract class BsWHtLoading extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] HT_LOADING_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 積込検品ワークID
    ...
    /**
     * [set] HT_LOADING_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 積込検品ワークID
