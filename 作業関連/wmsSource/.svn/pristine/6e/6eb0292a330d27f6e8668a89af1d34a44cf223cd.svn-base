...
public abstract class BsTReceivePlanBDtoMapper implements DtoMapper<TReceivePlanB, TReceivePlanBDto>, Serializable {
    ...
    protected boolean _suppressTReceivePlanDataTransferList;
    ...
    public TReceivePlanBDto mappingToDto(TReceivePlanB entity) {
        ...
        dto.setStoreRowNo(entity.getStoreRowNo());
        dto.setPlanProdDt(entity.getPlanProdDt());
        ...
        dto.setRemainingReceiveNum(entity.getRemainingReceiveNum());
        dto.setLotManagTypeId(entity.getLotManagTypeId());
        ...
        dto.setRemainFlg(entity.getRemainFlg());
        ...
        if (!_suppressTReceivePlanDataTransferList && !entity.getTReceivePlanDataTransferList().isEmpty()) {
            TReceivePlanDataTransferDtoMapper mapper = new TReceivePlanDataTransferDtoMapper(_relationDtoMap, _relationEntityMap);
            mapper.setExceptCommonColumn(exceptCommonColumn);
            mapper.setReverseReference(reverseReference);
            if (!instanceCache) { mapper.disableInstanceCache(); }
            mapper.suppressTReceivePlanB();
            List<TReceivePlanDataTransferDto> relationDtoList = mapper.mappingToDtoList(entity.getTReceivePlanDataTransferList());
            dto.setTReceivePlanDataTransferList(relationDtoList);
            if (reverseReference) {
                for (TReceivePlanDataTransferDto relationDto : relationDtoList) {
                    relationDto.setTReceivePlanB(dto);
                }
            }
        };
    ...
    public TReceivePlanB mappingToEntity(TReceivePlanBDto dto) {
        ...
        if (needsMapping(dto, dto.getStoreRowNo(), "storeRowNo")) {
            entity.setStoreRowNo(dto.getStoreRowNo());
        }
        if (needsMapping(dto, dto.getPlanProdDt(), "planProdDt")) {
            entity.setPlanProdDt(dto.getPlanProdDt());
        }
        ...
        if (needsMapping(dto, dto.getRemainingReceiveNum(), "remainingReceiveNum")) {
            entity.setRemainingReceiveNum(dto.getRemainingReceiveNum());
        }
        if (needsMapping(dto, dto.getLotManagTypeId(), "lotManagTypeId")) {
            entity.setLotManagTypeId(dto.getLotManagTypeId());
        }
        ...
        if (needsMapping(dto, dto.getRemainFlg(), "remainFlg")) {
            entity.setRemainFlg(dto.getRemainFlg());
        }
        ...
        if (!_suppressTReceivePlanDataTransferList && !dto.getTReceivePlanDataTransferList().isEmpty()) {
            TReceivePlanDataTransferDtoMapper mapper = new TReceivePlanDataTransferDtoMapper(_relationDtoMap, _relationEntityMap);
            mapper.setExceptCommonColumn(exceptCommonColumn);
            mapper.setReverseReference(reverseReference);
            if (!instanceCache) { mapper.disableInstanceCache(); }
            mapper.suppressTReceivePlanB();
            List<TReceivePlanDataTransfer> relationEntityList = mapper.mappingToEntityList(dto.getTReceivePlanDataTransferList());
            entity.setTReceivePlanDataTransferList(relationEntityList);
            if (reverseReference) {
                for (TReceivePlanDataTransfer relationEntity : relationEntityList) {
                    relationEntity.setTReceivePlanB(entity);
                }
            }
        };
    ...
    public void suppressTReceivePlanDataTransferList() {
        _suppressTReceivePlanDataTransferList = true;
    }
    ...
    protected void doSuppressAll() { // internal
        ...
        suppressTReceivePlanDataTransferList();
    ...
    protected void doSuppressClear() { // internal
        ...
        _suppressTReceivePlanDataTransferList = false;
