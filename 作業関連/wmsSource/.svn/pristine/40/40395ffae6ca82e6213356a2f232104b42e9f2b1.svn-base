...
public class TSerialNoDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnSerialNoId = cci("SERIAL_NO_ID", "SERIAL_NO_ID", null, null, Long.class, "serialNoId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * SERIAL_NO_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    /**
     * CLIENT_ID: {+UQ, IX, NotNull, BIGINT(19), FK to m_client}
     * @return The information object of specified column. (NotNull)
     */
    ...
    public ForeignInfo foreignMClient() {
        ...
        return cfi("T_SERIAL_NO_FK2", "MClient", this, MClientDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "TSerialNoList", false);
    }
    /**
    ...
    public ForeignInfo foreignMProduct() {
        ...
        return cfi("T_SERIAL_NO_FK3", "MProduct", this, MProductDbm.getInstance(), mp, 2, null, false, false, false, false, null, null, false, "TSerialNoList", false);
    }
