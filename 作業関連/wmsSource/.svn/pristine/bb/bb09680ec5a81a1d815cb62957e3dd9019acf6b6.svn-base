...
public class MHtDictCultureDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnDictCultureId = cci("DICT_CULTURE_ID", "DICT_CULTURE_ID", null, null, Long.class, "dictCultureId", null, true, false, true, "BIGINT", 19, 0, null, null, false, null, null, "BDictCulture", null, null, false);
    ...
    /**
     * DICT_CULTURE_ID: {PK, NotNull, BIGINT(19), FK to b_dict_culture}
