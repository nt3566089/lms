...
/**
 * The entity of e_sales_org as TABLE. <br>
 * 販売組織マスタ受信テーブル
 * <pre>
 * [primary-key]
 *     SALES_ORG_ID
 ...
 */
public abstract class BsESalesOrg extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsESalesOrg) {
            BsESalesOrg other = (BsESalesOrg)obj;
    ...
    @Override
    public ESalesOrg clone() {
        return (ESalesOrg)super.clone();
    }
