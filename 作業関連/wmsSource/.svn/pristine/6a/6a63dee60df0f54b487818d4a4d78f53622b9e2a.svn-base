...
public class BsTReceivePlanBCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<TReceivePlanBCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnStoreRowNo() { return doColumn("STORE_ROW_NO"); }
        /**
         * PLAN_PROD_DT: {VARCHAR(8)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPlanProdDt() { return doColumn("PLAN_PROD_DT"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnRemainingReceiveNum() { return doColumn("REMAINING_RECEIVE_NUM"); }
        /**
         * LOT_MANAG_TYPE_ID: {BIGINT(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnLotManagTypeId() { return doColumn("LOT_MANAG_TYPE_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnRemainFlg() { return doColumn("REMAIN_FLG"); }
        /**
         ...
         */
        public HpSDRFunction<TReceiveLabelCB, TReceivePlanBCQ> derivedTReceiveLabelList() {
            assertDerived("tReceiveLabelList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TReceiveLabelCB> sq, TReceivePlanBCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTReceiveLabelList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_receive_plan_data_transfer where ...) as FOO_MAX} <br>
         ...
         * }, TReceivePlanDataTransfer.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TReceivePlanDataTransferCB, TReceivePlanBCQ> derivedTReceivePlanDataTransferList() {
            assertDerived("tReceivePlanDataTransferList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TReceivePlanDataTransferCB> sq, TReceivePlanBCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTReceivePlanDataTransferList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
