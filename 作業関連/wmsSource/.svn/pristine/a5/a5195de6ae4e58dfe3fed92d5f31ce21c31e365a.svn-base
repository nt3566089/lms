...
/**
 * The entity of t_bldl5620 as TABLE. <br>
 * BLDL5620
 * <pre>
 * [primary-key]
 *     BLDL5620_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5620Id = entity.getBldl5620Id();
 ...
 * entity.setBldl5620Id(bldl5620Id);
 ...
 */
public abstract class BsTBldl5620 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5620Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5620) {
            BsTBldl5620 other = (BsTBldl5620)obj;
            if (!xSV(_bldl5620Id, other._bldl5620Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5620Id));
    ...
    @Override
    public TBldl5620 clone() {
        return (TBldl5620)super.clone();
    }
     ...
     * BLDL5620ID
     * @return The value of the column 'BLDL5620_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5620Id() {
        checkSpecifiedProperty("bldl5620Id");
        return _bldl5620Id;
    }
     ...
     * BLDL5620ID
     * @param bldl5620Id The value of the column 'BLDL5620_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5620Id(Long bldl5620Id) {
        registerModifiedProperty("bldl5620Id");
        _bldl5620Id = bldl5620Id;
    }
