...
public abstract class BsSqlShippingInstList extends AbstractEntity implements CustomizeEntity {
    ...
    //                                                                            ========
    /**
     * [get] SHIPPING_INST_H_ID: {BIGINT(20)} <br>
    ...
    /**
     * [set] SHIPPING_INST_H_ID: {BIGINT(20)} <br>
    ...
    /**
     * [get] PACKING_OUT_FLG: {VARCHAR(4)} <br>
    ...
    /**
     * [set] PACKING_OUT_FLG: {VARCHAR(4)} <br>
    ...
    /**
     * [get] INSPECTION_OUT_NM: {BINARY} <br>
    ...
    /**
     * [set] INSPECTION_OUT_NM: {BINARY} <br>
    ...
    /**
     * [get] INVOICE_CREATE_NM: {BINARY} <br>
    ...
    /**
     * [set] INVOICE_CREATE_NM: {BINARY} <br>
    ...
    /**
     * [get] INSPECTION_NUM: {DECIMAL(59)} <br>
    ...
    /**
     * [set] INSPECTION_NUM: {DECIMAL(59)} <br>
    ...
    /**
     * [get] LOADING_STATUS: {DECIMAL(28)} <br>
    ...
    /**
     * [set] LOADING_STATUS: {DECIMAL(28)} <br>
    ...
    /**
     * [get] PICKING_WORK_NO_CNT: {BIGINT(21)} <br>
    ...
    /**
     * [set] PICKING_WORK_NO_CNT: {BIGINT(21)} <br>
    ...
    /**
     * [get] SHIPPING_STOP_CS: {VARCHAR(1)} <br>
    ...
    /**
     * [set] SHIPPING_STOP_CS: {VARCHAR(1)} <br>
    ...
    /**
     * [get] SHIPPING_STOP_CS_NM: {BINARY} <br>
    ...
    /**
     * [set] SHIPPING_STOP_CS_NM: {BINARY} <br>
    ...
    /**
     * [get] SHIPPING_STOP_PD_NM: {BINARY} <br>
    ...
    /**
     * [set] SHIPPING_STOP_PD_NM: {BINARY} <br>
    ...
    /**
     * [get] FORCE_FIXED_FLG_NM: {BINARY} <br>
    ...
    /**
     * [set] FORCE_FIXED_FLG_NM: {BINARY} <br>
