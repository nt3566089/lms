...
public class BItemRoleDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnItemRoleId = cci("ITEM_ROLE_ID", "ITEM_ROLE_ID", null, null, Long.class, "itemRoleId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * ITEM_ROLE_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ForeignInfo foreignBRole() {
        ...
        return cfi("B_ITEM_ROLE_FK2", "BRole", this, BRoleDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "BItemRoleList", false);
    }
    /**
    ...
    public ForeignInfo foreignBItem() {
        ...
        return cfi("B_ITEM_ROLE_FK1", "BItem", this, BItemDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "BItemRoleList", false);
    }
    /**
