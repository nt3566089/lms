...
/**
 * The entity of t_bldl5353 as TABLE. <br>
 * BLDL5353
 * <pre>
 * [primary-key]
 *     BLDL5353_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5353Id = entity.getBldl5353Id();
 ...
 * entity.setBldl5353Id(bldl5353Id);
 ...
 */
public abstract class BsTBldl5353 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5353Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5353) {
            BsTBldl5353 other = (BsTBldl5353)obj;
            if (!xSV(_bldl5353Id, other._bldl5353Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5353Id));
    ...
    @Override
    public TBldl5353 clone() {
        return (TBldl5353)super.clone();
    }
     ...
     * BLDL5353ID
     * @return The value of the column 'BLDL5353_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5353Id() {
        checkSpecifiedProperty("bldl5353Id");
        return _bldl5353Id;
    }
     ...
     * BLDL5353ID
     * @param bldl5353Id The value of the column 'BLDL5353_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5353Id(Long bldl5353Id) {
        registerModifiedProperty("bldl5353Id");
        _bldl5353Id = bldl5353Id;
    }
