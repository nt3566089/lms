...
/**
 * The condition-query for in-line of e_inventory_record_dtl.
 * @author DBFlute(AutoGenerator)
 */
public class EInventoryRecordDtlCIQ extends AbstractBsEInventoryRecordDtlCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEInventoryRecordDtlCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EInventoryRecordDtlCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEInventoryRecordDtlCQ myCQ) {
    ...
    public String keepScalarCondition(EInventoryRecordDtlCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EInventoryRecordDtlCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EInventoryRecordDtlCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EInventoryRecordDtlCQ sq)
    ...
    protected String xinCB() { return EInventoryRecordDtlCB.class.getName(); }
    protected String xinCQ() { return EInventoryRecordDtlCQ.class.getName(); }
}
