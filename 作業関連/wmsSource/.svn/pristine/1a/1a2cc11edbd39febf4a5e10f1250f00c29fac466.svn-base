...
public abstract class BsMZoneDtoMapper implements DtoMapper<MZone, MZoneDto>, Serializable {
    ...
    public MZoneDto mappingToDto(MZone entity) {
        ...
        dto.setFloorCd(entity.getFloorCd());
        dto.setStorageSpaceCd(entity.getStorageSpaceCd());
        dto.setReplenishTypeCd(entity.getReplenishTypeCd());
    ...
    public MZone mappingToEntity(MZoneDto dto) {
        ...
        if (needsMapping(dto, dto.getFloorCd(), "floorCd")) {
            entity.setFloorCd(dto.getFloorCd());
        }
        if (needsMapping(dto, dto.getStorageSpaceCd(), "storageSpaceCd")) {
            entity.setStorageSpaceCd(dto.getStorageSpaceCd());
        }
        if (needsMapping(dto, dto.getReplenishTypeCd(), "replenishTypeCd")) {
            entity.setReplenishTypeCd(dto.getReplenishTypeCd());
        }
