...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsEsSalesOrgCQ;

/**
 * The condition-query of es_sales_org.
 * <p>
 ...
 */
public class EsSalesOrgCQ extends BsEsSalesOrgCQ {
     ...
     */
    public EsSalesOrgCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
