...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsEInventoryInstDtlCQ;

/**
 * The condition-query of e_inventory_inst_dtl.
 * <p>
 ...
 */
public class EInventoryInstDtlCQ extends BsEInventoryInstDtlCQ {
     ...
     */
    public EInventoryInstDtlCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
