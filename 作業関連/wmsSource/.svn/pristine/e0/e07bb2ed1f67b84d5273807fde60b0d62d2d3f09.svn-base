...
/**
 * The base condition-bean of er_serial_no.
 * @author DBFlute(AutoGenerator)
 */
public class BsErSerialNoCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ErSerialNoCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsErSerialNoCB() {
     ...
     * @return this. (NotNull)
     */
    public ErSerialNoCB acceptPK(Long serialNoId) {
        assertObjectNotNull("serialNoId", serialNoId);
        BsErSerialNoCB cb = this;
        cb.query().setSerialNoId_Equal(serialNoId);
        return (ErSerialNoCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ErSerialNoCB acceptUniqueOf(String receiveCd, Long receiveRowId) {
     ...
     */
    public ErSerialNoCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ErSerialNoCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ErSerialNoCQ doGetConditionQuery() {
    ...
    protected ErSerialNoCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ErSerialNoCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ErSerialNoCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ErSerialNoCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ErSerialNoCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ErSerialNoCB> unionCBLambda) {
        final ErSerialNoCB cb = new ErSerialNoCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErSerialNoCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ErSerialNoCB> unionCBLambda) {
        final ErSerialNoCB cb = new ErSerialNoCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErSerialNoCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ErSerialNoCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ErSerialNoCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "er_serial_no"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<ErSerialNoCB, ErSerialNoCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ErSerialNoCB> sq, ErSerialNoCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ErSerialNoCB dreamCruiseCB() {
        ErSerialNoCB cb = new ErSerialNoCB();
        cb.xsetupForDreamCruise((ErSerialNoCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ErSerialNoCB> columnQuery(final SpecifyQuery<ErSerialNoCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ErSerialNoCB xcreateColumnQueryCB() {
        ErSerialNoCB cb = new ErSerialNoCB();
        cb.xsetupForColumnQuery((ErSerialNoCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ErSerialNoCB> orCBLambda) {
        xorSQ((ErSerialNoCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ErSerialNoCB> andCBLambda) {
        xorSQAP((ErSerialNoCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ErSerialNoCB cb;
        if (mainCB != null) {
            cb = (ErSerialNoCB)mainCB;
        } else {
            cb = new ErSerialNoCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ErSerialNoCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ErSerialNoCQ.class.getName(); }
