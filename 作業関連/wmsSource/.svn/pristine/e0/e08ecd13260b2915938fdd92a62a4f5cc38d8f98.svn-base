...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTNizoroeAlarmLogCQ;

/**
 * The condition-query of t_nizoroe_alarm_log.
 * <p>
 ...
 */
public class TNizoroeAlarmLogCQ extends BsTNizoroeAlarmLogCQ {
     ...
     */
    public TNizoroeAlarmLogCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
