...
public class MWarehouseDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnWarehouseId = cci("WAREHOUSE_ID", "WAREHOUSE_ID", null, null, Long.class, "warehouseId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MWebHtInfoList,MZoneList,TAllocInstBList,TInventoryBList,TMoveInstBList,TReceivePlanBList,TShippingInstBList,TStockList,WHtInventoryInputProdList,WHtReceiveInspectionList,WHtReceiveNoPlanInspList,WHtReceiveStoreList", null, false);
    ...
    public ReferrerInfo referrerMWebHtInfoList() {
        ...
        return cri("M_WEB_HT_INFO_FK1", "MWebHtInfoList", this, MWebHtInfoDbm.getInstance(), mp, false, "MWarehouse");
    }
    /**
    ...
    public ReferrerInfo referrerTAllocInstBList() {
        ...
        return cri("T_ALLOC_INST_B_FK6", "TAllocInstBList", this, TAllocInstBDbm.getInstance(), mp, false, "MWarehouse");
    }
    /**
    ...
    public ReferrerInfo referrerTInventoryBList() {
        ...
        return cri("T_INVENTORY_B_FK9", "TInventoryBList", this, TInventoryBDbm.getInstance(), mp, false, "MWarehouse");
    }
    /**
    ...
    public ReferrerInfo referrerTMoveInstBList() {
        ...
        return cri("T_MOVE_INST_B_FK9", "TMoveInstBList", this, TMoveInstBDbm.getInstance(), mp, false, "MWarehouse");
    }
    /**
    ...
    public ReferrerInfo referrerTReceivePlanBList() {
        ...
        return cri("T_RECEIVE_PLAN_B_FK3", "TReceivePlanBList", this, TReceivePlanBDbm.getInstance(), mp, false, "MWarehouse");
    }
    /**
    ...
    public ReferrerInfo referrerTShippingInstBList() {
        ...
        return cri("T_SHIPPING_INST_B_FK10", "TShippingInstBList", this, TShippingInstBDbm.getInstance(), mp, false, "MWarehouse");
    }
    /**
    ...
    public ReferrerInfo referrerTStockList() {
        ...
        return cri("T_STOCK_FK8", "TStockList", this, TStockDbm.getInstance(), mp, false, "MWarehouse");
    }
    /**
    ...
    public ReferrerInfo referrerWHtInventoryInputProdList() {
        ...
        return cri("W_HT_INVENTORY_INPUT_PROD_FK3", "WHtInventoryInputProdList", this, WHtInventoryInputProdDbm.getInstance(), mp, false, "MWarehouse");
    }
    /**
    ...
    public ReferrerInfo referrerWHtReceiveStoreList() {
        ...
        return cri("W_HT_RECEIVE_STORE_FK5", "WHtReceiveStoreList", this, WHtReceiveStoreDbm.getInstance(), mp, false, "MWarehouse");
    }
