...
public abstract class BsWHtReceiveInspectionDtoMapper implements DtoMapper<WHtReceiveInspection, WHtReceiveInspectionDto>, Serializable {
    ...
    public WHtReceiveInspectionDto mappingToDto(WHtReceiveInspection entity) {
        ...
        dto.setProductionDt(entity.getProductionDt());
        dto.setInputAssistanceUnitNum(entity.getInputAssistanceUnitNum());
        dto.setInputAssistanceCaseNum(entity.getInputAssistanceCaseNum());
        dto.setInputAssistancePieceNum(entity.getInputAssistancePieceNum());
        dto.setCaseReceiveLabelNum(entity.getCaseReceiveLabelNum());
        dto.setPieceReceiveLabelNum(entity.getPieceReceiveLabelNum());
    ...
    public WHtReceiveInspection mappingToEntity(WHtReceiveInspectionDto dto) {
        ...
        if (needsMapping(dto, dto.getProductionDt(), "productionDt")) {
            entity.setProductionDt(dto.getProductionDt());
        }
        if (needsMapping(dto, dto.getInputAssistanceUnitNum(), "inputAssistanceUnitNum")) {
            entity.setInputAssistanceUnitNum(dto.getInputAssistanceUnitNum());
        }
        if (needsMapping(dto, dto.getInputAssistanceCaseNum(), "inputAssistanceCaseNum")) {
            entity.setInputAssistanceCaseNum(dto.getInputAssistanceCaseNum());
        }
        if (needsMapping(dto, dto.getInputAssistancePieceNum(), "inputAssistancePieceNum")) {
            entity.setInputAssistancePieceNum(dto.getInputAssistancePieceNum());
        }
        if (needsMapping(dto, dto.getCaseReceiveLabelNum(), "caseReceiveLabelNum")) {
            entity.setCaseReceiveLabelNum(dto.getCaseReceiveLabelNum());
        }
        if (needsMapping(dto, dto.getPieceReceiveLabelNum(), "pieceReceiveLabelNum")) {
            entity.setPieceReceiveLabelNum(dto.getPieceReceiveLabelNum());
        }
