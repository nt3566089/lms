...
public class SqlShipmentRequestProductDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnPackingNum = cci("PACKING_NUM", "PACKING_NUM", null, null, java.math.BigDecimal.class, "packingNum", null, false, false, false, "DECIMAL", 58, 4, null, null, false, null, null, null, null, null, false);
