...
/**
 * The entity of er_inventory_inst_dtl as TABLE. <br>
 * 棚卸指示(明細)受信テーブル
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsErInventoryInstDtl extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsErInventoryInstDtl) {
            BsErInventoryInstDtl other = (BsErInventoryInstDtl)obj;
    ...
    @Override
    public ErInventoryInstDtl clone() {
        return (ErInventoryInstDtl)super.clone();
    }
