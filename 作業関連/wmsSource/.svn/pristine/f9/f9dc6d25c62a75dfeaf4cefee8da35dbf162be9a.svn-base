...
public class TInventoryHCIQ extends AbstractBsTInventoryHCQ {
    ...
    protected ConditionValue xgetCValueInventoryInstNo() { return _myCQ.xdfgetInventoryInstNo(); }
    protected ConditionValue xgetCValueInventoryStatusTypeId() { return _myCQ.xdfgetInventoryStatusTypeId(); }
    protected ConditionValue xgetCValueInventoryStatusTypeCd() { return _myCQ.xdfgetInventoryStatusTypeCd(); }
    protected ConditionValue xgetCValueInstRecvTime() { return _myCQ.xdfgetInstRecvTime(); }
    protected ConditionValue xgetCValueReportSendTime() { return _myCQ.xdfgetReportSendTime(); }
    protected ConditionValue xgetCValueInventoryUpdateFlg() { return _myCQ.xdfgetInventoryUpdateFlg(); }
    protected ConditionValue xgetCValueInventoryDataStatus() { return _myCQ.xdfgetInventoryDataStatus(); }
