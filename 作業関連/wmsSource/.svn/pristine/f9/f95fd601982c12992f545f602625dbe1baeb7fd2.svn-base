...
public class TPickingHCIQ extends AbstractBsTPickingHCQ {
    ...
    protected ConditionValue xgetCValuePickForceCopleteFlg() { return _myCQ.xdfgetPickForceCopleteFlg(); }
    protected ConditionValue xgetCValueInspForceCopleteFlg() { return _myCQ.xdfgetInspForceCopleteFlg(); }
    ...
    protected ConditionValue xgetCValueNizoroePrintTypeCd() { return _myCQ.xdfgetNizoroePrintTypeCd(); }
    protected ConditionValue xgetCValueDelivPrintTypeCd() { return _myCQ.xdfgetDelivPrintTypeCd(); }
    protected ConditionValue xgetCValueTagPrintTypeCd() { return _myCQ.xdfgetTagPrintTypeCd(); }
    protected ConditionValue xgetCValueIntegPrintFlg() { return _myCQ.xdfgetIntegPrintFlg(); }
    protected ConditionValue xgetCValueIdManagPrintFlg() { return _myCQ.xdfgetIdManagPrintFlg(); }
    protected ConditionValue xgetCValueScmPrintFlg() { return _myCQ.xdfgetScmPrintFlg(); }
