...
/**
 * The abstract condition-query of t_id_manag_data.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTIdManagDataCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTIdManagDataCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<TIdManagDataCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TIdManagDataCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TIdManagDataCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TIdManagDataCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TIdManagDataCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TIdManagDataCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TIdManagDataCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TIdManagDataCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TIdManagDataCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TIdManagDataCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TIdManagDataCB&gt;() {
     *     public void query(TIdManagDataCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TIdManagDataCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TIdManagDataCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TIdManagDataCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TIdManagDataCQ sq);

    protected TIdManagDataCB xcreateScalarConditionCB() {
        TIdManagDataCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TIdManagDataCB xcreateScalarConditionPartitionByCB() {
        TIdManagDataCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TIdManagDataCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TIdManagDataCB cb = new TIdManagDataCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "ID_MANAG_DATA_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TIdManagDataCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TIdManagDataCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TIdManagDataCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TIdManagDataCB cb = new TIdManagDataCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "ID_MANAG_DATA_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TIdManagDataCQ sq);
     ...
     */
    public void myselfExists(SubQuery<TIdManagDataCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TIdManagDataCB cb = new TIdManagDataCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TIdManagDataCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TIdManagDataCB newMyCB() {
        return new TIdManagDataCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TIdManagDataCQ.class.getName(); }
