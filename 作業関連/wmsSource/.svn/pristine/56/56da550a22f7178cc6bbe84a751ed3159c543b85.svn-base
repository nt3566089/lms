...
public class BsMZoneCB extends AbstractConditionBean {
     ...
     * @param zoneId : PK, ID, NotNull, BIGINT(19). (NotNull)
     * @return this. (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<MZoneCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnFloorCd() { return doColumn("FLOOR_CD"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnReplenishTypeCd() { return doColumn("REPLENISH_TYPE_CD"); }
        /**
