...
/**
 * The entity of t_shipping_record_b as TABLE. <br>
 * 出荷実績ボディ
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long shippingRecordBId = entity.getShippingRecordBId();
 ...
 * String srSendFlg = entity.getSrSendFlg();
 ...
 * entity.setShippingRecordBId(shippingRecordBId);
 ...
 */
public abstract class BsTShippingRecordB extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_shippingRecordBId == null) { return false; }
    ...
    protected TShippingRecordH _tShippingRecordH;

    /**
     * [get] t_shipping_record_h by my SHIPPING_RECORD_H_ID, named 'TShippingRecordH'. <br>
     * @return The entity of foreign property 'TShippingRecordH'. (NullAllowed: when e.g. null FK column, no setupSelect)
     */
    public TShippingRecordH getTShippingRecordH() {
        return _tShippingRecordH;
    }

    /**
     * [set] t_shipping_record_h by my SHIPPING_RECORD_H_ID, named 'TShippingRecordH'.
     * @param tShippingRecordH The entity of foreign property 'TShippingRecordH'. (NullAllowed)
     */
    public void setTShippingRecordH(TShippingRecordH tShippingRecordH) {
        _tShippingRecordH = tShippingRecordH;
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTShippingRecordB) {
            BsTShippingRecordB other = (BsTShippingRecordB)obj;
            if (!xSV(_shippingRecordBId, other._shippingRecordBId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        { sb.append(li).append(xbRDS(_tShippingRecordH, "tShippingRecordH")); }
        return sb.toString();
    }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_shippingRecordBId));
        ...
        sb.append(dm).append(xfND(_srSendFlg));
    ...
    protected String doBuildRelationString(String dm) {
        StringBuilder sb = new StringBuilder();
        if (_tShippingRecordH != null)
        { sb.append(dm).append("tShippingRecordH"); }
        if (sb.length() > dm.length()) {
    ...
    @Override
    public TShippingRecordB clone() {
        return (TShippingRecordB)super.clone();
    }
     ...
     * 出荷実績ボディID
     * @return The value of the column 'SHIPPING_RECORD_B_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getShippingRecordBId() {
        checkSpecifiedProperty("shippingRecordBId");
     ...
     * 出荷実績ボディID
     * @param shippingRecordBId The value of the column 'SHIPPING_RECORD_B_ID'. (basically NotNull if update: for the constraint)
     */
    public void setShippingRecordBId(Long shippingRecordBId) {
        registerModifiedProperty("shippingRecordBId");
        _shippingRecordBId = shippingRecordBId;
    }

    /**
     * [get] SHIPPING_RECORD_H_ID: {IX, BIGINT(19), FK to t_shipping_record_h} <br>
     * 出荷実績ヘッダID
     * @return The value of the column 'SHIPPING_RECORD_H_ID'. (NullAllowed even if selected: for no constraint)
     */
     ...
     * 出荷実績ヘッダID
     * @param shippingRecordHId The value of the column 'SHIPPING_RECORD_H_ID'. (NullAllowed: null update allowed for no constraint)
     */
     ...
     * 出荷実績送信済フラグ
     * @return The value of the column 'SR_SEND_FLG'. (NullAllowed even if selected: for no constraint)
     */
    public String getSrSendFlg() {
        checkSpecifiedProperty("srSendFlg");
        return convertEmptyToNull(_srSendFlg);
    }

    /**
     * [set] SR_SEND_FLG: {CHAR(1), default=[0]} <br>
     * 出荷実績送信済フラグ
     * @param srSendFlg The value of the column 'SR_SEND_FLG'. (NullAllowed: null update allowed for no constraint)
     */
    public void setSrSendFlg(String srSendFlg) {
        registerModifiedProperty("srSendFlg");
        _srSendFlg = srSendFlg;
    }
