...
/**
 * The entity of t_bldl5150 as TABLE. <br>
 * BLDL5150
 * <pre>
 * [primary-key]
 *     BLDL5150_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5150Id = entity.getBldl5150Id();
 ...
 * entity.setBldl5150Id(bldl5150Id);
 ...
 */
public abstract class BsTBldl5150 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5150Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5150) {
            BsTBldl5150 other = (BsTBldl5150)obj;
            if (!xSV(_bldl5150Id, other._bldl5150Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5150Id));
    ...
    @Override
    public TBldl5150 clone() {
        return (TBldl5150)super.clone();
    }
     ...
     * BLDL5150ID
     * @return The value of the column 'BLDL5150_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5150Id() {
        checkSpecifiedProperty("bldl5150Id");
        return _bldl5150Id;
    }
     ...
     * BLDL5150ID
     * @param bldl5150Id The value of the column 'BLDL5150_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5150Id(Long bldl5150Id) {
        registerModifiedProperty("bldl5150Id");
        _bldl5150Id = bldl5150Id;
    }
