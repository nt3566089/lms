...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTBldl5312CQ;

/**
 * The condition-query of t_bldl5312.
 * <p>
 ...
 */
public class TBldl5312CQ extends BsTBldl5312CQ {
     ...
     */
    public TBldl5312CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
