 ...
 * java.math.BigDecimal packingCaseCnt = entity.getPackingCaseCnt();
 * java.math.BigDecimal packingMixedCnt = entity.getPackingMixedCnt();
 * String multiPicFlg = entity.getMultiPicFlg();
 * String multiPicFlgNm = entity.getMultiPicFlgNm();
 * String tagOutFlg = entity.getTagOutFlg();
 * String tagOutFlgNm = entity.getTagOutFlgNm();
...
public abstract class BsSqlPickingListPrint extends AbstractEntity implements CustomizeEntity {
    ...
    protected java.math.BigDecimal _packingCaseCnt;

    /** PACKING_MIXED_CNT: {DECIMAL(23)} */
    protected java.math.BigDecimal _packingMixedCnt;
    ...
    protected String _multiPicFlgNm;

    /** TAG_OUT_FLG: {VARCHAR(16)} */
    protected String _tagOutFlg;

    /** TAG_OUT_FLG_NM: {NULL} */
    protected String _tagOutFlgNm;
     ...
     * MULTI_PIC_FLG: {CHAR(1), refers to t_packing_h.MULTI_PIC_FLG, classification=MultiPicFlg} <br>
     * マルチピック計算フラグ
     ...
     * SGL_ROW_PIC_FLG: {CHAR(1), refers to t_picking_h.SGL_ROW_PIC_FLG, classification=SglRowPicFlg} <br>
     * 単行ピックフラグ
     * <p>It's treated as case insensitive and if the code value is null, it returns null.</p>
     * @return The instance of classification definition (as ENUM type). (NullAllowed: when the column value is null)
     */
    ...
    /**
     * [get] SHIPPING_DT: {VARCHAR(8), refers to t_alloc_inst_h.SHIPPING_DT} <br>
     * 出荷日
    ...
    /**
     * [set] SHIPPING_DT: {VARCHAR(8), refers to t_alloc_inst_h.SHIPPING_DT} <br>
     * 出荷日
    ...
    /**
     * [get] CARRIER_NM: {VARCHAR(60), refers to m_carrier.CARRIER_NM} <br>
     * 運送業者名称
    ...
    /**
     * [set] CARRIER_NM: {VARCHAR(60), refers to m_carrier.CARRIER_NM} <br>
     * 運送業者名称
    ...
    /**
     * [get] PL1_OUT_DT: {DATETIME(23), refers to t_picking_r.PL1_OUT_DT} <br>
     * 1次ピッキングリスト出力日時
    ...
    /**
     * [set] PL1_OUT_DT: {DATETIME(23), refers to t_picking_r.PL1_OUT_DT} <br>
     * 1次ピッキングリスト出力日時
    ...
    /**
     * [get] PL2_OUT_DT: {DATETIME(23), refers to t_picking_r.PL2_OUT_DT} <br>
     * 2次ピッキングリスト出力日時
    ...
    /**
     * [set] PL2_OUT_DT: {DATETIME(23), refers to t_picking_r.PL2_OUT_DT} <br>
     * 2次ピッキングリスト出力日時
    ...
    /**
     * [get] CASE_OUT_DT: {DATETIME(23), refers to t_picking_r.CASE_OUT_DT} <br>
     * ケースピッキングリスト出力日時
    ...
    /**
     * [set] CASE_OUT_DT: {DATETIME(23), refers to t_picking_r.CASE_OUT_DT} <br>
     * ケースピッキングリスト出力日時
    ...
    /**
     * [set] MULTI_PIC_FLG: {CHAR(1), refers to t_packing_h.MULTI_PIC_FLG, classification=MultiPicFlg} <br>
     * マルチピック計算フラグ<br>
     * // cls(MultiPicFlg) マルチピック計算フラグ
    ...
    /**
     * [get] SGL_ROW_PIC_FLG: {CHAR(1), refers to t_picking_h.SGL_ROW_PIC_FLG, classification=SglRowPicFlg} <br>
     * 単行ピックフラグ<br>
     * // cls(SglRowPicFlg)
    ...
    /**
     * [set] SGL_ROW_PIC_FLG: {CHAR(1), refers to t_picking_h.SGL_ROW_PIC_FLG, classification=SglRowPicFlg} <br>
     * 単行ピックフラグ<br>
     * // cls(SglRowPicFlg)
