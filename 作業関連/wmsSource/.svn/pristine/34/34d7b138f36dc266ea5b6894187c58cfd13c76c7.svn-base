...
public class BsTInventoryBCB extends AbstractConditionBean {
     ...
     * @param inventoryBId : PK, ID, NotNull, BIGINT(19). (NotNull)
     * @return this. (NotNull)
     */
    ...
    protected BUserNss _nssBUserByInventoryUpdUserId;
    public BUserNss xdfgetNssBUserByInventoryUpdUserId() {
        if (_nssBUserByInventoryUpdUserId == null) { _nssBUserByInventoryUpdUserId = new BUserNss(null); }
        return _nssBUserByInventoryUpdUserId;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tInventoryBBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_BUserByInventoryUpdUserId()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tInventoryB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tInventoryB</span>.<span style="color: #CC4747">getBUserByInventoryUpdUserId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public BUserNss setupSelect_BUserByInventoryUpdUserId() {
        assertSetupSelectPurpose("bUserByInventoryUpdUserId");
        if (hasSpecifiedLocalColumn()) {
            specify().columnInventoryUpdUserId();
        }
        doSetupSelect(() -> query().queryBUserByInventoryUpdUserId());
        if (_nssBUserByInventoryUpdUserId == null || !_nssBUserByInventoryUpdUserId.hasConditionQuery())
        { _nssBUserByInventoryUpdUserId = new BUserNss(query().queryBUserByInventoryUpdUserId()); }
        return _nssBUserByInventoryUpdUserId;
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tInventoryB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tInventoryB</span>.<span style="color: #CC4747">getMSalesOrg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    ...
    protected MCustomerNss _nssMCustomerByAccountId;
    public MCustomerNss xdfgetNssMCustomerByAccountId() {
        if (_nssMCustomerByAccountId == null) { _nssMCustomerByAccountId = new MCustomerNss(null); }
        return _nssMCustomerByAccountId;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tInventoryBBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_MCustomerByAccountId()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tInventoryB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tInventoryB</span>.<span style="color: #CC4747">getMCustomerByAccountId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public MCustomerNss setupSelect_MCustomerByAccountId() {
        assertSetupSelectPurpose("mCustomerByAccountId");
        if (hasSpecifiedLocalColumn()) {
            specify().columnAccountId();
        }
        doSetupSelect(() -> query().queryMCustomerByAccountId());
        if (_nssMCustomerByAccountId == null || !_nssMCustomerByAccountId.hasConditionQuery())
        { _nssMCustomerByAccountId = new MCustomerNss(query().queryMCustomerByAccountId()); }
        return _nssMCustomerByAccountId;
    }
    ...
    protected BUserNss _nssBUserByInventoryUserId;
    public BUserNss xdfgetNssBUserByInventoryUserId() {
        if (_nssBUserByInventoryUserId == null) { _nssBUserByInventoryUserId = new BUserNss(null); }
        return _nssBUserByInventoryUserId;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tInventoryBBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_BUserByInventoryUserId()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tInventoryB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tInventoryB</span>.<span style="color: #CC4747">getBUserByInventoryUserId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public BUserNss setupSelect_BUserByInventoryUserId() {
        assertSetupSelectPurpose("bUserByInventoryUserId");
        if (hasSpecifiedLocalColumn()) {
            specify().columnInventoryUserId();
        }
        doSetupSelect(() -> query().queryBUserByInventoryUserId());
        if (_nssBUserByInventoryUserId == null || !_nssBUserByInventoryUserId.hasConditionQuery())
        { _nssBUserByInventoryUserId = new BUserNss(query().queryBUserByInventoryUserId()); }
        return _nssBUserByInventoryUserId;
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<TInventoryBCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnHtInputInventoryNum() { return doColumn("HT_INPUT_INVENTORY_NUM"); }
        /**
         * WEB_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnWebInputInventoryNum() { return doColumn("WEB_INPUT_INVENTORY_NUM"); }
        /**
         * AJIS_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnAjisInputInventoryNum() { return doColumn("AJIS_INPUT_INVENTORY_NUM"); }
        /**
         * PROD_DT: {VARCHAR(8)}
         * @return The information object of specified column. (NotNull)
         */
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnAreaCd() { return doColumn("AREA_CD"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnAllocTypeCd() { return doColumn("ALLOC_TYPE_CD"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCmSendFlg() { return doColumn("CM_SEND_FLG"); }
        /**
         * INVENTORY_USER_ID: {IX, BIGINT(19), FK to b_user}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnInventoryUserId() { return doColumn("INVENTORY_USER_ID"); }
        /**
         * INVENTORY_UPD_USER_ID: {IX, BIGINT(19), FK to b_user}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnInventoryUpdUserId() { return doColumn("INVENTORY_UPD_USER_ID"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryBUserByInventoryUpdUserId()
                    || qyCall().qy().xgetReferrerQuery() instanceof BUserCQ) {
                columnInventoryUpdUserId(); // FK or one-to-one referrer
            }
            ...
            if (qyCall().qy().hasConditionQueryMCustomerByAccountId()
            ...
            if (qyCall().qy().hasConditionQueryBUserByInventoryUserId()
                    || qyCall().qy().xgetReferrerQuery() instanceof BUserCQ) {
                columnInventoryUserId(); // FK or one-to-one referrer
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public BUserCB.HpSpecification specifyBUserByInventoryUpdUserId() {
            assertRelation("bUserByInventoryUpdUserId");
            if (_bUserByInventoryUpdUserId == null) {
                _bUserByInventoryUpdUserId = new BUserCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryBUserByInventoryUpdUserId()
                                    , () -> _qyCall.qy().queryBUserByInventoryUpdUserId())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _bUserByInventoryUpdUserId.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBUserByInventoryUpdUserId()
                      , () -> xsyncQyCall().qy().queryBUserByInventoryUpdUserId()));
                }
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public MCustomerCB.HpSpecification specifyMCustomerByAccountId() {
            assertRelation("mCustomerByAccountId");
            if (_mCustomerByAccountId == null) {
                _mCustomerByAccountId = new MCustomerCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryMCustomerByAccountId()
                                    , () -> _qyCall.qy().queryMCustomerByAccountId())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _mCustomerByAccountId.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryMCustomerByAccountId()
                      , () -> xsyncQyCall().qy().queryMCustomerByAccountId()));
                }
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public BUserCB.HpSpecification specifyBUserByInventoryUserId() {
            assertRelation("bUserByInventoryUserId");
            if (_bUserByInventoryUserId == null) {
                _bUserByInventoryUserId = new BUserCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryBUserByInventoryUserId()
                                    , () -> _qyCall.qy().queryBUserByInventoryUserId())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _bUserByInventoryUserId.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBUserByInventoryUserId()
                      , () -> xsyncQyCall().qy().queryBUserByInventoryUserId()));
                }
            }
        ...
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_inventory_receive_label where ...) as FOO_MAX} <br>
         * t_inventory_receive_label by INVENTORY_B_ID, named 'TInventoryReceiveLabelList'.
         * <pre>
         * cb.specify().<span style="color: #CC4747">derived${relationMethodIdentityName}()</span>.<span style="color: #CC4747">max</span>(labelCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
         *     labelCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     labelCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, TInventoryReceiveLabel.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TInventoryReceiveLabelCB, TInventoryBCQ> derivedTInventoryReceiveLabelList() {
            assertDerived("tInventoryReceiveLabelList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TInventoryReceiveLabelCB> sq, TInventoryBCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTInventoryReceiveLabelList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
