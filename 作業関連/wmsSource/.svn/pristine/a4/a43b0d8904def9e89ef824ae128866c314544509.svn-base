...
public abstract class BsHReceiveSpareDto implements Serializable {
    ...
    //                                                Column
    //                                                ------
    /** STORE_RECORD_B_ID: {PK, NotNull, BIGINT(19), FK to h_receive_b} */
    @JsonKey
    ...
    //                                                                            ========
    /**
     * [get] STORE_RECORD_B_ID: {PK, NotNull, BIGINT(19), FK to h_receive_b} <br>
     * 入庫実績ボディID
    ...
    /**
     * [set] STORE_RECORD_B_ID: {PK, NotNull, BIGINT(19), FK to h_receive_b} <br>
     * 入庫実績ボディID
