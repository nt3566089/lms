...
/**
 * The DTO mapper of t_receive_label as TABLE. <br>
 * 入荷ラベル
 * <pre>
 * [primary-key]
 *     RECEIVE_LABEL_ID
 ...
 */
public abstract class BsTReceiveLabelDtoMapper implements DtoMapper<TReceiveLabel, TReceiveLabelDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTReceiveLabelDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTReceiveLabelDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TReceiveLabelDto mappingToDto(TReceiveLabel entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (TReceiveLabelDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TReceiveLabelDto dto = new TReceiveLabelDto();
        dto.setReceiveLabelId(entity.getReceiveLabelId());
        dto.setStockId(entity.getStockId());
        dto.setReceiveLabelNo(entity.getReceiveLabelNo());
        dto.setNum(entity.getNum());
        dto.setOwnerCd(entity.getOwnerCd());
        dto.setOwnerAbbr(entity.getOwnerAbbr());
        dto.setRecommendLocationCd(entity.getRecommendLocationCd());
        ...
        dto.setReprintFlg(entity.getReprintFlg());
        dto.setReceiveUnitNum(entity.getReceiveUnitNum());
        dto.setReceivePlanBId(entity.getReceivePlanBId());
        dto.setRcvLblOutUserId(entity.getRcvLblOutUserId());
        dto.setRcvLblOutDt(entity.getRcvLblOutDt());
        ...
        if (!_suppressTReceivePlanB && entity.getTReceivePlanB() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getTReceiveLabelList().add(dto);
                }
            } else {
                ...
                mapper.suppressTReceiveLabelList();
     ...
     * {@inheritDoc}
     */
    public List<TReceiveLabelDto> mappingToDtoList(List<TReceiveLabel> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TReceiveLabelDto> dtoList = new ArrayList<TReceiveLabelDto>();
        for (TReceiveLabel entity : entityList) {
            TReceiveLabelDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TReceiveLabel mappingToEntity(TReceiveLabelDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (TReceiveLabel)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TReceiveLabel entity = new TReceiveLabel();
        if (needsMapping(dto, dto.getReceiveLabelId(), "receiveLabelId")) {
            entity.setReceiveLabelId(dto.getReceiveLabelId());
        }
        ...
        if (needsMapping(dto, dto.getOwnerAbbr(), "ownerAbbr")) {
            entity.setOwnerAbbr(dto.getOwnerAbbr());
        }
        if (needsMapping(dto, dto.getRecommendLocationCd(), "recommendLocationCd")) {
            entity.setRecommendLocationCd(dto.getRecommendLocationCd());
        }
        ...
        if (needsMapping(dto, dto.getReprintFlg(), "reprintFlg")) {
            entity.setReprintFlg(dto.getReprintFlg());
        }
        if (needsMapping(dto, dto.getReceiveUnitNum(), "receiveUnitNum")) {
            entity.setReceiveUnitNum(dto.getReceiveUnitNum());
        }
        if (needsMapping(dto, dto.getReceivePlanBId(), "receivePlanBId")) {
            entity.setReceivePlanBId(dto.getReceivePlanBId());
        }
        if (needsMapping(dto, dto.getRcvLblOutUserId(), "rcvLblOutUserId")) {
            entity.setRcvLblOutUserId(dto.getRcvLblOutUserId());
        }
        if (needsMapping(dto, dto.getRcvLblOutDt(), "rcvLblOutDt")) {
            entity.setRcvLblOutDt(dto.getRcvLblOutDt());
        }
        ...
        if (!_suppressTReceivePlanB && dto.getTReceivePlanB() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getTReceiveLabelList().add(entity);
                }
            } else {
                TReceivePlanBDtoMapper mapper = new TReceivePlanBDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(TReceiveLabelDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TReceiveLabel> mappingToEntityList(List<TReceiveLabelDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TReceiveLabel> entityList = new ArrayList<TReceiveLabel>();
        for (TReceiveLabelDto dto : dtoList) {
            TReceiveLabel entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TReceiveLabelDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TReceiveLabelDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TReceiveLabelDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TReceiveLabelDtoMapper reverseReference() {
