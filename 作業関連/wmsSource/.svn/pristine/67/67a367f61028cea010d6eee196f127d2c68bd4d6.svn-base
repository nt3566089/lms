...
/**
 * The simple DTO of t_bldl5620 as TABLE. <br>
 * BLDL5620
 * <pre>
 * [primary-key]
 *     BLDL5620_ID
...
public abstract class BsTBldl5620Dto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTBldl5620Dto)) { return false; }
        final BsTBldl5620Dto otherEntity = (BsTBldl5620Dto)other;
        if (!helpComparingValue(getBldl5620Id(), otherEntity.getBldl5620Id())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "t_bldl5620");
        result = xCH(result, getBldl5620Id());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getBldl5620Id());
        ...
        sb.append(c).append(getUnShippingCnt());
    ...
    //                                                                            ========
    /**
     * [get] BLDL5620_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5620ID
     * @return The value of the column 'BLDL5620_ID'. (NullAllowed)
     */
    public Long getBldl5620Id() {
        return _bldl5620Id;
    }

    /**
     * [set] BLDL5620_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5620ID
     * @param bldl5620Id The value of the column 'BLDL5620_ID'. (NullAllowed)
     */
    public void setBldl5620Id(Long bldl5620Id) {
        __modifiedProperties.add("bldl5620Id");
        this._bldl5620Id = bldl5620Id;
    }
     ...
     * UN関連_出荷件数
     * @return The value of the column 'UN_SHIPPING_CNT'. (NullAllowed)
     */
     ...
     * UN関連_出荷件数
     * @param unShippingCnt The value of the column 'UN_SHIPPING_CNT'. (NullAllowed)
     */
    public void setUnShippingCnt(Long unShippingCnt) {
        __modifiedProperties.add("unShippingCnt");
        this._unShippingCnt = unShippingCnt;
    }
