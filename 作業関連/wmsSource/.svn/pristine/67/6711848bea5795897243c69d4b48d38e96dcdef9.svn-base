...
/**
 * The simple DTO of er_sales_org as TABLE. <br>
 * 販売組織マスタ受信テーブル
 * <pre>
 * [primary-key]
 *     SALES_ORG_ID
...
public abstract class BsErSalesOrgDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsErSalesOrgDto)) { return false; }
        final BsErSalesOrgDto otherEntity = (BsErSalesOrgDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "er_sales_org");
