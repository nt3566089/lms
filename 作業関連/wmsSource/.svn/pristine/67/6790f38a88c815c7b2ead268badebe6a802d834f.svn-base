 ...
 *
 * [foreign-table]
 *     m_center_class, b_dict, v_dict
 *
 * [referrer-table]
 *     m_center_class_grp_dtl
 *
 * [foreign-property]
 *     mCenterClass, bDict, vDict
 *
 * [referrer-property]
...
public abstract class BsMCenterClassDtlDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] CENTER_CLASS_DTL_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * センタ区分値明細ID
    ...
    /**
     * [set] CENTER_CLASS_DTL_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * センタ区分値明細ID
