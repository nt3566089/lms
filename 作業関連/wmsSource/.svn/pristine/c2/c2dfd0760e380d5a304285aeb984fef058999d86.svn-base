...
/**
 * The abstract condition-query of t_bldl5175.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTBldl5175CQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTBldl5175CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param bldl5175Id The value of bldl5175Id as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5175Id_Equal(Long bldl5175Id) {
        doSetBldl5175Id_Equal(bldl5175Id);
    }

    protected void doSetBldl5175Id_Equal(Long bldl5175Id) {
        regBldl5175Id(CK_EQ, bldl5175Id);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5175_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5175Id The value of bldl5175Id as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5175Id_NotEqual(Long bldl5175Id) {
        doSetBldl5175Id_NotEqual(bldl5175Id);
    }

    protected void doSetBldl5175Id_NotEqual(Long bldl5175Id) {
        regBldl5175Id(CK_NES, bldl5175Id);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5175_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5175Id The value of bldl5175Id as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5175Id_GreaterThan(Long bldl5175Id) {
        regBldl5175Id(CK_GT, bldl5175Id);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5175_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5175Id The value of bldl5175Id as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5175Id_LessThan(Long bldl5175Id) {
        regBldl5175Id(CK_LT, bldl5175Id);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5175_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5175Id The value of bldl5175Id as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5175Id_GreaterEqual(Long bldl5175Id) {
        regBldl5175Id(CK_GE, bldl5175Id);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5175_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5175Id The value of bldl5175Id as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5175Id_LessEqual(Long bldl5175Id) {
        regBldl5175Id(CK_LE, bldl5175Id);
    }
     ...
     * BLDL5175_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of bldl5175Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of bldl5175Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setBldl5175Id_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueBldl5175Id(), "BLDL5175_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5175_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5175IdList The collection of bldl5175Id as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5175Id_InScope(Collection<Long> bldl5175IdList) {
        doSetBldl5175Id_InScope(bldl5175IdList);
    }

    protected void doSetBldl5175Id_InScope(Collection<Long> bldl5175IdList) {
        regINS(CK_INS, cTL(bldl5175IdList), xgetCValueBldl5175Id(), "BLDL5175_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5175_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5175IdList The collection of bldl5175Id as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5175Id_NotInScope(Collection<Long> bldl5175IdList) {
        doSetBldl5175Id_NotInScope(bldl5175IdList);
    }

    protected void doSetBldl5175Id_NotInScope(Collection<Long> bldl5175IdList) {
        regINS(CK_NINS, cTL(bldl5175IdList), xgetCValueBldl5175Id(), "BLDL5175_ID");
    }
     ...
     * BLDL5175_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5175Id_IsNull() { regBldl5175Id(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * BLDL5175_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5175Id_IsNotNull() { regBldl5175Id(CK_ISNN, DOBJ); }

    protected void regBldl5175Id(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueBldl5175Id(), "BLDL5175_ID"); }
    protected abstract ConditionValue xgetCValueBldl5175Id();
     ...
     */
    public HpSLCFunction<TBldl5175CB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TBldl5175CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5175CB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TBldl5175CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5175CB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TBldl5175CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5175CB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TBldl5175CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5175CB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TBldl5175CB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TBldl5175CB&gt;() {
     *     public void query(TBldl5175CB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5175CB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TBldl5175CB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5175CB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TBldl5175CQ sq);

    protected TBldl5175CB xcreateScalarConditionCB() {
        TBldl5175CB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TBldl5175CB xcreateScalarConditionPartitionByCB() {
        TBldl5175CB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TBldl5175CB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5175CB cb = new TBldl5175CB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "BLDL5175_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TBldl5175CQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TBldl5175CB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TBldl5175CB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5175CB cb = new TBldl5175CB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "BLDL5175_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TBldl5175CQ sq);
     ...
     */
    public void myselfExists(SubQuery<TBldl5175CB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TBldl5175CB cb = new TBldl5175CB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TBldl5175CQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TBldl5175CB newMyCB() {
        return new TBldl5175CB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TBldl5175CQ.class.getName(); }
