...
public class BSystemLogDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnSystemLogId = cci("SYSTEM_LOG_ID", "SYSTEM_LOG_ID", null, null, Long.class, "systemLogId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * SYSTEM_LOG_ID: {PK, ID, NotNull, BIGINT(19)}
