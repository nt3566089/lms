...
public class TAllocLotDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnAllocInstBId = cci("ALLOC_INST_B_ID", "ALLOC_INST_B_ID", null, null, Long.class, "allocInstBId", null, true, false, true, "BIGINT", 19, 0, null, null, false, null, null, "TAllocInstB", null, null, false);
    ...
    public ForeignInfo foreignMProduct() {
        ...
        return cfi("T_ALLOC_LOT_FK1", "MProduct", this, MProductDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "TAllocLotList", false);
    }
    /**
    ...
    public ForeignInfo foreignTLot() {
        ...
        return cfi("T_ALLOC_LOT_FK4", "TLot", this, TLotDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "TAllocLotList", false);
    }
    /**
