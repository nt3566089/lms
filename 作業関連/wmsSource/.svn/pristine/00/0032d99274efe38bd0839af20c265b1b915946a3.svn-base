...
/**
 * The DB meta of t_bldl5353. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class TBldl5353Dbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final TBldl5353Dbm _instance = new TBldl5353Dbm();
    private TBldl5353Dbm() {}
    public static TBldl5353Dbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((TBldl5353)et).getBldl5353Id(), (et, vl) -> ((TBldl5353)et).setBldl5353Id(ctl(vl)), "bldl5353Id");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getYearmonth(), (et, vl) -> ((TBldl5353)et).setYearmonth((String)vl), "yearmonth");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getMonth(), (et, vl) -> ((TBldl5353)et).setMonth((String)vl), "month");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getSalesOrgCd(), (et, vl) -> ((TBldl5353)et).setSalesOrgCd((String)vl), "salesOrgCd");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getSalesOrgNm(), (et, vl) -> ((TBldl5353)et).setSalesOrgNm((String)vl), "salesOrgNm");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getRowNo(), (et, vl) -> ((TBldl5353)et).setRowNo((String)vl), "rowNo");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getDate(), (et, vl) -> ((TBldl5353)et).setDate((String)vl), "date");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getHoliday(), (et, vl) -> ((TBldl5353)et).setHoliday((String)vl), "holiday");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getSoukaFwNum(), (et, vl) -> ((TBldl5353)et).setSoukaFwNum(ctl(vl)), "soukaFwNum");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getSoukaUnNum(), (et, vl) -> ((TBldl5353)et).setSoukaUnNum(ctl(vl)), "soukaUnNum");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getSoukaShNum(), (et, vl) -> ((TBldl5353)et).setSoukaShNum(ctl(vl)), "soukaShNum");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getSoukaTotalNum(), (et, vl) -> ((TBldl5353)et).setSoukaTotalNum(ctl(vl)), "soukaTotalNum");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getKoshigayaFwNum(), (et, vl) -> ((TBldl5353)et).setKoshigayaFwNum(ctl(vl)), "koshigayaFwNum");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getKoshigayaUnNum(), (et, vl) -> ((TBldl5353)et).setKoshigayaUnNum(ctl(vl)), "koshigayaUnNum");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getKoshigayaShNum(), (et, vl) -> ((TBldl5353)et).setKoshigayaShNum(ctl(vl)), "koshigayaShNum");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getKoshigayaTotalNum(), (et, vl) -> ((TBldl5353)et).setKoshigayaTotalNum(ctl(vl)), "koshigayaTotalNum");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getTotalNum(), (et, vl) -> ((TBldl5353)et).setTotalNum(ctl(vl)), "totalNum");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getDelFlg(), (et, vl) -> ((TBldl5353)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getVersionNo(), (et, vl) -> ((TBldl5353)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getControlNo(), (et, vl) -> ((TBldl5353)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getAddDt(), (et, vl) -> ((TBldl5353)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getAddUser(), (et, vl) -> ((TBldl5353)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getAddProcess(), (et, vl) -> ((TBldl5353)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getUpdDt(), (et, vl) -> ((TBldl5353)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getUpdUser(), (et, vl) -> ((TBldl5353)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((TBldl5353)et).getUpdProcess(), (et, vl) -> ((TBldl5353)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "t_bldl5353";
    protected final String _tableDispName = "t_bldl5353";
    protected final String _tablePropertyName = "TBldl5353";
    protected final TableSqlName _tableSqlName = new TableSqlName("t_bldl5353", _tableDbName);
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnBldl5353Id = cci("BLDL5353_ID", "BLDL5353_ID", null, null, Long.class, "bldl5353Id", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
     ...
     */
    public ColumnInfo columnBldl5353Id() { return _columnBldl5353Id; }
    /**
    ...
    //                                       Primary Element
    //                                       ---------------
    protected UniqueInfo cpui() { return hpcpui(columnBldl5353Id()); }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.TBldl5353"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.TBldl5353CB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.TBldl5353Bhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<TBldl5353> getEntityType() { return TBldl5353.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public TBldl5353 newEntity() { return new TBldl5353(); }
    ...
    { doAcceptPrimaryKeyMap((TBldl5353)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((TBldl5353)et, mp); }
