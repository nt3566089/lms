...
/**
 * The condition-query for in-line of e_id_manag.
 * @author DBFlute(AutoGenerator)
 */
public class EIdManagCIQ extends AbstractBsEIdManagCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEIdManagCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EIdManagCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEIdManagCQ myCQ) {
    ...
    public String keepScalarCondition(EIdManagCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EIdManagCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EIdManagCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EIdManagCQ sq)
    ...
    protected String xinCB() { return EIdManagCB.class.getName(); }
    protected String xinCQ() { return EIdManagCQ.class.getName(); }
}
