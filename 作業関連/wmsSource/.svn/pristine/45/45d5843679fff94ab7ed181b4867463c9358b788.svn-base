...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTBldl5640CQ;

/**
 * The condition-query of t_bldl5640.
 * <p>
 ...
 */
public class TBldl5640CQ extends BsTBldl5640CQ {
     ...
     */
    public TBldl5640CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
