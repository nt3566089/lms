...
/**
 * The simple DTO of w_ht_picking as TABLE. <br>
 * ピッキングワーク
 * <pre>
 * [primary-key]
 *     HT_PICKING_ID
...
public abstract class BsWHtPickingDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWHtPickingDto)) { return false; }
        final BsWHtPickingDto otherEntity = (BsWHtPickingDto)other;
        if (!helpComparingValue(getHtPickingId(), otherEntity.getHtPickingId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "w_ht_picking");
        result = xCH(result, getHtPickingId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getHtPickingId());
     ...
     * ピッキングワークID
     * @return The value of the column 'HT_PICKING_ID'. (NullAllowed)
     */
     ...
     * ピッキングワークID
     * @param htPickingId The value of the column 'HT_PICKING_ID'. (NullAllowed)
     */
    public void setHtPickingId(Long htPickingId) {
        __modifiedProperties.add("htPickingId");
        this._htPickingId = htPickingId;
    }
