...
public abstract class BsSqlDeliveryCourseShippingList extends AbstractEntity implements CustomizeEntity {
    ...
    /**
     * [get] STOCK_OUT_FLG: {VARCHAR(4)} <br>
    ...
    /**
     * [set] STOCK_OUT_FLG: {VARCHAR(4)} <br>
    ...
    /**
     * [get] PIC_LIST_STATUS1: {DECIMAL(28)} <br>
    ...
    /**
     * [set] PIC_LIST_STATUS1: {DECIMAL(28)} <br>
    ...
    /**
     * [get] PIC_LIST_STATUS2: {DECIMAL(28)} <br>
    ...
    /**
     * [set] PIC_LIST_STATUS2: {DECIMAL(28)} <br>
    ...
    /**
     * [get] INVOICE_CREATE: {DECIMAL(28)} <br>
    ...
    /**
     * [set] INVOICE_CREATE: {DECIMAL(28)} <br>
    ...
    /**
     * [get] LOADING_STATUS: {DECIMAL(50)} <br>
    ...
    /**
     * [set] LOADING_STATUS: {DECIMAL(50)} <br>
    ...
    /**
     * [get] SHIPPING_FIXED: {DECIMAL(28)} <br>
    ...
    /**
     * [set] SHIPPING_FIXED: {DECIMAL(28)} <br>
