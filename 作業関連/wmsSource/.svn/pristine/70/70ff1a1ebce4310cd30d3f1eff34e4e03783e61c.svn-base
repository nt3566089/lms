...
public class PReportLayoutItemDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnReportLayoutItemId = cci("REPORT_LAYOUT_ITEM_ID", "REPORT_LAYOUT_ITEM_ID", null, null, Long.class, "reportLayoutItemId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * REPORT_LAYOUT_ITEM_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ForeignInfo foreignPReportLayout() {
        ...
        return cfi("P_REPORT_LAYOUT_ITEM_FK1", "PReportLayout", this, PReportLayoutDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "PReportLayoutItemList", false);
    }
    /**
    ...
    public ForeignInfo foreignBDict() {
        ...
        return cfi("P_REPORT_LAYOUT_ITEM_FK2", "BDict", this, BDictDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "PReportLayoutItemList", false);
    }
    /**
