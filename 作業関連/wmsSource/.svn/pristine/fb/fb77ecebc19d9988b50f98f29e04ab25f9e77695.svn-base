 ...
 *
 * [column]
 *     SHIPPING_INST_ID, RECEIVE_CD, RECEIVE_ROW_ID, IMPORT_FLG, ERROR_FLG, ERROR_MESSAGE_CD
 *
 * [sequence]
 *     
 *
 ...
 */
public abstract class BsSqlEShippingInstList extends AbstractEntity implements CustomizeEntity {
    ...
    //                                                                            ========
    /**
     * [get] SHIPPING_INST_ID: {BIGINT(20), refers to e_shipping_inst.SHIPPING_INST_ID} <br>
     * 出荷指示受信ID
    ...
    /**
     * [set] SHIPPING_INST_ID: {BIGINT(20), refers to e_shipping_inst.SHIPPING_INST_ID} <br>
     * 出荷指示受信ID
    ...
    /**
     * [get] RECEIVE_CD: {VARCHAR(30), refers to e_shipping_inst.RECEIVE_CD} <br>
     * 受信CD
    ...
    /**
     * [set] RECEIVE_CD: {VARCHAR(30), refers to e_shipping_inst.RECEIVE_CD} <br>
     * 受信CD
    ...
    /**
     * [get] RECEIVE_ROW_ID: {BIGINT(20), refers to e_shipping_inst.RECEIVE_ROW_ID} <br>
     * 受信行ID
    ...
    /**
     * [set] RECEIVE_ROW_ID: {BIGINT(20), refers to e_shipping_inst.RECEIVE_ROW_ID} <br>
     * 受信行ID
    ...
    /**
     * [get] IMPORT_FLG: {CHAR(1), refers to e_shipping_inst.IMPORT_FLG} <br>
     * 取込みフラグ
    ...
    /**
     * [set] IMPORT_FLG: {CHAR(1), refers to e_shipping_inst.IMPORT_FLG} <br>
     * 取込みフラグ
    ...
    /**
     * [get] ERROR_FLG: {CHAR(1), refers to e_shipping_inst.ERROR_FLG} <br>
     * エラーフラグ
    ...
    /**
     * [set] ERROR_FLG: {CHAR(1), refers to e_shipping_inst.ERROR_FLG} <br>
     * エラーフラグ
    ...
    /**
     * [get] ERROR_MESSAGE_CD: {VARCHAR(100), refers to e_shipping_inst.ERROR_MESSAGE_CD} <br>
     * エラーメッセージCD
    ...
    /**
     * [set] ERROR_MESSAGE_CD: {VARCHAR(100), refers to e_shipping_inst.ERROR_MESSAGE_CD} <br>
     * エラーメッセージCD
