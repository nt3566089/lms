...
public class MUserCenterDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnUserCenterId = cci("USER_CENTER_ID", "USER_CENTER_ID", null, null, Long.class, "userCenterId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * USER_CENTER_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ForeignInfo foreignMCenter() {
        ...
        return cfi("M_USER_CENTER_FK1", "MCenter", this, MCenterDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "MUserCenterList", false);
    }
    /**
    ...
    public ForeignInfo foreignBUser() {
        ...
        return cfi("M_USER_CENTER_FK2", "BUser", this, BUserDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "MUserCenterList", false);
    }
