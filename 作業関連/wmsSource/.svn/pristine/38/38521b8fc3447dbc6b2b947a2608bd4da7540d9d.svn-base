...
/**
 * The entity of t_bldl5110 as TABLE. <br>
 * BLDL5110
 * <pre>
 * [primary-key]
 *     BLDL5110_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5110Id = entity.getBldl5110Id();
 ...
 * entity.setBldl5110Id(bldl5110Id);
 ...
 */
public abstract class BsTBldl5110 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5110Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5110) {
            BsTBldl5110 other = (BsTBldl5110)obj;
            if (!xSV(_bldl5110Id, other._bldl5110Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5110Id));
    ...
    @Override
    public TBldl5110 clone() {
        return (TBldl5110)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] BLDL5110_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5110ID
     * @return The value of the column 'BLDL5110_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5110Id() {
        checkSpecifiedProperty("bldl5110Id");
        return _bldl5110Id;
    }

    /**
     * [set] BLDL5110_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5110ID
     * @param bldl5110Id The value of the column 'BLDL5110_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5110Id(Long bldl5110Id) {
        registerModifiedProperty("bldl5110Id");
        _bldl5110Id = bldl5110Id;
    }
