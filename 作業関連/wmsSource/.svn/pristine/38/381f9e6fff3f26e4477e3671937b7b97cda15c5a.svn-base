 ...
 * String receiveLabelFlg = entity.getReceiveLabelFlg();
 ...
 * entity.setReceiveLabelFlg(receiveLabelFlg);
...
public abstract class BsMParam extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected String _receiveLabelFlg;
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_receiveLabelFlg));
    ...
    //                                                                            ========
    /**
     * [get] CLIENT_CENTER_ID: {PK, NotNull, BIGINT(19), FK to m_client_center} <br>
     * 荷主センタID
    ...
    /**
     * [set] CLIENT_CENTER_ID: {PK, NotNull, BIGINT(19), FK to m_client_center} <br>
     * 荷主センタID
    ...
    /**
     * [get] RECEIVE_LABEL_FLG: {CHAR(1)} <br>
     * 入荷ラベル使用フラグ
     * @return The value of the column 'RECEIVE_LABEL_FLG'. (NullAllowed even if selected: for no constraint)
     */
    public String getReceiveLabelFlg() {
        checkSpecifiedProperty("receiveLabelFlg");
        return convertEmptyToNull(_receiveLabelFlg);
    }

    /**
     * [set] RECEIVE_LABEL_FLG: {CHAR(1)} <br>
     * 入荷ラベル使用フラグ
     * @param receiveLabelFlg The value of the column 'RECEIVE_LABEL_FLG'. (NullAllowed: null update allowed for no constraint)
     */
    public void setReceiveLabelFlg(String receiveLabelFlg) {
        registerModifiedProperty("receiveLabelFlg");
        _receiveLabelFlg = receiveLabelFlg;
    }
