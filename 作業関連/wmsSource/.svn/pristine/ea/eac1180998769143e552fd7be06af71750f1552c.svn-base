...
/**
 * The simple DTO of es_inventory_inst_dtl as TABLE. <br>
 * 棚卸指示(明細)送信テーブル
 * <pre>
 * [primary-key]
...
public abstract class BsEsInventoryInstDtlDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsInventoryInstDtlDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEsInventoryInstDtlDto)) { return false; }
        final BsEsInventoryInstDtlDto otherEntity = (BsEsInventoryInstDtlDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "es_inventory_inst_dtl");
