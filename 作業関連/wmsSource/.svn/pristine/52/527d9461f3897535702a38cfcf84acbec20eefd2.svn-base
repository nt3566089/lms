...
public abstract class AbstractBsTWorkDataCQ extends AbstractConditionQuery {
     ...
     * WORK_DATA_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. <br>
     * WORK_LOG_ID: {IX, NotNull, BIGINT(19), FK to t_work_log}
     ...
     */
    public void setWorkQtyCs_NotEqual(Long workQtyCs) {
        doSetWorkQtyCs_NotEqual(workQtyCs);
    }

    protected void doSetWorkQtyCs_NotEqual(Long workQtyCs) {
     ...
     */
    public void setWorkQtyCs_GreaterThan(Long workQtyCs) {
     ...
     */
    public void setWorkQtyCs_LessThan(Long workQtyCs) {
     ...
     */
    public void setWorkQtyCs_GreaterEqual(Long workQtyCs) {
     ...
     */
    public void setWorkQtyCs_LessEqual(Long workQtyCs) {
     ...
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setWorkQtyCs_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
     ...
     */
    public void setWorkQtyCs_InScope(Collection<Long> workQtyCsList) {
        doSetWorkQtyCs_InScope(workQtyCsList);
    }

    protected void doSetWorkQtyCs_InScope(Collection<Long> workQtyCsList) {
     ...
     */
    public void setWorkQtyCs_NotInScope(Collection<Long> workQtyCsList) {
        doSetWorkQtyCs_NotInScope(workQtyCsList);
    }

    protected void doSetWorkQtyCs_NotInScope(Collection<Long> workQtyCsList) {
