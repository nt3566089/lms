...
/**
 * The simple DTO of e_inventory_inst_dtl as TABLE. <br>
 * 棚卸指示(明細)受信テーブル
 * <pre>
 * [primary-key]
...
public abstract class BsEInventoryInstDtlDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEInventoryInstDtlDto)) { return false; }
        final BsEInventoryInstDtlDto otherEntity = (BsEInventoryInstDtlDto)other;
        if (!helpComparingValue(getInventoryInstDtlId(), otherEntity.getInventoryInstDtlId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "e_inventory_inst_dtl");
        result = xCH(result, getInventoryInstDtlId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getInventoryInstDtlId());
    ...
    //                                                                            ========
    /**
     * [get] INVENTORY_INST_DTL_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 棚卸指示_明細受信ID
     * @return The value of the column 'INVENTORY_INST_DTL_ID'. (NullAllowed)
     */
    ...
    /**
     * [set] INVENTORY_INST_DTL_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 棚卸指示_明細受信ID
     * @param inventoryInstDtlId The value of the column 'INVENTORY_INST_DTL_ID'. (NullAllowed)
     */
    public void setInventoryInstDtlId(Long inventoryInstDtlId) {
        __modifiedProperties.add("inventoryInstDtlId");
        this._inventoryInstDtlId = inventoryInstDtlId;
    }
