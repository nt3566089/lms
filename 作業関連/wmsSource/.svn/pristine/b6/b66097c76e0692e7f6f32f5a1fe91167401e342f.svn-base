...
public class BMenuGrpDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMenuGrpId = cci("MENU_GRP_ID", "MENU_GRP_ID", null, null, Long.class, "menuGrpId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "BMenuList,BMenuGrpSelfList", null, false);
    ...
    public ForeignInfo foreignBMenuGrpSelf() {
        ...
        return cfi("B_MENU_GRP_FK2", "BMenuGrpSelf", this, BMenuGrpDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "BMenuGrpSelfList", false);
    }
    /**
    ...
    public ForeignInfo foreignBDict() {
        ...
        return cfi("B_MENU_GRP_FK1", "BDict", this, BDictDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "BMenuGrpList", false);
    }
    /**
    ...
    public ReferrerInfo referrerBMenuList() {
        ...
        return cri("B_MENU_FK1", "BMenuList", this, BMenuDbm.getInstance(), mp, false, "BMenuGrp");
    }
    /**
    ...
    public ReferrerInfo referrerBMenuGrpSelfList() {
        ...
        return cri("B_MENU_GRP_FK2", "BMenuGrpSelfList", this, BMenuGrpDbm.getInstance(), mp, false, "BMenuGrpSelf");
    }
