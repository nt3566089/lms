...
public class BsBUserCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<BUserCQ> {
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TInventoryBCB, BUserCQ> derivedTInventoryBByInventoryUpdUserIdList() {
            assertDerived("tInventoryBByInventoryUpdUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TInventoryBCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTInventoryBByInventoryUpdUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_inventory_b where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TInventoryBCB, BUserCQ> derivedTInventoryBByInventoryUserIdList() {
            assertDerived("tInventoryBByInventoryUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TInventoryBCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTInventoryBByInventoryUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TInventoryRCB, BUserCQ> derivedTInventoryRByInventoryRecordLocOutUserIdList() {
            assertDerived("tInventoryRByInventoryRecordLocOutUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TInventoryRCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTInventoryRByInventoryRecordLocOutUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_inventory_r where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TInventoryRCB, BUserCQ> derivedTInventoryRByStockDiffOutUserIdList() {
            assertDerived("tInventoryRByStockDiffOutUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TInventoryRCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTInventoryRByStockDiffOutUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_inventory_r where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TInventoryRCB, BUserCQ> derivedTInventoryRByTwlOutUserIdList() {
            assertDerived("tInventoryRByTwlOutUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TInventoryRCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTInventoryRByTwlOutUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_inventory_r where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TInventoryRCB, BUserCQ> derivedTInventoryRByInventoryRecordOutUserIdList() {
            assertDerived("tInventoryRByInventoryRecordOutUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TInventoryRCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTInventoryRByInventoryRecordOutUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_inventory_r where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TInventoryRCB, BUserCQ> derivedTInventoryRByInventoryDiffOutUserIdList() {
            assertDerived("tInventoryRByInventoryDiffOutUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TInventoryRCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTInventoryRByInventoryDiffOutUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TMoveRecordBCB, BUserCQ> derivedTMoveRecordBList() {
            assertDerived("tMoveRecordBList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TMoveRecordBCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TNizoroeAlarmLogCB, BUserCQ> derivedTNizoroeAlarmLogList() {
            assertDerived("tNizoroeAlarmLogList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TNizoroeAlarmLogCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TPickingRCB, BUserCQ> derivedTPickingRByBolOutUserIdList() {
            assertDerived("tPickingRByBolOutUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TPickingRCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTPickingRByBolOutUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_picking_r where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TPickingRCB, BUserCQ> derivedTPickingRByTagOutUserIdList() {
            assertDerived("tPickingRByTagOutUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TPickingRCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTPickingRByTagOutUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_picking_r where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TPickingRCB, BUserCQ> derivedTPickingRByDelivOutUserIdList() {
            assertDerived("tPickingRByDelivOutUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TPickingRCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTPickingRByDelivOutUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_picking_r where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TPickingRCB, BUserCQ> derivedTPickingRByIndvSupplyOutUserIdList() {
            assertDerived("tPickingRByIndvSupplyOutUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TPickingRCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTPickingRByIndvSupplyOutUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_picking_r where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TPickingRCB, BUserCQ> derivedTPickingRByPlOutUserIdList() {
            assertDerived("tPickingRByPlOutUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TPickingRCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTPickingRByPlOutUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_picking_r where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TPickingRCB, BUserCQ> derivedTPickingRByIndvLabelOutUserIdList() {
            assertDerived("tPickingRByIndvLabelOutUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TPickingRCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTPickingRByIndvLabelOutUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_picking_r where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TPickingRCB, BUserCQ> derivedTPickingRByNizoroeOutUserIdList() {
            assertDerived("tPickingRByNizoroeOutUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TPickingRCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTPickingRByNizoroeOutUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_picking_r where ...) as FOO_MAX} <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TPickingRCB, BUserCQ> derivedTPickingRByPllOutUserIdList() {
            assertDerived("tPickingRByPllOutUserIdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TPickingRCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTPickingRByPllOutUserIdList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from t_receive_label where ...) as FOO_MAX} <br>
         ...
         * }, TReceiveLabel.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TReceiveLabelCB, BUserCQ> derivedTReceiveLabelList() {
            assertDerived("tReceiveLabelList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TReceiveLabelCB> sq, BUserCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveTReceiveLabelList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
