...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTIdManagDataCQ;

/**
 * The condition-query of t_id_manag_data.
 * <p>
 ...
 */
public class TIdManagDataCQ extends BsTIdManagDataCQ {
     ...
     */
    public TIdManagDataCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
