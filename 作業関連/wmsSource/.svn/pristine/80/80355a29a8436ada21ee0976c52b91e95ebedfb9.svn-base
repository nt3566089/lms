...
/**
 * The base condition-bean of er_sales_org.
 * @author DBFlute(AutoGenerator)
 */
public class BsErSalesOrgCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ErSalesOrgCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsErSalesOrgCB() {
     ...
     * @return this. (NotNull)
     */
    public ErSalesOrgCB acceptPK(Long salesOrgId) {
        assertObjectNotNull("salesOrgId", salesOrgId);
        BsErSalesOrgCB cb = this;
        cb.query().setSalesOrgId_Equal(salesOrgId);
        return (ErSalesOrgCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ErSalesOrgCB acceptUniqueOf(String receiveCd, Long receiveRowId) {
     ...
     */
    public ErSalesOrgCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ErSalesOrgCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ErSalesOrgCQ doGetConditionQuery() {
    ...
    protected ErSalesOrgCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ErSalesOrgCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ErSalesOrgCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ErSalesOrgCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ErSalesOrgCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ErSalesOrgCB> unionCBLambda) {
        final ErSalesOrgCB cb = new ErSalesOrgCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErSalesOrgCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ErSalesOrgCB> unionCBLambda) {
        final ErSalesOrgCB cb = new ErSalesOrgCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErSalesOrgCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ErSalesOrgCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ErSalesOrgCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "er_sales_org"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<ErSalesOrgCB, ErSalesOrgCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ErSalesOrgCB> sq, ErSalesOrgCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ErSalesOrgCB dreamCruiseCB() {
        ErSalesOrgCB cb = new ErSalesOrgCB();
        cb.xsetupForDreamCruise((ErSalesOrgCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ErSalesOrgCB> columnQuery(final SpecifyQuery<ErSalesOrgCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ErSalesOrgCB xcreateColumnQueryCB() {
        ErSalesOrgCB cb = new ErSalesOrgCB();
        cb.xsetupForColumnQuery((ErSalesOrgCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ErSalesOrgCB> orCBLambda) {
        xorSQ((ErSalesOrgCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ErSalesOrgCB> andCBLambda) {
        xorSQAP((ErSalesOrgCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ErSalesOrgCB cb;
        if (mainCB != null) {
            cb = (ErSalesOrgCB)mainCB;
        } else {
            cb = new ErSalesOrgCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ErSalesOrgCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ErSalesOrgCQ.class.getName(); }
