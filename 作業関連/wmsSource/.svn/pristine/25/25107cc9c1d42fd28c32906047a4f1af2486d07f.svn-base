...
/**
 * The DTO mapper of t_bldl5175 as TABLE. <br>
 * BLDL5175
 * <pre>
 * [primary-key]
 *     BLDL5175_ID
 ...
 */
public abstract class BsTBldl5175DtoMapper implements DtoMapper<TBldl5175, TBldl5175Dto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTBldl5175DtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTBldl5175DtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TBldl5175Dto mappingToDto(TBldl5175 entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TBldl5175Dto dto = new TBldl5175Dto();
        dto.setBldl5175Id(entity.getBldl5175Id());
     ...
     * {@inheritDoc}
     */
    public List<TBldl5175Dto> mappingToDtoList(List<TBldl5175> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TBldl5175Dto> dtoList = new ArrayList<TBldl5175Dto>();
        for (TBldl5175 entity : entityList) {
            TBldl5175Dto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TBldl5175 mappingToEntity(TBldl5175Dto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TBldl5175 entity = new TBldl5175();
        if (needsMapping(dto, dto.getBldl5175Id(), "bldl5175Id")) {
            entity.setBldl5175Id(dto.getBldl5175Id());
        }
     ...
     */
    protected boolean needsMapping(TBldl5175Dto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TBldl5175> mappingToEntityList(List<TBldl5175Dto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TBldl5175> entityList = new ArrayList<TBldl5175>();
        for (TBldl5175Dto dto : dtoList) {
            TBldl5175 entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TBldl5175DtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TBldl5175DtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TBldl5175DtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TBldl5175DtoMapper reverseReference() {
