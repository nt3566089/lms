...
/**
 * The entity of er_id_manag as TABLE. <br>
 * 個体管理情報連携受信テーブル
 * <pre>
 * [primary-key]
 *     ID_MANAG_ID
 ...
 */
public abstract class BsErIdManag extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsErIdManag) {
            BsErIdManag other = (BsErIdManag)obj;
    ...
    @Override
    public ErIdManag clone() {
        return (ErIdManag)super.clone();
    }
