...
/**
 * The abstract condition-query of e_shipping_record.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEShippingRecordCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEShippingRecordCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * Equal(=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PL_SEND_FLG: {CHAR(1)}
     * @param plSendFlg The value of plSendFlg as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPlSendFlg_Equal(String plSendFlg) {
        doSetPlSendFlg_Equal(fRES(plSendFlg));
    }

    protected void doSetPlSendFlg_Equal(String plSendFlg) {
        regPlSendFlg(CK_EQ, plSendFlg);
    }

    /**
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PL_SEND_FLG: {CHAR(1)}
     * @param plSendFlg The value of plSendFlg as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPlSendFlg_NotEqual(String plSendFlg) {
        doSetPlSendFlg_NotEqual(fRES(plSendFlg));
    }

    protected void doSetPlSendFlg_NotEqual(String plSendFlg) {
        regPlSendFlg(CK_NES, plSendFlg);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PL_SEND_FLG: {CHAR(1)}
     * @param plSendFlg The value of plSendFlg as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPlSendFlg_GreaterThan(String plSendFlg) {
        regPlSendFlg(CK_GT, fRES(plSendFlg));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PL_SEND_FLG: {CHAR(1)}
     * @param plSendFlg The value of plSendFlg as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPlSendFlg_LessThan(String plSendFlg) {
        regPlSendFlg(CK_LT, fRES(plSendFlg));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PL_SEND_FLG: {CHAR(1)}
     * @param plSendFlg The value of plSendFlg as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPlSendFlg_GreaterEqual(String plSendFlg) {
        regPlSendFlg(CK_GE, fRES(plSendFlg));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PL_SEND_FLG: {CHAR(1)}
     * @param plSendFlg The value of plSendFlg as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPlSendFlg_LessEqual(String plSendFlg) {
        regPlSendFlg(CK_LE, fRES(plSendFlg));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * PL_SEND_FLG: {CHAR(1)}
     * @param plSendFlgList The collection of plSendFlg as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPlSendFlg_InScope(Collection<String> plSendFlgList) {
        doSetPlSendFlg_InScope(plSendFlgList);
    }

    protected void doSetPlSendFlg_InScope(Collection<String> plSendFlgList) {
        regINS(CK_INS, cTL(plSendFlgList), xgetCValuePlSendFlg(), "PL_SEND_FLG");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * PL_SEND_FLG: {CHAR(1)}
     * @param plSendFlgList The collection of plSendFlg as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPlSendFlg_NotInScope(Collection<String> plSendFlgList) {
        doSetPlSendFlg_NotInScope(plSendFlgList);
    }

    protected void doSetPlSendFlg_NotInScope(Collection<String> plSendFlgList) {
        regINS(CK_NINS, cTL(plSendFlgList), xgetCValuePlSendFlg(), "PL_SEND_FLG");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * PL_SEND_FLG: {CHAR(1)} <br>
     * <pre>e.g. setPlSendFlg_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param plSendFlg The value of plSendFlg as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setPlSendFlg_LikeSearch(String plSendFlg, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(plSendFlg), xgetCValuePlSendFlg(), "PL_SEND_FLG", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * PL_SEND_FLG: {CHAR(1)}
     * @param plSendFlg The value of plSendFlg as notLikeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setPlSendFlg_NotLikeSearch(String plSendFlg, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(plSendFlg), xgetCValuePlSendFlg(), "PL_SEND_FLG", likeSearchOption);
    }

    /**
     * PrefixSearch {like 'xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * PL_SEND_FLG: {CHAR(1)}
     * @param plSendFlg The value of plSendFlg as prefixSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPlSendFlg_PrefixSearch(String plSendFlg) {
        setPlSendFlg_LikeSearch(plSendFlg, xcLSOPPre());
    }
     ...
     * PL_SEND_FLG: {CHAR(1)}
     */
    public void setPlSendFlg_IsNull() { regPlSendFlg(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * PL_SEND_FLG: {CHAR(1)}
     */
    public void setPlSendFlg_IsNullOrEmpty() { regPlSendFlg(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * PL_SEND_FLG: {CHAR(1)}
     */
    public void setPlSendFlg_IsNotNull() { regPlSendFlg(CK_ISNN, DOBJ); }

    protected void regPlSendFlg(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValuePlSendFlg(), "PL_SEND_FLG"); }
    protected abstract ConditionValue xgetCValuePlSendFlg();
     ...
     */
    public HpSLCFunction<EShippingRecordCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EShippingRecordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EShippingRecordCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EShippingRecordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EShippingRecordCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EShippingRecordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EShippingRecordCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EShippingRecordCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EShippingRecordCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EShippingRecordCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EShippingRecordCB&gt;() {
     *     public void query(EShippingRecordCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EShippingRecordCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EShippingRecordCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EShippingRecordCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EShippingRecordCQ sq);

    protected EShippingRecordCB xcreateScalarConditionCB() {
        EShippingRecordCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EShippingRecordCB xcreateScalarConditionPartitionByCB() {
        EShippingRecordCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EShippingRecordCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EShippingRecordCB cb = new EShippingRecordCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "SHIPPING_RECORD_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EShippingRecordCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EShippingRecordCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EShippingRecordCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EShippingRecordCB cb = new EShippingRecordCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "SHIPPING_RECORD_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EShippingRecordCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EShippingRecordCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EShippingRecordCB cb = new EShippingRecordCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EShippingRecordCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EShippingRecordCB newMyCB() {
        return new EShippingRecordCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EShippingRecordCQ.class.getName(); }
