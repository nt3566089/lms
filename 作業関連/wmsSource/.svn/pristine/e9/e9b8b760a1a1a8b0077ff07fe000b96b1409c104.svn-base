...
/**
 * The DB meta of e_sales_org. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class ESalesOrgDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final ESalesOrgDbm _instance = new ESalesOrgDbm();
    private ESalesOrgDbm() {}
    public static ESalesOrgDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSalesOrgId(), (et, vl) -> ((ESalesOrg)et).setSalesOrgId(ctl(vl)), "salesOrgId");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getReceiveCd(), (et, vl) -> ((ESalesOrg)et).setReceiveCd((String)vl), "receiveCd");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getReceiveRowId(), (et, vl) -> ((ESalesOrg)et).setReceiveRowId(ctl(vl)), "receiveRowId");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getImportFlg(), (et, vl) -> ((ESalesOrg)et).setImportFlg((String)vl), "importFlg");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getErrorFlg(), (et, vl) -> ((ESalesOrg)et).setErrorFlg((String)vl), "errorFlg");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getErrorMessageCd(), (et, vl) -> ((ESalesOrg)et).setErrorMessageCd((String)vl), "errorMessageCd");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSalesOrgCd(), (et, vl) -> ((ESalesOrg)et).setSalesOrgCd((String)vl), "salesOrgCd");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getPurchaseOrgCd(), (et, vl) -> ((ESalesOrg)et).setPurchaseOrgCd((String)vl), "purchaseOrgCd");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getTenhanshaCd(), (et, vl) -> ((ESalesOrg)et).setTenhanshaCd((String)vl), "tenhanshaCd");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getTenhanshaNm1(), (et, vl) -> ((ESalesOrg)et).setTenhanshaNm1((String)vl), "tenhanshaNm1");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getTenhanshaNm2(), (et, vl) -> ((ESalesOrg)et).setTenhanshaNm2((String)vl), "tenhanshaNm2");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getTenhanshaZipCd(), (et, vl) -> ((ESalesOrg)et).setTenhanshaZipCd((String)vl), "tenhanshaZipCd");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getTenhanshaPrefecture(), (et, vl) -> ((ESalesOrg)et).setTenhanshaPrefecture((String)vl), "tenhanshaPrefecture");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getTenhanshaAddress1(), (et, vl) -> ((ESalesOrg)et).setTenhanshaAddress1((String)vl), "tenhanshaAddress1");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getTenhanshaAddress2(), (et, vl) -> ((ESalesOrg)et).setTenhanshaAddress2((String)vl), "tenhanshaAddress2");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getTenhanshaTelNo(), (et, vl) -> ((ESalesOrg)et).setTenhanshaTelNo((String)vl), "tenhanshaTelNo");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getTenhanshaFaxNo(), (et, vl) -> ((ESalesOrg)et).setTenhanshaFaxNo((String)vl), "tenhanshaFaxNo");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getPlantNormal(), (et, vl) -> ((ESalesOrg)et).setPlantNormal((String)vl), "plantNormal");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getPlantDeposit(), (et, vl) -> ((ESalesOrg)et).setPlantDeposit((String)vl), "plantDeposit");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapAddYyyy(), (et, vl) -> ((ESalesOrg)et).setSapAddYyyy((String)vl), "sapAddYyyy");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapAddMm(), (et, vl) -> ((ESalesOrg)et).setSapAddMm((String)vl), "sapAddMm");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapAddDd(), (et, vl) -> ((ESalesOrg)et).setSapAddDd((String)vl), "sapAddDd");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapAddHh(), (et, vl) -> ((ESalesOrg)et).setSapAddHh((String)vl), "sapAddHh");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapAddMi(), (et, vl) -> ((ESalesOrg)et).setSapAddMi((String)vl), "sapAddMi");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapAddSs(), (et, vl) -> ((ESalesOrg)et).setSapAddSs((String)vl), "sapAddSs");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapAddUserCd(), (et, vl) -> ((ESalesOrg)et).setSapAddUserCd((String)vl), "sapAddUserCd");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapUpdYyyy(), (et, vl) -> ((ESalesOrg)et).setSapUpdYyyy((String)vl), "sapUpdYyyy");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapUpdMm(), (et, vl) -> ((ESalesOrg)et).setSapUpdMm((String)vl), "sapUpdMm");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapUpdDd(), (et, vl) -> ((ESalesOrg)et).setSapUpdDd((String)vl), "sapUpdDd");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapUpdHh(), (et, vl) -> ((ESalesOrg)et).setSapUpdHh((String)vl), "sapUpdHh");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapUpdMi(), (et, vl) -> ((ESalesOrg)et).setSapUpdMi((String)vl), "sapUpdMi");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapUpdSs(), (et, vl) -> ((ESalesOrg)et).setSapUpdSs((String)vl), "sapUpdSs");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSapUpdUserCd(), (et, vl) -> ((ESalesOrg)et).setSapUpdUserCd((String)vl), "sapUpdUserCd");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getSpareStr(), (et, vl) -> ((ESalesOrg)et).setSpareStr((String)vl), "spareStr");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getDelFlg(), (et, vl) -> ((ESalesOrg)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getVersionNo(), (et, vl) -> ((ESalesOrg)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getControlNo(), (et, vl) -> ((ESalesOrg)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getAddDt(), (et, vl) -> ((ESalesOrg)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getAddUser(), (et, vl) -> ((ESalesOrg)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getAddProcess(), (et, vl) -> ((ESalesOrg)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getUpdDt(), (et, vl) -> ((ESalesOrg)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getUpdUser(), (et, vl) -> ((ESalesOrg)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((ESalesOrg)et).getUpdProcess(), (et, vl) -> ((ESalesOrg)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "e_sales_org";
    protected final String _tableDispName = "e_sales_org";
    protected final String _tablePropertyName = "ESalesOrg";
    protected final TableSqlName _tableSqlName = new TableSqlName("e_sales_org", _tableDbName);
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnSalesOrgId = cci("SALES_ORG_ID", "SALES_ORG_ID", null, null, Long.class, "salesOrgId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.ESalesOrg"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.ESalesOrgCB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.ESalesOrgBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<ESalesOrg> getEntityType() { return ESalesOrg.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public ESalesOrg newEntity() { return new ESalesOrg(); }
    ...
    { doAcceptPrimaryKeyMap((ESalesOrg)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((ESalesOrg)et, mp); }
