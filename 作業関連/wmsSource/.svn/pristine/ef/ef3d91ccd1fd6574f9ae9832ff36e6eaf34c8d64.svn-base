...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTBldl3390CQ;

/**
 * The condition-query of t_bldl3390.
 * <p>
 ...
 */
public class TBldl3390CQ extends BsTBldl3390CQ {
     ...
     */
    public TBldl3390CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
