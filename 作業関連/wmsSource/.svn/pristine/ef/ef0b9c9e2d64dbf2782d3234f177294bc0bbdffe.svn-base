...
/**
 * The condition-query for in-line of t_shipping_inst_data_transfer.
 * @author DBFlute(AutoGenerator)
 */
public class TShippingInstDataTransferCIQ extends AbstractBsTShippingInstDataTransferCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTShippingInstDataTransferCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TShippingInstDataTransferCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTShippingInstDataTransferCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueShippingInstDataTransferId() { return _myCQ.xdfgetShippingInstDataTransferId(); }
    ...
    public String keepScalarCondition(TShippingInstDataTransferCQ sq)
    ...
    protected String xinCB() { return TShippingInstDataTransferCB.class.getName(); }
    protected String xinCQ() { return TShippingInstDataTransferCQ.class.getName(); }
}
