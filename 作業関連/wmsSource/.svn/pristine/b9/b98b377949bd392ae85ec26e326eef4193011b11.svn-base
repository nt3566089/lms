...
public class TStoreRecordBCIQ extends AbstractBsTStoreRecordBCQ {
    ...
    protected ConditionValue xgetCValueStoreRecordSendFlg() { return _myCQ.xdfgetStoreRecordSendFlg(); }
    protected ConditionValue xgetCValueTransferSendFlg() { return _myCQ.xdfgetTransferSendFlg(); }
    protected ConditionValue xgetCValueProductStoreStatus() { return _myCQ.xdfgetProductStoreStatus(); }
    protected ConditionValue xgetCValueUserId() { return _myCQ.xdfgetUserId(); }
    protected ConditionValue xgetCValueCmSendFlgStore() { return _myCQ.xdfgetCmSendFlgStore(); }
    protected ConditionValue xgetCValueCmSendFlgTransfer() { return _myCQ.xdfgetCmSendFlgTransfer(); }
