...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsErInventoryInstSumCQ;

/**
 * The condition-query of er_inventory_inst_sum.
 * <p>
 ...
 */
public class ErInventoryInstSumCQ extends BsErInventoryInstSumCQ {
     ...
     */
    public ErInventoryInstSumCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
