...
public class PTerminalAutoPrintSetDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnTerminalAutoPrintSetId = cci("TERMINAL_AUTO_PRINT_SET_ID", "TERMINAL_AUTO_PRINT_SET_ID", null, null, Long.class, "terminalAutoPrintSetId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * TERMINAL_AUTO_PRINT_SET_ID: {PK, ID, NotNull, BIGINT(19)}
