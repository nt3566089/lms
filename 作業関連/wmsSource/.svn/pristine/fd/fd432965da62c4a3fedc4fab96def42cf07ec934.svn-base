...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsEsInventoryInstDtlCQ;

/**
 * The condition-query of es_inventory_inst_dtl.
 * <p>
 ...
 */
public class EsInventoryInstDtlCQ extends BsEsInventoryInstDtlCQ {
     ...
     */
    public EsInventoryInstDtlCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
