...
public class MCenterClassDtlDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnCenterClassDtlId = cci("CENTER_CLASS_DTL_ID", "CENTER_CLASS_DTL_ID", null, null, Long.class, "centerClassDtlId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MCenterClassGrpDtlList", null, false);
    ...
    /**
     * CENTER_CLASS_DTL_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ReferrerInfo referrerMCenterClassGrpDtlList() {
        ...
        return cri("M_CENTER_CLASS_GRP_DTL_FK1", "MCenterClassGrpDtlList", this, MCenterClassGrpDtlDbm.getInstance(), mp, false, "MCenterClassDtl");
    }
