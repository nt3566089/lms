...
/**
 * The referrer loader of es_sales_org as TABLE. <br>
 * <pre>
 * [primary key]
 *     SALES_ORG_ID
 *
 ...
 */
public class LoaderOfEsSalesOrg {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<EsSalesOrg> _selectedList;
    protected BehaviorSelector _selector;
    protected EsSalesOrgBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfEsSalesOrg ready(List<EsSalesOrg> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected EsSalesOrgBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(EsSalesOrgBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<EsSalesOrg> getSelectedList() { return _selectedList; }
