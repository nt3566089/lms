...
public class MCarrierSlipYupkDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnCarrierSlipYupkId = cci("CARRIER_SLIP_YUPK_ID", "CARRIER_SLIP_YUPK_ID", null, null, Long.class, "carrierSlipYupkId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MDeliveryCourseList", null, false);
    ...
    /**
     * CARRIER_SLIP_YUPK_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ReferrerInfo referrerMDeliveryCourseList() {
        ...
        return cri("M_DELIVERY_COURSE_FK3", "MDeliveryCourseList", this, MDeliveryCourseDbm.getInstance(), mp, false, "MCarrierSlipYupk");
    }
