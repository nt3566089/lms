...
/**
 * The condition-query for in-line of e_product_price.
 * @author DBFlute(AutoGenerator)
 */
public class EProductPriceCIQ extends AbstractBsEProductPriceCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEProductPriceCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EProductPriceCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEProductPriceCQ myCQ) {
    ...
    public String keepScalarCondition(EProductPriceCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EProductPriceCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EProductPriceCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EProductPriceCQ sq)
    ...
    protected String xinCB() { return EProductPriceCB.class.getName(); }
    protected String xinCQ() { return EProductPriceCQ.class.getName(); }
}
