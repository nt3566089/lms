...
/**
 * The entity of e_inventory_inst_dtl as TABLE. <br>
 * 棚卸指示(明細)受信テーブル
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsEInventoryInstDtl extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEInventoryInstDtl) {
            BsEInventoryInstDtl other = (BsEInventoryInstDtl)obj;
    ...
    @Override
    public EInventoryInstDtl clone() {
        return (EInventoryInstDtl)super.clone();
    }
