...
/**
 * The abstract condition-query of t_bldl5352.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTBldl5352CQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTBldl5352CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param bldl5352Id The value of bldl5352Id as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5352Id_Equal(Long bldl5352Id) {
        doSetBldl5352Id_Equal(bldl5352Id);
    }

    protected void doSetBldl5352Id_Equal(Long bldl5352Id) {
        regBldl5352Id(CK_EQ, bldl5352Id);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5352_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5352Id The value of bldl5352Id as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5352Id_NotEqual(Long bldl5352Id) {
        doSetBldl5352Id_NotEqual(bldl5352Id);
    }

    protected void doSetBldl5352Id_NotEqual(Long bldl5352Id) {
        regBldl5352Id(CK_NES, bldl5352Id);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5352_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5352Id The value of bldl5352Id as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5352Id_GreaterThan(Long bldl5352Id) {
        regBldl5352Id(CK_GT, bldl5352Id);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5352_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5352Id The value of bldl5352Id as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5352Id_LessThan(Long bldl5352Id) {
        regBldl5352Id(CK_LT, bldl5352Id);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5352_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5352Id The value of bldl5352Id as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5352Id_GreaterEqual(Long bldl5352Id) {
        regBldl5352Id(CK_GE, bldl5352Id);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5352_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5352Id The value of bldl5352Id as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5352Id_LessEqual(Long bldl5352Id) {
        regBldl5352Id(CK_LE, bldl5352Id);
    }
     ...
     * BLDL5352_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of bldl5352Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of bldl5352Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setBldl5352Id_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueBldl5352Id(), "BLDL5352_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5352_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5352IdList The collection of bldl5352Id as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5352Id_InScope(Collection<Long> bldl5352IdList) {
        doSetBldl5352Id_InScope(bldl5352IdList);
    }

    protected void doSetBldl5352Id_InScope(Collection<Long> bldl5352IdList) {
        regINS(CK_INS, cTL(bldl5352IdList), xgetCValueBldl5352Id(), "BLDL5352_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5352_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5352IdList The collection of bldl5352Id as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5352Id_NotInScope(Collection<Long> bldl5352IdList) {
        doSetBldl5352Id_NotInScope(bldl5352IdList);
    }

    protected void doSetBldl5352Id_NotInScope(Collection<Long> bldl5352IdList) {
        regINS(CK_NINS, cTL(bldl5352IdList), xgetCValueBldl5352Id(), "BLDL5352_ID");
    }
     ...
     * BLDL5352_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5352Id_IsNull() { regBldl5352Id(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * BLDL5352_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5352Id_IsNotNull() { regBldl5352Id(CK_ISNN, DOBJ); }

    protected void regBldl5352Id(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueBldl5352Id(), "BLDL5352_ID"); }
    protected abstract ConditionValue xgetCValueBldl5352Id();
     ...
     */
    public HpSLCFunction<TBldl5352CB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TBldl5352CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5352CB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TBldl5352CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5352CB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TBldl5352CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5352CB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TBldl5352CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5352CB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TBldl5352CB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TBldl5352CB&gt;() {
     *     public void query(TBldl5352CB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5352CB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TBldl5352CB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5352CB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TBldl5352CQ sq);

    protected TBldl5352CB xcreateScalarConditionCB() {
        TBldl5352CB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TBldl5352CB xcreateScalarConditionPartitionByCB() {
        TBldl5352CB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TBldl5352CB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5352CB cb = new TBldl5352CB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "BLDL5352_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TBldl5352CQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TBldl5352CB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TBldl5352CB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5352CB cb = new TBldl5352CB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "BLDL5352_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TBldl5352CQ sq);
     ...
     */
    public void myselfExists(SubQuery<TBldl5352CB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TBldl5352CB cb = new TBldl5352CB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TBldl5352CQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TBldl5352CB newMyCB() {
        return new TBldl5352CB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TBldl5352CQ.class.getName(); }
