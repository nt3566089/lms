...
public class BColExtUserDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnColExtUserId = cci("COL_EXT_USER_ID", "COL_EXT_USER_ID", null, null, Long.class, "colExtUserId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * COL_EXT_USER_ID: {PK, ID, NotNull, BIGINT(19)}
