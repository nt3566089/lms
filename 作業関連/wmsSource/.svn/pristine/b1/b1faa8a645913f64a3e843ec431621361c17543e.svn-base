...
/**
 * The abstract condition-query of es_inventory_inst.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEsInventoryInstCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEsInventoryInstCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<EsInventoryInstCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EsInventoryInstCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EsInventoryInstCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EsInventoryInstCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EsInventoryInstCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EsInventoryInstCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EsInventoryInstCB&gt;() {
     *     public void query(EsInventoryInstCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EsInventoryInstCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EsInventoryInstCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EsInventoryInstCQ sq);

    protected EsInventoryInstCB xcreateScalarConditionCB() {
        EsInventoryInstCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EsInventoryInstCB xcreateScalarConditionPartitionByCB() {
        EsInventoryInstCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EsInventoryInstCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EsInventoryInstCB cb = new EsInventoryInstCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "INVENTORY_INST_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EsInventoryInstCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EsInventoryInstCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EsInventoryInstCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EsInventoryInstCB cb = new EsInventoryInstCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "INVENTORY_INST_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EsInventoryInstCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EsInventoryInstCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EsInventoryInstCB cb = new EsInventoryInstCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EsInventoryInstCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EsInventoryInstCB newMyCB() {
        return new EsInventoryInstCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EsInventoryInstCQ.class.getName(); }
