...
public abstract class BsSqlReceivePlanBulkMasterData extends AbstractEntity implements CustomizeEntity {
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** RECEIVE_PLAN_H_ID: {BIGINT(20), refers to t_receive_plan_h.RECEIVE_PLAN_H_ID} */
    protected Long _receivePlanHId;

    /** RECEIVE_PLAN_B_ID: {BIGINT(20), refers to t_receive_plan_b.RECEIVE_PLAN_B_ID} */
    protected Long _receivePlanBId;

    /** PRODUCT_ID: {BIGINT(20), refers to m_product.PRODUCT_ID} */
    protected Long _productId;

    /** LOCATION_ID: {BIGINT(20), refers to m_location.LOCATION_ID} */
    protected Long _locationId;

    /** LOC_ZONE_WAREHOUSE_ID: {BIGINT(20), refers to m_warehouse.WAREHOUSE_ID} */
    ...
    /** SUPPLY_VENDOR_FLG: {CHAR(1), refers to m_customer.VENDOR_FLG} */
    ...
    /** DEPOSIT_FLG: {CHAR(1), refers to m_customer.DEPOSIT_FLG, classification=DepositFlg} */
    protected String _depositFlg;

    /** DECIMAL_EXIST_FLG: {CHAR(1), refers to m_shape_grp.DECIMAL_EXIST_FLG, classification=DecimalExistFlg} */
     ...
     * DEPOSIT_FLG: {CHAR(1), refers to m_customer.DEPOSIT_FLG, classification=DepositFlg} <br>
     * 預託先フラグ
     ...
     * DECIMAL_EXIST_FLG: {CHAR(1), refers to m_shape_grp.DECIMAL_EXIST_FLG, classification=DecimalExistFlg} <br>
     * 小数有無フラグ
     * <p>It's treated as case insensitive and if the code value is null, it returns null.</p>
     * @return The instance of classification definition (as ENUM type). (NullAllowed: when the column value is null)
     */
    ...
    //                                                                            ========
    /**
     * [get] RECEIVE_PLAN_H_ID: {BIGINT(20), refers to t_receive_plan_h.RECEIVE_PLAN_H_ID} <br>
     * 入荷予定ヘッダID
    ...
    /**
     * [set] RECEIVE_PLAN_H_ID: {BIGINT(20), refers to t_receive_plan_h.RECEIVE_PLAN_H_ID} <br>
     * 入荷予定ヘッダID
    ...
    /**
     * [get] RECEIVE_PLAN_B_ID: {BIGINT(20), refers to t_receive_plan_b.RECEIVE_PLAN_B_ID} <br>
     * 入荷予定ボディID
    ...
    /**
     * [set] RECEIVE_PLAN_B_ID: {BIGINT(20), refers to t_receive_plan_b.RECEIVE_PLAN_B_ID} <br>
     * 入荷予定ボディID
    ...
    /**
     * [get] LOCATION_ID: {BIGINT(20), refers to m_location.LOCATION_ID} <br>
     * ロケーションID
    ...
    /**
     * [set] LOCATION_ID: {BIGINT(20), refers to m_location.LOCATION_ID} <br>
     * ロケーションID
    ...
    /**
     * [get] LOC_ZONE_WAREHOUSE_ID: {BIGINT(20), refers to m_warehouse.WAREHOUSE_ID} <br>
     * 倉庫ID
    ...
    /**
     * [set] LOC_ZONE_WAREHOUSE_ID: {BIGINT(20), refers to m_warehouse.WAREHOUSE_ID} <br>
     * 倉庫ID
    ...
    /**
     * [get] SUPPLY_VENDOR_FLG: {CHAR(1), refers to m_customer.VENDOR_FLG} <br>
     * 仕入先フラグ
    ...
    /**
     * [set] SUPPLY_VENDOR_FLG: {CHAR(1), refers to m_customer.VENDOR_FLG} <br>
     * 仕入先フラグ
    ...
    /**
     * [get] DEPOSIT_FLG: {CHAR(1), refers to m_customer.DEPOSIT_FLG, classification=DepositFlg} <br>
     * 預託先フラグ<br>
     * // cls(DepositFlg)
    ...
    /**
     * [set] DEPOSIT_FLG: {CHAR(1), refers to m_customer.DEPOSIT_FLG, classification=DepositFlg} <br>
     * 預託先フラグ<br>
     * // cls(DepositFlg)
    ...
    /**
     * [get] DECIMAL_EXIST_FLG: {CHAR(1), refers to m_shape_grp.DECIMAL_EXIST_FLG, classification=DecimalExistFlg} <br>
     * 小数有無フラグ<br>
     * // cls(DecimalExistFlg)
    ...
    /**
     * [set] DECIMAL_EXIST_FLG: {CHAR(1), refers to m_shape_grp.DECIMAL_EXIST_FLG, classification=DecimalExistFlg} <br>
     * 小数有無フラグ<br>
     * // cls(DecimalExistFlg)
