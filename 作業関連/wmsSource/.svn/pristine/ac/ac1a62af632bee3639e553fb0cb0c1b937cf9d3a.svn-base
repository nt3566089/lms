...
public class PPrintRequestDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPrintRequestId = cci("PRINT_REQUEST_ID", "PRINT_REQUEST_ID", null, null, Long.class, "printRequestId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "PPrintQueueList,PPrintRequestBinaryList,PPrintRequestHistList", null, false);
    ...
    protected final ColumnInfo _columnFirstPrintDt = cci("FIRST_PRINT_DT", "FIRST_PRINT_DT", null, null, java.sql.Timestamp.class, "firstPrintDt", null, false, false, false, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnLatestPrintDt = cci("LATEST_PRINT_DT", "LATEST_PRINT_DT", null, null, java.sql.Timestamp.class, "latestPrintDt", null, false, false, false, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnQueueAddDt = cci("QUEUE_ADD_DT", "QUEUE_ADD_DT", null, null, java.sql.Timestamp.class, "queueAddDt", null, false, false, false, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    ...
    /**
     * PRINT_REQUEST_ID: {PK, ID, NotNull, BIGINT(19)}
