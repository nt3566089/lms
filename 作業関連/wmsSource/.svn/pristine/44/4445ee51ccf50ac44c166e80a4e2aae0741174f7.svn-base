...
public abstract class BsSqlPackingSlipListPrint extends AbstractEntity implements CustomizeEntity {
    ...
    /** CLIENT_SHIPPING_NO: {VARCHAR(30), refers to t_shipping_inst_h.CLIENT_SHIPPING_NO} */
    ...
    /**
     * [get] CLIENT_SHIPPING_NO: {VARCHAR(30), refers to t_shipping_inst_h.CLIENT_SHIPPING_NO} <br>
     * 顧客出荷指示No.
    ...
    /**
     * [set] CLIENT_SHIPPING_NO: {VARCHAR(30), refers to t_shipping_inst_h.CLIENT_SHIPPING_NO} <br>
     * 顧客出荷指示No.
