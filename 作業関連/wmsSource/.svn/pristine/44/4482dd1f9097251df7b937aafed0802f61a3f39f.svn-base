...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsMSalesOrgCQ;

/**
 * The condition-query of m_sales_org.
 * <p>
 ...
 */
public class MSalesOrgCQ extends BsMSalesOrgCQ {
     ...
     */
    public MSalesOrgCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
