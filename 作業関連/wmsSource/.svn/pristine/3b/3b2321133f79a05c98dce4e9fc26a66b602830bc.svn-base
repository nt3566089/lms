 ...
 * String forceCompleteFlg = entity.getForceCompleteFlg();
 * java.math.BigDecimal workQtyCs = entity.getWorkQtyCs();
 ...
 * entity.setForceCompleteFlg(forceCompleteFlg);
 * entity.setWorkQtyCs(workQtyCs);
...
public abstract class BsTWorkLog extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_forceCompleteFlg));
        sb.append(dm).append(xfND(_workQtyCs));
     ...
     * 強制完了フラグ
     * @return The value of the column 'FORCE_COMPLETE_FLG'. (NullAllowed even if selected: for no constraint)
     */
    public String getForceCompleteFlg() {
        checkSpecifiedProperty("forceCompleteFlg");
        return convertEmptyToNull(_forceCompleteFlg);
    }

    /**
     * [set] FORCE_COMPLETE_FLG: {CHAR(1)} <br>
     * 強制完了フラグ
     * @param forceCompleteFlg The value of the column 'FORCE_COMPLETE_FLG'. (NullAllowed: null update allowed for no constraint)
     */
    public void setForceCompleteFlg(String forceCompleteFlg) {
        registerModifiedProperty("forceCompleteFlg");
        _forceCompleteFlg = forceCompleteFlg;
    }

    /**
     * [get] WORK_QTY_CS: {DECIMAL(14, 4)} <br>
     * 作業数量（ケース）
     * @return The value of the column 'WORK_QTY_CS'. (NullAllowed even if selected: for no constraint)
     */
    public java.math.BigDecimal getWorkQtyCs() {
        checkSpecifiedProperty("workQtyCs");
        return _workQtyCs;
    }
     ...
     * 作業数量（ケース）
     * @param workQtyCs The value of the column 'WORK_QTY_CS'. (NullAllowed: null update allowed for no constraint)
     */
    public void setWorkQtyCs(java.math.BigDecimal workQtyCs) {
        registerModifiedProperty("workQtyCs");
        _workQtyCs = workQtyCs;
    }
