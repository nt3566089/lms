...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTBldl5340CQ;

/**
 * The condition-query of t_bldl5340.
 * <p>
 ...
 */
public class TBldl5340CQ extends BsTBldl5340CQ {
     ...
     */
    public TBldl5340CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
