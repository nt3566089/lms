...
public class MCenterItemDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnCenterItemId = cci("CENTER_ITEM_ID", "CENTER_ITEM_ID", null, null, Long.class, "centerItemId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
