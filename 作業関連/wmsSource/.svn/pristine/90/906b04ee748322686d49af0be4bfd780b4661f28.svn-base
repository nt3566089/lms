...
/**
 * The DTO mapper of t_bldl5100 as TABLE. <br>
 * BLDL5100
 * <pre>
 * [primary-key]
 *     BLDL5100_ID
 ...
 */
public abstract class BsTBldl5100DtoMapper implements DtoMapper<TBldl5100, TBldl5100Dto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTBldl5100DtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTBldl5100DtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TBldl5100Dto mappingToDto(TBldl5100 entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TBldl5100Dto dto = new TBldl5100Dto();
        dto.setBldl5100Id(entity.getBldl5100Id());
     ...
     * {@inheritDoc}
     */
    public List<TBldl5100Dto> mappingToDtoList(List<TBldl5100> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TBldl5100Dto> dtoList = new ArrayList<TBldl5100Dto>();
        for (TBldl5100 entity : entityList) {
            TBldl5100Dto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TBldl5100 mappingToEntity(TBldl5100Dto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TBldl5100 entity = new TBldl5100();
        if (needsMapping(dto, dto.getBldl5100Id(), "bldl5100Id")) {
            entity.setBldl5100Id(dto.getBldl5100Id());
        }
     ...
     */
    protected boolean needsMapping(TBldl5100Dto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TBldl5100> mappingToEntityList(List<TBldl5100Dto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TBldl5100> entityList = new ArrayList<TBldl5100>();
        for (TBldl5100Dto dto : dtoList) {
            TBldl5100 entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TBldl5100DtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TBldl5100DtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TBldl5100DtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TBldl5100DtoMapper reverseReference() {
