...
public abstract class AbstractBsMStockTypeCQ extends AbstractConditionQuery {
    ...
    /**
     * Set up ExistsReferrer (correlated sub-query). <br>
     * {exists (select REPLENISH_STOCK_TYPE_ID from m_location_replenish_product where ...)} <br>
     * m_location_replenish_product by REPLENISH_STOCK_TYPE_ID, named 'MLocationReplenishProductAsOne'.
     * <pre>
    ...
    public void existsMLocationReplenishProductList(SubQuery<MLocationReplenishProductCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepStockTypeId_ExistsReferrer_MLocationReplenishProductList(cb.query());
        registerExistsReferrer(cb.query(), "STOCK_TYPE_ID", "REPLENISH_STOCK_TYPE_ID", pp, "mLocationReplenishProductList");
    }
    public abstract String keepStockTypeId_ExistsReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq);
    ...
    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select REPLENISH_STOCK_TYPE_ID from m_location_replenish_product where ...)} <br>
     * m_location_replenish_product by REPLENISH_STOCK_TYPE_ID, named 'MLocationReplenishProductAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of StockTypeId_NotExistsReferrer_MLocationReplenishProductList for 'not exists'. (NotNull)
     */
    public void notExistsMLocationReplenishProductList(SubQuery<MLocationReplenishProductCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MLocationReplenishProductCB cb = new MLocationReplenishProductCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepStockTypeId_NotExistsReferrer_MLocationReplenishProductList(cb.query());
        registerNotExistsReferrer(cb.query(), "STOCK_TYPE_ID", "REPLENISH_STOCK_TYPE_ID", pp, "mLocationReplenishProductList");
    }
    public abstract String keepStockTypeId_NotExistsReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq);
    ...
    public void xsderiveMLocationReplenishProductList(String fn, SubQuery<MLocationReplenishProductCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepStockTypeId_SpecifyDerivedReferrer_MLocationReplenishProductList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "STOCK_TYPE_ID", "REPLENISH_STOCK_TYPE_ID", pp, "mLocationReplenishProductList", al, op);
    }
    public abstract String keepStockTypeId_SpecifyDerivedReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq);
    ...
    public void xqderiveMLocationReplenishProductList(String fn, SubQuery<MLocationReplenishProductCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MLocationReplenishProductCB cb = new MLocationReplenishProductCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepStockTypeId_QueryDerivedReferrer_MLocationReplenishProductList(cb.query()); String prpp = keepStockTypeId_QueryDerivedReferrer_MLocationReplenishProductListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "STOCK_TYPE_ID", "REPLENISH_STOCK_TYPE_ID", sqpp, "mLocationReplenishProductList", rd, vl, prpp, op);
    }
    public abstract String keepStockTypeId_QueryDerivedReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq);
    public abstract String keepStockTypeId_QueryDerivedReferrer_MLocationReplenishProductListParameter(Object vl);
     ...
     * REVERSE_VALID_FLG: {CHAR(1), FK to B_CLASS_DTL, classification=ReverseValidFlg}
     */
    public void setReverseValidFlg_IsNullOrEmpty() { regReverseValidFlg(CK_ISNOE, DOBJ); }
