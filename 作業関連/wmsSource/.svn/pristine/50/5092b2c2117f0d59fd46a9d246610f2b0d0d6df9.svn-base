...
/**
 * The simple DTO of t_bldl5170 as TABLE. <br>
 * BLDL5170
 * <pre>
 * [primary-key]
 *     BLDL5170_ID
...
public abstract class BsTBldl5170Dto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTBldl5170Dto)) { return false; }
        final BsTBldl5170Dto otherEntity = (BsTBldl5170Dto)other;
        if (!helpComparingValue(getBldl5170Id(), otherEntity.getBldl5170Id())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "t_bldl5170");
        result = xCH(result, getBldl5170Id());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getBldl5170Id());
     ...
     * BLDL5170ID
     * @return The value of the column 'BLDL5170_ID'. (NullAllowed)
     */
     ...
     * BLDL5170ID
     * @param bldl5170Id The value of the column 'BLDL5170_ID'. (NullAllowed)
     */
    public void setBldl5170Id(Long bldl5170Id) {
        __modifiedProperties.add("bldl5170Id");
        this._bldl5170Id = bldl5170Id;
    }
