...
public class WProductInputDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductInputId = cci("PRODUCT_INPUT_ID", "PRODUCT_INPUT_ID", null, null, Long.class, "productInputId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * PRODUCT_INPUT_ID: {PK, ID, NotNull, BIGINT(19)}
