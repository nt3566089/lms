...
public class TMoveRecordBDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((TMoveRecordB)et).getUserId(), (et, vl) -> ((TMoveRecordB)et).setUserId(ctl(vl)), "userId");
        setupEpg(_epgMap, et -> ((TMoveRecordB)et).getCmSendFlg(), (et, vl) -> ((TMoveRecordB)et).setCmSendFlg((String)vl), "cmSendFlg");
    ...
    protected void xsetupEfpg() {
        setupEfpg(_efpgMap, et -> ((TMoveRecordB)et).getBUser(), (et, vl) -> ((TMoveRecordB)et).setBUser((BUser)vl), "BUser");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMoveRecordBId = cci("MOVE_RECORD_B_ID", "MOVE_RECORD_B_ID", null, null, Long.class, "moveRecordBId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "TStockInoutList", null, false);
    ...
    protected final ColumnInfo _columnMoveNum = cci("MOVE_NUM", "MOVE_NUM", null, null, java.math.BigDecimal.class, "moveNum", null, false, false, false, "DECIMAL", 14, 4, null, null, false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignBUser() {
        ...
        return cfi("T_MOVE_RECORD_B_FK2", "BUser", this, BUserDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "TMoveRecordBList", false);
    }
    /**
    ...
    public ForeignInfo foreignMLocation() {
        ...
        return cfi("T_MOVE_RECORD_B_FK4", "MLocation", this, MLocationDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "TMoveRecordBList", false);
    }
    /**
    ...
    public ForeignInfo foreignTMoveInstB() {
        ...
        return cfi("T_MOVE_RECORD_B_FK1", "TMoveInstB", this, TMoveInstBDbm.getInstance(), mp, 2, null, false, false, false, false, null, null, false, "TMoveRecordBList", false);
    }
    /**
    ...
    public ForeignInfo foreignTMoveInstH() {
        ...
        return cfi("T_MOVE_RECORD_B_FK3", "TMoveInstH", this, TMoveInstHDbm.getInstance(), mp, 3, null, false, false, false, false, null, null, false, "TMoveRecordBList", false);
    }
    /**
    ...
    public ForeignInfo foreignBClassDtlByAllShippingFlg() {
        ...
        return cfi("FK_T_MOVE_RECORD_B_ALL_SHIPPING_FLG", "BClassDtlByAllShippingFlg", this, BClassDtlDbm.getInstance(), mp, 4, null, false, false, false, true, "$$foreignAlias$$.DEL_FLG = '0'\n            AND EXISTS \n              ($$sqbegin$$\n                SELECT * \n                  FROM B_CLASS C\n                  WHERE C.CLASS_ID = $$foreignAlias$$.CLASS_ID\n                    AND C.CLASS_CD  = 'ALL_SHIPPING_FLG'\n                    AND C.DEL_FLG   = '0'\n              )$$sqend$$", null, false, null, false);
    }
    /**
    ...
    public ForeignInfo foreignBClassDtlByStoreNoMergeFlg() {
        ...
        return cfi("FK_T_MOVE_RECORD_B_STORE_NO_MERGE_FLG", "BClassDtlByStoreNoMergeFlg", this, BClassDtlDbm.getInstance(), mp, 5, null, false, false, false, true, "$$foreignAlias$$.DEL_FLG = '0'\n            AND EXISTS \n              ($$sqbegin$$\n                SELECT * \n                  FROM B_CLASS C\n                  WHERE C.CLASS_ID = $$foreignAlias$$.CLASS_ID\n                    AND C.CLASS_CD  = 'STORE_NO_MERGE_FLG'\n                    AND C.DEL_FLG   = '0'\n              )$$sqend$$", null, false, null, false);
    }
    ...
    public ReferrerInfo referrerTStockInoutList() {
        ...
        return cri("T_STOCK_INOUT_FK6", "TStockInoutList", this, TStockInoutDbm.getInstance(), mp, false, "TMoveRecordB");
    }
