...
public class TStockReportDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnStockId = cci("STOCK_ID", "STOCK_ID", null, null, Long.class, "stockId", null, true, false, true, "BIGINT", 19, 0, null, null, false, null, null, "TStock", null, null, false);
    ...
    /**
     * STOCK_ID: {PK, NotNull, BIGINT(19), FK to t_stock}
