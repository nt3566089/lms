...
public class BClassGrpDtlDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnClassGrpDtlId = cci("CLASS_GRP_DTL_ID", "CLASS_GRP_DTL_ID", null, null, Long.class, "classGrpDtlId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * CLASS_GRP_DTL_ID: {PK, ID, NotNull, BIGINT(19)}
