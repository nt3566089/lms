...
public class TPackingBCIQ extends AbstractBsTPackingBCQ {
    ...
    protected ConditionValue xgetCValueShippingPackingRowNo() { return _myCQ.xdfgetShippingPackingRowNo(); }
    protected ConditionValue xgetCValueOldPackingBId() { return _myCQ.xdfgetOldPackingBId(); }
