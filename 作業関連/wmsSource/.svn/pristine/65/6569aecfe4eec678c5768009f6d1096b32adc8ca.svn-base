...
public abstract class BsTPackingRDto implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(c).append(getCdlOutFlg());
        sb.append(c).append(getCdlOutUserId());
        sb.append(c).append(getCdlOutDt());
     ...
     * 運送業者引き渡し票出力フラグ
     * @return The value of the column 'CDL_OUT_FLG'. (NullAllowed)
     */
     ...
     * 運送業者引き渡し票出力フラグ
     * @param cdlOutFlg The value of the column 'CDL_OUT_FLG'. (NullAllowed)
     */
    public void setCdlOutFlg(String cdlOutFlg) {
        __modifiedProperties.add("cdlOutFlg");
        this._cdlOutFlg = cdlOutFlg;
    }

    /**
     * [get] CDL_OUT_USER_ID: {BIGINT(19)} <br>
     * 運送業者引き渡し票出力者ID
     * @return The value of the column 'CDL_OUT_USER_ID'. (NullAllowed)
     */
     ...
     * 運送業者引き渡し票出力者ID
     * @param cdlOutUserId The value of the column 'CDL_OUT_USER_ID'. (NullAllowed)
     */
    public void setCdlOutUserId(Long cdlOutUserId) {
        __modifiedProperties.add("cdlOutUserId");
        this._cdlOutUserId = cdlOutUserId;
    }

    /**
     * [get] CDL_OUT_DT: {DATETIME(19)} <br>
     * 運送業者引き渡し票出力日時
     * @return The value of the column 'CDL_OUT_DT'. (NullAllowed)
     */
    @JSONHint(format="yyyy-MM-dd HH:mm:ss.SSS")
     ...
     * 運送業者引き渡し票出力日時
     * @param cdlOutDt The value of the column 'CDL_OUT_DT'. (NullAllowed)
     */
    public void setCdlOutDt(java.sql.Timestamp cdlOutDt) {
        __modifiedProperties.add("cdlOutDt");
        this._cdlOutDt = cdlOutDt;
    }
