...
public class TStoreNoDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnStoreNoId = cci("STORE_NO_ID", "STORE_NO_ID", null, null, Long.class, "storeNoId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "TAllocInstBList,TInventoryBList,TMoveInstBList,TShippingInstBList,TStockList,TStoreNoSelfList", null, false);
    ...
    public ForeignInfo foreignTStoreNoSelf() {
        ...
        return cfi("T_STORE_NO_FK1", "TStoreNoSelf", this, TStoreNoDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "TStoreNoSelfList", false);
    }
    /**
    ...
    public ForeignInfo foreignMCustomer() {
        ...
        return cfi("T_STORE_NO_FK2", "MCustomer", this, MCustomerDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "TStoreNoList", false);
    }
    /**
    ...
    public ReferrerInfo referrerTAllocInstBList() {
        ...
        return cri("T_ALLOC_INST_B_FK4", "TAllocInstBList", this, TAllocInstBDbm.getInstance(), mp, false, "TStoreNo");
    }
    /**
    ...
    public ReferrerInfo referrerTInventoryBList() {
        ...
        return cri("T_INVENTORY_B_FK3", "TInventoryBList", this, TInventoryBDbm.getInstance(), mp, false, "TStoreNo");
    }
    /**
    ...
    public ReferrerInfo referrerTShippingInstBList() {
        ...
        return cri("T_SHIPPING_INST_B_FK6", "TShippingInstBList", this, TShippingInstBDbm.getInstance(), mp, false, "TStoreNo");
    }
    /**
    ...
    public ReferrerInfo referrerTStockList() {
        ...
        return cri("T_STOCK_FK4", "TStockList", this, TStockDbm.getInstance(), mp, false, "TStoreNo");
    }
    /**
    ...
    public ReferrerInfo referrerTStoreNoSelfList() {
        ...
        return cri("T_STORE_NO_FK1", "TStoreNoSelfList", this, TStoreNoDbm.getInstance(), mp, false, "TStoreNoSelf");
    }
