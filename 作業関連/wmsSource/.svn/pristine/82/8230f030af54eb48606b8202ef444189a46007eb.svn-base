...
public abstract class BsTPicMthdRcmd extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] PIC_MTHD_RCMD_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * ピッキング提案ID
    ...
    /**
     * [set] PIC_MTHD_RCMD_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * ピッキング提案ID
    ...
    /**
     * [get] WORK_VOLUME: {DECIMAL(14, 4)} <br>
     * 仕事量
    ...
    /**
     * [set] WORK_VOLUME: {DECIMAL(14, 4)} <br>
     * 仕事量
