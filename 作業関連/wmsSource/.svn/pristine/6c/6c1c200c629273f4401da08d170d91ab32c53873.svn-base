...
/**
 * The DB meta of t_bldl5151. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class TBldl5151Dbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final TBldl5151Dbm _instance = new TBldl5151Dbm();
    private TBldl5151Dbm() {}
    public static TBldl5151Dbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((TBldl5151)et).getBldl5151Id(), (et, vl) -> ((TBldl5151)et).setBldl5151Id(ctl(vl)), "bldl5151Id");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getYearmonth(), (et, vl) -> ((TBldl5151)et).setYearmonth((String)vl), "yearmonth");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getBaseNm(), (et, vl) -> ((TBldl5151)et).setBaseNm((String)vl), "baseNm");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getMonth(), (et, vl) -> ((TBldl5151)et).setMonth((String)vl), "month");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getRowNo(), (et, vl) -> ((TBldl5151)et).setRowNo((String)vl), "rowNo");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getReceiveDt(), (et, vl) -> ((TBldl5151)et).setReceiveDt((String)vl), "receiveDt");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getFwRcvCnt(), (et, vl) -> ((TBldl5151)et).setFwRcvCnt(ctl(vl)), "fwRcvCnt");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getFwRcvNum(), (et, vl) -> ((TBldl5151)et).setFwRcvNum(ctl(vl)), "fwRcvNum");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getFwCaseNum(), (et, vl) -> ((TBldl5151)et).setFwCaseNum(ctl(vl)), "fwCaseNum");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getUnRcvCnt(), (et, vl) -> ((TBldl5151)et).setUnRcvCnt(ctl(vl)), "unRcvCnt");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getUnRcvNum(), (et, vl) -> ((TBldl5151)et).setUnRcvNum(ctl(vl)), "unRcvNum");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getUnCaseNum(), (et, vl) -> ((TBldl5151)et).setUnCaseNum(ctl(vl)), "unCaseNum");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getShRcvCnt(), (et, vl) -> ((TBldl5151)et).setShRcvCnt(ctl(vl)), "shRcvCnt");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getShRcvNum(), (et, vl) -> ((TBldl5151)et).setShRcvNum(ctl(vl)), "shRcvNum");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getShCaseNum(), (et, vl) -> ((TBldl5151)et).setShCaseNum(ctl(vl)), "shCaseNum");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getHmRcvCnt(), (et, vl) -> ((TBldl5151)et).setHmRcvCnt(ctl(vl)), "hmRcvCnt");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getHmRcvNum(), (et, vl) -> ((TBldl5151)et).setHmRcvNum(ctl(vl)), "hmRcvNum");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getHmCaseNum(), (et, vl) -> ((TBldl5151)et).setHmCaseNum(ctl(vl)), "hmCaseNum");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getTotalRcvNum(), (et, vl) -> ((TBldl5151)et).setTotalRcvNum(ctl(vl)), "totalRcvNum");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getTotalCaseNum(), (et, vl) -> ((TBldl5151)et).setTotalCaseNum(ctl(vl)), "totalCaseNum");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getDelFlg(), (et, vl) -> ((TBldl5151)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getVersionNo(), (et, vl) -> ((TBldl5151)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getControlNo(), (et, vl) -> ((TBldl5151)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getAddDt(), (et, vl) -> ((TBldl5151)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getAddUser(), (et, vl) -> ((TBldl5151)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getAddProcess(), (et, vl) -> ((TBldl5151)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getUpdDt(), (et, vl) -> ((TBldl5151)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getUpdUser(), (et, vl) -> ((TBldl5151)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((TBldl5151)et).getUpdProcess(), (et, vl) -> ((TBldl5151)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "t_bldl5151";
    protected final String _tableDispName = "t_bldl5151";
    protected final String _tablePropertyName = "TBldl5151";
    protected final TableSqlName _tableSqlName = new TableSqlName("t_bldl5151", _tableDbName);
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnBldl5151Id = cci("BLDL5151_ID", "BLDL5151_ID", null, null, Long.class, "bldl5151Id", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
     ...
     */
    public ColumnInfo columnBldl5151Id() { return _columnBldl5151Id; }
    /**
    ...
    //                                       Primary Element
    //                                       ---------------
    protected UniqueInfo cpui() { return hpcpui(columnBldl5151Id()); }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.TBldl5151"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.TBldl5151CB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.TBldl5151Bhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<TBldl5151> getEntityType() { return TBldl5151.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public TBldl5151 newEntity() { return new TBldl5151(); }
    ...
    { doAcceptPrimaryKeyMap((TBldl5151)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((TBldl5151)et, mp); }
