...
/**
 * The condition-query for in-line of es_inventory_inst_dtl.
 * @author DBFlute(AutoGenerator)
 */
public class EsInventoryInstDtlCIQ extends AbstractBsEsInventoryInstDtlCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEsInventoryInstDtlCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EsInventoryInstDtlCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEsInventoryInstDtlCQ myCQ) {
    ...
    public String keepScalarCondition(EsInventoryInstDtlCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EsInventoryInstDtlCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EsInventoryInstDtlCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EsInventoryInstDtlCQ sq)
    ...
    protected String xinCB() { return EsInventoryInstDtlCB.class.getName(); }
    protected String xinCQ() { return EsInventoryInstDtlCQ.class.getName(); }
}
