...
public class BsMLocationCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MLocationCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnExternalWhFlg() { return doColumn("EXTERNAL_WH_FLG"); }
        /**
         * LOCATION_ATTRIBUTE: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnLocationAttribute() { return doColumn("LOCATION_ATTRIBUTE"); }
        /**
         ...
         */
        public HpSDRFunction<HLocationAttributeCB, MLocationCQ> derivedHLocationAttributeList() {
            assertDerived("hLocationAttributeList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<HLocationAttributeCB> sq, MLocationCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MLocationReplenishProductCB, MLocationCQ> derivedMLocationReplenishProductList() {
            assertDerived("mLocationReplenishProductList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MLocationReplenishProductCB> sq, MLocationCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WHtPickingCB, MLocationCQ> derivedWHtPickingList() {
            assertDerived("wHtPickingList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtPickingCB> sq, MLocationCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WHtTotalPickingCB, MLocationCQ> derivedWHtTotalPickingList() {
            assertDerived("wHtTotalPickingList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtTotalPickingCB> sq, MLocationCQ cq, String al, DerivedReferrerOption op)
