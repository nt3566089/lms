...
/**
 * The entity of es_product as TABLE. <br>
 * 商品マスタ連携送信テーブル
 * <pre>
 * [primary-key]
 *     PRODUCT_ID
 ...
 */
public abstract class BsEsProduct extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEsProduct) {
            BsEsProduct other = (BsEsProduct)obj;
    ...
    @Override
    public EsProduct clone() {
        return (EsProduct)super.clone();
    }
