...
public class MCarrierBoxDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnCarrierBoxId = cci("CARRIER_BOX_ID", "CARRIER_BOX_ID", null, null, Long.class, "carrierBoxId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * CARRIER_BOX_ID: {PK, ID, NotNull, BIGINT(19)}
