...
/**
 * The simple DTO of t_bldl5110 as TABLE. <br>
 * BLDL5110
 * <pre>
 * [primary-key]
 *     BLDL5110_ID
...
public abstract class BsTBldl5110Dto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTBldl5110Dto)) { return false; }
        final BsTBldl5110Dto otherEntity = (BsTBldl5110Dto)other;
        if (!helpComparingValue(getBldl5110Id(), otherEntity.getBldl5110Id())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "t_bldl5110");
        result = xCH(result, getBldl5110Id());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getBldl5110Id());
     ...
     * BLDL5110ID
     * @return The value of the column 'BLDL5110_ID'. (NullAllowed)
     */
     ...
     * BLDL5110ID
     * @param bldl5110Id The value of the column 'BLDL5110_ID'. (NullAllowed)
     */
    public void setBldl5110Id(Long bldl5110Id) {
        __modifiedProperties.add("bldl5110Id");
        this._bldl5110Id = bldl5110Id;
    }
