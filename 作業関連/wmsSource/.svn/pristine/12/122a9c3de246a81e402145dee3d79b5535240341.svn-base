...
public class TInventoryBCIQ extends AbstractBsTInventoryBCQ {
    ...
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepInventoryBId_ExistsReferrer_TInventoryReceiveLabelList(TInventoryReceiveLabelCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    ...
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepInventoryBId_NotExistsReferrer_TInventoryReceiveLabelList(TInventoryReceiveLabelCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepInventoryBId_SpecifyDerivedReferrer_TInventoryInpHistList(TInventoryInpHistCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepInventoryBId_SpecifyDerivedReferrer_TInventoryReceiveLabelList(TInventoryReceiveLabelCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    ...
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepInventoryBId_QueryDerivedReferrer_TInventoryReceiveLabelList(TInventoryReceiveLabelCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepInventoryBId_QueryDerivedReferrer_TInventoryReceiveLabelListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    ...
    protected ConditionValue xgetCValueHtInputInventoryNum() { return _myCQ.xdfgetHtInputInventoryNum(); }
    protected ConditionValue xgetCValueWebInputInventoryNum() { return _myCQ.xdfgetWebInputInventoryNum(); }
    protected ConditionValue xgetCValueAjisInputInventoryNum() { return _myCQ.xdfgetAjisInputInventoryNum(); }
    ...
    public String keepAccountId_InScopeRelation_MCustomerByAccountId(MCustomerCQ sq)
    { return _myCQ.keepAccountId_InScopeRelation_MCustomerByAccountId(sq); }
    public String keepAccountId_NotInScopeRelation_MCustomerByAccountId(MCustomerCQ sq)
    { return _myCQ.keepAccountId_NotInScopeRelation_MCustomerByAccountId(sq); }
    ...
    protected ConditionValue xgetCValueInventoryUserId() { return _myCQ.xdfgetInventoryUserId(); }
    public String keepInventoryUserId_InScopeRelation_BUserByInventoryUserId(BUserCQ sq)
    { return _myCQ.keepInventoryUserId_InScopeRelation_BUserByInventoryUserId(sq); }
    public String keepInventoryUserId_NotInScopeRelation_BUserByInventoryUserId(BUserCQ sq)
    { return _myCQ.keepInventoryUserId_NotInScopeRelation_BUserByInventoryUserId(sq); }
    protected ConditionValue xgetCValueInventoryUpdUserId() { return _myCQ.xdfgetInventoryUpdUserId(); }
    public String keepInventoryUpdUserId_InScopeRelation_BUserByInventoryUpdUserId(BUserCQ sq)
    { return _myCQ.keepInventoryUpdUserId_InScopeRelation_BUserByInventoryUpdUserId(sq); }
    public String keepInventoryUpdUserId_NotInScopeRelation_BUserByInventoryUpdUserId(BUserCQ sq)
    { return _myCQ.keepInventoryUpdUserId_NotInScopeRelation_BUserByInventoryUpdUserId(sq); }
