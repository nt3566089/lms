...
public class WHtReceiveInspectionCIQ extends AbstractBsWHtReceiveInspectionCQ {
    ...
    protected ConditionValue xgetCValueProductionDt() { return _myCQ.xdfgetProductionDt(); }
    protected ConditionValue xgetCValueInputAssistanceUnitNum() { return _myCQ.xdfgetInputAssistanceUnitNum(); }
    protected ConditionValue xgetCValueInputAssistanceCaseNum() { return _myCQ.xdfgetInputAssistanceCaseNum(); }
    protected ConditionValue xgetCValueInputAssistancePieceNum() { return _myCQ.xdfgetInputAssistancePieceNum(); }
    protected ConditionValue xgetCValueCaseReceiveLabelNum() { return _myCQ.xdfgetCaseReceiveLabelNum(); }
    protected ConditionValue xgetCValuePieceReceiveLabelNum() { return _myCQ.xdfgetPieceReceiveLabelNum(); }
