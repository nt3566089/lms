...
public abstract class BsTReceivePlanRDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] RECEIVE_PLAN_H_ID: {PK, NotNull, BIGINT(19), FK to t_receive_plan_h} <br>
     * 入荷予定ヘッダID
    ...
    /**
     * [set] RECEIVE_PLAN_H_ID: {PK, NotNull, BIGINT(19), FK to t_receive_plan_h} <br>
     * 入荷予定ヘッダID
