...
/**
 * The condition-query for in-line of m_plant_storage_space.
 * @author DBFlute(AutoGenerator)
 */
public class MPlantStorageSpaceCIQ extends AbstractBsMPlantStorageSpaceCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsMPlantStorageSpaceCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MPlantStorageSpaceCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsMPlantStorageSpaceCQ myCQ) {
    ...
    public String keepScalarCondition(MPlantStorageSpaceCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(MPlantStorageSpaceCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(MPlantStorageSpaceCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(MPlantStorageSpaceCQ sq)
    ...
    protected String xinCB() { return MPlantStorageSpaceCB.class.getName(); }
    protected String xinCQ() { return MPlantStorageSpaceCQ.class.getName(); }
}
