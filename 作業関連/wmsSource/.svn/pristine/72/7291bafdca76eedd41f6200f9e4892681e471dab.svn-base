...
public abstract class BsTStockBhv extends AbstractBehaviorWritable<TStock, TStockCB> {
     ...
     * @param stockId : PK, ID, NotNull, BIGINT(19). (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">tStockBhv</span>.<span style="color: #CC4747">loadTPickingRecordStockList</span>(<span style="color: #553000">tStockList</span>, <span style="color: #553000">stockCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingRecordStock> loadTPickingRecordStockList(List<TStock> tStockList, ConditionBeanSetupper<TPickingRecordStockCB> refCBLambda) {
        xassLRArg(tStockList, refCBLambda);
        return doLoadTPickingRecordStockList(tStockList, new LoadReferrerOption<TPickingRecordStockCB, TPickingRecordStock>().xinit(refCBLambda));
    }
     ...
     * t_picking_record_stock by STOCK_ID, named 'TPickingRecordStockList'.
     * <pre>
     * <span style="color: #0000C0">tStockBhv</span>.<span style="color: #CC4747">loadTPickingRecordStockList</span>(<span style="color: #553000">tStock</span>, <span style="color: #553000">stockCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">stockCB</span>.setupSelect...
     *     <span style="color: #553000">stockCB</span>.query().set...
     *     <span style="color: #553000">stockCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">tStock</span>.<span style="color: #CC4747">getTPickingRecordStockList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingRecordStock> loadTPickingRecordStockList(TStock tStock, ConditionBeanSetupper<TPickingRecordStockCB> refCBLambda) {
        xassLRArg(tStock, refCBLambda);
        return doLoadTPickingRecordStockList(xnewLRLs(tStock), new LoadReferrerOption<TPickingRecordStockCB, TPickingRecordStock>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingRecordStock> loadTPickingRecordStockList(TStock tStock, LoadReferrerOption<TPickingRecordStockCB, TPickingRecordStock> loadReferrerOption) {
        xassLRArg(tStock, loadReferrerOption);
        return loadTPickingRecordStockList(xnewLRLs(tStock), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TPickingRecordStock> loadTPickingRecordStockList(List<TStock> tStockList, LoadReferrerOption<TPickingRecordStockCB, TPickingRecordStock> loadReferrerOption) {
        xassLRArg(tStockList, loadReferrerOption);
        if (tStockList.isEmpty()) { return (NestedReferrerListGateway<TPickingRecordStock>)EMPTY_NREF_LGWAY; }
        return doLoadTPickingRecordStockList(tStockList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TPickingRecordStock> doLoadTPickingRecordStockList(List<TStock> tStockList, LoadReferrerOption<TPickingRecordStockCB, TPickingRecordStock> option) {
        return helpLoadReferrerInternally(tStockList, option, "tPickingRecordStockList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tStockBhv</span>.<span style="color: #CC4747">loadTReceiveLabelList</span>(<span style="color: #553000">tStockList</span>, <span style="color: #553000">labelCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TReceiveLabel> loadTReceiveLabelList(List<TStock> tStockList, ConditionBeanSetupper<TReceiveLabelCB> refCBLambda) {
        xassLRArg(tStockList, refCBLambda);
        return doLoadTReceiveLabelList(tStockList, new LoadReferrerOption<TReceiveLabelCB, TReceiveLabel>().xinit(refCBLambda));
    }
     ...
     * t_receive_label by STOCK_ID, named 'TReceiveLabelList'.
     * <pre>
     * <span style="color: #0000C0">tStockBhv</span>.<span style="color: #CC4747">loadTReceiveLabelList</span>(<span style="color: #553000">tStock</span>, <span style="color: #553000">labelCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">labelCB</span>.setupSelect...
     *     <span style="color: #553000">labelCB</span>.query().set...
     *     <span style="color: #553000">labelCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">tStock</span>.<span style="color: #CC4747">getTReceiveLabelList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TReceiveLabel> loadTReceiveLabelList(TStock tStock, ConditionBeanSetupper<TReceiveLabelCB> refCBLambda) {
        xassLRArg(tStock, refCBLambda);
        return doLoadTReceiveLabelList(xnewLRLs(tStock), new LoadReferrerOption<TReceiveLabelCB, TReceiveLabel>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TReceiveLabel> loadTReceiveLabelList(TStock tStock, LoadReferrerOption<TReceiveLabelCB, TReceiveLabel> loadReferrerOption) {
        xassLRArg(tStock, loadReferrerOption);
        return loadTReceiveLabelList(xnewLRLs(tStock), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TReceiveLabel> loadTReceiveLabelList(List<TStock> tStockList, LoadReferrerOption<TReceiveLabelCB, TReceiveLabel> loadReferrerOption) {
        xassLRArg(tStockList, loadReferrerOption);
        if (tStockList.isEmpty()) { return (NestedReferrerListGateway<TReceiveLabel>)EMPTY_NREF_LGWAY; }
        return doLoadTReceiveLabelList(tStockList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TReceiveLabel> doLoadTReceiveLabelList(List<TStock> tStockList, LoadReferrerOption<TReceiveLabelCB, TReceiveLabel> option) {
        return helpLoadReferrerInternally(tStockList, option, "tReceiveLabelList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tStockBhv</span>.<span style="color: #CC4747">loadTScmLabelList</span>(<span style="color: #553000">tStockList</span>, <span style="color: #553000">labelCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">labelCB</span>.setupSelect...
     *     <span style="color: #553000">labelCB</span>.query().set...
     *     <span style="color: #553000">labelCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TScmLabel> loadTScmLabelList(List<TStock> tStockList, ConditionBeanSetupper<TScmLabelCB> refCBLambda) {
        xassLRArg(tStockList, refCBLambda);
        return doLoadTScmLabelList(tStockList, new LoadReferrerOption<TScmLabelCB, TScmLabel>().xinit(refCBLambda));
    }
     ...
     * t_scm_label by STOCK_ID, named 'TScmLabelList'.
     * <pre>
     * <span style="color: #0000C0">tStockBhv</span>.<span style="color: #CC4747">loadTScmLabelList</span>(<span style="color: #553000">tStock</span>, <span style="color: #553000">labelCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">labelCB</span>.setupSelect...
     *     <span style="color: #553000">labelCB</span>.query().set...
     *     <span style="color: #553000">labelCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">tStock</span>.<span style="color: #CC4747">getTScmLabelList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TScmLabel> loadTScmLabelList(TStock tStock, ConditionBeanSetupper<TScmLabelCB> refCBLambda) {
        xassLRArg(tStock, refCBLambda);
        return doLoadTScmLabelList(xnewLRLs(tStock), new LoadReferrerOption<TScmLabelCB, TScmLabel>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TScmLabel> loadTScmLabelList(TStock tStock, LoadReferrerOption<TScmLabelCB, TScmLabel> loadReferrerOption) {
        xassLRArg(tStock, loadReferrerOption);
        return loadTScmLabelList(xnewLRLs(tStock), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TScmLabel> loadTScmLabelList(List<TStock> tStockList, LoadReferrerOption<TScmLabelCB, TScmLabel> loadReferrerOption) {
        xassLRArg(tStockList, loadReferrerOption);
        if (tStockList.isEmpty()) { return (NestedReferrerListGateway<TScmLabel>)EMPTY_NREF_LGWAY; }
        return doLoadTScmLabelList(tStockList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TScmLabel> doLoadTScmLabelList(List<TStock> tStockList, LoadReferrerOption<TScmLabelCB, TScmLabel> option) {
        return helpLoadReferrerInternally(tStockList, option, "tScmLabelList");
    }
