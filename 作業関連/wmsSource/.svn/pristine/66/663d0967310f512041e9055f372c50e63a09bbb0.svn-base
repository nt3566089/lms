...
public abstract class BsPReportLayoutDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] REPORT_LAYOUT_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 帳票レイアウトID
    ...
    /**
     * [set] REPORT_LAYOUT_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 帳票レイアウトID
    ...
    /**
     * [get] REPORT_LAYOUT_DATA: {NotNull, LONGTEXT(2147483647)} <br>
     * 帳票レイアウトデータ
    ...
    /**
     * [set] REPORT_LAYOUT_DATA: {NotNull, LONGTEXT(2147483647)} <br>
     * 帳票レイアウトデータ
