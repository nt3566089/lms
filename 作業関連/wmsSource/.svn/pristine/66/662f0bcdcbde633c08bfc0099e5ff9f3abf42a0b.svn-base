...
/**
 * The base condition-bean of m_sales_org.
 * @author DBFlute(AutoGenerator)
 */
public class BsMSalesOrgCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MSalesOrgCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMSalesOrgCB() {
     ...
     * @return this. (NotNull)
     */
    public MSalesOrgCB acceptPK(Long salesOrgId) {
        assertObjectNotNull("salesOrgId", salesOrgId);
        BsMSalesOrgCB cb = this;
        cb.query().setSalesOrgId_Equal(salesOrgId);
        return (MSalesOrgCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public MSalesOrgCB acceptUniqueOf(String salesOrgCd) {
     ...
     */
    public MSalesOrgCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MSalesOrgCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MSalesOrgCQ doGetConditionQuery() {
    ...
    protected MSalesOrgCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MSalesOrgCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MSalesOrgCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MSalesOrgCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MSalesOrgCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MSalesOrgCB> unionCBLambda) {
        final MSalesOrgCB cb = new MSalesOrgCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MSalesOrgCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MSalesOrgCB> unionCBLambda) {
        final MSalesOrgCB cb = new MSalesOrgCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MSalesOrgCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<MSalesOrgCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MSalesOrgCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnWmsSendFlg() { return doColumn("WMS_SEND_FLG"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "m_sales_org"; }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from m_base_sales_org where ...) as FOO_MAX} <br>
         * m_base_sales_org by SALES_ORG_ID, named 'MBaseSalesOrgList'.
         * <pre>
         * cb.specify().<span style="color: #CC4747">derived${relationMethodIdentityName}()</span>.<span style="color: #CC4747">max</span>(orgCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
         *     orgCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     orgCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, MBaseSalesOrg.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MBaseSalesOrgCB, MSalesOrgCQ> derivedMBaseSalesOrgList() {
            assertDerived("mBaseSalesOrgList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MBaseSalesOrgCB> sq, MSalesOrgCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveMBaseSalesOrgList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MCarrierDecisionCB, MSalesOrgCQ> derivedMCarrierDecisionList() {
            assertDerived("mCarrierDecisionList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MCarrierDecisionCB> sq, MSalesOrgCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MCustomerPickingCB, MSalesOrgCQ> derivedMCustomerPickingList() {
            assertDerived("mCustomerPickingList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MCustomerPickingCB> sq, MSalesOrgCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MDepositProductCB, MSalesOrgCQ> derivedMDepositProductList() {
            assertDerived("mDepositProductList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MDepositProductCB> sq, MSalesOrgCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveMDepositProductList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from m_koguchi_delivery where ...) as FOO_MAX} <br>
         * m_koguchi_delivery by SERV_SALES_ORG_ID, named 'MKoguchiDeliveryList'.
         * <pre>
         * cb.specify().<span style="color: #CC4747">derived${relationMethodIdentityName}()</span>.<span style="color: #CC4747">max</span>(deliveryCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
         *     deliveryCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     deliveryCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, MKoguchiDelivery.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MKoguchiDeliveryCB, MSalesOrgCQ> derivedMKoguchiDeliveryList() {
            assertDerived("mKoguchiDeliveryList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MKoguchiDeliveryCB> sq, MSalesOrgCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveMKoguchiDeliveryList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TInventoryBCB, MSalesOrgCQ> derivedTInventoryBList() {
            assertDerived("tInventoryBList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TInventoryBCB> sq, MSalesOrgCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<MSalesOrgCB, MSalesOrgCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MSalesOrgCB> sq, MSalesOrgCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MSalesOrgCB dreamCruiseCB() {
        MSalesOrgCB cb = new MSalesOrgCB();
        cb.xsetupForDreamCruise((MSalesOrgCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MSalesOrgCB> columnQuery(final SpecifyQuery<MSalesOrgCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MSalesOrgCB xcreateColumnQueryCB() {
        MSalesOrgCB cb = new MSalesOrgCB();
        cb.xsetupForColumnQuery((MSalesOrgCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MSalesOrgCB> orCBLambda) {
        xorSQ((MSalesOrgCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MSalesOrgCB> andCBLambda) {
        xorSQAP((MSalesOrgCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MSalesOrgCB cb;
        if (mainCB != null) {
            cb = (MSalesOrgCB)mainCB;
        } else {
            cb = new MSalesOrgCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MSalesOrgCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MSalesOrgCQ.class.getName(); }
