...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTInvoiceTrackingCQ;

/**
 * The condition-query of t_invoice_tracking.
 * <p>
 ...
 */
public class TInvoiceTrackingCQ extends BsTInvoiceTrackingCQ {
     ...
     */
    public TInvoiceTrackingCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
