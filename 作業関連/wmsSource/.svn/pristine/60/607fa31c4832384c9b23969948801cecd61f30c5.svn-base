...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsMKoguchiDeliveryCQ;

/**
 * The condition-query of m_koguchi_delivery.
 * <p>
 ...
 */
public class MKoguchiDeliveryCQ extends BsMKoguchiDeliveryCQ {
     ...
     */
    public MKoguchiDeliveryCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
