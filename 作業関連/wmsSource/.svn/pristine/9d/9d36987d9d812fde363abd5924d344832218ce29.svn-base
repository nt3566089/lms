...
public class MEdiColumnDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnEdiColumnId = cci("EDI_COLUMN_ID", "EDI_COLUMN_ID", null, null, Long.class, "ediColumnId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MImportTypeBList", null, false);
    ...
    public ReferrerInfo referrerMImportTypeBList() {
        ...
        return cri("M_IMPORT_TYPE_B_FK1", "MImportTypeBList", this, MImportTypeBDbm.getInstance(), mp, false, "MEdiColumn");
    }
