...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsMGeneralCQ;

/**
 * The condition-query of m_general.
 * <p>
 ...
 */
public class MGeneralCQ extends BsMGeneralCQ {
     ...
     */
    public MGeneralCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
