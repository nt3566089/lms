...
public class BsTLotCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<TLotCQ> {
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WHtPickingCB, TLotCQ> derivedWHtPickingList() {
            assertDerived("wHtPickingList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtPickingCB> sq, TLotCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WHtTotalPickingCB, TLotCQ> derivedWHtTotalPickingList() {
            assertDerived("wHtTotalPickingList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtTotalPickingCB> sq, TLotCQ cq, String al, DerivedReferrerOption op)
