...
public class MDataInputTypeBDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnDataInputTypeBId = cci("DATA_INPUT_TYPE_B_ID", "DATA_INPUT_TYPE_B_ID", null, null, Long.class, "dataInputTypeBId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
