...
public class TPicMthdRcmdCartDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPicMthdRcmdCartId = cci("PIC_MTHD_RCMD_CART_ID", "PIC_MTHD_RCMD_CART_ID", null, null, Long.class, "picMthdRcmdCartId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignTPackingH() {
        ...
        return cfi("T_PIC_MTHD_RCMD_CART_FK2", "TPackingH", this, TPackingHDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "TPicMthdRcmdCartList", false);
    }
    /**
    ...
    public ForeignInfo foreignTPicMthdRcmd() {
        ...
        return cfi("T_PIC_MTHD_RCMD_CART_FK1", "TPicMthdRcmd", this, TPicMthdRcmdDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "TPicMthdRcmdCartList", false);
    }
