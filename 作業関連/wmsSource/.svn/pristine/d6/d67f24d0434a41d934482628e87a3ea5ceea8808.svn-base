...
/**
 * The condition-query for in-line of es_inventory_inst.
 * @author DBFlute(AutoGenerator)
 */
public class EsInventoryInstCIQ extends AbstractBsEsInventoryInstCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEsInventoryInstCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EsInventoryInstCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEsInventoryInstCQ myCQ) {
    ...
    public String keepScalarCondition(EsInventoryInstCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EsInventoryInstCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EsInventoryInstCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EsInventoryInstCQ sq)
    ...
    protected String xinCB() { return EsInventoryInstCB.class.getName(); }
    protected String xinCQ() { return EsInventoryInstCQ.class.getName(); }
}
