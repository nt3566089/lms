...
public abstract class BsBUserBhv extends AbstractBehaviorWritable<BUser, BUserCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryBByInventoryUpdUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">bCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryB> loadTInventoryBByInventoryUpdUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TInventoryBCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTInventoryBByInventoryUpdUserIdList(bUserList, new LoadReferrerOption<TInventoryBCB, TInventoryB>().xinit(refCBLambda));
    }
     ...
     * t_inventory_b by INVENTORY_UPD_USER_ID, named 'TInventoryBByInventoryUpdUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryBByInventoryUpdUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">bCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">bCB</span>.setupSelect...
     *     <span style="color: #553000">bCB</span>.query().set...
     *     <span style="color: #553000">bCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTInventoryBByInventoryUpdUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryB> loadTInventoryBByInventoryUpdUserIdList(BUser bUser, ConditionBeanSetupper<TInventoryBCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTInventoryBByInventoryUpdUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TInventoryBCB, TInventoryB>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryB> loadTInventoryBByInventoryUpdUserIdList(BUser bUser, LoadReferrerOption<TInventoryBCB, TInventoryB> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTInventoryBByInventoryUpdUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TInventoryB> loadTInventoryBByInventoryUpdUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryBCB, TInventoryB> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TInventoryB>)EMPTY_NREF_LGWAY; }
        return doLoadTInventoryBByInventoryUpdUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TInventoryB> doLoadTInventoryBByInventoryUpdUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryBCB, TInventoryB> option) {
        return helpLoadReferrerInternally(bUserList, option, "tInventoryBByInventoryUpdUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryBByInventoryUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">bCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">bCB</span>.setupSelect...
     *     <span style="color: #553000">bCB</span>.query().set...
     *     <span style="color: #553000">bCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryB> loadTInventoryBByInventoryUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TInventoryBCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTInventoryBByInventoryUserIdList(bUserList, new LoadReferrerOption<TInventoryBCB, TInventoryB>().xinit(refCBLambda));
    }
     ...
     * t_inventory_b by INVENTORY_USER_ID, named 'TInventoryBByInventoryUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryBByInventoryUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">bCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">bCB</span>.setupSelect...
     *     <span style="color: #553000">bCB</span>.query().set...
     *     <span style="color: #553000">bCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTInventoryBByInventoryUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryB> loadTInventoryBByInventoryUserIdList(BUser bUser, ConditionBeanSetupper<TInventoryBCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTInventoryBByInventoryUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TInventoryBCB, TInventoryB>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryB> loadTInventoryBByInventoryUserIdList(BUser bUser, LoadReferrerOption<TInventoryBCB, TInventoryB> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTInventoryBByInventoryUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TInventoryB> loadTInventoryBByInventoryUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryBCB, TInventoryB> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TInventoryB>)EMPTY_NREF_LGWAY; }
        return doLoadTInventoryBByInventoryUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TInventoryB> doLoadTInventoryBByInventoryUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryBCB, TInventoryB> option) {
        return helpLoadReferrerInternally(bUserList, option, "tInventoryBByInventoryUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryRByInventoryRecordLocOutUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByInventoryRecordLocOutUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TInventoryRCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTInventoryRByInventoryRecordLocOutUserIdList(bUserList, new LoadReferrerOption<TInventoryRCB, TInventoryR>().xinit(refCBLambda));
    }
     ...
     * t_inventory_r by INVENTORY_RECORD_LOC_OUT_USER_ID, named 'TInventoryRByInventoryRecordLocOutUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryRByInventoryRecordLocOutUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTInventoryRByInventoryRecordLocOutUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByInventoryRecordLocOutUserIdList(BUser bUser, ConditionBeanSetupper<TInventoryRCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTInventoryRByInventoryRecordLocOutUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TInventoryRCB, TInventoryR>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByInventoryRecordLocOutUserIdList(BUser bUser, LoadReferrerOption<TInventoryRCB, TInventoryR> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTInventoryRByInventoryRecordLocOutUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByInventoryRecordLocOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryRCB, TInventoryR> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TInventoryR>)EMPTY_NREF_LGWAY; }
        return doLoadTInventoryRByInventoryRecordLocOutUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TInventoryR> doLoadTInventoryRByInventoryRecordLocOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryRCB, TInventoryR> option) {
        return helpLoadReferrerInternally(bUserList, option, "tInventoryRByInventoryRecordLocOutUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryRByStockDiffOutUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByStockDiffOutUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TInventoryRCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTInventoryRByStockDiffOutUserIdList(bUserList, new LoadReferrerOption<TInventoryRCB, TInventoryR>().xinit(refCBLambda));
    }
     ...
     * t_inventory_r by STOCK_DIFF_OUT_USER_ID, named 'TInventoryRByStockDiffOutUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryRByStockDiffOutUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTInventoryRByStockDiffOutUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByStockDiffOutUserIdList(BUser bUser, ConditionBeanSetupper<TInventoryRCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTInventoryRByStockDiffOutUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TInventoryRCB, TInventoryR>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByStockDiffOutUserIdList(BUser bUser, LoadReferrerOption<TInventoryRCB, TInventoryR> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTInventoryRByStockDiffOutUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByStockDiffOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryRCB, TInventoryR> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TInventoryR>)EMPTY_NREF_LGWAY; }
        return doLoadTInventoryRByStockDiffOutUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TInventoryR> doLoadTInventoryRByStockDiffOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryRCB, TInventoryR> option) {
        return helpLoadReferrerInternally(bUserList, option, "tInventoryRByStockDiffOutUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryRByTwlOutUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByTwlOutUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TInventoryRCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTInventoryRByTwlOutUserIdList(bUserList, new LoadReferrerOption<TInventoryRCB, TInventoryR>().xinit(refCBLambda));
    }
     ...
     * t_inventory_r by TWL_OUT_USER_ID, named 'TInventoryRByTwlOutUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryRByTwlOutUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTInventoryRByTwlOutUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByTwlOutUserIdList(BUser bUser, ConditionBeanSetupper<TInventoryRCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTInventoryRByTwlOutUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TInventoryRCB, TInventoryR>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByTwlOutUserIdList(BUser bUser, LoadReferrerOption<TInventoryRCB, TInventoryR> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTInventoryRByTwlOutUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByTwlOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryRCB, TInventoryR> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TInventoryR>)EMPTY_NREF_LGWAY; }
        return doLoadTInventoryRByTwlOutUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TInventoryR> doLoadTInventoryRByTwlOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryRCB, TInventoryR> option) {
        return helpLoadReferrerInternally(bUserList, option, "tInventoryRByTwlOutUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryRByInventoryRecordOutUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByInventoryRecordOutUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TInventoryRCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTInventoryRByInventoryRecordOutUserIdList(bUserList, new LoadReferrerOption<TInventoryRCB, TInventoryR>().xinit(refCBLambda));
    }
     ...
     * t_inventory_r by INVENTORY_RECORD_OUT_USER_ID, named 'TInventoryRByInventoryRecordOutUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryRByInventoryRecordOutUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTInventoryRByInventoryRecordOutUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByInventoryRecordOutUserIdList(BUser bUser, ConditionBeanSetupper<TInventoryRCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTInventoryRByInventoryRecordOutUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TInventoryRCB, TInventoryR>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByInventoryRecordOutUserIdList(BUser bUser, LoadReferrerOption<TInventoryRCB, TInventoryR> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTInventoryRByInventoryRecordOutUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByInventoryRecordOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryRCB, TInventoryR> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TInventoryR>)EMPTY_NREF_LGWAY; }
        return doLoadTInventoryRByInventoryRecordOutUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TInventoryR> doLoadTInventoryRByInventoryRecordOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryRCB, TInventoryR> option) {
        return helpLoadReferrerInternally(bUserList, option, "tInventoryRByInventoryRecordOutUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryRByInventoryDiffOutUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByInventoryDiffOutUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TInventoryRCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTInventoryRByInventoryDiffOutUserIdList(bUserList, new LoadReferrerOption<TInventoryRCB, TInventoryR>().xinit(refCBLambda));
    }
     ...
     * t_inventory_r by INVENTORY_DIFF_OUT_USER_ID, named 'TInventoryRByInventoryDiffOutUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTInventoryRByInventoryDiffOutUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTInventoryRByInventoryDiffOutUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByInventoryDiffOutUserIdList(BUser bUser, ConditionBeanSetupper<TInventoryRCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTInventoryRByInventoryDiffOutUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TInventoryRCB, TInventoryR>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByInventoryDiffOutUserIdList(BUser bUser, LoadReferrerOption<TInventoryRCB, TInventoryR> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTInventoryRByInventoryDiffOutUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TInventoryR> loadTInventoryRByInventoryDiffOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryRCB, TInventoryR> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TInventoryR>)EMPTY_NREF_LGWAY; }
        return doLoadTInventoryRByInventoryDiffOutUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TInventoryR> doLoadTInventoryRByInventoryDiffOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TInventoryRCB, TInventoryR> option) {
        return helpLoadReferrerInternally(bUserList, option, "tInventoryRByInventoryDiffOutUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTMoveRecordBList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">bCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">bCB</span>.setupSelect...
     *     <span style="color: #553000">bCB</span>.query().set...
     *     <span style="color: #553000">bCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TMoveRecordB> loadTMoveRecordBList(List<BUser> bUserList, ConditionBeanSetupper<TMoveRecordBCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTMoveRecordBList(bUserList, new LoadReferrerOption<TMoveRecordBCB, TMoveRecordB>().xinit(refCBLambda));
    }
     ...
     * t_move_record_b by USER_ID, named 'TMoveRecordBList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTMoveRecordBList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">bCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">bCB</span>.setupSelect...
     *     <span style="color: #553000">bCB</span>.query().set...
     *     <span style="color: #553000">bCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTMoveRecordBList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TMoveRecordB> loadTMoveRecordBList(BUser bUser, ConditionBeanSetupper<TMoveRecordBCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTMoveRecordBList(xnewLRLs(bUser), new LoadReferrerOption<TMoveRecordBCB, TMoveRecordB>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TMoveRecordB> loadTMoveRecordBList(BUser bUser, LoadReferrerOption<TMoveRecordBCB, TMoveRecordB> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTMoveRecordBList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TMoveRecordB> loadTMoveRecordBList(List<BUser> bUserList, LoadReferrerOption<TMoveRecordBCB, TMoveRecordB> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TMoveRecordB>)EMPTY_NREF_LGWAY; }
        return doLoadTMoveRecordBList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TMoveRecordB> doLoadTMoveRecordBList(List<BUser> bUserList, LoadReferrerOption<TMoveRecordBCB, TMoveRecordB> option) {
        return helpLoadReferrerInternally(bUserList, option, "tMoveRecordBList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTNizoroeAlarmLogList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">logCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TNizoroeAlarmLog> loadTNizoroeAlarmLogList(List<BUser> bUserList, ConditionBeanSetupper<TNizoroeAlarmLogCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTNizoroeAlarmLogList(bUserList, new LoadReferrerOption<TNizoroeAlarmLogCB, TNizoroeAlarmLog>().xinit(refCBLambda));
    }
     ...
     * t_nizoroe_alarm_log by OUT_USER_ID, named 'TNizoroeAlarmLogList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTNizoroeAlarmLogList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">logCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">logCB</span>.setupSelect...
     *     <span style="color: #553000">logCB</span>.query().set...
     *     <span style="color: #553000">logCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTNizoroeAlarmLogList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TNizoroeAlarmLog> loadTNizoroeAlarmLogList(BUser bUser, ConditionBeanSetupper<TNizoroeAlarmLogCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTNizoroeAlarmLogList(xnewLRLs(bUser), new LoadReferrerOption<TNizoroeAlarmLogCB, TNizoroeAlarmLog>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TNizoroeAlarmLog> loadTNizoroeAlarmLogList(BUser bUser, LoadReferrerOption<TNizoroeAlarmLogCB, TNizoroeAlarmLog> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTNizoroeAlarmLogList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TNizoroeAlarmLog> loadTNizoroeAlarmLogList(List<BUser> bUserList, LoadReferrerOption<TNizoroeAlarmLogCB, TNizoroeAlarmLog> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TNizoroeAlarmLog>)EMPTY_NREF_LGWAY; }
        return doLoadTNizoroeAlarmLogList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TNizoroeAlarmLog> doLoadTNizoroeAlarmLogList(List<BUser> bUserList, LoadReferrerOption<TNizoroeAlarmLogCB, TNizoroeAlarmLog> option) {
        return helpLoadReferrerInternally(bUserList, option, "tNizoroeAlarmLogList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByBolOutUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByBolOutUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTPickingRByBolOutUserIdList(bUserList, new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * t_picking_r by BOL_OUT_USER_ID, named 'TPickingRByBolOutUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByBolOutUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTPickingRByBolOutUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByBolOutUserIdList(BUser bUser, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTPickingRByBolOutUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByBolOutUserIdList(BUser bUser, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTPickingRByBolOutUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TPickingR> loadTPickingRByBolOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TPickingR>)EMPTY_NREF_LGWAY; }
        return doLoadTPickingRByBolOutUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TPickingR> doLoadTPickingRByBolOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> option) {
        return helpLoadReferrerInternally(bUserList, option, "tPickingRByBolOutUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByTagOutUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByTagOutUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTPickingRByTagOutUserIdList(bUserList, new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * t_picking_r by TAG_OUT_USER_ID, named 'TPickingRByTagOutUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByTagOutUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTPickingRByTagOutUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByTagOutUserIdList(BUser bUser, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTPickingRByTagOutUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByTagOutUserIdList(BUser bUser, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTPickingRByTagOutUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TPickingR> loadTPickingRByTagOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TPickingR>)EMPTY_NREF_LGWAY; }
        return doLoadTPickingRByTagOutUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TPickingR> doLoadTPickingRByTagOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> option) {
        return helpLoadReferrerInternally(bUserList, option, "tPickingRByTagOutUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByDelivOutUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByDelivOutUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTPickingRByDelivOutUserIdList(bUserList, new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * t_picking_r by DELIV_OUT_USER_ID, named 'TPickingRByDelivOutUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByDelivOutUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTPickingRByDelivOutUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByDelivOutUserIdList(BUser bUser, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTPickingRByDelivOutUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByDelivOutUserIdList(BUser bUser, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTPickingRByDelivOutUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TPickingR> loadTPickingRByDelivOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TPickingR>)EMPTY_NREF_LGWAY; }
        return doLoadTPickingRByDelivOutUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TPickingR> doLoadTPickingRByDelivOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> option) {
        return helpLoadReferrerInternally(bUserList, option, "tPickingRByDelivOutUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByIndvSupplyOutUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByIndvSupplyOutUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTPickingRByIndvSupplyOutUserIdList(bUserList, new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * t_picking_r by INDV_SUPPLY_OUT_USER_ID, named 'TPickingRByIndvSupplyOutUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByIndvSupplyOutUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTPickingRByIndvSupplyOutUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByIndvSupplyOutUserIdList(BUser bUser, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTPickingRByIndvSupplyOutUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByIndvSupplyOutUserIdList(BUser bUser, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTPickingRByIndvSupplyOutUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TPickingR> loadTPickingRByIndvSupplyOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TPickingR>)EMPTY_NREF_LGWAY; }
        return doLoadTPickingRByIndvSupplyOutUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TPickingR> doLoadTPickingRByIndvSupplyOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> option) {
        return helpLoadReferrerInternally(bUserList, option, "tPickingRByIndvSupplyOutUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByPlOutUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByPlOutUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTPickingRByPlOutUserIdList(bUserList, new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * t_picking_r by PL_OUT_USER_ID, named 'TPickingRByPlOutUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByPlOutUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTPickingRByPlOutUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByPlOutUserIdList(BUser bUser, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTPickingRByPlOutUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByPlOutUserIdList(BUser bUser, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTPickingRByPlOutUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TPickingR> loadTPickingRByPlOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TPickingR>)EMPTY_NREF_LGWAY; }
        return doLoadTPickingRByPlOutUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TPickingR> doLoadTPickingRByPlOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> option) {
        return helpLoadReferrerInternally(bUserList, option, "tPickingRByPlOutUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByIndvLabelOutUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByIndvLabelOutUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTPickingRByIndvLabelOutUserIdList(bUserList, new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * t_picking_r by INDV_LABEL_OUT_USER_ID, named 'TPickingRByIndvLabelOutUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByIndvLabelOutUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTPickingRByIndvLabelOutUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByIndvLabelOutUserIdList(BUser bUser, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTPickingRByIndvLabelOutUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByIndvLabelOutUserIdList(BUser bUser, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTPickingRByIndvLabelOutUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TPickingR> loadTPickingRByIndvLabelOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TPickingR>)EMPTY_NREF_LGWAY; }
        return doLoadTPickingRByIndvLabelOutUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TPickingR> doLoadTPickingRByIndvLabelOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> option) {
        return helpLoadReferrerInternally(bUserList, option, "tPickingRByIndvLabelOutUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByNizoroeOutUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByNizoroeOutUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTPickingRByNizoroeOutUserIdList(bUserList, new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * t_picking_r by NIZOROE_OUT_USER_ID, named 'TPickingRByNizoroeOutUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByNizoroeOutUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTPickingRByNizoroeOutUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByNizoroeOutUserIdList(BUser bUser, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTPickingRByNizoroeOutUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByNizoroeOutUserIdList(BUser bUser, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTPickingRByNizoroeOutUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TPickingR> loadTPickingRByNizoroeOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TPickingR>)EMPTY_NREF_LGWAY; }
        return doLoadTPickingRByNizoroeOutUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TPickingR> doLoadTPickingRByNizoroeOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> option) {
        return helpLoadReferrerInternally(bUserList, option, "tPickingRByNizoroeOutUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByPllOutUserIdList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByPllOutUserIdList(List<BUser> bUserList, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTPickingRByPllOutUserIdList(bUserList, new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * t_picking_r by PLL_OUT_USER_ID, named 'TPickingRByPllOutUserIdList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTPickingRByPllOutUserIdList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">rCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">rCB</span>.setupSelect...
     *     <span style="color: #553000">rCB</span>.query().set...
     *     <span style="color: #553000">rCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTPickingRByPllOutUserIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByPllOutUserIdList(BUser bUser, ConditionBeanSetupper<TPickingRCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTPickingRByPllOutUserIdList(xnewLRLs(bUser), new LoadReferrerOption<TPickingRCB, TPickingR>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TPickingR> loadTPickingRByPllOutUserIdList(BUser bUser, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTPickingRByPllOutUserIdList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TPickingR> loadTPickingRByPllOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TPickingR>)EMPTY_NREF_LGWAY; }
        return doLoadTPickingRByPllOutUserIdList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TPickingR> doLoadTPickingRByPllOutUserIdList(List<BUser> bUserList, LoadReferrerOption<TPickingRCB, TPickingR> option) {
        return helpLoadReferrerInternally(bUserList, option, "tPickingRByPllOutUserIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTReceiveLabelList</span>(<span style="color: #553000">bUserList</span>, <span style="color: #553000">labelCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TReceiveLabel> loadTReceiveLabelList(List<BUser> bUserList, ConditionBeanSetupper<TReceiveLabelCB> refCBLambda) {
        xassLRArg(bUserList, refCBLambda);
        return doLoadTReceiveLabelList(bUserList, new LoadReferrerOption<TReceiveLabelCB, TReceiveLabel>().xinit(refCBLambda));
    }
     ...
     * t_receive_label by RCV_LBL_OUT_USER_ID, named 'TReceiveLabelList'.
     * <pre>
     * <span style="color: #0000C0">bUserBhv</span>.<span style="color: #CC4747">loadTReceiveLabelList</span>(<span style="color: #553000">bUser</span>, <span style="color: #553000">labelCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">labelCB</span>.setupSelect...
     *     <span style="color: #553000">labelCB</span>.query().set...
     *     <span style="color: #553000">labelCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">bUser</span>.<span style="color: #CC4747">getTReceiveLabelList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TReceiveLabel> loadTReceiveLabelList(BUser bUser, ConditionBeanSetupper<TReceiveLabelCB> refCBLambda) {
        xassLRArg(bUser, refCBLambda);
        return doLoadTReceiveLabelList(xnewLRLs(bUser), new LoadReferrerOption<TReceiveLabelCB, TReceiveLabel>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TReceiveLabel> loadTReceiveLabelList(BUser bUser, LoadReferrerOption<TReceiveLabelCB, TReceiveLabel> loadReferrerOption) {
        xassLRArg(bUser, loadReferrerOption);
        return loadTReceiveLabelList(xnewLRLs(bUser), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TReceiveLabel> loadTReceiveLabelList(List<BUser> bUserList, LoadReferrerOption<TReceiveLabelCB, TReceiveLabel> loadReferrerOption) {
        xassLRArg(bUserList, loadReferrerOption);
        if (bUserList.isEmpty()) { return (NestedReferrerListGateway<TReceiveLabel>)EMPTY_NREF_LGWAY; }
        return doLoadTReceiveLabelList(bUserList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TReceiveLabel> doLoadTReceiveLabelList(List<BUser> bUserList, LoadReferrerOption<TReceiveLabelCB, TReceiveLabel> option) {
        return helpLoadReferrerInternally(bUserList, option, "tReceiveLabelList");
    }
