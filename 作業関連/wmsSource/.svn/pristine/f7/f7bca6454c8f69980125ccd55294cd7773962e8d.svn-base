...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsErTransferReportCQ;

/**
 * The condition-query of er_transfer_report.
 * <p>
 ...
 */
public class ErTransferReportCQ extends BsErTransferReportCQ {
     ...
     */
    public ErTransferReportCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
