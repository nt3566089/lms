...
public abstract class BsTReceivePlanHDtoMapper implements DtoMapper<TReceivePlanH, TReceivePlanHDto>, Serializable {
    ...
    public TReceivePlanHDto mappingToDto(TReceivePlanH entity) {
        ...
        dto.setSapReceiveSlipNo(entity.getSapReceiveSlipNo());
        dto.setSlipTypeId(entity.getSlipTypeId());
        ...
        dto.setConfirmedDeliveryDt(entity.getConfirmedDeliveryDt());
    ...
    public TReceivePlanH mappingToEntity(TReceivePlanHDto dto) {
        ...
        if (needsMapping(dto, dto.getSapReceiveSlipNo(), "sapReceiveSlipNo")) {
            entity.setSapReceiveSlipNo(dto.getSapReceiveSlipNo());
        }
        if (needsMapping(dto, dto.getSlipTypeId(), "slipTypeId")) {
            entity.setSlipTypeId(dto.getSlipTypeId());
        }
        if (needsMapping(dto, dto.getSlipTypeCd(), "slipTypeCd")) {
            entity.setSlipTypeCd(dto.getSlipTypeCd());
        }
        if (needsMapping(dto, dto.getPurchaseOrderNo(), "purchaseOrderNo")) {
        ...
        if (needsMapping(dto, dto.getConfirmedDeliveryDt(), "confirmedDeliveryDt")) {
            entity.setConfirmedDeliveryDt(dto.getConfirmedDeliveryDt());
        }
