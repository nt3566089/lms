...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTNizoroeCQ;

/**
 * The condition-query of t_nizoroe.
 * <p>
 ...
 */
public class TNizoroeCQ extends BsTNizoroeCQ {
     ...
     */
    public TNizoroeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
