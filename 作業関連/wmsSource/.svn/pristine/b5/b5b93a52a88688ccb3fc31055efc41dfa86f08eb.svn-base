...
public class TPicMthdRcmdDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPicMthdRcmdId = cci("PIC_MTHD_RCMD_ID", "PIC_MTHD_RCMD_ID", null, null, Long.class, "picMthdRcmdId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "TPicMthdRcmdCartList,TPicMthdRcmdDataList", null, false);
    ...
    protected final ColumnInfo _columnWorkVolume = cci("WORK_VOLUME", "WORK_VOLUME", null, null, java.math.BigDecimal.class, "workVolume", null, false, false, false, "DECIMAL", 14, 4, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * PIC_MTHD_RCMD_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ReferrerInfo referrerTPicMthdRcmdCartList() {
        ...
        return cri("T_PIC_MTHD_RCMD_CART_FK1", "TPicMthdRcmdCartList", this, TPicMthdRcmdCartDbm.getInstance(), mp, false, "TPicMthdRcmd");
    }
    /**
