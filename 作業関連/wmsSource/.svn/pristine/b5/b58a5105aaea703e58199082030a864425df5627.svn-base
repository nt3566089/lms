...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTShippingPlanHCQ;

/**
 * The condition-query of t_shipping_plan_h.
 * <p>
 ...
 */
public class TShippingPlanHCQ extends BsTShippingPlanHCQ {
     ...
     */
    public TShippingPlanHCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
