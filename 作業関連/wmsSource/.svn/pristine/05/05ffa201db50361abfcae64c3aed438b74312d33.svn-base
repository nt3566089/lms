...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTBldl350kCQ;

/**
 * The condition-query of t_bldl350k.
 * <p>
 ...
 */
public class TBldl350kCQ extends BsTBldl350kCQ {
     ...
     */
    public TBldl350kCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
