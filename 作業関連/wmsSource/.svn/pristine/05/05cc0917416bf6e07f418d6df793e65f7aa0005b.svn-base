...
public abstract class BsTStoreRecordBDtoMapper implements DtoMapper<TStoreRecordB, TStoreRecordBDto>, Serializable {
    ...
    public TStoreRecordBDto mappingToDto(TStoreRecordB entity) {
        ...
        dto.setStoreRecordSendFlg(entity.getStoreRecordSendFlg());
        dto.setTransferSendFlg(entity.getTransferSendFlg());
        dto.setProductStoreStatus(entity.getProductStoreStatus());
        dto.setUserId(entity.getUserId());
        dto.setCmSendFlgStore(entity.getCmSendFlgStore());
        dto.setCmSendFlgTransfer(entity.getCmSendFlgTransfer());
    ...
    public TStoreRecordB mappingToEntity(TStoreRecordBDto dto) {
        ...
        if (needsMapping(dto, dto.getStoreRecordSendFlg(), "storeRecordSendFlg")) {
            entity.setStoreRecordSendFlg(dto.getStoreRecordSendFlg());
        }
        if (needsMapping(dto, dto.getTransferSendFlg(), "transferSendFlg")) {
            entity.setTransferSendFlg(dto.getTransferSendFlg());
        }
        if (needsMapping(dto, dto.getProductStoreStatus(), "productStoreStatus")) {
            entity.setProductStoreStatus(dto.getProductStoreStatus());
        }
        if (needsMapping(dto, dto.getUserId(), "userId")) {
            entity.setUserId(dto.getUserId());
        }
        if (needsMapping(dto, dto.getCmSendFlgStore(), "cmSendFlgStore")) {
            entity.setCmSendFlgStore(dto.getCmSendFlgStore());
        }
        if (needsMapping(dto, dto.getCmSendFlgTransfer(), "cmSendFlgTransfer")) {
            entity.setCmSendFlgTransfer(dto.getCmSendFlgTransfer());
        }
