...
/**
 * The abstract condition-query of w_ht_total_picking.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsWHtTotalPickingCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsWHtTotalPickingCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param htTotalPickingId The value of htTotalPickingId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtTotalPickingId_Equal(Long htTotalPickingId) {
        doSetHtTotalPickingId_Equal(htTotalPickingId);
    }

    protected void doSetHtTotalPickingId_Equal(Long htTotalPickingId) {
        regHtTotalPickingId(CK_EQ, htTotalPickingId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_TOTAL_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htTotalPickingId The value of htTotalPickingId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtTotalPickingId_NotEqual(Long htTotalPickingId) {
        doSetHtTotalPickingId_NotEqual(htTotalPickingId);
    }

    protected void doSetHtTotalPickingId_NotEqual(Long htTotalPickingId) {
        regHtTotalPickingId(CK_NES, htTotalPickingId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_TOTAL_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htTotalPickingId The value of htTotalPickingId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtTotalPickingId_GreaterThan(Long htTotalPickingId) {
        regHtTotalPickingId(CK_GT, htTotalPickingId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_TOTAL_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htTotalPickingId The value of htTotalPickingId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtTotalPickingId_LessThan(Long htTotalPickingId) {
        regHtTotalPickingId(CK_LT, htTotalPickingId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_TOTAL_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htTotalPickingId The value of htTotalPickingId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtTotalPickingId_GreaterEqual(Long htTotalPickingId) {
        regHtTotalPickingId(CK_GE, htTotalPickingId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_TOTAL_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htTotalPickingId The value of htTotalPickingId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtTotalPickingId_LessEqual(Long htTotalPickingId) {
        regHtTotalPickingId(CK_LE, htTotalPickingId);
    }
     ...
     * HT_TOTAL_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of htTotalPickingId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of htTotalPickingId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setHtTotalPickingId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueHtTotalPickingId(), "HT_TOTAL_PICKING_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * HT_TOTAL_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htTotalPickingIdList The collection of htTotalPickingId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setHtTotalPickingId_InScope(Collection<Long> htTotalPickingIdList) {
        doSetHtTotalPickingId_InScope(htTotalPickingIdList);
    }

    protected void doSetHtTotalPickingId_InScope(Collection<Long> htTotalPickingIdList) {
        regINS(CK_INS, cTL(htTotalPickingIdList), xgetCValueHtTotalPickingId(), "HT_TOTAL_PICKING_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * HT_TOTAL_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param htTotalPickingIdList The collection of htTotalPickingId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setHtTotalPickingId_NotInScope(Collection<Long> htTotalPickingIdList) {
        doSetHtTotalPickingId_NotInScope(htTotalPickingIdList);
    }

    protected void doSetHtTotalPickingId_NotInScope(Collection<Long> htTotalPickingIdList) {
        regINS(CK_NINS, cTL(htTotalPickingIdList), xgetCValueHtTotalPickingId(), "HT_TOTAL_PICKING_ID");
    }
     ...
     * HT_TOTAL_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setHtTotalPickingId_IsNull() { regHtTotalPickingId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * HT_TOTAL_PICKING_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setHtTotalPickingId_IsNotNull() { regHtTotalPickingId(CK_ISNN, DOBJ); }

    protected void regHtTotalPickingId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueHtTotalPickingId(), "HT_TOTAL_PICKING_ID"); }
    protected abstract ConditionValue xgetCValueHtTotalPickingId();
     ...
     */
    public HpSLCFunction<WHtTotalPickingCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WHtTotalPickingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtTotalPickingCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WHtTotalPickingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtTotalPickingCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WHtTotalPickingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtTotalPickingCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WHtTotalPickingCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtTotalPickingCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WHtTotalPickingCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WHtTotalPickingCB&gt;() {
     *     public void query(WHtTotalPickingCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtTotalPickingCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WHtTotalPickingCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        WHtTotalPickingCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(WHtTotalPickingCQ sq);

    protected WHtTotalPickingCB xcreateScalarConditionCB() {
        WHtTotalPickingCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected WHtTotalPickingCB xcreateScalarConditionPartitionByCB() {
        WHtTotalPickingCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<WHtTotalPickingCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WHtTotalPickingCB cb = new WHtTotalPickingCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "HT_TOTAL_PICKING_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(WHtTotalPickingCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<WHtTotalPickingCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(WHtTotalPickingCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WHtTotalPickingCB cb = new WHtTotalPickingCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "HT_TOTAL_PICKING_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(WHtTotalPickingCQ sq);
     ...
     */
    public void myselfExists(SubQuery<WHtTotalPickingCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        WHtTotalPickingCB cb = new WHtTotalPickingCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(WHtTotalPickingCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected WHtTotalPickingCB newMyCB() {
        return new WHtTotalPickingCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return WHtTotalPickingCQ.class.getName(); }
