...
/**
 * The simple DTO of t_bldl5310 as TABLE. <br>
 * BLDL5310
 * <pre>
 * [primary-key]
 *     BLDL5310_ID
...
public abstract class BsTBldl5310Dto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTBldl5310Dto)) { return false; }
        final BsTBldl5310Dto otherEntity = (BsTBldl5310Dto)other;
        if (!helpComparingValue(getBldl5310Id(), otherEntity.getBldl5310Id())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "t_bldl5310");
        result = xCH(result, getBldl5310Id());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getBldl5310Id());
     ...
     * BLDL5310ID
     * @return The value of the column 'BLDL5310_ID'. (NullAllowed)
     */
     ...
     * BLDL5310ID
     * @param bldl5310Id The value of the column 'BLDL5310_ID'. (NullAllowed)
     */
    public void setBldl5310Id(Long bldl5310Id) {
        __modifiedProperties.add("bldl5310Id");
        this._bldl5310Id = bldl5310Id;
    }
