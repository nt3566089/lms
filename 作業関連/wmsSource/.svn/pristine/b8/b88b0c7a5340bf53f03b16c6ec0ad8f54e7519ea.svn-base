...
public abstract class BsPPrintRequest extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] PRINT_REQUEST_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 印刷情報ID
    ...
    /**
     * [set] PRINT_REQUEST_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 印刷情報ID
    ...
    /**
     * [get] FIRST_PRINT_DT: {DATETIME(19)} <br>
     * 初回印刷日時
    ...
    /**
     * [set] FIRST_PRINT_DT: {DATETIME(19)} <br>
     * 初回印刷日時
    ...
    /**
     * [get] LATEST_PRINT_DT: {DATETIME(19)} <br>
     * 最終印刷日時
    ...
    /**
     * [set] LATEST_PRINT_DT: {DATETIME(19)} <br>
     * 最終印刷日時
    ...
    /**
     * [get] QUEUE_ADD_DT: {IX, DATETIME(19)} <br>
     * キュー登録日時
    ...
    /**
     * [set] QUEUE_ADD_DT: {IX, DATETIME(19)} <br>
     * キュー登録日時
