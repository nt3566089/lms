...
public class MHtMessageDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMessageId = cci("MESSAGE_ID", "MESSAGE_ID", null, null, Long.class, "messageId", null, true, false, true, "BIGINT", 19, 0, null, null, false, null, null, "BMessage", null, null, false);
    ...
    /**
     * MESSAGE_ID: {PK, NotNull, BIGINT(19), FK to b_message}
