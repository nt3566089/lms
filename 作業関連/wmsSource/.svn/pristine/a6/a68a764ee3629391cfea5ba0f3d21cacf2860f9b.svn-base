...
/**
 * The base condition-bean of e_koguchi_delivery.
 * @author DBFlute(AutoGenerator)
 */
public class BsEKoguchiDeliveryCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected EKoguchiDeliveryCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsEKoguchiDeliveryCB() {
     ...
     * @return this. (NotNull)
     */
    public EKoguchiDeliveryCB acceptPK(Long koguchiDeliveryId) {
        assertObjectNotNull("koguchiDeliveryId", koguchiDeliveryId);
        BsEKoguchiDeliveryCB cb = this;
        cb.query().setKoguchiDeliveryId_Equal(koguchiDeliveryId);
        return (EKoguchiDeliveryCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EKoguchiDeliveryCB acceptUniqueOf(String receiveCd, Long receiveRowId) {
     ...
     */
    public EKoguchiDeliveryCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public EKoguchiDeliveryCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected EKoguchiDeliveryCQ doGetConditionQuery() {
    ...
    protected EKoguchiDeliveryCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected EKoguchiDeliveryCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        EKoguchiDeliveryCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected EKoguchiDeliveryCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new EKoguchiDeliveryCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<EKoguchiDeliveryCB> unionCBLambda) {
        final EKoguchiDeliveryCB cb = new EKoguchiDeliveryCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EKoguchiDeliveryCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<EKoguchiDeliveryCB> unionCBLambda) {
        final EKoguchiDeliveryCB cb = new EKoguchiDeliveryCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EKoguchiDeliveryCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<EKoguchiDeliveryCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<EKoguchiDeliveryCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "e_koguchi_delivery"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<EKoguchiDeliveryCB, EKoguchiDeliveryCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<EKoguchiDeliveryCB> sq, EKoguchiDeliveryCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public EKoguchiDeliveryCB dreamCruiseCB() {
        EKoguchiDeliveryCB cb = new EKoguchiDeliveryCB();
        cb.xsetupForDreamCruise((EKoguchiDeliveryCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<EKoguchiDeliveryCB> columnQuery(final SpecifyQuery<EKoguchiDeliveryCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected EKoguchiDeliveryCB xcreateColumnQueryCB() {
        EKoguchiDeliveryCB cb = new EKoguchiDeliveryCB();
        cb.xsetupForColumnQuery((EKoguchiDeliveryCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<EKoguchiDeliveryCB> orCBLambda) {
        xorSQ((EKoguchiDeliveryCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<EKoguchiDeliveryCB> andCBLambda) {
        xorSQAP((EKoguchiDeliveryCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final EKoguchiDeliveryCB cb;
        if (mainCB != null) {
            cb = (EKoguchiDeliveryCB)mainCB;
        } else {
            cb = new EKoguchiDeliveryCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return EKoguchiDeliveryCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return EKoguchiDeliveryCQ.class.getName(); }
