...
public class BSystemDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnSystemId = cci("SYSTEM_ID", "SYSTEM_ID", null, null, Long.class, "systemId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * SYSTEM_ID: {PK, ID, NotNull, BIGINT(19)}
