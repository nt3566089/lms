...
/**
 * The condition-query for in-line of w_ht_total_picking.
 * @author DBFlute(AutoGenerator)
 */
public class WHtTotalPickingCIQ extends AbstractBsWHtTotalPickingCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWHtTotalPickingCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WHtTotalPickingCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWHtTotalPickingCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueHtTotalPickingId() { return _myCQ.xdfgetHtTotalPickingId(); }
    ...
    protected ConditionValue xgetCValueWorkGroupKey() { return _myCQ.xdfgetWorkGroupKey(); }
    protected ConditionValue xgetCValueAnotherPickingFlg() { return _myCQ.xdfgetAnotherPickingFlg(); }
    protected ConditionValue xgetCValueLapNum() { return _myCQ.xdfgetLapNum(); }
    ...
    public String keepScalarCondition(WHtTotalPickingCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(WHtTotalPickingCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(WHtTotalPickingCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(WHtTotalPickingCQ sq)
    ...
    protected String xinCB() { return WHtTotalPickingCB.class.getName(); }
    protected String xinCQ() { return WHtTotalPickingCQ.class.getName(); }
}
