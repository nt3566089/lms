...
public abstract class BsSqlCasePickingNoListDto implements Serializable {
    ...
    /**
     * [get] packing_status_nm: {VARCHAR(400)} <br>
    ...
    /**
     * [set] packing_status_nm: {VARCHAR(400)} <br>
    ...
    /**
     * [get] user_cd: {VARCHAR(60), refers to t_packing_b} <br>
    ...
    /**
     * [set] user_cd: {VARCHAR(60), refers to t_packing_b} <br>
