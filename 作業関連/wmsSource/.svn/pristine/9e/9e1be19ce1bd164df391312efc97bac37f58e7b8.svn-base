...
/**
 * The DTO mapper of e_id_manag as TABLE. <br>
 * 個体管理情報連携送信テーブル
 * <pre>
 * [primary-key]
 *     ID_MANAG_ID
 ...
 */
public abstract class BsEIdManagDtoMapper implements DtoMapper<EIdManag, EIdManagDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEIdManagDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEIdManagDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EIdManagDto mappingToDto(EIdManag entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EIdManagDto dto = new EIdManagDto();
     ...
     * {@inheritDoc}
     */
    public List<EIdManagDto> mappingToDtoList(List<EIdManag> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EIdManagDto> dtoList = new ArrayList<EIdManagDto>();
        for (EIdManag entity : entityList) {
            EIdManagDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EIdManag mappingToEntity(EIdManagDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EIdManag entity = new EIdManag();
     ...
     */
    protected boolean needsMapping(EIdManagDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EIdManag> mappingToEntityList(List<EIdManagDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EIdManag> entityList = new ArrayList<EIdManag>();
        for (EIdManagDto dto : dtoList) {
            EIdManag entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EIdManagDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EIdManagDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EIdManagDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EIdManagDtoMapper reverseReference() {
