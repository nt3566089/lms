 ...
 *
 * [column]
 *     PACKING_H_ID, STW_OUT_FLG, STW_OUT_USER_ID, STW_OUT_DT, TAG_OUT_FLG, TAG_OUT_USER_ID, TAG_OUT_DT, TAG_DL_URL, INSPECTION_OUT_FLG, INSPECTION_OUT_USER_ID, INSPECTION_OUT_DT, CDL_OUT_FLG, CDL_OUT_USER_ID, CDL_OUT_DT, DEL_FLG, VERSION_NO, CONTROL_NO, ADD_DT, ADD_USER, ADD_PROCESS, UPD_DT, UPD_USER, UPD_PROCESS
 *
 * [sequence]
 *     
 *
 ...
 *
 * [foreign table]
 *     t_packing_h, b_user, b_class_dtl(ByStwOutFlg)
 *
 * [referrer table]
 *     
 *
 * [foreign property]
 *     tPackingH, bUserByStwOutUserId, bUserByInspectionOutUserId, bUserByTagOutUserId, bClassDtlByStwOutFlg, bClassDtlByTagOutFlg, bClassDtlByInspectionOutFlg
 *
 * [referrer property]
 *     
 *
 ...
 * String cdlOutFlg = entity.getCdlOutFlg();
 * Long cdlOutUserId = entity.getCdlOutUserId();
 * java.sql.Timestamp cdlOutDt = entity.getCdlOutDt();
 ...
 * entity.setCdlOutFlg(cdlOutFlg);
 * entity.setCdlOutUserId(cdlOutUserId);
 * entity.setCdlOutDt(cdlOutDt);
...
public abstract class BsTPackingR extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    /** CDL_OUT_FLG: {CHAR(1)} */
    protected String _cdlOutFlg;

    /** CDL_OUT_USER_ID: {BIGINT(19)} */
    protected Long _cdlOutUserId;

    /** CDL_OUT_DT: {DATETIME(19)} */
    protected java.sql.Timestamp _cdlOutDt;
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_cdlOutFlg));
        sb.append(dm).append(xfND(_cdlOutUserId));
        sb.append(dm).append(xfND(_cdlOutDt));
    ...
    //                                                                            ========
    /**
     * [get] PACKING_H_ID: {PK, NotNull, BIGINT(19), FK to t_packing_h} <br>
     * 梱包ヘッダID
    ...
    /**
     * [set] PACKING_H_ID: {PK, NotNull, BIGINT(19), FK to t_packing_h} <br>
     * 梱包ヘッダID
    ...
    /**
     * [get] INSPECTION_OUT_DT: {DATETIME(19)} <br>
     * SD検品ラベル出力日時
    ...
    /**
     * [set] INSPECTION_OUT_DT: {DATETIME(19)} <br>
     * SD検品ラベル出力日時
    ...
    /**
     * [get] CDL_OUT_FLG: {CHAR(1)} <br>
     * 運送業者引き渡し票出力フラグ
     * @return The value of the column 'CDL_OUT_FLG'. (NullAllowed even if selected: for no constraint)
     */
    public String getCdlOutFlg() {
        checkSpecifiedProperty("cdlOutFlg");
        return convertEmptyToNull(_cdlOutFlg);
    }

    /**
     * [set] CDL_OUT_FLG: {CHAR(1)} <br>
     * 運送業者引き渡し票出力フラグ
     * @param cdlOutFlg The value of the column 'CDL_OUT_FLG'. (NullAllowed: null update allowed for no constraint)
     */
    public void setCdlOutFlg(String cdlOutFlg) {
        registerModifiedProperty("cdlOutFlg");
        _cdlOutFlg = cdlOutFlg;
    }

    /**
     * [get] CDL_OUT_USER_ID: {BIGINT(19)} <br>
     * 運送業者引き渡し票出力者ID
     * @return The value of the column 'CDL_OUT_USER_ID'. (NullAllowed even if selected: for no constraint)
     */
    public Long getCdlOutUserId() {
        checkSpecifiedProperty("cdlOutUserId");
        return _cdlOutUserId;
    }

    /**
     * [set] CDL_OUT_USER_ID: {BIGINT(19)} <br>
     * 運送業者引き渡し票出力者ID
     * @param cdlOutUserId The value of the column 'CDL_OUT_USER_ID'. (NullAllowed: null update allowed for no constraint)
     */
    public void setCdlOutUserId(Long cdlOutUserId) {
        registerModifiedProperty("cdlOutUserId");
        _cdlOutUserId = cdlOutUserId;
    }

    /**
     * [get] CDL_OUT_DT: {DATETIME(19)} <br>
     * 運送業者引き渡し票出力日時
     * @return The value of the column 'CDL_OUT_DT'. (NullAllowed even if selected: for no constraint)
     */
    public java.sql.Timestamp getCdlOutDt() {
        checkSpecifiedProperty("cdlOutDt");
        return _cdlOutDt;
    }

    /**
     * [set] CDL_OUT_DT: {DATETIME(19)} <br>
     * 運送業者引き渡し票出力日時
     * @param cdlOutDt The value of the column 'CDL_OUT_DT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setCdlOutDt(java.sql.Timestamp cdlOutDt) {
        registerModifiedProperty("cdlOutDt");
        _cdlOutDt = cdlOutDt;
    }
