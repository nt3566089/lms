...
/**
 * The entity of t_bldl5125 as TABLE. <br>
 * BLDL5125
 * <pre>
 * [primary-key]
 *     BLDL5125_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5125Id = entity.getBldl5125Id();
 ...
 * Long koshigayaStore = entity.getKoshigayaStore();
 * Long koshigayaDirect = entity.getKoshigayaDirect();
 ...
 * entity.setBldl5125Id(bldl5125Id);
 ...
 * entity.setKoshigayaStore(koshigayaStore);
 * entity.setKoshigayaDirect(koshigayaDirect);
 ...
 */
public abstract class BsTBldl5125 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5125Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5125) {
            BsTBldl5125 other = (BsTBldl5125)obj;
            if (!xSV(_bldl5125Id, other._bldl5125Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5125Id));
        ...
        sb.append(dm).append(xfND(_koshigayaStore));
        sb.append(dm).append(xfND(_koshigayaDirect));
    ...
    @Override
    public TBldl5125 clone() {
        return (TBldl5125)super.clone();
    }
     ...
     * BLDL5125ID
     * @return The value of the column 'BLDL5125_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5125Id() {
        checkSpecifiedProperty("bldl5125Id");
        return _bldl5125Id;
    }
     ...
     * BLDL5125ID
     * @param bldl5125Id The value of the column 'BLDL5125_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5125Id(Long bldl5125Id) {
        registerModifiedProperty("bldl5125Id");
        _bldl5125Id = bldl5125Id;
    }
     ...
     * 越谷US_店送り
     * @return The value of the column 'KOSHIGAYA_STORE'. (NullAllowed even if selected: for no constraint)
     */
    public Long getKoshigayaStore() {
        checkSpecifiedProperty("koshigayaStore");
     ...
     * 越谷US_店送り
     * @param koshigayaStore The value of the column 'KOSHIGAYA_STORE'. (NullAllowed: null update allowed for no constraint)
     */
    public void setKoshigayaStore(Long koshigayaStore) {
        registerModifiedProperty("koshigayaStore");
        _koshigayaStore = koshigayaStore;
    }

    /**
     * [get] KOSHIGAYA_DIRECT: {BIGINT(19)} <br>
     * 越谷US_直送
     * @return The value of the column 'KOSHIGAYA_DIRECT'. (NullAllowed even if selected: for no constraint)
     */
    public Long getKoshigayaDirect() {
        checkSpecifiedProperty("koshigayaDirect");
     ...
     * 越谷US_直送
     * @param koshigayaDirect The value of the column 'KOSHIGAYA_DIRECT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setKoshigayaDirect(Long koshigayaDirect) {
        registerModifiedProperty("koshigayaDirect");
        _koshigayaDirect = koshigayaDirect;
    }
