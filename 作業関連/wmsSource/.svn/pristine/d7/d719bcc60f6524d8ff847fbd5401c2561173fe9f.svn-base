...
.factory('productMasterEditApi', ['AngularAPIClient', function(AngularAPIClient) {
	return {
		...
		// ミドリ安全 商品マスタ修正 2024.05.19 Jeongmin [S]
		...
		// ミドリ安全 商品マスタ修正 2024.05.19 Jeongmin [E]
...
//	                                ];
	...
	// ミドリ安全 商品マスタ修正 2024.05.21 Jeongmin [S]
	var prodDtManagFlag;
	var ocrDateFormat;
	// ミドリ安全 商品マスタ修正 2024.05.21 Jeongmin [E]
...
//				// [#165][2.1.0-CT-019] 商品荷姿の削除機能を追加 2016.11.02 kawana End
	...
	$scope.initScreenHttp = function() {
		...
		$q.all(
				...
				// ミドリ安全 商品マスタ修正 2024.05.19 Jeongmin [S]
				 ...
				 $scope.deferredGetProdDtManagFlg(),
				 $scope.deferredGetLogiSpecialTypeCd(),
				 $scope.deferredGetRecomendLocationTypeCd(),
	 ...
	 */
//	$scope.lotManageFlgChange = function() {
...
//	};
	...
	$scope.limitDtManagFlgChange = function() {
		...
		if ($scope.productSearch.limitDtManagFlg == "0") {
			...
			directiveControl.editable($scope, 'limitDtManagFlg', false);
	...
	// ミドリ安全 商品マスタ修正 2024.05.19 Jeongmin [S]
	$scope.prodDtManagFlgChange = function() {
		if ($scope.productSearch.prodDtManagFlg == "0") {
			directiveControl.editable($scope, 'prodDtManagFlg', false);
			directiveControl.editable($scope, 'prodDtLimitDaysRcv', false);
			directiveControl.editable($scope, 'prodDtLimitDaysShp', false);
			$scope.productSearch.prodDtLimitDaysRcv = null;
			$scope.productSearch.prodDtLimitDaysShp = null;
		} else {
			directiveControl.editable($scope, 'prodDtLimitDaysRcv', true);
			directiveControl.editable($scope, 'prodDtLimitDaysShp', true);
		}
	};
	// ミドリ安全 商品マスタ修正 2024.05.19 Jeongmin [E]

	// ミドリ安全 商品マスタ修正 2024.05.21 Jeongmin [S] OCR仕様が決まり次第修正
//	$scope.ocrDateFormatChange = function() {
//		if ($scope.productSearch.limitDtManagFlg == "1" || $scope.productSearch.prodDtManagFlg == "1" ) {
//			directiveControl.editable($scope, 'prodDtManagFlg', false);
//			directiveControl.editable($scope, 'prodDtLimitDaysRcv', false);
//			directiveControl.editable($scope, 'prodDtLimitDaysShp', false);
//		} else {
...
//	};
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.ProductMasterEdit.object:ProductMasterEdit#deferredGetDateFormat
	 * @methodOf oneslogiWms.ProductMasterEdit.object:ProductMasterEdit
	 *
	 * @description
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.ProductMasterEdit.object:ProductMasterEdit#deferredGetProdDtManagFlg
	 * @methodOf oneslogiWms.ProductMasterEdit.object:ProductMasterEdit
	 *
	 * @description
	 ...
	 * サーバとの通信を行い、取得結果を画面項目に反映する。
	 */
	$scope.deferredGetProdDtManagFlg = function () {
		var deferred  = $q.defer();

		var request = {};
		request.classCd = "PROD_DT_MANAG_FLG";
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.ProductMasterEdit.object:ProductMasterEdit#deferredGetLogiSpecialTypeCd
	 * @methodOf oneslogiWms.ProductMasterEdit.object:ProductMasterEdit
	 *
	 * @description
	...
	$scope.deferredGetLogiSpecialTypeCd = function () {
		...
		owsCommon.getDataCacheable(api.dropdownList, request).then(function(response){
			$scope.logiSpecialTypeCdList = response.data;
			deferred.resolve();
		});
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.ProductMasterEdit.object:ProductMasterEdit#deferredGetRecomendLocationTypeCd
	 * @methodOf oneslogiWms.ProductMasterEdit.object:ProductMasterEdit
	 *
	 * @description
	 ...
	 * サーバとの通信を行い、取得結果を画面項目に反映する。
	 */
	$scope.deferredGetRecomendLocationTypeCd = function () {
		var deferred  = $q.defer();
		...
		owsCommon.getDataCacheable(api.dropdownList, request).then(function(response){
			$scope.recomendLocationTypeCdList = response.data;
			deferred.resolve();
		});
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.ProductMasterEdit.object:ProductMasterEdit#def
	 * erredGetInsuranceFlg
	 * @methodOf oneslogiWms.ProductMasterEdit.object:ProductMasterEdit
	 *
	 * @description
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.ProductMasterEdit.object:ProductMasterEdit#deferredGetNoOkinawaFlightFlg
	 * @methodOf oneslogiWms.ProductMasterEdit.object:ProductMasterEdit
	 *
	 * @description
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.ProductMasterEdit.object:ProductMasterEdit#deferredGetLogiAttentionTypeCd
	 * @methodOf oneslogiWms.ProductMasterEdit.object:ProductMasterEdit
	 *
	 * @description
	...
	$scope.deferredGetLogiAttentionTypeCd = function () {
		...
		var request = {};
		request.classCd = "LOGI_ATTENTION_TYPE_CD";
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.ProductMasterEdit.object:ProductMasterEdit#deferredGetHeavyItemFlg
	 * @methodOf oneslogiWms.ProductMasterEdit.object:ProductMasterEdit
	 *
	 * @description
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.ProductMasterEdit.object:ProductMasterEdit#deferredGetLargeItemFlg
	 * @methodOf oneslogiWms.ProductMasterEdit.object:ProductMasterEdit
	 *
	 * @description
...
//				limitDtManagFlag = 1;
				...
				$scope.prodDtManagFlgChange();
				//$scope.ocrDateFormatChange();
				// ミドリ安全 商品マスタ修正 2024.05.19 Jeongmin [E]
					...
					if (checkResponse.status.listStatus != null){
						...
						for (var i = 0 ;i <checkResponse.status.listStatus.length;i++){
							...
							if (checkResponse.status.listStatus[i].status.statusCode == 8){
								// ミドリ安全 商品マスタ修正 2024.05.20 Jeongmin [S]
								alertMessage.setErrorMessageByCode("alreadyRegisteredCannotRegisterError");
								// ミドリ安全 商品マスタ修正 2024.05.20 Jeongmin [E]
