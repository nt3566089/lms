...
public class PPrintRequestHistDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPrintRequestHistId = cci("PRINT_REQUEST_HIST_ID", "PRINT_REQUEST_HIST_ID", null, null, Long.class, "printRequestHistId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnProcessInfo = cci("PROCESS_INFO", "PROCESS_INFO", null, null, String.class, "processInfo", null, false, false, false, "LONGTEXT", 2147483647, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnQueueAddDt = cci("QUEUE_ADD_DT", "QUEUE_ADD_DT", null, null, java.sql.Timestamp.class, "queueAddDt", null, false, false, true, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnPrintDt = cci("PRINT_DT", "PRINT_DT", null, null, java.sql.Timestamp.class, "printDt", null, false, false, true, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    ...
    /**
     * PRINT_REQUEST_HIST_ID: {PK, ID, NotNull, BIGINT(19)}
