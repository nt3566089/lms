...
/**
 * The entity of er_inventory_inst_sum as TABLE. <br>
 * 棚卸指示(集約)受信テーブル
 * <pre>
 * [primary-key]
 *     INVENTORY_INST_ID
 ...
 */
public abstract class BsErInventoryInstSum extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsErInventoryInstSum) {
            BsErInventoryInstSum other = (BsErInventoryInstSum)obj;
    ...
    @Override
    public ErInventoryInstSum clone() {
        return (ErInventoryInstSum)super.clone();
    }
