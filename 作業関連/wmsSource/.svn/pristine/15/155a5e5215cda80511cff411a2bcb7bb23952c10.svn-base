...
public abstract class BsTReceivePlanBBhv extends AbstractBehaviorWritable<TReceivePlanB, TReceivePlanBCB> {
     ...
     * @param receivePlanBId : PK, ID, NotNull, BIGINT(19). (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">tReceivePlanBBhv</span>.<span style="color: #CC4747">loadTReceiveLabelList</span>(<span style="color: #553000">tReceivePlanBList</span>, <span style="color: #553000">labelCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerListGateway<TReceiveLabel> loadTReceiveLabelList(List<TReceivePlanB> tReceivePlanBList, ConditionBeanSetupper<TReceiveLabelCB> refCBLambda) {
        xassLRArg(tReceivePlanBList, refCBLambda);
        return doLoadTReceiveLabelList(tReceivePlanBList, new LoadReferrerOption<TReceiveLabelCB, TReceiveLabel>().xinit(refCBLambda));
    }
     ...
     * t_receive_label by RECEIVE_PLAN_B_ID, named 'TReceiveLabelList'.
     * <pre>
     * <span style="color: #0000C0">tReceivePlanBBhv</span>.<span style="color: #CC4747">loadTReceiveLabelList</span>(<span style="color: #553000">tReceivePlanB</span>, <span style="color: #553000">labelCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">labelCB</span>.setupSelect...
     *     <span style="color: #553000">labelCB</span>.query().set...
     *     <span style="color: #553000">labelCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">tReceivePlanB</span>.<span style="color: #CC4747">getTReceiveLabelList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TReceiveLabel> loadTReceiveLabelList(TReceivePlanB tReceivePlanB, ConditionBeanSetupper<TReceiveLabelCB> refCBLambda) {
        xassLRArg(tReceivePlanB, refCBLambda);
        return doLoadTReceiveLabelList(xnewLRLs(tReceivePlanB), new LoadReferrerOption<TReceiveLabelCB, TReceiveLabel>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TReceiveLabel> loadTReceiveLabelList(TReceivePlanB tReceivePlanB, LoadReferrerOption<TReceiveLabelCB, TReceiveLabel> loadReferrerOption) {
        xassLRArg(tReceivePlanB, loadReferrerOption);
        return loadTReceiveLabelList(xnewLRLs(tReceivePlanB), loadReferrerOption);
    }
    ...
    public NestedReferrerListGateway<TReceiveLabel> loadTReceiveLabelList(List<TReceivePlanB> tReceivePlanBList, LoadReferrerOption<TReceiveLabelCB, TReceiveLabel> loadReferrerOption) {
        xassLRArg(tReceivePlanBList, loadReferrerOption);
        if (tReceivePlanBList.isEmpty()) { return (NestedReferrerListGateway<TReceiveLabel>)EMPTY_NREF_LGWAY; }
        return doLoadTReceiveLabelList(tReceivePlanBList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TReceiveLabel> doLoadTReceiveLabelList(List<TReceivePlanB> tReceivePlanBList, LoadReferrerOption<TReceiveLabelCB, TReceiveLabel> option) {
        return helpLoadReferrerInternally(tReceivePlanBList, option, "tReceiveLabelList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tReceivePlanBBhv</span>.<span style="color: #CC4747">loadTReceivePlanDataTransferList</span>(<span style="color: #553000">tReceivePlanBList</span>, <span style="color: #553000">transferCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TReceivePlanDataTransfer> loadTReceivePlanDataTransferList(List<TReceivePlanB> tReceivePlanBList, ConditionBeanSetupper<TReceivePlanDataTransferCB> refCBLambda) {
        xassLRArg(tReceivePlanBList, refCBLambda);
        return doLoadTReceivePlanDataTransferList(tReceivePlanBList, new LoadReferrerOption<TReceivePlanDataTransferCB, TReceivePlanDataTransfer>().xinit(refCBLambda));
    }
     ...
     * t_receive_plan_data_transfer by RECEIVE_PLAN_B_ID, named 'TReceivePlanDataTransferList'.
     * <pre>
     * <span style="color: #0000C0">tReceivePlanBBhv</span>.<span style="color: #CC4747">loadTReceivePlanDataTransferList</span>(<span style="color: #553000">tReceivePlanB</span>, <span style="color: #553000">transferCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">transferCB</span>.setupSelect...
     *     <span style="color: #553000">transferCB</span>.query().set...
     *     <span style="color: #553000">transferCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">tReceivePlanB</span>.<span style="color: #CC4747">getTReceivePlanDataTransferList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TReceivePlanDataTransfer> loadTReceivePlanDataTransferList(TReceivePlanB tReceivePlanB, ConditionBeanSetupper<TReceivePlanDataTransferCB> refCBLambda) {
        xassLRArg(tReceivePlanB, refCBLambda);
        return doLoadTReceivePlanDataTransferList(xnewLRLs(tReceivePlanB), new LoadReferrerOption<TReceivePlanDataTransferCB, TReceivePlanDataTransfer>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<TReceivePlanDataTransfer> loadTReceivePlanDataTransferList(TReceivePlanB tReceivePlanB, LoadReferrerOption<TReceivePlanDataTransferCB, TReceivePlanDataTransfer> loadReferrerOption) {
        xassLRArg(tReceivePlanB, loadReferrerOption);
        return loadTReceivePlanDataTransferList(xnewLRLs(tReceivePlanB), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<TReceivePlanDataTransfer> loadTReceivePlanDataTransferList(List<TReceivePlanB> tReceivePlanBList, LoadReferrerOption<TReceivePlanDataTransferCB, TReceivePlanDataTransfer> loadReferrerOption) {
        xassLRArg(tReceivePlanBList, loadReferrerOption);
        if (tReceivePlanBList.isEmpty()) { return (NestedReferrerListGateway<TReceivePlanDataTransfer>)EMPTY_NREF_LGWAY; }
        return doLoadTReceivePlanDataTransferList(tReceivePlanBList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<TReceivePlanDataTransfer> doLoadTReceivePlanDataTransferList(List<TReceivePlanB> tReceivePlanBList, LoadReferrerOption<TReceivePlanDataTransferCB, TReceivePlanDataTransfer> option) {
        return helpLoadReferrerInternally(tReceivePlanBList, option, "tReceivePlanDataTransferList");
    }
