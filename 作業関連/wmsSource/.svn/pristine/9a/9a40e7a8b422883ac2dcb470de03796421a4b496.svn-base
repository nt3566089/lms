...
public class SqlShippingStatusProgressDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((SqlShippingStatusProgress)et).getShippingCnt(), (et, vl) -> ((SqlShippingStatusProgress)et).setShippingCnt(ctb(vl)), "shippingCnt");
    ...
    protected final ColumnInfo _columnShippingCnt = cci("SHIPPING_CNT", "SHIPPING_CNT", null, null, java.math.BigDecimal.class, "shippingCnt", null, false, false, false, "DECIMAL", 42, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnNum = cci("NUM", "NUM", null, null, java.math.BigDecimal.class, "num", null, false, false, false, "DECIMAL", 58, 4, null, null, false, null, null, null, null, null, false);
