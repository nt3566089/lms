...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTBldl5610CQ;

/**
 * The condition-query of t_bldl5610.
 * <p>
 ...
 */
public class TBldl5610CQ extends BsTBldl5610CQ {
     ...
     */
    public TBldl5610CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
