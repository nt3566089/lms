...
public class BsMStockTypeCQ extends AbstractBsMStockTypeCQ {
    ...
    public Map<String, MLocationReplenishProductCQ> xdfgetStockTypeId_ExistsReferrer_MLocationReplenishProductList() { return xgetSQueMap("stockTypeId_ExistsReferrer_MLocationReplenishProductList"); }
    public String keepStockTypeId_ExistsReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq) { return xkeepSQue("stockTypeId_ExistsReferrer_MLocationReplenishProductList", sq); }
    ...
    public Map<String, MLocationReplenishProductCQ> xdfgetStockTypeId_NotExistsReferrer_MLocationReplenishProductList() { return xgetSQueMap("stockTypeId_NotExistsReferrer_MLocationReplenishProductList"); }
    public String keepStockTypeId_NotExistsReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq) { return xkeepSQue("stockTypeId_NotExistsReferrer_MLocationReplenishProductList", sq); }
    ...
    public Map<String, MLocationReplenishProductCQ> xdfgetStockTypeId_SpecifyDerivedReferrer_MLocationReplenishProductList() { return xgetSQueMap("stockTypeId_SpecifyDerivedReferrer_MLocationReplenishProductList"); }
    public String keepStockTypeId_SpecifyDerivedReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq) { return xkeepSQue("stockTypeId_SpecifyDerivedReferrer_MLocationReplenishProductList", sq); }
    ...
    public Map<String, MLocationReplenishProductCQ> xdfgetStockTypeId_QueryDerivedReferrer_MLocationReplenishProductList() { return xgetSQueMap("stockTypeId_QueryDerivedReferrer_MLocationReplenishProductList"); }
    public String keepStockTypeId_QueryDerivedReferrer_MLocationReplenishProductList(MLocationReplenishProductCQ sq) { return xkeepSQue("stockTypeId_QueryDerivedReferrer_MLocationReplenishProductList", sq); }
    public Map<String, Object> xdfgetStockTypeId_QueryDerivedReferrer_MLocationReplenishProductListParameter() { return xgetSQuePmMap("stockTypeId_QueryDerivedReferrer_MLocationReplenishProductList"); }
    public String keepStockTypeId_QueryDerivedReferrer_MLocationReplenishProductListParameter(Object pm) { return xkeepSQuePm("stockTypeId_QueryDerivedReferrer_MLocationReplenishProductList", pm); }
