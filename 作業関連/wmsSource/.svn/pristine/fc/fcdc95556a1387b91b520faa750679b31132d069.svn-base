...
/**
 * The simple DTO of er_inventory_report_sum as TABLE. <br>
 * 棚卸実績(集約)受信テーブル
 * <pre>
 * [primary-key]
...
public abstract class BsErInventoryReportSumDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsErInventoryReportSumDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsErInventoryReportSumDto)) { return false; }
        final BsErInventoryReportSumDto otherEntity = (BsErInventoryReportSumDto)other;
        if (!helpComparingValue(getInventoryReportSumId(), otherEntity.getInventoryReportSumId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "er_inventory_report_sum");
        result = xCH(result, getInventoryReportSumId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getInventoryReportSumId());
     ...
     * 棚卸実績_集約受信ID
     * @return The value of the column 'INVENTORY_REPORT_SUM_ID'. (NullAllowed)
     */
     ...
     * 棚卸実績_集約受信ID
     * @param inventoryReportSumId The value of the column 'INVENTORY_REPORT_SUM_ID'. (NullAllowed)
     */
    public void setInventoryReportSumId(Long inventoryReportSumId) {
        __modifiedProperties.add("inventoryReportSumId");
        this._inventoryReportSumId = inventoryReportSumId;
    }
