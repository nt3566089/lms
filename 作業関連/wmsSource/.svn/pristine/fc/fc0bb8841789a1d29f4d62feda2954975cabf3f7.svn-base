...
public class BColRoleDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnColRoleId = cci("COL_ROLE_ID", "COL_ROLE_ID", null, null, Long.class, "colRoleId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * COL_ROLE_ID: {PK, ID, NotNull, BIGINT(19)}
