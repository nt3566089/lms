...
public abstract class BsTEcOrderR extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] EC_ORDER_H_ID: {PK, NotNull, BIGINT(19), FK to t_ec_order_h} <br>
     * EC受注ヘッダID
    ...
    /**
     * [set] EC_ORDER_H_ID: {PK, NotNull, BIGINT(19), FK to t_ec_order_h} <br>
     * EC受注ヘッダID
    ...
    /**
     * [get] STATEMENT_OUT_DT: {DATETIME(19)} <br>
     * 納品書出力日時
    ...
    /**
     * [set] STATEMENT_OUT_DT: {DATETIME(19)} <br>
     * 納品書出力日時
