...
/**
 * The abstract condition-query of t_bldl5353.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTBldl5353CQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTBldl5353CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param bldl5353Id The value of bldl5353Id as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5353Id_Equal(Long bldl5353Id) {
        doSetBldl5353Id_Equal(bldl5353Id);
    }

    protected void doSetBldl5353Id_Equal(Long bldl5353Id) {
        regBldl5353Id(CK_EQ, bldl5353Id);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5353_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5353Id The value of bldl5353Id as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5353Id_NotEqual(Long bldl5353Id) {
        doSetBldl5353Id_NotEqual(bldl5353Id);
    }

    protected void doSetBldl5353Id_NotEqual(Long bldl5353Id) {
        regBldl5353Id(CK_NES, bldl5353Id);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5353_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5353Id The value of bldl5353Id as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5353Id_GreaterThan(Long bldl5353Id) {
        regBldl5353Id(CK_GT, bldl5353Id);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5353_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5353Id The value of bldl5353Id as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5353Id_LessThan(Long bldl5353Id) {
        regBldl5353Id(CK_LT, bldl5353Id);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5353_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5353Id The value of bldl5353Id as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5353Id_GreaterEqual(Long bldl5353Id) {
        regBldl5353Id(CK_GE, bldl5353Id);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5353_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5353Id The value of bldl5353Id as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5353Id_LessEqual(Long bldl5353Id) {
        regBldl5353Id(CK_LE, bldl5353Id);
    }
     ...
     * BLDL5353_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of bldl5353Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of bldl5353Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setBldl5353Id_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueBldl5353Id(), "BLDL5353_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5353_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5353IdList The collection of bldl5353Id as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5353Id_InScope(Collection<Long> bldl5353IdList) {
        doSetBldl5353Id_InScope(bldl5353IdList);
    }

    protected void doSetBldl5353Id_InScope(Collection<Long> bldl5353IdList) {
        regINS(CK_INS, cTL(bldl5353IdList), xgetCValueBldl5353Id(), "BLDL5353_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5353_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5353IdList The collection of bldl5353Id as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5353Id_NotInScope(Collection<Long> bldl5353IdList) {
        doSetBldl5353Id_NotInScope(bldl5353IdList);
    }

    protected void doSetBldl5353Id_NotInScope(Collection<Long> bldl5353IdList) {
        regINS(CK_NINS, cTL(bldl5353IdList), xgetCValueBldl5353Id(), "BLDL5353_ID");
    }
     ...
     * BLDL5353_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5353Id_IsNull() { regBldl5353Id(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * BLDL5353_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5353Id_IsNotNull() { regBldl5353Id(CK_ISNN, DOBJ); }

    protected void regBldl5353Id(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueBldl5353Id(), "BLDL5353_ID"); }
    protected abstract ConditionValue xgetCValueBldl5353Id();
     ...
     */
    public HpSLCFunction<TBldl5353CB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TBldl5353CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5353CB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TBldl5353CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5353CB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TBldl5353CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5353CB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TBldl5353CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5353CB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TBldl5353CB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TBldl5353CB&gt;() {
     *     public void query(TBldl5353CB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5353CB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TBldl5353CB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5353CB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TBldl5353CQ sq);

    protected TBldl5353CB xcreateScalarConditionCB() {
        TBldl5353CB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TBldl5353CB xcreateScalarConditionPartitionByCB() {
        TBldl5353CB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TBldl5353CB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5353CB cb = new TBldl5353CB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "BLDL5353_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TBldl5353CQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TBldl5353CB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TBldl5353CB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5353CB cb = new TBldl5353CB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "BLDL5353_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TBldl5353CQ sq);
     ...
     */
    public void myselfExists(SubQuery<TBldl5353CB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TBldl5353CB cb = new TBldl5353CB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TBldl5353CQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TBldl5353CB newMyCB() {
        return new TBldl5353CB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TBldl5353CQ.class.getName(); }
