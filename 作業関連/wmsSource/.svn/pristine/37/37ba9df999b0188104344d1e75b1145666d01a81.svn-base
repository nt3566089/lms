...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTBldl5180CQ;

/**
 * The condition-query of t_bldl5180.
 * <p>
 ...
 */
public class TBldl5180CQ extends BsTBldl5180CQ {
     ...
     */
    public TBldl5180CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
