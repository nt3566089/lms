...
public abstract class BsWHtShippingPickingDto implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(c).append(getMultiPickFlg());
        sb.append(c).append(getMultiMacAddress());
     ...
     * 複数人ピッキングフラグ
     * @return The value of the column 'MULTI_PICK_FLG'. (NullAllowed)
     */
     ...
     * 複数人ピッキングフラグ
     * @param multiPickFlg The value of the column 'MULTI_PICK_FLG'. (NullAllowed)
     */
    public void setMultiPickFlg(String multiPickFlg) {
        __modifiedProperties.add("multiPickFlg");
        this._multiPickFlg = multiPickFlg;
    }

    /**
     * [get] MULTI_MAC_ADDRESS: {VARCHAR(30)} <br>
     * MACアドレス(複数人作業者)
     * @return The value of the column 'MULTI_MAC_ADDRESS'. (NullAllowed)
     */
     ...
     * MACアドレス(複数人作業者)
     * @param multiMacAddress The value of the column 'MULTI_MAC_ADDRESS'. (NullAllowed)
     */
    public void setMultiMacAddress(String multiMacAddress) {
        __modifiedProperties.add("multiMacAddress");
        this._multiMacAddress = multiMacAddress;
    }
