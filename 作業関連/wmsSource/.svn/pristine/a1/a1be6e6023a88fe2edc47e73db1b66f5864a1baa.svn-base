...
/**
 * The base condition-bean of er_distribution.
 * @author DBFlute(AutoGenerator)
 */
public class BsErDistributionCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ErDistributionCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsErDistributionCB() {
     ...
     * @return this. (NotNull)
     */
    public ErDistributionCB acceptPK(Long distributionId) {
        assertObjectNotNull("distributionId", distributionId);
        BsErDistributionCB cb = this;
        cb.query().setDistributionId_Equal(distributionId);
        return (ErDistributionCB)this;
    }
     ...
     * @param distributionId : PK, NotNull, BIGINT(19). (NotNull)
     */
    public void acceptPrimaryKey(Long distributionId) {
        assertObjectNotNull("distributionId", distributionId);
        BsErDistributionCB cb = this;
        cb.query().setDistributionId_Equal(distributionId);
    }
     ...
     * @return this. (NotNull)
     */
    public ErDistributionCB acceptUniqueOf(String receiveCd, Long receiveRowId) {
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_DistributionId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_DistributionId_Desc();
        return this;
    }
     ...
     */
    public ErDistributionCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ErDistributionCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ErDistributionCQ doGetConditionQuery() {
    ...
    protected ErDistributionCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ErDistributionCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ErDistributionCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ErDistributionCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ErDistributionCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ErDistributionCB> unionCBLambda) {
        final ErDistributionCB cb = new ErDistributionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErDistributionCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ErDistributionCB> unionCBLambda) {
        final ErDistributionCB cb = new ErDistributionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErDistributionCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ErDistributionCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ErDistributionCQ> qyCall
         ...
         */
        public SpecifiedColumn columnDistributionId() { return doColumn("DISTRIBUTION_ID"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            columnDistributionId(); // PK
        }
        @Override
        protected String getTableDbName() { return "er_distribution"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<ErDistributionCB, ErDistributionCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ErDistributionCB> sq, ErDistributionCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ErDistributionCB dreamCruiseCB() {
        ErDistributionCB cb = new ErDistributionCB();
        cb.xsetupForDreamCruise((ErDistributionCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ErDistributionCB> columnQuery(final SpecifyQuery<ErDistributionCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ErDistributionCB xcreateColumnQueryCB() {
        ErDistributionCB cb = new ErDistributionCB();
        cb.xsetupForColumnQuery((ErDistributionCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ErDistributionCB> orCBLambda) {
        xorSQ((ErDistributionCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ErDistributionCB> andCBLambda) {
        xorSQAP((ErDistributionCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ErDistributionCB cb;
        if (mainCB != null) {
            cb = (ErDistributionCB)mainCB;
        } else {
            cb = new ErDistributionCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ErDistributionCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ErDistributionCQ.class.getName(); }
