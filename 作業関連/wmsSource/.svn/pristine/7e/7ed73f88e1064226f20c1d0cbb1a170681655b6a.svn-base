...
/**
 * The condition-query for in-line of t_bldl5352.
 * @author DBFlute(AutoGenerator)
 */
public class TBldl5352CIQ extends AbstractBsTBldl5352CQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTBldl5352CQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TBldl5352CIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTBldl5352CQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueBldl5352Id() { return _myCQ.xdfgetBldl5352Id(); }
    ...
    public String keepScalarCondition(TBldl5352CQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TBldl5352CQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TBldl5352CQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TBldl5352CQ sq)
    ...
    protected String xinCB() { return TBldl5352CB.class.getName(); }
    protected String xinCQ() { return TBldl5352CQ.class.getName(); }
}
