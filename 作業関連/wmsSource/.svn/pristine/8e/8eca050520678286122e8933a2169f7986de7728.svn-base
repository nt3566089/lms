...
public class MCommonCarrierDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnCommonCarrierId = cci("COMMON_CARRIER_ID", "COMMON_CARRIER_ID", null, null, Long.class, "commonCarrierId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MCarrierList,MCarrierZipList", null, false);
    ...
    /**
     * COMMON_CARRIER_ID: {PK, ID, NotNull, BIGINT(19)}
