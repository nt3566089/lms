...
public class TPickingHDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((TPickingH)et).getWorkGroupKey(), (et, vl) -> ((TPickingH)et).setWorkGroupKey((String)vl), "workGroupKey");
        ...
        setupEpg(_epgMap, et -> ((TPickingH)et).getIdManagPrintFlg(), (et, vl) -> ((TPickingH)et).setIdManagPrintFlg((String)vl), "idManagPrintFlg");
        setupEpg(_epgMap, et -> ((TPickingH)et).getScmPrintFlg(), (et, vl) -> ((TPickingH)et).setScmPrintFlg((String)vl), "scmPrintFlg");
    ...
    protected final ColumnInfo _columnIdManagPrintFlg = cci("ID_MANAG_PRINT_FLG", "ID_MANAG_PRINT_FLG", null, null, String.class, "idManagPrintFlg", null, false, false, false, "CHAR", 1, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnScmPrintFlg = cci("SCM_PRINT_FLG", "SCM_PRINT_FLG", null, null, String.class, "scmPrintFlg", null, false, false, false, "CHAR", 1, 0, null, null, false, null, null, null, null, null, false);
     ...
     * @return The information object of specified column. (NotNull)
     */
    public ColumnInfo columnIdManagPrintFlg() { return _columnIdManagPrintFlg; }
    /**
     * SCM_PRINT_FLG: {CHAR(1)}
     * @return The information object of specified column. (NotNull)
     */
    public ColumnInfo columnScmPrintFlg() { return _columnScmPrintFlg; }
    /**
    ...
    protected List<ColumnInfo> ccil() {
        ...
        ls.add(columnIdManagPrintFlg());
        ls.add(columnScmPrintFlg());
        ls.add(columnDelFlg());
