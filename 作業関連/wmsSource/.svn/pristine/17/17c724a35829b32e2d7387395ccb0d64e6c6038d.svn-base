...
public abstract class BsTPickingHDtoMapper implements DtoMapper<TPickingH, TPickingHDto>, Serializable {
    ...
    public TPickingHDto mappingToDto(TPickingH entity) {
        ...
        dto.setIdManagPrintFlg(entity.getIdManagPrintFlg());
        dto.setScmPrintFlg(entity.getScmPrintFlg());
    ...
    public TPickingH mappingToEntity(TPickingHDto dto) {
        ...
        if (needsMapping(dto, dto.getIdManagPrintFlg(), "idManagPrintFlg")) {
            entity.setIdManagPrintFlg(dto.getIdManagPrintFlg());
        }
        if (needsMapping(dto, dto.getScmPrintFlg(), "scmPrintFlg")) {
            entity.setScmPrintFlg(dto.getScmPrintFlg());
        }
