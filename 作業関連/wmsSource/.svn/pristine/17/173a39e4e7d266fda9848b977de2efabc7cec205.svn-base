...
public abstract class BsBLogDtl extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] LOG_DTL_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * ログ明細ID
    ...
    /**
     * [set] LOG_DTL_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * ログ明細ID
    ...
    /**
     * [get] PROCESS_INFO: {NotNull, LONGTEXT(2147483647)} <br>
     * 処理情報
    ...
    /**
     * [set] PROCESS_INFO: {NotNull, LONGTEXT(2147483647)} <br>
     * 処理情報
    ...
    /**
     * [get] PROCESS_DT: {NotNull, DATETIME(19)} <br>
     * 処理日時
    ...
    /**
     * [set] PROCESS_DT: {NotNull, DATETIME(19)} <br>
     * 処理日時
    ...
    /**
     * [get] MESSAGE_REPLACE_STRING1: {LONGTEXT(2147483647)} <br>
     * メッセージ差替文字列1
    ...
    /**
     * [set] MESSAGE_REPLACE_STRING1: {LONGTEXT(2147483647)} <br>
     * メッセージ差替文字列1
    ...
    /**
     * [get] MESSAGE_REPLACE_STRING2: {LONGTEXT(2147483647)} <br>
     * メッセージ差替文字列2
    ...
    /**
     * [set] MESSAGE_REPLACE_STRING2: {LONGTEXT(2147483647)} <br>
     * メッセージ差替文字列2
    ...
    /**
     * [get] MESSAGE_REPLACE_STRING3: {LONGTEXT(2147483647)} <br>
     * メッセージ差替文字列3
    ...
    /**
     * [set] MESSAGE_REPLACE_STRING3: {LONGTEXT(2147483647)} <br>
     * メッセージ差替文字列3
    ...
    /**
     * [get] MESSAGE_REPLACE_STRING4: {LONGTEXT(2147483647)} <br>
     * メッセージ差替文字列4
    ...
    /**
     * [set] MESSAGE_REPLACE_STRING4: {LONGTEXT(2147483647)} <br>
     * メッセージ差替文字列4
    ...
    /**
     * [get] MESSAGE_REPLACE_STRING5: {LONGTEXT(2147483647)} <br>
     * メッセージ差替文字列5
    ...
    /**
     * [set] MESSAGE_REPLACE_STRING5: {LONGTEXT(2147483647)} <br>
     * メッセージ差替文字列5
