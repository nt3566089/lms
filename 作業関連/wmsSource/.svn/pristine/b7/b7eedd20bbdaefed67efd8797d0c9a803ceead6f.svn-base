...
/**
 * The DTO mapper of t_bldl5160 as TABLE. <br>
 * BLDL5160
 * <pre>
 * [primary-key]
 *     BLDL5160_ID
 ...
 */
public abstract class BsTBldl5160DtoMapper implements DtoMapper<TBldl5160, TBldl5160Dto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTBldl5160DtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTBldl5160DtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TBldl5160Dto mappingToDto(TBldl5160 entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TBldl5160Dto dto = new TBldl5160Dto();
        dto.setBldl5160Id(entity.getBldl5160Id());
     ...
     * {@inheritDoc}
     */
    public List<TBldl5160Dto> mappingToDtoList(List<TBldl5160> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TBldl5160Dto> dtoList = new ArrayList<TBldl5160Dto>();
        for (TBldl5160 entity : entityList) {
            TBldl5160Dto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TBldl5160 mappingToEntity(TBldl5160Dto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TBldl5160 entity = new TBldl5160();
        if (needsMapping(dto, dto.getBldl5160Id(), "bldl5160Id")) {
            entity.setBldl5160Id(dto.getBldl5160Id());
        }
     ...
     */
    protected boolean needsMapping(TBldl5160Dto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TBldl5160> mappingToEntityList(List<TBldl5160Dto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TBldl5160> entityList = new ArrayList<TBldl5160>();
        for (TBldl5160Dto dto : dtoList) {
            TBldl5160 entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TBldl5160DtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TBldl5160DtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TBldl5160DtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TBldl5160DtoMapper reverseReference() {
