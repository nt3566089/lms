...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTBldl6760CQ;

/**
 * The condition-query of t_bldl6760.
 * <p>
 ...
 */
public class TBldl6760CQ extends BsTBldl6760CQ {
     ...
     */
    public TBldl6760CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
