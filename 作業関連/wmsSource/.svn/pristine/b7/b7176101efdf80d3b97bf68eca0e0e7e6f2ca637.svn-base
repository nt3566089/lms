...
public class SqlDeliveryCourseShippingListDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((SqlDeliveryCourseShippingList)et).getShippingSlipNo(), (et, vl) -> ((SqlDeliveryCourseShippingList)et).setShippingSlipNo(ctb(vl)), "shippingSlipNo");
        setupEpg(_epgMap, et -> ((SqlDeliveryCourseShippingList)et).getNum(), (et, vl) -> ((SqlDeliveryCourseShippingList)et).setNum(ctb(vl)), "num");
        ...
        setupEpg(_epgMap, et -> ((SqlDeliveryCourseShippingList)et).getCountProductCd(), (et, vl) -> ((SqlDeliveryCourseShippingList)et).setCountProductCd(ctb(vl)), "countProductCd");
        ...
        setupEpg(_epgMap, et -> ((SqlDeliveryCourseShippingList)et).getCountShippingPackingNo(), (et, vl) -> ((SqlDeliveryCourseShippingList)et).setCountShippingPackingNo(ctb(vl)), "countShippingPackingNo");
        ...
        setupEpg(_epgMap, et -> ((SqlDeliveryCourseShippingList)et).getPicListStatus1(), (et, vl) -> ((SqlDeliveryCourseShippingList)et).setPicListStatus1(ctb(vl)), "picListStatus1");
        setupEpg(_epgMap, et -> ((SqlDeliveryCourseShippingList)et).getPicListStatus2(), (et, vl) -> ((SqlDeliveryCourseShippingList)et).setPicListStatus2(ctb(vl)), "picListStatus2");
        setupEpg(_epgMap, et -> ((SqlDeliveryCourseShippingList)et).getChkStatus(), (et, vl) -> ((SqlDeliveryCourseShippingList)et).setChkStatus(ctb(vl)), "chkStatus");
        setupEpg(_epgMap, et -> ((SqlDeliveryCourseShippingList)et).getInvoiceCreate(), (et, vl) -> ((SqlDeliveryCourseShippingList)et).setInvoiceCreate(ctb(vl)), "invoiceCreate");
        setupEpg(_epgMap, et -> ((SqlDeliveryCourseShippingList)et).getPackingOut(), (et, vl) -> ((SqlDeliveryCourseShippingList)et).setPackingOut(ctb(vl)), "packingOut");
        setupEpg(_epgMap, et -> ((SqlDeliveryCourseShippingList)et).getLoadingStatus(), (et, vl) -> ((SqlDeliveryCourseShippingList)et).setLoadingStatus(ctb(vl)), "loadingStatus");
        setupEpg(_epgMap, et -> ((SqlDeliveryCourseShippingList)et).getShippingFixed(), (et, vl) -> ((SqlDeliveryCourseShippingList)et).setShippingFixed(ctb(vl)), "shippingFixed");
    }
    ...
    protected final ColumnInfo _columnMaxUpdDt = cci("MAX_UPD_DT", "MAX_UPD_DT", null, null, java.sql.Timestamp.class, "maxUpdDt", null, false, false, false, "DATETIME", 23, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnCountSupplyCustomerCd = cci("COUNT_SUPPLY_CUSTOMER_CD", "COUNT_SUPPLY_CUSTOMER_CD", null, null, Long.class, "countSupplyCustomerCd", null, false, false, false, "BIGINT", 21, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnShippingSlipNo = cci("SHIPPING_SLIP_NO", "SHIPPING_SLIP_NO", null, null, java.math.BigDecimal.class, "shippingSlipNo", null, false, false, false, "DECIMAL", 42, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnNum = cci("NUM", "NUM", null, null, java.math.BigDecimal.class, "num", null, false, false, false, "DECIMAL", 42, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnTsihNum = cci("TSIH_NUM", "TSIH_NUM", null, null, Long.class, "tsihNum", null, false, false, false, "DECIMAL", 42, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnCountProductCd = cci("COUNT_PRODUCT_CD", "COUNT_PRODUCT_CD", null, null, java.math.BigDecimal.class, "countProductCd", null, false, false, false, "DECIMAL", 42, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnInstNum = cci("INST_NUM", "INST_NUM", null, null, java.math.BigDecimal.class, "instNum", null, false, false, false, "DECIMAL", 58, 4, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnAllocNum = cci("ALLOC_NUM", "ALLOC_NUM", null, null, java.math.BigDecimal.class, "allocNum", null, false, false, false, "DECIMAL", 58, 4, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnCountShippingPackingNo = cci("COUNT_SHIPPING_PACKING_NO", "COUNT_SHIPPING_PACKING_NO", null, null, java.math.BigDecimal.class, "countShippingPackingNo", null, false, false, false, "DECIMAL", 42, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnSumGrossWeight = cci("SUM_GROSS_WEIGHT", "SUM_GROSS_WEIGHT", null, null, java.math.BigDecimal.class, "sumGrossWeight", null, false, false, false, "DECIMAL", 58, 4, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnPicListStatus1 = cci("PIC_LIST_STATUS1", "PIC_LIST_STATUS1", null, null, java.math.BigDecimal.class, "picListStatus1", null, false, false, false, "DECIMAL", 28, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnPicListStatus2 = cci("PIC_LIST_STATUS2", "PIC_LIST_STATUS2", null, null, java.math.BigDecimal.class, "picListStatus2", null, false, false, false, "DECIMAL", 28, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnChkStatus = cci("CHK_STATUS", "CHK_STATUS", null, null, java.math.BigDecimal.class, "chkStatus", null, false, false, false, "DECIMAL", 28, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnInvoiceCreate = cci("INVOICE_CREATE", "INVOICE_CREATE", null, null, java.math.BigDecimal.class, "invoiceCreate", null, false, false, false, "DECIMAL", 28, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnPackingOut = cci("PACKING_OUT", "PACKING_OUT", null, null, java.math.BigDecimal.class, "packingOut", null, false, false, false, "DECIMAL", 28, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnLoadingStatus = cci("LOADING_STATUS", "LOADING_STATUS", null, null, java.math.BigDecimal.class, "loadingStatus", null, false, false, false, "DECIMAL", 50, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnShippingFixed = cci("SHIPPING_FIXED", "SHIPPING_FIXED", null, null, java.math.BigDecimal.class, "shippingFixed", null, false, false, false, "DECIMAL", 28, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * COUNT_SUPPLY_CUSTOMER_CD: {BIGINT(21)}
     * @return The information object of specified column. (NotNull)
     */
