...
/**
 * The entity of t_bldl5250 as TABLE. <br>
 * BLDL5250
 * <pre>
 * [primary-key]
 *     BLDL5250_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5250Id = entity.getBldl5250Id();
 ...
 * String transferDt = entity.getTransferDt();
 * String beforeLocCd = entity.getBeforeLocCd();
 * String afterLocCd = entity.getAfterLocCd();
 ...
 * entity.setBldl5250Id(bldl5250Id);
 * entity.setYearmonth(yearmonth);
 * entity.setBaseNm(baseNm);
 * entity.setMonth(month);
 * entity.setTransferTypeCd(transferTypeCd);
 * entity.setTransferDt(transferDt);
 * entity.setBeforeLocCd(beforeLocCd);
 * entity.setAfterLocCd(afterLocCd);
 ...
 */
public abstract class BsTBldl5250 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5250Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5250) {
            BsTBldl5250 other = (BsTBldl5250)obj;
            if (!xSV(_bldl5250Id, other._bldl5250Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5250Id));
        ...
        sb.append(dm).append(xfND(_transferDt));
        sb.append(dm).append(xfND(_beforeLocCd));
        sb.append(dm).append(xfND(_afterLocCd));
    ...
    @Override
    public TBldl5250 clone() {
        return (TBldl5250)super.clone();
    }
     ...
     * BLDL5250ID
     * @return The value of the column 'BLDL5250_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5250Id() {
        checkSpecifiedProperty("bldl5250Id");
        return _bldl5250Id;
    }
     ...
     * BLDL5250ID
     * @param bldl5250Id The value of the column 'BLDL5250_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5250Id(Long bldl5250Id) {
        registerModifiedProperty("bldl5250Id");
        _bldl5250Id = bldl5250Id;
    }
     ...
     * 移動日
     * @return The value of the column 'TRANSFER_DT'. (NullAllowed even if selected: for no constraint)
     */
    public String getTransferDt() {
        checkSpecifiedProperty("transferDt");
        return convertEmptyToNull(_transferDt);
    }

    /**
     * [set] TRANSFER_DT: {VARCHAR(8)} <br>
     * 移動日
     * @param transferDt The value of the column 'TRANSFER_DT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setTransferDt(String transferDt) {
        registerModifiedProperty("transferDt");
        _transferDt = transferDt;
    }

    /**
     * [get] BEFORE_LOC_CD: {VARCHAR(30)} <br>
     * 移動元ロケ
     * @return The value of the column 'BEFORE_LOC_CD'. (NullAllowed even if selected: for no constraint)
     */
    public String getBeforeLocCd() {
        checkSpecifiedProperty("beforeLocCd");
        return convertEmptyToNull(_beforeLocCd);
    }

    /**
     * [set] BEFORE_LOC_CD: {VARCHAR(30)} <br>
     * 移動元ロケ
     * @param beforeLocCd The value of the column 'BEFORE_LOC_CD'. (NullAllowed: null update allowed for no constraint)
     */
    public void setBeforeLocCd(String beforeLocCd) {
        registerModifiedProperty("beforeLocCd");
        _beforeLocCd = beforeLocCd;
    }

    /**
     * [get] AFTER_LOC_CD: {VARCHAR(30)} <br>
     * 移動先ロケ
     * @return The value of the column 'AFTER_LOC_CD'. (NullAllowed even if selected: for no constraint)
     */
    public String getAfterLocCd() {
        checkSpecifiedProperty("afterLocCd");
        return convertEmptyToNull(_afterLocCd);
    }

    /**
     * [set] AFTER_LOC_CD: {VARCHAR(30)} <br>
     * 移動先ロケ
     * @param afterLocCd The value of the column 'AFTER_LOC_CD'. (NullAllowed: null update allowed for no constraint)
     */
    public void setAfterLocCd(String afterLocCd) {
        registerModifiedProperty("afterLocCd");
        _afterLocCd = afterLocCd;
    }
