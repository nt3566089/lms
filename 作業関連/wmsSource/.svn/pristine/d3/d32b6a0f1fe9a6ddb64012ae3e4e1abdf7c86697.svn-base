...
public abstract class BsMCarrierBhv extends AbstractBehaviorWritable<MCarrier, MCarrierCB> {
     ...
     * @param carrierId : PK, ID, NotNull, BIGINT(19). (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">mCarrierBhv</span>.<span style="color: #CC4747">loadMBaseSalesOrgList</span>(<span style="color: #553000">mCarrierList</span>, <span style="color: #553000">orgCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerListGateway<MBaseSalesOrg> loadMBaseSalesOrgList(List<MCarrier> mCarrierList, ConditionBeanSetupper<MBaseSalesOrgCB> refCBLambda) {
        xassLRArg(mCarrierList, refCBLambda);
        return doLoadMBaseSalesOrgList(mCarrierList, new LoadReferrerOption<MBaseSalesOrgCB, MBaseSalesOrg>().xinit(refCBLambda));
    }
     ...
     * m_base_sales_org by CARRIER_ID, named 'MBaseSalesOrgList'.
     * <pre>
     * <span style="color: #0000C0">mCarrierBhv</span>.<span style="color: #CC4747">loadMBaseSalesOrgList</span>(<span style="color: #553000">mCarrier</span>, <span style="color: #553000">orgCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">orgCB</span>.setupSelect...
     *     <span style="color: #553000">orgCB</span>.query().set...
     *     <span style="color: #553000">orgCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mCarrier</span>.<span style="color: #CC4747">getMBaseSalesOrgList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MBaseSalesOrg> loadMBaseSalesOrgList(MCarrier mCarrier, ConditionBeanSetupper<MBaseSalesOrgCB> refCBLambda) {
        xassLRArg(mCarrier, refCBLambda);
        return doLoadMBaseSalesOrgList(xnewLRLs(mCarrier), new LoadReferrerOption<MBaseSalesOrgCB, MBaseSalesOrg>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MBaseSalesOrg> loadMBaseSalesOrgList(MCarrier mCarrier, LoadReferrerOption<MBaseSalesOrgCB, MBaseSalesOrg> loadReferrerOption) {
        xassLRArg(mCarrier, loadReferrerOption);
        return loadMBaseSalesOrgList(xnewLRLs(mCarrier), loadReferrerOption);
    }
    ...
    public NestedReferrerListGateway<MBaseSalesOrg> loadMBaseSalesOrgList(List<MCarrier> mCarrierList, LoadReferrerOption<MBaseSalesOrgCB, MBaseSalesOrg> loadReferrerOption) {
        xassLRArg(mCarrierList, loadReferrerOption);
        if (mCarrierList.isEmpty()) { return (NestedReferrerListGateway<MBaseSalesOrg>)EMPTY_NREF_LGWAY; }
        return doLoadMBaseSalesOrgList(mCarrierList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MBaseSalesOrg> doLoadMBaseSalesOrgList(List<MCarrier> mCarrierList, LoadReferrerOption<MBaseSalesOrgCB, MBaseSalesOrg> option) {
        return helpLoadReferrerInternally(mCarrierList, option, "mBaseSalesOrgList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCarrierBhv</span>.<span style="color: #CC4747">loadMCarrierDecisionByCarrierId2List</span>(<span style="color: #553000">mCarrierList</span>, <span style="color: #553000">decisionCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierId2List(List<MCarrier> mCarrierList, ConditionBeanSetupper<MCarrierDecisionCB> refCBLambda) {
        xassLRArg(mCarrierList, refCBLambda);
        return doLoadMCarrierDecisionByCarrierId2List(mCarrierList, new LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision>().xinit(refCBLambda));
    }
     ...
     * m_carrier_decision by CARRIER_ID2, named 'MCarrierDecisionByCarrierId2List'.
     * <pre>
     * <span style="color: #0000C0">mCarrierBhv</span>.<span style="color: #CC4747">loadMCarrierDecisionByCarrierId2List</span>(<span style="color: #553000">mCarrier</span>, <span style="color: #553000">decisionCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">decisionCB</span>.setupSelect...
     *     <span style="color: #553000">decisionCB</span>.query().set...
     *     <span style="color: #553000">decisionCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mCarrier</span>.<span style="color: #CC4747">getMCarrierDecisionByCarrierId2List()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierId2List(MCarrier mCarrier, ConditionBeanSetupper<MCarrierDecisionCB> refCBLambda) {
        xassLRArg(mCarrier, refCBLambda);
        return doLoadMCarrierDecisionByCarrierId2List(xnewLRLs(mCarrier), new LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierId2List(MCarrier mCarrier, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> loadReferrerOption) {
        xassLRArg(mCarrier, loadReferrerOption);
        return loadMCarrierDecisionByCarrierId2List(xnewLRLs(mCarrier), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierId2List(List<MCarrier> mCarrierList, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> loadReferrerOption) {
        xassLRArg(mCarrierList, loadReferrerOption);
        if (mCarrierList.isEmpty()) { return (NestedReferrerListGateway<MCarrierDecision>)EMPTY_NREF_LGWAY; }
        return doLoadMCarrierDecisionByCarrierId2List(mCarrierList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MCarrierDecision> doLoadMCarrierDecisionByCarrierId2List(List<MCarrier> mCarrierList, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> option) {
        return helpLoadReferrerInternally(mCarrierList, option, "mCarrierDecisionByCarrierId2List");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCarrierBhv</span>.<span style="color: #CC4747">loadMCarrierDecisionByCarrierId1List</span>(<span style="color: #553000">mCarrierList</span>, <span style="color: #553000">decisionCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">decisionCB</span>.setupSelect...
     *     <span style="color: #553000">decisionCB</span>.query().set...
     *     <span style="color: #553000">decisionCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierId1List(List<MCarrier> mCarrierList, ConditionBeanSetupper<MCarrierDecisionCB> refCBLambda) {
        xassLRArg(mCarrierList, refCBLambda);
        return doLoadMCarrierDecisionByCarrierId1List(mCarrierList, new LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision>().xinit(refCBLambda));
    }
     ...
     * m_carrier_decision by CARRIER_ID1, named 'MCarrierDecisionByCarrierId1List'.
     * <pre>
     * <span style="color: #0000C0">mCarrierBhv</span>.<span style="color: #CC4747">loadMCarrierDecisionByCarrierId1List</span>(<span style="color: #553000">mCarrier</span>, <span style="color: #553000">decisionCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">decisionCB</span>.setupSelect...
     *     <span style="color: #553000">decisionCB</span>.query().set...
     *     <span style="color: #553000">decisionCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mCarrier</span>.<span style="color: #CC4747">getMCarrierDecisionByCarrierId1List()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierId1List(MCarrier mCarrier, ConditionBeanSetupper<MCarrierDecisionCB> refCBLambda) {
        xassLRArg(mCarrier, refCBLambda);
        return doLoadMCarrierDecisionByCarrierId1List(xnewLRLs(mCarrier), new LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierId1List(MCarrier mCarrier, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> loadReferrerOption) {
        xassLRArg(mCarrier, loadReferrerOption);
        return loadMCarrierDecisionByCarrierId1List(xnewLRLs(mCarrier), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierId1List(List<MCarrier> mCarrierList, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> loadReferrerOption) {
        xassLRArg(mCarrierList, loadReferrerOption);
        if (mCarrierList.isEmpty()) { return (NestedReferrerListGateway<MCarrierDecision>)EMPTY_NREF_LGWAY; }
        return doLoadMCarrierDecisionByCarrierId1List(mCarrierList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MCarrierDecision> doLoadMCarrierDecisionByCarrierId1List(List<MCarrier> mCarrierList, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> option) {
        return helpLoadReferrerInternally(mCarrierList, option, "mCarrierDecisionByCarrierId1List");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCarrierBhv</span>.<span style="color: #CC4747">loadMCarrierDecisionByCarrierId3List</span>(<span style="color: #553000">mCarrierList</span>, <span style="color: #553000">decisionCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">decisionCB</span>.setupSelect...
     *     <span style="color: #553000">decisionCB</span>.query().set...
     *     <span style="color: #553000">decisionCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierId3List(List<MCarrier> mCarrierList, ConditionBeanSetupper<MCarrierDecisionCB> refCBLambda) {
        xassLRArg(mCarrierList, refCBLambda);
        return doLoadMCarrierDecisionByCarrierId3List(mCarrierList, new LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision>().xinit(refCBLambda));
    }
     ...
     * m_carrier_decision by CARRIER_ID3, named 'MCarrierDecisionByCarrierId3List'.
     * <pre>
     * <span style="color: #0000C0">mCarrierBhv</span>.<span style="color: #CC4747">loadMCarrierDecisionByCarrierId3List</span>(<span style="color: #553000">mCarrier</span>, <span style="color: #553000">decisionCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">decisionCB</span>.setupSelect...
     *     <span style="color: #553000">decisionCB</span>.query().set...
     *     <span style="color: #553000">decisionCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mCarrier</span>.<span style="color: #CC4747">getMCarrierDecisionByCarrierId3List()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierId3List(MCarrier mCarrier, ConditionBeanSetupper<MCarrierDecisionCB> refCBLambda) {
        xassLRArg(mCarrier, refCBLambda);
        return doLoadMCarrierDecisionByCarrierId3List(xnewLRLs(mCarrier), new LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierId3List(MCarrier mCarrier, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> loadReferrerOption) {
        xassLRArg(mCarrier, loadReferrerOption);
        return loadMCarrierDecisionByCarrierId3List(xnewLRLs(mCarrier), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierId3List(List<MCarrier> mCarrierList, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> loadReferrerOption) {
        xassLRArg(mCarrierList, loadReferrerOption);
        if (mCarrierList.isEmpty()) { return (NestedReferrerListGateway<MCarrierDecision>)EMPTY_NREF_LGWAY; }
        return doLoadMCarrierDecisionByCarrierId3List(mCarrierList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MCarrierDecision> doLoadMCarrierDecisionByCarrierId3List(List<MCarrier> mCarrierList, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> option) {
        return helpLoadReferrerInternally(mCarrierList, option, "mCarrierDecisionByCarrierId3List");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCarrierBhv</span>.<span style="color: #CC4747">loadMCarrierDecisionByCarrierIdList</span>(<span style="color: #553000">mCarrierList</span>, <span style="color: #553000">decisionCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">decisionCB</span>.setupSelect...
     *     <span style="color: #553000">decisionCB</span>.query().set...
     *     <span style="color: #553000">decisionCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierIdList(List<MCarrier> mCarrierList, ConditionBeanSetupper<MCarrierDecisionCB> refCBLambda) {
        xassLRArg(mCarrierList, refCBLambda);
        return doLoadMCarrierDecisionByCarrierIdList(mCarrierList, new LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision>().xinit(refCBLambda));
    }
     ...
     * m_carrier_decision by CARRIER_ID, named 'MCarrierDecisionByCarrierIdList'.
     * <pre>
     * <span style="color: #0000C0">mCarrierBhv</span>.<span style="color: #CC4747">loadMCarrierDecisionByCarrierIdList</span>(<span style="color: #553000">mCarrier</span>, <span style="color: #553000">decisionCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">decisionCB</span>.setupSelect...
     *     <span style="color: #553000">decisionCB</span>.query().set...
     *     <span style="color: #553000">decisionCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mCarrier</span>.<span style="color: #CC4747">getMCarrierDecisionByCarrierIdList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierIdList(MCarrier mCarrier, ConditionBeanSetupper<MCarrierDecisionCB> refCBLambda) {
        xassLRArg(mCarrier, refCBLambda);
        return doLoadMCarrierDecisionByCarrierIdList(xnewLRLs(mCarrier), new LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierIdList(MCarrier mCarrier, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> loadReferrerOption) {
        xassLRArg(mCarrier, loadReferrerOption);
        return loadMCarrierDecisionByCarrierIdList(xnewLRLs(mCarrier), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<MCarrierDecision> loadMCarrierDecisionByCarrierIdList(List<MCarrier> mCarrierList, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> loadReferrerOption) {
        xassLRArg(mCarrierList, loadReferrerOption);
        if (mCarrierList.isEmpty()) { return (NestedReferrerListGateway<MCarrierDecision>)EMPTY_NREF_LGWAY; }
        return doLoadMCarrierDecisionByCarrierIdList(mCarrierList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MCarrierDecision> doLoadMCarrierDecisionByCarrierIdList(List<MCarrier> mCarrierList, LoadReferrerOption<MCarrierDecisionCB, MCarrierDecision> option) {
        return helpLoadReferrerInternally(mCarrierList, option, "mCarrierDecisionByCarrierIdList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCarrierBhv</span>.<span style="color: #CC4747">loadMKoguchiDeliveryList</span>(<span style="color: #553000">mCarrierList</span>, <span style="color: #553000">deliveryCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MKoguchiDelivery> loadMKoguchiDeliveryList(List<MCarrier> mCarrierList, ConditionBeanSetupper<MKoguchiDeliveryCB> refCBLambda) {
        xassLRArg(mCarrierList, refCBLambda);
        return doLoadMKoguchiDeliveryList(mCarrierList, new LoadReferrerOption<MKoguchiDeliveryCB, MKoguchiDelivery>().xinit(refCBLambda));
    }
     ...
     * m_koguchi_delivery by CARRIER_ID, named 'MKoguchiDeliveryList'.
     * <pre>
     * <span style="color: #0000C0">mCarrierBhv</span>.<span style="color: #CC4747">loadMKoguchiDeliveryList</span>(<span style="color: #553000">mCarrier</span>, <span style="color: #553000">deliveryCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">deliveryCB</span>.setupSelect...
     *     <span style="color: #553000">deliveryCB</span>.query().set...
     *     <span style="color: #553000">deliveryCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">mCarrier</span>.<span style="color: #CC4747">getMKoguchiDeliveryList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MKoguchiDelivery> loadMKoguchiDeliveryList(MCarrier mCarrier, ConditionBeanSetupper<MKoguchiDeliveryCB> refCBLambda) {
        xassLRArg(mCarrier, refCBLambda);
        return doLoadMKoguchiDeliveryList(xnewLRLs(mCarrier), new LoadReferrerOption<MKoguchiDeliveryCB, MKoguchiDelivery>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<MKoguchiDelivery> loadMKoguchiDeliveryList(MCarrier mCarrier, LoadReferrerOption<MKoguchiDeliveryCB, MKoguchiDelivery> loadReferrerOption) {
        xassLRArg(mCarrier, loadReferrerOption);
        return loadMKoguchiDeliveryList(xnewLRLs(mCarrier), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<MKoguchiDelivery> loadMKoguchiDeliveryList(List<MCarrier> mCarrierList, LoadReferrerOption<MKoguchiDeliveryCB, MKoguchiDelivery> loadReferrerOption) {
        xassLRArg(mCarrierList, loadReferrerOption);
        if (mCarrierList.isEmpty()) { return (NestedReferrerListGateway<MKoguchiDelivery>)EMPTY_NREF_LGWAY; }
        return doLoadMKoguchiDeliveryList(mCarrierList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<MKoguchiDelivery> doLoadMKoguchiDeliveryList(List<MCarrier> mCarrierList, LoadReferrerOption<MKoguchiDeliveryCB, MKoguchiDelivery> option) {
        return helpLoadReferrerInternally(mCarrierList, option, "mKoguchiDeliveryList");
    }
