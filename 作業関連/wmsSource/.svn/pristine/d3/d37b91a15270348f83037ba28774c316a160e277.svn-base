...
/**
 * The DTO mapper of w_ht_total_picking as TABLE. <br>
 * トータルピッキングワーク
 * <pre>
 * [primary-key]
 *     HT_TOTAL_PICKING_ID
 ...
 */
public abstract class BsWHtTotalPickingDtoMapper implements DtoMapper<WHtTotalPicking, WHtTotalPickingDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWHtTotalPickingDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsWHtTotalPickingDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public WHtTotalPickingDto mappingToDto(WHtTotalPicking entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (WHtTotalPickingDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WHtTotalPickingDto dto = new WHtTotalPickingDto();
        dto.setHtTotalPickingId(entity.getHtTotalPickingId());
        ...
        dto.setForceCopleteFlg(entity.getForceCopleteFlg());
        ...
        dto.setSuspendFlg(entity.getSuspendFlg());
        dto.setWorkGroupKey(entity.getWorkGroupKey());
        dto.setAnotherPickingFlg(entity.getAnotherPickingFlg());
        dto.setLapNum(entity.getLapNum());
        ...
        if (!_suppressTLot && entity.getTLot() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getWHtTotalPickingList().add(dto);
                }
            } else {
                ...
                mapper.suppressWHtTotalPickingList();
     ...
     * {@inheritDoc}
     */
    public List<WHtTotalPickingDto> mappingToDtoList(List<WHtTotalPicking> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<WHtTotalPickingDto> dtoList = new ArrayList<WHtTotalPickingDto>();
        for (WHtTotalPicking entity : entityList) {
            WHtTotalPickingDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public WHtTotalPicking mappingToEntity(WHtTotalPickingDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (WHtTotalPicking)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WHtTotalPicking entity = new WHtTotalPicking();
        if (needsMapping(dto, dto.getHtTotalPickingId(), "htTotalPickingId")) {
            entity.setHtTotalPickingId(dto.getHtTotalPickingId());
        }
        ...
        if (needsMapping(dto, dto.getForceCopleteFlg(), "forceCopleteFlg")) {
            entity.setForceCopleteFlg(dto.getForceCopleteFlg());
        }
        ...
        if (needsMapping(dto, dto.getSuspendFlg(), "suspendFlg")) {
            entity.setSuspendFlg(dto.getSuspendFlg());
        }
        if (needsMapping(dto, dto.getWorkGroupKey(), "workGroupKey")) {
            entity.setWorkGroupKey(dto.getWorkGroupKey());
        }
        if (needsMapping(dto, dto.getAnotherPickingFlg(), "anotherPickingFlg")) {
            entity.setAnotherPickingFlg(dto.getAnotherPickingFlg());
        }
        if (needsMapping(dto, dto.getLapNum(), "lapNum")) {
            entity.setLapNum(dto.getLapNum());
        }
        ...
        if (!_suppressTLot && dto.getTLot() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getWHtTotalPickingList().add(entity);
                }
            } else {
                TLotDtoMapper mapper = new TLotDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(WHtTotalPickingDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<WHtTotalPicking> mappingToEntityList(List<WHtTotalPickingDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<WHtTotalPicking> entityList = new ArrayList<WHtTotalPicking>();
        for (WHtTotalPickingDto dto : dtoList) {
            WHtTotalPicking entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public WHtTotalPickingDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (WHtTotalPickingDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public WHtTotalPickingDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public WHtTotalPickingDtoMapper reverseReference() {
