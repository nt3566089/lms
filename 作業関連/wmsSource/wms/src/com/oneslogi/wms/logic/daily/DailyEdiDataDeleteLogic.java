...
public class DailyEdiDataDeleteLogic extends AbstractWmsLogic {
	...
	private void ediDataDelete(Timestamp delDayTimestamp, final String centerCd, final String clientCd) {
...

		{
			...
			//20240508 		// 荷主CD
			//20240508 		eProductCB.query().setClientCd_Equal(clientCd);
			// 更新日
...

		{
			...
			// 荷主CD
			//20240508 		eReceivePlanCB.query().setClientCd_Equal(clientCd);
			// 更新日
...

		{
			...
			// 荷主CD
			//20240508 		eShippingInstCB.query().setClientCd_Equal(clientCd);
			// センタCD
			//20240508 		eShippingInstCB.query().setCenterCd_Equal(centerCd);
