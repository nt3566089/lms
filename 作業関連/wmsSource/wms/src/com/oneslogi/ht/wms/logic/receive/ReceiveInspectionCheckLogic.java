...
public class ReceiveInspectionCheckLogic extends AbstractWmsLogic {
	...
	public void checkOverPlanNum(TReceivePlanB planB) {
		...
		tReceivePlanBCB.specify().columnReceivePlanBId();
		...
		tReceivePlanBCB.lockForUpdate();

		List<TReceivePlanB> lstTReceivePlanB = tReceivePlanBBhv.selectList(tReceivePlanBCB);
		List<Long> pkList = tReceivePlanBBhv.extractReceivePlanBIdList(lstTReceivePlanB);

		tReceivePlanBCB = tReceivePlanBBhv.newMyConditionBean();

		tReceivePlanBCB.setupSelect_TReceivePlanH();
		tReceivePlanBCB.query().setReceivePlanBId_InScope(pkList);
		...
		lstTReceivePlanB = tReceivePlanBBhv.selectList(tReceivePlanBCB);
