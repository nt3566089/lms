...
/**
 * The DTO mapper of es_product_price as TABLE. <br>
 * 商品マスタ(移動平均単価)送信テーブル
 * <pre>
 * [primary-key]
 *     PRODUCT_PRICE_ID
 ...
 */
public abstract class BsEsProductPriceDtoMapper implements DtoMapper<EsProductPrice, EsProductPriceDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsProductPriceDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEsProductPriceDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EsProductPriceDto mappingToDto(EsProductPrice entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsProductPriceDto dto = new EsProductPriceDto();
     ...
     * {@inheritDoc}
     */
    public List<EsProductPriceDto> mappingToDtoList(List<EsProductPrice> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EsProductPriceDto> dtoList = new ArrayList<EsProductPriceDto>();
        for (EsProductPrice entity : entityList) {
            EsProductPriceDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EsProductPrice mappingToEntity(EsProductPriceDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsProductPrice entity = new EsProductPrice();
     ...
     */
    protected boolean needsMapping(EsProductPriceDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EsProductPrice> mappingToEntityList(List<EsProductPriceDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EsProductPrice> entityList = new ArrayList<EsProductPrice>();
        for (EsProductPriceDto dto : dtoList) {
            EsProductPrice entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EsProductPriceDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EsProductPriceDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EsProductPriceDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EsProductPriceDtoMapper reverseReference() {
