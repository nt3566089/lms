...
/**
 * The DTO mapper of er_stock_record as TABLE. <br>
 * 在庫実績受信テーブル
 * <pre>
 * [primary-key]
 *     STOCK_RECORD_ID
 ...
 */
public abstract class BsErStockRecordDtoMapper implements DtoMapper<ErStockRecord, ErStockRecordDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsErStockRecordDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsErStockRecordDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ErStockRecordDto mappingToDto(ErStockRecord entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErStockRecordDto dto = new ErStockRecordDto();
     ...
     * {@inheritDoc}
     */
    public List<ErStockRecordDto> mappingToDtoList(List<ErStockRecord> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ErStockRecordDto> dtoList = new ArrayList<ErStockRecordDto>();
        for (ErStockRecord entity : entityList) {
            ErStockRecordDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ErStockRecord mappingToEntity(ErStockRecordDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErStockRecord entity = new ErStockRecord();
     ...
     */
    protected boolean needsMapping(ErStockRecordDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ErStockRecord> mappingToEntityList(List<ErStockRecordDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ErStockRecord> entityList = new ArrayList<ErStockRecord>();
        for (ErStockRecordDto dto : dtoList) {
            ErStockRecord entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ErStockRecordDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ErStockRecordDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ErStockRecordDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ErStockRecordDtoMapper reverseReference() {
