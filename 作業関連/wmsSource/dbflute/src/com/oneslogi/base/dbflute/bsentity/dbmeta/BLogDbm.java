...
public class BLogDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnLogId = cci("LOG_ID", "LOG_ID", null, null, Long.class, "logId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "BLogDtlList", null, false);
    ...
    protected final ColumnInfo _columnProcessStartDt = cci("PROCESS_START_DT", "PROCESS_START_DT", null, null, java.sql.Timestamp.class, "processStartDt", null, false, false, true, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnProcessEndDt = cci("PROCESS_END_DT", "PROCESS_END_DT", null, null, java.sql.Timestamp.class, "processEndDt", null, false, false, false, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    ...
    /**
     * LOG_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    /**
     * PROCESS_START_DT: {IX, NotNull, DATETIME(19)}
     * @return The information object of specified column. (NotNull)
     */
    public ColumnInfo columnProcessStartDt() { return _columnProcessStartDt; }
    /**
     * PROCESS_END_DT: {IX, DATETIME(19)}
     * @return The information object of specified column. (NotNull)
     */
