...
/**
 * The condition-query for in-line of er_inventory_record_dtl.
 * @author DBFlute(AutoGenerator)
 */
public class ErInventoryRecordDtlCIQ extends AbstractBsErInventoryRecordDtlCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsErInventoryRecordDtlCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ErInventoryRecordDtlCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsErInventoryRecordDtlCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueInventoryRecordDtlId() { return _myCQ.xdfgetInventoryRecordDtlId(); }
    ...
    public String keepScalarCondition(ErInventoryRecordDtlCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ErInventoryRecordDtlCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ErInventoryRecordDtlCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ErInventoryRecordDtlCQ sq)
    ...
    protected String xinCB() { return ErInventoryRecordDtlCB.class.getName(); }
    protected String xinCQ() { return ErInventoryRecordDtlCQ.class.getName(); }
}
