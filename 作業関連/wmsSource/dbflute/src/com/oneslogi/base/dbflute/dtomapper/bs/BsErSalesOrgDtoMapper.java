...
/**
 * The DTO mapper of er_sales_org as TABLE. <br>
 * 販売組織マスタ受信テーブル
 * <pre>
 * [primary-key]
 *     SALES_ORG_ID
 ...
 */
public abstract class BsErSalesOrgDtoMapper implements DtoMapper<ErSalesOrg, ErSalesOrgDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsErSalesOrgDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsErSalesOrgDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ErSalesOrgDto mappingToDto(ErSalesOrg entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErSalesOrgDto dto = new ErSalesOrgDto();
     ...
     * {@inheritDoc}
     */
    public List<ErSalesOrgDto> mappingToDtoList(List<ErSalesOrg> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ErSalesOrgDto> dtoList = new ArrayList<ErSalesOrgDto>();
        for (ErSalesOrg entity : entityList) {
            ErSalesOrgDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ErSalesOrg mappingToEntity(ErSalesOrgDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErSalesOrg entity = new ErSalesOrg();
     ...
     */
    protected boolean needsMapping(ErSalesOrgDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ErSalesOrg> mappingToEntityList(List<ErSalesOrgDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ErSalesOrg> entityList = new ArrayList<ErSalesOrg>();
        for (ErSalesOrgDto dto : dtoList) {
            ErSalesOrg entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ErSalesOrgDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ErSalesOrgDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ErSalesOrgDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ErSalesOrgDtoMapper reverseReference() {
