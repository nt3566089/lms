 ...
 * String idManagPrintFlg = entity.getIdManagPrintFlg();
 * String scmPrintFlg = entity.getScmPrintFlg();
 ...
 * entity.setIdManagPrintFlg(idManagPrintFlg);
 * entity.setScmPrintFlg(scmPrintFlg);
...
public abstract class BsTPickingH extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_idManagPrintFlg));
        sb.append(dm).append(xfND(_scmPrintFlg));
     ...
     * 個体管理印刷フラグ
     * @return The value of the column 'ID_MANAG_PRINT_FLG'. (NullAllowed even if selected: for no constraint)
     */
    public String getIdManagPrintFlg() {
        checkSpecifiedProperty("idManagPrintFlg");
        return convertEmptyToNull(_idManagPrintFlg);
    }

    /**
     * [set] ID_MANAG_PRINT_FLG: {CHAR(1)} <br>
     * 個体管理印刷フラグ
     * @param idManagPrintFlg The value of the column 'ID_MANAG_PRINT_FLG'. (NullAllowed: null update allowed for no constraint)
     */
    public void setIdManagPrintFlg(String idManagPrintFlg) {
        registerModifiedProperty("idManagPrintFlg");
        _idManagPrintFlg = idManagPrintFlg;
    }

    /**
     * [get] SCM_PRINT_FLG: {CHAR(1)} <br>
     * 梱包明細印刷フラグ
     * @return The value of the column 'SCM_PRINT_FLG'. (NullAllowed even if selected: for no constraint)
     */
    public String getScmPrintFlg() {
        checkSpecifiedProperty("scmPrintFlg");
        return convertEmptyToNull(_scmPrintFlg);
    }

    /**
     * [set] SCM_PRINT_FLG: {CHAR(1)} <br>
     * 梱包明細印刷フラグ
     * @param scmPrintFlg The value of the column 'SCM_PRINT_FLG'. (NullAllowed: null update allowed for no constraint)
     */
    public void setScmPrintFlg(String scmPrintFlg) {
        registerModifiedProperty("scmPrintFlg");
        _scmPrintFlg = scmPrintFlg;
    }
