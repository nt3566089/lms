...
public abstract class AbstractBsWWorkCQ extends AbstractConditionQuery {
     ...
     * WORK_ID: {PK, ID, NotNull, BIGINT(19)}
     ...
     * CLOCK_IN_FLG: {CHAR(1), default=[0]}
     */
    public void setClockInFlg_IsNullOrEmpty() { regClockInFlg(CK_ISNOE, DOBJ); }
     ...
     * CLOCK_OUT_FLG: {CHAR(1), default=[0]}
     */
    public void setClockOutFlg_IsNullOrEmpty() { regClockOutFlg(CK_ISNOE, DOBJ); }
     ...
     * BREAK_START_FLG: {CHAR(1), default=[0]}
     */
    public void setBreakStartFlg_IsNullOrEmpty() { regBreakStartFlg(CK_ISNOE, DOBJ); }
     ...
     * FORCED_CLOCK_OUT_FLG: {CHAR(1), default=[0]}
     */
    public void setForcedClockOutFlg_IsNullOrEmpty() { regForcedClockOutFlg(CK_ISNOE, DOBJ); }
     ...
     * WORK_FLG: {CHAR(1), default=[0]}
     */
    public void setWorkFlg_IsNullOrEmpty() { regWorkFlg(CK_ISNOE, DOBJ); }
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * ERROR_MSG: {LONGTEXT(2147483647)} <br>
