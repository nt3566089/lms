...
public class THtComctlDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnHtComctlId = cci("HT_COMCTL_ID", "HT_COMCTL_ID", null, null, Long.class, "htComctlId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * HT_COMCTL_ID: {PK, ID, NotNull, BIGINT(19)}
