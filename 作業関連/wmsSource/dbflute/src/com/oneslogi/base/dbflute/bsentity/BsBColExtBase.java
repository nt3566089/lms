...
public abstract class BsBColExtBase extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] COL_EXT_BASE_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 列マスタ拡張基本
    ...
    /**
     * [set] COL_EXT_BASE_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 列マスタ拡張基本
    ...
    /**
     * [get] ITEM_ID: {IX, NotNull, BIGINT(19), FK to b_item} <br>
     * 項目ID
    ...
    /**
     * [set] ITEM_ID: {IX, NotNull, BIGINT(19), FK to b_item} <br>
     * 項目ID
