...
/**
 * The abstract condition-query of e_inventory_record_sum.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEInventoryRecordSumCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEInventoryRecordSumCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param inventoryRecordSumId The value of inventoryRecordSumId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryRecordSumId_Equal(Long inventoryRecordSumId) {
        doSetInventoryRecordSumId_Equal(inventoryRecordSumId);
    }

    protected void doSetInventoryRecordSumId_Equal(Long inventoryRecordSumId) {
        regInventoryRecordSumId(CK_EQ, inventoryRecordSumId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_RECORD_SUM_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param inventoryRecordSumId The value of inventoryRecordSumId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryRecordSumId_NotEqual(Long inventoryRecordSumId) {
        doSetInventoryRecordSumId_NotEqual(inventoryRecordSumId);
    }

    protected void doSetInventoryRecordSumId_NotEqual(Long inventoryRecordSumId) {
        regInventoryRecordSumId(CK_NES, inventoryRecordSumId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_RECORD_SUM_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param inventoryRecordSumId The value of inventoryRecordSumId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryRecordSumId_GreaterThan(Long inventoryRecordSumId) {
        regInventoryRecordSumId(CK_GT, inventoryRecordSumId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_RECORD_SUM_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param inventoryRecordSumId The value of inventoryRecordSumId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryRecordSumId_LessThan(Long inventoryRecordSumId) {
        regInventoryRecordSumId(CK_LT, inventoryRecordSumId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_RECORD_SUM_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param inventoryRecordSumId The value of inventoryRecordSumId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryRecordSumId_GreaterEqual(Long inventoryRecordSumId) {
        regInventoryRecordSumId(CK_GE, inventoryRecordSumId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_RECORD_SUM_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param inventoryRecordSumId The value of inventoryRecordSumId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryRecordSumId_LessEqual(Long inventoryRecordSumId) {
        regInventoryRecordSumId(CK_LE, inventoryRecordSumId);
    }
     ...
     * INVENTORY_RECORD_SUM_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of inventoryRecordSumId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of inventoryRecordSumId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setInventoryRecordSumId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueInventoryRecordSumId(), "INVENTORY_RECORD_SUM_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * INVENTORY_RECORD_SUM_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param inventoryRecordSumIdList The collection of inventoryRecordSumId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryRecordSumId_InScope(Collection<Long> inventoryRecordSumIdList) {
        doSetInventoryRecordSumId_InScope(inventoryRecordSumIdList);
    }

    protected void doSetInventoryRecordSumId_InScope(Collection<Long> inventoryRecordSumIdList) {
        regINS(CK_INS, cTL(inventoryRecordSumIdList), xgetCValueInventoryRecordSumId(), "INVENTORY_RECORD_SUM_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * INVENTORY_RECORD_SUM_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param inventoryRecordSumIdList The collection of inventoryRecordSumId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryRecordSumId_NotInScope(Collection<Long> inventoryRecordSumIdList) {
        doSetInventoryRecordSumId_NotInScope(inventoryRecordSumIdList);
    }

    protected void doSetInventoryRecordSumId_NotInScope(Collection<Long> inventoryRecordSumIdList) {
        regINS(CK_NINS, cTL(inventoryRecordSumIdList), xgetCValueInventoryRecordSumId(), "INVENTORY_RECORD_SUM_ID");
    }
     ...
     * INVENTORY_RECORD_SUM_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setInventoryRecordSumId_IsNull() { regInventoryRecordSumId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * INVENTORY_RECORD_SUM_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setInventoryRecordSumId_IsNotNull() { regInventoryRecordSumId(CK_ISNN, DOBJ); }

    protected void regInventoryRecordSumId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueInventoryRecordSumId(), "INVENTORY_RECORD_SUM_ID"); }
    protected abstract ConditionValue xgetCValueInventoryRecordSumId();
     ...
     */
    public HpSLCFunction<EInventoryRecordSumCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EInventoryRecordSumCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EInventoryRecordSumCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EInventoryRecordSumCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EInventoryRecordSumCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EInventoryRecordSumCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EInventoryRecordSumCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EInventoryRecordSumCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EInventoryRecordSumCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EInventoryRecordSumCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EInventoryRecordSumCB&gt;() {
     *     public void query(EInventoryRecordSumCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EInventoryRecordSumCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EInventoryRecordSumCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EInventoryRecordSumCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EInventoryRecordSumCQ sq);

    protected EInventoryRecordSumCB xcreateScalarConditionCB() {
        EInventoryRecordSumCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EInventoryRecordSumCB xcreateScalarConditionPartitionByCB() {
        EInventoryRecordSumCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EInventoryRecordSumCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EInventoryRecordSumCB cb = new EInventoryRecordSumCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "INVENTORY_RECORD_SUM_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EInventoryRecordSumCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EInventoryRecordSumCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EInventoryRecordSumCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EInventoryRecordSumCB cb = new EInventoryRecordSumCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "INVENTORY_RECORD_SUM_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EInventoryRecordSumCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EInventoryRecordSumCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EInventoryRecordSumCB cb = new EInventoryRecordSumCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EInventoryRecordSumCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EInventoryRecordSumCB newMyCB() {
        return new EInventoryRecordSumCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EInventoryRecordSumCQ.class.getName(); }
