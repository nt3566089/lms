...
/**
 * The referrer loader of er_inventory_report_sum as TABLE. <br>
 * <pre>
 * [primary key]
 ...
 */
public class LoaderOfErInventoryReportSum {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<ErInventoryReportSum> _selectedList;
    protected BehaviorSelector _selector;
    protected ErInventoryReportSumBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfErInventoryReportSum ready(List<ErInventoryReportSum> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected ErInventoryReportSumBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(ErInventoryReportSumBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<ErInventoryReportSum> getSelectedList() { return _selectedList; }
