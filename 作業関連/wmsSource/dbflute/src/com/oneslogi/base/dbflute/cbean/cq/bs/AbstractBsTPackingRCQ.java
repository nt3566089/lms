...
public abstract class AbstractBsTPackingRCQ extends AbstractConditionQuery {
     ...
     * PACKING_H_ID: {PK, NotNull, BIGINT(19), FK to t_packing_h}
     ...
     * STW_OUT_FLG: {CHAR(1), FK to B_CLASS_DTL, classification=ListOutFlg}
     */
    public void setStwOutFlg_IsNullOrEmpty() { regStwOutFlg(CK_ISNOE, DOBJ); }
     ...
     * INSPECTION_OUT_FLG: {CHAR(1), default=[0], FK to B_CLASS_DTL, classification=ListOutFlg}
     */
    public void setInspectionOutFlg_IsNullOrEmpty() { regInspectionOutFlg(CK_ISNOE, DOBJ); }
     ...
     * Equal(=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_FLG: {CHAR(1)}
     * @param cdlOutFlg The value of cdlOutFlg as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCdlOutFlg_Equal(String cdlOutFlg) {
        doSetCdlOutFlg_Equal(fRES(cdlOutFlg));
    }

    protected void doSetCdlOutFlg_Equal(String cdlOutFlg) {
        regCdlOutFlg(CK_EQ, cdlOutFlg);
    }

    /**
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_FLG: {CHAR(1)}
     * @param cdlOutFlg The value of cdlOutFlg as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCdlOutFlg_NotEqual(String cdlOutFlg) {
        doSetCdlOutFlg_NotEqual(fRES(cdlOutFlg));
    }

    protected void doSetCdlOutFlg_NotEqual(String cdlOutFlg) {
        regCdlOutFlg(CK_NES, cdlOutFlg);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_FLG: {CHAR(1)}
     * @param cdlOutFlg The value of cdlOutFlg as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCdlOutFlg_GreaterThan(String cdlOutFlg) {
        regCdlOutFlg(CK_GT, fRES(cdlOutFlg));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_FLG: {CHAR(1)}
     * @param cdlOutFlg The value of cdlOutFlg as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCdlOutFlg_LessThan(String cdlOutFlg) {
        regCdlOutFlg(CK_LT, fRES(cdlOutFlg));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_FLG: {CHAR(1)}
     * @param cdlOutFlg The value of cdlOutFlg as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCdlOutFlg_GreaterEqual(String cdlOutFlg) {
        regCdlOutFlg(CK_GE, fRES(cdlOutFlg));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_FLG: {CHAR(1)}
     * @param cdlOutFlg The value of cdlOutFlg as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCdlOutFlg_LessEqual(String cdlOutFlg) {
        regCdlOutFlg(CK_LE, fRES(cdlOutFlg));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * CDL_OUT_FLG: {CHAR(1)}
     * @param cdlOutFlgList The collection of cdlOutFlg as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCdlOutFlg_InScope(Collection<String> cdlOutFlgList) {
        doSetCdlOutFlg_InScope(cdlOutFlgList);
    }

    protected void doSetCdlOutFlg_InScope(Collection<String> cdlOutFlgList) {
        regINS(CK_INS, cTL(cdlOutFlgList), xgetCValueCdlOutFlg(), "CDL_OUT_FLG");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * CDL_OUT_FLG: {CHAR(1)}
     * @param cdlOutFlgList The collection of cdlOutFlg as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCdlOutFlg_NotInScope(Collection<String> cdlOutFlgList) {
        doSetCdlOutFlg_NotInScope(cdlOutFlgList);
    }

    protected void doSetCdlOutFlg_NotInScope(Collection<String> cdlOutFlgList) {
        regINS(CK_NINS, cTL(cdlOutFlgList), xgetCValueCdlOutFlg(), "CDL_OUT_FLG");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * CDL_OUT_FLG: {CHAR(1)} <br>
     * <pre>e.g. setCdlOutFlg_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param cdlOutFlg The value of cdlOutFlg as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setCdlOutFlg_LikeSearch(String cdlOutFlg, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(cdlOutFlg), xgetCValueCdlOutFlg(), "CDL_OUT_FLG", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * CDL_OUT_FLG: {CHAR(1)}
     * @param cdlOutFlg The value of cdlOutFlg as notLikeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setCdlOutFlg_NotLikeSearch(String cdlOutFlg, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(cdlOutFlg), xgetCValueCdlOutFlg(), "CDL_OUT_FLG", likeSearchOption);
    }

    /**
     * PrefixSearch {like 'xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * CDL_OUT_FLG: {CHAR(1)}
     * @param cdlOutFlg The value of cdlOutFlg as prefixSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCdlOutFlg_PrefixSearch(String cdlOutFlg) {
        setCdlOutFlg_LikeSearch(cdlOutFlg, xcLSOPPre());
    }
     ...
     * CDL_OUT_FLG: {CHAR(1)}
     */
    public void setCdlOutFlg_IsNull() { regCdlOutFlg(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * CDL_OUT_FLG: {CHAR(1)}
     */
    public void setCdlOutFlg_IsNullOrEmpty() { regCdlOutFlg(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * CDL_OUT_FLG: {CHAR(1)}
     */
    public void setCdlOutFlg_IsNotNull() { regCdlOutFlg(CK_ISNN, DOBJ); }

    protected void regCdlOutFlg(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueCdlOutFlg(), "CDL_OUT_FLG"); }
    protected abstract ConditionValue xgetCValueCdlOutFlg();

    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_USER_ID: {BIGINT(19)}
     * @param cdlOutUserId The value of cdlOutUserId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setCdlOutUserId_Equal(Long cdlOutUserId) {
        doSetCdlOutUserId_Equal(cdlOutUserId);
    }

    protected void doSetCdlOutUserId_Equal(Long cdlOutUserId) {
        regCdlOutUserId(CK_EQ, cdlOutUserId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_USER_ID: {BIGINT(19)}
     * @param cdlOutUserId The value of cdlOutUserId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCdlOutUserId_NotEqual(Long cdlOutUserId) {
        doSetCdlOutUserId_NotEqual(cdlOutUserId);
    }

    protected void doSetCdlOutUserId_NotEqual(Long cdlOutUserId) {
        regCdlOutUserId(CK_NES, cdlOutUserId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_USER_ID: {BIGINT(19)}
     * @param cdlOutUserId The value of cdlOutUserId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCdlOutUserId_GreaterThan(Long cdlOutUserId) {
        regCdlOutUserId(CK_GT, cdlOutUserId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_USER_ID: {BIGINT(19)}
     * @param cdlOutUserId The value of cdlOutUserId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCdlOutUserId_LessThan(Long cdlOutUserId) {
        regCdlOutUserId(CK_LT, cdlOutUserId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_USER_ID: {BIGINT(19)}
     * @param cdlOutUserId The value of cdlOutUserId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCdlOutUserId_GreaterEqual(Long cdlOutUserId) {
        regCdlOutUserId(CK_GE, cdlOutUserId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_USER_ID: {BIGINT(19)}
     * @param cdlOutUserId The value of cdlOutUserId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCdlOutUserId_LessEqual(Long cdlOutUserId) {
        regCdlOutUserId(CK_LE, cdlOutUserId);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_USER_ID: {BIGINT(19)}
     * @param minNumber The min number of cdlOutUserId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of cdlOutUserId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setCdlOutUserId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueCdlOutUserId(), "CDL_OUT_USER_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * CDL_OUT_USER_ID: {BIGINT(19)}
     * @param cdlOutUserIdList The collection of cdlOutUserId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCdlOutUserId_InScope(Collection<Long> cdlOutUserIdList) {
        doSetCdlOutUserId_InScope(cdlOutUserIdList);
    }

    protected void doSetCdlOutUserId_InScope(Collection<Long> cdlOutUserIdList) {
        regINS(CK_INS, cTL(cdlOutUserIdList), xgetCValueCdlOutUserId(), "CDL_OUT_USER_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * CDL_OUT_USER_ID: {BIGINT(19)}
     * @param cdlOutUserIdList The collection of cdlOutUserId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCdlOutUserId_NotInScope(Collection<Long> cdlOutUserIdList) {
        doSetCdlOutUserId_NotInScope(cdlOutUserIdList);
    }

    protected void doSetCdlOutUserId_NotInScope(Collection<Long> cdlOutUserIdList) {
        regINS(CK_NINS, cTL(cdlOutUserIdList), xgetCValueCdlOutUserId(), "CDL_OUT_USER_ID");
    }
     ...
     * CDL_OUT_USER_ID: {BIGINT(19)}
     */
    public void setCdlOutUserId_IsNull() { regCdlOutUserId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * CDL_OUT_USER_ID: {BIGINT(19)}
     */
    public void setCdlOutUserId_IsNotNull() { regCdlOutUserId(CK_ISNN, DOBJ); }

    protected void regCdlOutUserId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueCdlOutUserId(), "CDL_OUT_USER_ID"); }
    protected abstract ConditionValue xgetCValueCdlOutUserId();

    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_DT: {DATETIME(19)}
     * @param cdlOutDt The value of cdlOutDt as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setCdlOutDt_Equal(java.sql.Timestamp cdlOutDt) {
        regCdlOutDt(CK_EQ,  cdlOutDt);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_DT: {DATETIME(19)}
     * @param cdlOutDt The value of cdlOutDt as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCdlOutDt_GreaterThan(java.sql.Timestamp cdlOutDt) {
        regCdlOutDt(CK_GT,  cdlOutDt);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_DT: {DATETIME(19)}
     * @param cdlOutDt The value of cdlOutDt as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCdlOutDt_LessThan(java.sql.Timestamp cdlOutDt) {
        regCdlOutDt(CK_LT,  cdlOutDt);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_DT: {DATETIME(19)}
     * @param cdlOutDt The value of cdlOutDt as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCdlOutDt_GreaterEqual(java.sql.Timestamp cdlOutDt) {
        regCdlOutDt(CK_GE,  cdlOutDt);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_DT: {DATETIME(19)}
     * @param cdlOutDt The value of cdlOutDt as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCdlOutDt_LessEqual(java.sql.Timestamp cdlOutDt) {
        regCdlOutDt(CK_LE, cdlOutDt);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * CDL_OUT_DT: {DATETIME(19)}
     * <pre>e.g. setCdlOutDt_FromTo(fromDate, toDate, new <span style="color: #CC4747">FromToOption</span>().compareAsDate());</pre>
     * @param fromDatetime The from-datetime(yyyy/MM/dd HH:mm:ss.SSS) of cdlOutDt. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param toDatetime The to-datetime(yyyy/MM/dd HH:mm:ss.SSS) of cdlOutDt. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param fromToOption The option of from-to. (NotNull)
     */
    public void setCdlOutDt_FromTo(Date fromDatetime, Date toDatetime, FromToOption fromToOption) {
        regFTQ((fromDatetime != null ? new java.sql.Timestamp(fromDatetime.getTime()) : null), (toDatetime != null ? new java.sql.Timestamp(toDatetime.getTime()) : null), xgetCValueCdlOutDt(), "CDL_OUT_DT", fromToOption);
    }
     ...
     *  column &gt;= '2007/04/10 00:00:00' and column <span style="color: #CC4747">&lt; '2007/04/17 00:00:00'</span>
     * </pre>
     * @param fromDate The from-date(yyyy/MM/dd) of cdlOutDt. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param toDate The to-date(yyyy/MM/dd) of cdlOutDt. (basically NotNull: if op.allowOneSide(), null allowed)
     */
    public void setCdlOutDt_DateFromTo(Date fromDate, Date toDate) {
        setCdlOutDt_FromTo(fromDate, toDate, xcDFTOP());
    }
     ...
     * CDL_OUT_DT: {DATETIME(19)}
     */
    public void setCdlOutDt_IsNull() { regCdlOutDt(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * CDL_OUT_DT: {DATETIME(19)}
     */
    public void setCdlOutDt_IsNotNull() { regCdlOutDt(CK_ISNN, DOBJ); }

    protected void regCdlOutDt(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueCdlOutDt(), "CDL_OUT_DT"); }
    protected abstract ConditionValue xgetCValueCdlOutDt();
