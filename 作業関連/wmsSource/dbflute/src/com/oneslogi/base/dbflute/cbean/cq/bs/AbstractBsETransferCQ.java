...
/**
 * The abstract condition-query of e_transfer.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsETransferCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsETransferCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<ETransferCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ETransferCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETransferCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ETransferCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETransferCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ETransferCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETransferCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ETransferCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETransferCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ETransferCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ETransferCB&gt;() {
     *     public void query(ETransferCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETransferCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ETransferCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ETransferCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ETransferCQ sq);

    protected ETransferCB xcreateScalarConditionCB() {
        ETransferCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ETransferCB xcreateScalarConditionPartitionByCB() {
        ETransferCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ETransferCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ETransferCB cb = new ETransferCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "TRANSFER_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ETransferCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ETransferCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ETransferCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ETransferCB cb = new ETransferCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "TRANSFER_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ETransferCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ETransferCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ETransferCB cb = new ETransferCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ETransferCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ETransferCB newMyCB() {
        return new ETransferCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ETransferCQ.class.getName(); }
