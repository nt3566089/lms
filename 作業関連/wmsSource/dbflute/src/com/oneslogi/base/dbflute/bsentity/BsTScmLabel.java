...
/**
 * The entity of t_scm_label as TABLE. <br>
 * SCMラベル
 * <pre>
 * [primary-key]
 *     SCM_LABEL_ID
 ...
 * String scmLabelNo = entity.getScmLabelNo();
 ...
 * entity.setScmLabelNo(scmLabelNo);
 * entity.setNum(num);
 ...
 */
public abstract class BsTScmLabel extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTScmLabel) {
            BsTScmLabel other = (BsTScmLabel)obj;
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_scmLabelNo));
    ...
    @Override
    public TScmLabel clone() {
        return (TScmLabel)super.clone();
    }
    ...
    /**
     * [get] SCM_LABEL_NO: {IX, VARCHAR(255)} <br>
     * SCMラベルNo
     * @return The value of the column 'SCM_LABEL_NO'. (NullAllowed even if selected: for no constraint)
     */
    public String getScmLabelNo() {
        checkSpecifiedProperty("scmLabelNo");
        return convertEmptyToNull(_scmLabelNo);
    }

    /**
     * [set] SCM_LABEL_NO: {IX, VARCHAR(255)} <br>
     * SCMラベルNo
     * @param scmLabelNo The value of the column 'SCM_LABEL_NO'. (NullAllowed: null update allowed for no constraint)
     */
    public void setScmLabelNo(String scmLabelNo) {
        registerModifiedProperty("scmLabelNo");
        _scmLabelNo = scmLabelNo;
    }
