...
public class BRoleGrpDtlDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRoleGrpDtlId = cci("ROLE_GRP_DTL_ID", "ROLE_GRP_DTL_ID", null, null, Long.class, "roleGrpDtlId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignBRole() {
        ...
        return cfi("B_ROLE_GRP_DTL_FK2", "BRole", this, BRoleDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "BRoleGrpDtlList", false);
    }
    /**
    ...
    public ForeignInfo foreignBRoleGrp() {
        ...
        return cfi("B_ROLE_GRP_DTL_FK1", "BRoleGrp", this, BRoleGrpDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "BRoleGrpDtlList", false);
    }
