 ...
 *
 * [foreign-table]
 *     p_printer_group, p_printer, p_report_layout, p_printer_attribute, b_class_dtl(BySheetCollate)
 *
 * [referrer-table]
 *     
 *
 * [foreign-property]
 *     pPrinterGroup, pPrinter, pReportLayout, pPrinterAttribute, bClassDtlBySheetCollate
 *
 * [referrer-property]
 *     
 * </pre>
...
public abstract class BsPLayoutPrintSettingDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] LAYOUT_PRINT_SETTING_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * レイアウト別印刷設定ID
    ...
    /**
     * [set] LAYOUT_PRINT_SETTING_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * レイアウト別印刷設定ID
