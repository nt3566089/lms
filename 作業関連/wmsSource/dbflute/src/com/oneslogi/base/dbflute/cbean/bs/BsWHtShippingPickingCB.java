...
public class BsWHtShippingPickingCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<WHtShippingPickingCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnMultiPickFlg() { return doColumn("MULTI_PICK_FLG"); }
        /**
         * MULTI_MAC_ADDRESS: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnMultiMacAddress() { return doColumn("MULTI_MAC_ADDRESS"); }
        /**
