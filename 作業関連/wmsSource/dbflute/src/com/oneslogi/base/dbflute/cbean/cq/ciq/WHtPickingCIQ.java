...
/**
 * The condition-query for in-line of w_ht_picking.
 * @author DBFlute(AutoGenerator)
 */
public class WHtPickingCIQ extends AbstractBsWHtPickingCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWHtPickingCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WHtPickingCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWHtPickingCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueHtPickingId() { return _myCQ.xdfgetHtPickingId(); }
    ...
    public String keepScalarCondition(WHtPickingCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(WHtPickingCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(WHtPickingCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(WHtPickingCQ sq)
    ...
    protected String xinCB() { return WHtPickingCB.class.getName(); }
    protected String xinCQ() { return WHtPickingCQ.class.getName(); }
}
