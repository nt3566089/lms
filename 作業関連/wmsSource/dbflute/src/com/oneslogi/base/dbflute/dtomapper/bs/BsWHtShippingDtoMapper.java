...
public abstract class BsWHtShippingDtoMapper implements DtoMapper<WHtShipping, WHtShippingDto>, Serializable {
    ...
    public WHtShippingDto mappingToDto(WHtShipping entity) {
        ...
        dto.setConsumeDt(entity.getConsumeDt());
        dto.setProdDt(entity.getProdDt());
        dto.setIndvLabelNo(entity.getIndvLabelNo());
        dto.setExpectedShipmentNo(entity.getExpectedShipmentNo());
    ...
    public WHtShipping mappingToEntity(WHtShippingDto dto) {
        ...
        if (needsMapping(dto, dto.getConsumeDt(), "consumeDt")) {
            entity.setConsumeDt(dto.getConsumeDt());
        }
        if (needsMapping(dto, dto.getProdDt(), "prodDt")) {
            entity.setProdDt(dto.getProdDt());
        }
        if (needsMapping(dto, dto.getIndvLabelNo(), "indvLabelNo")) {
            entity.setIndvLabelNo(dto.getIndvLabelNo());
        }
        if (needsMapping(dto, dto.getExpectedShipmentNo(), "expectedShipmentNo")) {
            entity.setExpectedShipmentNo(dto.getExpectedShipmentNo());
        }
