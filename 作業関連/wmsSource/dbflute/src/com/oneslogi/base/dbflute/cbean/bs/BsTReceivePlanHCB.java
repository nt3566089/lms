...
public class BsTReceivePlanHCB extends AbstractConditionBean {
     ...
     * @param receivePlanHId : PK, ID, NotNull, BIGINT(19). (NotNull)
     * @return this. (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<TReceivePlanHCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSapReceiveSlipNo() { return doColumn("SAP_RECEIVE_SLIP_NO"); }
        /**
         * SLIP_TYPE_ID: {BIGINT(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSlipTypeId() { return doColumn("SLIP_TYPE_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPurchaseOrderNo() { return doColumn("PURCHASE_ORDER_NO"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnConfirmedDeliveryDt() { return doColumn("CONFIRMED_DELIVERY_DT"); }
        /**
         * PLANT_CD: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
