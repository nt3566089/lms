...
/**
 * The simple DTO of es_plant_storage_space as TABLE. <br>
 * プラント保管場所マスタ送信テーブル
 * <pre>
 * [primary-key]
...
public abstract class BsEsPlantStorageSpaceDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsPlantStorageSpaceDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEsPlantStorageSpaceDto)) { return false; }
        final BsEsPlantStorageSpaceDto otherEntity = (BsEsPlantStorageSpaceDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "es_plant_storage_space");
