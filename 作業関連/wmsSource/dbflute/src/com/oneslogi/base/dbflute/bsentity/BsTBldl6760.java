...
/**
 * The entity of t_bldl6760 as TABLE. <br>
 * BLDL6760
 * <pre>
 * [primary-key]
 *     BLDL6760_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl6760Id = entity.getBldl6760Id();
 ...
 * entity.setBldl6760Id(bldl6760Id);
 ...
 */
public abstract class BsTBldl6760 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl6760Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl6760) {
            BsTBldl6760 other = (BsTBldl6760)obj;
            if (!xSV(_bldl6760Id, other._bldl6760Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl6760Id));
    ...
    @Override
    public TBldl6760 clone() {
        return (TBldl6760)super.clone();
    }
     ...
     * BLDL6760ID
     * @return The value of the column 'BLDL6760_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl6760Id() {
        checkSpecifiedProperty("bldl6760Id");
        return _bldl6760Id;
    }
     ...
     * BLDL6760ID
     * @param bldl6760Id The value of the column 'BLDL6760_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl6760Id(Long bldl6760Id) {
        registerModifiedProperty("bldl6760Id");
        _bldl6760Id = bldl6760Id;
    }
