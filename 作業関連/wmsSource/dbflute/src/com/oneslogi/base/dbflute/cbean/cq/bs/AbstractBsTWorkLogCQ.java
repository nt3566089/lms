...
public abstract class AbstractBsTWorkLogCQ extends AbstractConditionQuery {
     ...
     * WORK_LOG_OUT_FLG: {IX, CHAR(1), FK to B_CLASS_DTL, classification=WorkLogOutFlg}
     */
    public void setWorkLogOutFlg_IsNullOrEmpty() { regWorkLogOutFlg(CK_ISNOE, DOBJ); }
     ...
     * @param forceCompleteFlg The value of forceCompleteFlg as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setForceCompleteFlg_Equal(String forceCompleteFlg) {
        doSetForceCompleteFlg_Equal(fRES(forceCompleteFlg));
    }

    protected void doSetForceCompleteFlg_Equal(String forceCompleteFlg) {
        regForceCompleteFlg(CK_EQ, forceCompleteFlg);
    }

    /**
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * FORCE_COMPLETE_FLG: {CHAR(1)}
     * @param forceCompleteFlg The value of forceCompleteFlg as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setForceCompleteFlg_NotEqual(String forceCompleteFlg) {
        doSetForceCompleteFlg_NotEqual(fRES(forceCompleteFlg));
    }

    protected void doSetForceCompleteFlg_NotEqual(String forceCompleteFlg) {
        regForceCompleteFlg(CK_NES, forceCompleteFlg);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * FORCE_COMPLETE_FLG: {CHAR(1)}
     * @param forceCompleteFlg The value of forceCompleteFlg as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setForceCompleteFlg_GreaterThan(String forceCompleteFlg) {
        regForceCompleteFlg(CK_GT, fRES(forceCompleteFlg));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * FORCE_COMPLETE_FLG: {CHAR(1)}
     * @param forceCompleteFlg The value of forceCompleteFlg as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setForceCompleteFlg_LessThan(String forceCompleteFlg) {
        regForceCompleteFlg(CK_LT, fRES(forceCompleteFlg));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * FORCE_COMPLETE_FLG: {CHAR(1)}
     * @param forceCompleteFlg The value of forceCompleteFlg as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setForceCompleteFlg_GreaterEqual(String forceCompleteFlg) {
        regForceCompleteFlg(CK_GE, fRES(forceCompleteFlg));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * FORCE_COMPLETE_FLG: {CHAR(1)}
     * @param forceCompleteFlg The value of forceCompleteFlg as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setForceCompleteFlg_LessEqual(String forceCompleteFlg) {
        regForceCompleteFlg(CK_LE, fRES(forceCompleteFlg));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * FORCE_COMPLETE_FLG: {CHAR(1)}
     * @param forceCompleteFlgList The collection of forceCompleteFlg as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setForceCompleteFlg_InScope(Collection<String> forceCompleteFlgList) {
        doSetForceCompleteFlg_InScope(forceCompleteFlgList);
    }

    protected void doSetForceCompleteFlg_InScope(Collection<String> forceCompleteFlgList) {
        regINS(CK_INS, cTL(forceCompleteFlgList), xgetCValueForceCompleteFlg(), "FORCE_COMPLETE_FLG");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * FORCE_COMPLETE_FLG: {CHAR(1)}
     * @param forceCompleteFlgList The collection of forceCompleteFlg as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setForceCompleteFlg_NotInScope(Collection<String> forceCompleteFlgList) {
        doSetForceCompleteFlg_NotInScope(forceCompleteFlgList);
    }

    protected void doSetForceCompleteFlg_NotInScope(Collection<String> forceCompleteFlgList) {
        regINS(CK_NINS, cTL(forceCompleteFlgList), xgetCValueForceCompleteFlg(), "FORCE_COMPLETE_FLG");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * FORCE_COMPLETE_FLG: {CHAR(1)} <br>
     * <pre>e.g. setForceCompleteFlg_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param forceCompleteFlg The value of forceCompleteFlg as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setForceCompleteFlg_LikeSearch(String forceCompleteFlg, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(forceCompleteFlg), xgetCValueForceCompleteFlg(), "FORCE_COMPLETE_FLG", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * FORCE_COMPLETE_FLG: {CHAR(1)}
     * @param forceCompleteFlg The value of forceCompleteFlg as notLikeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setForceCompleteFlg_NotLikeSearch(String forceCompleteFlg, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(forceCompleteFlg), xgetCValueForceCompleteFlg(), "FORCE_COMPLETE_FLG", likeSearchOption);
    }

    /**
     * PrefixSearch {like 'xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * FORCE_COMPLETE_FLG: {CHAR(1)}
     * @param forceCompleteFlg The value of forceCompleteFlg as prefixSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setForceCompleteFlg_PrefixSearch(String forceCompleteFlg) {
        setForceCompleteFlg_LikeSearch(forceCompleteFlg, xcLSOPPre());
    }
     ...
     * FORCE_COMPLETE_FLG: {CHAR(1)}
     */
    public void setForceCompleteFlg_IsNull() { regForceCompleteFlg(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * FORCE_COMPLETE_FLG: {CHAR(1)}
     */
    public void setForceCompleteFlg_IsNullOrEmpty() { regForceCompleteFlg(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * FORCE_COMPLETE_FLG: {CHAR(1)}
     */
    public void setForceCompleteFlg_IsNotNull() { regForceCompleteFlg(CK_ISNN, DOBJ); }

    protected void regForceCompleteFlg(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueForceCompleteFlg(), "FORCE_COMPLETE_FLG"); }
    protected abstract ConditionValue xgetCValueForceCompleteFlg();

    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. <br>
     * WORK_QTY_CS: {DECIMAL(14, 4)}
     * @param workQtyCs The value of workQtyCs as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setWorkQtyCs_Equal(java.math.BigDecimal workQtyCs) {
        doSetWorkQtyCs_Equal(workQtyCs);
    }

    protected void doSetWorkQtyCs_Equal(java.math.BigDecimal workQtyCs) {
        regWorkQtyCs(CK_EQ, workQtyCs);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * WORK_QTY_CS: {DECIMAL(14, 4)}
     * @param workQtyCs The value of workQtyCs as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setWorkQtyCs_NotEqual(java.math.BigDecimal workQtyCs) {
        doSetWorkQtyCs_NotEqual(workQtyCs);
    }

    protected void doSetWorkQtyCs_NotEqual(java.math.BigDecimal workQtyCs) {
        regWorkQtyCs(CK_NES, workQtyCs);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * WORK_QTY_CS: {DECIMAL(14, 4)}
     * @param workQtyCs The value of workQtyCs as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setWorkQtyCs_GreaterThan(java.math.BigDecimal workQtyCs) {
        regWorkQtyCs(CK_GT, workQtyCs);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * WORK_QTY_CS: {DECIMAL(14, 4)}
     * @param workQtyCs The value of workQtyCs as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setWorkQtyCs_LessThan(java.math.BigDecimal workQtyCs) {
        regWorkQtyCs(CK_LT, workQtyCs);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * WORK_QTY_CS: {DECIMAL(14, 4)}
     * @param workQtyCs The value of workQtyCs as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setWorkQtyCs_GreaterEqual(java.math.BigDecimal workQtyCs) {
        regWorkQtyCs(CK_GE, workQtyCs);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * WORK_QTY_CS: {DECIMAL(14, 4)}
     * @param workQtyCs The value of workQtyCs as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setWorkQtyCs_LessEqual(java.math.BigDecimal workQtyCs) {
        regWorkQtyCs(CK_LE, workQtyCs);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * WORK_QTY_CS: {DECIMAL(14, 4)}
     * @param minNumber The min number of workQtyCs. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of workQtyCs. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setWorkQtyCs_RangeOf(java.math.BigDecimal minNumber, java.math.BigDecimal maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueWorkQtyCs(), "WORK_QTY_CS", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * WORK_QTY_CS: {DECIMAL(14, 4)}
     * @param workQtyCsList The collection of workQtyCs as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setWorkQtyCs_InScope(Collection<java.math.BigDecimal> workQtyCsList) {
        doSetWorkQtyCs_InScope(workQtyCsList);
    }

    protected void doSetWorkQtyCs_InScope(Collection<java.math.BigDecimal> workQtyCsList) {
        regINS(CK_INS, cTL(workQtyCsList), xgetCValueWorkQtyCs(), "WORK_QTY_CS");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * WORK_QTY_CS: {DECIMAL(14, 4)}
     * @param workQtyCsList The collection of workQtyCs as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setWorkQtyCs_NotInScope(Collection<java.math.BigDecimal> workQtyCsList) {
        doSetWorkQtyCs_NotInScope(workQtyCsList);
    }

    protected void doSetWorkQtyCs_NotInScope(Collection<java.math.BigDecimal> workQtyCsList) {
        regINS(CK_NINS, cTL(workQtyCsList), xgetCValueWorkQtyCs(), "WORK_QTY_CS");
    }
     ...
     * WORK_QTY_CS: {DECIMAL(14, 4)}
     */
    public void setWorkQtyCs_IsNull() { regWorkQtyCs(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * WORK_QTY_CS: {DECIMAL(14, 4)}
     */
    public void setWorkQtyCs_IsNotNull() { regWorkQtyCs(CK_ISNN, DOBJ); }

    protected void regWorkQtyCs(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueWorkQtyCs(), "WORK_QTY_CS"); }
    protected abstract ConditionValue xgetCValueWorkQtyCs();
