...
public abstract class BsSqlShippingConfirmList extends AbstractEntity implements CustomizeEntity {
     ...
     * PICKING_STATUS: {VARCHAR(30), refers to t_picking_h.PICKING_STATUS, classification=ShippingStatus} <br>
     * 出荷ステータス
     ...
     * FORCE_FIXED_FLG: {CHAR(1), refers to t_picking_h.FORCE_FIXED_FLG, classification=ForceFixedFlg} <br>
     * 強制確定フラグ
     * <p>It's treated as case insensitive and if the code value is null, it returns null.</p>
     * @return The instance of classification definition (as ENUM type). (NullAllowed: when the column value is null)
     */
     ...
     * CENTER_TRANSIT_FLG: {CHAR(1), refers to t_picking_h.CENTER_TRANSIT_FLG, classification=CenterTransitFlg} <br>
     * センタ間移動フラグ
     * <p>It's treated as case insensitive and if the code value is null, it returns null.</p>
     * @return The instance of classification definition (as ENUM type). (NullAllowed: when the column value is null)
     */
    ...
    //                                                                            ========
    /**
     * [get] ALLOC_INST_H_ID: {BIGINT(20), refers to t_alloc_inst_h.ALLOC_INST_H_ID} <br>
     * 引当指示ヘッダID
    ...
    /**
     * [set] ALLOC_INST_H_ID: {BIGINT(20), refers to t_alloc_inst_h.ALLOC_INST_H_ID} <br>
     * 引当指示ヘッダID
    ...
    /**
     * [get] PICKING_H_ID: {BIGINT(20), refers to t_picking_h.PICKING_H_ID} <br>
     * 出庫ヘッダID
    ...
    /**
     * [set] PICKING_H_ID: {BIGINT(20), refers to t_picking_h.PICKING_H_ID} <br>
     * 出庫ヘッダID
    ...
    /**
     * [get] UPD_DT: {DATETIME(23), refers to t_picking_h.UPD_DT} <br>
     * 更新日時
    ...
    /**
     * [set] UPD_DT: {DATETIME(23), refers to t_picking_h.UPD_DT} <br>
     * 更新日時
    ...
    /**
     * [get] SHIPPING_H_UPD_DT: {DATETIME(23)} <br>
    ...
    /**
     * [set] SHIPPING_H_UPD_DT: {DATETIME(23)} <br>
    ...
    /**
     * [get] PICKING_TIME: {VARCHAR(60), refers to m_delivery_course.PICKING_TIME} <br>
     * 出庫開始時刻
    ...
    /**
     * [set] PICKING_TIME: {VARCHAR(60), refers to m_delivery_course.PICKING_TIME} <br>
     * 出庫開始時刻
    ...
    /**
     * [get] STOWAGE_TIME: {VARCHAR(60), refers to m_delivery_course.STOWAGE_TIME} <br>
     * 積込予定時刻
    ...
    /**
     * [set] STOWAGE_TIME: {VARCHAR(60), refers to m_delivery_course.STOWAGE_TIME} <br>
     * 積込予定時刻
    ...
    /**
     * [get] SHIPPING_TIME: {VARCHAR(60), refers to m_delivery_course.SHIPPING_TIME} <br>
     * 出荷予定時刻
    ...
    /**
     * [set] SHIPPING_TIME: {VARCHAR(60), refers to m_delivery_course.SHIPPING_TIME} <br>
     * 出荷予定時刻
    ...
    /**
     * [get] DELIV_CUSTOMER_CD: {VARCHAR(30), refers to t_alloc_inst_h.DELIV_CUSTOMER_CD} <br>
     * 届先CD
    ...
    /**
     * [set] DELIV_CUSTOMER_CD: {VARCHAR(30), refers to t_alloc_inst_h.DELIV_CUSTOMER_CD} <br>
     * 届先CD
    ...
    /**
     * [get] PICKING_STATUS: {VARCHAR(30), refers to t_picking_h.PICKING_STATUS, classification=ShippingStatus} <br>
     * 出庫ステータス<br>
    ...
    /**
     * [set] PICKING_STATUS: {VARCHAR(30), refers to t_picking_h.PICKING_STATUS, classification=ShippingStatus} <br>
     * 出庫ステータス<br>
     * // cls(ShippingStatus) 出荷ステータス
    ...
    /**
     * [get] BOL_NO: {VARCHAR(30), refers to t_picking_h.BOL_NO} <br>
     * Bill of Lading No.
    ...
    /**
     * [set] BOL_NO: {VARCHAR(30), refers to t_picking_h.BOL_NO} <br>
     * Bill of Lading No.
    ...
    /**
     * [get] SHIPPING_H_COUNT: {BIGINT(21)} <br>
    ...
    /**
     * [set] SHIPPING_H_COUNT: {BIGINT(21)} <br>
    ...
    /**
     * [get] TOTAL_VOLUME: {DECIMAL(36, 4)} <br>
    ...
    /**
     * [set] TOTAL_VOLUME: {DECIMAL(36, 4)} <br>
    ...
    /**
     * [get] INVOICE_CREATE_FLG: {VARCHAR(4)} <br>
    ...
    /**
     * [set] INVOICE_CREATE_FLG: {VARCHAR(4)} <br>
    ...
    /**
     * [get] INVOICE_CREATE_FLG_NM: {NULL} <br>
    ...
    /**
     * [set] INVOICE_CREATE_FLG_NM: {NULL} <br>
    ...
    /**
     * [get] FORCE_FIXED_FLG: {CHAR(1), refers to t_picking_h.FORCE_FIXED_FLG, classification=ForceFixedFlg} <br>
     * 強制確定フラグ<br>
    ...
    /**
     * [set] FORCE_FIXED_FLG: {CHAR(1), refers to t_picking_h.FORCE_FIXED_FLG, classification=ForceFixedFlg} <br>
     * 強制確定フラグ<br>
     * // cls(ForceFixedFlg) 強制確定フラグ
    ...
    /**
     * [get] FORCE_FIXED_FLG_NM: {NULL} <br>
    ...
    /**
     * [set] FORCE_FIXED_FLG_NM: {NULL} <br>
    ...
    /**
     * [get] SHIPPING_STOP_FLG: {VARCHAR(1)} <br>
    ...
    /**
     * [set] SHIPPING_STOP_FLG: {VARCHAR(1)} <br>
    ...
    /**
     * [get] SHIPPING_STOP_FLG_NM: {NULL} <br>
    ...
    /**
     * [set] SHIPPING_STOP_FLG_NM: {NULL} <br>
    ...
    /**
     * [get] STOP_FLG: {CHAR(1), refers to m_product} <br>
    ...
    /**
     * [set] STOP_FLG: {CHAR(1), refers to m_product} <br>
    ...
    /**
     * [get] CENTER_TRANSIT_FLG: {CHAR(1), refers to t_picking_h.CENTER_TRANSIT_FLG, classification=CenterTransitFlg} <br>
     * センタ間移動フラグ<br>
    ...
    /**
     * [set] CENTER_TRANSIT_FLG: {CHAR(1), refers to t_picking_h.CENTER_TRANSIT_FLG, classification=CenterTransitFlg} <br>
     * センタ間移動フラグ<br>
     * // cls(CenterTransitFlg) センタ間移動フラグ
