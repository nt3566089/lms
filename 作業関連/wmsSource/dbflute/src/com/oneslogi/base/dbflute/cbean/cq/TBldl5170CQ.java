...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTBldl5170CQ;

/**
 * The condition-query of t_bldl5170.
 * <p>
 ...
 */
public class TBldl5170CQ extends BsTBldl5170CQ {
     ...
     */
    public TBldl5170CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
