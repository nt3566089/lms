...
/**
 * The DTO mapper of er_receive_report as TABLE. <br>
 * 入庫実績受信テーブル
 * <pre>
 * [primary-key]
 *     RECEIVE_REPORT_ID
 ...
 */
public abstract class BsErReceiveReportDtoMapper implements DtoMapper<ErReceiveReport, ErReceiveReportDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsErReceiveReportDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsErReceiveReportDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ErReceiveReportDto mappingToDto(ErReceiveReport entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErReceiveReportDto dto = new ErReceiveReportDto();
        dto.setReceiveReportId(entity.getReceiveReportId());
        ...
        dto.setReceiveNo(entity.getReceiveNo());
        ...
        dto.setWmsAddUserNm(entity.getWmsAddUserNm());
        ...
        dto.setWmsUpdUserNm(entity.getWmsUpdUserNm());
     ...
     * {@inheritDoc}
     */
    public List<ErReceiveReportDto> mappingToDtoList(List<ErReceiveReport> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ErReceiveReportDto> dtoList = new ArrayList<ErReceiveReportDto>();
        for (ErReceiveReport entity : entityList) {
            ErReceiveReportDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ErReceiveReport mappingToEntity(ErReceiveReportDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErReceiveReport entity = new ErReceiveReport();
        if (needsMapping(dto, dto.getReceiveReportId(), "receiveReportId")) {
            entity.setReceiveReportId(dto.getReceiveReportId());
        }
        ...
        if (needsMapping(dto, dto.getReceiveNo(), "receiveNo")) {
            entity.setReceiveNo(dto.getReceiveNo());
        }
        ...
        if (needsMapping(dto, dto.getWmsAddUserNm(), "wmsAddUserNm")) {
            entity.setWmsAddUserNm(dto.getWmsAddUserNm());
        }
        ...
        if (needsMapping(dto, dto.getWmsUpdUserNm(), "wmsUpdUserNm")) {
            entity.setWmsUpdUserNm(dto.getWmsUpdUserNm());
        }
     ...
     */
    protected boolean needsMapping(ErReceiveReportDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ErReceiveReport> mappingToEntityList(List<ErReceiveReportDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ErReceiveReport> entityList = new ArrayList<ErReceiveReport>();
        for (ErReceiveReportDto dto : dtoList) {
            ErReceiveReport entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ErReceiveReportDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ErReceiveReportDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ErReceiveReportDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ErReceiveReportDtoMapper reverseReference() {
