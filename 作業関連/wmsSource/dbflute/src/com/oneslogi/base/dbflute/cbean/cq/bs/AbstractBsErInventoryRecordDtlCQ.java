...
/**
 * The abstract condition-query of er_inventory_record_dtl.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsErInventoryRecordDtlCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsErInventoryRecordDtlCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<ErInventoryRecordDtlCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ErInventoryRecordDtlCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErInventoryRecordDtlCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ErInventoryRecordDtlCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErInventoryRecordDtlCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ErInventoryRecordDtlCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErInventoryRecordDtlCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ErInventoryRecordDtlCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErInventoryRecordDtlCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ErInventoryRecordDtlCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ErInventoryRecordDtlCB&gt;() {
     *     public void query(ErInventoryRecordDtlCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErInventoryRecordDtlCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ErInventoryRecordDtlCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ErInventoryRecordDtlCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ErInventoryRecordDtlCQ sq);

    protected ErInventoryRecordDtlCB xcreateScalarConditionCB() {
        ErInventoryRecordDtlCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ErInventoryRecordDtlCB xcreateScalarConditionPartitionByCB() {
        ErInventoryRecordDtlCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ErInventoryRecordDtlCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErInventoryRecordDtlCB cb = new ErInventoryRecordDtlCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "INVENTORY_RECORD_DTL_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ErInventoryRecordDtlCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ErInventoryRecordDtlCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ErInventoryRecordDtlCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErInventoryRecordDtlCB cb = new ErInventoryRecordDtlCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "INVENTORY_RECORD_DTL_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ErInventoryRecordDtlCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ErInventoryRecordDtlCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ErInventoryRecordDtlCB cb = new ErInventoryRecordDtlCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ErInventoryRecordDtlCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ErInventoryRecordDtlCB newMyCB() {
        return new ErInventoryRecordDtlCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ErInventoryRecordDtlCQ.class.getName(); }
