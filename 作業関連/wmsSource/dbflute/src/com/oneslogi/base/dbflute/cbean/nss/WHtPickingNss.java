...
import com.oneslogi.base.dbflute.cbean.cq.WHtPickingCQ;

/**
 * The nest select set-upper of w_ht_picking.
 * @author DBFlute(AutoGenerator)
 */
public class WHtPickingNss {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final WHtPickingCQ _query;
    public WHtPickingNss(WHtPickingCQ query) { _query = query; }
