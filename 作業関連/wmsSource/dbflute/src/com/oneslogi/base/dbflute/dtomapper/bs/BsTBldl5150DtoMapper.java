...
/**
 * The DTO mapper of t_bldl5150 as TABLE. <br>
 * BLDL5150
 * <pre>
 * [primary-key]
 *     BLDL5150_ID
 ...
 */
public abstract class BsTBldl5150DtoMapper implements DtoMapper<TBldl5150, TBldl5150Dto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTBldl5150DtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTBldl5150DtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TBldl5150Dto mappingToDto(TBldl5150 entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TBldl5150Dto dto = new TBldl5150Dto();
        dto.setBldl5150Id(entity.getBldl5150Id());
     ...
     * {@inheritDoc}
     */
    public List<TBldl5150Dto> mappingToDtoList(List<TBldl5150> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TBldl5150Dto> dtoList = new ArrayList<TBldl5150Dto>();
        for (TBldl5150 entity : entityList) {
            TBldl5150Dto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TBldl5150 mappingToEntity(TBldl5150Dto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TBldl5150 entity = new TBldl5150();
        if (needsMapping(dto, dto.getBldl5150Id(), "bldl5150Id")) {
            entity.setBldl5150Id(dto.getBldl5150Id());
        }
     ...
     */
    protected boolean needsMapping(TBldl5150Dto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TBldl5150> mappingToEntityList(List<TBldl5150Dto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TBldl5150> entityList = new ArrayList<TBldl5150>();
        for (TBldl5150Dto dto : dtoList) {
            TBldl5150 entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TBldl5150DtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TBldl5150DtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TBldl5150DtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TBldl5150DtoMapper reverseReference() {
