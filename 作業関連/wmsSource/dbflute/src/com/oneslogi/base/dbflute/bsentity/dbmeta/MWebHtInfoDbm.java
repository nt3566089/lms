...
public class MWebHtInfoDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnWebHtInfoId = cci("WEB_HT_INFO_ID", "WEB_HT_INFO_ID", null, null, Long.class, "webHtInfoId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * WEB_HT_INFO_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ForeignInfo foreignMWarehouse() {
        ...
        return cfi("M_WEB_HT_INFO_FK1", "MWarehouse", this, MWarehouseDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "MWebHtInfoList", false);
    }
    /**
    ...
    public ForeignInfo foreignMClient() {
        ...
        return cfi("M_WEB_HT_INFO_FK3", "MClient", this, MClientDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "MWebHtInfoList", false);
    }
    /**
