...
/**
 * The simple DTO of er_inventory_record_dtl as TABLE. <br>
 * 棚卸実績(明細)受信テーブル
 * <pre>
 * [primary-key]
...
public abstract class BsErInventoryRecordDtlDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsErInventoryRecordDtlDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsErInventoryRecordDtlDto)) { return false; }
        final BsErInventoryRecordDtlDto otherEntity = (BsErInventoryRecordDtlDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "er_inventory_record_dtl");
