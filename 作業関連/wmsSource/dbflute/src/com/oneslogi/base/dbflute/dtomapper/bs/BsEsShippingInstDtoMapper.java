...
/**
 * The DTO mapper of es_shipping_inst as TABLE. <br>
 * 出荷指示送信テーブル
 * <pre>
 * [primary-key]
 *     SHIPPING_INST_ID
 ...
 */
public abstract class BsEsShippingInstDtoMapper implements DtoMapper<EsShippingInst, EsShippingInstDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsShippingInstDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEsShippingInstDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EsShippingInstDto mappingToDto(EsShippingInst entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsShippingInstDto dto = new EsShippingInstDto();
     ...
     * {@inheritDoc}
     */
    public List<EsShippingInstDto> mappingToDtoList(List<EsShippingInst> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EsShippingInstDto> dtoList = new ArrayList<EsShippingInstDto>();
        for (EsShippingInst entity : entityList) {
            EsShippingInstDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EsShippingInst mappingToEntity(EsShippingInstDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsShippingInst entity = new EsShippingInst();
     ...
     */
    protected boolean needsMapping(EsShippingInstDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EsShippingInst> mappingToEntityList(List<EsShippingInstDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EsShippingInst> entityList = new ArrayList<EsShippingInst>();
        for (EsShippingInstDto dto : dtoList) {
            EsShippingInst entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EsShippingInstDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EsShippingInstDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EsShippingInstDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EsShippingInstDtoMapper reverseReference() {
