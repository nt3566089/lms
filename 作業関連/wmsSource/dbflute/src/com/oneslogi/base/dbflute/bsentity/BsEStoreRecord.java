...
/**
 * The entity of e_store_record as TABLE. <br>
 * 入庫実績送信テーブル
 * <pre>
 * [primary-key]
 *     STORE_RECORD_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long storeRecordId = entity.getStoreRecordId();
 ...
 * entity.setStoreRecordId(storeRecordId);
 ...
 */
public abstract class BsEStoreRecord extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_storeRecordId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEStoreRecord) {
            BsEStoreRecord other = (BsEStoreRecord)obj;
            if (!xSV(_storeRecordId, other._storeRecordId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_storeRecordId));
    ...
    @Override
    public EStoreRecord clone() {
        return (EStoreRecord)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] STORE_RECORD_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 入庫実績送信ID
     * @return The value of the column 'STORE_RECORD_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getStoreRecordId() {
        checkSpecifiedProperty("storeRecordId");
        return _storeRecordId;
    }

    /**
     * [set] STORE_RECORD_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 入庫実績送信ID
     * @param storeRecordId The value of the column 'STORE_RECORD_ID'. (basically NotNull if update: for the constraint)
     */
    public void setStoreRecordId(Long storeRecordId) {
        registerModifiedProperty("storeRecordId");
        _storeRecordId = storeRecordId;
    }
