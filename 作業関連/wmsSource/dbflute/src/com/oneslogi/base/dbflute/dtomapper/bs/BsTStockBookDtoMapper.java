...
/**
 * The DTO mapper of t_stock_book as TABLE. <br>
 * 帳簿在庫
 * <pre>
 * [primary-key]
 *     STOCK_BOOK_ID
 ...
 */
public abstract class BsTStockBookDtoMapper implements DtoMapper<TStockBook, TStockBookDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTStockBookDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTStockBookDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TStockBookDto mappingToDto(TStockBook entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (TStockBookDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TStockBookDto dto = new TStockBookDto();
        dto.setStockBookId(entity.getStockBookId());
        dto.setBaseCd(entity.getBaseCd());
        dto.setBaseTypeCd(entity.getBaseTypeCd());
        dto.setVarietyTypeCd(entity.getVarietyTypeCd());
        ...
        if (!_suppressMProduct && entity.getMProduct() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getTStockBookList().add(dto);
                }
            } else {
     ...
     * {@inheritDoc}
     */
    public List<TStockBookDto> mappingToDtoList(List<TStockBook> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TStockBookDto> dtoList = new ArrayList<TStockBookDto>();
        for (TStockBook entity : entityList) {
            TStockBookDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TStockBook mappingToEntity(TStockBookDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (TStockBook)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TStockBook entity = new TStockBook();
        if (needsMapping(dto, dto.getStockBookId(), "stockBookId")) {
            entity.setStockBookId(dto.getStockBookId());
        }
        ...
        if (needsMapping(dto, dto.getVarietyTypeCd(), "varietyTypeCd")) {
            entity.setVarietyTypeCd(dto.getVarietyTypeCd());
        }
        ...
        if (!_suppressMProduct && dto.getMProduct() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getTStockBookList().add(entity);
                }
            } else {
                MProductDtoMapper mapper = new MProductDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(TStockBookDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TStockBook> mappingToEntityList(List<TStockBookDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TStockBook> entityList = new ArrayList<TStockBook>();
        for (TStockBookDto dto : dtoList) {
            TStockBook entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TStockBookDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TStockBookDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TStockBookDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TStockBookDtoMapper reverseReference() {
