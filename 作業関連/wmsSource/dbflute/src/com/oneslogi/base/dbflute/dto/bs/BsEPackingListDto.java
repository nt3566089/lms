...
/**
 * The simple DTO of e_packing_list as TABLE. <br>
 * 梱包明細送信テーブル
 * <pre>
 * [primary-key]
 *     PACKING_LIST_ID
...
public abstract class BsEPackingListDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEPackingListDto)) { return false; }
        final BsEPackingListDto otherEntity = (BsEPackingListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "e_packing_list");
