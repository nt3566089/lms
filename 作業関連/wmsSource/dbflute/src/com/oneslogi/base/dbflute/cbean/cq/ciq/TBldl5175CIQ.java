...
/**
 * The condition-query for in-line of t_bldl5175.
 * @author DBFlute(AutoGenerator)
 */
public class TBldl5175CIQ extends AbstractBsTBldl5175CQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTBldl5175CQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TBldl5175CIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTBldl5175CQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueBldl5175Id() { return _myCQ.xdfgetBldl5175Id(); }
    ...
    public String keepScalarCondition(TBldl5175CQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TBldl5175CQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TBldl5175CQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TBldl5175CQ sq)
    ...
    protected String xinCB() { return TBldl5175CB.class.getName(); }
    protected String xinCQ() { return TBldl5175CQ.class.getName(); }
}
