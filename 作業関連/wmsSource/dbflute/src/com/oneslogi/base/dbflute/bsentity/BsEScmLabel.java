...
/**
 * The entity of e_scm_label as TABLE. <br>
 * SCMラベル情報送信テーブル
 * <pre>
 * [primary-key]
 *     SCM_LABEL_ID
 ...
 */
public abstract class BsEScmLabel extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEScmLabel) {
            BsEScmLabel other = (BsEScmLabel)obj;
    ...
    @Override
    public EScmLabel clone() {
        return (EScmLabel)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] SCM_LABEL_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * SCMラベル情報送信ID
    ...
    /**
     * [set] SCM_LABEL_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * SCMラベル情報送信ID
