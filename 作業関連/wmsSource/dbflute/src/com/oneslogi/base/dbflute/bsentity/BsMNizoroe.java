...
/**
 * The entity of m_nizoroe as TABLE. <br>
 * 荷揃マスタ
 * <pre>
 * [primary-key]
 *     NIZOROE_ID
 ...
 */
public abstract class BsMNizoroe extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected MNizoroePatern _mNizoroePatern;

    /**
     * [get] m_nizoroe_patern by my NIZOROE_PATERN_ID, named 'MNizoroePatern'. <br>
     * @return The entity of foreign property 'MNizoroePatern'. (NullAllowed: when e.g. null FK column, no setupSelect)
     */
    public MNizoroePatern getMNizoroePatern() {
        return _mNizoroePatern;
    }

    /**
     * [set] m_nizoroe_patern by my NIZOROE_PATERN_ID, named 'MNizoroePatern'.
     * @param mNizoroePatern The entity of foreign property 'MNizoroePatern'. (NullAllowed)
     */
    public void setMNizoroePatern(MNizoroePatern mNizoroePatern) {
        _mNizoroePatern = mNizoroePatern;
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMNizoroe) {
            BsMNizoroe other = (BsMNizoroe)obj;
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        { sb.append(li).append(xbRDS(_mNizoroePatern, "mNizoroePatern")); }
        return sb.toString();
    }
    ...
    protected String doBuildRelationString(String dm) {
        ...
        if (_mNizoroePatern != null)
        { sb.append(dm).append("mNizoroePatern"); }
        if (sb.length() > dm.length()) {
    ...
    @Override
    public MNizoroe clone() {
        return (MNizoroe)super.clone();
    }
    ...
    /**
     * [get] NIZOROE_PATERN_ID: {IX, BIGINT(19), FK to m_nizoroe_patern} <br>
     * 荷揃パターンID
     * @return The value of the column 'NIZOROE_PATERN_ID'. (NullAllowed even if selected: for no constraint)
     */
    ...
    /**
     * [set] NIZOROE_PATERN_ID: {IX, BIGINT(19), FK to m_nizoroe_patern} <br>
     * 荷揃パターンID
     * @param nizoroePaternId The value of the column 'NIZOROE_PATERN_ID'. (NullAllowed: null update allowed for no constraint)
     */
