...
public class BsTMoveRecordBCB extends AbstractConditionBean {
     ...
     * @param moveRecordBId : PK, ID, NotNull, BIGINT(19). (NotNull)
     * @return this. (NotNull)
     */
     ...
     *     ... = <span style="color: #553000">tMoveRecordB</span>.<span style="color: #CC4747">getBUser()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
