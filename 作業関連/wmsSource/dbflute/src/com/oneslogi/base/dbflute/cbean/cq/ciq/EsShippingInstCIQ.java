...
/**
 * The condition-query for in-line of es_shipping_inst.
 * @author DBFlute(AutoGenerator)
 */
public class EsShippingInstCIQ extends AbstractBsEsShippingInstCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEsShippingInstCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EsShippingInstCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEsShippingInstCQ myCQ) {
    ...
    public String keepScalarCondition(EsShippingInstCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EsShippingInstCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EsShippingInstCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EsShippingInstCQ sq)
    ...
    protected String xinCB() { return EsShippingInstCB.class.getName(); }
    protected String xinCQ() { return EsShippingInstCQ.class.getName(); }
}
