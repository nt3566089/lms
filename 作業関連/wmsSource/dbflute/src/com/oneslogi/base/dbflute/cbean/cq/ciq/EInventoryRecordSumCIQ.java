...
/**
 * The condition-query for in-line of e_inventory_record_sum.
 * @author DBFlute(AutoGenerator)
 */
public class EInventoryRecordSumCIQ extends AbstractBsEInventoryRecordSumCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEInventoryRecordSumCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EInventoryRecordSumCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEInventoryRecordSumCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueInventoryRecordSumId() { return _myCQ.xdfgetInventoryRecordSumId(); }
    ...
    public String keepScalarCondition(EInventoryRecordSumCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EInventoryRecordSumCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EInventoryRecordSumCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EInventoryRecordSumCQ sq)
    ...
    protected String xinCB() { return EInventoryRecordSumCB.class.getName(); }
    protected String xinCQ() { return EInventoryRecordSumCQ.class.getName(); }
}
