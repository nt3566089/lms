...
/**
 * The simple DTO of t_picking_receive_label as TABLE. <br>
 * 出庫入荷ラベル
 * <pre>
 * [primary-key]
...
public abstract class BsTPickingReceiveLabelDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTPickingReceiveLabelDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTPickingReceiveLabelDto)) { return false; }
        final BsTPickingReceiveLabelDto otherEntity = (BsTPickingReceiveLabelDto)other;
        if (!helpComparingValue(getPickingReceiveLabelId(), otherEntity.getPickingReceiveLabelId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "t_picking_receive_label");
        result = xCH(result, getPickingReceiveLabelId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getPickingReceiveLabelId());
     ...
     * 出庫入荷ラベル
     * @return The value of the column 'PICKING_RECEIVE_LABEL_ID'. (NullAllowed)
     */
     ...
     * 出庫入荷ラベル
     * @param pickingReceiveLabelId The value of the column 'PICKING_RECEIVE_LABEL_ID'. (NullAllowed)
     */
    public void setPickingReceiveLabelId(Long pickingReceiveLabelId) {
        __modifiedProperties.add("pickingReceiveLabelId");
        this._pickingReceiveLabelId = pickingReceiveLabelId;
    }
