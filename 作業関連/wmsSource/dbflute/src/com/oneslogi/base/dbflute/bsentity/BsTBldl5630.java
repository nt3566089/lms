...
/**
 * The entity of t_bldl5630 as TABLE. <br>
 * BLDL5630
 * <pre>
 * [primary-key]
 *     BLDL5630_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5630Id = entity.getBldl5630Id();
 ...
 * Long koshigayaUs = entity.getKoshigayaUs();
 ...
 */
public abstract class BsTBldl5630 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5630Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5630) {
            BsTBldl5630 other = (BsTBldl5630)obj;
            if (!xSV(_bldl5630Id, other._bldl5630Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5630Id));
        ...
        sb.append(dm).append(xfND(_koshigayaUs));
    ...
    @Override
    public TBldl5630 clone() {
        return (TBldl5630)super.clone();
    }
     ...
     * BLDL5630ID
     * @return The value of the column 'BLDL5630_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5630Id() {
        checkSpecifiedProperty("bldl5630Id");
        return _bldl5630Id;
    }
     ...
     * BLDL5630ID
     * @param bldl5630Id The value of the column 'BLDL5630_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5630Id(Long bldl5630Id) {
        registerModifiedProperty("bldl5630Id");
        _bldl5630Id = bldl5630Id;
    }
     ...
     * 越谷US
     * @return The value of the column 'KOSHIGAYA_US'. (NullAllowed even if selected: for no constraint)
     */
    public Long getKoshigayaUs() {
        checkSpecifiedProperty("koshigayaUs");
        return _koshigayaUs;
    }
     ...
     * 越谷US
     * @param koshigayaUs The value of the column 'KOSHIGAYA_US'. (NullAllowed: null update allowed for no constraint)
     */
    public void setKoshigayaUs(Long koshigayaUs) {
        registerModifiedProperty("koshigayaUs");
        _koshigayaUs = koshigayaUs;
    }
