...
public class HMoveHDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMoveInstHId = cci("MOVE_INST_H_ID", "MOVE_INST_H_ID", null, null, Long.class, "moveInstHId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "HInventoryBList,HMoveBList", null, false);
    ...
    public ReferrerInfo referrerHInventoryBList() {
        ...
        return cri("H_INVENTORY_B_FK3", "HInventoryBList", this, HInventoryBDbm.getInstance(), mp, false, "HMoveH");
    }
    /**
