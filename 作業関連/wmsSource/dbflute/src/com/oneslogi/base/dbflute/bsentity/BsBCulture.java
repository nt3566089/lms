...
public abstract class BsBCulture extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] CULTURE_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * カルチャID
    ...
    /**
     * [set] CULTURE_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * カルチャID
    ...
    /**
     * [get] LANG_CULTURE_ID: {IX, BIGINT(19), FK to b_culture} <br>
     * 言語カルチャID
    ...
    /**
     * [set] LANG_CULTURE_ID: {IX, BIGINT(19), FK to b_culture} <br>
     * 言語カルチャID
