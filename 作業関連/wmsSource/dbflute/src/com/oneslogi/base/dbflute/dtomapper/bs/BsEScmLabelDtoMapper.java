...
/**
 * The DTO mapper of e_scm_label as TABLE. <br>
 * SCMラベル情報送信テーブル
 * <pre>
 * [primary-key]
 *     SCM_LABEL_ID
 ...
 */
public abstract class BsEScmLabelDtoMapper implements DtoMapper<EScmLabel, EScmLabelDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEScmLabelDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEScmLabelDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EScmLabelDto mappingToDto(EScmLabel entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EScmLabelDto dto = new EScmLabelDto();
     ...
     * {@inheritDoc}
     */
    public List<EScmLabelDto> mappingToDtoList(List<EScmLabel> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EScmLabelDto> dtoList = new ArrayList<EScmLabelDto>();
        for (EScmLabel entity : entityList) {
            EScmLabelDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EScmLabel mappingToEntity(EScmLabelDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EScmLabel entity = new EScmLabel();
     ...
     */
    protected boolean needsMapping(EScmLabelDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EScmLabel> mappingToEntityList(List<EScmLabelDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EScmLabel> entityList = new ArrayList<EScmLabel>();
        for (EScmLabelDto dto : dtoList) {
            EScmLabel entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EScmLabelDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EScmLabelDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EScmLabelDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EScmLabelDtoMapper reverseReference() {
