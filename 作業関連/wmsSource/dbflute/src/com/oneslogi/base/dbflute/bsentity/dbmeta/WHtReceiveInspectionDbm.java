...
public class WHtReceiveInspectionDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((WHtReceiveInspection)et).getProductionDt(), (et, vl) -> ((WHtReceiveInspection)et).setProductionDt((String)vl), "productionDt");
        setupEpg(_epgMap, et -> ((WHtReceiveInspection)et).getInputAssistanceUnitNum(), (et, vl) -> ((WHtReceiveInspection)et).setInputAssistanceUnitNum(ctl(vl)), "inputAssistanceUnitNum");
        setupEpg(_epgMap, et -> ((WHtReceiveInspection)et).getInputAssistanceCaseNum(), (et, vl) -> ((WHtReceiveInspection)et).setInputAssistanceCaseNum(ctb(vl)), "inputAssistanceCaseNum");
        setupEpg(_epgMap, et -> ((WHtReceiveInspection)et).getInputAssistancePieceNum(), (et, vl) -> ((WHtReceiveInspection)et).setInputAssistancePieceNum(ctb(vl)), "inputAssistancePieceNum");
        setupEpg(_epgMap, et -> ((WHtReceiveInspection)et).getCaseReceiveLabelNum(), (et, vl) -> ((WHtReceiveInspection)et).setCaseReceiveLabelNum(ctl(vl)), "caseReceiveLabelNum");
        setupEpg(_epgMap, et -> ((WHtReceiveInspection)et).getPieceReceiveLabelNum(), (et, vl) -> ((WHtReceiveInspection)et).setPieceReceiveLabelNum(ctl(vl)), "pieceReceiveLabelNum");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnHtReceiveInspectionId = cci("HT_RECEIVE_INSPECTION_ID", "HT_RECEIVE_INSPECTION_ID", null, null, Long.class, "htReceiveInspectionId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnPieceQtyRcvOrd = cci("PIECE_QTY_RCV_ORD", "PIECE_QTY_RCV_ORD", null, null, java.math.BigDecimal.class, "pieceQtyRcvOrd", null, false, false, false, "DECIMAL", 14, 4, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnPieceQtyRcv = cci("PIECE_QTY_RCV", "PIECE_QTY_RCV", null, null, java.math.BigDecimal.class, "pieceQtyRcv", null, false, false, false, "DECIMAL", 14, 4, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnCaseReceiveLabelNum = cci("CASE_RECEIVE_LABEL_NUM", "CASE_RECEIVE_LABEL_NUM", null, null, Long.class, "caseReceiveLabelNum", null, false, false, false, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnPieceReceiveLabelNum = cci("PIECE_RECEIVE_LABEL_NUM", "PIECE_RECEIVE_LABEL_NUM", null, null, Long.class, "pieceReceiveLabelNum", null, false, false, false, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
     ...
     * @return The information object of specified column. (NotNull)
     */
    public ColumnInfo columnCaseReceiveLabelNum() { return _columnCaseReceiveLabelNum; }
    /**
     * PIECE_RECEIVE_LABEL_NUM: {BIGINT(19)}
     * @return The information object of specified column. (NotNull)
     */
    public ColumnInfo columnPieceReceiveLabelNum() { return _columnPieceReceiveLabelNum; }
    /**
    ...
    protected List<ColumnInfo> ccil() {
        ...
        ls.add(columnCaseReceiveLabelNum());
        ls.add(columnPieceReceiveLabelNum());
        ls.add(columnDelFlg());
