...
public class MShapeDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnShapeId = cci("SHAPE_ID", "SHAPE_ID", null, null, Long.class, "shapeId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "HInventoryBList,HStockList,MLocationReplenishProductList,MShapeGrpDtlList,TAllocInstBList,TInventoryBList,TMoveInstBList,TPickingBList,TShippingInstBList,TStockList", null, false);
    ...
    public ReferrerInfo referrerHInventoryBList() {
        ...
        return cri("H_INVENTORY_B_FK5", "HInventoryBList", this, HInventoryBDbm.getInstance(), mp, false, "MShape");
    }
    /**
    ...
    public ReferrerInfo referrerHStockList() {
        ...
        return cri("H_STOCK_FK2", "HStockList", this, HStockDbm.getInstance(), mp, false, "MShape");
    }
    /**
    ...
    public ReferrerInfo referrerMLocationReplenishProductList() {
        Map<ColumnInfo, ColumnInfo> mp = newLinkedHashMap(columnShapeId(), MLocationReplenishProductDbm.getInstance().columnReplenishPProductShapeId());
        return cri("M_LOCATION_REPLENISH_PRODUCT_FK6", "MLocationReplenishProductList", this, MLocationReplenishProductDbm.getInstance(), mp, false, "MShape");
    }
    /**
    ...
    public ReferrerInfo referrerMShapeGrpDtlList() {
        ...
        return cri("M_SHAPE_GRP_DTL_FK2", "MShapeGrpDtlList", this, MShapeGrpDtlDbm.getInstance(), mp, false, "MShape");
    }
    /**
    ...
    public ReferrerInfo referrerTAllocInstBList() {
        ...
        return cri("T_ALLOC_INST_B_FK2", "TAllocInstBList", this, TAllocInstBDbm.getInstance(), mp, false, "MShape");
    }
    /**
    ...
    public ReferrerInfo referrerTInventoryBList() {
        ...
        return cri("T_INVENTORY_B_FK2", "TInventoryBList", this, TInventoryBDbm.getInstance(), mp, false, "MShape");
    }
    /**
    ...
    public ReferrerInfo referrerTMoveInstBList() {
        ...
        return cri("T_MOVE_INST_B_FK1", "TMoveInstBList", this, TMoveInstBDbm.getInstance(), mp, false, "MShape");
    }
    /**
    ...
    public ReferrerInfo referrerTPickingBList() {
        ...
        return cri("T_PICKING_B_FK5", "TPickingBList", this, TPickingBDbm.getInstance(), mp, false, "MShape");
    }
    /**
    ...
    public ReferrerInfo referrerTShippingInstBList() {
        ...
        return cri("T_SHIPPING_INST_B_FK8", "TShippingInstBList", this, TShippingInstBDbm.getInstance(), mp, false, "MShape");
    }
    /**
    ...
    public ReferrerInfo referrerTStockList() {
        ...
        return cri("T_STOCK_FK6", "TStockList", this, TStockDbm.getInstance(), mp, false, "MShape");
    }
