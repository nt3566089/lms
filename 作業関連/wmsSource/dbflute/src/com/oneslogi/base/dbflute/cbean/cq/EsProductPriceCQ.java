...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsEsProductPriceCQ;

/**
 * The condition-query of es_product_price.
 * <p>
 ...
 */
public class EsProductPriceCQ extends BsEsProductPriceCQ {
     ...
     */
    public EsProductPriceCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
