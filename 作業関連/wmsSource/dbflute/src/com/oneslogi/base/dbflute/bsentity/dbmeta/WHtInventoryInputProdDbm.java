...
public class WHtInventoryInputProdDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((WHtInventoryInputProd)et).getProductionDt(), (et, vl) -> ((WHtInventoryInputProd)et).setProductionDt((String)vl), "productionDt");
        setupEpg(_epgMap, et -> ((WHtInventoryInputProd)et).getUnitNm(), (et, vl) -> ((WHtInventoryInputProd)et).setUnitNm((String)vl), "unitNm");
        setupEpg(_epgMap, et -> ((WHtInventoryInputProd)et).getAreaCd(), (et, vl) -> ((WHtInventoryInputProd)et).setAreaCd((String)vl), "areaCd");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnHtInventoryInputProdId = cci("HT_INVENTORY_INPUT_PROD_ID", "HT_INVENTORY_INPUT_PROD_ID", null, null, Long.class, "htInventoryInputProdId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnQty = cci("QTY", "QTY", null, null, java.math.BigDecimal.class, "qty", null, false, false, false, "DECIMAL", 14, 4, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnCrDt = cci("CR_DT", "CR_DT", null, null, java.sql.Timestamp.class, "crDt", null, false, false, false, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignMLocation() {
        ...
        return cfi("W_HT_INVENTORY_INPUT_PROD_FK2", "MLocation", this, MLocationDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "WHtInventoryInputProdList", false);
    }
    /**
    ...
    public ForeignInfo foreignMStockType() {
        ...
        return cfi("W_HT_INVENTORY_INPUT_PROD_FK1", "MStockType", this, MStockTypeDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "WHtInventoryInputProdList", false);
    }
    /**
    ...
    public ForeignInfo foreignTLot() {
        ...
        return cfi("W_HT_INVENTORY_INPUT_PROD_FK5", "TLot", this, TLotDbm.getInstance(), mp, 2, null, false, false, false, false, null, null, false, "WHtInventoryInputProdList", false);
    }
    /**
    ...
    public ForeignInfo foreignMWarehouse() {
        ...
        return cfi("W_HT_INVENTORY_INPUT_PROD_FK3", "MWarehouse", this, MWarehouseDbm.getInstance(), mp, 3, null, false, false, false, false, null, null, false, "WHtInventoryInputProdList", false);
    }
    /**
    ...
    public ForeignInfo foreignMProduct() {
        ...
        return cfi("W_HT_INVENTORY_INPUT_PROD_FK6", "MProduct", this, MProductDbm.getInstance(), mp, 4, null, false, false, false, false, null, null, false, "WHtInventoryInputProdList", false);
    }
    /**
    ...
    public ForeignInfo foreignMCenter() {
        ...
        return cfi("W_HT_INVENTORY_INPUT_PROD_FK8", "MCenter", this, MCenterDbm.getInstance(), mp, 5, null, false, false, false, false, null, null, false, "WHtInventoryInputProdList", false);
    }
    /**
    ...
    public ForeignInfo foreignMClient() {
        ...
        return cfi("W_HT_INVENTORY_INPUT_PROD_FK4", "MClient", this, MClientDbm.getInstance(), mp, 6, null, false, false, false, false, null, null, false, "WHtInventoryInputProdList", false);
    }
    /**
    ...
    public ForeignInfo foreignMCustomer() {
        ...
        return cfi("W_HT_INVENTORY_INPUT_PROD_FK7", "MCustomer", this, MCustomerDbm.getInstance(), mp, 7, null, false, false, false, false, null, null, false, "WHtInventoryInputProdList", false);
    }
