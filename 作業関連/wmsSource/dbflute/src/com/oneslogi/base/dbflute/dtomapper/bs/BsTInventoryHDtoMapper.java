...
public abstract class BsTInventoryHDtoMapper implements DtoMapper<TInventoryH, TInventoryHDto>, Serializable {
    ...
    public TInventoryHDto mappingToDto(TInventoryH entity) {
        ...
        dto.setInventoryInstNo(entity.getInventoryInstNo());
        dto.setInventoryStatusTypeId(entity.getInventoryStatusTypeId());
        dto.setInventoryStatusTypeCd(entity.getInventoryStatusTypeCd());
        dto.setInstRecvTime(entity.getInstRecvTime());
        dto.setReportSendTime(entity.getReportSendTime());
        dto.setInventoryUpdateFlg(entity.getInventoryUpdateFlg());
        dto.setInventoryDataStatus(entity.getInventoryDataStatus());
    ...
    public TInventoryH mappingToEntity(TInventoryHDto dto) {
        ...
        if (needsMapping(dto, dto.getInventoryInstNo(), "inventoryInstNo")) {
            entity.setInventoryInstNo(dto.getInventoryInstNo());
        }
        if (needsMapping(dto, dto.getInventoryStatusTypeId(), "inventoryStatusTypeId")) {
            entity.setInventoryStatusTypeId(dto.getInventoryStatusTypeId());
        }
        if (needsMapping(dto, dto.getInventoryStatusTypeCd(), "inventoryStatusTypeCd")) {
            entity.setInventoryStatusTypeCd(dto.getInventoryStatusTypeCd());
        }
        if (needsMapping(dto, dto.getInstRecvTime(), "instRecvTime")) {
            entity.setInstRecvTime(dto.getInstRecvTime());
        }
        if (needsMapping(dto, dto.getReportSendTime(), "reportSendTime")) {
            entity.setReportSendTime(dto.getReportSendTime());
        }
        if (needsMapping(dto, dto.getInventoryUpdateFlg(), "inventoryUpdateFlg")) {
            entity.setInventoryUpdateFlg(dto.getInventoryUpdateFlg());
        }
        if (needsMapping(dto, dto.getInventoryDataStatus(), "inventoryDataStatus")) {
            entity.setInventoryDataStatus(dto.getInventoryDataStatus());
        }
