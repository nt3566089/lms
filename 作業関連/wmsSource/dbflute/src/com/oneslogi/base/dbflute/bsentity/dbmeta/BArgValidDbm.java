...
public class BArgValidDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnArgId = cci("ARG_ID", "ARG_ID", null, null, Long.class, "argId", null, true, false, true, "BIGINT", 19, 0, null, null, false, null, null, "BArg", null, null, false);
    ...
    /**
     * ARG_ID: {PK, NotNull, BIGINT(19), FK to b_arg}
