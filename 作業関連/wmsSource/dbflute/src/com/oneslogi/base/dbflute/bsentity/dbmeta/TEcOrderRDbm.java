...
public class TEcOrderRDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnEcOrderHId = cci("EC_ORDER_H_ID", "EC_ORDER_H_ID", null, null, Long.class, "ecOrderHId", null, true, false, true, "BIGINT", 19, 0, null, null, false, null, null, "TEcOrderH", null, null, false);
    ...
    protected final ColumnInfo _columnStatementOutDt = cci("STATEMENT_OUT_DT", "STATEMENT_OUT_DT", null, null, java.sql.Timestamp.class, "statementOutDt", null, false, false, false, "DATETIME", 19, 0, 3, null, false, null, null, null, null, null, false);
    ...
    /**
     * EC_ORDER_H_ID: {PK, NotNull, BIGINT(19), FK to t_ec_order_h}
