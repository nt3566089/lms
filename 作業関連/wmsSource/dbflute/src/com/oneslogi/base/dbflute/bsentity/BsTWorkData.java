 ...
 * Long workQtyCs = entity.getWorkQtyCs();
...
public abstract class BsTWorkData extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] WORK_DATA_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 作業中データID
    ...
    /**
     * [set] WORK_DATA_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 作業中データID
    ...
    /**
     * [get] WORK_LOG_ID: {IX, NotNull, BIGINT(19), FK to t_work_log} <br>
     * 作業実績ID
    ...
    /**
     * [set] WORK_LOG_ID: {IX, NotNull, BIGINT(19), FK to t_work_log} <br>
     * 作業実績ID
