...
public abstract class AbstractBsTInventoryBCQ extends AbstractConditionQuery {
    ...
    /**
     * Set up ExistsReferrer (correlated sub-query). <br>
     * {exists (select INVENTORY_B_ID from t_inventory_receive_label where ...)} <br>
     * t_inventory_receive_label by INVENTORY_B_ID, named 'TInventoryReceiveLabelAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">existsTInventoryReceiveLabelList</span>(labelCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     labelCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of TInventoryReceiveLabelList for 'exists'. (NotNull)
     */
    public void existsTInventoryReceiveLabelList(SubQuery<TInventoryReceiveLabelCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TInventoryReceiveLabelCB cb = new TInventoryReceiveLabelCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepInventoryBId_ExistsReferrer_TInventoryReceiveLabelList(cb.query());
        registerExistsReferrer(cb.query(), "INVENTORY_B_ID", "INVENTORY_B_ID", pp, "tInventoryReceiveLabelList");
    }
    public abstract String keepInventoryBId_ExistsReferrer_TInventoryReceiveLabelList(TInventoryReceiveLabelCQ sq);
    ...
    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select INVENTORY_B_ID from t_inventory_receive_label where ...)} <br>
     * t_inventory_receive_label by INVENTORY_B_ID, named 'TInventoryReceiveLabelAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">notExistsTInventoryReceiveLabelList</span>(labelCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     labelCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of InventoryBId_NotExistsReferrer_TInventoryReceiveLabelList for 'not exists'. (NotNull)
     */
    public void notExistsTInventoryReceiveLabelList(SubQuery<TInventoryReceiveLabelCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TInventoryReceiveLabelCB cb = new TInventoryReceiveLabelCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepInventoryBId_NotExistsReferrer_TInventoryReceiveLabelList(cb.query());
        registerNotExistsReferrer(cb.query(), "INVENTORY_B_ID", "INVENTORY_B_ID", pp, "tInventoryReceiveLabelList");
    }
    public abstract String keepInventoryBId_NotExistsReferrer_TInventoryReceiveLabelList(TInventoryReceiveLabelCQ sq);
    ...
    public void xsderiveTInventoryReceiveLabelList(String fn, SubQuery<TInventoryReceiveLabelCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TInventoryReceiveLabelCB cb = new TInventoryReceiveLabelCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepInventoryBId_SpecifyDerivedReferrer_TInventoryReceiveLabelList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "INVENTORY_B_ID", "INVENTORY_B_ID", pp, "tInventoryReceiveLabelList", al, op);
    }
    public abstract String keepInventoryBId_SpecifyDerivedReferrer_TInventoryReceiveLabelList(TInventoryReceiveLabelCQ sq);
    ...
    /**
     * Prepare for (Query)DerivedReferrer (correlated sub-query). <br>
     * {FOO &lt;= (select max(BAR) from t_inventory_receive_label where ...)} <br>
     * t_inventory_receive_label by INVENTORY_B_ID, named 'TInventoryReceiveLabelAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">derivedTInventoryReceiveLabelList()</span>.<span style="color: #CC4747">max</span>(labelCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The object to set up a function for referrer table. (NotNull)
     */
    public HpQDRFunction<TInventoryReceiveLabelCB> derivedTInventoryReceiveLabelList() {
        return xcreateQDRFunctionTInventoryReceiveLabelList();
    }
    protected HpQDRFunction<TInventoryReceiveLabelCB> xcreateQDRFunctionTInventoryReceiveLabelList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveTInventoryReceiveLabelList(fn, sq, rd, vl, op));
    }
    public void xqderiveTInventoryReceiveLabelList(String fn, SubQuery<TInventoryReceiveLabelCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TInventoryReceiveLabelCB cb = new TInventoryReceiveLabelCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepInventoryBId_QueryDerivedReferrer_TInventoryReceiveLabelList(cb.query()); String prpp = keepInventoryBId_QueryDerivedReferrer_TInventoryReceiveLabelListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "INVENTORY_B_ID", "INVENTORY_B_ID", sqpp, "tInventoryReceiveLabelList", rd, vl, prpp, op);
    }
    public abstract String keepInventoryBId_QueryDerivedReferrer_TInventoryReceiveLabelList(TInventoryReceiveLabelCQ sq);
    public abstract String keepInventoryBId_QueryDerivedReferrer_TInventoryReceiveLabelListParameter(Object vl);
     ...
     * @param htInputInventoryNum The value of htInputInventoryNum as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtInputInventoryNum_Equal(java.math.BigDecimal htInputInventoryNum) {
        doSetHtInputInventoryNum_Equal(htInputInventoryNum);
    }

    protected void doSetHtInputInventoryNum_Equal(java.math.BigDecimal htInputInventoryNum) {
        regHtInputInventoryNum(CK_EQ, htInputInventoryNum);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param htInputInventoryNum The value of htInputInventoryNum as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtInputInventoryNum_NotEqual(java.math.BigDecimal htInputInventoryNum) {
        doSetHtInputInventoryNum_NotEqual(htInputInventoryNum);
    }

    protected void doSetHtInputInventoryNum_NotEqual(java.math.BigDecimal htInputInventoryNum) {
        regHtInputInventoryNum(CK_NES, htInputInventoryNum);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param htInputInventoryNum The value of htInputInventoryNum as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtInputInventoryNum_GreaterThan(java.math.BigDecimal htInputInventoryNum) {
        regHtInputInventoryNum(CK_GT, htInputInventoryNum);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param htInputInventoryNum The value of htInputInventoryNum as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtInputInventoryNum_LessThan(java.math.BigDecimal htInputInventoryNum) {
        regHtInputInventoryNum(CK_LT, htInputInventoryNum);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param htInputInventoryNum The value of htInputInventoryNum as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtInputInventoryNum_GreaterEqual(java.math.BigDecimal htInputInventoryNum) {
        regHtInputInventoryNum(CK_GE, htInputInventoryNum);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param htInputInventoryNum The value of htInputInventoryNum as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtInputInventoryNum_LessEqual(java.math.BigDecimal htInputInventoryNum) {
        regHtInputInventoryNum(CK_LE, htInputInventoryNum);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * HT_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param minNumber The min number of htInputInventoryNum. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of htInputInventoryNum. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setHtInputInventoryNum_RangeOf(java.math.BigDecimal minNumber, java.math.BigDecimal maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueHtInputInventoryNum(), "HT_INPUT_INVENTORY_NUM", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * HT_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param htInputInventoryNumList The collection of htInputInventoryNum as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setHtInputInventoryNum_InScope(Collection<java.math.BigDecimal> htInputInventoryNumList) {
        doSetHtInputInventoryNum_InScope(htInputInventoryNumList);
    }

    protected void doSetHtInputInventoryNum_InScope(Collection<java.math.BigDecimal> htInputInventoryNumList) {
        regINS(CK_INS, cTL(htInputInventoryNumList), xgetCValueHtInputInventoryNum(), "HT_INPUT_INVENTORY_NUM");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * HT_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param htInputInventoryNumList The collection of htInputInventoryNum as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setHtInputInventoryNum_NotInScope(Collection<java.math.BigDecimal> htInputInventoryNumList) {
        doSetHtInputInventoryNum_NotInScope(htInputInventoryNumList);
    }

    protected void doSetHtInputInventoryNum_NotInScope(Collection<java.math.BigDecimal> htInputInventoryNumList) {
        regINS(CK_NINS, cTL(htInputInventoryNumList), xgetCValueHtInputInventoryNum(), "HT_INPUT_INVENTORY_NUM");
    }
     ...
     * HT_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     */
    public void setHtInputInventoryNum_IsNull() { regHtInputInventoryNum(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * HT_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     */
    public void setHtInputInventoryNum_IsNotNull() { regHtInputInventoryNum(CK_ISNN, DOBJ); }

    protected void regHtInputInventoryNum(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueHtInputInventoryNum(), "HT_INPUT_INVENTORY_NUM"); }
    protected abstract ConditionValue xgetCValueHtInputInventoryNum();

    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. <br>
     * WEB_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param webInputInventoryNum The value of webInputInventoryNum as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setWebInputInventoryNum_Equal(java.math.BigDecimal webInputInventoryNum) {
        doSetWebInputInventoryNum_Equal(webInputInventoryNum);
    }

    protected void doSetWebInputInventoryNum_Equal(java.math.BigDecimal webInputInventoryNum) {
        regWebInputInventoryNum(CK_EQ, webInputInventoryNum);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * WEB_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param webInputInventoryNum The value of webInputInventoryNum as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setWebInputInventoryNum_NotEqual(java.math.BigDecimal webInputInventoryNum) {
        doSetWebInputInventoryNum_NotEqual(webInputInventoryNum);
    }

    protected void doSetWebInputInventoryNum_NotEqual(java.math.BigDecimal webInputInventoryNum) {
        regWebInputInventoryNum(CK_NES, webInputInventoryNum);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * WEB_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param webInputInventoryNum The value of webInputInventoryNum as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setWebInputInventoryNum_GreaterThan(java.math.BigDecimal webInputInventoryNum) {
        regWebInputInventoryNum(CK_GT, webInputInventoryNum);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * WEB_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param webInputInventoryNum The value of webInputInventoryNum as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setWebInputInventoryNum_LessThan(java.math.BigDecimal webInputInventoryNum) {
        regWebInputInventoryNum(CK_LT, webInputInventoryNum);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * WEB_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param webInputInventoryNum The value of webInputInventoryNum as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setWebInputInventoryNum_GreaterEqual(java.math.BigDecimal webInputInventoryNum) {
        regWebInputInventoryNum(CK_GE, webInputInventoryNum);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * WEB_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param webInputInventoryNum The value of webInputInventoryNum as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setWebInputInventoryNum_LessEqual(java.math.BigDecimal webInputInventoryNum) {
        regWebInputInventoryNum(CK_LE, webInputInventoryNum);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * WEB_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param minNumber The min number of webInputInventoryNum. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of webInputInventoryNum. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setWebInputInventoryNum_RangeOf(java.math.BigDecimal minNumber, java.math.BigDecimal maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueWebInputInventoryNum(), "WEB_INPUT_INVENTORY_NUM", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * WEB_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param webInputInventoryNumList The collection of webInputInventoryNum as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setWebInputInventoryNum_InScope(Collection<java.math.BigDecimal> webInputInventoryNumList) {
        doSetWebInputInventoryNum_InScope(webInputInventoryNumList);
    }

    protected void doSetWebInputInventoryNum_InScope(Collection<java.math.BigDecimal> webInputInventoryNumList) {
        regINS(CK_INS, cTL(webInputInventoryNumList), xgetCValueWebInputInventoryNum(), "WEB_INPUT_INVENTORY_NUM");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * WEB_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param webInputInventoryNumList The collection of webInputInventoryNum as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setWebInputInventoryNum_NotInScope(Collection<java.math.BigDecimal> webInputInventoryNumList) {
        doSetWebInputInventoryNum_NotInScope(webInputInventoryNumList);
    }

    protected void doSetWebInputInventoryNum_NotInScope(Collection<java.math.BigDecimal> webInputInventoryNumList) {
        regINS(CK_NINS, cTL(webInputInventoryNumList), xgetCValueWebInputInventoryNum(), "WEB_INPUT_INVENTORY_NUM");
    }
     ...
     * WEB_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     */
    public void setWebInputInventoryNum_IsNull() { regWebInputInventoryNum(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * WEB_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     */
    public void setWebInputInventoryNum_IsNotNull() { regWebInputInventoryNum(CK_ISNN, DOBJ); }

    protected void regWebInputInventoryNum(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueWebInputInventoryNum(), "WEB_INPUT_INVENTORY_NUM"); }
    protected abstract ConditionValue xgetCValueWebInputInventoryNum();

    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. <br>
     * AJIS_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param ajisInputInventoryNum The value of ajisInputInventoryNum as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setAjisInputInventoryNum_Equal(java.math.BigDecimal ajisInputInventoryNum) {
        doSetAjisInputInventoryNum_Equal(ajisInputInventoryNum);
    }

    protected void doSetAjisInputInventoryNum_Equal(java.math.BigDecimal ajisInputInventoryNum) {
        regAjisInputInventoryNum(CK_EQ, ajisInputInventoryNum);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * AJIS_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param ajisInputInventoryNum The value of ajisInputInventoryNum as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setAjisInputInventoryNum_NotEqual(java.math.BigDecimal ajisInputInventoryNum) {
        doSetAjisInputInventoryNum_NotEqual(ajisInputInventoryNum);
    }

    protected void doSetAjisInputInventoryNum_NotEqual(java.math.BigDecimal ajisInputInventoryNum) {
        regAjisInputInventoryNum(CK_NES, ajisInputInventoryNum);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * AJIS_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param ajisInputInventoryNum The value of ajisInputInventoryNum as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setAjisInputInventoryNum_GreaterThan(java.math.BigDecimal ajisInputInventoryNum) {
        regAjisInputInventoryNum(CK_GT, ajisInputInventoryNum);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * AJIS_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param ajisInputInventoryNum The value of ajisInputInventoryNum as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setAjisInputInventoryNum_LessThan(java.math.BigDecimal ajisInputInventoryNum) {
        regAjisInputInventoryNum(CK_LT, ajisInputInventoryNum);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * AJIS_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param ajisInputInventoryNum The value of ajisInputInventoryNum as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setAjisInputInventoryNum_GreaterEqual(java.math.BigDecimal ajisInputInventoryNum) {
        regAjisInputInventoryNum(CK_GE, ajisInputInventoryNum);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * AJIS_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param ajisInputInventoryNum The value of ajisInputInventoryNum as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setAjisInputInventoryNum_LessEqual(java.math.BigDecimal ajisInputInventoryNum) {
        regAjisInputInventoryNum(CK_LE, ajisInputInventoryNum);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * AJIS_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param minNumber The min number of ajisInputInventoryNum. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of ajisInputInventoryNum. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setAjisInputInventoryNum_RangeOf(java.math.BigDecimal minNumber, java.math.BigDecimal maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueAjisInputInventoryNum(), "AJIS_INPUT_INVENTORY_NUM", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * AJIS_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param ajisInputInventoryNumList The collection of ajisInputInventoryNum as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setAjisInputInventoryNum_InScope(Collection<java.math.BigDecimal> ajisInputInventoryNumList) {
        doSetAjisInputInventoryNum_InScope(ajisInputInventoryNumList);
    }

    protected void doSetAjisInputInventoryNum_InScope(Collection<java.math.BigDecimal> ajisInputInventoryNumList) {
        regINS(CK_INS, cTL(ajisInputInventoryNumList), xgetCValueAjisInputInventoryNum(), "AJIS_INPUT_INVENTORY_NUM");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * AJIS_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     * @param ajisInputInventoryNumList The collection of ajisInputInventoryNum as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setAjisInputInventoryNum_NotInScope(Collection<java.math.BigDecimal> ajisInputInventoryNumList) {
        doSetAjisInputInventoryNum_NotInScope(ajisInputInventoryNumList);
    }

    protected void doSetAjisInputInventoryNum_NotInScope(Collection<java.math.BigDecimal> ajisInputInventoryNumList) {
        regINS(CK_NINS, cTL(ajisInputInventoryNumList), xgetCValueAjisInputInventoryNum(), "AJIS_INPUT_INVENTORY_NUM");
    }
     ...
     * AJIS_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     */
    public void setAjisInputInventoryNum_IsNull() { regAjisInputInventoryNum(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * AJIS_INPUT_INVENTORY_NUM: {DECIMAL(14, 4), default=[0.0000]}
     */
    public void setAjisInputInventoryNum_IsNotNull() { regAjisInputInventoryNum(CK_ISNN, DOBJ); }

    protected void regAjisInputInventoryNum(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueAjisInputInventoryNum(), "AJIS_INPUT_INVENTORY_NUM"); }
    protected abstract ConditionValue xgetCValueAjisInputInventoryNum();
    ...
    protected void doSetAreaCd_InScope(Collection<String> areaCdList) {
        regINS(CK_INS, cTL(areaCdList), xgetCValueAreaCd(), "AREA_CD");
    }
    ...
    protected void doSetAreaCd_NotInScope(Collection<String> areaCdList) {
        regINS(CK_NINS, cTL(areaCdList), xgetCValueAreaCd(), "AREA_CD");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * AREA_CD: {VARCHAR(30)} <br>
    ...
    public void setAreaCd_LikeSearch(String areaCd, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(areaCd), xgetCValueAreaCd(), "AREA_CD", likeSearchOption);
    }
    ...
    public void setAreaCd_NotLikeSearch(String areaCd, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(areaCd), xgetCValueAreaCd(), "AREA_CD", likeSearchOption);
    }
    ...
    protected void regAreaCd(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueAreaCd(), "AREA_CD"); }
     ...
     * @param inventoryUserId The value of inventoryUserId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryUserId_Equal(Long inventoryUserId) {
        doSetInventoryUserId_Equal(inventoryUserId);
    }

    protected void doSetInventoryUserId_Equal(Long inventoryUserId) {
        regInventoryUserId(CK_EQ, inventoryUserId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUserId The value of inventoryUserId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryUserId_NotEqual(Long inventoryUserId) {
        doSetInventoryUserId_NotEqual(inventoryUserId);
    }

    protected void doSetInventoryUserId_NotEqual(Long inventoryUserId) {
        regInventoryUserId(CK_NES, inventoryUserId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUserId The value of inventoryUserId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryUserId_GreaterThan(Long inventoryUserId) {
        regInventoryUserId(CK_GT, inventoryUserId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUserId The value of inventoryUserId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryUserId_LessThan(Long inventoryUserId) {
        regInventoryUserId(CK_LT, inventoryUserId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUserId The value of inventoryUserId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryUserId_GreaterEqual(Long inventoryUserId) {
        regInventoryUserId(CK_GE, inventoryUserId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUserId The value of inventoryUserId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryUserId_LessEqual(Long inventoryUserId) {
        regInventoryUserId(CK_LE, inventoryUserId);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param minNumber The min number of inventoryUserId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of inventoryUserId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setInventoryUserId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueInventoryUserId(), "INVENTORY_USER_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * INVENTORY_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUserIdList The collection of inventoryUserId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryUserId_InScope(Collection<Long> inventoryUserIdList) {
        doSetInventoryUserId_InScope(inventoryUserIdList);
    }

    protected void doSetInventoryUserId_InScope(Collection<Long> inventoryUserIdList) {
        regINS(CK_INS, cTL(inventoryUserIdList), xgetCValueInventoryUserId(), "INVENTORY_USER_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * INVENTORY_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUserIdList The collection of inventoryUserId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryUserId_NotInScope(Collection<Long> inventoryUserIdList) {
        doSetInventoryUserId_NotInScope(inventoryUserIdList);
    }

    protected void doSetInventoryUserId_NotInScope(Collection<Long> inventoryUserIdList) {
        regINS(CK_NINS, cTL(inventoryUserIdList), xgetCValueInventoryUserId(), "INVENTORY_USER_ID");
    }

    /**
     * Set up InScopeRelation (sub-query). <br />
     * {in (select INVENTORY_USER_ID from b_user where ...)} <br />
     * b_user by my INVENTORY_USER_ID, named 'BUserByInventoryUserId'.
     * @param subCBLambda The callback for sub-query of BUserByInventoryUserId for 'in-scope'. (NotNull)
     */
    public void inScopeBUserByInventoryUserId(SubQuery<BUserCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        BUserCB cb = new BUserCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subCBLambda.query(cb); } finally { unlock(); }
        String pp = keepInventoryUserId_InScopeRelation_BUserByInventoryUserId(cb.query());
        registerInScopeRelation(cb.query(), "INVENTORY_USER_ID", "USER_ID", pp, "bUserByInventoryUserId", false);
    }
    public abstract String keepInventoryUserId_InScopeRelation_BUserByInventoryUserId(BUserCQ sq);

    /**
     * Set up NotInScopeRelation (sub-query). <br />
     * {not in (select INVENTORY_USER_ID from b_user where ...)} <br />
     * b_user by my INVENTORY_USER_ID, named 'BUserByInventoryUserId'.
     * @param subCBLambda The callback for sub-query of BUserByInventoryUserId for 'not in-scope'. (NotNull)
     */
    public void notInScopeBUserByInventoryUserId(SubQuery<BUserCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        BUserCB cb = new BUserCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subCBLambda.query(cb); } finally { unlock(); }
        String pp = keepInventoryUserId_NotInScopeRelation_BUserByInventoryUserId(cb.query());
        registerInScopeRelation(cb.query(), "INVENTORY_USER_ID", "USER_ID", pp, "bUserByInventoryUserId", true);
    }
    public abstract String keepInventoryUserId_NotInScopeRelation_BUserByInventoryUserId(BUserCQ sq);

    /**
     * IsNull {is null}. And OnlyOnceRegistered. <br>
     * INVENTORY_USER_ID: {IX, BIGINT(19), FK to b_user}
     */
    public void setInventoryUserId_IsNull() { regInventoryUserId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * INVENTORY_USER_ID: {IX, BIGINT(19), FK to b_user}
     */
    public void setInventoryUserId_IsNotNull() { regInventoryUserId(CK_ISNN, DOBJ); }

    protected void regInventoryUserId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueInventoryUserId(), "INVENTORY_USER_ID"); }
    protected abstract ConditionValue xgetCValueInventoryUserId();

    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_UPD_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUpdUserId The value of inventoryUpdUserId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryUpdUserId_Equal(Long inventoryUpdUserId) {
        doSetInventoryUpdUserId_Equal(inventoryUpdUserId);
    }

    protected void doSetInventoryUpdUserId_Equal(Long inventoryUpdUserId) {
        regInventoryUpdUserId(CK_EQ, inventoryUpdUserId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_UPD_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUpdUserId The value of inventoryUpdUserId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryUpdUserId_NotEqual(Long inventoryUpdUserId) {
        doSetInventoryUpdUserId_NotEqual(inventoryUpdUserId);
    }

    protected void doSetInventoryUpdUserId_NotEqual(Long inventoryUpdUserId) {
        regInventoryUpdUserId(CK_NES, inventoryUpdUserId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_UPD_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUpdUserId The value of inventoryUpdUserId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryUpdUserId_GreaterThan(Long inventoryUpdUserId) {
        regInventoryUpdUserId(CK_GT, inventoryUpdUserId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_UPD_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUpdUserId The value of inventoryUpdUserId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryUpdUserId_LessThan(Long inventoryUpdUserId) {
        regInventoryUpdUserId(CK_LT, inventoryUpdUserId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_UPD_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUpdUserId The value of inventoryUpdUserId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryUpdUserId_GreaterEqual(Long inventoryUpdUserId) {
        regInventoryUpdUserId(CK_GE, inventoryUpdUserId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_UPD_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUpdUserId The value of inventoryUpdUserId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryUpdUserId_LessEqual(Long inventoryUpdUserId) {
        regInventoryUpdUserId(CK_LE, inventoryUpdUserId);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_UPD_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param minNumber The min number of inventoryUpdUserId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of inventoryUpdUserId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setInventoryUpdUserId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueInventoryUpdUserId(), "INVENTORY_UPD_USER_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * INVENTORY_UPD_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUpdUserIdList The collection of inventoryUpdUserId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryUpdUserId_InScope(Collection<Long> inventoryUpdUserIdList) {
        doSetInventoryUpdUserId_InScope(inventoryUpdUserIdList);
    }

    protected void doSetInventoryUpdUserId_InScope(Collection<Long> inventoryUpdUserIdList) {
        regINS(CK_INS, cTL(inventoryUpdUserIdList), xgetCValueInventoryUpdUserId(), "INVENTORY_UPD_USER_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * INVENTORY_UPD_USER_ID: {IX, BIGINT(19), FK to b_user}
     * @param inventoryUpdUserIdList The collection of inventoryUpdUserId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryUpdUserId_NotInScope(Collection<Long> inventoryUpdUserIdList) {
        doSetInventoryUpdUserId_NotInScope(inventoryUpdUserIdList);
    }

    protected void doSetInventoryUpdUserId_NotInScope(Collection<Long> inventoryUpdUserIdList) {
        regINS(CK_NINS, cTL(inventoryUpdUserIdList), xgetCValueInventoryUpdUserId(), "INVENTORY_UPD_USER_ID");
    }

    /**
     * Set up InScopeRelation (sub-query). <br />
     * {in (select INVENTORY_UPD_USER_ID from b_user where ...)} <br />
     * b_user by my INVENTORY_UPD_USER_ID, named 'BUserByInventoryUpdUserId'.
     * @param subCBLambda The callback for sub-query of BUserByInventoryUpdUserId for 'in-scope'. (NotNull)
     */
    public void inScopeBUserByInventoryUpdUserId(SubQuery<BUserCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        BUserCB cb = new BUserCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subCBLambda.query(cb); } finally { unlock(); }
        String pp = keepInventoryUpdUserId_InScopeRelation_BUserByInventoryUpdUserId(cb.query());
        registerInScopeRelation(cb.query(), "INVENTORY_UPD_USER_ID", "USER_ID", pp, "bUserByInventoryUpdUserId", false);
    }
    public abstract String keepInventoryUpdUserId_InScopeRelation_BUserByInventoryUpdUserId(BUserCQ sq);

    /**
     * Set up NotInScopeRelation (sub-query). <br />
     * {not in (select INVENTORY_UPD_USER_ID from b_user where ...)} <br />
     * b_user by my INVENTORY_UPD_USER_ID, named 'BUserByInventoryUpdUserId'.
     * @param subCBLambda The callback for sub-query of BUserByInventoryUpdUserId for 'not in-scope'. (NotNull)
     */
    public void notInScopeBUserByInventoryUpdUserId(SubQuery<BUserCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        BUserCB cb = new BUserCB(); cb.xsetupForInScopeRelation(this);
        try { lock(); subCBLambda.query(cb); } finally { unlock(); }
        String pp = keepInventoryUpdUserId_NotInScopeRelation_BUserByInventoryUpdUserId(cb.query());
        registerInScopeRelation(cb.query(), "INVENTORY_UPD_USER_ID", "USER_ID", pp, "bUserByInventoryUpdUserId", true);
    }
    public abstract String keepInventoryUpdUserId_NotInScopeRelation_BUserByInventoryUpdUserId(BUserCQ sq);

    /**
     * IsNull {is null}. And OnlyOnceRegistered. <br>
     * INVENTORY_UPD_USER_ID: {IX, BIGINT(19), FK to b_user}
     */
    public void setInventoryUpdUserId_IsNull() { regInventoryUpdUserId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * INVENTORY_UPD_USER_ID: {IX, BIGINT(19), FK to b_user}
     */
    public void setInventoryUpdUserId_IsNotNull() { regInventoryUpdUserId(CK_ISNN, DOBJ); }

    protected void regInventoryUpdUserId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueInventoryUpdUserId(), "INVENTORY_UPD_USER_ID"); }
    protected abstract ConditionValue xgetCValueInventoryUpdUserId();
