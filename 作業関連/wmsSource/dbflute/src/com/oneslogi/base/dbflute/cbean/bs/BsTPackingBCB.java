...
public class BsTPackingBCB extends AbstractConditionBean {
     ...
     * @param packingBId : PK, ID, NotNull, BIGINT(19). (NotNull)
     * @return this. (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<TPackingBCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnShippingPackingRowNo() { return doColumn("SHIPPING_PACKING_ROW_NO"); }
        /**
         * OLD_PACKING_B_ID: {BIGINT(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnOldPackingBId() { return doColumn("OLD_PACKING_B_ID"); }
        /**
