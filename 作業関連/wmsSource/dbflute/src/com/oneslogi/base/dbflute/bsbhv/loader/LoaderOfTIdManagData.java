...
/**
 * The referrer loader of t_id_manag_data as TABLE. <br>
 * <pre>
 * [primary key]
 *     ID_MANAG_DATA_ID
 *
 ...
 */
public class LoaderOfTIdManagData {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<TIdManagData> _selectedList;
    protected BehaviorSelector _selector;
    protected TIdManagDataBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfTIdManagData ready(List<TIdManagData> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected TIdManagDataBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(TIdManagDataBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<TIdManagData> getSelectedList() { return _selectedList; }
