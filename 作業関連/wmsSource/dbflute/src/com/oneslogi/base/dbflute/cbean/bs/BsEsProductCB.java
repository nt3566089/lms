...
/**
 * The base condition-bean of es_product.
 * @author DBFlute(AutoGenerator)
 */
public class BsEsProductCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected EsProductCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsProductCB() {
     ...
     * @return this. (NotNull)
     */
    public EsProductCB acceptPK(Long productId) {
        assertObjectNotNull("productId", productId);
        BsEsProductCB cb = this;
        cb.query().setProductId_Equal(productId);
        return (EsProductCB)this;
    }
     ...
     */
    public EsProductCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public EsProductCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected EsProductCQ doGetConditionQuery() {
    ...
    protected EsProductCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected EsProductCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        EsProductCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected EsProductCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new EsProductCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<EsProductCB> unionCBLambda) {
        final EsProductCB cb = new EsProductCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EsProductCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<EsProductCB> unionCBLambda) {
        final EsProductCB cb = new EsProductCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EsProductCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<EsProductCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<EsProductCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSizeNm() { return doColumn("SIZE_NM"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSapAddDt() { return doColumn("SAP_ADD_DT"); }
        /**
         * SAP_ADD_TIME: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSapAddTime() { return doColumn("SAP_ADD_TIME"); }
        /**
         * STORAGE_LOCATION_TYPE_CD: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnStorageLocationTypeCd() { return doColumn("STORAGE_LOCATION_TYPE_CD"); }
        /**
         * MEDICAL_MANAG_FLG: {CHAR(1)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnMedicalManagFlg() { return doColumn("MEDICAL_MANAG_FLG"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnNizoroe10Num() { return doColumn("NIZOROE_10_NUM"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSapAddUserNm() { return doColumn("SAP_ADD_USER_NM"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSapUpdUserNm() { return doColumn("SAP_UPD_USER_NM"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "es_product"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<EsProductCB, EsProductCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<EsProductCB> sq, EsProductCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public EsProductCB dreamCruiseCB() {
        EsProductCB cb = new EsProductCB();
        cb.xsetupForDreamCruise((EsProductCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<EsProductCB> columnQuery(final SpecifyQuery<EsProductCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected EsProductCB xcreateColumnQueryCB() {
        EsProductCB cb = new EsProductCB();
        cb.xsetupForColumnQuery((EsProductCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<EsProductCB> orCBLambda) {
        xorSQ((EsProductCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<EsProductCB> andCBLambda) {
        xorSQAP((EsProductCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final EsProductCB cb;
        if (mainCB != null) {
            cb = (EsProductCB)mainCB;
        } else {
            cb = new EsProductCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return EsProductCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return EsProductCQ.class.getName(); }
