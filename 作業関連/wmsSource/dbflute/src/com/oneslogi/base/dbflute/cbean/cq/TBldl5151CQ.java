...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTBldl5151CQ;

/**
 * The condition-query of t_bldl5151.
 * <p>
 ...
 */
public class TBldl5151CQ extends BsTBldl5151CQ {
     ...
     */
    public TBldl5151CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
