...
public class PPrintQueueDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPrintQueueId = cci("PRINT_QUEUE_ID", "PRINT_QUEUE_ID", null, null, Long.class, "printQueueId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * PRINT_QUEUE_ID: {PK, ID, NotNull, BIGINT(19)}
