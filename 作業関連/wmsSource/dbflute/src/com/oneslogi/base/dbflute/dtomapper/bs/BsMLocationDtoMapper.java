...
public abstract class BsMLocationDtoMapper implements DtoMapper<MLocation, MLocationDto>, Serializable {
    ...
    public MLocationDto mappingToDto(MLocation entity) {
        ...
        dto.setExternalWhFlg(entity.getExternalWhFlg());
        dto.setLocationAttribute(entity.getLocationAttribute());
    ...
    public MLocation mappingToEntity(MLocationDto dto) {
        ...
        if (needsMapping(dto, dto.getExternalWhFlg(), "externalWhFlg")) {
            entity.setExternalWhFlg(dto.getExternalWhFlg());
        }
        if (needsMapping(dto, dto.getLocationAttribute(), "locationAttribute")) {
            entity.setLocationAttribute(dto.getLocationAttribute());
        }
