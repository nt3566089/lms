...
public abstract class BsSqlELocationListDto implements Serializable {
    ...
    /**
     * [get] ZONE_ID: {BIGINT(20), refers to m_zone.ZONE_ID} <br>
     * ゾーンID
    ...
    /**
     * [set] ZONE_ID: {BIGINT(20), refers to m_zone.ZONE_ID} <br>
     * ゾーンID
    ...
    /**
     * [get] ZONE_NM: {VARCHAR(60), refers to m_zone.ZONE_NM} <br>
     * ゾーン名称
    ...
    /**
     * [set] ZONE_NM: {VARCHAR(60), refers to m_zone.ZONE_NM} <br>
     * ゾーン名称
    ...
    /**
     * [get] REPLENISH_PRODUCT_SHAPE_ID: {BIGINT(20), refers to m_product_shape} <br>
    ...
    /**
     * [set] REPLENISH_PRODUCT_SHAPE_ID: {BIGINT(20), refers to m_product_shape} <br>
    ...
    /**
     * [get] MAX_STORE_PRODUCT_SHAPE_ID: {BIGINT(20), refers to m_product_shape} <br>
    ...
    /**
     * [set] MAX_STORE_PRODUCT_SHAPE_ID: {BIGINT(20), refers to m_product_shape} <br>
