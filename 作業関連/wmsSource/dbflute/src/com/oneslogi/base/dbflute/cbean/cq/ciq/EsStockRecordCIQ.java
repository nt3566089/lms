...
/**
 * The condition-query for in-line of es_stock_record.
 * @author DBFlute(AutoGenerator)
 */
public class EsStockRecordCIQ extends AbstractBsEsStockRecordCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEsStockRecordCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EsStockRecordCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEsStockRecordCQ myCQ) {
    ...
    public String keepScalarCondition(EsStockRecordCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EsStockRecordCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EsStockRecordCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EsStockRecordCQ sq)
    ...
    protected String xinCB() { return EsStockRecordCB.class.getName(); }
    protected String xinCQ() { return EsStockRecordCQ.class.getName(); }
}
