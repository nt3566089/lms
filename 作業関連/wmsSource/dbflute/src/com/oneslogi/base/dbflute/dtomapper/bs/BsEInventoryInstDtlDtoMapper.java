...
/**
 * The DTO mapper of e_inventory_inst_dtl as TABLE. <br>
 * 棚卸指示(明細)受信テーブル
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsEInventoryInstDtlDtoMapper implements DtoMapper<EInventoryInstDtl, EInventoryInstDtlDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEInventoryInstDtlDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEInventoryInstDtlDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EInventoryInstDtlDto mappingToDto(EInventoryInstDtl entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EInventoryInstDtlDto dto = new EInventoryInstDtlDto();
     ...
     * {@inheritDoc}
     */
    public List<EInventoryInstDtlDto> mappingToDtoList(List<EInventoryInstDtl> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EInventoryInstDtlDto> dtoList = new ArrayList<EInventoryInstDtlDto>();
        for (EInventoryInstDtl entity : entityList) {
            EInventoryInstDtlDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EInventoryInstDtl mappingToEntity(EInventoryInstDtlDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EInventoryInstDtl entity = new EInventoryInstDtl();
     ...
     */
    protected boolean needsMapping(EInventoryInstDtlDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EInventoryInstDtl> mappingToEntityList(List<EInventoryInstDtlDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EInventoryInstDtl> entityList = new ArrayList<EInventoryInstDtl>();
        for (EInventoryInstDtlDto dto : dtoList) {
            EInventoryInstDtl entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EInventoryInstDtlDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EInventoryInstDtlDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EInventoryInstDtlDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EInventoryInstDtlDtoMapper reverseReference() {
