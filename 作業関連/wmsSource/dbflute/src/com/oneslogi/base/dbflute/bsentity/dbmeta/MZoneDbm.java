...
public class MZoneDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((MZone)et).getFloorCd(), (et, vl) -> ((MZone)et).setFloorCd((String)vl), "floorCd");
        setupEpg(_epgMap, et -> ((MZone)et).getStorageSpaceCd(), (et, vl) -> ((MZone)et).setStorageSpaceCd((String)vl), "storageSpaceCd");
        setupEpg(_epgMap, et -> ((MZone)et).getReplenishTypeCd(), (et, vl) -> ((MZone)et).setReplenishTypeCd((String)vl), "replenishTypeCd");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnZoneId = cci("ZONE_ID", "ZONE_ID", null, null, Long.class, "zoneId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MLocationList,MParamList,TInventoryInstList", null, false);
    ...
    protected final ColumnInfo _columnFloorCd = cci("FLOOR_CD", "FLOOR_CD", null, null, String.class, "floorCd", null, false, false, false, "VARCHAR", 30, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnReplenishTypeCd = cci("REPLENISH_TYPE_CD", "REPLENISH_TYPE_CD", null, null, String.class, "replenishTypeCd", null, false, false, false, "VARCHAR", 30, 0, null, null, false, null, null, null, null, null, false);
     ...
     * @return The information object of specified column. (NotNull)
     */
    public ColumnInfo columnFloorCd() { return _columnFloorCd; }
    /**
     ...
     * @return The information object of specified column. (NotNull)
     */
    public ColumnInfo columnReplenishTypeCd() { return _columnReplenishTypeCd; }
    /**
    ...
    protected List<ColumnInfo> ccil() {
        ...
        ls.add(columnFloorCd());
        ls.add(columnStorageSpaceCd());
        ls.add(columnReplenishTypeCd());
        ls.add(columnDelFlg());
    ...
    public ReferrerInfo referrerMLocationList() {
        ...
        return cri("M_LOCATION_FK7", "MLocationList", this, MLocationDbm.getInstance(), mp, false, "MZone");
    }
    /**
    ...
    public ReferrerInfo referrerMParamList() {
        ...
        return cri("M_PARAM_FK3", "MParamList", this, MParamDbm.getInstance(), mp, false, "MZone");
    }
    /**
    ...
    public ReferrerInfo referrerTInventoryInstList() {
        ...
        return cri("T_INVENTORY_INST_FK2", "TInventoryInstList", this, TInventoryInstDbm.getInstance(), mp, false, "MZone");
    }
