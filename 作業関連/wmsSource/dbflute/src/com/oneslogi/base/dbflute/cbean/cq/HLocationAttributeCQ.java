...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsHLocationAttributeCQ;

/**
 * The condition-query of h_location_attribute.
 * <p>
 ...
 */
public class HLocationAttributeCQ extends BsHLocationAttributeCQ {
     ...
     */
    public HLocationAttributeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
