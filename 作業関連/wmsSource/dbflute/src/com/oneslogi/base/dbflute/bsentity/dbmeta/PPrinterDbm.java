...
public class PPrinterDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPrinterId = cci("PRINTER_ID", "PRINTER_ID", null, null, Long.class, "printerId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "PLayoutPrintSettingList,PPrinterAttributeList,PUserAutoPrintSettingByPrinterIdList,PTerminalAutoPrintSetByPrinterIdList", null, false);
    ...
    /**
     * PRINTER_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ReferrerInfo referrerPLayoutPrintSettingList() {
        ...
        return cri("P_LAYOUT_PRINT_SETTING_FK1", "PLayoutPrintSettingList", this, PLayoutPrintSettingDbm.getInstance(), mp, false, "PPrinter");
    }
    /**
