...
/**
 * The entity of er_scm_label as TABLE. <br>
 * SCMラベル情報受信テーブル
 * <pre>
 * [primary-key]
 *     SCM_LABEL_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long scmLabelId = entity.getScmLabelId();
 ...
 * String cartonIdNo = entity.getCartonIdNo();
 * String sn = entity.getSn();
 * String managTypeCd = entity.getManagTypeCd();
 ...
 * entity.setScmLabelId(scmLabelId);
 ...
 * entity.setCartonIdNo(cartonIdNo);
 * entity.setSn(sn);
 * entity.setManagTypeCd(managTypeCd);
 ...
 */
public abstract class BsErScmLabel extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected String _cartonIdNo;

    /** SN: {VARCHAR(30)} */
    protected String _sn;

    /** MANAG_TYPE_CD: {VARCHAR(30)} */
    protected String _managTypeCd;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_scmLabelId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsErScmLabel) {
            BsErScmLabel other = (BsErScmLabel)obj;
            if (!xSV(_scmLabelId, other._scmLabelId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_scmLabelId));
        ...
        sb.append(dm).append(xfND(_cartonIdNo));
        sb.append(dm).append(xfND(_sn));
        sb.append(dm).append(xfND(_managTypeCd));
    ...
    @Override
    public ErScmLabel clone() {
        return (ErScmLabel)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] SCM_LABEL_ID: {PK, NotNull, BIGINT(19)} <br>
     * SCMラベル情報受信ID
     * @return The value of the column 'SCM_LABEL_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getScmLabelId() {
        checkSpecifiedProperty("scmLabelId");
        return _scmLabelId;
    }

    /**
     * [set] SCM_LABEL_ID: {PK, NotNull, BIGINT(19)} <br>
     * SCMラベル情報受信ID
     * @param scmLabelId The value of the column 'SCM_LABEL_ID'. (basically NotNull if update: for the constraint)
     */
    public void setScmLabelId(Long scmLabelId) {
        registerModifiedProperty("scmLabelId");
        _scmLabelId = scmLabelId;
    }
    ...
    /**
     * [get] CARTON_ID_NO: {VARCHAR(30)} <br>
     * カートン識別番号
     * @return The value of the column 'CARTON_ID_NO'. (NullAllowed even if selected: for no constraint)
     */
    public String getCartonIdNo() {
        checkSpecifiedProperty("cartonIdNo");
        return convertEmptyToNull(_cartonIdNo);
    }

    /**
     * [set] CARTON_ID_NO: {VARCHAR(30)} <br>
     * カートン識別番号
     * @param cartonIdNo The value of the column 'CARTON_ID_NO'. (NullAllowed: null update allowed for no constraint)
     */
    public void setCartonIdNo(String cartonIdNo) {
        registerModifiedProperty("cartonIdNo");
        _cartonIdNo = cartonIdNo;
    }

    /**
     * [get] SN: {VARCHAR(30)} <br>
     * 連番
     * @return The value of the column 'SN'. (NullAllowed even if selected: for no constraint)
     */
    public String getSn() {
        checkSpecifiedProperty("sn");
        return convertEmptyToNull(_sn);
    }

    /**
     * [set] SN: {VARCHAR(30)} <br>
     * 連番
    ...
    /**
     * [get] MANAG_TYPE_CD: {VARCHAR(30)} <br>
     * 管理区分
     * @return The value of the column 'MANAG_TYPE_CD'. (NullAllowed even if selected: for no constraint)
     */
    public String getManagTypeCd() {
        checkSpecifiedProperty("managTypeCd");
        return convertEmptyToNull(_managTypeCd);
    }

    /**
     * [set] MANAG_TYPE_CD: {VARCHAR(30)} <br>
     * 管理区分
     * @param managTypeCd The value of the column 'MANAG_TYPE_CD'. (NullAllowed: null update allowed for no constraint)
     */
    public void setManagTypeCd(String managTypeCd) {
        registerModifiedProperty("managTypeCd");
        _managTypeCd = managTypeCd;
    }
