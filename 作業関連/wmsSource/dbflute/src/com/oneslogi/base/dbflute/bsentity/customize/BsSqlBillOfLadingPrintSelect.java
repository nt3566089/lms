...
public abstract class BsSqlBillOfLadingPrintSelect extends AbstractEntity implements CustomizeEntity {
    ...
    /** SUPPLY_CUSTOMER_NM: {VARCHAR(255), refers to t_alloc_inst_h.SUPPLY_CUSTOMER_NM} */
    ...
    /** DELIV_CUSTOMER_NM: {VARCHAR(255), refers to t_alloc_inst_h.DELIV_CUSTOMER_NM} */
    protected String _delivCustomerNm;

    /** DELIV_ADDRESS1: {VARCHAR(255), refers to t_alloc_inst_h.DELIV_ADDRESS1} */
    protected String _delivAddress1;

    /** DELIV_ADDRESS2: {VARCHAR(255), refers to t_alloc_inst_h.DELIV_ADDRESS2} */
    protected String _delivAddress2;

    /** DELIV_ADDRESS3: {VARCHAR(255), refers to t_alloc_inst_h.DELIV_ADDRESS3} */
    protected String _delivAddress3;

    /** DELIV_ZIP_CD: {VARCHAR(30), refers to t_alloc_inst_h.DELIV_ZIP_CD} */
    protected String _delivZipCd;

    /** CARRIER_TRACE_NUM: {VARCHAR(30), refers to t_packing_h.CARRIER_TRACE_NUM} */
    protected String _carrierTraceNum;

    /** BOL_OUT_FLG: {CHAR(1), refers to t_picking_r.BOL_OUT_FLG, classification=BolOutFlg} */
    protected String _bolOutFlg;

    /** BOL_OUT_NM: {NULL} */
    protected String _bolOutNm;

    /** BOL_OUT_DT: {DATETIME(23), refers to t_picking_r.BOL_OUT_DT} */
     ...
     * BOL_OUT_FLG: {CHAR(1), refers to t_picking_r.BOL_OUT_FLG, classification=BolOutFlg} <br>
     * Bill of Lading出力フラグ
    ...
    /**
     * [get] SUPPLY_CUSTOMER_NM: {VARCHAR(255), refers to t_alloc_inst_h.SUPPLY_CUSTOMER_NM} <br>
     * 納品先名称
    ...
    /**
     * [set] SUPPLY_CUSTOMER_NM: {VARCHAR(255), refers to t_alloc_inst_h.SUPPLY_CUSTOMER_NM} <br>
     * 納品先名称
    ...
    /**
     * [get] DELIV_CUSTOMER_NM: {VARCHAR(255), refers to t_alloc_inst_h.DELIV_CUSTOMER_NM} <br>
     * 届先名称
    ...
    /**
     * [set] DELIV_CUSTOMER_NM: {VARCHAR(255), refers to t_alloc_inst_h.DELIV_CUSTOMER_NM} <br>
     * 届先名称
    ...
    /**
     * [get] DELIV_ADDRESS1: {VARCHAR(255), refers to t_alloc_inst_h.DELIV_ADDRESS1} <br>
     * 届先住所1
    ...
    /**
     * [set] DELIV_ADDRESS1: {VARCHAR(255), refers to t_alloc_inst_h.DELIV_ADDRESS1} <br>
     * 届先住所1
    ...
    /**
     * [get] DELIV_ADDRESS2: {VARCHAR(255), refers to t_alloc_inst_h.DELIV_ADDRESS2} <br>
     * 届先住所2
    ...
    /**
     * [set] DELIV_ADDRESS2: {VARCHAR(255), refers to t_alloc_inst_h.DELIV_ADDRESS2} <br>
     * 届先住所2
    ...
    /**
     * [get] DELIV_ADDRESS3: {VARCHAR(255), refers to t_alloc_inst_h.DELIV_ADDRESS3} <br>
     * 届先住所3
    ...
    /**
     * [set] DELIV_ADDRESS3: {VARCHAR(255), refers to t_alloc_inst_h.DELIV_ADDRESS3} <br>
     * 届先住所3
    ...
    /**
     * [get] DELIV_ZIP_CD: {VARCHAR(30), refers to t_alloc_inst_h.DELIV_ZIP_CD} <br>
     * 届先郵便番号
    ...
    /**
     * [set] DELIV_ZIP_CD: {VARCHAR(30), refers to t_alloc_inst_h.DELIV_ZIP_CD} <br>
     * 届先郵便番号
    ...
    /**
     * [get] CARRIER_TRACE_NUM: {VARCHAR(30), refers to t_packing_h.CARRIER_TRACE_NUM} <br>
     * 貨物追跡No.
    ...
    /**
     * [set] CARRIER_TRACE_NUM: {VARCHAR(30), refers to t_packing_h.CARRIER_TRACE_NUM} <br>
     * 貨物追跡No.
    ...
    /**
     * [get] BOL_OUT_FLG: {CHAR(1), refers to t_picking_r.BOL_OUT_FLG, classification=BolOutFlg} <br>
     * Bill of Lading出力フラグ<br>
    ...
    /**
     * [set] BOL_OUT_FLG: {CHAR(1), refers to t_picking_r.BOL_OUT_FLG, classification=BolOutFlg} <br>
     * Bill of Lading出力フラグ<br>
     * // cls(BolOutFlg) Bill of lading発行フラグ
    ...
    /**
     * [get] BOL_OUT_DT: {DATETIME(23), refers to t_picking_r.BOL_OUT_DT} <br>
     * Bill of Lading出力日時
    ...
    /**
     * [set] BOL_OUT_DT: {DATETIME(23), refers to t_picking_r.BOL_OUT_DT} <br>
     * Bill of Lading出力日時
