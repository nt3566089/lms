...
/**
 * The abstract condition-query of er_packing_list.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsErPackingListCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsErPackingListCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<ErPackingListCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ErPackingListCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErPackingListCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ErPackingListCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErPackingListCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ErPackingListCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErPackingListCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ErPackingListCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErPackingListCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ErPackingListCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ErPackingListCB&gt;() {
     *     public void query(ErPackingListCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErPackingListCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ErPackingListCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ErPackingListCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ErPackingListCQ sq);

    protected ErPackingListCB xcreateScalarConditionCB() {
        ErPackingListCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ErPackingListCB xcreateScalarConditionPartitionByCB() {
        ErPackingListCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ErPackingListCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErPackingListCB cb = new ErPackingListCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "PACKING_LIST_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ErPackingListCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ErPackingListCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ErPackingListCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErPackingListCB cb = new ErPackingListCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PACKING_LIST_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ErPackingListCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ErPackingListCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ErPackingListCB cb = new ErPackingListCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ErPackingListCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ErPackingListCB newMyCB() {
        return new ErPackingListCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ErPackingListCQ.class.getName(); }
