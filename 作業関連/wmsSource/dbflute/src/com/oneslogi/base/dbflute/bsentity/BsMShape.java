...
public abstract class BsMShape extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    /**
     * [get] m_location_replenish_product by REPLENISH_P_PRODUCT_SHAPE_ID, named 'MLocationReplenishProductList'.
    ...
    /**
     * [set] m_location_replenish_product by REPLENISH_P_PRODUCT_SHAPE_ID, named 'MLocationReplenishProductList'.
    ...
    //                                                                            ========
    /**
     * [get] SHAPE_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 荷姿ID
    ...
    /**
     * [set] SHAPE_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 荷姿ID
