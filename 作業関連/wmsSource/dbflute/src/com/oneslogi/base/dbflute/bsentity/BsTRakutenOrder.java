...
public abstract class BsTRakutenOrder extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] RAKUTEN_ORDER_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 楽天RMS受注ID
    ...
    /**
     * [set] RAKUTEN_ORDER_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 楽天RMS受注ID
    ...
    /**
     * [get] POINT_SCALE: {DECIMAL(14, 4)} <br>
     * ポイント倍率
    ...
    /**
     * [set] POINT_SCALE: {DECIMAL(14, 4)} <br>
     * ポイント倍率
    ...
    /**
     * [get] EC_ORDER_B_ID: {IX, BIGINT(19), FK to t_ec_order_b} <br>
     * EC受注ボディID
    ...
    /**
     * [set] EC_ORDER_B_ID: {IX, BIGINT(19), FK to t_ec_order_b} <br>
     * EC受注ボディID
