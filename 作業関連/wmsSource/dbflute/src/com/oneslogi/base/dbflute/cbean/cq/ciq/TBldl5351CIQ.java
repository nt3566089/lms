...
/**
 * The condition-query for in-line of t_bldl5351.
 * @author DBFlute(AutoGenerator)
 */
public class TBldl5351CIQ extends AbstractBsTBldl5351CQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTBldl5351CQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TBldl5351CIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTBldl5351CQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueBldl5351Id() { return _myCQ.xdfgetBldl5351Id(); }
    ...
    protected ConditionValue xgetCValueOtherTotalNum() { return _myCQ.xdfgetOtherTotalNum(); }
    ...
    public String keepScalarCondition(TBldl5351CQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TBldl5351CQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TBldl5351CQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TBldl5351CQ sq)
    ...
    protected String xinCB() { return TBldl5351CB.class.getName(); }
    protected String xinCQ() { return TBldl5351CQ.class.getName(); }
}
