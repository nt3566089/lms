...
public class MCarrierSlipYmtDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnCarrierSlipYmtId = cci("CARRIER_SLIP_YMT_ID", "CARRIER_SLIP_YMT_ID", null, null, Long.class, "carrierSlipYmtId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MDeliveryCourseList", null, false);
    ...
    /**
     * CARRIER_SLIP_YMT_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ReferrerInfo referrerMDeliveryCourseList() {
        ...
        return cri("M_DELIVERY_COURSE_FK1", "MDeliveryCourseList", this, MDeliveryCourseDbm.getInstance(), mp, false, "MCarrierSlipYmt");
    }
