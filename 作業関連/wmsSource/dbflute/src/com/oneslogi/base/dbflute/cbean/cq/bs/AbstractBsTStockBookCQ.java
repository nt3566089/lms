...
/**
 * The abstract condition-query of t_stock_book.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTStockBookCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTStockBookCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<TStockBookCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TStockBookCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TStockBookCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TStockBookCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TStockBookCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TStockBookCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TStockBookCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TStockBookCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TStockBookCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TStockBookCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TStockBookCB&gt;() {
     *     public void query(TStockBookCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TStockBookCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TStockBookCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TStockBookCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TStockBookCQ sq);

    protected TStockBookCB xcreateScalarConditionCB() {
        TStockBookCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TStockBookCB xcreateScalarConditionPartitionByCB() {
        TStockBookCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TStockBookCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
    ...
    public abstract String keepSpecifyMyselfDerived(TStockBookCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TStockBookCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TStockBookCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TStockBookCB cb = new TStockBookCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "STOCK_BOOK_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TStockBookCQ sq);
     ...
     */
    public void myselfExists(SubQuery<TStockBookCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TStockBookCB cb = new TStockBookCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TStockBookCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TStockBookCB newMyCB() {
        return new TStockBookCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TStockBookCQ.class.getName(); }
