...
public class BsTPackingRCQ extends AbstractBsTPackingRCQ {
    ...
    protected ConditionValue _cdlOutFlg;
    public ConditionValue xdfgetCdlOutFlg()
    { if (_cdlOutFlg == null) { _cdlOutFlg = nCV(); }
      return _cdlOutFlg; }
    protected ConditionValue xgetCValueCdlOutFlg() { return xdfgetCdlOutFlg(); }
     ...
     * @return this. (NotNull)
     */
    public BsTPackingRCQ addOrderBy_CdlOutFlg_Asc() { regOBA("CDL_OUT_FLG"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTPackingRCQ addOrderBy_CdlOutFlg_Desc() { regOBD("CDL_OUT_FLG"); return this; }

    protected ConditionValue _cdlOutUserId;
    public ConditionValue xdfgetCdlOutUserId()
    { if (_cdlOutUserId == null) { _cdlOutUserId = nCV(); }
      return _cdlOutUserId; }
    protected ConditionValue xgetCValueCdlOutUserId() { return xdfgetCdlOutUserId(); }
     ...
     * @return this. (NotNull)
     */
    public BsTPackingRCQ addOrderBy_CdlOutUserId_Asc() { regOBA("CDL_OUT_USER_ID"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTPackingRCQ addOrderBy_CdlOutUserId_Desc() { regOBD("CDL_OUT_USER_ID"); return this; }

    protected ConditionValue _cdlOutDt;
    public ConditionValue xdfgetCdlOutDt()
    { if (_cdlOutDt == null) { _cdlOutDt = nCV(); }
      return _cdlOutDt; }
    protected ConditionValue xgetCValueCdlOutDt() { return xdfgetCdlOutDt(); }
     ...
     * @return this. (NotNull)
     */
    public BsTPackingRCQ addOrderBy_CdlOutDt_Asc() { regOBA("CDL_OUT_DT"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTPackingRCQ addOrderBy_CdlOutDt_Desc() { regOBD("CDL_OUT_DT"); return this; }
