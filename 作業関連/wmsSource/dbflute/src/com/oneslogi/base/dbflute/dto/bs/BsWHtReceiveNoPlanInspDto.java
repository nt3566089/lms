 ...
 *
 * [foreign-table]
 *     m_process_type, m_product, m_customer, m_location, m_stock_type, m_client, t_lot, m_center, m_warehouse
 *
 * [referrer-table]
 *     
 *
 * [foreign-property]
 *     mProcessType, mProduct, mCustomerBySupplierId, mLocation, mStockType, mCustomerByDepositId, mClient, tLot, mCenter, mWarehouse
 *
 * [referrer-property]
 *     
 * </pre>
...
public abstract class BsWHtReceiveNoPlanInspDto implements Serializable {
    ...
    //                                                                            ========
    /**
     * [get] HT_RECEIVE_NO_PLAN_INSP_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 予定無し入荷ワークID
    ...
    /**
     * [set] HT_RECEIVE_NO_PLAN_INSP_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 予定無し入荷ワークID
