...
/**
 * The referrer loader of er_id_manag as TABLE. <br>
 * <pre>
 * [primary key]
 *     ID_MANAG_ID
 *
 ...
 */
public class LoaderOfErIdManag {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<ErIdManag> _selectedList;
    protected BehaviorSelector _selector;
    protected ErIdManagBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfErIdManag ready(List<ErIdManag> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected ErIdManagBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(ErIdManagBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<ErIdManag> getSelectedList() { return _selectedList; }
