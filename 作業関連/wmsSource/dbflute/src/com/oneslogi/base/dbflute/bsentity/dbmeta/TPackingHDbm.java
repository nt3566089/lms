...
public class TPackingHDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((TPackingH)et).getNizoroeNo(), (et, vl) -> ((TPackingH)et).setNizoroeNo((String)vl), "nizoroeNo");
        setupEpg(_epgMap, et -> ((TPackingH)et).getDaihyoNizoroeNo(), (et, vl) -> ((TPackingH)et).setDaihyoNizoroeNo((String)vl), "daihyoNizoroeNo");
        setupEpg(_epgMap, et -> ((TPackingH)et).getNizoroeNo2(), (et, vl) -> ((TPackingH)et).setNizoroeNo2((String)vl), "nizoroeNo2");
        setupEpg(_epgMap, et -> ((TPackingH)et).getDaihyoNizoroeNo2(), (et, vl) -> ((TPackingH)et).setDaihyoNizoroeNo2((String)vl), "daihyoNizoroeNo2");
        setupEpg(_epgMap, et -> ((TPackingH)et).getCmSendFlg(), (et, vl) -> ((TPackingH)et).setCmSendFlg((String)vl), "cmSendFlg");
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPackingHId = cci("PACKING_H_ID", "PACKING_H_ID", null, null, Long.class, "packingHId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "TPackingBList,TPicMthdRcmdCartList", null, false);
    ...
    protected final ColumnInfo _columnGrossWeight = cci("GROSS_WEIGHT", "GROSS_WEIGHT", null, null, java.math.BigDecimal.class, "grossWeight", null, false, false, false, "DECIMAL", 14, 4, null, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnTotalVolume = cci("TOTAL_VOLUME", "TOTAL_VOLUME", null, null, java.math.BigDecimal.class, "totalVolume", null, false, false, false, "DECIMAL", 14, 4, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnUpdUser = cci("UPD_USER", "UPD_USER", null, null, String.class, "updUser", null, false, false, false, "VARCHAR", 60, 0, null, null, true, null, null, "BUserByUpdUser", null, null, false);
    ...
    public ForeignInfo foreignTAllocInstH() {
        ...
        return cfi("T_PACKING_H_FK3", "TAllocInstH", this, TAllocInstHDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "TPackingHList", false);
    }
    /**
    ...
    public ForeignInfo foreignTPickingH() {
        ...
        return cfi("T_PACKING_H_FK5", "TPickingH", this, TPickingHDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "TPackingHList", false);
    }
    /**
    ...
    public ForeignInfo foreignMClient() {
        ...
        return cfi("T_PACKING_H_FK2", "MClient", this, MClientDbm.getInstance(), mp, 2, null, false, false, false, false, null, null, false, "TPackingHList", false);
    }
    /**
    ...
    public ForeignInfo foreignMBox() {
        ...
        return cfi("T_PACKING_H_FK1", "MBox", this, MBoxDbm.getInstance(), mp, 3, null, false, false, false, false, null, null, false, "TPackingHList", false);
    }
    /**
    ...
    public ForeignInfo foreignMProcessType() {
        ...
        return cfi("T_PACKING_H_FK6", "MProcessType", this, MProcessTypeDbm.getInstance(), mp, 4, null, false, false, false, false, null, null, false, "TPackingHList", false);
    }
    /**
    ...
    public ForeignInfo foreignMCenter() {
        ...
        return cfi("T_PACKING_H_FK4", "MCenter", this, MCenterDbm.getInstance(), mp, 5, null, false, false, false, false, null, null, false, "TPackingHList", false);
    }
    /**
    ...
    public ForeignInfo foreignTPackingRAsOne() {
        ...
        return cfi("T_PACKING_R_FK1", "TPackingRAsOne", this, TPackingRDbm.getInstance(), mp, 11, null, true, false, true, false, null, null, false, "TPackingH", false);
    }
    ...
    public ReferrerInfo referrerTPackingBList() {
        ...
        return cri("T_PACKING_B_FK1", "TPackingBList", this, TPackingBDbm.getInstance(), mp, false, "TPackingH");
    }
    /**
    ...
    public ReferrerInfo referrerTPicMthdRcmdCartList() {
        ...
        return cri("T_PIC_MTHD_RCMD_CART_FK2", "TPicMthdRcmdCartList", this, TPicMthdRcmdCartDbm.getInstance(), mp, false, "TPackingH");
    }
