...
public class BTimeZoneDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnTimeZoneId = cci("TIME_ZONE_ID", "TIME_ZONE_ID", null, null, Long.class, "timeZoneId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "BSystemList,MCenterList", null, false);
    ...
    public ReferrerInfo referrerMCenterList() {
        ...
        return cri("M_CENTER_FK2", "MCenterList", this, MCenterDbm.getInstance(), mp, false, "BTimeZone");
    }
