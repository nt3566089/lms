...
public class TPickingBCIQ extends AbstractBsTPickingBCQ {
    ...
    public String keepPickingBId_ExistsReferrer_TPickingRecordStockList(TPickingRecordStockCQ sq)
    { throwIICBOE("ExistsReferrer"); return null; }
    public String keepPickingBId_NotExistsReferrer_TPackingBList(TPackingBCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepPickingBId_NotExistsReferrer_TPickingRecordStockList(TPickingRecordStockCQ sq)
    { throwIICBOE("NotExistsReferrer"); return null; }
    public String keepPickingBId_SpecifyDerivedReferrer_TPackingBList(TPackingBCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    public String keepPickingBId_SpecifyDerivedReferrer_TPickingRecordStockList(TPickingRecordStockCQ sq)
    { throwIICBOE("(Specify)DerivedReferrer"); return null; }
    ...
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepPickingBId_QueryDerivedReferrer_TPickingRecordStockList(TPickingRecordStockCQ sq)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    public String keepPickingBId_QueryDerivedReferrer_TPickingRecordStockListParameter(Object vl)
    { throwIICBOE("(Query)DerivedReferrer"); return null; }
    ...
    protected ConditionValue xgetCValuePickedNum() { return _myCQ.xdfgetPickedNum(); }
    protected ConditionValue xgetCValuePickingPaternCd() { return _myCQ.xdfgetPickingPaternCd(); }
    protected ConditionValue xgetCValueIndvLabelNo() { return _myCQ.xdfgetIndvLabelNo(); }
    protected ConditionValue xgetCValueOldPickingBId() { return _myCQ.xdfgetOldPickingBId(); }
