...
public class MSetParentDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnSetParentId = cci("SET_PARENT_ID", "SET_PARENT_ID", null, null, Long.class, "setParentId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MSetStructureList", null, false);
    ...
    /**
     * SET_PARENT_ID: {PK, ID, NotNull, BIGINT(19)}
