...
/**
 * The DTO mapper of e_plant_storage_space as TABLE. <br>
 * プラント保管場所マスタ受信テーブル
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsEPlantStorageSpaceDtoMapper implements DtoMapper<EPlantStorageSpace, EPlantStorageSpaceDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEPlantStorageSpaceDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEPlantStorageSpaceDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EPlantStorageSpaceDto mappingToDto(EPlantStorageSpace entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EPlantStorageSpaceDto dto = new EPlantStorageSpaceDto();
     ...
     * {@inheritDoc}
     */
    public List<EPlantStorageSpaceDto> mappingToDtoList(List<EPlantStorageSpace> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EPlantStorageSpaceDto> dtoList = new ArrayList<EPlantStorageSpaceDto>();
        for (EPlantStorageSpace entity : entityList) {
            EPlantStorageSpaceDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EPlantStorageSpace mappingToEntity(EPlantStorageSpaceDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EPlantStorageSpace entity = new EPlantStorageSpace();
     ...
     */
    protected boolean needsMapping(EPlantStorageSpaceDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EPlantStorageSpace> mappingToEntityList(List<EPlantStorageSpaceDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EPlantStorageSpace> entityList = new ArrayList<EPlantStorageSpace>();
        for (EPlantStorageSpaceDto dto : dtoList) {
            EPlantStorageSpace entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EPlantStorageSpaceDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EPlantStorageSpaceDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EPlantStorageSpaceDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EPlantStorageSpaceDtoMapper reverseReference() {
