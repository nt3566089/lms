...
/**
 * The base condition-bean of es_shipping_inst.
 * @author DBFlute(AutoGenerator)
 */
public class BsEsShippingInstCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected EsShippingInstCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsShippingInstCB() {
     ...
     * @return this. (NotNull)
     */
    public EsShippingInstCB acceptPK(Long shippingInstId) {
        assertObjectNotNull("shippingInstId", shippingInstId);
        BsEsShippingInstCB cb = this;
        cb.query().setShippingInstId_Equal(shippingInstId);
        return (EsShippingInstCB)this;
    }
     ...
     */
    public EsShippingInstCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public EsShippingInstCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected EsShippingInstCQ doGetConditionQuery() {
    ...
    protected EsShippingInstCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected EsShippingInstCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        EsShippingInstCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected EsShippingInstCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new EsShippingInstCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<EsShippingInstCB> unionCBLambda) {
        final EsShippingInstCB cb = new EsShippingInstCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EsShippingInstCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<EsShippingInstCB> unionCBLambda) {
        final EsShippingInstCB cb = new EsShippingInstCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EsShippingInstCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<EsShippingInstCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<EsShippingInstCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "es_shipping_inst"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<EsShippingInstCB, EsShippingInstCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<EsShippingInstCB> sq, EsShippingInstCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public EsShippingInstCB dreamCruiseCB() {
        EsShippingInstCB cb = new EsShippingInstCB();
        cb.xsetupForDreamCruise((EsShippingInstCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<EsShippingInstCB> columnQuery(final SpecifyQuery<EsShippingInstCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected EsShippingInstCB xcreateColumnQueryCB() {
        EsShippingInstCB cb = new EsShippingInstCB();
        cb.xsetupForColumnQuery((EsShippingInstCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<EsShippingInstCB> orCBLambda) {
        xorSQ((EsShippingInstCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<EsShippingInstCB> andCBLambda) {
        xorSQAP((EsShippingInstCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final EsShippingInstCB cb;
        if (mainCB != null) {
            cb = (EsShippingInstCB)mainCB;
        } else {
            cb = new EsShippingInstCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return EsShippingInstCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return EsShippingInstCQ.class.getName(); }
