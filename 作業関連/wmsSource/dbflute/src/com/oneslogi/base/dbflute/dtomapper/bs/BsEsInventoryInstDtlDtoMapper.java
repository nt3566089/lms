...
/**
 * The DTO mapper of es_inventory_inst_dtl as TABLE. <br>
 * 棚卸指示(明細)送信テーブル
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsEsInventoryInstDtlDtoMapper implements DtoMapper<EsInventoryInstDtl, EsInventoryInstDtlDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEsInventoryInstDtlDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEsInventoryInstDtlDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EsInventoryInstDtlDto mappingToDto(EsInventoryInstDtl entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsInventoryInstDtlDto dto = new EsInventoryInstDtlDto();
     ...
     * {@inheritDoc}
     */
    public List<EsInventoryInstDtlDto> mappingToDtoList(List<EsInventoryInstDtl> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EsInventoryInstDtlDto> dtoList = new ArrayList<EsInventoryInstDtlDto>();
        for (EsInventoryInstDtl entity : entityList) {
            EsInventoryInstDtlDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EsInventoryInstDtl mappingToEntity(EsInventoryInstDtlDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EsInventoryInstDtl entity = new EsInventoryInstDtl();
     ...
     */
    protected boolean needsMapping(EsInventoryInstDtlDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EsInventoryInstDtl> mappingToEntityList(List<EsInventoryInstDtlDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EsInventoryInstDtl> entityList = new ArrayList<EsInventoryInstDtl>();
        for (EsInventoryInstDtlDto dto : dtoList) {
            EsInventoryInstDtl entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EsInventoryInstDtlDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EsInventoryInstDtlDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EsInventoryInstDtlDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EsInventoryInstDtlDtoMapper reverseReference() {
