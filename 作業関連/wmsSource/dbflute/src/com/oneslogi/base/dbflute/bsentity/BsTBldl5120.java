...
/**
 * The entity of t_bldl5120 as TABLE. <br>
 * BLDL5120
 * <pre>
 * [primary-key]
 *     BLDL5120_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5120Id = entity.getBldl5120Id();
 ...
 * Long kamataStore = entity.getKamataStore();
 * Long kamataDirect = entity.getKamataDirect();
 * Long kashiwaStore = entity.getKashiwaStore();
 * Long kashiwaDirect = entity.getKashiwaDirect();
 ...
 * entity.setBldl5120Id(bldl5120Id);
 ...
 * entity.setKamataStore(kamataStore);
 * entity.setKamataDirect(kamataDirect);
 * entity.setKashiwaStore(kashiwaStore);
 * entity.setKashiwaDirect(kashiwaDirect);
 ...
 */
public abstract class BsTBldl5120 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5120Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5120) {
            BsTBldl5120 other = (BsTBldl5120)obj;
            if (!xSV(_bldl5120Id, other._bldl5120Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5120Id));
        ...
        sb.append(dm).append(xfND(_kamataStore));
        sb.append(dm).append(xfND(_kamataDirect));
        sb.append(dm).append(xfND(_kashiwaStore));
        sb.append(dm).append(xfND(_kashiwaDirect));
    ...
    @Override
    public TBldl5120 clone() {
        return (TBldl5120)super.clone();
    }
     ...
     * BLDL5120ID
     * @return The value of the column 'BLDL5120_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5120Id() {
        checkSpecifiedProperty("bldl5120Id");
        return _bldl5120Id;
    }
     ...
     * BLDL5120ID
     * @param bldl5120Id The value of the column 'BLDL5120_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5120Id(Long bldl5120Id) {
        registerModifiedProperty("bldl5120Id");
        _bldl5120Id = bldl5120Id;
    }
     ...
     * 蓮田物流_店送り
     * @return The value of the column 'KAMATA_STORE'. (NullAllowed even if selected: for no constraint)
     */
    public Long getKamataStore() {
        checkSpecifiedProperty("kamataStore");
        return _kamataStore;
    }
     ...
     * 蓮田物流_店送り
     * @param kamataStore The value of the column 'KAMATA_STORE'. (NullAllowed: null update allowed for no constraint)
     */
    public void setKamataStore(Long kamataStore) {
        registerModifiedProperty("kamataStore");
        _kamataStore = kamataStore;
    }

    /**
     * [get] KAMATA_DIRECT: {BIGINT(19)} <br>
     * 蓮田物流_直送
     * @return The value of the column 'KAMATA_DIRECT'. (NullAllowed even if selected: for no constraint)
     */
    public Long getKamataDirect() {
        checkSpecifiedProperty("kamataDirect");
     ...
     * 蓮田物流_直送
     * @param kamataDirect The value of the column 'KAMATA_DIRECT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setKamataDirect(Long kamataDirect) {
        registerModifiedProperty("kamataDirect");
        _kamataDirect = kamataDirect;
    }

    /**
     * [get] KASHIWA_STORE: {BIGINT(19)} <br>
     * 柏SRC_店送り
     * @return The value of the column 'KASHIWA_STORE'. (NullAllowed even if selected: for no constraint)
     */
    public Long getKashiwaStore() {
        checkSpecifiedProperty("kashiwaStore");
     ...
     * 柏SRC_店送り
     * @param kashiwaStore The value of the column 'KASHIWA_STORE'. (NullAllowed: null update allowed for no constraint)
     */
    public void setKashiwaStore(Long kashiwaStore) {
        registerModifiedProperty("kashiwaStore");
        _kashiwaStore = kashiwaStore;
    }

    /**
     * [get] KASHIWA_DIRECT: {BIGINT(19)} <br>
     * 柏SRC_直送
     * @return The value of the column 'KASHIWA_DIRECT'. (NullAllowed even if selected: for no constraint)
     */
    public Long getKashiwaDirect() {
        checkSpecifiedProperty("kashiwaDirect");
     ...
     * 柏SRC_直送
     * @param kashiwaDirect The value of the column 'KASHIWA_DIRECT'. (NullAllowed: null update allowed for no constraint)
     */
    public void setKashiwaDirect(Long kashiwaDirect) {
        registerModifiedProperty("kashiwaDirect");
        _kashiwaDirect = kashiwaDirect;
    }
