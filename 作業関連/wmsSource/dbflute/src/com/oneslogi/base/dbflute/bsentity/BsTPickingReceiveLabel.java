...
/**
 * The entity of t_picking_receive_label as TABLE. <br>
 * 出庫入荷ラベル
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long pickingReceiveLabelId = entity.getPickingReceiveLabelId();
 ...
 * entity.setPickingReceiveLabelId(pickingReceiveLabelId);
 ...
 */
public abstract class BsTPickingReceiveLabel extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected Long _pickingReceiveLabelId;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_pickingReceiveLabelId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTPickingReceiveLabel) {
            BsTPickingReceiveLabel other = (BsTPickingReceiveLabel)obj;
            if (!xSV(_pickingReceiveLabelId, other._pickingReceiveLabelId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _pickingReceiveLabelId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_pickingReceiveLabelId));
    ...
    @Override
    public TPickingReceiveLabel clone() {
        return (TPickingReceiveLabel)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] PICKING_RECEIVE_LABEL_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 出庫入荷ラベル
     * @return The value of the column 'PICKING_RECEIVE_LABEL_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getPickingReceiveLabelId() {
        checkSpecifiedProperty("pickingReceiveLabelId");
        return _pickingReceiveLabelId;
    }

    /**
     * [set] PICKING_RECEIVE_LABEL_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 出庫入荷ラベル
     * @param pickingReceiveLabelId The value of the column 'PICKING_RECEIVE_LABEL_ID'. (basically NotNull if update: for the constraint)
     */
    public void setPickingReceiveLabelId(Long pickingReceiveLabelId) {
        registerModifiedProperty("pickingReceiveLabelId");
        _pickingReceiveLabelId = pickingReceiveLabelId;
    }

    /**
     * [get] PICKING_B_ID: {BIGINT(19)} <br>
     * 出庫ボディID
