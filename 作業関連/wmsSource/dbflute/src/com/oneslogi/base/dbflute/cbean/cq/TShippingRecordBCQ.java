...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTShippingRecordBCQ;

/**
 * The condition-query of t_shipping_record_b.
 * <p>
 ...
 */
public class TShippingRecordBCQ extends BsTShippingRecordBCQ {
     ...
     */
    public TShippingRecordBCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
