...
/**
 * The simple DTO of e_inventory_record_dtl as TABLE. <br>
 * 棚卸実績(明細)送信テーブル
 * <pre>
 * [primary-key]
...
public abstract class BsEInventoryRecordDtlDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEInventoryRecordDtlDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEInventoryRecordDtlDto)) { return false; }
        final BsEInventoryRecordDtlDto otherEntity = (BsEInventoryRecordDtlDto)other;
        if (!helpComparingValue(getInventoryRecordDtlId(), otherEntity.getInventoryRecordDtlId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "e_inventory_record_dtl");
        result = xCH(result, getInventoryRecordDtlId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getInventoryRecordDtlId());
    ...
    //                                                                            ========
    /**
     * [get] INVENTORY_RECORD_DTL_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 棚卸実績_明細送信ID
     * @return The value of the column 'INVENTORY_RECORD_DTL_ID'. (NullAllowed)
     */
    ...
    /**
     * [set] INVENTORY_RECORD_DTL_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * 棚卸実績_明細送信ID
     * @param inventoryRecordDtlId The value of the column 'INVENTORY_RECORD_DTL_ID'. (NullAllowed)
     */
    public void setInventoryRecordDtlId(Long inventoryRecordDtlId) {
        __modifiedProperties.add("inventoryRecordDtlId");
        this._inventoryRecordDtlId = inventoryRecordDtlId;
    }
