...
/**
 * The entity of t_bldl5650 as TABLE. <br>
 * BLDL5650
 * <pre>
 * [primary-key]
 *     BLDL5650_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long bldl5650Id = entity.getBldl5650Id();
 ...
 * Long unNum = entity.getUnNum();
 * Long shNum = entity.getShNum();
 ...
 * entity.setBldl5650Id(bldl5650Id);
 ...
 */
public abstract class BsTBldl5650 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    /** UN_NUM: {BIGINT(19)} */
    protected Long _unNum;

    /** SH_NUM: {BIGINT(19)} */
    protected Long _shNum;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_bldl5650Id == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTBldl5650) {
            BsTBldl5650 other = (BsTBldl5650)obj;
            if (!xSV(_bldl5650Id, other._bldl5650Id)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_bldl5650Id));
        ...
        sb.append(dm).append(xfND(_unNum));
        sb.append(dm).append(xfND(_shNum));
    ...
    @Override
    public TBldl5650 clone() {
        return (TBldl5650)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] BLDL5650_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5650ID
     * @return The value of the column 'BLDL5650_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getBldl5650Id() {
        checkSpecifiedProperty("bldl5650Id");
        return _bldl5650Id;
    }

    /**
     * [set] BLDL5650_ID: {PK, ID, NotNull, BIGINT(19)} <br>
     * BLDL5650ID
     * @param bldl5650Id The value of the column 'BLDL5650_ID'. (basically NotNull if update: for the constraint)
     */
    public void setBldl5650Id(Long bldl5650Id) {
        registerModifiedProperty("bldl5650Id");
        _bldl5650Id = bldl5650Id;
    }
    ...
    /**
     * [get] UN_NUM: {BIGINT(19)} <br>
     * UN関連
     * @return The value of the column 'UN_NUM'. (NullAllowed even if selected: for no constraint)
     */
    public Long getUnNum() {
        checkSpecifiedProperty("unNum");
        return _unNum;
    }

    /**
     * [set] UN_NUM: {BIGINT(19)} <br>
     * UN関連
     * @param unNum The value of the column 'UN_NUM'. (NullAllowed: null update allowed for no constraint)
     */
    public void setUnNum(Long unNum) {
        registerModifiedProperty("unNum");
        _unNum = unNum;
    }

    /**
     * [get] SH_NUM: {BIGINT(19)} <br>
     * SH関連
     * @return The value of the column 'SH_NUM'. (NullAllowed even if selected: for no constraint)
     */
    public Long getShNum() {
        checkSpecifiedProperty("shNum");
        return _shNum;
    }

    /**
     * [set] SH_NUM: {BIGINT(19)} <br>
     * SH関連
     * @param shNum The value of the column 'SH_NUM'. (NullAllowed: null update allowed for no constraint)
     */
    public void setShNum(Long shNum) {
        registerModifiedProperty("shNum");
        _shNum = shNum;
    }
