...
/**
 * The abstract condition-query of er_inventory_report_sum.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsErInventoryReportSumCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsErInventoryReportSumCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public String asTableDbName() {
        return "er_inventory_report_sum";
    }
     ...
     * @param inventoryReportSumId The value of inventoryReportSumId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryReportSumId_Equal(Long inventoryReportSumId) {
        doSetInventoryReportSumId_Equal(inventoryReportSumId);
    }

    protected void doSetInventoryReportSumId_Equal(Long inventoryReportSumId) {
        regInventoryReportSumId(CK_EQ, inventoryReportSumId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_REPORT_SUM_ID: {PK, NotNull, BIGINT(19)}
     * @param inventoryReportSumId The value of inventoryReportSumId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryReportSumId_NotEqual(Long inventoryReportSumId) {
        doSetInventoryReportSumId_NotEqual(inventoryReportSumId);
    }

    protected void doSetInventoryReportSumId_NotEqual(Long inventoryReportSumId) {
        regInventoryReportSumId(CK_NES, inventoryReportSumId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_REPORT_SUM_ID: {PK, NotNull, BIGINT(19)}
     * @param inventoryReportSumId The value of inventoryReportSumId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryReportSumId_GreaterThan(Long inventoryReportSumId) {
        regInventoryReportSumId(CK_GT, inventoryReportSumId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_REPORT_SUM_ID: {PK, NotNull, BIGINT(19)}
     * @param inventoryReportSumId The value of inventoryReportSumId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryReportSumId_LessThan(Long inventoryReportSumId) {
        regInventoryReportSumId(CK_LT, inventoryReportSumId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_REPORT_SUM_ID: {PK, NotNull, BIGINT(19)}
     * @param inventoryReportSumId The value of inventoryReportSumId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryReportSumId_GreaterEqual(Long inventoryReportSumId) {
        regInventoryReportSumId(CK_GE, inventoryReportSumId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * INVENTORY_REPORT_SUM_ID: {PK, NotNull, BIGINT(19)}
     * @param inventoryReportSumId The value of inventoryReportSumId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setInventoryReportSumId_LessEqual(Long inventoryReportSumId) {
        regInventoryReportSumId(CK_LE, inventoryReportSumId);
    }
     ...
     * INVENTORY_REPORT_SUM_ID: {PK, NotNull, BIGINT(19)}
     * @param minNumber The min number of inventoryReportSumId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of inventoryReportSumId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setInventoryReportSumId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueInventoryReportSumId(), "INVENTORY_REPORT_SUM_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * INVENTORY_REPORT_SUM_ID: {PK, NotNull, BIGINT(19)}
     * @param inventoryReportSumIdList The collection of inventoryReportSumId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryReportSumId_InScope(Collection<Long> inventoryReportSumIdList) {
        doSetInventoryReportSumId_InScope(inventoryReportSumIdList);
    }

    protected void doSetInventoryReportSumId_InScope(Collection<Long> inventoryReportSumIdList) {
        regINS(CK_INS, cTL(inventoryReportSumIdList), xgetCValueInventoryReportSumId(), "INVENTORY_REPORT_SUM_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * INVENTORY_REPORT_SUM_ID: {PK, NotNull, BIGINT(19)}
     * @param inventoryReportSumIdList The collection of inventoryReportSumId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setInventoryReportSumId_NotInScope(Collection<Long> inventoryReportSumIdList) {
        doSetInventoryReportSumId_NotInScope(inventoryReportSumIdList);
    }

    protected void doSetInventoryReportSumId_NotInScope(Collection<Long> inventoryReportSumIdList) {
        regINS(CK_NINS, cTL(inventoryReportSumIdList), xgetCValueInventoryReportSumId(), "INVENTORY_REPORT_SUM_ID");
    }
     ...
     * INVENTORY_REPORT_SUM_ID: {PK, NotNull, BIGINT(19)}
     */
    public void setInventoryReportSumId_IsNull() { regInventoryReportSumId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * INVENTORY_REPORT_SUM_ID: {PK, NotNull, BIGINT(19)}
     */
    public void setInventoryReportSumId_IsNotNull() { regInventoryReportSumId(CK_ISNN, DOBJ); }

    protected void regInventoryReportSumId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueInventoryReportSumId(), "INVENTORY_REPORT_SUM_ID"); }
    protected abstract ConditionValue xgetCValueInventoryReportSumId();
     ...
     */
    public HpSLCFunction<ErInventoryReportSumCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ErInventoryReportSumCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErInventoryReportSumCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ErInventoryReportSumCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErInventoryReportSumCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ErInventoryReportSumCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErInventoryReportSumCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ErInventoryReportSumCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErInventoryReportSumCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ErInventoryReportSumCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ErInventoryReportSumCB&gt;() {
     *     public void query(ErInventoryReportSumCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ErInventoryReportSumCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ErInventoryReportSumCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ErInventoryReportSumCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ErInventoryReportSumCQ sq);

    protected ErInventoryReportSumCB xcreateScalarConditionCB() {
        ErInventoryReportSumCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ErInventoryReportSumCB xcreateScalarConditionPartitionByCB() {
        ErInventoryReportSumCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ErInventoryReportSumCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErInventoryReportSumCB cb = new ErInventoryReportSumCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "INVENTORY_REPORT_SUM_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ErInventoryReportSumCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ErInventoryReportSumCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ErInventoryReportSumCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ErInventoryReportSumCB cb = new ErInventoryReportSumCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "INVENTORY_REPORT_SUM_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ErInventoryReportSumCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ErInventoryReportSumCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ErInventoryReportSumCB cb = new ErInventoryReportSumCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ErInventoryReportSumCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ErInventoryReportSumCB newMyCB() {
        return new ErInventoryReportSumCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ErInventoryReportSumCQ.class.getName(); }
