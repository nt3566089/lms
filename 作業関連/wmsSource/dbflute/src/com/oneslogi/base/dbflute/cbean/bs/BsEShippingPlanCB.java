...
/**
 * The base condition-bean of e_shipping_plan.
 * @author DBFlute(AutoGenerator)
 */
public class BsEShippingPlanCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected EShippingPlanCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsEShippingPlanCB() {
     ...
     * @return this. (NotNull)
     */
    public EShippingPlanCB acceptPK(Long shippingPlanId) {
        assertObjectNotNull("shippingPlanId", shippingPlanId);
        BsEShippingPlanCB cb = this;
        cb.query().setShippingPlanId_Equal(shippingPlanId);
        return (EShippingPlanCB)this;
    }
     ...
     * @param shippingPlanId : PK, ID, NotNull, BIGINT(19). (NotNull)
     */
    public void acceptPrimaryKey(Long shippingPlanId) {
        assertObjectNotNull("shippingPlanId", shippingPlanId);
        BsEShippingPlanCB cb = this;
        cb.query().setShippingPlanId_Equal(shippingPlanId);
    }
     ...
     * @return this. (NotNull)
     */
    public EShippingPlanCB acceptUniqueOf(String receiveCd, Long receiveRowId) {
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_ShippingPlanId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_ShippingPlanId_Desc();
        return this;
    }
     ...
     */
    public EShippingPlanCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public EShippingPlanCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected EShippingPlanCQ doGetConditionQuery() {
    ...
    protected EShippingPlanCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected EShippingPlanCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        EShippingPlanCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected EShippingPlanCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new EShippingPlanCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<EShippingPlanCB> unionCBLambda) {
        final EShippingPlanCB cb = new EShippingPlanCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EShippingPlanCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<EShippingPlanCB> unionCBLambda) {
        final EShippingPlanCB cb = new EShippingPlanCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EShippingPlanCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<EShippingPlanCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<EShippingPlanCQ> qyCall
         ...
         */
        public SpecifiedColumn columnShippingPlanId() { return doColumn("SHIPPING_PLAN_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnShippingPlanSlipNo() { return doColumn("SHIPPING_PLAN_SLIP_NO"); }
        /**
         * SHIPPING_PLAN_SLIP_ROW_NO: {VARCHAR(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnShippingPlanSlipRowNo() { return doColumn("SHIPPING_PLAN_SLIP_ROW_NO"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSalesOrderTypeCd() { return doColumn("SALES_ORDER_TYPE_CD"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            columnShippingPlanId(); // PK
        }
        @Override
        protected String getTableDbName() { return "e_shipping_plan"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<EShippingPlanCB, EShippingPlanCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<EShippingPlanCB> sq, EShippingPlanCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public EShippingPlanCB dreamCruiseCB() {
        EShippingPlanCB cb = new EShippingPlanCB();
        cb.xsetupForDreamCruise((EShippingPlanCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<EShippingPlanCB> columnQuery(final SpecifyQuery<EShippingPlanCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected EShippingPlanCB xcreateColumnQueryCB() {
        EShippingPlanCB cb = new EShippingPlanCB();
        cb.xsetupForColumnQuery((EShippingPlanCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<EShippingPlanCB> orCBLambda) {
        xorSQ((EShippingPlanCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<EShippingPlanCB> andCBLambda) {
        xorSQAP((EShippingPlanCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final EShippingPlanCB cb;
        if (mainCB != null) {
            cb = (EShippingPlanCB)mainCB;
        } else {
            cb = new EShippingPlanCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return EShippingPlanCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return EShippingPlanCQ.class.getName(); }
