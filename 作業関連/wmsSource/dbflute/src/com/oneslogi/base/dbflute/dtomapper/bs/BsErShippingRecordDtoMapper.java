...
/**
 * The DTO mapper of er_shipping_record as TABLE. <br>
 * 出荷実績受信テーブル
 * <pre>
 * [primary-key]
 *     SHIPPING_RECORD_ID
 ...
 */
public abstract class BsErShippingRecordDtoMapper implements DtoMapper<ErShippingRecord, ErShippingRecordDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsErShippingRecordDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsErShippingRecordDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ErShippingRecordDto mappingToDto(ErShippingRecord entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErShippingRecordDto dto = new ErShippingRecordDto();
     ...
     * {@inheritDoc}
     */
    public List<ErShippingRecordDto> mappingToDtoList(List<ErShippingRecord> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ErShippingRecordDto> dtoList = new ArrayList<ErShippingRecordDto>();
        for (ErShippingRecord entity : entityList) {
            ErShippingRecordDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ErShippingRecord mappingToEntity(ErShippingRecordDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ErShippingRecord entity = new ErShippingRecord();
     ...
     */
    protected boolean needsMapping(ErShippingRecordDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ErShippingRecord> mappingToEntityList(List<ErShippingRecordDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ErShippingRecord> entityList = new ArrayList<ErShippingRecord>();
        for (ErShippingRecordDto dto : dtoList) {
            ErShippingRecord entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ErShippingRecordDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ErShippingRecordDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ErShippingRecordDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ErShippingRecordDtoMapper reverseReference() {
