...
/**
 * The base condition-bean of er_stock_record.
 * @author DBFlute(AutoGenerator)
 */
public class BsErStockRecordCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ErStockRecordCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsErStockRecordCB() {
     ...
     * @return this. (NotNull)
     */
    public ErStockRecordCB acceptPK(Long stockRecordId) {
        assertObjectNotNull("stockRecordId", stockRecordId);
        BsErStockRecordCB cb = this;
        cb.query().setStockRecordId_Equal(stockRecordId);
        return (ErStockRecordCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ErStockRecordCB acceptUniqueOf(String receiveCd, Long receiveRowId) {
     ...
     */
    public ErStockRecordCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ErStockRecordCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ErStockRecordCQ doGetConditionQuery() {
    ...
    protected ErStockRecordCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ErStockRecordCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ErStockRecordCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ErStockRecordCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ErStockRecordCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ErStockRecordCB> unionCBLambda) {
        final ErStockRecordCB cb = new ErStockRecordCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErStockRecordCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ErStockRecordCB> unionCBLambda) {
        final ErStockRecordCB cb = new ErStockRecordCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ErStockRecordCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ErStockRecordCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ErStockRecordCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "er_stock_record"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<ErStockRecordCB, ErStockRecordCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ErStockRecordCB> sq, ErStockRecordCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ErStockRecordCB dreamCruiseCB() {
        ErStockRecordCB cb = new ErStockRecordCB();
        cb.xsetupForDreamCruise((ErStockRecordCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ErStockRecordCB> columnQuery(final SpecifyQuery<ErStockRecordCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ErStockRecordCB xcreateColumnQueryCB() {
        ErStockRecordCB cb = new ErStockRecordCB();
        cb.xsetupForColumnQuery((ErStockRecordCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ErStockRecordCB> orCBLambda) {
        xorSQ((ErStockRecordCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ErStockRecordCB> andCBLambda) {
        xorSQAP((ErStockRecordCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ErStockRecordCB cb;
        if (mainCB != null) {
            cb = (ErStockRecordCB)mainCB;
        } else {
            cb = new ErStockRecordCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ErStockRecordCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ErStockRecordCQ.class.getName(); }
