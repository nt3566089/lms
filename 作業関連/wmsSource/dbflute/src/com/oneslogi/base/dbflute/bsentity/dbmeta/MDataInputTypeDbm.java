...
public class MDataInputTypeDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnDataInputTypeId = cci("DATA_INPUT_TYPE_ID", "DATA_INPUT_TYPE_ID", null, null, Long.class, "dataInputTypeId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "MDataInputTypeBList", null, false);
    ...
    /**
     * DATA_INPUT_TYPE_ID: {PK, ID, NotNull, BIGINT(19)}
