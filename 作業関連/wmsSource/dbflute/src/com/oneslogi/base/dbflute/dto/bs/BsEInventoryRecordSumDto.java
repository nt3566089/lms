...
/**
 * The simple DTO of e_inventory_record_sum as TABLE. <br>
 * 棚卸実績(集約)送信テーブル
 * <pre>
 * [primary-key]
...
public abstract class BsEInventoryRecordSumDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEInventoryRecordSumDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEInventoryRecordSumDto)) { return false; }
        final BsEInventoryRecordSumDto otherEntity = (BsEInventoryRecordSumDto)other;
        if (!helpComparingValue(getInventoryRecordSumId(), otherEntity.getInventoryRecordSumId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "e_inventory_record_sum");
        result = xCH(result, getInventoryRecordSumId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getInventoryRecordSumId());
     ...
     * 棚卸実績_集約送信ID
     * @return The value of the column 'INVENTORY_RECORD_SUM_ID'. (NullAllowed)
     */
     ...
     * 棚卸実績_集約送信ID
     * @param inventoryRecordSumId The value of the column 'INVENTORY_RECORD_SUM_ID'. (NullAllowed)
     */
    public void setInventoryRecordSumId(Long inventoryRecordSumId) {
        __modifiedProperties.add("inventoryRecordSumId");
        this._inventoryRecordSumId = inventoryRecordSumId;
    }
