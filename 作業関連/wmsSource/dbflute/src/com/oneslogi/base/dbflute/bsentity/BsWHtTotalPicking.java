...
/**
 * The entity of w_ht_total_picking as TABLE. <br>
 * トータルピッキングワーク
 * <pre>
 * [primary-key]
 *     HT_TOTAL_PICKING_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long htTotalPickingId = entity.getHtTotalPickingId();
 ...
 * entity.setHtTotalPickingId(htTotalPickingId);
 ...
 */
public abstract class BsWHtTotalPicking extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_htTotalPickingId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsWHtTotalPicking) {
            BsWHtTotalPicking other = (BsWHtTotalPicking)obj;
            if (!xSV(_htTotalPickingId, other._htTotalPickingId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_htTotalPickingId));
    ...
    @Override
    public WHtTotalPicking clone() {
        return (WHtTotalPicking)super.clone();
    }
     ...
     * トータルピッキングワークID
     * @return The value of the column 'HT_TOTAL_PICKING_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getHtTotalPickingId() {
        checkSpecifiedProperty("htTotalPickingId");
     ...
     * トータルピッキングワークID
     * @param htTotalPickingId The value of the column 'HT_TOTAL_PICKING_ID'. (basically NotNull if update: for the constraint)
     */
    public void setHtTotalPickingId(Long htTotalPickingId) {
        registerModifiedProperty("htTotalPickingId");
        _htTotalPickingId = htTotalPickingId;
    }
