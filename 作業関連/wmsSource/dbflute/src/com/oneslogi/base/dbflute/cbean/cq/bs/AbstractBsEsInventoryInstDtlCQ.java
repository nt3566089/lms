...
/**
 * The abstract condition-query of es_inventory_inst_dtl.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEsInventoryInstDtlCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEsInventoryInstDtlCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<EsInventoryInstDtlCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EsInventoryInstDtlCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstDtlCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EsInventoryInstDtlCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstDtlCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EsInventoryInstDtlCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstDtlCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EsInventoryInstDtlCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstDtlCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EsInventoryInstDtlCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EsInventoryInstDtlCB&gt;() {
     *     public void query(EsInventoryInstDtlCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EsInventoryInstDtlCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EsInventoryInstDtlCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EsInventoryInstDtlCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EsInventoryInstDtlCQ sq);

    protected EsInventoryInstDtlCB xcreateScalarConditionCB() {
        EsInventoryInstDtlCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EsInventoryInstDtlCB xcreateScalarConditionPartitionByCB() {
        EsInventoryInstDtlCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EsInventoryInstDtlCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EsInventoryInstDtlCB cb = new EsInventoryInstDtlCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "INVENTORY_INST_DTL_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EsInventoryInstDtlCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EsInventoryInstDtlCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EsInventoryInstDtlCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EsInventoryInstDtlCB cb = new EsInventoryInstDtlCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "INVENTORY_INST_DTL_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EsInventoryInstDtlCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EsInventoryInstDtlCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EsInventoryInstDtlCB cb = new EsInventoryInstDtlCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EsInventoryInstDtlCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EsInventoryInstDtlCB newMyCB() {
        return new EsInventoryInstDtlCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EsInventoryInstDtlCQ.class.getName(); }
