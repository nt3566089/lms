...
public class PPrinterAttributeDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPrinterAttributeId = cci("PRINTER_ATTRIBUTE_ID", "PRINTER_ATTRIBUTE_ID", null, null, Long.class, "printerAttributeId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "PLayoutPrintSettingList,PUserAutoPrintSettingByPrinterAttributeIdList,PTerminalAutoPrintSetByPrinterAttributeIdList", null, false);
    ...
    /**
     * PRINTER_ATTRIBUTE_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    public ReferrerInfo referrerPLayoutPrintSettingList() {
        ...
        return cri("P_LAYOUT_PRINT_SETTING_FK4", "PLayoutPrintSettingList", this, PLayoutPrintSettingDbm.getInstance(), mp, false, "PPrinterAttribute");
    }
    /**
