...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsEProductPriceCQ;

/**
 * The condition-query of e_product_price.
 * <p>
 ...
 */
public class EProductPriceCQ extends BsEProductPriceCQ {
     ...
     */
    public EProductPriceCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
