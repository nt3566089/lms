...
/**
 * The simple DTO of t_id_manag_data as TABLE. <br>
 * 個体管理情報
 * <pre>
 * [primary-key]
 *     ID_MANAG_DATA_ID
...
public abstract class BsTIdManagDataDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTIdManagDataDto)) { return false; }
        final BsTIdManagDataDto otherEntity = (BsTIdManagDataDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "t_id_manag_data");
