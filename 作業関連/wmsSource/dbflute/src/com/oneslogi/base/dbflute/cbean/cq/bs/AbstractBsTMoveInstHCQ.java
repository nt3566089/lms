...
public abstract class AbstractBsTMoveInstHCQ extends AbstractConditionQuery {
     ...
     * @param kohaiTypeCd The value of kohaiTypeCd as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setKohaiTypeCd_Equal(String kohaiTypeCd) {
        doSetKohaiTypeCd_Equal(fRES(kohaiTypeCd));
    }

    protected void doSetKohaiTypeCd_Equal(String kohaiTypeCd) {
        regKohaiTypeCd(CK_EQ, kohaiTypeCd);
    }

    /**
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * KOHAI_TYPE_CD: {VARCHAR(30)}
     * @param kohaiTypeCd The value of kohaiTypeCd as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setKohaiTypeCd_NotEqual(String kohaiTypeCd) {
        doSetKohaiTypeCd_NotEqual(fRES(kohaiTypeCd));
    }

    protected void doSetKohaiTypeCd_NotEqual(String kohaiTypeCd) {
        regKohaiTypeCd(CK_NES, kohaiTypeCd);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * KOHAI_TYPE_CD: {VARCHAR(30)}
     * @param kohaiTypeCd The value of kohaiTypeCd as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setKohaiTypeCd_GreaterThan(String kohaiTypeCd) {
        regKohaiTypeCd(CK_GT, fRES(kohaiTypeCd));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * KOHAI_TYPE_CD: {VARCHAR(30)}
     * @param kohaiTypeCd The value of kohaiTypeCd as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setKohaiTypeCd_LessThan(String kohaiTypeCd) {
        regKohaiTypeCd(CK_LT, fRES(kohaiTypeCd));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * KOHAI_TYPE_CD: {VARCHAR(30)}
     * @param kohaiTypeCd The value of kohaiTypeCd as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setKohaiTypeCd_GreaterEqual(String kohaiTypeCd) {
        regKohaiTypeCd(CK_GE, fRES(kohaiTypeCd));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * KOHAI_TYPE_CD: {VARCHAR(30)}
     * @param kohaiTypeCd The value of kohaiTypeCd as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setKohaiTypeCd_LessEqual(String kohaiTypeCd) {
        regKohaiTypeCd(CK_LE, fRES(kohaiTypeCd));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * KOHAI_TYPE_CD: {VARCHAR(30)}
     * @param kohaiTypeCdList The collection of kohaiTypeCd as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setKohaiTypeCd_InScope(Collection<String> kohaiTypeCdList) {
        doSetKohaiTypeCd_InScope(kohaiTypeCdList);
    }

    protected void doSetKohaiTypeCd_InScope(Collection<String> kohaiTypeCdList) {
        regINS(CK_INS, cTL(kohaiTypeCdList), xgetCValueKohaiTypeCd(), "KOHAI_TYPE_CD");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * KOHAI_TYPE_CD: {VARCHAR(30)}
     * @param kohaiTypeCdList The collection of kohaiTypeCd as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setKohaiTypeCd_NotInScope(Collection<String> kohaiTypeCdList) {
        doSetKohaiTypeCd_NotInScope(kohaiTypeCdList);
    }

    protected void doSetKohaiTypeCd_NotInScope(Collection<String> kohaiTypeCdList) {
        regINS(CK_NINS, cTL(kohaiTypeCdList), xgetCValueKohaiTypeCd(), "KOHAI_TYPE_CD");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * KOHAI_TYPE_CD: {VARCHAR(30)} <br>
     * <pre>e.g. setKohaiTypeCd_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param kohaiTypeCd The value of kohaiTypeCd as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setKohaiTypeCd_LikeSearch(String kohaiTypeCd, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(kohaiTypeCd), xgetCValueKohaiTypeCd(), "KOHAI_TYPE_CD", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * KOHAI_TYPE_CD: {VARCHAR(30)}
     * @param kohaiTypeCd The value of kohaiTypeCd as notLikeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setKohaiTypeCd_NotLikeSearch(String kohaiTypeCd, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(kohaiTypeCd), xgetCValueKohaiTypeCd(), "KOHAI_TYPE_CD", likeSearchOption);
    }

    /**
     * PrefixSearch {like 'xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * KOHAI_TYPE_CD: {VARCHAR(30)}
     * @param kohaiTypeCd The value of kohaiTypeCd as prefixSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setKohaiTypeCd_PrefixSearch(String kohaiTypeCd) {
        setKohaiTypeCd_LikeSearch(kohaiTypeCd, xcLSOPPre());
    }
     ...
     * KOHAI_TYPE_CD: {VARCHAR(30)}
     */
    public void setKohaiTypeCd_IsNull() { regKohaiTypeCd(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * KOHAI_TYPE_CD: {VARCHAR(30)}
     */
    public void setKohaiTypeCd_IsNullOrEmpty() { regKohaiTypeCd(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * KOHAI_TYPE_CD: {VARCHAR(30)}
     */
    public void setKohaiTypeCd_IsNotNull() { regKohaiTypeCd(CK_ISNN, DOBJ); }

    protected void regKohaiTypeCd(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueKohaiTypeCd(), "KOHAI_TYPE_CD"); }
    protected abstract ConditionValue xgetCValueKohaiTypeCd();
