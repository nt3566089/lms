...
public class BsTPackingBCQ extends AbstractBsTPackingBCQ {
    ...
    protected ConditionValue _shippingPackingRowNo;
    public ConditionValue xdfgetShippingPackingRowNo()
    { if (_shippingPackingRowNo == null) { _shippingPackingRowNo = nCV(); }
      return _shippingPackingRowNo; }
    protected ConditionValue xgetCValueShippingPackingRowNo() { return xdfgetShippingPackingRowNo(); }
     ...
     * @return this. (NotNull)
     */
    public BsTPackingBCQ addOrderBy_ShippingPackingRowNo_Asc() { regOBA("SHIPPING_PACKING_ROW_NO"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTPackingBCQ addOrderBy_ShippingPackingRowNo_Desc() { regOBD("SHIPPING_PACKING_ROW_NO"); return this; }

    protected ConditionValue _oldPackingBId;
    public ConditionValue xdfgetOldPackingBId()
    { if (_oldPackingBId == null) { _oldPackingBId = nCV(); }
      return _oldPackingBId; }
    protected ConditionValue xgetCValueOldPackingBId() { return xdfgetOldPackingBId(); }
     ...
     * @return this. (NotNull)
     */
    public BsTPackingBCQ addOrderBy_OldPackingBId_Asc() { regOBA("OLD_PACKING_B_ID"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTPackingBCQ addOrderBy_OldPackingBId_Desc() { regOBD("OLD_PACKING_B_ID"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTPackingBCQ addOrderBy_ReceiveLabelNo_Asc() { regOBA("RECEIVE_LABEL_NO"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTPackingBCQ addOrderBy_ReceiveLabelNo_Desc() { regOBD("RECEIVE_LABEL_NO"); return this; }
