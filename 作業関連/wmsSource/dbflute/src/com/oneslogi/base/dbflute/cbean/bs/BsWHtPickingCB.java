...
/**
 * The base condition-bean of w_ht_picking.
 * @author DBFlute(AutoGenerator)
 */
public class BsWHtPickingCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WHtPickingCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWHtPickingCB() {
     ...
     * @return this. (NotNull)
     */
    public WHtPickingCB acceptPK(Long htPickingId) {
        assertObjectNotNull("htPickingId", htPickingId);
        BsWHtPickingCB cb = this;
        cb.query().setHtPickingId_Equal(htPickingId);
        return (WHtPickingCB)this;
    }
     ...
     * @param htPickingId : PK, ID, NotNull, BIGINT(19). (NotNull)
     */
    public void acceptPrimaryKey(Long htPickingId) {
        assertObjectNotNull("htPickingId", htPickingId);
        BsWHtPickingCB cb = this;
        cb.query().setHtPickingId_Equal(htPickingId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_HtPickingId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_HtPickingId_Desc();
        return this;
    }
     ...
     */
    public WHtPickingCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public WHtPickingCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected WHtPickingCQ doGetConditionQuery() {
    ...
    protected WHtPickingCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WHtPickingCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WHtPickingCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WHtPickingCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new WHtPickingCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<WHtPickingCB> unionCBLambda) {
        final WHtPickingCB cb = new WHtPickingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtPickingCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<WHtPickingCB> unionCBLambda) {
        final WHtPickingCB cb = new WHtPickingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtPickingCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">wHtPickingBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">wHtPicking</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtPicking</span>.<span style="color: #CC4747">getTLot()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtPicking</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtPicking</span>.<span style="color: #CC4747">getMLocation()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtPicking</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtPicking</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtPicking</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtPicking</span>.<span style="color: #CC4747">getMProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtPicking</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtPicking</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WHtPickingCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WHtPickingCQ> qyCall
         ...
         */
        public SpecifiedColumn columnHtPickingId() { return doColumn("HT_PICKING_ID"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "w_ht_picking"; }
        /**
         ...
         */
        public HpSDRFunction<WHtPickingCB, WHtPickingCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtPickingCB> sq, WHtPickingCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public WHtPickingCB dreamCruiseCB() {
        WHtPickingCB cb = new WHtPickingCB();
        cb.xsetupForDreamCruise((WHtPickingCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<WHtPickingCB> columnQuery(final SpecifyQuery<WHtPickingCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected WHtPickingCB xcreateColumnQueryCB() {
        WHtPickingCB cb = new WHtPickingCB();
        cb.xsetupForColumnQuery((WHtPickingCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<WHtPickingCB> orCBLambda) {
        xorSQ((WHtPickingCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WHtPickingCB> andCBLambda) {
        xorSQAP((WHtPickingCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WHtPickingCB cb;
        if (mainCB != null) {
            cb = (WHtPickingCB)mainCB;
        } else {
            cb = new WHtPickingCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return WHtPickingCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return WHtPickingCQ.class.getName(); }
