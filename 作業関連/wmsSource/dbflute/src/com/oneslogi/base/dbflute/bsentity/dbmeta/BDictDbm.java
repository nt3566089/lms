...
public class BDictDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnDictId = cci("DICT_ID", "DICT_ID", null, null, Long.class, "dictId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "BArgList,BClassDtlList,BColList,BCultureList,BDictCultureList,BItemList,BMenuList,BMenuGrpList,BRoleList,BRoleGrpList,BScreenList,MCenterClassDtlList,MCenterColList,MCenterItemList,MCenterScreenList,MClientColList,MClientItemList,MClientScreenList,MProcessTypeList,MShapeByShapeDictIdList,MShapeByShapeUnitDictIdList,MStockTypeList,PReportLayoutItemList,PSubrepLayoutItemList", null, false);
    ...
    public ReferrerInfo referrerBClassDtlList() {
        ...
        return cri("B_CLASS_DTL_FK1", "BClassDtlList", this, BClassDtlDbm.getInstance(), mp, false, "BDict");
    }
    /**
    ...
    public ReferrerInfo referrerBColList() {
        ...
        return cri("B_COL_FK2", "BColList", this, BColDbm.getInstance(), mp, false, "BDict");
    }
    /**
    ...
    public ReferrerInfo referrerBDictCultureList() {
        ...
        return cri("B_DICT_CULTURE_FK2", "BDictCultureList", this, BDictCultureDbm.getInstance(), mp, false, "BDict");
    }
    /**
    ...
    public ReferrerInfo referrerBMenuList() {
        ...
        return cri("B_MENU_FK2", "BMenuList", this, BMenuDbm.getInstance(), mp, false, "BDict");
    }
    /**
    ...
    public ReferrerInfo referrerBMenuGrpList() {
        ...
        return cri("B_MENU_GRP_FK1", "BMenuGrpList", this, BMenuGrpDbm.getInstance(), mp, false, "BDict");
    }
    /**
    ...
    public ReferrerInfo referrerMCenterColList() {
        ...
        return cri("M_CENTER_COL_FK1", "MCenterColList", this, MCenterColDbm.getInstance(), mp, false, "BDict");
    }
    /**
    ...
    public ReferrerInfo referrerMCenterScreenList() {
        ...
        return cri("M_CENTER_SCREEN_FK1", "MCenterScreenList", this, MCenterScreenDbm.getInstance(), mp, false, "BDict");
    }
    /**
    ...
    public ReferrerInfo referrerMClientScreenList() {
        ...
        return cri("M_CLIENT_SCREEN_FK1", "MClientScreenList", this, MClientScreenDbm.getInstance(), mp, false, "BDict");
    }
    /**
    ...
    public ReferrerInfo referrerPReportLayoutItemList() {
        ...
        return cri("P_REPORT_LAYOUT_ITEM_FK2", "PReportLayoutItemList", this, PReportLayoutItemDbm.getInstance(), mp, false, "BDict");
    }
    /**
    ...
    public ReferrerInfo referrerPSubrepLayoutItemList() {
        ...
        return cri("P_SUBREP_LAYOUT_ITEM_FK2", "PSubrepLayoutItemList", this, PSubrepLayoutItemDbm.getInstance(), mp, false, "BDict");
    }
