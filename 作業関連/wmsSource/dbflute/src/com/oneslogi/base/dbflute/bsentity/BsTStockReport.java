...
public abstract class BsTStockReport extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    //                                                                            ========
    /**
     * [get] STOCK_ID: {PK, NotNull, BIGINT(19), FK to t_stock} <br>
     * 在庫ID
    ...
    /**
     * [set] STOCK_ID: {PK, NotNull, BIGINT(19), FK to t_stock} <br>
     * 在庫ID
    ...
    /**
     * [get] STORE_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当日入庫数
    ...
    /**
     * [set] STORE_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当日入庫数
    ...
    /**
     * [get] PICKING_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当日出庫数
    ...
    /**
     * [set] PICKING_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当日出庫数
    ...
    /**
     * [get] MOVE_PLS_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当日移動数＋
    ...
    /**
     * [set] MOVE_PLS_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当日移動数＋
    ...
    /**
     * [get] MOVE_MNS_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当日移動数－
    ...
    /**
     * [set] MOVE_MNS_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当日移動数－
    ...
    /**
     * [get] ADJ_PLS_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当日調整数＋
    ...
    /**
     * [set] ADJ_PLS_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当日調整数＋
    ...
    /**
     * [get] ADJ_MNS_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当日調整数－
    ...
    /**
     * [set] ADJ_MNS_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当日調整数－
    ...
    /**
     * [get] P_CHARGE_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前日引当可能数
    ...
    /**
     * [set] P_CHARGE_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前日引当可能数
    ...
    /**
     * [get] P_ALLOC_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前日引当済数
    ...
    /**
     * [set] P_ALLOC_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前日引当済数
    ...
    /**
     * [get] P_MOVE_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前日移動中数
    ...
    /**
     * [set] P_MOVE_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前日移動中数
    ...
    /**
     * [get] P_TRANSIT_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前日積送中数
    ...
    /**
     * [set] P_TRANSIT_NUM_DAY: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前日積送中数
    ...
    /**
     * [get] STORE_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当月入庫数
    ...
    /**
     * [set] STORE_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当月入庫数
    ...
    /**
     * [get] PICKING_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当月出庫数
    ...
    /**
     * [set] PICKING_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当月出庫数
    ...
    /**
     * [get] MOVE_PLS_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当月移動数＋
    ...
    /**
     * [set] MOVE_PLS_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当月移動数＋
    ...
    /**
     * [get] MOVE_MNS_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当月移動数－
    ...
    /**
     * [set] MOVE_MNS_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当月移動数－
    ...
    /**
     * [get] ADJ_PLS_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当月調整数＋
    ...
    /**
     * [set] ADJ_PLS_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当月調整数＋
    ...
    /**
     * [get] ADJ_MNS_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当月調整数－
    ...
    /**
     * [set] ADJ_MNS_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 当月調整数－
    ...
    /**
     * [get] P_CHARGE_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前月引当可能数
    ...
    /**
     * [set] P_CHARGE_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前月引当可能数
    ...
    /**
     * [get] P_ALLOC_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前月引当済数
    ...
    /**
     * [set] P_ALLOC_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前月引当済数
    ...
    /**
     * [get] P_MOVE_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前月移動中数
    ...
    /**
     * [set] P_MOVE_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前月移動中数
    ...
    /**
     * [get] P_TRANSIT_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前月積送中数
    ...
    /**
     * [set] P_TRANSIT_NUM_MONTH: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 前月積送中数
    ...
    /**
     * [get] CHARGE_NUM_10: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 10日残引当可能数
    ...
    /**
     * [set] CHARGE_NUM_10: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 10日残引当可能数
    ...
    /**
     * [get] ALLOC_NUM_10: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 10日残引当済数
    ...
    /**
     * [set] ALLOC_NUM_10: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 10日残引当済数
    ...
    /**
     * [get] MOVE_NUM_10: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 10日残移動中数
    ...
    /**
     * [set] MOVE_NUM_10: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 10日残移動中数
    ...
    /**
     * [get] TRANSIT_NUM_10: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 10日残積送中数
    ...
    /**
     * [set] TRANSIT_NUM_10: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 10日残積送中数
    ...
    /**
     * [get] CHARGE_NUM_15: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 15日残引当可能数
    ...
    /**
     * [set] CHARGE_NUM_15: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 15日残引当可能数
    ...
    /**
     * [get] ALLOC_NUM_15: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 15日残引当済数
    ...
    /**
     * [set] ALLOC_NUM_15: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 15日残引当済数
    ...
    /**
     * [get] MOVE_NUM_15: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 15日残移動中数
    ...
    /**
     * [set] MOVE_NUM_15: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 15日残移動中数
    ...
    /**
     * [get] TRANSIT_NUM_15: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 15日残積送中数
    ...
    /**
     * [set] TRANSIT_NUM_15: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 15日残積送中数
    ...
    /**
     * [get] CHARGE_NUM_20: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 20日残引当可能数
    ...
    /**
     * [set] CHARGE_NUM_20: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 20日残引当可能数
    ...
    /**
     * [get] ALLOC_NUM_20: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 20日残引当済数
    ...
    /**
     * [set] ALLOC_NUM_20: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 20日残引当済数
    ...
    /**
     * [get] MOVE_NUM_20: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 20日残移動中数
    ...
    /**
     * [set] MOVE_NUM_20: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 20日残移動中数
    ...
    /**
     * [get] TRANSIT_NUM_20: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 20日残積送中数
    ...
    /**
     * [set] TRANSIT_NUM_20: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 20日残積送中数
    ...
    /**
     * [get] CHARGE_NUM_LAST: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 末日残引当可能数
    ...
    /**
     * [set] CHARGE_NUM_LAST: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 末日残引当可能数
    ...
    /**
     * [get] ALLOC_NUM_LAST: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 末日残引当済数
    ...
    /**
     * [set] ALLOC_NUM_LAST: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 末日残引当済数
    ...
    /**
     * [get] MOVE_NUM_LAST: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 末日残移動中数
    ...
    /**
     * [set] MOVE_NUM_LAST: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 末日残移動中数
    ...
    /**
     * [get] TRANSIT_NUM_LAST: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 末日残積送中数
    ...
    /**
     * [set] TRANSIT_NUM_LAST: {DECIMAL(14, 4), default=[0.0000]} <br>
     * 末日残積送中数
