...
/**
 * The simple DTO of t_bldl5610 as TABLE. <br>
 * BLDL5610
 * <pre>
 * [primary-key]
 *     BLDL5610_ID
...
public abstract class BsTBldl5610Dto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTBldl5610Dto)) { return false; }
        final BsTBldl5610Dto otherEntity = (BsTBldl5610Dto)other;
        if (!helpComparingValue(getBldl5610Id(), otherEntity.getBldl5610Id())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "t_bldl5610");
        result = xCH(result, getBldl5610Id());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getBldl5610Id());
        ...
        sb.append(c).append(getHasudaNum());
        sb.append(c).append(getKashiwaNum());
     ...
     * BLDL5610ID
     * @return The value of the column 'BLDL5610_ID'. (NullAllowed)
     */
     ...
     * BLDL5610ID
     * @param bldl5610Id The value of the column 'BLDL5610_ID'. (NullAllowed)
     */
    public void setBldl5610Id(Long bldl5610Id) {
        __modifiedProperties.add("bldl5610Id");
        this._bldl5610Id = bldl5610Id;
    }
     ...
     * 蓮田物流
     * @return The value of the column 'HASUDA_NUM'. (NullAllowed)
     */
     ...
     * 蓮田物流
     * @param hasudaNum The value of the column 'HASUDA_NUM'. (NullAllowed)
     */
    public void setHasudaNum(Long hasudaNum) {
        __modifiedProperties.add("hasudaNum");
        this._hasudaNum = hasudaNum;
    }

    /**
     * [get] KASHIWA_NUM: {BIGINT(19)} <br>
     * 柏SRC
     * @return The value of the column 'KASHIWA_NUM'. (NullAllowed)
     */
     ...
     * 柏SRC
     * @param kashiwaNum The value of the column 'KASHIWA_NUM'. (NullAllowed)
     */
    public void setKashiwaNum(Long kashiwaNum) {
        __modifiedProperties.add("kashiwaNum");
        this._kashiwaNum = kashiwaNum;
    }
