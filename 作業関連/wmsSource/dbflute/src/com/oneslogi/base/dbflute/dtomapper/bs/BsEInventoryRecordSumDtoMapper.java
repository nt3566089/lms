...
/**
 * The DTO mapper of e_inventory_record_sum as TABLE. <br>
 * 棚卸実績(集約)送信テーブル
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsEInventoryRecordSumDtoMapper implements DtoMapper<EInventoryRecordSum, EInventoryRecordSumDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEInventoryRecordSumDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEInventoryRecordSumDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EInventoryRecordSumDto mappingToDto(EInventoryRecordSum entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EInventoryRecordSumDto dto = new EInventoryRecordSumDto();
        dto.setInventoryRecordSumId(entity.getInventoryRecordSumId());
     ...
     * {@inheritDoc}
     */
    public List<EInventoryRecordSumDto> mappingToDtoList(List<EInventoryRecordSum> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EInventoryRecordSumDto> dtoList = new ArrayList<EInventoryRecordSumDto>();
        for (EInventoryRecordSum entity : entityList) {
            EInventoryRecordSumDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EInventoryRecordSum mappingToEntity(EInventoryRecordSumDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EInventoryRecordSum entity = new EInventoryRecordSum();
        if (needsMapping(dto, dto.getInventoryRecordSumId(), "inventoryRecordSumId")) {
            entity.setInventoryRecordSumId(dto.getInventoryRecordSumId());
        }
     ...
     */
    protected boolean needsMapping(EInventoryRecordSumDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EInventoryRecordSum> mappingToEntityList(List<EInventoryRecordSumDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EInventoryRecordSum> entityList = new ArrayList<EInventoryRecordSum>();
        for (EInventoryRecordSumDto dto : dtoList) {
            EInventoryRecordSum entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EInventoryRecordSumDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EInventoryRecordSumDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EInventoryRecordSumDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EInventoryRecordSumDtoMapper reverseReference() {
