...
/**
 * The entity of es_stock_record as TABLE. <br>
 * 在庫実績送信テーブル
 * <pre>
 * [primary-key]
 *     PACKING_LIST_ID
 ...
 */
public abstract class BsEsStockRecord extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEsStockRecord) {
            BsEsStockRecord other = (BsEsStockRecord)obj;
    ...
    @Override
    public EsStockRecord clone() {
        return (EsStockRecord)super.clone();
    }
