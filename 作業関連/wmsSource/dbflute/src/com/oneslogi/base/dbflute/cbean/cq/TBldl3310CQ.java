...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTBldl3310CQ;

/**
 * The condition-query of t_bldl3310.
 * <p>
 ...
 */
public class TBldl3310CQ extends BsTBldl3310CQ {
     ...
     */
    public TBldl3310CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
