...
/**
 * The abstract condition-query of t_bldl5620.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTBldl5620CQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTBldl5620CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param bldl5620Id The value of bldl5620Id as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5620Id_Equal(Long bldl5620Id) {
        doSetBldl5620Id_Equal(bldl5620Id);
    }

    protected void doSetBldl5620Id_Equal(Long bldl5620Id) {
        regBldl5620Id(CK_EQ, bldl5620Id);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5620_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5620Id The value of bldl5620Id as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5620Id_NotEqual(Long bldl5620Id) {
        doSetBldl5620Id_NotEqual(bldl5620Id);
    }

    protected void doSetBldl5620Id_NotEqual(Long bldl5620Id) {
        regBldl5620Id(CK_NES, bldl5620Id);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5620_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5620Id The value of bldl5620Id as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5620Id_GreaterThan(Long bldl5620Id) {
        regBldl5620Id(CK_GT, bldl5620Id);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5620_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5620Id The value of bldl5620Id as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5620Id_LessThan(Long bldl5620Id) {
        regBldl5620Id(CK_LT, bldl5620Id);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5620_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5620Id The value of bldl5620Id as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5620Id_GreaterEqual(Long bldl5620Id) {
        regBldl5620Id(CK_GE, bldl5620Id);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * BLDL5620_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5620Id The value of bldl5620Id as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setBldl5620Id_LessEqual(Long bldl5620Id) {
        regBldl5620Id(CK_LE, bldl5620Id);
    }
     ...
     * BLDL5620_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param minNumber The min number of bldl5620Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of bldl5620Id. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setBldl5620Id_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueBldl5620Id(), "BLDL5620_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5620_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5620IdList The collection of bldl5620Id as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5620Id_InScope(Collection<Long> bldl5620IdList) {
        doSetBldl5620Id_InScope(bldl5620IdList);
    }

    protected void doSetBldl5620Id_InScope(Collection<Long> bldl5620IdList) {
        regINS(CK_INS, cTL(bldl5620IdList), xgetCValueBldl5620Id(), "BLDL5620_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * BLDL5620_ID: {PK, ID, NotNull, BIGINT(19)}
     * @param bldl5620IdList The collection of bldl5620Id as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setBldl5620Id_NotInScope(Collection<Long> bldl5620IdList) {
        doSetBldl5620Id_NotInScope(bldl5620IdList);
    }

    protected void doSetBldl5620Id_NotInScope(Collection<Long> bldl5620IdList) {
        regINS(CK_NINS, cTL(bldl5620IdList), xgetCValueBldl5620Id(), "BLDL5620_ID");
    }
     ...
     * BLDL5620_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5620Id_IsNull() { regBldl5620Id(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * BLDL5620_ID: {PK, ID, NotNull, BIGINT(19)}
     */
    public void setBldl5620Id_IsNotNull() { regBldl5620Id(CK_ISNN, DOBJ); }

    protected void regBldl5620Id(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueBldl5620Id(), "BLDL5620_ID"); }
    protected abstract ConditionValue xgetCValueBldl5620Id();
     ...
     */
    public HpSLCFunction<TBldl5620CB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TBldl5620CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5620CB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TBldl5620CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5620CB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TBldl5620CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5620CB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TBldl5620CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5620CB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TBldl5620CB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TBldl5620CB&gt;() {
     *     public void query(TBldl5620CB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TBldl5620CB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TBldl5620CB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5620CB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TBldl5620CQ sq);

    protected TBldl5620CB xcreateScalarConditionCB() {
        TBldl5620CB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TBldl5620CB xcreateScalarConditionPartitionByCB() {
        TBldl5620CB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TBldl5620CB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5620CB cb = new TBldl5620CB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "BLDL5620_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TBldl5620CQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TBldl5620CB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TBldl5620CB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TBldl5620CB cb = new TBldl5620CB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "BLDL5620_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TBldl5620CQ sq);
     ...
     */
    public void myselfExists(SubQuery<TBldl5620CB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TBldl5620CB cb = new TBldl5620CB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TBldl5620CQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TBldl5620CB newMyCB() {
        return new TBldl5620CB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TBldl5620CQ.class.getName(); }
