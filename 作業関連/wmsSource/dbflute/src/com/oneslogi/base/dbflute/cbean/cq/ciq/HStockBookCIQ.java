...
/**
 * The condition-query for in-line of h_stock_book.
 * @author DBFlute(AutoGenerator)
 */
public class HStockBookCIQ extends AbstractBsHStockBookCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsHStockBookCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public HStockBookCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsHStockBookCQ myCQ) {
    ...
    public String keepScalarCondition(HStockBookCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(HStockBookCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(HStockBookCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(HStockBookCQ sq)
    ...
    protected String xinCB() { return HStockBookCB.class.getName(); }
    protected String xinCQ() { return HStockBookCQ.class.getName(); }
}
