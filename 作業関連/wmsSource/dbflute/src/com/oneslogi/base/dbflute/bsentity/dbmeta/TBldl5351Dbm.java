...
/**
 * The DB meta of t_bldl5351. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class TBldl5351Dbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final TBldl5351Dbm _instance = new TBldl5351Dbm();
    private TBldl5351Dbm() {}
    public static TBldl5351Dbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((TBldl5351)et).getBldl5351Id(), (et, vl) -> ((TBldl5351)et).setBldl5351Id(ctl(vl)), "bldl5351Id");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getYearmonth(), (et, vl) -> ((TBldl5351)et).setYearmonth((String)vl), "yearmonth");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getMonth(), (et, vl) -> ((TBldl5351)et).setMonth((String)vl), "month");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getSalesOrgCd(), (et, vl) -> ((TBldl5351)et).setSalesOrgCd((String)vl), "salesOrgCd");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getSalesOrgNm(), (et, vl) -> ((TBldl5351)et).setSalesOrgNm((String)vl), "salesOrgNm");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getRowNo(), (et, vl) -> ((TBldl5351)et).setRowNo((String)vl), "rowNo");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getDate(), (et, vl) -> ((TBldl5351)et).setDate((String)vl), "date");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getHoliday(), (et, vl) -> ((TBldl5351)et).setHoliday((String)vl), "holiday");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getSoukaFwNum(), (et, vl) -> ((TBldl5351)et).setSoukaFwNum(ctl(vl)), "soukaFwNum");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getSoukaUnNum(), (et, vl) -> ((TBldl5351)et).setSoukaUnNum(ctl(vl)), "soukaUnNum");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getSoukaShNum(), (et, vl) -> ((TBldl5351)et).setSoukaShNum(ctl(vl)), "soukaShNum");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getSoukaTotalNum(), (et, vl) -> ((TBldl5351)et).setSoukaTotalNum(ctl(vl)), "soukaTotalNum");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getKoshigayaFwNum(), (et, vl) -> ((TBldl5351)et).setKoshigayaFwNum(ctl(vl)), "koshigayaFwNum");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getKoshigayaUnNum(), (et, vl) -> ((TBldl5351)et).setKoshigayaUnNum(ctl(vl)), "koshigayaUnNum");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getKoshigayaShNum(), (et, vl) -> ((TBldl5351)et).setKoshigayaShNum(ctl(vl)), "koshigayaShNum");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getKoshigayaTotalNum(), (et, vl) -> ((TBldl5351)et).setKoshigayaTotalNum(ctl(vl)), "koshigayaTotalNum");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getOtherTotalNum(), (et, vl) -> ((TBldl5351)et).setOtherTotalNum(ctl(vl)), "otherTotalNum");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getTotalNum(), (et, vl) -> ((TBldl5351)et).setTotalNum(ctl(vl)), "totalNum");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getDelFlg(), (et, vl) -> ((TBldl5351)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getVersionNo(), (et, vl) -> ((TBldl5351)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getControlNo(), (et, vl) -> ((TBldl5351)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getAddDt(), (et, vl) -> ((TBldl5351)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getAddUser(), (et, vl) -> ((TBldl5351)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getAddProcess(), (et, vl) -> ((TBldl5351)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getUpdDt(), (et, vl) -> ((TBldl5351)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getUpdUser(), (et, vl) -> ((TBldl5351)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((TBldl5351)et).getUpdProcess(), (et, vl) -> ((TBldl5351)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "t_bldl5351";
    protected final String _tableDispName = "t_bldl5351";
    protected final String _tablePropertyName = "TBldl5351";
    protected final TableSqlName _tableSqlName = new TableSqlName("t_bldl5351", _tableDbName);
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnBldl5351Id = cci("BLDL5351_ID", "BLDL5351_ID", null, null, Long.class, "bldl5351Id", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    protected final ColumnInfo _columnOtherTotalNum = cci("OTHER_TOTAL_NUM", "OTHER_TOTAL_NUM", null, null, Long.class, "otherTotalNum", null, false, false, false, "BIGINT", 19, 0, null, null, false, null, null, null, null, null, false);
     ...
     */
    public ColumnInfo columnBldl5351Id() { return _columnBldl5351Id; }
    /**
     ...
     * @return The information object of specified column. (NotNull)
     */
    public ColumnInfo columnOtherTotalNum() { return _columnOtherTotalNum; }
    /**
     * TOTAL_NUM: {BIGINT(19)}
     * @return The information object of specified column. (NotNull)
     */
    ...
    //                                       Primary Element
    //                                       ---------------
    protected UniqueInfo cpui() { return hpcpui(columnBldl5351Id()); }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.TBldl5351"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.TBldl5351CB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.TBldl5351Bhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<TBldl5351> getEntityType() { return TBldl5351.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public TBldl5351 newEntity() { return new TBldl5351(); }
    ...
    { doAcceptPrimaryKeyMap((TBldl5351)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((TBldl5351)et, mp); }
