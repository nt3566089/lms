...
/**
 * The condition-query for in-line of e_packing_list.
 * @author DBFlute(AutoGenerator)
 */
public class EPackingListCIQ extends AbstractBsEPackingListCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEPackingListCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EPackingListCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEPackingListCQ myCQ) {
    ...
    public String keepScalarCondition(EPackingListCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EPackingListCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EPackingListCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EPackingListCQ sq)
    ...
    protected String xinCB() { return EPackingListCB.class.getName(); }
    protected String xinCQ() { return EPackingListCQ.class.getName(); }
}
