...
public class BCultureDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnCultureId = cci("CULTURE_ID", "CULTURE_ID", null, null, Long.class, "cultureId", null, true, true, true, "BIGINT", 19, 0, null, null, false, null, null, null, "BCultureSelfList,BDictCultureList,BInfoList,BMessageList,BUserList,MCenterList", null, false);
    ...
    /**
     * CULTURE_ID: {PK, ID, NotNull, BIGINT(19)}
    ...
    /**
     * LANG_CULTURE_ID: {IX, BIGINT(19), FK to b_culture}
     * @return The information object of specified column. (NotNull)
     */
    ...
    public ReferrerInfo referrerBDictCultureList() {
        ...
        return cri("B_DICT_CULTURE_FK1", "BDictCultureList", this, BDictCultureDbm.getInstance(), mp, false, "BCulture");
    }
    /**
    ...
    public ReferrerInfo referrerBUserList() {
        ...
        return cri("B_USER_FK1", "BUserList", this, BUserDbm.getInstance(), mp, false, "BCulture");
    }
    /**
    ...
    public ReferrerInfo referrerMCenterList() {
        ...
        return cri("M_CENTER_FK1", "MCenterList", this, MCenterDbm.getInstance(), mp, false, "BCulture");
    }
