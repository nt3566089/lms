...
.controller('PickingListPrint', ['$scope', '$route', '$filter', '$location', '$q', 'alertMessage', 'directiveControl', 'gridDirectiveControl', 'optionMessageControl', 'gridOptionMessageControl', 'owsHistory', 'owsCommon', 'userInfo', 'statusInfo', 'modalFactory', 'printFactory', 'PickingListPrintApi', function($scope, $route, $filter, $location, $q, alertMessage, directiveControl, gridDirectiveControl, optionMessageControl, gridOptionMessageControl, owsHistory, owsCommon, userInfo, statusInfo, modalFactory, printFactory, api) {
	...
	$scope.pickingListPrintCols = [
		...
		{field:"carrierNm", displayName:"運送便名称"},
		{field:"carrierCd", displayName:"運送業者CD"},
		{field:"carruerNm", displayName:"運送業者名称"},
		{field:"constractorCd", displayName:"ユーザCD"},
		{field:"constractorNm", displayName:"ユーザ名称"},
		...
		{field:"shippingStatusCd", displayName:"出荷区分CD"},
		{field:"shippingStatusNm", displayName:"出荷区分名称"},
		{field:"slipNo", displayName:"伝票枚数"},
		{field:"lineNo", displayName:"行数"},
		{field:"productId", displayName:"アイテム数"},
		{field:"allocNum", displayName:"総バラ数"},
		{field:"packingNum", displayName:"梱包数"},
		{field:"nizoroeOutFlg", displayName:"荷揃表発行"},
		{field:"nizoroeOutDt", displayName:"荷揃表発行日時"},
		{field:"tagOutFlgNm", displayName:"荷札発行"},
		{field:"tagOutDt", displayName:"荷札発行日時"},
		{field:"delivOutFlg", displayName:"納品書発行"},
		{field:"delivOutDt", displayName:"納品書発行日時"},
		{field:"scmOutFlg", displayName:"梱包明細発行"},
		{field:"scmOutDt", displayName:"梱包明細発行日時"},
		{field:"indvSupplyOutFlg", displayName:"個人別支給明細発行"},
		{field:"indvSupplyOutDt", displayName:"個人別支給明細発行日時"},
		{field:"indvLabelOutFlg", displayName:"個別貼り付けラベル発行"},
...
//				if (requestReport.data.list[row].shippingStatusCd != "50") {
//					alertMessage.setErrorMessageByCode("printDataTypeNotAllowedRePrintError");
//					return;
//				}
//				break;
...
//				// 個体管理印刷フラグが「オン」以外のデータがある
//				if (requestReport.data.list[row].idManagPrintFlg != "1") {
//					alertMessage.setErrorMessageByCode("printDataTypeNotAllowedRePrintError");
//					return;
//				}
//				break;
...
//		case "01":
//			// バラ荷揃表
//			requestReport.data.listReportCd.push("PiecePickingList");
//			// バラ荷揃表(個体管理用)
//			requestReport.data.listReportCd.push("PieceNizoroeListIdManag");
//			break;
//		case "02":
//			// 発行区分で[02：ケース荷揃表]が選択された場合
//			requestReport.data.head.reportCd = "CasePickingList";
//			break;
//		case "03":
//			// 発行区分で[03：バラトータル荷揃表(戸配)]が選択された場合
//			requestReport.data.head.reportCd = "PieceTotalPickingList";
//			break;
//		case "04":
//			// 発行区分で[04：ケース荷揃表(戸配)]が選択された場合
//			requestReport.data.head.reportCd = "IndividualCasePickingList";
//			break;
//		case "05":
//			// 発行区分で[05：バラトータル荷揃表]が選択された場合
//			requestReport.data.head.reportCd = "PieceTotalPickingList";
//			break;
//		case "06":
//			// 発行区分で[06：摘み取りリスト]が選択された場合
//			requestReport.data.head.reportCd = "PLPickingList";
//			break;
//		case "10":
//			// 発行区分で[10：梱包明細]が選択された場合
//			requestReport.data.head.reportCd = "PakcingSCMLabel";
//			break;
//		case "11":
//			// 発行区分で[11：個別貼り付けラベル]が選択された場合
//			requestReport.data.head.reportCd = "IndvLabel";
//			break;
//		case "12":
//			// 発行区分で[12：個人別支給明細]が選択された場合
//			requestReport.data.head.reportCd = "IndvSupplyDetail";
//			break;
//		}
